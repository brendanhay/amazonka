...
mkGenerateDataKeyPairWithoutPlaintext keyId keyPairSpec
  = GenerateDataKeyPairWithoutPlaintext'{keyId, keyPairSpec,
...
{-# INLINEABLE gdkpwpEncryptionContext #-}
...
{-# INLINEABLE gdkpwpGrantTokens #-}
{-# DEPRECATED grantTokens "Use generic-lens or generic-optics with 'grantTokens' instead"  #-}

instance Core.ToQuery GenerateDataKeyPairWithoutPlaintext where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders GenerateDataKeyPairWithoutPlaintext where
        toHeaders GenerateDataKeyPairWithoutPlaintext{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest GenerateDataKeyPairWithoutPlaintext where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GenerateDataKeyPairWithoutPlaintextResponse' Core.<$>
...
{-# INLINEABLE gdkpwprrsKeyPairSpec #-}
{-# DEPRECATED keyPairSpec "Use generic-lens or generic-optics with 'keyPairSpec' instead"  #-}
...
{-# INLINEABLE gdkpwprrsPrivateKeyCiphertextBlob #-}
...
{-# INLINEABLE gdkpwprrsResponseStatus #-}
