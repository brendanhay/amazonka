...
instancePortState_cidrListAliases = Lens.lens (\InstancePortState' {cidrListAliases} -> cidrListAliases) (\s@InstancePortState' {} a -> s {cidrListAliases = a} :: InstancePortState) Prelude.. Lens.mapping Lens._Coerce
