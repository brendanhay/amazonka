...
instance Hashable UpdateSubscription where

instance NFData UpdateSubscription where
...
updateSubscriptionResponse pResponseStatus_ =
  UpdateSubscriptionResponse' {_usrsResponseStatus = pResponseStatus_}
...
instance NFData UpdateSubscriptionResponse where
