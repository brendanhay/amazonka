...
{-# DEPRECATED gsvrrsARN "Use generic-lens or generic-optics with 'arn' instead." #-}
...
{-# DEPRECATED gsvrrsCreatedDate "Use generic-lens or generic-optics with 'createdDate' instead." #-}
...
{-# DEPRECATED gsvrrsName "Use generic-lens or generic-optics with 'name' instead." #-}
...
{-# DEPRECATED gsvrrsSecretBinary "Use generic-lens or generic-optics with 'secretBinary' instead." #-}
...
{-# DEPRECATED gsvrrsSecretString "Use generic-lens or generic-optics with 'secretString' instead." #-}
...
{-# DEPRECATED gsvrrsVersionId "Use generic-lens or generic-optics with 'versionId' instead." #-}
...
{-# DEPRECATED gsvrrsVersionStages "Use generic-lens or generic-optics with 'versionStages' instead." #-}
