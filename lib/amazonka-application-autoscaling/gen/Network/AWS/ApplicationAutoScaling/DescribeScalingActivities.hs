...
{-# INLINEABLE dsafServiceNamespace #-}
...
{-# INLINEABLE dsafScalableDimension #-}
          ...
          = Response.receiveJSON
              (\ s h x ->
                 DescribeScalingActivitiesResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "ScalingActivities"
...
mkDescribeScalingActivitiesResponse responseStatus
  = DescribeScalingActivitiesResponse'{nextToken = Core.Nothing,
                                       scalingActivities = Core.Nothing, responseStatus}
...
{-# INLINEABLE dsargrsScalingActivities #-}
{-# DEPRECATED scalingActivities "Use generic-lens or generic-optics with 'scalingActivities' instead"  #-}
...
{-# INLINEABLE dsargrsResponseStatus #-}
