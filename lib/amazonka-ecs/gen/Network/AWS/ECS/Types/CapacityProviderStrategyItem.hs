...
mkCapacityProviderStrategyItem capacityProvider
  = CapacityProviderStrategyItem'{capacityProvider,
                                  base = Core.Nothing, weight = Core.Nothing}
...
cpsiCapacityProvider :: Lens.Lens' CapacityProviderStrategyItem Core.Text
cpsiCapacityProvider = Lens.field @"capacityProvider"
{-# INLINEABLE cpsiCapacityProvider #-}
...
instance Core.FromJSON CapacityProviderStrategyItem where
        parseJSON
          = Core.withObject "CapacityProviderStrategyItem" Core.$
              \ x ->
                CapacityProviderStrategyItem' Core.<$>
                  (x Core..: "capacityProvider") Core.<*> x Core..:? "base" Core.<*>
                    x Core..:? "weight"
