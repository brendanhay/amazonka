...
newtype DeleteGlobalCluster = DeleteGlobalCluster'
  { _dgcGlobalClusterIdentifier :: Text
...
deleteGlobalCluster
    :: Text -- ^ 'dgcGlobalClusterIdentifier'
    -> DeleteGlobalCluster
deleteGlobalCluster pGlobalClusterIdentifier_ =
  DeleteGlobalCluster' {_dgcGlobalClusterIdentifier = pGlobalClusterIdentifier_}
...
instance AWSRequest DeleteGlobalCluster where
        type Rs DeleteGlobalCluster =
             DeleteGlobalClusterResponse
        request = postQuery rds
        response
          = receiveXMLWrapper "DeleteGlobalClusterResult"
              (\ s h x ->
                 DeleteGlobalClusterResponse' <$>
                   (x .@? "GlobalCluster") <*> (pure (fromEnum s)))

instance Hashable DeleteGlobalCluster where

instance NFData DeleteGlobalCluster where
...
data DeleteGlobalClusterResponse = DeleteGlobalClusterResponse'
  { _dgcrsGlobalCluster  :: !(Maybe GlobalCluster)
...
deleteGlobalClusterResponse pResponseStatus_ =
  DeleteGlobalClusterResponse'
    {_dgcrsGlobalCluster = Nothing, _dgcrsResponseStatus = pResponseStatus_}
...
instance NFData DeleteGlobalClusterResponse where
