...
mkListStreamConsumers streamARN
  = ListStreamConsumers'{streamARN, maxResults = Core.Nothing,
                         nextToken = Core.Nothing, streamCreationTimestamp = Core.Nothing}
...
{-# INLINEABLE lscStreamCreationTimestamp #-}
...
instance Core.AWSRequest ListStreamConsumers where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListStreamConsumersResponse' Core.<$>
                   (x Core..:? "Consumers") Core.<*> x Core..:? "NextToken" Core.<*>
...
mkListStreamConsumersResponse responseStatus
  = ListStreamConsumersResponse'{consumers = Core.Nothing,
...
{-# INLINEABLE lscrrsConsumers #-}
{-# DEPRECATED consumers "Use generic-lens or generic-optics with 'consumers' instead"  #-}
