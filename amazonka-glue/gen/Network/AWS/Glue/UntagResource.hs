...
untagResource_tagsToRemove = Lens.lens (\UntagResource' {tagsToRemove} -> tagsToRemove) (\s@UntagResource' {} a -> s {tagsToRemove = a} :: UntagResource) Prelude.. Prelude._Coerce
...
instance Prelude.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("AWSGlue.UntagResource" :: Prelude.ByteString),
            "Content-Type"
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ Prelude.Just ("ResourceArn" Prelude..= resourceArn),
            Prelude.Just
              ("TagsToRemove" Prelude..= tagsToRemove)
          ]
      )
