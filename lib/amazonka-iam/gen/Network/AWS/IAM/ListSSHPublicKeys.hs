...
mkListSSHPublicKeys
    :: ListSSHPublicKeys
mkListSSHPublicKeys
  = ListSSHPublicKeys'{marker = Core.Nothing,
...
instance Core.AWSRequest ListSSHPublicKeys where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListSSHPublicKeysResult"
              (\ s h x ->
                 ListSSHPublicKeysResponse' Core.<$>
                   (x Core..@? "IsTruncated") Core.<*> x Core..@? "Marker" Core.<*>
                     x Core..@? "SSHPublicKeys" Core..<@> Core.parseXMLList "member"
...
mkListSSHPublicKeysResponse responseStatus
  = ListSSHPublicKeysResponse'{isTruncated = Core.Nothing,
                               marker = Core.Nothing, sSHPublicKeys = Core.Nothing,
                               responseStatus}
...
{-# INLINEABLE lsshpkrrsIsTruncated #-}
...
{-# INLINEABLE lsshpkrrsSSHPublicKeys #-}
{-# DEPRECATED sSHPublicKeys "Use generic-lens or generic-optics with 'sSHPublicKeys' instead"  #-}
...
{-# INLINEABLE lsshpkrrsResponseStatus #-}
