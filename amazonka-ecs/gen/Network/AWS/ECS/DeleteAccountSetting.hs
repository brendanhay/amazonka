...
--
-- * 'dasName' - The resource name for which to disable the new format. If @serviceLongArnFormat@ is specified, the ARN for your Amazon ECS services is affected. If @taskLongArnFormat@ is specified, the ARN and resource ID for your Amazon ECS tasks is affected. If @containerInstanceLongArnFormat@ is specified, the ARN and resource ID for your Amazon ECS container instances is affected.
deleteAccountSetting
    :: SettingName -- ^ 'dasName'
    -> DeleteAccountSetting
deleteAccountSetting pName_ =
  DeleteAccountSetting' {_dasPrincipalARN = Nothing, _dasName = pName_}
...
deleteAccountSettingResponse pResponseStatus_ =
  DeleteAccountSettingResponse'
    {_dasrsSetting = Nothing, _dasrsResponseStatus = pResponseStatus_}
