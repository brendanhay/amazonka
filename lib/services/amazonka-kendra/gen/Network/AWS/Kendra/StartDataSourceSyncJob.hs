...
-- |
-- Module      : Network.AWS.Kendra.StartDataSourceSyncJob
...
--
-- 'id', 'startDataSourceSyncJob_id' - The identifier of the data source to synchronize.
--
-- 'indexId', 'startDataSourceSyncJob_indexId' - The identifier of the index that contains the data source.
newStartDataSourceSyncJob ::
  -- | 'id'
  Prelude.Text ->
  -- | 'indexId'
...
instance Prelude.Hashable StartDataSourceSyncJob

instance Prelude.NFData StartDataSourceSyncJob
