...
module Network.AWS.LakeFormation.Types.TableWithColumnsResource where
...
instance Prelude.Hashable TableWithColumnsResource

instance Prelude.NFData TableWithColumnsResource
