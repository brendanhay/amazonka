...
mkWebhookAuthConfiguration
    :: WebhookAuthConfiguration
mkWebhookAuthConfiguration
  = WebhookAuthConfiguration'{allowedIPRange = Core.Nothing,
...
{-# INLINEABLE wacAllowedIPRange #-}
{-# DEPRECATED allowedIPRange "Use generic-lens or generic-optics with 'allowedIPRange' instead"  #-}
...
{-# INLINEABLE wacSecretToken #-}
{-# DEPRECATED secretToken "Use generic-lens or generic-optics with 'secretToken' instead"  #-}
...
instance Core.FromJSON WebhookAuthConfiguration where
        parseJSON
          = Core.withObject "WebhookAuthConfiguration" Core.$
              \ x ->
                WebhookAuthConfiguration' Core.<$>
                  (x Core..:? "AllowedIPRange") Core.<*> x Core..:? "SecretToken"
