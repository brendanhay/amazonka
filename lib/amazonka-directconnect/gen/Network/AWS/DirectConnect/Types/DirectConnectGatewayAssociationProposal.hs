...
{-# INLINEABLE dcgapAssociatedGateway #-}
...
{-# INLINEABLE dcgapDirectConnectGatewayId #-}
...
{-# INLINEABLE dcgapDirectConnectGatewayOwnerAccount #-}
...
{-# INLINEABLE dcgapExistingAllowedPrefixesToDirectConnectGateway #-}
{-# DEPRECATED existingAllowedPrefixesToDirectConnectGateway "Use generic-lens or generic-optics with 'existingAllowedPrefixesToDirectConnectGateway' instead"  #-}
...
{-# INLINEABLE dcgapProposalState #-}
{-# DEPRECATED proposalState "Use generic-lens or generic-optics with 'proposalState' instead"  #-}
...
{-# INLINEABLE dcgapRequestedAllowedPrefixesToDirectConnectGateway #-}
{-# DEPRECATED requestedAllowedPrefixesToDirectConnectGateway "Use generic-lens or generic-optics with 'requestedAllowedPrefixesToDirectConnectGateway' instead"  #-}

instance Core.FromJSON DirectConnectGatewayAssociationProposal
         where
        parseJSON
          = Core.withObject "DirectConnectGatewayAssociationProposal" Core.$
              \ x ->
                DirectConnectGatewayAssociationProposal' Core.<$>
                  (x Core..:? "associatedGateway") Core.<*>
                    ...
                    Core.<*>
                    x Core..:? "requestedAllowedPrefixesToDirectConnectGateway"
