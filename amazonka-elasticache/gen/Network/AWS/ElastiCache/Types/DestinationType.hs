...
-- |
-- Module      : Network.AWS.ElastiCache.Types.DestinationType
...
pattern DestinationType_Cloudwatch_logs = DestinationType' "cloudwatch-logs"

pattern DestinationType_Kinesis_firehose :: DestinationType
pattern DestinationType_Kinesis_firehose = DestinationType' "kinesis-firehose"
