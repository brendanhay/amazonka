...
deleteDBInstanceAutomatedBackup
    :: Text -- ^ 'ddiabDBiResourceId'
    -> DeleteDBInstanceAutomatedBackup
deleteDBInstanceAutomatedBackup pDBiResourceId_ =
  DeleteDBInstanceAutomatedBackup' {_ddiabDBiResourceId = pDBiResourceId_}
...
instance AWSRequest DeleteDBInstanceAutomatedBackup
         where
...
instance NFData DeleteDBInstanceAutomatedBackup where

instance ToHeaders DeleteDBInstanceAutomatedBackup
         where
...
instance ToQuery DeleteDBInstanceAutomatedBackup
         where
...
data DeleteDBInstanceAutomatedBackupResponse = DeleteDBInstanceAutomatedBackupResponse'
  { _ddbiabrsDBInstanceAutomatedBackup :: !(Maybe DBInstanceAutomatedBackup)
  , _ddbiabrsResponseStatus            :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
deleteDBInstanceAutomatedBackupResponse
    :: Int -- ^ 'ddbiabrsResponseStatus'
    -> DeleteDBInstanceAutomatedBackupResponse
deleteDBInstanceAutomatedBackupResponse pResponseStatus_ =
  DeleteDBInstanceAutomatedBackupResponse'
    { _ddbiabrsDBInstanceAutomatedBackup = Nothing
