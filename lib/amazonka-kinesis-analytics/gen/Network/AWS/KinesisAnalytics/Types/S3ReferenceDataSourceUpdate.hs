...
mkS3ReferenceDataSourceUpdate
    :: S3ReferenceDataSourceUpdate
mkS3ReferenceDataSourceUpdate
  = S3ReferenceDataSourceUpdate'{bucketARNUpdate = Core.Nothing,
...
{-# INLINEABLE srdsuBucketARNUpdate #-}
{-# DEPRECATED bucketARNUpdate "Use generic-lens or generic-optics with 'bucketARNUpdate' instead"  #-}
...
{-# INLINEABLE srdsuFileKeyUpdate #-}
{-# DEPRECATED fileKeyUpdate "Use generic-lens or generic-optics with 'fileKeyUpdate' instead"  #-}
...
{-# INLINEABLE srdsuReferenceRoleARNUpdate #-}
{-# DEPRECATED referenceRoleARNUpdate "Use generic-lens or generic-optics with 'referenceRoleARNUpdate' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("BucketARNUpdate" Core..=) Core.<$> bucketARNUpdate,
                  ...
                  ("ReferenceRoleARNUpdate" Core..=) Core.<$>
