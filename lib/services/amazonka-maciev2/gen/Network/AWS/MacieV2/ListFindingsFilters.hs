...
-- |
-- Module      : Network.AWS.MacieV2.ListFindingsFilters
...
instance Prelude.Hashable ListFindingsFilters

instance Prelude.NFData ListFindingsFilters
...
instance Prelude.NFData ListFindingsFiltersResponse
