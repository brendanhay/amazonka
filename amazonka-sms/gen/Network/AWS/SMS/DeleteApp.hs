...
--
-- * 'daForceTerminateApp' - While deleting the application, terminate the stack corresponding to the application.
--
-- * 'daAppId' - ID of the application to delete.
--
-- * 'daForceStopAppReplication' - While deleting the application, stop all replication jobs corresponding to the servers in the application.
deleteApp
    :: DeleteApp
deleteApp =
  DeleteApp'
