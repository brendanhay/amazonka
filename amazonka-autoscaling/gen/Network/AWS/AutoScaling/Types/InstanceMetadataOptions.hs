...
data InstanceMetadataOptions = InstanceMetadataOptions'
  { -- | This parameter enables or disables the HTTP metadata endpoint on your
    ...
    httpTokens :: Core.Maybe InstanceMetadataHttpTokensState
  }
...
-- If you specify a value of @disabled@, you will not be able to access
-- your instance metadata.
instanceMetadataOptions_httpEndpoint :: Lens.Lens' InstanceMetadataOptions (Core.Maybe InstanceMetadataEndpointState)
...
--
-- Default: 1
instanceMetadataOptions_httpPutResponseHopLimit :: Lens.Lens' InstanceMetadataOptions (Core.Maybe Core.Natural)
...
-- role credentials always returns the version 2.0 credentials; the version
-- 1.0 credentials are not available.
instanceMetadataOptions_httpTokens :: Lens.Lens' InstanceMetadataOptions (Core.Maybe InstanceMetadataHttpTokensState)
...
instance Core.Hashable InstanceMetadataOptions

instance Core.NFData InstanceMetadataOptions
