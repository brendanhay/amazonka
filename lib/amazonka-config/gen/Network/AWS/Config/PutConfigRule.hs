...
{-# INLINEABLE pcrConfigRule #-}
{-# DEPRECATED configRule "Use generic-lens or generic-optics with 'configRule' instead"  #-}
...
instance Core.AWSRequest PutConfigRule where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull PutConfigRuleResponse'
