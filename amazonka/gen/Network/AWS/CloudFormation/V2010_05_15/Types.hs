...
instance ServiceError (Er CloudFormation) where
...
instance ToByteString Capability where
    toBS CapabilityCapabilityIam = "CAPABILITY_IAM"
...
instance ToByteString OnFailure where
    toBS OnFailureDelete = "DELETE"
    toBS OnFailureDoNothing = "DO_NOTHING"
    toBS OnFailureRollback = "ROLLBACK"
...
instance ToByteString ResourceStatus where
    toBS ResourceStatusCreateComplete = "CREATE_COMPLETE"
    toBS ResourceStatusCreateFailed = "CREATE_FAILED"
    toBS ResourceStatusCreateInProgress = "CREATE_IN_PROGRESS"
    toBS ResourceStatusDeleteComplete = "DELETE_COMPLETE"
    toBS ResourceStatusDeleteFailed = "DELETE_FAILED"
    toBS ResourceStatusDeleteInProgress = "DELETE_IN_PROGRESS"
    toBS ResourceStatusUpdateComplete = "UPDATE_COMPLETE"
    toBS ResourceStatusUpdateFailed = "UPDATE_FAILED"
    toBS ResourceStatusUpdateInProgress = "UPDATE_IN_PROGRESS"
...
instance ToByteString StackStatus where
    toBS StackStatusCreateComplete = "CREATE_COMPLETE"
    toBS StackStatusCreateFailed = "CREATE_FAILED"
    toBS StackStatusCreateInProgress = "CREATE_IN_PROGRESS"
    toBS StackStatusDeleteComplete = "DELETE_COMPLETE"
    toBS StackStatusDeleteFailed = "DELETE_FAILED"
    toBS StackStatusDeleteInProgress = "DELETE_IN_PROGRESS"
    toBS StackStatusRollbackComplete = "ROLLBACK_COMPLETE"
    toBS StackStatusRollbackFailed = "ROLLBACK_FAILED"
    toBS StackStatusRollbackInProgress = "ROLLBACK_IN_PROGRESS"
    toBS StackStatusUpdateComplete = "UPDATE_COMPLETE"
    toBS StackStatusUpdateCompleteCleanupInProgress = "UPDATE_COMPLETE_CLEANUP_IN_PROGRESS"
    toBS StackStatusUpdateInProgress = "UPDATE_IN_PROGRESS"
    toBS StackStatusUpdateRollbackComplete = "UPDATE_ROLLBACK_COMPLETE"
    toBS StackStatusUpdateRollbackCompleteCleanupInProgress = "UPDATE_ROLLBACK_COMPLETE_CLEANUP_IN_PROGRESS"
    toBS StackStatusUpdateRollbackFailed = "UPDATE_ROLLBACK_FAILED"
    toBS StackStatusUpdateRollbackInProgress = "UPDATE_ROLLBACK_IN_PROGRESS"
