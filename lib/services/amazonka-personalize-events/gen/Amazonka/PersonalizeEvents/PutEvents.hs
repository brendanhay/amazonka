...
data PutEvents = PutEvents'
  { -- | The user associated with the event.
    userId :: Prelude.Maybe (Core.Sensitive Prelude.Text),
    ...
    eventList :: Prelude.NonEmpty (Core.Sensitive Event)
  }
...
putEvents_userId = Lens.lens (\PutEvents' {userId} -> userId) (\s@PutEvents' {} a -> s {userId = a} :: PutEvents) Prelude.. Lens.mapping Core._Sensitive
    ...
    Core.object
      ( Prelude.catMaybes
          [ ("userId" Core..=) Prelude.<$> userId,
            Prelude.Just ("trackingId" Core..= trackingId),
            Prelude.Just ("sessionId" Core..= sessionId),
            Prelude.Just ("eventList" Core..= eventList)
          ]
      )
