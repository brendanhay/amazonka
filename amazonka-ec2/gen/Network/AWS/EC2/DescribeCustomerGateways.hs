...
-- Protocol (BGP) Autonomous System Number (ASN). 'customer-gateway-id' -
-- The ID of the customer gateway. 'ip-address' - The IP address of the
-- customer gateway's Internet-routable external interface. 'state' - The
-- state of the customer gateway ('pending' | 'available' | 'deleting' |
-- 'deleted'). 'type' - The type of customer gateway. Currently, the only
-- supported type is 'ipsec.1'. 'tag':/key/=/value/ - The key/value
-- combination of a tag assigned to the resource. 'tag-key' - The key of a
