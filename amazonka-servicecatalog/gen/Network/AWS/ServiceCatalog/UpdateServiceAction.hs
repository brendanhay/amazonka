...
data UpdateServiceAction = UpdateServiceAction'
  { _usaDefinition     :: !(Maybe (Map ServiceActionDefinitionKey Text))
  , _usaName           :: !(Maybe Text)
...
instance Hashable UpdateServiceAction where

instance NFData UpdateServiceAction where
...
data UpdateServiceActionResponse = UpdateServiceActionResponse'
  { _usarsServiceActionDetail :: !(Maybe ServiceActionDetail)
...
instance NFData UpdateServiceActionResponse where
