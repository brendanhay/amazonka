...
searchNetworkProfiles_sortCriteria = Lens.lens (\SearchNetworkProfiles' {sortCriteria} -> sortCriteria) (\s@SearchNetworkProfiles' {} a -> s {sortCriteria = a} :: SearchNetworkProfiles) Prelude.. Lens.mapping Prelude._Coerce
...
searchNetworkProfiles_filters = Lens.lens (\SearchNetworkProfiles' {filters} -> filters) (\s@SearchNetworkProfiles' {} a -> s {filters = a} :: SearchNetworkProfiles) Prelude.. Lens.mapping Prelude._Coerce

instance Prelude.AWSRequest SearchNetworkProfiles where
  type
...
instance Prelude.ToHeaders SearchNetworkProfiles where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AlexaForBusiness.SearchNetworkProfiles" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON SearchNetworkProfiles where
...
instance Prelude.ToPath SearchNetworkProfiles where
  toPath = Prelude.const "/"

instance Prelude.ToQuery SearchNetworkProfiles where
...
searchNetworkProfilesResponse_networkProfiles = Lens.lens (\SearchNetworkProfilesResponse' {networkProfiles} -> networkProfiles) (\s@SearchNetworkProfilesResponse' {} a -> s {networkProfiles = a} :: SearchNetworkProfilesResponse) Prelude.. Lens.mapping Prelude._Coerce
