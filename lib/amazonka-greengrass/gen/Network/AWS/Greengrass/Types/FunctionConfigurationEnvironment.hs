...
mkFunctionConfigurationEnvironment
    :: FunctionConfigurationEnvironment
mkFunctionConfigurationEnvironment
  = FunctionConfigurationEnvironment'{accessSysfs = Core.Nothing,
...
{-# INLINEABLE fceAccessSysfs #-}
{-# DEPRECATED accessSysfs "Use generic-lens or generic-optics with 'accessSysfs' instead"  #-}
...
{-# INLINEABLE fceResourceAccessPolicies #-}
{-# DEPRECATED resourceAccessPolicies "Use generic-lens or generic-optics with 'resourceAccessPolicies' instead"  #-}
...
instance Core.FromJSON FunctionConfigurationEnvironment where
        parseJSON
          = Core.withObject "FunctionConfigurationEnvironment" Core.$
              \ x ->
                FunctionConfigurationEnvironment' Core.<$>
                  (x Core..:? "AccessSysfs") Core.<*> x Core..:? "Execution" Core.<*>
                    x Core..:? "ResourceAccessPolicies"
