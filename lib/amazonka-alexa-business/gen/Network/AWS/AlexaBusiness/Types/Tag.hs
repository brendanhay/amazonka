...
import qualified Network.AWS.AlexaBusiness.Types.TagKey as Types
import qualified Network.AWS.AlexaBusiness.Types.TagValue as Types
...
tKey :: Lens.Lens' Tag Types.TagKey
tKey = Lens.field @"key"
{-# INLINEABLE tKey #-}
