...
mkParquetSerDe
    :: ParquetSerDe
mkParquetSerDe
  = ParquetSerDe'{blockSizeBytes = Core.Nothing,
                  compression = Core.Nothing,
                  enableDictionaryCompression = Core.Nothing,
                  maxPaddingBytes = Core.Nothing, pageSizeBytes = Core.Nothing,
...
{-# INLINEABLE psdEnableDictionaryCompression #-}
{-# DEPRECATED enableDictionaryCompression "Use generic-lens or generic-optics with 'enableDictionaryCompression' instead"  #-}
...
{-# INLINEABLE psdMaxPaddingBytes #-}
{-# DEPRECATED maxPaddingBytes "Use generic-lens or generic-optics with 'maxPaddingBytes' instead"  #-}
...
{-# INLINEABLE psdPageSizeBytes #-}
{-# DEPRECATED pageSizeBytes "Use generic-lens or generic-optics with 'pageSizeBytes' instead"  #-}
...
{-# INLINEABLE psdWriterVersion #-}
{-# DEPRECATED writerVersion "Use generic-lens or generic-optics with 'writerVersion' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("BlockSizeBytes" Core..=) Core.<$> blockSizeBytes,
                  ...
                  ("EnableDictionaryCompression" Core..=) Core.<$>
...
instance Core.FromJSON ParquetSerDe where
        parseJSON
          = Core.withObject "ParquetSerDe" Core.$
              \ x ->
                ParquetSerDe' Core.<$>
                  (x Core..:? "BlockSizeBytes") Core.<*> x Core..:? "Compression"
