...
mkAvailabilityZone
    :: AvailabilityZone
mkAvailabilityZone
  = AvailabilityZone'{groupName = Core.Nothing,
                      messages = Core.Nothing, networkBorderGroup = Core.Nothing,
                      optInStatus = Core.Nothing, parentZoneId = Core.Nothing,
                      parentZoneName = Core.Nothing, regionName = Core.Nothing,
                      state = Core.Nothing, zoneId = Core.Nothing,
                      zoneName = Core.Nothing, zoneType = Core.Nothing}
...
azGroupName :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
azGroupName = Lens.field @"groupName"
{-# INLINEABLE azGroupName #-}
...
azNetworkBorderGroup :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
azNetworkBorderGroup = Lens.field @"networkBorderGroup"
{-# INLINEABLE azNetworkBorderGroup #-}
...
azParentZoneId :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
azParentZoneId = Lens.field @"parentZoneId"
{-# INLINEABLE azParentZoneId #-}
{-# DEPRECATED parentZoneId "Use generic-lens or generic-optics with 'parentZoneId' instead"  #-}
...
azParentZoneName :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
azParentZoneName = Lens.field @"parentZoneName"
{-# INLINEABLE azParentZoneName #-}
{-# DEPRECATED parentZoneName "Use generic-lens or generic-optics with 'parentZoneName' instead"  #-}

-- | The name of the Region.
--
-- /Note:/ Consider using 'regionName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
azRegionName :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
azRegionName = Lens.field @"regionName"
{-# INLINEABLE azRegionName #-}
...
azZoneId :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
azZoneId = Lens.field @"zoneId"
{-# INLINEABLE azZoneId #-}
{-# DEPRECATED zoneId "Use generic-lens or generic-optics with 'zoneId' instead"  #-}
...
azZoneName :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
...
azZoneType :: Lens.Lens' AvailabilityZone (Core.Maybe Core.Text)
azZoneType = Lens.field @"zoneType"
{-# INLINEABLE azZoneType #-}
{-# DEPRECATED zoneType "Use generic-lens or generic-optics with 'zoneType' instead"  #-}

instance Core.FromXML AvailabilityZone where
        parseXML x
          = AvailabilityZone' Core.<$>
              (x Core..@? "groupName") Core.<*>
                x Core..@? "messageSet" Core..<@> Core.parseXMLList "item"
