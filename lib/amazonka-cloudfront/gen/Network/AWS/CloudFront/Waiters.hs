...
mkStreamingDistributionDeployed
  = Waiter.Wait{Waiter._waitName = "StreamingDistributionDeployed",
                Waiter._waitAttempts = 25, Waiter._waitDelay = 60,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "Deployed" Waiter.AcceptSuccess
                     (Lens.field @"streamingDistribution" Core.. Lens._Just Core..
                        Lens.field @"status")]}
...
mkDistributionDeployed
  = Waiter.Wait{Waiter._waitName = "DistributionDeployed",
                Waiter._waitAttempts = 35, Waiter._waitDelay = 60,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "Deployed" Waiter.AcceptSuccess
                     (Lens.field @"distribution" Core.. Lens._Just Core..
                        Lens.field @"status")]}
...
mkInvalidationCompleted
  = Waiter.Wait{Waiter._waitName = "InvalidationCompleted",
                Waiter._waitAttempts = 30, Waiter._waitDelay = 20,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "Completed" Waiter.AcceptSuccess
                     (Lens.field @"invalidation" Core.. Lens._Just Core..
                        Lens.field @"status")]}
