...
mkDeleteFile
    ...
    -> Types.Path -- ^ 'filePath'
    -> Types.CommitId -- ^ 'parentCommitId'
    -> DeleteFile
mkDeleteFile repositoryName branchName filePath parentCommitId
  = DeleteFile'{repositoryName, branchName, filePath, parentCommitId,
                commitMessage = Core.Nothing, email = Core.Nothing,
                keepEmptyFolders = Core.Nothing, name = Core.Nothing}
...
mkDeleteFileResponse commitId blobId treeId filePath responseStatus
  = DeleteFileResponse'{commitId, blobId, treeId, filePath,
                        responseStatus}
