...
mkListStreams
    :: ListStreams
mkListStreams
  = ListStreams'{exclusiveStartStreamName = Core.Nothing,
                 limit = Core.Nothing}
...
{-# INLINEABLE lsExclusiveStartStreamName #-}
{-# DEPRECATED exclusiveStartStreamName "Use generic-lens or generic-optics with 'exclusiveStartStreamName' instead"  #-}
...
instance Core.FromJSON ListStreams where
        toJSON ListStreams{..}
          = Core.object
              (Core.catMaybes
                 [("ExclusiveStartStreamName" Core..=) Core.<$>
          ...
          = Response.receiveJSON
              (\ s h x ->
                 ListStreamsResponse' Core.<$>
                   (x Core..:? "StreamNames" Core..!= Core.mempty) Core.<*>
                     x Core..: "HasMoreStreams"
...
instance Pager.AWSPager ListStreams where
        page rq rs
          ...
          | Core.otherwise =
            Core.Just
              (rq Core.&
                 Lens.field @"exclusiveStartStreamName" Lens..~
                   rs Lens.^? Lens.field @"streamNames" Core.. Lens._last)
...
mkListStreamsResponse hasMoreStreams responseStatus
  = ListStreamsResponse'{streamNames = Core.mempty, hasMoreStreams,
                         responseStatus}
...
{-# INLINEABLE lrsStreamNames #-}
{-# DEPRECATED streamNames "Use generic-lens or generic-optics with 'streamNames' instead"  #-}
...
{-# INLINEABLE lrsHasMoreStreams #-}
{-# DEPRECATED hasMoreStreams "Use generic-lens or generic-optics with 'hasMoreStreams' instead"  #-}
