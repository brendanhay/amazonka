...
dvsFilters :: Lens.Lens' DescribeVPCs (Lude.Maybe [Filter])
dvsFilters = Lens.lens (filters :: DescribeVPCs -> Lude.Maybe [Filter]) (\s a -> s {filters = a} :: DescribeVPCs)
{-# DEPRECATED dvsFilters "Use generic-lens or generic-optics with 'filters' instead." #-}

-- | The token for the next page of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dvsNextToken :: Lens.Lens' DescribeVPCs (Lude.Maybe Lude.Text)
dvsNextToken = Lens.lens (nextToken :: DescribeVPCs -> Lude.Maybe Lude.Text) (\s a -> s {nextToken = a} :: DescribeVPCs)
...
dvsVPCIds :: Lens.Lens' DescribeVPCs (Lude.Maybe [Lude.Text])
dvsVPCIds = Lens.lens (vpcIds :: DescribeVPCs -> Lude.Maybe [Lude.Text]) (\s a -> s {vpcIds = a} :: DescribeVPCs)
{-# DEPRECATED dvsVPCIds "Use generic-lens or generic-optics with 'vpcIds' instead." #-}

-- | Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is @DryRunOperation@ . Otherwise, it is @UnauthorizedOperation@ .
--
-- /Note:/ Consider using 'dryRun' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dvsDryRun :: Lens.Lens' DescribeVPCs (Lude.Maybe Lude.Bool)
dvsDryRun = Lens.lens (dryRun :: DescribeVPCs -> Lude.Maybe Lude.Bool) (\s a -> s {dryRun = a} :: DescribeVPCs)
...
dvsMaxResults :: Lens.Lens' DescribeVPCs (Lude.Maybe Lude.Natural)
dvsMaxResults = Lens.lens (maxResults :: DescribeVPCs -> Lude.Maybe Lude.Natural) (\s a -> s {maxResults = a} :: DescribeVPCs)
...
instance Page.AWSPager DescribeVPCs where
  page rq rs
    ...
    | Lude.otherwise =
      Lude.Just Lude.$
        rq
          Lude.& dvsNextToken Lens..~ rs Lens.^. dvrsNextToken
