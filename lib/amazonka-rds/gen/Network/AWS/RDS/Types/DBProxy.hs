...
mkDBProxy
    :: DBProxy
mkDBProxy
  = DBProxy'{auth = Core.Nothing, createdDate = Core.Nothing,
             dBProxyArn = Core.Nothing, dBProxyName = Core.Nothing,
             debugLogging = Core.Nothing, endpoint = Core.Nothing,
             engineFamily = Core.Nothing, idleClientTimeout = Core.Nothing,
             requireTLS = Core.Nothing, roleArn = Core.Nothing,
             status = Core.Nothing, updatedDate = Core.Nothing,
             vpcSecurityGroupIds = Core.Nothing, vpcSubnetIds = Core.Nothing}
...
dbpDBProxyArn :: Lens.Lens' DBProxy (Core.Maybe Core.Text)
dbpDBProxyArn = Lens.field @"dBProxyArn"
{-# INLINEABLE dbpDBProxyArn #-}
{-# DEPRECATED dBProxyArn "Use generic-lens or generic-optics with 'dBProxyArn' instead"  #-}
...
dbpDBProxyName :: Lens.Lens' DBProxy (Core.Maybe Core.Text)
dbpDBProxyName = Lens.field @"dBProxyName"
{-# INLINEABLE dbpDBProxyName #-}
...
dbpEngineFamily :: Lens.Lens' DBProxy (Core.Maybe Core.Text)
dbpEngineFamily = Lens.field @"engineFamily"
{-# INLINEABLE dbpEngineFamily #-}
...
{-# INLINEABLE dbpIdleClientTimeout #-}
...
dbpVpcSecurityGroupIds :: Lens.Lens' DBProxy (Core.Maybe [Core.Text])
dbpVpcSecurityGroupIds = Lens.field @"vpcSecurityGroupIds"
{-# INLINEABLE dbpVpcSecurityGroupIds #-}
        ...
        parseXML x
          = DBProxy' Core.<$>
              (x Core..@? "Auth" Core..<@> Core.parseXMLList "member") Core.<*>
                ...
                Core.<*>
                x Core..@? "VpcSecurityGroupIds" Core..<@>
                  Core.parseXMLList "member"
                Core.<*>
                x Core..@? "VpcSubnetIds" Core..<@> Core.parseXMLList "member"
