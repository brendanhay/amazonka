...
{-# INLINEABLE dtseaStartToCloseTimeout #-}
...
instance Core.FromJSON DecisionTaskScheduledEventAttributes where
        parseJSON
          = Core.withObject "DecisionTaskScheduledEventAttributes" Core.$
              \ x ->
                DecisionTaskScheduledEventAttributes' Core.<$>
                  (x Core..: "taskList") Core.<*> x Core..:? "startToCloseTimeout"
