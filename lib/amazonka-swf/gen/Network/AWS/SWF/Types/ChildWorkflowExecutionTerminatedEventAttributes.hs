...
mkChildWorkflowExecutionTerminatedEventAttributes
    ...
    -> ChildWorkflowExecutionTerminatedEventAttributes
mkChildWorkflowExecutionTerminatedEventAttributes workflowExecution
...
{-# INLINEABLE cweteaWorkflowExecution #-}
...
{-# INLINEABLE cweteaInitiatedEventId #-}
...
{-# INLINEABLE cweteaStartedEventId #-}
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ChildWorkflowExecutionTerminatedEventAttributes"
              Core.$
              \ x ->
                ChildWorkflowExecutionTerminatedEventAttributes' Core.<$>
