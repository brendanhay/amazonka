...
mkPutBucketWebsite
    ...
    -> Types.WebsiteConfiguration -- ^ 'websiteConfiguration'
    -> PutBucketWebsite
...
{-# INLINEABLE pbwWebsiteConfiguration #-}
{-# DEPRECATED websiteConfiguration "Use generic-lens or generic-optics with 'websiteConfiguration' instead"  #-}
...
instance Core.AWSRequest PutBucketWebsite where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull PutBucketWebsiteResponse'
