...
data ListLabelingJobsForWorkteam = ListLabelingJobsForWorkteam'
  { _lljfwJobReferenceCodeContains :: !(Maybe Text)
  , _lljfwCreationTimeAfter :: !(Maybe POSIX)
  , _lljfwNextToken :: !(Maybe Text)
  , _lljfwSortOrder :: !(Maybe SortOrder)
  , _lljfwCreationTimeBefore :: !(Maybe POSIX)
  , _lljfwMaxResults :: !(Maybe Nat)
  , _lljfwSortBy :: !(Maybe ListLabelingJobsForWorkteamSortByOptions)
...
instance AWSPager ListLabelingJobsForWorkteam where
        page rq rs
          ...
          | stop (rs ^. lljfwrsLabelingJobSummaryList) =
            Nothing
          | otherwise =
            Just $ rq & lljfwNextToken .~ rs ^. lljfwrsNextToken
...
instance Hashable ListLabelingJobsForWorkteam where

instance NFData ListLabelingJobsForWorkteam where
...
data ListLabelingJobsForWorkteamResponse = ListLabelingJobsForWorkteamResponse'
  { _lljfwrsNextToken              :: !(Maybe Text)
  , _lljfwrsResponseStatus         :: !Int
  , _lljfwrsLabelingJobSummaryList :: ![LabelingJobForWorkteamSummary]
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
