...
{-# INLINEABLE ifpsOnDemandSpecification #-}
{-# DEPRECATED onDemandSpecification "Use generic-lens or generic-optics with 'onDemandSpecification' instead"  #-}
...
{-# INLINEABLE ifpsSpotSpecification #-}
{-# DEPRECATED spotSpecification "Use generic-lens or generic-optics with 'spotSpecification' instead"  #-}

instance Core.FromJSON InstanceFleetProvisioningSpecifications
         where
...
instance Core.FromJSON InstanceFleetProvisioningSpecifications
        ...
        parseJSON
          = Core.withObject "InstanceFleetProvisioningSpecifications" Core.$
              \ x ->
                InstanceFleetProvisioningSpecifications' Core.<$>
                  (x Core..:? "OnDemandSpecification") Core.<*>
                    x Core..:? "SpotSpecification"
