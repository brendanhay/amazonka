...
-- |
-- Module      : Amazonka.DrS.DescribeLaunchConfigurationTemplates
...
--
-- 'nextToken', 'describeLaunchConfigurationTemplates_nextToken' - The token of the next Launch Configuration Template to retrieve.
newDescribeLaunchConfigurationTemplates ::
  DescribeLaunchConfigurationTemplates
newDescribeLaunchConfigurationTemplates =
  DescribeLaunchConfigurationTemplates'
...
--
-- 'nextToken', 'describeLaunchConfigurationTemplatesResponse_nextToken' - The token of the next Launch Configuration Template to retrieve.
--
