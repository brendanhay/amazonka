...
--
-- Removes the specified tags from the user. For more information about tagging, see <http://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html Tagging IAM Identities> in the /IAM User Guide/ .
--
--
module Network.AWS.IAM.UntagUser
    (
...
instance Hashable UntagUser where

instance NFData UntagUser where
...
instance NFData UntagUserResponse where
