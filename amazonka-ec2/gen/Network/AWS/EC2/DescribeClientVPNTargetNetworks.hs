...
data DescribeClientVPNTargetNetworks = DescribeClientVPNTargetNetworks'
  { _dcvtnFilters             :: !(Maybe [Filter])
  , _dcvtnNextToken           :: !(Maybe Text)
  , _dcvtnAssociationIds      :: !(Maybe [Text])
  , _dcvtnDryRun              :: !(Maybe Bool)
  , _dcvtnMaxResults          :: !(Maybe Nat)
  , _dcvtnClientVPNEndpointId :: !Text
...
--
-- * 'dcvtnFilters' - One or more filters. Filter names and values are case-sensitive.
--
...
instance AWSPager DescribeClientVPNTargetNetworks
         where
        page rq rs
          | stop (rs ^. dcvtnrsNextToken) = Nothing
          | stop (rs ^. dcvtnrsClientVPNTargetNetworks) =
            Nothing
          | otherwise =
            Just $ rq & dcvtnNextToken .~ rs ^. dcvtnrsNextToken

instance AWSRequest DescribeClientVPNTargetNetworks
         where
...
instance NFData DescribeClientVPNTargetNetworks where

instance ToHeaders DescribeClientVPNTargetNetworks
         where
...
instance ToQuery DescribeClientVPNTargetNetworks
         where
...
data DescribeClientVPNTargetNetworksResponse = DescribeClientVPNTargetNetworksResponse'
  { _dcvtnrsClientVPNTargetNetworks :: !(Maybe [TargetNetwork])
  , _dcvtnrsNextToken               :: !(Maybe Text)
  , _dcvtnrsResponseStatus          :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeClientVPNTargetNetworksResponse
    :: Int -- ^ 'dcvtnrsResponseStatus'
    -> DescribeClientVPNTargetNetworksResponse
describeClientVPNTargetNetworksResponse pResponseStatus_ =
  DescribeClientVPNTargetNetworksResponse'
    { _dcvtnrsClientVPNTargetNetworks = Nothing
