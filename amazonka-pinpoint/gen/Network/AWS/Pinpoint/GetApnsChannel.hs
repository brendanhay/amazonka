...
instance Prelude.AWSRequest GetApnsChannel where
...
instance Prelude.ToHeaders GetApnsChannel where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath GetApnsChannel where
...
instance Prelude.ToQuery GetApnsChannel where
