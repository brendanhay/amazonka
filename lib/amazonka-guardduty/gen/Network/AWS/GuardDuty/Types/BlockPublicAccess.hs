...
mkBlockPublicAccess
    :: BlockPublicAccess
mkBlockPublicAccess
  = BlockPublicAccess'{blockPublicAcls = Core.Nothing,
                       blockPublicPolicy = Core.Nothing, ignorePublicAcls = Core.Nothing,
...
{-# INLINEABLE bpaBlockPublicPolicy #-}
...
{-# INLINEABLE bpaIgnorePublicAcls #-}
...
{-# INLINEABLE bpaRestrictPublicBuckets #-}
