...
mkAdvancedFieldSelector
    :: Types.SelectorField -- ^ 'field'
    -> AdvancedFieldSelector
mkAdvancedFieldSelector field
  = AdvancedFieldSelector'{field, endsWith = Core.Nothing,
                           equals = Core.Nothing, notEndsWith = Core.Nothing,
                           notEquals = Core.Nothing, notStartsWith = Core.Nothing,
...
{-# INLINEABLE afsEndsWith #-}
{-# DEPRECATED endsWith "Use generic-lens or generic-optics with 'endsWith' instead"  #-}
...
{-# INLINEABLE afsNotEndsWith #-}
{-# DEPRECATED notEndsWith "Use generic-lens or generic-optics with 'notEndsWith' instead"  #-}
...
{-# INLINEABLE afsNotStartsWith #-}
{-# DEPRECATED notStartsWith "Use generic-lens or generic-optics with 'notStartsWith' instead"  #-}
...
{-# INLINEABLE afsStartsWith #-}
{-# DEPRECATED startsWith "Use generic-lens or generic-optics with 'startsWith' instead"  #-}
...
instance Core.FromJSON AdvancedFieldSelector where
        parseJSON
          = Core.withObject "AdvancedFieldSelector" Core.$
              \ x ->
                AdvancedFieldSelector' Core.<$>
                  (x Core..: "Field") Core.<*> x Core..:? "EndsWith" Core.<*>
                    x Core..:? "Equals"
