...
mkInstanceAggregatedAssociationOverview
    :: InstanceAggregatedAssociationOverview
mkInstanceAggregatedAssociationOverview
  = InstanceAggregatedAssociationOverview'{detailedStatus =
                                             Core.Nothing,
...
{-# INLINEABLE iaaoInstanceAssociationStatusAggregatedCount #-}
{-# DEPRECATED instanceAssociationStatusAggregatedCount "Use generic-lens or generic-optics with 'instanceAssociationStatusAggregatedCount' instead"  #-}
...
instance Core.FromJSON InstanceAggregatedAssociationOverview where
        parseJSON
          = Core.withObject "InstanceAggregatedAssociationOverview" Core.$
              \ x ->
                InstanceAggregatedAssociationOverview' Core.<$>
                  (x Core..:? "DetailedStatus") Core.<*>
                    x Core..:? "InstanceAssociationStatusAggregatedCount"
