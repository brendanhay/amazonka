...
-- |
-- Module      : Network.AWS.LexV2Models.Types.BotLocaleFilter
-- Copyright   : (c) 2013-2021 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Network.AWS.LexV2Models.Types.BotLocaleFilter where
...
instance Prelude.Hashable BotLocaleFilter

instance Prelude.NFData BotLocaleFilter
