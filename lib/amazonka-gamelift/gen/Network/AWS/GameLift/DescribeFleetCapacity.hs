...
mkDescribeFleetCapacity
    :: DescribeFleetCapacity
mkDescribeFleetCapacity
  = DescribeFleetCapacity'{fleetIds = Core.Nothing,
...
instance Core.ToHeaders DescribeFleetCapacity where
        toHeaders DescribeFleetCapacity{..}
...
instance Core.AWSRequest DescribeFleetCapacity where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeFleetCapacityResponse' Core.<$>
                   (x Core..:? "FleetCapacity") Core.<*> x Core..:? "NextToken"
...
mkDescribeFleetCapacityResponse responseStatus
  = DescribeFleetCapacityResponse'{fleetCapacity = Core.Nothing,
...
{-# INLINEABLE dfcrrsFleetCapacity #-}
{-# DEPRECATED fleetCapacity "Use generic-lens or generic-optics with 'fleetCapacity' instead"  #-}
