...
mkListGroups
    :: ListGroups
mkListGroups
  = ListGroups'{filters = Core.Nothing, maxResults = Core.Nothing,
...
instance Core.AWSRequest ListGroups where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         Core._rqMethod = Request.POST, Core._rqPath = "/groups-list",
          ...
          = Response.receiveJSON
              (\ s h x ->
                 ListGroupsResponse' Core.<$>
                   (x Core..:? "GroupIdentifiers") Core.<*> x Core..:? "Groups"
...
mkListGroupsResponse responseStatus
  = ListGroupsResponse'{groupIdentifiers = Core.Nothing,
                        groups = Core.Nothing, nextToken = Core.Nothing, responseStatus}
...
{-# INLINEABLE lgrrsGroupIdentifiers #-}
{-# DEPRECATED groupIdentifiers "Use generic-lens or generic-optics with 'groupIdentifiers' instead"  #-}
