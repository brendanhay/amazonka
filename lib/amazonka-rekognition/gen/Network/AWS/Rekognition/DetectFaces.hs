...
instance Core.AWSRequest DetectFaces where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DetectFacesResponse' Core.<$>
                   (x Core..:? "FaceDetails") Core.<*>
...
mkDetectFacesResponse responseStatus
  = DetectFacesResponse'{faceDetails = Core.Nothing,
                         orientationCorrection = Core.Nothing, responseStatus}
...
{-# INLINEABLE dfrrsFaceDetails #-}
{-# DEPRECATED faceDetails "Use generic-lens or generic-optics with 'faceDetails' instead"  #-}
...
{-# INLINEABLE dfrrsOrientationCorrection #-}
