...
mkListDeliveryStreams
    :: ListDeliveryStreams
mkListDeliveryStreams
  = ListDeliveryStreams'{deliveryStreamType = Core.Nothing,
...
{-# INLINEABLE ldsDeliveryStreamType #-}
...
{-# INLINEABLE ldsExclusiveStartDeliveryStreamName #-}
{-# DEPRECATED exclusiveStartDeliveryStreamName "Use generic-lens or generic-optics with 'exclusiveStartDeliveryStreamName' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("DeliveryStreamType" Core..=) Core.<$> deliveryStreamType,
                  ("ExclusiveStartDeliveryStreamName" Core..=) Core.<$>
...
instance Core.AWSRequest ListDeliveryStreams where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListDeliveryStreamsResponse' Core.<$>
                   (x Core..:? "DeliveryStreamNames" Core..!= Core.mempty) Core.<*>
                     x Core..: "HasMoreDeliveryStreams"
...
mkListDeliveryStreamsResponse
    :: Core.Bool -- ^ 'hasMoreDeliveryStreams'
    -> Core.Int -- ^ 'responseStatus'
    -> ListDeliveryStreamsResponse
mkListDeliveryStreamsResponse hasMoreDeliveryStreams responseStatus
  = ListDeliveryStreamsResponse'{deliveryStreamNames = Core.mempty,
                                 hasMoreDeliveryStreams, responseStatus}
...
{-# INLINEABLE ldsrrsDeliveryStreamNames #-}
{-# DEPRECATED deliveryStreamNames "Use generic-lens or generic-optics with 'deliveryStreamNames' instead"  #-}
...
{-# INLINEABLE ldsrrsHasMoreDeliveryStreams #-}
{-# DEPRECATED hasMoreDeliveryStreams "Use generic-lens or generic-optics with 'hasMoreDeliveryStreams' instead"  #-}
