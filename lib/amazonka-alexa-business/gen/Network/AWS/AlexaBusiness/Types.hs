...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "AlexaBusiness",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "a4b",
                 Core._svcVersion = "2017-11-09", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _SkillNotLinkedException #-}
...
{-# INLINEABLE _InvalidCertificateAuthorityException #-}
...
{-# INLINEABLE _DeviceNotRegisteredException #-}
...
{-# INLINEABLE _InvalidUserStatusException #-}
...
{-# INLINEABLE _InvalidServiceLinkedRoleStateException #-}
...
{-# INLINEABLE _NameInUseException #-}
...
{-# INLINEABLE _InvalidSecretsManagerResourceException #-}
