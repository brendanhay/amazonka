...
mkHlsWebdavSettings
    :: HlsWebdavSettings
mkHlsWebdavSettings
  = HlsWebdavSettings'{connectionRetryInterval = Core.Nothing,
...
{-# INLINEABLE hwsConnectionRetryInterval #-}
...
{-# INLINEABLE hwsFilecacheDuration #-}
...
{-# INLINEABLE hwsHttpTransferMode #-}
