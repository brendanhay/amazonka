...
mkCreateLogGroup logGroupName
  = CreateLogGroup'{logGroupName, kmsKeyId = Core.Nothing,
                    tags = Core.Nothing}
...
instance Core.AWSRequest CreateLogGroup where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull CreateLogGroupResponse'
