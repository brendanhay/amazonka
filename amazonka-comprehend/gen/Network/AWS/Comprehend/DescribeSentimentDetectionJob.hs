...
instance AWSRequest DescribeSentimentDetectionJob
         where
...
instance Hashable DescribeSentimentDetectionJob where

instance NFData DescribeSentimentDetectionJob where

instance ToHeaders DescribeSentimentDetectionJob
         where
        toHeaders
          = const
              (mconcat
