...
mkDescribeScalingPlans
    :: DescribeScalingPlans
mkDescribeScalingPlans
  = DescribeScalingPlans'{applicationSources = Core.Nothing,
                          maxResults = Core.Nothing, nextToken = Core.Nothing,
                          scalingPlanNames = Core.Nothing, scalingPlanVersion = Core.Nothing}
...
{-# INLINEABLE dApplicationSources #-}
{-# DEPRECATED applicationSources "Use generic-lens or generic-optics with 'applicationSources' instead"  #-}
...
{-# INLINEABLE dScalingPlanNames #-}
{-# DEPRECATED scalingPlanNames "Use generic-lens or generic-optics with 'scalingPlanNames' instead"  #-}
...
{-# INLINEABLE dScalingPlanVersion #-}
...
instance Core.ToHeaders DescribeScalingPlans where
        toHeaders DescribeScalingPlans{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeScalingPlans where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeScalingPlansResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "ScalingPlans"
...
mkDescribeScalingPlansResponse responseStatus
  = DescribeScalingPlansResponse'{nextToken = Core.Nothing,
                                  scalingPlans = Core.Nothing, responseStatus}
...
{-# INLINEABLE drsScalingPlans #-}
{-# DEPRECATED scalingPlans "Use generic-lens or generic-optics with 'scalingPlans' instead"  #-}
