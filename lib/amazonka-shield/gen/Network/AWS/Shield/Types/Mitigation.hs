...
mMitigationName :: Lens.Lens' Mitigation (Core.Maybe Core.Text)
mMitigationName = Lens.field @"mitigationName"
{-# INLINEABLE mMitigationName #-}
{-# DEPRECATED mitigationName "Use generic-lens or generic-optics with 'mitigationName' instead"  #-}
