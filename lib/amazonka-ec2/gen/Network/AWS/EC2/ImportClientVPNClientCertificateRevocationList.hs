...
instance AWSRequest ImportClientVPNClientCertificateRevocationList where
  type
...
instance Hashable ImportClientVPNClientCertificateRevocationList

instance NFData ImportClientVPNClientCertificateRevocationList

instance ToHeaders ImportClientVPNClientCertificateRevocationList where
  toHeaders = const mempty

instance ToPath ImportClientVPNClientCertificateRevocationList where
  toPath = const "/"

instance ToQuery ImportClientVPNClientCertificateRevocationList where
  toQuery ImportClientVPNClientCertificateRevocationList' {..} =
    mconcat
      [ "Action"
          =: ("ImportClientVpnClientCertificateRevocationList" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        "DryRun" =: _icvccrlDryRun,
        "ClientVpnEndpointId" =: _icvccrlClientVPNEndpointId,
        "CertificateRevocationList" =: _icvccrlCertificateRevocationList
      ]
