...
-- or AmazonProvidedDNS. The default DHCP option set specifies
...
-- If you're using AmazonProvidedDNS in us-east-1, specify ec2.internal. If
-- you're using AmazonProvidedDNS in another region, specify
-- region.compute.internal (for example, ap-northeast-1.compute.internal).
-- Otherwise, specify a domain name (for example, MyCompany.com). If
-- specifying more than one domain name, separate them with spaces.
...
-- <http://www.ietf.org/rfc/rfc2132.txt RFC 2132>. Your VPC automatically
