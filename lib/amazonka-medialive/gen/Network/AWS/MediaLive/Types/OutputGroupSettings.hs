...
mkOutputGroupSettings
    :: OutputGroupSettings
mkOutputGroupSettings
  = OutputGroupSettings'{archiveGroupSettings = Core.Nothing,
                         ...
                         rtmpGroupSettings = Core.Nothing, udpGroupSettings = Core.Nothing}
...
{-# INLINEABLE ogsArchiveGroupSettings #-}
{-# DEPRECATED archiveGroupSettings "Use generic-lens or generic-optics with 'archiveGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsFrameCaptureGroupSettings #-}
{-# DEPRECATED frameCaptureGroupSettings "Use generic-lens or generic-optics with 'frameCaptureGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsMediaPackageGroupSettings #-}
{-# DEPRECATED mediaPackageGroupSettings "Use generic-lens or generic-optics with 'mediaPackageGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsMultiplexGroupSettings #-}
{-# DEPRECATED multiplexGroupSettings "Use generic-lens or generic-optics with 'multiplexGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsRtmpGroupSettings #-}
{-# DEPRECATED rtmpGroupSettings "Use generic-lens or generic-optics with 'rtmpGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsUdpGroupSettings #-}
{-# DEPRECATED udpGroupSettings "Use generic-lens or generic-optics with 'udpGroupSettings' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("archiveGroupSettings" Core..=) Core.<$> archiveGroupSettings,
                  ("frameCaptureGroupSettings" Core..=) Core.<$>
                    frameCaptureGroupSettings,
                  ("hlsGroupSettings" Core..=) Core.<$> hlsGroupSettings,
                  ("mediaPackageGroupSettings" Core..=) Core.<$>
          ...
          = Core.withObject "OutputGroupSettings" Core.$
              \ x ->
                OutputGroupSettings' Core.<$>
                  (x Core..:? "archiveGroupSettings") Core.<*>
                    x Core..:? "frameCaptureGroupSettings"
