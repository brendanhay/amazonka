...
pearlvfValue :: Lens.Lens' Phase2EncryptionAlgorithmsRequestListValue (Core.Maybe Core.Text)
pearlvfValue = Lens.field @"value"
{-# INLINEABLE pearlvfValue #-}
{-# DEPRECATED value "Use generic-lens or generic-optics with 'value' instead"  #-}

instance Core.ToQuery Phase2EncryptionAlgorithmsRequestListValue
         where
