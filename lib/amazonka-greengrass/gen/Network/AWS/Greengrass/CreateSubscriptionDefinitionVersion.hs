...
mkCreateSubscriptionDefinitionVersion subscriptionDefinitionId
  = CreateSubscriptionDefinitionVersion'{subscriptionDefinitionId,
...
{-# INLINEABLE csdvSubscriptionDefinitionId #-}
...
{-# INLINEABLE csdvAmznClientToken #-}
...
{-# INLINEABLE csdvSubscriptions #-}
{-# DEPRECATED subscriptions "Use generic-lens or generic-optics with 'subscriptions' instead"  #-}

instance Core.ToQuery CreateSubscriptionDefinitionVersion where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders CreateSubscriptionDefinitionVersion where
...
instance Core.AWSRequest CreateSubscriptionDefinitionVersion where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateSubscriptionDefinitionVersionResponse' Core.<$>
...
mkCreateSubscriptionDefinitionVersionResponse responseStatus
  = CreateSubscriptionDefinitionVersionResponse'{arn = Core.Nothing,
...
{-# INLINEABLE csdvrrsCreationTimestamp #-}
...
{-# INLINEABLE csdvrrsResponseStatus #-}
