...
mkCacheNode
    :: CacheNode
mkCacheNode
  = CacheNode'{cacheNodeCreateTime = Core.Nothing,
               cacheNodeId = Core.Nothing, cacheNodeStatus = Core.Nothing,
               customerAvailabilityZone = Core.Nothing,
               customerOutpostArn = Core.Nothing, endpoint = Core.Nothing,
...
{-# INLINEABLE cnCacheNodeCreateTime #-}
...
cnCacheNodeId :: Lens.Lens' CacheNode (Core.Maybe Core.Text)
cnCacheNodeId = Lens.field @"cacheNodeId"
{-# INLINEABLE cnCacheNodeId #-}
...
cnCacheNodeStatus :: Lens.Lens' CacheNode (Core.Maybe Core.Text)
cnCacheNodeStatus = Lens.field @"cacheNodeStatus"
{-# INLINEABLE cnCacheNodeStatus #-}
{-# DEPRECATED cacheNodeStatus "Use generic-lens or generic-optics with 'cacheNodeStatus' instead"  #-}
...
cnCustomerAvailabilityZone :: Lens.Lens' CacheNode (Core.Maybe Core.Text)
cnCustomerAvailabilityZone = Lens.field @"customerAvailabilityZone"
{-# INLINEABLE cnCustomerAvailabilityZone #-}
{-# DEPRECATED customerAvailabilityZone "Use generic-lens or generic-optics with 'customerAvailabilityZone' instead"  #-}
...
cnCustomerOutpostArn :: Lens.Lens' CacheNode (Core.Maybe Core.Text)
cnCustomerOutpostArn = Lens.field @"customerOutpostArn"
{-# INLINEABLE cnCustomerOutpostArn #-}
{-# DEPRECATED customerOutpostArn "Use generic-lens or generic-optics with 'customerOutpostArn' instead"  #-}
...
cnParameterGroupStatus :: Lens.Lens' CacheNode (Core.Maybe Core.Text)
cnParameterGroupStatus = Lens.field @"parameterGroupStatus"
{-# INLINEABLE cnParameterGroupStatus #-}
...
cnSourceCacheNodeId :: Lens.Lens' CacheNode (Core.Maybe Core.Text)
cnSourceCacheNodeId = Lens.field @"sourceCacheNodeId"
{-# INLINEABLE cnSourceCacheNodeId #-}
{-# DEPRECATED sourceCacheNodeId "Use generic-lens or generic-optics with 'sourceCacheNodeId' instead"  #-}

instance Core.FromXML CacheNode where
        parseXML x
          = CacheNode' Core.<$>
              (x Core..@? "CacheNodeCreateTime") Core.<*>
                x Core..@? "CacheNodeId"
