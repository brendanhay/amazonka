...
mkWorkspaceAccessProperties
    :: WorkspaceAccessProperties
mkWorkspaceAccessProperties
  = WorkspaceAccessProperties'{deviceTypeAndroid = Core.Nothing,
                               deviceTypeChromeOs = Core.Nothing, deviceTypeIos = Core.Nothing,
                               deviceTypeOsx = Core.Nothing, deviceTypeWeb = Core.Nothing,
...
{-# INLINEABLE wapDeviceTypeAndroid #-}
{-# DEPRECATED deviceTypeAndroid "Use generic-lens or generic-optics with 'deviceTypeAndroid' instead"  #-}
...
{-# INLINEABLE wapDeviceTypeChromeOs #-}
{-# DEPRECATED deviceTypeChromeOs "Use generic-lens or generic-optics with 'deviceTypeChromeOs' instead"  #-}
...
{-# INLINEABLE wapDeviceTypeIos #-}
{-# DEPRECATED deviceTypeIos "Use generic-lens or generic-optics with 'deviceTypeIos' instead"  #-}
...
{-# INLINEABLE wapDeviceTypeOsx #-}
{-# DEPRECATED deviceTypeOsx "Use generic-lens or generic-optics with 'deviceTypeOsx' instead"  #-}
...
{-# INLINEABLE wapDeviceTypeWeb #-}
{-# DEPRECATED deviceTypeWeb "Use generic-lens or generic-optics with 'deviceTypeWeb' instead"  #-}
...
{-# INLINEABLE wapDeviceTypeWindows #-}
{-# DEPRECATED deviceTypeWindows "Use generic-lens or generic-optics with 'deviceTypeWindows' instead"  #-}
...
{-# INLINEABLE wapDeviceTypeZeroClient #-}
{-# DEPRECATED deviceTypeZeroClient "Use generic-lens or generic-optics with 'deviceTypeZeroClient' instead"  #-}
...
instance Core.FromJSON WorkspaceAccessProperties where
        parseJSON
          = Core.withObject "WorkspaceAccessProperties" Core.$
              \ x ->
                WorkspaceAccessProperties' Core.<$>
                  (x Core..:? "DeviceTypeAndroid") Core.<*>
                    x Core..:? "DeviceTypeChromeOs"
