...
data PendingMaintenanceAction = PendingMaintenanceAction'
  { -- | The date when the maintenance action is automatically applied.
    ...
    forcedApplyDate :: Prelude.Maybe Prelude.ISO8601,
    ...
    autoAppliedAfterDate :: Prelude.Maybe Prelude.ISO8601,
    ...
    -- @ForcedApplyDate@.
    currentApplyDate :: Prelude.Maybe Prelude.ISO8601,
...
instance Prelude.FromXML PendingMaintenanceAction where
  parseXML x =
    PendingMaintenanceAction'
