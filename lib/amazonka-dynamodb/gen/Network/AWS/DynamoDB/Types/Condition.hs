...
mkCondition ::
  ...
  ComparisonOperator ->
  Condition
mkCondition pComparisonOperator_ =
  Condition'
...
cAttributeValueList :: Lens.Lens' Condition (Lude.Maybe [AttributeValue])
cAttributeValueList = Lens.lens (attributeValueList :: Condition -> Lude.Maybe [AttributeValue]) (\s a -> s {attributeValueList = a} :: Condition)
...
cComparisonOperator :: Lens.Lens' Condition ComparisonOperator
cComparisonOperator = Lens.lens (comparisonOperator :: Condition -> ComparisonOperator) (\s a -> s {comparisonOperator = a} :: Condition)
