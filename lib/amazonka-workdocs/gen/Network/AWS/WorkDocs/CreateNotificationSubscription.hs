...
instance AWSRequest CreateNotificationSubscription where
  type
...
instance ToHeaders CreateNotificationSubscription where
  toHeaders =
    const
      ( mconcat
...
instance NFData CreateNotificationSubscriptionResponse
