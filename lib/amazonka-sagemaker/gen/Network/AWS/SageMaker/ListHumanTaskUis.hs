...
instance Core.AWSRequest ListHumanTaskUis where
  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "SageMaker.ListHumanTaskUis")
  ...
  response =
    Response.receiveJSON
      ( \s h x ->
          ListHumanTaskUisResponse'
            Core.<$> (x Core..:? "HumanTaskUiSummaries" Core..!= Core.mempty)
...
{-# DEPRECATED lhturrsHumanTaskUiSummaries "Use generic-lens or generic-optics with 'humanTaskUiSummaries' instead." #-}
...
{-# DEPRECATED lhturrsNextToken "Use generic-lens or generic-optics with 'nextToken' instead." #-}
...
{-# DEPRECATED lhturrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
