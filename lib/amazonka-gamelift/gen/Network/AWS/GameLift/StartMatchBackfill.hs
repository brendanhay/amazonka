...
mkStartMatchBackfill ::
  -- | 'configurationName'
  Types.MatchmakingConfigurationName ->
  StartMatchBackfill
  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "GameLift.StartMatchBackfill")
...
{-# DEPRECATED smbrrsMatchmakingTicket "Use generic-lens or generic-optics with 'matchmakingTicket' instead." #-}
