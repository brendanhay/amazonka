...
mkSplitShard
    ...
    -> Types.ShardToSplit -- ^ 'shardToSplit'
    -> Types.HashKey -- ^ 'newStartingHashKey'
    -> SplitShard
...
{-# INLINEABLE ssShardToSplit #-}
{-# DEPRECATED shardToSplit "Use generic-lens or generic-optics with 'shardToSplit' instead"  #-}
...
{-# INLINEABLE ssNewStartingHashKey #-}
{-# DEPRECATED newStartingHashKey "Use generic-lens or generic-optics with 'newStartingHashKey' instead"  #-}

instance Core.ToQuery SplitShard where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders SplitShard where
        toHeaders SplitShard{..}
          = Core.pure ("X-Amz-Target", "Kinesis_20131202.SplitShard") Core.<>
...
instance Core.AWSRequest SplitShard where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull SplitShardResponse'
