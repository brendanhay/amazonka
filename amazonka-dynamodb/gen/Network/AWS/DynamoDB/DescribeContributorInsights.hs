    ...
    Response.receiveJSON
      ( \s h x ->
          DescribeContributorInsightsResponse'
            ...
            Prelude.<*> (x Prelude..?> "FailureException")
            Prelude.<*> ( x Prelude..?> "ContributorInsightsRuleList"
                            Prelude..!@ Prelude.mempty
                        )
            Prelude.<*> (x Prelude..?> "LastUpdateDateTime")
...
instance
  ...
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "DynamoDB_20120810.DescribeContributorInsights" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON DescribeContributorInsights where
...
instance Prelude.ToPath DescribeContributorInsights where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DescribeContributorInsights where
...
data DescribeContributorInsightsResponse = DescribeContributorInsightsResponse'
  { -- | The name of the table being described.
    ...
    lastUpdateDateTime :: Prelude.Maybe Prelude.POSIX,
...
describeContributorInsightsResponse_lastUpdateDateTime = Lens.lens (\DescribeContributorInsightsResponse' {lastUpdateDateTime} -> lastUpdateDateTime) (\s@DescribeContributorInsightsResponse' {} a -> s {lastUpdateDateTime = a} :: DescribeContributorInsightsResponse) Prelude.. Lens.mapping Prelude._Time
