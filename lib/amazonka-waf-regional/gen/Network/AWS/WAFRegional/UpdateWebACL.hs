...
mkUpdateWebACL webACLId changeToken
  = UpdateWebACL'{webACLId, changeToken,
                  defaultAction = Core.Nothing, updates = Core.Nothing}
...
{-# INLINEABLE uwaclrrsChangeToken #-}
{-# DEPRECATED changeToken "Use generic-lens or generic-optics with 'changeToken' instead"  #-}
...
{-# INLINEABLE uwaclrrsResponseStatus #-}
