...
mkStopMultiplexResponse responseStatus
  = StopMultiplexResponse'{arn = Core.Nothing,
...
{-# INLINEABLE smrrsAvailabilityZones #-}
...
{-# INLINEABLE smrrsMultiplexSettings #-}
...
{-# INLINEABLE smrrsPipelinesRunningCount #-}
