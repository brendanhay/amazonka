...
mkGetSegmentVersions segmentId applicationId
  = GetSegmentVersions'{segmentId, applicationId,
...
instance Core.AWSRequest GetSegmentVersions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetSegmentVersionsResponse' Core.<$>
...
{-# INLINEABLE grsSegmentsResponse #-}
