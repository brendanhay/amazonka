...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Discovery",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "discovery",
                 Core._svcVersion = "2015-11-01", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _ConflictErrorException #-}
...
{-# INLINEABLE _ServerInternalErrorException #-}
