...
instance ToPath UpdateHealthCheck where
  toPath UpdateHealthCheck' {..} =
    mconcat ["/2013-04-01/healthcheck/", toBS _uhcHealthCheckId]
  ...
  toXML UpdateHealthCheck' {..} =
    mconcat
      [ "FailureThreshold" @= _uhcFailureThreshold,
        ...
        "ResetElements"
          @= toXML (toXMLList "ResettableElementName" <$> _uhcResetElements),
        "SearchString" @= _uhcSearchString,
        "HealthThreshold" @= _uhcHealthThreshold,
        "Regions" @= toXML (toXMLList "Region" <$> _uhcRegions),
        "ResourcePath" @= _uhcResourcePath,
        "InsufficientDataHealthStatus" @= _uhcInsufficientDataHealthStatus,
        ...
        "ChildHealthChecks"
          @= toXML (toXMLList "ChildHealthCheck" <$> _uhcChildHealthChecks),
        "Port" @= _uhcPort
      ]
