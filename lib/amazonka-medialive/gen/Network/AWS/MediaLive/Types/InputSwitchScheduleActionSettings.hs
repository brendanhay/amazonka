...
mkInputSwitchScheduleActionSettings
    :: Core.Text -- ^ 'inputAttachmentNameReference'
    -> InputSwitchScheduleActionSettings
mkInputSwitchScheduleActionSettings inputAttachmentNameReference
  = InputSwitchScheduleActionSettings'{inputAttachmentNameReference,
                                       inputClippingSettings = Core.Nothing, urlPath = Core.Nothing}
...
{-# INLINEABLE issasInputAttachmentNameReference #-}
...
{-# INLINEABLE issasInputClippingSettings #-}
...
instance Core.FromJSON InputSwitchScheduleActionSettings where
        parseJSON
          = Core.withObject "InputSwitchScheduleActionSettings" Core.$
              \ x ->
                InputSwitchScheduleActionSettings' Core.<$>
