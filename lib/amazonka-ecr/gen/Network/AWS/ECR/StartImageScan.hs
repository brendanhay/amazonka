...
mkStartImageScan repositoryName imageId
  = StartImageScan'{repositoryName, imageId,
...
instance Core.AWSRequest StartImageScan where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartImageScanResponse' Core.<$>
                   (x Core..:? "imageId") Core.<*> x Core..:? "imageScanStatus"
...
mkStartImageScanResponse responseStatus
  = StartImageScanResponse'{imageId = Core.Nothing,
                            imageScanStatus = Core.Nothing, registryId = Core.Nothing,
...
{-# INLINEABLE sisrrsImageScanStatus #-}
...
{-# INLINEABLE sisrrsRepositoryName #-}
{-# DEPRECATED repositoryName "Use generic-lens or generic-optics with 'repositoryName' instead"  #-}
...
{-# INLINEABLE sisrrsResponseStatus #-}
