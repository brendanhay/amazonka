...
--
-- * 'prbrsFailedPutCount' - The number of unsuccessfully written records.
--
-- * 'prbrsRequestResponses' - The results for the individual records. The index of each element matches the same index in which records were sent.
putRecordBatchResponse
