...
--
-- * 'lasNextToken' - The @nextToken@ value returned from a previous paginated @ListAccountSettings@ request where @maxResults@ was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the @nextToken@ value.
--
-- * 'lasName' - The resource name you want to list the account settings for.
--
...
--
-- * 'lasEffectiveSettings' - Specifies whether to return the effective settings. If @true@ , the account settings for the root user or the default setting for the @principalArn@ . If @false@ , the account settings for the @principalArn@ are returned if they are set. Otherwise, no account settings are returned.
--
