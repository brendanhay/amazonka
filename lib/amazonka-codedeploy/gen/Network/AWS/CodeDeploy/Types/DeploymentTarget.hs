...
mkDeploymentTarget
    :: DeploymentTarget
mkDeploymentTarget
  = DeploymentTarget'{cloudFormationTarget = Core.Nothing,
                      deploymentTargetType = Core.Nothing, ecsTarget = Core.Nothing,
                      instanceTarget = Core.Nothing, lambdaTarget = Core.Nothing}
...
{-# INLINEABLE dtCloudFormationTarget #-}
{-# DEPRECATED cloudFormationTarget "Use generic-lens or generic-optics with 'cloudFormationTarget' instead"  #-}
...
{-# INLINEABLE dtDeploymentTargetType #-}
{-# DEPRECATED deploymentTargetType "Use generic-lens or generic-optics with 'deploymentTargetType' instead"  #-}
...
{-# INLINEABLE dtEcsTarget #-}
{-# DEPRECATED ecsTarget "Use generic-lens or generic-optics with 'ecsTarget' instead"  #-}
...
{-# INLINEABLE dtInstanceTarget #-}
{-# DEPRECATED instanceTarget "Use generic-lens or generic-optics with 'instanceTarget' instead"  #-}
...
{-# INLINEABLE dtLambdaTarget #-}
{-# DEPRECATED lambdaTarget "Use generic-lens or generic-optics with 'lambdaTarget' instead"  #-}

instance Core.FromJSON DeploymentTarget where
        parseJSON
          = Core.withObject "DeploymentTarget" Core.$
              \ x ->
                DeploymentTarget' Core.<$>
                  (x Core..:? "cloudFormationTarget") Core.<*>
                    x Core..:? "deploymentTargetType"
