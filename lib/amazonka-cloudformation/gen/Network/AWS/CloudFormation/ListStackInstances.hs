...
mkListStackInstances stackSetName
  = ListStackInstances'{stackSetName, filters = Core.Nothing,
...
{-# INLINEABLE lsiStackInstanceAccount #-}
...
{-# INLINEABLE lsiStackInstanceRegion #-}
...
instance Core.ToQuery ListStackInstances where
        toQuery ListStackInstances{..}
          = Core.toQueryPair "Action" ("ListStackInstances" :: Core.Text)
              ...
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "StackInstanceAccount")
                stackInstanceAccount
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "StackInstanceRegion")
                stackInstanceRegion
...
instance Core.AWSRequest ListStackInstances where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListStackInstancesResult"
              (\ s h x ->
                 ListStackInstancesResponse' Core.<$>
...
mkListStackInstancesResponse responseStatus
  = ListStackInstancesResponse'{nextToken = Core.Nothing,
...
{-# INLINEABLE lsirrsResponseStatus #-}
