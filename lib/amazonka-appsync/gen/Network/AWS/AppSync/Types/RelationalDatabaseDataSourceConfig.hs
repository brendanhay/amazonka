...
mkRelationalDatabaseDataSourceConfig
    :: RelationalDatabaseDataSourceConfig
mkRelationalDatabaseDataSourceConfig
  = RelationalDatabaseDataSourceConfig'{rdsHttpEndpointConfig =
                                          Core.Nothing,
...
{-# INLINEABLE rddscRdsHttpEndpointConfig #-}
{-# DEPRECATED rdsHttpEndpointConfig "Use generic-lens or generic-optics with 'rdsHttpEndpointConfig' instead"  #-}
...
{-# INLINEABLE rddscRelationalDatabaseSourceType #-}
{-# DEPRECATED relationalDatabaseSourceType "Use generic-lens or generic-optics with 'relationalDatabaseSourceType' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("rdsHttpEndpointConfig" Core..=) Core.<$> rdsHttpEndpointConfig,
                  ("relationalDatabaseSourceType" Core..=) Core.<$>
...
instance Core.FromJSON RelationalDatabaseDataSourceConfig where
        parseJSON
          = Core.withObject "RelationalDatabaseDataSourceConfig" Core.$
              \ x ->
                RelationalDatabaseDataSourceConfig' Core.<$>
                  (x Core..:? "rdsHttpEndpointConfig") Core.<*>
                    x Core..:? "relationalDatabaseSourceType"
