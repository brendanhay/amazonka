...
mkStartSegmentDetectionFilters
    :: StartSegmentDetectionFilters
mkStartSegmentDetectionFilters
  = StartSegmentDetectionFilters'{shotFilter = Core.Nothing,
...
{-# INLINEABLE ssdfShotFilter #-}
{-# DEPRECATED shotFilter "Use generic-lens or generic-optics with 'shotFilter' instead"  #-}
...
{-# INLINEABLE ssdfTechnicalCueFilter #-}
{-# DEPRECATED technicalCueFilter "Use generic-lens or generic-optics with 'technicalCueFilter' instead"  #-}
