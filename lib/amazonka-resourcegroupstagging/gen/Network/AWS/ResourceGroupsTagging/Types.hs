...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "ResourceGroupsTagging",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "tagging",
                 Core._svcVersion = "2017-01-26", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _ConstraintViolationException #-}
...
{-# INLINEABLE _PaginationTokenExpiredException #-}
