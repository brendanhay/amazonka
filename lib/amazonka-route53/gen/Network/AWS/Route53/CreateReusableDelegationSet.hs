...
mkCreateReusableDelegationSet callerReference
  = CreateReusableDelegationSet'{callerReference,
...
{-# INLINEABLE crdsCallerReference #-}
...
instance Core.ToXML CreateReusableDelegationSet where
        toXML CreateReusableDelegationSet{..}
          = Core.toXMLElement "CallerReference" callerReference Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "HostedZoneId")
                hostedZoneId
        toXMLDocument
          = Core.newXMLDocument
...
instance Core.AWSRequest CreateReusableDelegationSet where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 CreateReusableDelegationSetResponse' Core.<$>
                   (x Core..@ "DelegationSet") Core.<*> Core.parseHeader "Location" h
...
mkCreateReusableDelegationSetResponse
    ...
    -> CreateReusableDelegationSetResponse
mkCreateReusableDelegationSetResponse delegationSet location
  responseStatus
  = CreateReusableDelegationSetResponse'{delegationSet, location,
                                         responseStatus}
...
{-# INLINEABLE crdsrrsDelegationSet #-}
