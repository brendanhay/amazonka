...
mkNetworkAccessConfiguration
    :: NetworkAccessConfiguration
mkNetworkAccessConfiguration
  = NetworkAccessConfiguration'{eniId = Core.Nothing,
...
nacEniId :: Lens.Lens' NetworkAccessConfiguration (Core.Maybe Core.Text)
...
nacEniPrivateIpAddress :: Lens.Lens' NetworkAccessConfiguration (Core.Maybe Core.Text)
nacEniPrivateIpAddress = Lens.field @"eniPrivateIpAddress"
{-# INLINEABLE nacEniPrivateIpAddress #-}
{-# DEPRECATED eniPrivateIpAddress "Use generic-lens or generic-optics with 'eniPrivateIpAddress' instead"  #-}

instance Core.FromJSON NetworkAccessConfiguration where
        parseJSON
          = Core.withObject "NetworkAccessConfiguration" Core.$
              \ x ->
                NetworkAccessConfiguration' Core.<$>
                  (x Core..:? "EniId") Core.<*> x Core..:? "EniPrivateIpAddress"
