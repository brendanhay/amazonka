...
mkEC2ResourceUtilization
    :: EC2ResourceUtilization
mkEC2ResourceUtilization
  = EC2ResourceUtilization'{eBSResourceUtilization = Core.Nothing,
...
{-# INLINEABLE ecruEBSResourceUtilization #-}
{-# DEPRECATED eBSResourceUtilization "Use generic-lens or generic-optics with 'eBSResourceUtilization' instead"  #-}
...
{-# INLINEABLE ecruMaxCpuUtilizationPercentage #-}
{-# DEPRECATED maxCpuUtilizationPercentage "Use generic-lens or generic-optics with 'maxCpuUtilizationPercentage' instead"  #-}
...
{-# INLINEABLE ecruMaxMemoryUtilizationPercentage #-}
{-# DEPRECATED maxMemoryUtilizationPercentage "Use generic-lens or generic-optics with 'maxMemoryUtilizationPercentage' instead"  #-}
...
{-# INLINEABLE ecruMaxStorageUtilizationPercentage #-}
{-# DEPRECATED maxStorageUtilizationPercentage "Use generic-lens or generic-optics with 'maxStorageUtilizationPercentage' instead"  #-}

instance Core.FromJSON EC2ResourceUtilization where
        parseJSON
          = Core.withObject "EC2ResourceUtilization" Core.$
              \ x ->
                EC2ResourceUtilization' Core.<$>
                  (x Core..:? "EBSResourceUtilization") Core.<*>
                    x Core..:? "MaxCpuUtilizationPercentage"
