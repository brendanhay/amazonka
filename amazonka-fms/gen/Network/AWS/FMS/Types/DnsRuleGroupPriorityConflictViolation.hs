...
-- |
-- Module      : Network.AWS.FMS.Types.DnsRuleGroupPriorityConflictViolation
-- Copyright   : (c) 2013-2021 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Network.AWS.FMS.Types.DnsRuleGroupPriorityConflictViolation where
...
dnsRuleGroupPriorityConflictViolation_unavailablePriorities = Lens.lens (\DnsRuleGroupPriorityConflictViolation' {unavailablePriorities} -> unavailablePriorities) (\s@DnsRuleGroupPriorityConflictViolation' {} a -> s {unavailablePriorities = a} :: DnsRuleGroupPriorityConflictViolation) Prelude.. Lens.mapping Lens._Coerce
