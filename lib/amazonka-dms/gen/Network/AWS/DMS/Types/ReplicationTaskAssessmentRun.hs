...
data ReplicationTaskAssessmentRun = ReplicationTaskAssessmentRun'
  { -- | Assessment run status.
    ...
    replicationTaskAssessmentRunCreationDate :: Lude.Maybe Lude.Timestamp,
    -- | Indication of the completion progress for the individual assessments specified to run.
    assessmentProgress :: Lude.Maybe ReplicationTaskAssessmentRunProgress,
    ...
    resultLocationBucket :: Lude.Maybe Lude.Text,
