...
mkInstanceMetadataOptionsResponse
    :: InstanceMetadataOptionsResponse
mkInstanceMetadataOptionsResponse
  = InstanceMetadataOptionsResponse'{httpEndpoint = Core.Nothing,
...
{-# INLINEABLE imorHttpPutResponseHopLimit #-}
