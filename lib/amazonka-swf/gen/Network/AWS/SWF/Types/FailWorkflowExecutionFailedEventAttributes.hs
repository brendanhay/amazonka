...
mkFailWorkflowExecutionFailedEventAttributes
    :: Types.FailWorkflowExecutionFailedCause -- ^ 'cause'
    -> Core.Integer -- ^ 'decisionTaskCompletedEventId'
    -> FailWorkflowExecutionFailedEventAttributes
mkFailWorkflowExecutionFailedEventAttributes cause
  decisionTaskCompletedEventId
  = FailWorkflowExecutionFailedEventAttributes'{cause,
                                                decisionTaskCompletedEventId}
...
{-# INLINEABLE fwefeaDecisionTaskCompletedEventId #-}
{-# DEPRECATED decisionTaskCompletedEventId "Use generic-lens or generic-optics with 'decisionTaskCompletedEventId' instead"  #-}

instance Core.FromJSON FailWorkflowExecutionFailedEventAttributes
         where
        parseJSON
          = Core.withObject "FailWorkflowExecutionFailedEventAttributes"
              Core.$
              \ x ->
                FailWorkflowExecutionFailedEventAttributes' Core.<$>
                  (x Core..: "cause") Core.<*>
