...
mkArtifactDetails
    :: Core.Natural -- ^ 'minimumCount'
    -> Core.Natural -- ^ 'maximumCount'
    -> ArtifactDetails
...
{-# INLINEABLE adMinimumCount #-}
{-# DEPRECATED minimumCount "Use generic-lens or generic-optics with 'minimumCount' instead"  #-}
...
{-# INLINEABLE adMaximumCount #-}
{-# DEPRECATED maximumCount "Use generic-lens or generic-optics with 'maximumCount' instead"  #-}
...
instance Core.FromJSON ArtifactDetails where
        parseJSON
          = Core.withObject "ArtifactDetails" Core.$
              \ x ->
                ArtifactDetails' Core.<$>
                  (x Core..: "minimumCount") Core.<*> x Core..: "maximumCount"
