...
-- |
-- Module      : Amazonka.EMR.Types.ErrorDetail
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.EMR.Types.ErrorDetail where
...
data ErrorDetail = ErrorDetail'
  { -- | The name or code associated with the error.
    ...
    -- an error occured.
    errorData :: Prelude.Maybe [Prelude.HashMap Prelude.Text Prelude.Text],
...
--
-- 'errorCode', 'errorDetail_errorCode' - The name or code associated with the error.
--
-- 'errorData', 'errorDetail_errorData' - A list of key value pairs that provides contextual information about why
-- an error occured.
--
-- 'errorMessage', 'errorDetail_errorMessage' - A message that describes the error.
newErrorDetail ::
  ErrorDetail
newErrorDetail =
  ErrorDetail'
...
-- | A list of key value pairs that provides contextual information about why
-- an error occured.
errorDetail_errorData :: Lens.Lens' ErrorDetail (Prelude.Maybe [Prelude.HashMap Prelude.Text Prelude.Text])
errorDetail_errorData = Lens.lens (\ErrorDetail' {errorData} -> errorData) (\s@ErrorDetail' {} a -> s {errorData = a} :: ErrorDetail) Prelude.. Lens.mapping Lens.coerced
    ...
    Data.withObject
      ...
      ( \x ->
          ErrorDetail'
            ...
            Prelude.<*> (x Data..:? "ErrorData" Data..!= Prelude.mempty)
...
instance Prelude.NFData ErrorDetail where
  rnf ErrorDetail' {..} =
    Prelude.rnf errorCode
      `Prelude.seq` Prelude.rnf errorData
