...
mkListAttachedGroupPolicies groupName
  = ListAttachedGroupPolicies'{groupName, marker = Core.Nothing,
...
instance Core.ToQuery ListAttachedGroupPolicies where
        toQuery ListAttachedGroupPolicies{..}
          = Core.toQueryPair "Action"
              ("ListAttachedGroupPolicies" :: Core.Text)
...
instance Core.AWSRequest ListAttachedGroupPolicies where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListAttachedGroupPoliciesResult"
              (\ s h x ->
                 ListAttachedGroupPoliciesResponse' Core.<$>
...
{-# INLINEABLE lagprrsAttachedPolicies #-}
...
{-# INLINEABLE lagprrsResponseStatus #-}
