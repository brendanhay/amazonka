...
mkReservation
    :: Reservation
mkReservation
  = Reservation'{arn = Core.Nothing, count = Core.Nothing,
                 currencyCode = Core.Nothing, duration = Core.Nothing,
                 durationUnits = Core.Nothing, end = Core.Nothing,
                 fixedPrice = Core.Nothing, name = Core.Nothing,
...
{-# INLINEABLE rOfferingDescription #-}
...
{-# INLINEABLE rResourceSpecification #-}
