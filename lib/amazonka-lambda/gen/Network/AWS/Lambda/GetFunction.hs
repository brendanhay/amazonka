          ...
          = Response.receiveJSON
              (\ s h x ->
                 GetFunctionResponse' Core.<$>
                   (x Core..:? "Code") Core.<*> x Core..:? "Concurrency" Core.<*>
...
mkGetFunctionResponse responseStatus
  = GetFunctionResponse'{code = Core.Nothing,
                         concurrency = Core.Nothing, configuration = Core.Nothing,
