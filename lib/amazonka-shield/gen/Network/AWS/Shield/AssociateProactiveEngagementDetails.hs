...
mkAssociateProactiveEngagementDetails
    :: AssociateProactiveEngagementDetails
mkAssociateProactiveEngagementDetails
  = AssociateProactiveEngagementDetails'{emergencyContactList =
                                           Core.mempty}
...
{-# INLINEABLE apedEmergencyContactList #-}
{-# DEPRECATED emergencyContactList "Use generic-lens or generic-optics with 'emergencyContactList' instead"  #-}

instance Core.ToQuery AssociateProactiveEngagementDetails where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders AssociateProactiveEngagementDetails where
        toHeaders AssociateProactiveEngagementDetails{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest AssociateProactiveEngagementDetails where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 AssociateProactiveEngagementDetailsResponse' Core.<$>
...
{-# INLINEABLE apedrrsResponseStatus #-}
