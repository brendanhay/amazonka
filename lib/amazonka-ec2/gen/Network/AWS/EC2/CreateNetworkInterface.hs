...
instance ToQuery CreateNetworkInterface where
  toQuery CreateNetworkInterface' {..} =
    mconcat
      [ "Action" =: ("CreateNetworkInterface" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        toQuery (toQueryList "SecurityGroupId" <$> _cniGroups),
        toQuery
          (toQueryList "PrivateIpAddresses" <$> _cniPrivateIPAddresses),
        "InterfaceType" =: _cniInterfaceType,
        toQuery (toQueryList "TagSpecification" <$> _cniTagSpecifications),
        ...
        "DryRun" =: _cniDryRun,
        toQuery (toQueryList "Ipv6Addresses" <$> _cniIPv6Addresses),
