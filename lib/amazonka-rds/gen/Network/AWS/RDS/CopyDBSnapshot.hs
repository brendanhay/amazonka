...
mkCopyDBSnapshot
    :: Core.Text -- ^ 'sourceDBSnapshotIdentifier'
    -> Core.Text -- ^ 'targetDBSnapshotIdentifier'
    -> CopyDBSnapshot
mkCopyDBSnapshot sourceDBSnapshotIdentifier
  targetDBSnapshotIdentifier
  = CopyDBSnapshot'{sourceDBSnapshotIdentifier,
                    targetDBSnapshotIdentifier, copyTags = Core.Nothing,
                    kmsKeyId = Core.Nothing, optionGroupName = Core.Nothing,
                    preSignedUrl = Core.Nothing, tags = Core.Nothing,
...
cdbsSourceDBSnapshotIdentifier :: Lens.Lens' CopyDBSnapshot Core.Text
cdbsSourceDBSnapshotIdentifier = Lens.field @"sourceDBSnapshotIdentifier"
{-# INLINEABLE cdbsSourceDBSnapshotIdentifier #-}
...
cdbsTargetDBSnapshotIdentifier :: Lens.Lens' CopyDBSnapshot Core.Text
cdbsTargetDBSnapshotIdentifier = Lens.field @"targetDBSnapshotIdentifier"
{-# INLINEABLE cdbsTargetDBSnapshotIdentifier #-}
{-# DEPRECATED targetDBSnapshotIdentifier "Use generic-lens or generic-optics with 'targetDBSnapshotIdentifier' instead"  #-}
...
cdbsKmsKeyId :: Lens.Lens' CopyDBSnapshot (Core.Maybe Core.Text)
cdbsKmsKeyId = Lens.field @"kmsKeyId"
{-# INLINEABLE cdbsKmsKeyId #-}
...
cdbsOptionGroupName :: Lens.Lens' CopyDBSnapshot (Core.Maybe Core.Text)
cdbsOptionGroupName = Lens.field @"optionGroupName"
{-# INLINEABLE cdbsOptionGroupName #-}
...
cdbsPreSignedUrl :: Lens.Lens' CopyDBSnapshot (Core.Maybe Core.Text)
cdbsPreSignedUrl = Lens.field @"preSignedUrl"
{-# INLINEABLE cdbsPreSignedUrl #-}
...
cdbsTargetCustomAvailabilityZone :: Lens.Lens' CopyDBSnapshot (Core.Maybe Core.Text)
cdbsTargetCustomAvailabilityZone = Lens.field @"targetCustomAvailabilityZone"
{-# INLINEABLE cdbsTargetCustomAvailabilityZone #-}
{-# DEPRECATED targetCustomAvailabilityZone "Use generic-lens or generic-optics with 'targetCustomAvailabilityZone' instead"  #-}

instance Core.ToQuery CopyDBSnapshot where
        toQuery CopyDBSnapshot{..}
          = Core.toQueryPair "Action" ("CopyDBSnapshot" :: Core.Text) Core.<>
              Core.toQueryPair "Version" ("2014-10-31" :: Core.Text)
              Core.<>
              Core.toQueryPair "SourceDBSnapshotIdentifier"
                sourceDBSnapshotIdentifier
              Core.<>
              Core.toQueryPair "TargetDBSnapshotIdentifier"
                targetDBSnapshotIdentifier
              Core.<>
              ...
              Core.maybe Core.mempty
                (Core.toQueryPair "TargetCustomAvailabilityZone")
...
instance Core.AWSRequest CopyDBSnapshot where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "CopyDBSnapshotResult"
              (\ s h x ->
                 CopyDBSnapshotResponse' Core.<$>
...
mkCopyDBSnapshotResponse responseStatus
  = CopyDBSnapshotResponse'{dBSnapshot = Core.Nothing,
                            responseStatus}
...
{-# INLINEABLE cdbsrrsResponseStatus #-}
