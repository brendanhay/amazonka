...
-- |
-- Module      : Network.AWS.Kendra.Types.DataSourceSyncJob
-- Copyright   : (c) 2013-2021 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Network.AWS.Kendra.Types.DataSourceSyncJob where
...
-- by a data source connector.
--
-- 'startTime', 'dataSourceSyncJob_startTime' - The UNIX datetime that the synchronization job was started.
--
-- 'endTime', 'dataSourceSyncJob_endTime' - The UNIX datetime that the synchronization job was completed.
--
-- 'errorCode', 'dataSourceSyncJob_errorCode' - If the @Status@ field is set to @FAILED@, the @ErrorCode@ field contains
-- a the reason that the synchronization failed.
--
...
newDataSourceSyncJob =
  DataSourceSyncJob'
    { status = Prelude.Nothing,
      ...
      dataSourceErrorCode = Prelude.Nothing,
...
instance Prelude.Hashable DataSourceSyncJob

instance Prelude.NFData DataSourceSyncJob
