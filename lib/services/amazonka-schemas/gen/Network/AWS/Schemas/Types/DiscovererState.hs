...
-- |
-- Module      : Network.AWS.Schemas.Types.DiscovererState
...
pattern DiscovererState_STARTED = DiscovererState' "STARTED"

pattern DiscovererState_STOPPED :: DiscovererState
pattern DiscovererState_STOPPED = DiscovererState' "STOPPED"
