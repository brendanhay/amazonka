...
dspPolicyName :: Lens.Lens' DeleteScalingPolicy Lude.Text
dspPolicyName = Lens.lens (policyName :: DeleteScalingPolicy -> Lude.Text) (\s a -> s {policyName = a} :: DeleteScalingPolicy)
...
dspServiceNamespace :: Lens.Lens' DeleteScalingPolicy ServiceNamespace
dspServiceNamespace = Lens.lens (serviceNamespace :: DeleteScalingPolicy -> ServiceNamespace) (\s a -> s {serviceNamespace = a} :: DeleteScalingPolicy)
...
dspResourceId :: Lens.Lens' DeleteScalingPolicy Lude.Text
dspResourceId = Lens.lens (resourceId :: DeleteScalingPolicy -> Lude.Text) (\s a -> s {resourceId = a} :: DeleteScalingPolicy)
...
dspScalableDimension :: Lens.Lens' DeleteScalingPolicy ScalableDimension
dspScalableDimension = Lens.lens (scalableDimension :: DeleteScalingPolicy -> ScalableDimension) (\s a -> s {scalableDimension = a} :: DeleteScalingPolicy)
