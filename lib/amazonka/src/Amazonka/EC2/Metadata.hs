...
--
-- __NOTE__: this function is deprecated as it is unreliable. It will be removed
-- in the next major version (@v2.2@). Please comment on
-- [#1033](https://github.com/brendanhay/amazonka/issues/1033) if you think you
-- need it.
