...
data DescribeStorageResponse = DescribeStorageResponse'
  { _dsrsTotalProvisionedStorageInMegaBytes :: !(Maybe Double)
  , _dsrsTotalBackupSizeInMegaBytes         :: !(Maybe Double)
...
describeStorageResponse pResponseStatus_ =
  DescribeStorageResponse'
    { _dsrsTotalProvisionedStorageInMegaBytes = Nothing
