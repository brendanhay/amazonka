...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "DAX", Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "dax", Core._svcVersion = "2017-04-19",
...
{-# INLINEABLE _SubnetQuotaExceededFault #-}
...
{-# INLINEABLE _ParameterGroupNotFoundFault #-}
...
{-# INLINEABLE _InvalidParameterGroupStateFault #-}
...
{-# INLINEABLE _SubnetGroupInUseFault #-}
...
{-# INLINEABLE _ParameterGroupAlreadyExistsFault #-}
...
{-# INLINEABLE _ParameterGroupQuotaExceededFault #-}
...
{-# INLINEABLE _SubnetGroupNotFoundFault #-}
...
{-# INLINEABLE _SubnetGroupAlreadyExistsFault #-}
...
{-# INLINEABLE _SubnetGroupQuotaExceededFault #-}
