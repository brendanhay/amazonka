...
_InvalidAttachmentException =
    _MatchServiceError cloudDirectory "InvalidAttachmentException" .
    hasStatus 400
...
_FacetValidationException =
    _MatchServiceError cloudDirectory "FacetValidationException" .
    hasStatus 400
...
_InternalServiceException =
    _MatchServiceError cloudDirectory "InternalServiceException" .
    hasStatus 500
...
_DirectoryDeletedException =
    _MatchServiceError cloudDirectory "DirectoryDeletedException" .
    hasStatus 400
...
_RetryableConflictException =
    _MatchServiceError cloudDirectory "RetryableConflictException" .
    hasStatus 409
...
_ResourceNotFoundException =
    _MatchServiceError cloudDirectory "ResourceNotFoundException" .
    hasStatus 404
...
_ObjectNotDetachedException =
    _MatchServiceError cloudDirectory "ObjectNotDetachedException" .
    hasStatus 400
