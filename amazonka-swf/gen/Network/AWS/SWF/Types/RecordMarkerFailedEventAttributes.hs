...
-- | The marker\'s name.
recordMarkerFailedEventAttributes_markerName :: Lens.Lens' RecordMarkerFailedEventAttributes Core.Text
...
-- this cancellation request. This information can be useful for diagnosing
-- problems by tracing back the chain of events leading up to this event.
recordMarkerFailedEventAttributes_decisionTaskCompletedEventId :: Lens.Lens' RecordMarkerFailedEventAttributes Core.Integer
