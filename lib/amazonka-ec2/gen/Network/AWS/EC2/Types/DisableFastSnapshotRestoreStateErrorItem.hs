...
dfsrseiAvailabilityZone :: Lens.Lens' DisableFastSnapshotRestoreStateErrorItem (Core.Maybe Core.Text)
dfsrseiAvailabilityZone = Lens.field @"availabilityZone"
{-# INLINEABLE dfsrseiAvailabilityZone #-}
...
{-# INLINEABLE dfsrseiError #-}
{-# DEPRECATED error "Use generic-lens or generic-optics with 'error' instead"  #-}

instance Core.FromXML DisableFastSnapshotRestoreStateErrorItem
         where
        parseXML x
          = DisableFastSnapshotRestoreStateErrorItem' Core.<$>
