...
mkStaticImageDeactivateScheduleActionSettings
    :: StaticImageDeactivateScheduleActionSettings
mkStaticImageDeactivateScheduleActionSettings
  = StaticImageDeactivateScheduleActionSettings'{fadeOut =
                                                   Core.Nothing,
                                                 layer = Core.Nothing}
...
{-# INLINEABLE sidsasLayer #-}
{-# DEPRECATED layer "Use generic-lens or generic-optics with 'layer' instead"  #-}

instance Core.FromJSON StaticImageDeactivateScheduleActionSettings
         where
...
instance Core.FromJSON StaticImageDeactivateScheduleActionSettings
         where
        parseJSON
          = Core.withObject "StaticImageDeactivateScheduleActionSettings"
              Core.$
              \ x ->
                StaticImageDeactivateScheduleActionSettings' Core.<$>
                  (x Core..:? "fadeOut") Core.<*> x Core..:? "layer"
