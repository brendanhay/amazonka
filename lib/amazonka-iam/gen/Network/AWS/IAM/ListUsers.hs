...
mkListUsers
    :: ListUsers
mkListUsers
  = ListUsers'{marker = Core.Nothing, maxItems = Core.Nothing,
...
instance Core.AWSRequest ListUsers where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListUsersResult"
              (\ s h x ->
...
mkListUsersResponse responseStatus
  = ListUsersResponse'{users = Core.mempty,
