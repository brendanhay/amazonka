...
instance Hashable DeleteLoggingConfiguration where

instance NFData DeleteLoggingConfiguration where
...
instance ToJSON DeleteLoggingConfiguration where
        toJSON DeleteLoggingConfiguration'{..}
          = object
              (catMaybes [Just ("ResourceArn" .= _dlcResourceARN)])
...
deleteLoggingConfigurationResponse pResponseStatus_ =
  DeleteLoggingConfigurationResponse' {_dlcrsResponseStatus = pResponseStatus_}
