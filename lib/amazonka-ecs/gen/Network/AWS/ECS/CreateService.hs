...
csfServiceName :: Lens.Lens' CreateService Types.String
...
csfClientToken :: Lens.Lens' CreateService (Core.Maybe Types.String)
...
csfCluster :: Lens.Lens' CreateService (Core.Maybe Types.String)
...
csfPlatformVersion :: Lens.Lens' CreateService (Core.Maybe Types.String)
...
csfRole :: Lens.Lens' CreateService (Core.Maybe Types.String)
...
csfTaskDefinition :: Lens.Lens' CreateService (Core.Maybe Types.String)
