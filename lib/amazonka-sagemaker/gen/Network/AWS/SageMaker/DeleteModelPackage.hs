...
mkDeleteModelPackage
    :: Types.VersionedArnOrName -- ^ 'modelPackageName'
    -> DeleteModelPackage
...
{-# INLINEABLE dmpModelPackageName #-}
...
instance Core.AWSRequest DeleteModelPackage where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull DeleteModelPackageResponse'
