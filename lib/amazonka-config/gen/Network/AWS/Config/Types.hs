...
import Network.AWS.Config.Types.ErrorMessage
...
import Network.AWS.Config.Types.FailureMessage
...
import Network.AWS.Config.Types.LastErrorCode
import Network.AWS.Config.Types.LastErrorMessage
...
import Network.AWS.Config.Types.String
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "Config",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "config",
      Core._svcVersion = "2014-11-12",
