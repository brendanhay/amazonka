...
importExportService :: Lude.Service
importExportService =
  Lude.Service
    { Lude._svcAbbrev = "ImportExport",
      Lude._svcSigner = Sign.v2,
      Lude._svcPrefix = "importexport",
      Lude._svcVersion = "2010-06-01",
      Lude._svcEndpoint = Lude.defaultEndpoint importExportService,
      Lude._svcTimeout = Lude.Just 70,
      Lude._svcCheck = Lude.statusSuccess,
      Lude._svcError = Lude.parseXMLError "ImportExport",
