...
mkRepositoryNameIdPair
    :: RepositoryNameIdPair
mkRepositoryNameIdPair
  = RepositoryNameIdPair'{repositoryId = Core.Nothing,
...
instance Core.FromJSON RepositoryNameIdPair where
        parseJSON
          = Core.withObject "RepositoryNameIdPair" Core.$
              \ x ->
                RepositoryNameIdPair' Core.<$>
                  (x Core..:? "repositoryId") Core.<*> x Core..:? "repositoryName"
