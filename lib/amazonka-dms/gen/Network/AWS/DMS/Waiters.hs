...
mkReplicationInstanceAvailable
  = Waiter.Wait{Waiter._waitName = "ReplicationInstanceAvailable",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 60,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationInstances" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"replicationInstanceStatus" Core.. Lens._Just),
                     ...
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationInstances" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"replicationInstanceStatus" Core.. Lens._Just),
                   Waiter.matchAny "incompatible-credentials" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationInstances" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"replicationInstanceStatus" Core.. Lens._Just),
                   Waiter.matchAny "incompatible-network" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationInstances" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"replicationInstanceStatus" Core.. Lens._Just),
                   Waiter.matchAny "inaccessible-encryption-credentials"
...
mkReplicationTaskDeleted
  = Waiter.Wait{Waiter._waitName = "ReplicationTaskDeleted",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAny "ready" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                     ...
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"status" Core.. Lens._Just),
                   Waiter.matchAny "running" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkReplicationTaskReady
  = Waiter.Wait{Waiter._waitName = "ReplicationTaskReady",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                     ...
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"status" Core.. Lens._Just),
                   Waiter.matchAny "starting" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                     ...
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"status" Core.. Lens._Just),
                   Waiter.matchAny "testing" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkReplicationInstanceDeleted
  = Waiter.Wait{Waiter._waitName = "ReplicationInstanceDeleted",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAny "available" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationInstances" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkEndpointDeleted
  = Waiter.Wait{Waiter._waitName = "EndpointDeleted",
                ...
                Waiter._waitAcceptors =
                  [Waiter.matchError "ResourceNotFoundFault" Waiter.AcceptSuccess,
                   Waiter.matchAny "active" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"endpoints" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"status" Core.. Lens._Just),
                   Waiter.matchAny "creating" Waiter.AcceptFailure
                     (Lens.folding
...
mkReplicationTaskStopped
  = Waiter.Wait{Waiter._waitName = "ReplicationTaskStopped",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
...
mkReplicationTaskRunning
  = Waiter.Wait{Waiter._waitName = "ReplicationTaskRunning",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
...
mkTestConnectionSucceeds
  = Waiter.Wait{Waiter._waitName = "TestConnectionSucceeds",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 5,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "successful" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"connections" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"status" Core.. Lens._Just),
                   Waiter.matchAny "failed" Waiter.AcceptFailure
                     (Lens.folding
