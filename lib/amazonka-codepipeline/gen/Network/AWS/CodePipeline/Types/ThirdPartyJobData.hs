...
mkThirdPartyJobData
    :: ThirdPartyJobData
mkThirdPartyJobData
  = ThirdPartyJobData'{actionConfiguration = Core.Nothing,
...
{-# INLINEABLE tpjdActionConfiguration #-}
...
{-# INLINEABLE tpjdArtifactCredentials #-}
...
{-# INLINEABLE tpjdContinuationToken #-}
...
{-# INLINEABLE tpjdOutputArtifacts #-}
...
{-# INLINEABLE tpjdPipelineContext #-}
