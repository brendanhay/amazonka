...
mkLoadBalancerAttributes
    :: LoadBalancerAttributes
mkLoadBalancerAttributes
  = LoadBalancerAttributes'{accessLog = Core.Nothing,
...
{-# INLINEABLE lbaAccessLog #-}
{-# DEPRECATED accessLog "Use generic-lens or generic-optics with 'accessLog' instead"  #-}
...
{-# INLINEABLE lbaAdditionalAttributes #-}
{-# DEPRECATED additionalAttributes "Use generic-lens or generic-optics with 'additionalAttributes' instead"  #-}
...
{-# INLINEABLE lbaConnectionDraining #-}
{-# DEPRECATED connectionDraining "Use generic-lens or generic-optics with 'connectionDraining' instead"  #-}
...
{-# INLINEABLE lbaConnectionSettings #-}
{-# DEPRECATED connectionSettings "Use generic-lens or generic-optics with 'connectionSettings' instead"  #-}
...
{-# INLINEABLE lbaCrossZoneLoadBalancing #-}
{-# DEPRECATED crossZoneLoadBalancing "Use generic-lens or generic-optics with 'crossZoneLoadBalancing' instead"  #-}

instance Core.ToQuery LoadBalancerAttributes where
        toQuery LoadBalancerAttributes{..}
          = Core.maybe Core.mempty (Core.toQueryPair "AccessLog") accessLog
              Core.<>
              Core.toQueryPair "AdditionalAttributes"
                (Core.maybe Core.mempty (Core.toQueryList "member")
                   additionalAttributes)
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "ConnectionDraining")
                connectionDraining
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "ConnectionSettings")
                connectionSettings
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "CrossZoneLoadBalancing")
                crossZoneLoadBalancing

instance Core.FromXML LoadBalancerAttributes where
        parseXML x
          = LoadBalancerAttributes' Core.<$>
              (x Core..@? "AccessLog") Core.<*>
                x Core..@? "AdditionalAttributes" Core..<@>
