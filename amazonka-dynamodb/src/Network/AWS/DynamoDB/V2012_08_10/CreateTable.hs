...
-- } }.
module Network.AWS.DynamoDB.V2012_08_10.CreateTable where
...
createTable :: [AttributeDefinition] -- ^ '_ctiAttributeDefinitions'
            -> [KeySchemaElement] -- ^ '_ctiKeySchema'
            -> ProvisionedThroughput -- ^ '_ctiProvisionedThroughput'
            -> Text -- ^ '_ctiTableName'
            -> CreateTable
...
makeLenses ''CreateTableResponse
