...
-- |
-- Module      : Network.AWS.DataBrew.Types.EncryptionMode
...
pattern EncryptionMode_SSE_KMS = EncryptionMode' "SSE-KMS"

pattern EncryptionMode_SSE_S3 :: EncryptionMode
pattern EncryptionMode_SSE_S3 = EncryptionMode' "SSE-S3"
