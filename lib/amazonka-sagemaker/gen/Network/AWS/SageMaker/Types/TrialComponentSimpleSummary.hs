...
mkTrialComponentSimpleSummary
    :: TrialComponentSimpleSummary
mkTrialComponentSimpleSummary
  = TrialComponentSimpleSummary'{createdBy = Core.Nothing,
                                 creationTime = Core.Nothing, trialComponentArn = Core.Nothing,
...
{-# INLINEABLE tcssTrialComponentArn #-}
...
{-# INLINEABLE tcssTrialComponentName #-}
...
{-# INLINEABLE tcssTrialComponentSource #-}
...
instance Core.FromJSON TrialComponentSimpleSummary where
        parseJSON
          = Core.withObject "TrialComponentSimpleSummary" Core.$
              \ x ->
                TrialComponentSimpleSummary' Core.<$>
