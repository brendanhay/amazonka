...
mkUpdateDomainContact domainName
  = UpdateDomainContact'{domainName, adminContact = Core.Nothing,
                         registrantContact = Core.Nothing, techContact = Core.Nothing}
...
{-# INLINEABLE udcRegistrantContact #-}
...
instance Core.AWSRequest UpdateDomainContact where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateDomainContactResponse' Core.<$>
