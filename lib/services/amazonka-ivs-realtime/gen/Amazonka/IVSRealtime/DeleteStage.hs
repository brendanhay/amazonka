...
-- |
-- Module      : Amazonka.IVSRealtime.DeleteStage
...
--
-- 'arn', 'deleteStage_arn' - ARN of the stage to be deleted.
newDeleteStage ::
  -- | 'arn'
  Prelude.Text ->
  DeleteStage
newDeleteStage pArn_ = DeleteStage' {arn = pArn_}

-- | ARN of the stage to be deleted.
deleteStage_arn :: Lens.Lens' DeleteStage Prelude.Text
deleteStage_arn = Lens.lens (\DeleteStage' {arn} -> arn) (\s@DeleteStage' {} a -> s {arn = a} :: DeleteStage)
...
instance Prelude.NFData DeleteStage where
  rnf DeleteStage' {..} = Prelude.rnf arn
...
instance Data.ToJSON DeleteStage where
  toJSON DeleteStage' {..} =
    Data.object
      ( Prelude.catMaybes
...
instance Data.ToPath DeleteStage where
  toPath = Prelude.const "/DeleteStage"
