...
mkContactMethod
    :: ContactMethod
mkContactMethod
  = ContactMethod'{arn = Core.Nothing,
                   contactEndpoint = Core.Nothing, createdAt = Core.Nothing,
                   location = Core.Nothing, name = Core.Nothing,
                   protocol = Core.Nothing, resourceType = Core.Nothing,
                   status = Core.Nothing, supportCode = Core.Nothing}
...
cmSupportCode :: Lens.Lens' ContactMethod (Core.Maybe Core.Text)
cmSupportCode = Lens.field @"supportCode"
{-# INLINEABLE cmSupportCode #-}
...
instance Core.FromJSON ContactMethod where
        parseJSON
          = Core.withObject "ContactMethod" Core.$
              \ x ->
                ContactMethod' Core.<$>
                  (x Core..:? "arn") Core.<*> x Core..:? "contactEndpoint" Core.<*>
                    x Core..:? "createdAt"
