...
mkUpdateSmsChannel
    ...
    -> Types.SMSChannelRequest -- ^ 'sMSChannelRequest'
    -> UpdateSmsChannel
...
{-# INLINEABLE uscSMSChannelRequest #-}
{-# DEPRECATED sMSChannelRequest "Use generic-lens or generic-optics with 'sMSChannelRequest' instead"  #-}
...
{-# INLINEABLE uscrrsSMSChannelResponse #-}
