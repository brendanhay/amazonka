...
mkNetworkInputSettings
    :: NetworkInputSettings
mkNetworkInputSettings
  = NetworkInputSettings'{hlsInputSettings = Core.Nothing,
...
{-# INLINEABLE nisHlsInputSettings #-}
{-# DEPRECATED hlsInputSettings "Use generic-lens or generic-optics with 'hlsInputSettings' instead"  #-}
...
{-# INLINEABLE nisServerValidation #-}
{-# DEPRECATED serverValidation "Use generic-lens or generic-optics with 'serverValidation' instead"  #-}
          ...
          = Core.withObject "NetworkInputSettings" Core.$
              \ x ->
                NetworkInputSettings' Core.<$>
                  (x Core..:? "hlsInputSettings") Core.<*>
                    x Core..:? "serverValidation"
