...
mkMaintenanceWindowLambdaParameters
    :: MaintenanceWindowLambdaParameters
mkMaintenanceWindowLambdaParameters
  = MaintenanceWindowLambdaParameters'{clientContext = Core.Nothing,
                                       payload = Core.Nothing, qualifier = Core.Nothing}
...
instance Core.FromJSON MaintenanceWindowLambdaParameters where
        parseJSON
          = Core.withObject "MaintenanceWindowLambdaParameters" Core.$
              \ x ->
                MaintenanceWindowLambdaParameters' Core.<$>
                  (x Core..:? "ClientContext") Core.<*> x Core..:? "Payload" Core.<*>
                    x Core..:? "Qualifier"
