...
mkConfigurationRecorder
    :: ConfigurationRecorder
mkConfigurationRecorder
  = ConfigurationRecorder'{name = Core.Nothing,
                           recordingGroup = Core.Nothing, roleARN = Core.Nothing}
...
{-# INLINEABLE crRecordingGroup #-}
{-# DEPRECATED recordingGroup "Use generic-lens or generic-optics with 'recordingGroup' instead"  #-}

-- | Amazon Resource Name (ARN) of the IAM role used to describe the AWS resources associated with the account.
--
-- /Note:/ Consider using 'roleARN' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
crRoleARN :: Lens.Lens' ConfigurationRecorder (Core.Maybe Core.Text)
crRoleARN = Lens.field @"roleARN"
{-# INLINEABLE crRoleARN #-}
...
instance Core.FromJSON ConfigurationRecorder where
        parseJSON
          = Core.withObject "ConfigurationRecorder" Core.$
              \ x ->
                ConfigurationRecorder' Core.<$>
                  (x Core..:? "name") Core.<*> x Core..:? "recordingGroup" Core.<*>
                    x Core..:? "roleARN"
