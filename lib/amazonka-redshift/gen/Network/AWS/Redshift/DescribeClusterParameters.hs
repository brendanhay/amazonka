...
dcpsParameterGroupName :: Lens.Lens' DescribeClusterParameters Core.Text
dcpsParameterGroupName = Lens.field @"parameterGroupName"
{-# INLINEABLE dcpsParameterGroupName #-}
...
dcpsMarker :: Lens.Lens' DescribeClusterParameters (Core.Maybe Core.Text)
dcpsMarker = Lens.field @"marker"
{-# INLINEABLE dcpsMarker #-}
...
dcpsSource :: Lens.Lens' DescribeClusterParameters (Core.Maybe Core.Text)
dcpsSource = Lens.field @"source"
{-# INLINEABLE dcpsSource #-}
...
instance Core.ToQuery DescribeClusterParameters where
        toQuery DescribeClusterParameters{..}
          = Core.toQueryPair "Action"
              ("DescribeClusterParameters" :: Core.Text)
...
instance Core.AWSRequest DescribeClusterParameters where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "DescribeClusterParametersResult"
              (\ s h x ->
                 DescribeClusterParametersResponse' Core.<$>
                   (x Core..@? "Marker") Core.<*>
...
mkDescribeClusterParametersResponse responseStatus
  = DescribeClusterParametersResponse'{marker = Core.Nothing,
                                       parameters = Core.Nothing, responseStatus}

-- | A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned marker value in the @Marker@ parameter and retrying the command. If the @Marker@ field is empty, all response records have been retrieved for the request. 
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dcprrsMarker :: Lens.Lens' DescribeClusterParametersResponse (Core.Maybe Core.Text)
