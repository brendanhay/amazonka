...
mkGeoLocation
    :: GeoLocation
mkGeoLocation
  = GeoLocation'{continentCode = Core.Nothing,
...
instance Core.ToXML GeoLocation where
        toXML GeoLocation{..}
          = Core.maybe Core.mempty (Core.toXMLElement "ContinentCode")
              continentCode
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "CountryCode")
                countryCode
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "SubdivisionCode")
                subdivisionCode

instance Core.FromXML GeoLocation where
        parseXML x
          = GeoLocation' Core.<$>
              (x Core..@? "ContinentCode") Core.<*> x Core..@? "CountryCode"
