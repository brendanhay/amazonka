...
mkMappingRule
    :: Types.Claim -- ^ 'claim'
    -> Types.MappingRuleMatchType -- ^ 'matchType'
    -> Types.Value -- ^ 'value'
...
{-# INLINEABLE mrClaim #-}
{-# DEPRECATED claim "Use generic-lens or generic-optics with 'claim' instead"  #-}
...
{-# INLINEABLE mrMatchType #-}
{-# DEPRECATED matchType "Use generic-lens or generic-optics with 'matchType' instead"  #-}
...
instance Core.FromJSON MappingRule where
        parseJSON
          = Core.withObject "MappingRule" Core.$
              \ x ->
                MappingRule' Core.<$>
                  (x Core..: "Claim") Core.<*> x Core..: "MatchType" Core.<*>
                    x Core..: "Value"
                    Core.<*> x Core..: "RoleARN"
