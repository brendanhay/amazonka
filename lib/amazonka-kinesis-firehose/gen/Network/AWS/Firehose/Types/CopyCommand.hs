...
mkCopyCommand
    :: Types.DataTableName -- ^ 'dataTableName'
    -> CopyCommand
mkCopyCommand dataTableName
  = CopyCommand'{dataTableName, copyOptions = Core.Nothing,
...
{-# INLINEABLE ccDataTableName #-}
{-# DEPRECATED dataTableName "Use generic-lens or generic-optics with 'dataTableName' instead"  #-}
...
{-# INLINEABLE ccDataTableColumns #-}
{-# DEPRECATED dataTableColumns "Use generic-lens or generic-optics with 'dataTableColumns' instead"  #-}
...
instance Core.FromJSON CopyCommand where
        parseJSON
          = Core.withObject "CopyCommand" Core.$
              \ x ->
                CopyCommand' Core.<$>
                  (x Core..: "DataTableName") Core.<*> x Core..:? "CopyOptions"
