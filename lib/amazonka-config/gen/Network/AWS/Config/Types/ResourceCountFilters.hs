...
mkResourceCountFilters
    :: ResourceCountFilters
mkResourceCountFilters
  = ResourceCountFilters'{accountId = Core.Nothing,
                          region = Core.Nothing, resourceType = Core.Nothing}
