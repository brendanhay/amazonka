...
-- |
-- Module      : Amazonka.RDS.Types.ActivityStreamMode
...
pattern ActivityStreamMode_Async = ActivityStreamMode' "async"

pattern ActivityStreamMode_Sync :: ActivityStreamMode
pattern ActivityStreamMode_Sync = ActivityStreamMode' "sync"
