...
mkContentRedaction
    :: Types.RedactionType -- ^ 'redactionType'
    -> Types.RedactionOutput -- ^ 'redactionOutput'
    -> ContentRedaction
...
{-# INLINEABLE crRedactionType #-}
{-# DEPRECATED redactionType "Use generic-lens or generic-optics with 'redactionType' instead"  #-}
...
{-# INLINEABLE crRedactionOutput #-}
{-# DEPRECATED redactionOutput "Use generic-lens or generic-optics with 'redactionOutput' instead"  #-}
          ...
          = Core.withObject "ContentRedaction" Core.$
              \ x ->
                ContentRedaction' Core.<$>
                  (x Core..: "RedactionType") Core.<*> x Core..: "RedactionOutput"
