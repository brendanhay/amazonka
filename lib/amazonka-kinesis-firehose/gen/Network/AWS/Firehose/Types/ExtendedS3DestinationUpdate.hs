...
mkExtendedS3DestinationUpdate
    :: ExtendedS3DestinationUpdate
mkExtendedS3DestinationUpdate
  = ExtendedS3DestinationUpdate'{bucketARN = Core.Nothing,
                                 ...
                                 processingConfiguration = Core.Nothing, roleARN = Core.Nothing,
                                 s3BackupMode = Core.Nothing, s3BackupUpdate = Core.Nothing}
...
{-# INLINEABLE esduCloudWatchLoggingOptions #-}
...
{-# INLINEABLE esduCompressionFormat #-}
...
{-# INLINEABLE esduDataFormatConversionConfiguration #-}
...
{-# INLINEABLE esduEncryptionConfiguration #-}
...
{-# INLINEABLE esduErrorOutputPrefix #-}
...
{-# INLINEABLE esduProcessingConfiguration #-}
...
{-# INLINEABLE esduS3BackupUpdate #-}
{-# DEPRECATED s3BackupUpdate "Use generic-lens or generic-optics with 's3BackupUpdate' instead"  #-}
