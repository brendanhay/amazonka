...
mkDeleteScalingPolicy
    :: Types.ResourceIdMaxLen1600 -- ^ 'policyName'
    -> Types.ServiceNamespace -- ^ 'serviceNamespace'
    -> Types.ResourceIdMaxLen1600 -- ^ 'resourceId'
    -> Types.ScalableDimension -- ^ 'scalableDimension'
    -> DeleteScalingPolicy
mkDeleteScalingPolicy policyName serviceNamespace resourceId
  scalableDimension
  = DeleteScalingPolicy'{policyName, serviceNamespace, resourceId,
                         scalableDimension}
...
{-# INLINEABLE dspServiceNamespace #-}
...
{-# INLINEABLE dspScalableDimension #-}
...
instance Core.AWSRequest DeleteScalingPolicy where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 DeleteScalingPolicyResponse' Core.<$>
