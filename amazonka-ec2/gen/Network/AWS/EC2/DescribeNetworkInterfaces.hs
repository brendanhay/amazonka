...
-- the network interface. addresses.association.public-ip - The association ID
...
-- IP address. association.allocation-id - The allocation ID returned when you
...
-- attached | detaching | detached). attachment.attach.time - The time that
...
-- of the network interface. group-id - The ID of a security group associated
-- with the network interface. group-name - The name of a security group
-- associated with the network interface. mac-address - The MAC address of the
-- network interface. network-interface-id - The ID of the network interface.
-- owner-id - The AWS account ID of the network interface owner.
-- private-ip-address - The private IP address or addresses of the network
-- interface. private-dns-name - The private DNS name of the network
-- interface. requester-id - The ID of the entity that launched the instance
-- on your behalf (for example, AWS Management Console, Auto Scaling, and so
-- on). requester-managed - Indicates whether the network interface is being
...
-- (NAT) in your VPC. status - The status of the network interface. If the
-- network interface is not attached to an instance, the status is available;
-- if a network interface is attached to an instance the status is in-use.
-- subnet-id - The ID of the subnet for the network interface. tag:key=value -
