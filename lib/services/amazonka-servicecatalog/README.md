...
`2.0` - Derived from API version @2015-12-10@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.ServiceCatalog](http://hackage.haskell.org/package/amazonka-servicecatalog/docs/Amazonka-ServiceCatalog.html)
