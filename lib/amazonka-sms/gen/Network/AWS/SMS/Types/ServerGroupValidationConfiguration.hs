...
mkServerGroupValidationConfiguration
    :: ServerGroupValidationConfiguration
mkServerGroupValidationConfiguration
  = ServerGroupValidationConfiguration'{serverGroupId = Core.Nothing,
...
{-# INLINEABLE sgvcServerValidationConfigurations #-}
{-# DEPRECATED serverValidationConfigurations "Use generic-lens or generic-optics with 'serverValidationConfigurations' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("serverGroupId" Core..=) Core.<$> serverGroupId,
                  ("serverValidationConfigurations" Core..=) Core.<$>
...
instance Core.FromJSON ServerGroupValidationConfiguration where
        parseJSON
          = Core.withObject "ServerGroupValidationConfiguration" Core.$
              \ x ->
                ServerGroupValidationConfiguration' Core.<$>
                  (x Core..:? "serverGroupId") Core.<*>
                    x Core..:? "serverValidationConfigurations"
