...
-- Specify either @CustomerManagedPolicyReference@ to use the name and path
-- of a customer managed policy, or @ManagedPolicyArn@ to use the ARN of an
-- Amazon Web Services managed policy. A permissions boundary represents
-- the maximum permissions that any policy can grant your role. For more
-- information, see
...
--
-- 'managedPolicyArn', 'permissionsBoundary_managedPolicyArn' - The Amazon Web Services managed policy ARN that you want to attach to a
-- permission set as a permissions boundary.
--
