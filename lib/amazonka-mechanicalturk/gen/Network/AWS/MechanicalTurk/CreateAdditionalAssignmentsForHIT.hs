...
mkCreateAdditionalAssignmentsForHIT
    :: Types.HITId -- ^ 'hITId'
    -> Core.Int -- ^ 'numberOfAdditionalAssignments'
    -> CreateAdditionalAssignmentsForHIT
mkCreateAdditionalAssignmentsForHIT hITId
  numberOfAdditionalAssignments
  = CreateAdditionalAssignmentsForHIT'{hITId,
                                       numberOfAdditionalAssignments,
...
{-# INLINEABLE caafhitNumberOfAdditionalAssignments #-}
{-# DEPRECATED numberOfAdditionalAssignments "Use generic-lens or generic-optics with 'numberOfAdditionalAssignments' instead"  #-}
...
{-# INLINEABLE caafhitUniqueRequestToken #-}
{-# DEPRECATED uniqueRequestToken "Use generic-lens or generic-optics with 'uniqueRequestToken' instead"  #-}

instance Core.ToQuery CreateAdditionalAssignmentsForHIT where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders CreateAdditionalAssignmentsForHIT where
        toHeaders CreateAdditionalAssignmentsForHIT{..}
          = Core.pure
              ("X-Amz-Target",
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("HITId" Core..= hITId),
                  Core.Just
                    ("NumberOfAdditionalAssignments" Core..=
                       numberOfAdditionalAssignments),
...
instance Core.AWSRequest CreateAdditionalAssignmentsForHIT where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 CreateAdditionalAssignmentsForHITResponse' Core.<$>
...
{-# INLINEABLE caafhitrrsResponseStatus #-}
