...
mkDeleteStack stackName
  = DeleteStack'{stackName, clientRequestToken = Core.Nothing,
                 retainResources = Core.Nothing, roleARN = Core.Nothing}
...
{-# INLINEABLE dsClientRequestToken #-}
...
{-# INLINEABLE dsRetainResources #-}
{-# DEPRECATED retainResources "Use generic-lens or generic-optics with 'retainResources' instead"  #-}
...
instance Core.ToQuery DeleteStack where
        toQuery DeleteStack{..}
          = Core.toQueryPair "Action" ("DeleteStack" :: Core.Text) Core.<>
              ...
              Core.maybe Core.mempty (Core.toQueryPair "ClientRequestToken")
                clientRequestToken
              Core.<>
              Core.toQueryPair "RetainResources"
