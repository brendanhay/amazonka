...
mkDeregisterStreamConsumer
    :: DeregisterStreamConsumer
mkDeregisterStreamConsumer
  = DeregisterStreamConsumer'{consumerARN = Core.Nothing,
...
instance Core.ToHeaders DeregisterStreamConsumer where
        toHeaders DeregisterStreamConsumer{..}
          = Core.pure
