...
instance AWSRequest DeleteModelPackage where
        type Rs DeleteModelPackage =
             DeleteModelPackageResponse
        request = postJSON sageMaker
        response = receiveNull DeleteModelPackageResponse'

instance Hashable DeleteModelPackage where

instance NFData DeleteModelPackage where
...
data DeleteModelPackageResponse =
  DeleteModelPackageResponse'
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
instance NFData DeleteModelPackageResponse where
