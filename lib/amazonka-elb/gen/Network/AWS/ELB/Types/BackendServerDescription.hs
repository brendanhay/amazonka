...
mkBackendServerDescription
    :: BackendServerDescription
mkBackendServerDescription
  = BackendServerDescription'{instancePort = Core.Nothing,
...
instance Core.FromXML BackendServerDescription where
        parseXML x
          = BackendServerDescription' Core.<$>
              (x Core..@? "InstancePort") Core.<*>
