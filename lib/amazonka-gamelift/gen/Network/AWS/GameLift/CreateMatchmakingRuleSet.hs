...
instance Core.AWSRequest CreateMatchmakingRuleSet where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateMatchmakingRuleSetResponse' Core.<$>
                   (x Core..: "RuleSet") Core.<*> Core.pure (Core.fromEnum s))
...
mkCreateMatchmakingRuleSetResponse
    :: Types.MatchmakingRuleSet -- ^ 'ruleSet'
...
{-# INLINEABLE cmrsrrsRuleSet #-}
{-# DEPRECATED ruleSet "Use generic-lens or generic-optics with 'ruleSet' instead"  #-}
...
{-# INLINEABLE cmrsrrsResponseStatus #-}
