...
mkListHandshakesForAccount
    :: ListHandshakesForAccount
mkListHandshakesForAccount
  = ListHandshakesForAccount'{filter = Core.Nothing,
...
instance Core.ToHeaders ListHandshakesForAccount where
        toHeaders ListHandshakesForAccount{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest ListHandshakesForAccount where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListHandshakesForAccountResponse' Core.<$>
...
mkListHandshakesForAccountResponse responseStatus
  = ListHandshakesForAccountResponse'{handshakes = Core.Nothing,
...
{-# INLINEABLE lhfarrsResponseStatus #-}
