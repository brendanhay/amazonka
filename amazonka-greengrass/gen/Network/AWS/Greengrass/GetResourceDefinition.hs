...
instance Prelude.AWSRequest GetResourceDefinition where
  type
...
instance Prelude.ToHeaders GetResourceDefinition where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath GetResourceDefinition where
...
instance Prelude.ToQuery GetResourceDefinition where
...
getResourceDefinitionResponse_tags = Lens.lens (\GetResourceDefinitionResponse' {tags} -> tags) (\s@GetResourceDefinitionResponse' {} a -> s {tags = a} :: GetResourceDefinitionResponse) Prelude.. Lens.mapping Prelude._Coerce
