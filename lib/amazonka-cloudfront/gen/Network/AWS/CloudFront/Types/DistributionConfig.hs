...
mkDistributionConfig
    ...
    -> Core.Bool -- ^ 'enabled'
    -> DistributionConfig
mkDistributionConfig callerReference origins defaultCacheBehavior
  comment enabled
  = DistributionConfig'{callerReference, origins,
                        defaultCacheBehavior, comment, enabled, aliases = Core.Nothing,
                        cacheBehaviors = Core.Nothing, customErrorResponses = Core.Nothing,
                        defaultRootObject = Core.Nothing, httpVersion = Core.Nothing,
                        isIPV6Enabled = Core.Nothing, logging = Core.Nothing,
                        originGroups = Core.Nothing, priceClass = Core.Nothing,
                        restrictions = Core.Nothing, viewerCertificate = Core.Nothing,
...
dcCallerReference :: Lens.Lens' DistributionConfig Core.Text
dcCallerReference = Lens.field @"callerReference"
{-# INLINEABLE dcCallerReference #-}
...
{-# INLINEABLE dcDefaultCacheBehavior #-}
...
{-# INLINEABLE dcCustomErrorResponses #-}
...
dcDefaultRootObject :: Lens.Lens' DistributionConfig (Core.Maybe Core.Text)
dcDefaultRootObject = Lens.field @"defaultRootObject"
{-# INLINEABLE dcDefaultRootObject #-}
{-# DEPRECATED defaultRootObject "Use generic-lens or generic-optics with 'defaultRootObject' instead"  #-}
...
{-# INLINEABLE dcViewerCertificate #-}
...
dcWebACLId :: Lens.Lens' DistributionConfig (Core.Maybe Core.Text)
dcWebACLId = Lens.field @"webACLId"
{-# INLINEABLE dcWebACLId #-}
...
instance Core.ToXML DistributionConfig where
        toXML DistributionConfig{..}
          = Core.toXMLElement "CallerReference" callerReference Core.<>
              Core.toXMLElement "Origins" origins
              Core.<>
              Core.toXMLElement "DefaultCacheBehavior" defaultCacheBehavior
              ...
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "CacheBehaviors")
                cacheBehaviors
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "CustomErrorResponses")
                customErrorResponses
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "DefaultRootObject")
                defaultRootObject
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "HttpVersion")
                httpVersion
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "IsIPV6Enabled")
                isIPV6Enabled
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "Logging") logging
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "OriginGroups")
                originGroups
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "PriceClass") priceClass
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "Restrictions")
                restrictions
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "ViewerCertificate")
                viewerCertificate
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "WebACLId") webACLId

instance Core.FromXML DistributionConfig where
        parseXML x
          = DistributionConfig' Core.<$>
              (x Core..@ "CallerReference") Core.<*> x Core..@ "Origins" Core.<*>
                x Core..@ "DefaultCacheBehavior"
                Core.<*> x Core..@ "Comment"
                Core.<*> x Core..@ "Enabled"
                Core.<*> x Core..@? "Aliases"
