...
mkPasswordPolicyType
    :: PasswordPolicyType
mkPasswordPolicyType
  = PasswordPolicyType'{minimumLength = Core.Nothing,
                        requireLowercase = Core.Nothing, requireNumbers = Core.Nothing,
                        requireSymbols = Core.Nothing, requireUppercase = Core.Nothing,
...
{-# INLINEABLE pptMinimumLength #-}
{-# DEPRECATED minimumLength "Use generic-lens or generic-optics with 'minimumLength' instead"  #-}
...
{-# INLINEABLE pptRequireLowercase #-}
{-# DEPRECATED requireLowercase "Use generic-lens or generic-optics with 'requireLowercase' instead"  #-}
...
{-# INLINEABLE pptRequireUppercase #-}
{-# DEPRECATED requireUppercase "Use generic-lens or generic-optics with 'requireUppercase' instead"  #-}
...
{-# INLINEABLE pptTemporaryPasswordValidityDays #-}
{-# DEPRECATED temporaryPasswordValidityDays "Use generic-lens or generic-optics with 'temporaryPasswordValidityDays' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("MinimumLength" Core..=) Core.<$> minimumLength,
                  ...
                  ("TemporaryPasswordValidityDays" Core..=) Core.<$>
...
instance Core.FromJSON PasswordPolicyType where
        parseJSON
          = Core.withObject "PasswordPolicyType" Core.$
              \ x ->
                PasswordPolicyType' Core.<$>
                  (x Core..:? "MinimumLength") Core.<*> x Core..:? "RequireLowercase"
