...
mkDashIsoGroupSettings
    :: DashIsoGroupSettings
mkDashIsoGroupSettings
  = DashIsoGroupSettings'{additionalManifests = Core.Nothing,
                          baseUrl = Core.Nothing, destination = Core.Nothing,
                          destinationSettings = Core.Nothing, encryption = Core.Nothing,
                          fragmentLength = Core.Nothing, hbbtvCompliance = Core.Nothing,
...
{-# INLINEABLE digsAdditionalManifests #-}
...
{-# INLINEABLE digsDestinationSettings #-}
...
{-# INLINEABLE digsHbbtvCompliance #-}
{-# DEPRECATED hbbtvCompliance "Use generic-lens or generic-optics with 'hbbtvCompliance' instead"  #-}
...
{-# INLINEABLE digsMinFinalSegmentLength #-}
...
{-# INLINEABLE digsWriteSegmentTimelineInRepresentation #-}
