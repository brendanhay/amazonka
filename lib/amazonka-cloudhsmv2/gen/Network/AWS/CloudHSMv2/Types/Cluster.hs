...
mkCluster
    :: Cluster
mkCluster
  = Cluster'{backupPolicy = Core.Nothing,
             backupRetentionPolicy = Core.Nothing, certificates = Core.Nothing,
             clusterId = Core.Nothing, createTimestamp = Core.Nothing,
             hsmType = Core.Nothing, hsms = Core.Nothing,
             preCoPassword = Core.Nothing, securityGroup = Core.Nothing,
             sourceBackupId = Core.Nothing, state = Core.Nothing,
             stateMessage = Core.Nothing, subnetMapping = Core.Nothing,
             tagList = Core.Nothing, vpcId = Core.Nothing}
...
{-# INLINEABLE cBackupRetentionPolicy #-}
...
{-# INLINEABLE cHsms #-}
{-# DEPRECATED hsms "Use generic-lens or generic-optics with 'hsms' instead"  #-}
...
{-# INLINEABLE cPreCoPassword #-}
{-# DEPRECATED preCoPassword "Use generic-lens or generic-optics with 'preCoPassword' instead"  #-}
...
{-# INLINEABLE cSubnetMapping #-}
{-# DEPRECATED subnetMapping "Use generic-lens or generic-optics with 'subnetMapping' instead"  #-}
...
instance Core.FromJSON Cluster where
        parseJSON
          = Core.withObject "Cluster" Core.$
              \ x ->
                Cluster' Core.<$>
                  (x Core..:? "BackupPolicy") Core.<*>
                    x Core..:? "BackupRetentionPolicy"
