...
mkConditionalSplitActivity
    :: ConditionalSplitActivity
mkConditionalSplitActivity
  = ConditionalSplitActivity'{condition = Core.Nothing,
                              evaluationWaitTime = Core.Nothing, falseActivity = Core.Nothing,
...
{-# INLINEABLE csaEvaluationWaitTime #-}
{-# DEPRECATED evaluationWaitTime "Use generic-lens or generic-optics with 'evaluationWaitTime' instead"  #-}
...
{-# INLINEABLE csaFalseActivity #-}
{-# DEPRECATED falseActivity "Use generic-lens or generic-optics with 'falseActivity' instead"  #-}
...
{-# INLINEABLE csaTrueActivity #-}
{-# DEPRECATED trueActivity "Use generic-lens or generic-optics with 'trueActivity' instead"  #-}
...
instance Core.FromJSON ConditionalSplitActivity where
        parseJSON
          = Core.withObject "ConditionalSplitActivity" Core.$
              \ x ->
                ConditionalSplitActivity' Core.<$>
                  (x Core..:? "Condition") Core.<*> x Core..:? "EvaluationWaitTime"
