...
mkPolicy
    :: Policy
mkPolicy
  = Policy'{arn = Core.Nothing, attachmentCount = Core.Nothing,
            createDate = Core.Nothing, defaultVersionId = Core.Nothing,
            description = Core.Nothing, isAttachable = Core.Nothing,
            path = Core.Nothing, permissionsBoundaryUsageCount = Core.Nothing,
...
{-# INLINEABLE pPermissionsBoundaryUsageCount #-}
