...
data Eac3AtmosSettings = Eac3AtmosSettings'
  { stereoDownmix ::
    ...
    dynamicRangeCompressionRf ::
      Lude.Maybe Eac3AtmosDynamicRangeCompressionRf,
    ...
    dialogueIntelligence ::
      Lude.Maybe Eac3AtmosDialogueIntelligence,
