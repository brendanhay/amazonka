...
mkStartSegmentDetection
    :: Types.Video -- ^ 'video'
    -> Core.NonEmpty Types.SegmentType -- ^ 'segmentTypes'
    -> StartSegmentDetection
mkStartSegmentDetection video segmentTypes
  = StartSegmentDetection'{video, segmentTypes,
                           clientRequestToken = Core.Nothing, filters = Core.Nothing,
...
{-# INLINEABLE ssdSegmentTypes #-}
{-# DEPRECATED segmentTypes "Use generic-lens or generic-optics with 'segmentTypes' instead"  #-}
...
{-# INLINEABLE ssdClientRequestToken #-}
...
{-# INLINEABLE ssdNotificationChannel #-}
...
instance Core.ToHeaders StartSegmentDetection where
        toHeaders StartSegmentDetection{..}
          = Core.pure
...
instance Core.AWSRequest StartSegmentDetection where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartSegmentDetectionResponse' Core.<$>
...
mkStartSegmentDetectionResponse responseStatus
  = StartSegmentDetectionResponse'{jobId = Core.Nothing,
                                   responseStatus}
...
{-# INLINEABLE ssdrrsResponseStatus #-}
