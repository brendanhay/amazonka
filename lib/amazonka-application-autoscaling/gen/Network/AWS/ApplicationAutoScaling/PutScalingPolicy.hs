...
mkPutScalingPolicy
    ...
    -> PutScalingPolicy
mkPutScalingPolicy policyName serviceNamespace resourceId
  scalableDimension
  = PutScalingPolicy'{policyName, serviceNamespace, resourceId,
                      scalableDimension, policyType = Core.Nothing,
...
{-# INLINEABLE pspServiceNamespace #-}
...
{-# INLINEABLE pspScalableDimension #-}
...
{-# INLINEABLE pspStepScalingPolicyConfiguration #-}
...
{-# INLINEABLE pspTargetTrackingScalingPolicyConfiguration #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("PolicyName" Core..= policyName),
                  ...
                  ("StepScalingPolicyConfiguration" Core..=) Core.<$>
                    stepScalingPolicyConfiguration,
                  ("TargetTrackingScalingPolicyConfiguration" Core..=) Core.<$>
          ...
          = Response.receiveJSON
              (\ s h x ->
                 PutScalingPolicyResponse' Core.<$>
                   (x Core..: "PolicyARN") Core.<*> x Core..:? "Alarms" Core.<*>
...
mkPutScalingPolicyResponse policyARN responseStatus
  = PutScalingPolicyResponse'{policyARN, alarms = Core.Nothing,
                              responseStatus}
