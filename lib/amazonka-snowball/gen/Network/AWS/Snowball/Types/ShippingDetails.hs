...
mkShippingDetails
    :: ShippingDetails
mkShippingDetails
  = ShippingDetails'{inboundShipment = Core.Nothing,
                     outboundShipment = Core.Nothing, shippingOption = Core.Nothing}
...
{-# INLINEABLE sdInboundShipment #-}
{-# DEPRECATED inboundShipment "Use generic-lens or generic-optics with 'inboundShipment' instead"  #-}
...
{-# INLINEABLE sdOutboundShipment #-}
{-# DEPRECATED outboundShipment "Use generic-lens or generic-optics with 'outboundShipment' instead"  #-}
          ...
          = Core.withObject "ShippingDetails" Core.$
              \ x ->
                ShippingDetails' Core.<$>
                  (x Core..:? "InboundShipment") Core.<*>
                    x Core..:? "OutboundShipment"
