...
pattern ApplicationVersionLifecycle_Available = ApplicationVersionLifecycle' "Available"

pattern ApplicationVersionLifecycle_Creating :: ApplicationVersionLifecycle
pattern ApplicationVersionLifecycle_Creating = ApplicationVersionLifecycle' "Creating"

pattern ApplicationVersionLifecycle_Failed :: ApplicationVersionLifecycle
pattern ApplicationVersionLifecycle_Failed = ApplicationVersionLifecycle' "Failed"
