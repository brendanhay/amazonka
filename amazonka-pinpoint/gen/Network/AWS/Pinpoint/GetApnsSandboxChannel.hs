...
instance Prelude.AWSRequest GetApnsSandboxChannel where
  type
...
instance Prelude.ToHeaders GetApnsSandboxChannel where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath GetApnsSandboxChannel where
...
instance Prelude.ToQuery GetApnsSandboxChannel where
