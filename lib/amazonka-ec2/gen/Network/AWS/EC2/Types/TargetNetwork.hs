...
mkTargetNetwork
    :: TargetNetwork
mkTargetNetwork
  = TargetNetwork'{associationId = Core.Nothing,
                   clientVpnEndpointId = Core.Nothing, securityGroups = Core.Nothing,
                   status = Core.Nothing, targetNetworkId = Core.Nothing,
                   vpcId = Core.Nothing}

-- | The ID of the association.
--
-- /Note:/ Consider using 'associationId' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
tnAssociationId :: Lens.Lens' TargetNetwork (Core.Maybe Core.Text)
tnAssociationId = Lens.field @"associationId"
{-# INLINEABLE tnAssociationId #-}
...
tnClientVpnEndpointId :: Lens.Lens' TargetNetwork (Core.Maybe Core.Text)
tnClientVpnEndpointId = Lens.field @"clientVpnEndpointId"
{-# INLINEABLE tnClientVpnEndpointId #-}
...
tnSecurityGroups :: Lens.Lens' TargetNetwork (Core.Maybe [Core.Text])
tnSecurityGroups = Lens.field @"securityGroups"
{-# INLINEABLE tnSecurityGroups #-}
...
tnTargetNetworkId :: Lens.Lens' TargetNetwork (Core.Maybe Core.Text)
tnTargetNetworkId = Lens.field @"targetNetworkId"
{-# INLINEABLE tnTargetNetworkId #-}
{-# DEPRECATED targetNetworkId "Use generic-lens or generic-optics with 'targetNetworkId' instead"  #-}

-- | The ID of the VPC in which the target network (subnet) is located.
--
-- /Note:/ Consider using 'vpcId' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
tnVpcId :: Lens.Lens' TargetNetwork (Core.Maybe Core.Text)
        ...
        parseXML x
          = TargetNetwork' Core.<$>
              (x Core..@? "associationId") Core.<*>
                x Core..@? "clientVpnEndpointId"
                Core.<*>
                x Core..@? "securityGroups" Core..<@> Core.parseXMLList "item"
                Core.<*> x Core..@? "status"
