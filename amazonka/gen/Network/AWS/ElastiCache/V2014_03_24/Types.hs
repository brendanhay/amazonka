...
instance ToByteString SourceType where
    toBS SourceTypeCacheCluster = "cache-cluster"
    toBS SourceTypeCacheParameterGroup = "cache-parameter-group"
    toBS SourceTypeCacheSecurityGroup = "cache-security-group"
    toBS SourceTypeCacheSubnetGroup = "cache-subnet-group"
