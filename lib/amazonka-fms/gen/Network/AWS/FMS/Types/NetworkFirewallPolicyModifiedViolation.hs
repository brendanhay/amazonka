...
mkNetworkFirewallPolicyModifiedViolation
    :: NetworkFirewallPolicyModifiedViolation
mkNetworkFirewallPolicyModifiedViolation
  = NetworkFirewallPolicyModifiedViolation'{currentPolicyDescription
                                              = Core.Nothing,
...
{-# INLINEABLE nfpmvCurrentPolicyDescription #-}
{-# DEPRECATED currentPolicyDescription "Use generic-lens or generic-optics with 'currentPolicyDescription' instead"  #-}
...
{-# INLINEABLE nfpmvExpectedPolicyDescription #-}
{-# DEPRECATED expectedPolicyDescription "Use generic-lens or generic-optics with 'expectedPolicyDescription' instead"  #-}
...
{-# INLINEABLE nfpmvViolationTarget #-}
...
instance Core.FromJSON NetworkFirewallPolicyModifiedViolation where
        parseJSON
          = Core.withObject "NetworkFirewallPolicyModifiedViolation" Core.$
              \ x ->
                NetworkFirewallPolicyModifiedViolation' Core.<$>
                  (x Core..:? "CurrentPolicyDescription") Core.<*>
                    x Core..:? "ExpectedPolicyDescription"
