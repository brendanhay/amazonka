...
mkListParallelData
    :: ListParallelData
mkListParallelData
  = ListParallelData'{maxResults = Core.Nothing,
...
instance Core.AWSRequest ListParallelData where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListParallelDataResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*>
                     x Core..:? "ParallelDataPropertiesList"
...
mkListParallelDataResponse responseStatus
  = ListParallelDataResponse'{nextToken = Core.Nothing,
                              parallelDataPropertiesList = Core.Nothing, responseStatus}
...
{-# INLINEABLE lpdrrsParallelDataPropertiesList #-}
{-# DEPRECATED parallelDataPropertiesList "Use generic-lens or generic-optics with 'parallelDataPropertiesList' instead"  #-}
