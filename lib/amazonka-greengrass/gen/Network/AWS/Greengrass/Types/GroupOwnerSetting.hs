...
mkGroupOwnerSetting
    :: GroupOwnerSetting
mkGroupOwnerSetting
  = GroupOwnerSetting'{autoAddGroupOwner = Core.Nothing,
...
{-# INLINEABLE gosAutoAddGroupOwner #-}
{-# DEPRECATED autoAddGroupOwner "Use generic-lens or generic-optics with 'autoAddGroupOwner' instead"  #-}
...
{-# INLINEABLE gosGroupOwner #-}
{-# DEPRECATED groupOwner "Use generic-lens or generic-optics with 'groupOwner' instead"  #-}
          ...
          = Core.withObject "GroupOwnerSetting" Core.$
              \ x ->
                GroupOwnerSetting' Core.<$>
                  (x Core..:? "AutoAddGroupOwner") Core.<*> x Core..:? "GroupOwner"
