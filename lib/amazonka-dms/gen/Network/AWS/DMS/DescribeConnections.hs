...
mkDescribeConnections
    :: DescribeConnections
mkDescribeConnections
  = DescribeConnections'{filters = Core.Nothing,
...
dcMarker :: Lens.Lens' DescribeConnections (Core.Maybe Core.Text)
...
instance Core.AWSRequest DescribeConnections where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeConnectionsResponse' Core.<$>
                   (x Core..:? "Connections") Core.<*> x Core..:? "Marker" Core.<*>
...
mkDescribeConnectionsResponse responseStatus
  = DescribeConnectionsResponse'{connections = Core.Nothing,
...
{-# INLINEABLE dcrfrsConnections #-}
{-# DEPRECATED connections "Use generic-lens or generic-optics with 'connections' instead"  #-}

-- | An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by @MaxRecords@ . 
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dcrfrsMarker :: Lens.Lens' DescribeConnectionsResponse (Core.Maybe Core.Text)
dcrfrsMarker = Lens.field @"marker"
{-# INLINEABLE dcrfrsMarker #-}
{-# DEPRECATED marker "Use generic-lens or generic-optics with 'marker' instead"  #-}
