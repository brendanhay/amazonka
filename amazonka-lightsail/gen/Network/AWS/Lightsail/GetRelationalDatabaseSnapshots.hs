...
instance
  ...
  response =
    Response.receiveJSON
      ( \s h x ->
          GetRelationalDatabaseSnapshotsResponse'
            Prelude.<$> ( x Prelude..?> "relationalDatabaseSnapshots"
...
instance
  ...
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "Lightsail_20161128.GetRelationalDatabaseSnapshots" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
