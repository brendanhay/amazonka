...
mkStartPersonTracking video
  = StartPersonTracking'{video, clientRequestToken = Core.Nothing,
                         jobTag = Core.Nothing, notificationChannel = Core.Nothing}
...
{-# INLINEABLE sptClientRequestToken #-}
...
{-# INLINEABLE sptNotificationChannel #-}
...
instance Core.AWSRequest StartPersonTracking where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartPersonTrackingResponse' Core.<$>
...
mkStartPersonTrackingResponse responseStatus
  = StartPersonTrackingResponse'{jobId = Core.Nothing,
                                 responseStatus}
...
{-# INLINEABLE sptrrsResponseStatus #-}
