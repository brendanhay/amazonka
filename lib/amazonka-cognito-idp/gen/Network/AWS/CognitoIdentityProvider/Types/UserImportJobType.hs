...
mkUserImportJobType
    :: UserImportJobType
mkUserImportJobType
  = UserImportJobType'{cloudWatchLogsRoleArn = Core.Nothing,
                       completionDate = Core.Nothing, completionMessage = Core.Nothing,
                       creationDate = Core.Nothing, failedUsers = Core.Nothing,
                       importedUsers = Core.Nothing, jobId = Core.Nothing,
                       jobName = Core.Nothing, preSignedUrl = Core.Nothing,
                       skippedUsers = Core.Nothing, startDate = Core.Nothing,
                       status = Core.Nothing, userPoolId = Core.Nothing}
...
{-# INLINEABLE uijtCloudWatchLogsRoleArn #-}
...
{-# INLINEABLE uijtCompletionMessage #-}
{-# DEPRECATED completionMessage "Use generic-lens or generic-optics with 'completionMessage' instead"  #-}
...
{-# INLINEABLE uijtFailedUsers #-}
{-# DEPRECATED failedUsers "Use generic-lens or generic-optics with 'failedUsers' instead"  #-}
...
{-# INLINEABLE uijtImportedUsers #-}
{-# DEPRECATED importedUsers "Use generic-lens or generic-optics with 'importedUsers' instead"  #-}
...
{-# INLINEABLE uijtSkippedUsers #-}
{-# DEPRECATED skippedUsers "Use generic-lens or generic-optics with 'skippedUsers' instead"  #-}
...
instance Core.FromJSON UserImportJobType where
        parseJSON
          = Core.withObject "UserImportJobType" Core.$
              \ x ->
                UserImportJobType' Core.<$>
                  (x Core..:? "CloudWatchLogsRoleArn") Core.<*>
                    x Core..:? "CompletionDate"
