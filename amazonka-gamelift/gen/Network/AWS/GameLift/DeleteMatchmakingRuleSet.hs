...
--
-- * 'dmrsName' - Unique identifier for a matchmaking rule set to be deleted. (Note: The rule set name is different from the optional "name" field in the rule set body.)
deleteMatchmakingRuleSet
    :: Text -- ^ 'dmrsName'
    -> DeleteMatchmakingRuleSet
deleteMatchmakingRuleSet pName_ = DeleteMatchmakingRuleSet' {_dmrsName = pName_}
...
deleteMatchmakingRuleSetResponse pResponseStatus_ =
  DeleteMatchmakingRuleSetResponse' {_dmrsrsResponseStatus = pResponseStatus_}
