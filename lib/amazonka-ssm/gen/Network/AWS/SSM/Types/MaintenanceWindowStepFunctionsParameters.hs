...
mkMaintenanceWindowStepFunctionsParameters
    :: MaintenanceWindowStepFunctionsParameters
mkMaintenanceWindowStepFunctionsParameters
  = MaintenanceWindowStepFunctionsParameters'{input = Core.Nothing,
                                              name = Core.Nothing}
...
{-# INLINEABLE mwsfpName #-}
{-# DEPRECATED name "Use generic-lens or generic-optics with 'name' instead"  #-}

instance Core.FromJSON MaintenanceWindowStepFunctionsParameters
         where
...
instance Core.FromJSON MaintenanceWindowStepFunctionsParameters
        ...
        parseJSON
          = Core.withObject "MaintenanceWindowStepFunctionsParameters" Core.$
              \ x ->
                MaintenanceWindowStepFunctionsParameters' Core.<$>
                  (x Core..:? "Input") Core.<*> x Core..:? "Name"
