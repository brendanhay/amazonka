  ...
  = Waiter.Wait{Waiter._waitName = "InstanceTerminated",
                ...
                Waiter._waitAcceptors =
                  [Waiter.matchAll "terminated" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"reservations" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core..
                        Lens.folding
                          (Lens.concatOf
                             (Lens.field @"instances" Core.. Lens._Just Core..
                                Lens.to Core.toList))
                          Core.. Lens.field @"state" Core.. Lens.field @"name"),
...
mkVolumeInUse
  = Waiter.Wait{Waiter._waitName = "VolumeInUse",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "in-use" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"volumes" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkImageExists
  = Waiter.Wait{Waiter._waitName = "ImageExists",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchNonEmpty Core.True Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"images" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkNatGatewayAvailable
  = Waiter.Wait{Waiter._waitName = "NatGatewayAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"natGateways" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state" Core.. Lens._Just),
...
mkSubnetAvailable
  = Waiter.Wait{Waiter._waitName = "SubnetAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"subnets" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state")]}
...
mkNetworkInterfaceAvailable
  = Waiter.Wait{Waiter._waitName = "NetworkInterfaceAvailable",
                Waiter._waitAttempts = 10, Waiter._waitDelay = 20,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"networkInterfaces" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"status" Core.. Lens._Just),
                   Waiter.matchError "InvalidNetworkInterfaceID.NotFound"
...
mkKeyPairExists
  = Waiter.Wait{Waiter._waitName = "KeyPairExists",
                Waiter._waitAttempts = 6, Waiter._waitDelay = 5,
                Waiter._waitAcceptors =
                  [Waiter.matchNonEmpty Core.True Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"keyPairs" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"keyName" Core.. Lens._Just
                        Core.. Core._isNonEmpty),
...
mkSystemStatusOk
  = Waiter.Wait{Waiter._waitName = "SystemStatusOk",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "ok" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"instanceStatuses" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core..
                        Lens.field @"systemStatus" Core.. Lens._Just Core..
                          Lens.field @"status")]}
...
mkCustomerGatewayAvailable
  = Waiter.Wait{Waiter._waitName = "CustomerGatewayAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"customerGateways" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state"),
                   Waiter.matchAny "deleted" Waiter.AcceptFailure
                     (Lens.folding
...
mkConversionTaskCompleted
  = Waiter.Wait{Waiter._waitName = "ConversionTaskCompleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "completed" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"conversionTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state" Core.. Lens._Just),
                   Waiter.matchAny "cancelled" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"conversionTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state" Core.. Lens._Just),
                   Waiter.matchAny "cancelling" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"conversionTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkConversionTaskDeleted
  = Waiter.Wait{Waiter._waitName = "ConversionTaskDeleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
...
mkPasswordDataAvailable
  = Waiter.Wait{Waiter._waitName = "PasswordDataAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchNonEmpty Core.True Waiter.AcceptSuccess
...
mkInstanceRunning
  = Waiter.Wait{Waiter._waitName = "InstanceRunning",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                        ...
                        Lens.folding
                          (Lens.concatOf
                             (Lens.field @"instances" Core.. Lens._Just Core..
                                Lens.to Core.toList))
                          Core.. Lens.field @"state" Core.. Lens.field @"name"),
                   Waiter.matchAny "shutting-down" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"reservations" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkSecurityGroupExists
  = Waiter.Wait{Waiter._waitName = "SecurityGroupExists",
                Waiter._waitAttempts = 6, Waiter._waitDelay = 5,
                Waiter._waitAcceptors =
                  [Waiter.matchNonEmpty Core.True Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"securityGroups" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkSpotInstanceRequestFulfilled
  = Waiter.Wait{Waiter._waitName = "SpotInstanceRequestFulfilled",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "fulfilled" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"spotInstanceRequests" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core..
                        Lens.field @"status" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchAll "request-canceled-and-instance-running"
                     ...
                     (Lens.folding
                        ...
                        Lens.field @"status" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchAny "schedule-expired" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"spotInstanceRequests" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        ...
                        Lens.field @"status" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchAny "canceled-before-fulfillment" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"spotInstanceRequests" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        ...
                        Lens.field @"status" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchAny "bad-parameters" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"spotInstanceRequests" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        ...
                        Lens.field @"status" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchAny "system-error" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"spotInstanceRequests" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        ...
                        Lens.field @"status" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchError "InvalidSpotInstanceRequestID.NotFound"
                     Waiter.AcceptRetry]}
...
mkVpcAvailable
  = Waiter.Wait{Waiter._waitName = "VpcAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
...
mkExportTaskCompleted
  = Waiter.Wait{Waiter._waitName = "ExportTaskCompleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "completed" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"exportTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state")]}
...
mkVpcPeeringConnectionDeleted
  = Waiter.Wait{Waiter._waitName = "VpcPeeringConnectionDeleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "deleted" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"vpcPeeringConnections" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core..
                        Lens.field @"status" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchError "InvalidVpcPeeringConnectionID.NotFound"
                     Waiter.AcceptSuccess]}
...
mkVpnConnectionAvailable
  = Waiter.Wait{Waiter._waitName = "VpnConnectionAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"vpnConnections" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state"),
                   Waiter.matchAny "deleting" Waiter.AcceptFailure
                     (Lens.folding
...
mkExportTaskCancelled
  = Waiter.Wait{Waiter._waitName = "ExportTaskCancelled",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "cancelled" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"exportTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkVolumeDeleted
  = Waiter.Wait{Waiter._waitName = "VolumeDeleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "deleted" Waiter.AcceptSuccess
                     (Lens.folding
...
mkVpcExists
  = Waiter.Wait{Waiter._waitName = "VpcExists",
                Waiter._waitAttempts = 5, Waiter._waitDelay = 1,
                Waiter._waitAcceptors =
...
mkBundleTaskComplete
  = Waiter.Wait{Waiter._waitName = "BundleTaskComplete",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "complete" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"bundleTasks" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state"),
                   Waiter.matchAny "failed" Waiter.AcceptFailure
                     (Lens.folding
...
mkVpnConnectionDeleted
  = Waiter.Wait{Waiter._waitName = "VpnConnectionDeleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "deleted" Waiter.AcceptSuccess
                     (Lens.folding
...
mkConversionTaskCancelled
  = Waiter.Wait{Waiter._waitName = "ConversionTaskCancelled",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "cancelled" Waiter.AcceptSuccess
                     (Lens.folding
...
mkImageAvailable
  = Waiter.Wait{Waiter._waitName = "ImageAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"images" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"state"),
                   Waiter.matchAny "deregistered" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"images" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkVpcPeeringConnectionExists
  = Waiter.Wait{Waiter._waitName = "VpcPeeringConnectionExists",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchStatus 200 Waiter.AcceptSuccess,
                   Waiter.matchError "InvalidVpcPeeringConnectionID.NotFound"
...
mkSnapshotCompleted
  = Waiter.Wait{Waiter._waitName = "SnapshotCompleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "completed" Waiter.AcceptSuccess
                     (Lens.folding
...
mkInstanceExists
  = Waiter.Wait{Waiter._waitName = "InstanceExists",
...
mkInstanceStatusOk
  = Waiter.Wait{Waiter._waitName = "InstanceStatusOk",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "ok" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"instanceStatuses" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core..
                        Lens.field @"instanceStatus" Core.. Lens._Just Core..
                          Lens.field @"status"),
                   Waiter.matchError "InvalidInstanceID.NotFound" Waiter.AcceptRetry]}
...
mkVolumeAvailable
  = Waiter.Wait{Waiter._waitName = "VolumeAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
