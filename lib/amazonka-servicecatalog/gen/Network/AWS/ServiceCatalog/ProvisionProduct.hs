...
mkProvisionProduct
    ...
    -> Types.IdempotencyToken -- ^ 'provisionToken'
    -> ProvisionProduct
mkProvisionProduct provisionedProductName provisionToken
  = ProvisionProduct'{provisionedProductName, provisionToken,
...
{-# INLINEABLE ppProvisionedProductName #-}
...
{-# INLINEABLE ppProvisionToken #-}
{-# DEPRECATED provisionToken "Use generic-lens or generic-optics with 'provisionToken' instead"  #-}
...
{-# INLINEABLE ppProvisioningArtifactId #-}
...
{-# INLINEABLE ppProvisioningArtifactName #-}
...
{-# INLINEABLE ppProvisioningParameters #-}
...
{-# INLINEABLE ppProvisioningPreferences #-}
...
mkProvisionProductResponse responseStatus
  = ProvisionProductResponse'{recordDetail = Core.Nothing,
                              responseStatus}
