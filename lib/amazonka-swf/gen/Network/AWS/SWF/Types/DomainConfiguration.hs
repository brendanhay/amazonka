...
mkDomainConfiguration
    :: Types.DurationInDays -- ^ 'workflowExecutionRetentionPeriodInDays'
    -> DomainConfiguration
...
{-# INLINEABLE dcWorkflowExecutionRetentionPeriodInDays #-}
...
instance Core.FromJSON DomainConfiguration where
        parseJSON
          = Core.withObject "DomainConfiguration" Core.$
              \ x ->
                DomainConfiguration' Core.<$>
                  (x Core..: "workflowExecutionRetentionPeriodInDays")
