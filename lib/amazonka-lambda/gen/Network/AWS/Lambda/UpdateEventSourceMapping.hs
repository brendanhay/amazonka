...
mkUpdateEventSourceMapping uuid
  = UpdateEventSourceMapping'{uuid, batchSize = Core.Nothing,
...
uesmUUID :: Lens.Lens' UpdateEventSourceMapping Core.Text
...
{-# INLINEABLE uesmBisectBatchOnFunctionError #-}
...
{-# INLINEABLE uesmDestinationConfig #-}
...
{-# INLINEABLE uesmMaximumBatchingWindowInSeconds #-}
...
{-# INLINEABLE uesmMaximumRecordAgeInSeconds #-}
...
{-# INLINEABLE uesmMaximumRetryAttempts #-}
...
{-# INLINEABLE uesmParallelizationFactor #-}
...
{-# INLINEABLE uesmSourceAccessConfigurations #-}
