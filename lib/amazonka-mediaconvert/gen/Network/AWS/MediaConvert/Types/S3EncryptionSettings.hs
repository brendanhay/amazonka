...
mkS3EncryptionSettings
    :: S3EncryptionSettings
mkS3EncryptionSettings
  = S3EncryptionSettings'{encryptionType = Core.Nothing,
...
instance Core.FromJSON S3EncryptionSettings where
        parseJSON
          = Core.withObject "S3EncryptionSettings" Core.$
              \ x ->
                S3EncryptionSettings' Core.<$>
                  (x Core..:? "encryptionType") Core.<*> x Core..:? "kmsKeyArn"
