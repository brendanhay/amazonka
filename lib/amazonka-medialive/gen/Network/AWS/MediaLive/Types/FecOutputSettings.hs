...
mkFecOutputSettings
    :: FecOutputSettings
mkFecOutputSettings
  = FecOutputSettings'{columnDepth = Core.Nothing,
                       includeFec = Core.Nothing, rowLength = Core.Nothing}
...
{-# INLINEABLE fosColumnDepth #-}
{-# DEPRECATED columnDepth "Use generic-lens or generic-optics with 'columnDepth' instead"  #-}
...
{-# INLINEABLE fosIncludeFec #-}
{-# DEPRECATED includeFec "Use generic-lens or generic-optics with 'includeFec' instead"  #-}
...
{-# INLINEABLE fosRowLength #-}
{-# DEPRECATED rowLength "Use generic-lens or generic-optics with 'rowLength' instead"  #-}
          ...
          = Core.withObject "FecOutputSettings" Core.$
              \ x ->
                FecOutputSettings' Core.<$>
                  (x Core..:? "columnDepth") Core.<*> x Core..:? "includeFec"
