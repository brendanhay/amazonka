...
mkSsmControls
    :: SsmControls
mkSsmControls
  = SsmControls'{concurrentExecutionRatePercentage = Core.Nothing,
...
{-# INLINEABLE scConcurrentExecutionRatePercentage #-}
{-# DEPRECATED concurrentExecutionRatePercentage "Use generic-lens or generic-optics with 'concurrentExecutionRatePercentage' instead"  #-}
...
{-# INLINEABLE scErrorPercentage #-}
{-# DEPRECATED errorPercentage "Use generic-lens or generic-optics with 'errorPercentage' instead"  #-}

instance Core.FromJSON SsmControls where
        toJSON SsmControls{..}
          = Core.object
              (Core.catMaybes
                 [("ConcurrentExecutionRatePercentage" Core..=) Core.<$>
...
instance Core.FromJSON SsmControls where
        parseJSON
          = Core.withObject "SsmControls" Core.$
              \ x ->
                SsmControls' Core.<$>
                  (x Core..:? "ConcurrentExecutionRatePercentage") Core.<*>
                    x Core..:? "ErrorPercentage"
