...
-- |
-- Module      : Amazonka.ApplicationAutoScaling.Types.TargetTrackingMetricStat
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.ApplicationAutoScaling.Types.TargetTrackingMetricStat where
...
-- data type in the /Amazon CloudWatch API Reference/.
--
-- 'metric', 'targetTrackingMetricStat_metric' - The CloudWatch metric to return, including the metric name, namespace,
-- and dimensions. To get the exact metric name, namespace, and dimensions,
-- inspect the
-- <https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_Metric.html Metric>
-- object that is returned by a call to
...
-- object that is returned by a call to
-- <https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_ListMetrics.html ListMetrics>.
targetTrackingMetricStat_metric :: Lens.Lens' TargetTrackingMetricStat TargetTrackingMetric
...
instance Data.FromJSON TargetTrackingMetricStat where
  parseJSON =
    Data.withObject
      "TargetTrackingMetricStat"
      ( \x ->
...
instance Data.ToJSON TargetTrackingMetricStat where
  toJSON TargetTrackingMetricStat' {..} =
    Data.object
      ( Prelude.catMaybes
