...
mkDeltaTime
    ...
    -> Types.TimeExpression -- ^ 'timeExpression'
    -> DeltaTime
...
{-# INLINEABLE dtOffsetSeconds #-}
{-# DEPRECATED offsetSeconds "Use generic-lens or generic-optics with 'offsetSeconds' instead"  #-}
...
{-# INLINEABLE dtTimeExpression #-}
{-# DEPRECATED timeExpression "Use generic-lens or generic-optics with 'timeExpression' instead"  #-}
...
instance Core.FromJSON DeltaTime where
        parseJSON
          = Core.withObject "DeltaTime" Core.$
              \ x ->
                DeltaTime' Core.<$>
                  (x Core..: "offsetSeconds") Core.<*> x Core..: "timeExpression"
