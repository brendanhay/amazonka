...
ssmsaAttributes :: Lens.Lens' SetSMSAttributes (Core.HashMap Core.Text Core.Text)
ssmsaAttributes = Lens.field @"attributes"
{-# INLINEABLE ssmsaAttributes #-}
{-# DEPRECATED attributes "Use generic-lens or generic-optics with 'attributes' instead"  #-}

instance Core.ToQuery SetSMSAttributes where
        toQuery SetSMSAttributes{..}
          = Core.toQueryPair "Action" ("SetSMSAttributes" :: Core.Text)
...
instance Core.AWSRequest SetSMSAttributes where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "SetSMSAttributesResult"
              (\ s h x ->
...
{-# INLINEABLE ssmsarrsResponseStatus #-}
