...
mkModelPackageValidationSpecification
    ...
    -> Core.NonEmpty Types.ModelPackageValidationProfile -- ^ 'validationProfiles'
    -> ModelPackageValidationSpecification
mkModelPackageValidationSpecification validationRole
  validationProfiles
...
{-# INLINEABLE mpvsValidationProfiles #-}
...
instance Core.FromJSON ModelPackageValidationSpecification where
        parseJSON
          = Core.withObject "ModelPackageValidationSpecification" Core.$
              \ x ->
                ModelPackageValidationSpecification' Core.<$>
