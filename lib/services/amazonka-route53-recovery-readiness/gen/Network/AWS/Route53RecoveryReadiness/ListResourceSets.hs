...
-- |
-- Module      : Network.AWS.Route53RecoveryReadiness.ListResourceSets
...
instance Prelude.Hashable ListResourceSets

instance Prelude.NFData ListResourceSets
...
instance Prelude.NFData ListResourceSetsResponse
