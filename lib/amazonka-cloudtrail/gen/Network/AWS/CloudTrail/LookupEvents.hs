...
mkLookupEvents
    :: LookupEvents
mkLookupEvents
  = LookupEvents'{endTime = Core.Nothing,
                  eventCategory = Core.Nothing, lookupAttributes = Core.Nothing,
...
{-# INLINEABLE leEventCategory #-}
{-# DEPRECATED eventCategory "Use generic-lens or generic-optics with 'eventCategory' instead"  #-}
...
{-# INLINEABLE leLookupAttributes #-}
{-# DEPRECATED lookupAttributes "Use generic-lens or generic-optics with 'lookupAttributes' instead"  #-}
...
mkLookupEventsResponse responseStatus
  = LookupEventsResponse'{events = Core.Nothing,
