...
mkScheduledAction
    ...
    -> Types.ResourceIdMaxLen1600 -- ^ 'scheduledActionARN'
    -> Types.ServiceNamespace -- ^ 'serviceNamespace'
    -> Types.ResourceIdMaxLen1600 -- ^ 'schedule'
    -> Types.ResourceIdMaxLen1600 -- ^ 'resourceId'
    -> Core.NominalDiffTime -- ^ 'creationTime'
    -> ScheduledAction
mkScheduledAction scheduledActionName scheduledActionARN
  serviceNamespace schedule resourceId creationTime
  = ScheduledAction'{scheduledActionName, scheduledActionARN,
                     serviceNamespace, schedule, resourceId, creationTime,
                     endTime = Core.Nothing, scalableDimension = Core.Nothing,
                     scalableTargetAction = Core.Nothing, startTime = Core.Nothing}
...
{-# INLINEABLE saScheduledActionARN #-}
...
{-# INLINEABLE saScalableDimension #-}
...
{-# INLINEABLE saScalableTargetAction #-}
          ...
          = Core.withObject "ScheduledAction" Core.$
              \ x ->
                ScheduledAction' Core.<$>
                  (x Core..: "ScheduledActionName") Core.<*>
                    x Core..: "ScheduledActionARN"
