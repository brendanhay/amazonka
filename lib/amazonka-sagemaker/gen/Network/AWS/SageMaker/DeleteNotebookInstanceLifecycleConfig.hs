...
{-# INLINEABLE dnilcNotebookInstanceLifecycleConfigName #-}
...
instance Core.ToQuery DeleteNotebookInstanceLifecycleConfig where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DeleteNotebookInstanceLifecycleConfig where
        toHeaders DeleteNotebookInstanceLifecycleConfig{..}
          = Core.pure
...
instance Core.AWSRequest DeleteNotebookInstanceLifecycleConfig
         where
