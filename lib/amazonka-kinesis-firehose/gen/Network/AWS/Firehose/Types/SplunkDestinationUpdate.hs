...
mkSplunkDestinationUpdate
    :: SplunkDestinationUpdate
mkSplunkDestinationUpdate
  = SplunkDestinationUpdate'{cloudWatchLoggingOptions = Core.Nothing,
...
{-# INLINEABLE sduCloudWatchLoggingOptions #-}
...
{-# INLINEABLE sduHECAcknowledgmentTimeoutInSeconds #-}
...
{-# INLINEABLE sduProcessingConfiguration #-}
