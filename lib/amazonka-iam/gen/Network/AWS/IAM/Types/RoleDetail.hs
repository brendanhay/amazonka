...
rdCreateDate :: Lens.Lens' RoleDetail (Lude.Maybe Lude.ISO8601)
rdCreateDate = Lens.lens (createDate :: RoleDetail -> Lude.Maybe Lude.ISO8601) (\s a -> s {createDate = a} :: RoleDetail)
