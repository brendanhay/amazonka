...
--
-- As an example: using "Network.AWS.CloudWatchLogs" with the smart constructor and
...
-- @
--
-- Versus using "Network.AWS.CloudWatchLogs.Monadic" with the 'State' operator variants from
