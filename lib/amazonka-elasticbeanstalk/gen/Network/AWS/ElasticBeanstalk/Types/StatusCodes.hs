...
mkStatusCodes
    :: StatusCodes
mkStatusCodes
  = StatusCodes'{status2xx = Core.Nothing, status3xx = Core.Nothing,
                 status4xx = Core.Nothing, status5xx = Core.Nothing}
...
{-# INLINEABLE scStatus2xx #-}
{-# DEPRECATED status2xx "Use generic-lens or generic-optics with 'status2xx' instead"  #-}
...
{-# INLINEABLE scStatus3xx #-}
{-# DEPRECATED status3xx "Use generic-lens or generic-optics with 'status3xx' instead"  #-}
...
{-# INLINEABLE scStatus4xx #-}
{-# DEPRECATED status4xx "Use generic-lens or generic-optics with 'status4xx' instead"  #-}
...
{-# INLINEABLE scStatus5xx #-}
{-# DEPRECATED status5xx "Use generic-lens or generic-optics with 'status5xx' instead"  #-}

instance Core.FromXML StatusCodes where
        parseXML x
          = StatusCodes' Core.<$>
              (x Core..@? "Status2xx") Core.<*> x Core..@? "Status3xx" Core.<*>
                x Core..@? "Status4xx"
