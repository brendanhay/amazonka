...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CognitoSync",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "cognito-sync",
...
_DuplicateRequestException
  = Core._MatchServiceError mkServiceConfig "DuplicateRequest" Core..
      Core.hasStatues 400
...
_LambdaThrottledException
  = Core._MatchServiceError mkServiceConfig "LambdaThrottled" Core..
      Core.hasStatues 429
{-# INLINEABLE _LambdaThrottledException #-}
...
_AlreadyStreamedException
  = Core._MatchServiceError mkServiceConfig "AlreadyStreamed" Core..
      Core.hasStatues 400
{-# INLINEABLE _AlreadyStreamedException #-}
...
_InvalidLambdaFunctionOutputException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidLambdaFunctionOutputException #-}
...
_ResourceConflictException
  = Core._MatchServiceError mkServiceConfig "ResourceConflict" Core..
      Core.hasStatues 409
