...
mkNetworkFirewallMissingSubnetViolation
  = NetworkFirewallMissingSubnetViolation'{availabilityZone =
                                             Core.Nothing,
                                           targetViolationReason = Core.Nothing, vpc = Core.Nothing,
...
{-# INLINEABLE nfmsvAvailabilityZone #-}
...
{-# INLINEABLE nfmsvTargetViolationReason #-}
...
{-# INLINEABLE nfmsvViolationTarget #-}
...
instance Core.FromJSON NetworkFirewallMissingSubnetViolation where
        parseJSON
          = Core.withObject "NetworkFirewallMissingSubnetViolation" Core.$
              \ x ->
                NetworkFirewallMissingSubnetViolation' Core.<$>
