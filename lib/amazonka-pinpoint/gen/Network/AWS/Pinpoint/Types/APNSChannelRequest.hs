...
{-# DEPRECATED apnscrfBundleId "Use generic-lens or generic-optics with 'bundleId' instead." #-}
...
{-# DEPRECATED apnscrfCertificate "Use generic-lens or generic-optics with 'certificate' instead." #-}
...
{-# DEPRECATED apnscrfDefaultAuthenticationMethod "Use generic-lens or generic-optics with 'defaultAuthenticationMethod' instead." #-}
...
{-# DEPRECATED apnscrfEnabled "Use generic-lens or generic-optics with 'enabled' instead." #-}
...
{-# DEPRECATED apnscrfPrivateKey "Use generic-lens or generic-optics with 'privateKey' instead." #-}
...
{-# DEPRECATED apnscrfTeamId "Use generic-lens or generic-optics with 'teamId' instead." #-}
...
{-# DEPRECATED apnscrfTokenKey "Use generic-lens or generic-optics with 'tokenKey' instead." #-}
...
{-# DEPRECATED apnscrfTokenKeyId "Use generic-lens or generic-optics with 'tokenKeyId' instead." #-}
