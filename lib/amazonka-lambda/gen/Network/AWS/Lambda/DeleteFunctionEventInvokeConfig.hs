...
mkDeleteFunctionEventInvokeConfig functionName
  = DeleteFunctionEventInvokeConfig'{functionName,
...
instance Core.ToHeaders DeleteFunctionEventInvokeConfig where
