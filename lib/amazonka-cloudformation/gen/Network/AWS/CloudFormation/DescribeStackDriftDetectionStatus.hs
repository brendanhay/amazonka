...
{-# INLINEABLE dsddsStackDriftDetectionId #-}
{-# DEPRECATED stackDriftDetectionId "Use generic-lens or generic-optics with 'stackDriftDetectionId' instead"  #-}

instance Core.ToQuery DescribeStackDriftDetectionStatus where
        toQuery DescribeStackDriftDetectionStatus{..}
          = Core.toQueryPair "Action"
              ("DescribeStackDriftDetectionStatus" :: Core.Text)
              Core.<> Core.toQueryPair "Version" ("2010-05-15" :: Core.Text)
              Core.<>
              Core.toQueryPair "StackDriftDetectionId" stackDriftDetectionId

instance Core.ToHeaders DescribeStackDriftDetectionStatus where
...
instance Core.AWSRequest DescribeStackDriftDetectionStatus where
        ...
        parseResponse
          = Response.receiveXMLWrapper
              ...
              (\ s h x ->
                 DescribeStackDriftDetectionStatusResponse' Core.<$>
                   (x Core..@ "StackId") Core.<*> x Core..@ "StackDriftDetectionId"
...
mkDescribeStackDriftDetectionStatusResponse
    ...
    -> Types.StackDriftDetectionId -- ^ 'stackDriftDetectionId'
    -> Types.StackDriftDetectionStatus -- ^ 'detectionStatus'
    -> Core.UTCTime -- ^ 'timestamp'
    -> Core.Int -- ^ 'responseStatus'
    -> DescribeStackDriftDetectionStatusResponse
mkDescribeStackDriftDetectionStatusResponse stackId
  stackDriftDetectionId detectionStatus timestamp responseStatus
  = DescribeStackDriftDetectionStatusResponse'{stackId,
                                               stackDriftDetectionId, detectionStatus, timestamp,
                                               detectionStatusReason = Core.Nothing,
                                               driftedStackResourceCount = Core.Nothing,
                                               stackDriftStatus = Core.Nothing, responseStatus}
...
{-# INLINEABLE dsddsrrsStackDriftDetectionId #-}
{-# DEPRECATED stackDriftDetectionId "Use generic-lens or generic-optics with 'stackDriftDetectionId' instead"  #-}
...
{-# INLINEABLE dsddsrrsDetectionStatus #-}
{-# DEPRECATED detectionStatus "Use generic-lens or generic-optics with 'detectionStatus' instead"  #-}
...
{-# INLINEABLE dsddsrrsDetectionStatusReason #-}
{-# DEPRECATED detectionStatusReason "Use generic-lens or generic-optics with 'detectionStatusReason' instead"  #-}
...
{-# INLINEABLE dsddsrrsDriftedStackResourceCount #-}
{-# DEPRECATED driftedStackResourceCount "Use generic-lens or generic-optics with 'driftedStackResourceCount' instead"  #-}
...
{-# INLINEABLE dsddsrrsStackDriftStatus #-}
...
{-# INLINEABLE dsddsrrsResponseStatus #-}
