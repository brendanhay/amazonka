...
{-# INLINEABLE amuExpectedBucketOwner #-}
...
instance Core.AWSRequest AbortMultipartUpload where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 AbortMultipartUploadResponse' Core.<$>
...
mkAbortMultipartUploadResponse responseStatus
  = AbortMultipartUploadResponse'{requestCharged = Core.Nothing,
                                  responseStatus}
...
{-# INLINEABLE amurrsRequestCharged #-}
...
{-# INLINEABLE amurrsResponseStatus #-}
