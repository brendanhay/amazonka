...
mkM3u8Settings
    :: M3u8Settings
mkM3u8Settings
  = M3u8Settings'{audioDuration = Core.Nothing,
                  audioFramesPerPes = Core.Nothing, audioPids = Core.Nothing,
                  nielsenId3 = Core.Nothing, patInterval = Core.Nothing,
                  ...
                  timedMetadata = Core.Nothing, timedMetadataPid = Core.Nothing,
                  transportStreamId = Core.Nothing, videoPid = Core.Nothing}
...
{-# INLINEABLE msAudioFramesPerPes #-}
...
{-# INLINEABLE msPrivateMetadataPid #-}
...
{-# INLINEABLE msTimedMetadata #-}
{-# DEPRECATED timedMetadata "Use generic-lens or generic-optics with 'timedMetadata' instead"  #-}
...
{-# INLINEABLE msTransportStreamId #-}
...
instance Core.FromJSON M3u8Settings where
        parseJSON
          = Core.withObject "M3u8Settings" Core.$
              \ x ->
                M3u8Settings' Core.<$>
                  (x Core..:? "audioDuration") Core.<*>
                    x Core..:? "audioFramesPerPes"
