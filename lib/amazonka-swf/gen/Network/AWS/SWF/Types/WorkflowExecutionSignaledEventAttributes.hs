...
{-# DEPRECATED weseaSignalName "Use generic-lens or generic-optics with 'signalName' instead." #-}
...
{-# DEPRECATED weseaExternalInitiatedEventId "Use generic-lens or generic-optics with 'externalInitiatedEventId' instead." #-}
...
{-# DEPRECATED weseaExternalWorkflowExecution "Use generic-lens or generic-optics with 'externalWorkflowExecution' instead." #-}
...
instance Core.FromJSON WorkflowExecutionSignaledEventAttributes where
  parseJSON =
