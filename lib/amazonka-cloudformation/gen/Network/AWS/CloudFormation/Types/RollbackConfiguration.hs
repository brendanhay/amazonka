...
mkRollbackConfiguration
    :: RollbackConfiguration
mkRollbackConfiguration
  = RollbackConfiguration'{monitoringTimeInMinutes = Core.Nothing,
...
{-# INLINEABLE rcMonitoringTimeInMinutes #-}
{-# DEPRECATED monitoringTimeInMinutes "Use generic-lens or generic-optics with 'monitoringTimeInMinutes' instead"  #-}
...
{-# INLINEABLE rcRollbackTriggers #-}
{-# DEPRECATED rollbackTriggers "Use generic-lens or generic-optics with 'rollbackTriggers' instead"  #-}

instance Core.ToQuery RollbackConfiguration where
        toQuery RollbackConfiguration{..}
          = Core.maybe Core.mempty
              (Core.toQueryPair "MonitoringTimeInMinutes")
              monitoringTimeInMinutes
              Core.<>
              Core.toQueryPair "RollbackTriggers"
...
instance Core.FromXML RollbackConfiguration where
        parseXML x
          = RollbackConfiguration' Core.<$>
              (x Core..@? "MonitoringTimeInMinutes") Core.<*>
                x Core..@? "RollbackTriggers" Core..<@> Core.parseXMLList "member"
