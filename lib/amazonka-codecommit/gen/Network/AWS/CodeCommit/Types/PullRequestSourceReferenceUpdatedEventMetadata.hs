...
{-# INLINEABLE prsruemAfterCommitId #-}
...
{-# INLINEABLE prsruemBeforeCommitId #-}
...
{-# INLINEABLE prsruemRepositoryName #-}
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "PullRequestSourceReferenceUpdatedEventMetadata"
              Core.$
              \ x ->
                PullRequestSourceReferenceUpdatedEventMetadata' Core.<$>
                  (x Core..:? "afterCommitId") Core.<*> x Core..:? "beforeCommitId"
