...
mkCampaignDateRangeKpiResponse
    ...
    -> CampaignDateRangeKpiResponse
mkCampaignDateRangeKpiResponse kpiResult kpiName endTime campaignId
  startTime applicationId
  = CampaignDateRangeKpiResponse'{kpiResult, kpiName, endTime,
                                  campaignId, startTime, applicationId, nextToken = Core.Nothing}
...
instance Core.FromJSON CampaignDateRangeKpiResponse where
        parseJSON
          = Core.withObject "CampaignDateRangeKpiResponse" Core.$
              \ x ->
                CampaignDateRangeKpiResponse' Core.<$>
