...
data MpdSettings = MpdSettings'
  { -- | Use this setting only when you specify SCTE-35 markers from ESAM. Choose INSERT to put SCTE-35 markers in this output at the insertion points that you specify in an ESAM XML document. Provide the document in the setting SCC XML (sccXml).
    scte35Esam :: Lude.Maybe MpdScte35Esam,
    ...
    accessibilityCaptionHints :: Lude.Maybe MpdAccessibilityCaptionHints,
...
msfScte35Esam :: Lens.Lens' MpdSettings (Lude.Maybe MpdScte35Esam)
msfScte35Esam = Lens.lens (scte35Esam :: MpdSettings -> Lude.Maybe MpdScte35Esam) (\s a -> s {scte35Esam = a} :: MpdSettings)
{-# DEPRECATED msfScte35Esam "Use generic-lens or generic-optics with 'scte35Esam' instead." #-}
...
msfAudioDuration :: Lens.Lens' MpdSettings (Lude.Maybe MpdAudioDuration)
msfAudioDuration = Lens.lens (audioDuration :: MpdSettings -> Lude.Maybe MpdAudioDuration) (\s a -> s {audioDuration = a} :: MpdSettings)
{-# DEPRECATED msfAudioDuration "Use generic-lens or generic-optics with 'audioDuration' instead." #-}
...
msfScte35Source :: Lens.Lens' MpdSettings (Lude.Maybe MpdScte35Source)
msfScte35Source = Lens.lens (scte35Source :: MpdSettings -> Lude.Maybe MpdScte35Source) (\s a -> s {scte35Source = a} :: MpdSettings)
{-# DEPRECATED msfScte35Source "Use generic-lens or generic-optics with 'scte35Source' instead." #-}
...
msfAccessibilityCaptionHints :: Lens.Lens' MpdSettings (Lude.Maybe MpdAccessibilityCaptionHints)
msfAccessibilityCaptionHints = Lens.lens (accessibilityCaptionHints :: MpdSettings -> Lude.Maybe MpdAccessibilityCaptionHints) (\s a -> s {accessibilityCaptionHints = a} :: MpdSettings)
{-# DEPRECATED msfAccessibilityCaptionHints "Use generic-lens or generic-optics with 'accessibilityCaptionHints' instead." #-}
...
msfCaptionContainerType :: Lens.Lens' MpdSettings (Lude.Maybe MpdCaptionContainerType)
msfCaptionContainerType = Lens.lens (captionContainerType :: MpdSettings -> Lude.Maybe MpdCaptionContainerType) (\s a -> s {captionContainerType = a} :: MpdSettings)
{-# DEPRECATED msfCaptionContainerType "Use generic-lens or generic-optics with 'captionContainerType' instead." #-}
