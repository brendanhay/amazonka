...
data SetQueueAttributes = SetQueueAttributes'
  { -- | The URL of the Amazon SQS queue whose attributes are set.
    ...
    attributes :: Core.HashMap Types.QueueAttributeName Types.String
  }
...
sqaQueueUrl :: Lens.Lens' SetQueueAttributes Types.String
...
sqaAttributes :: Lens.Lens' SetQueueAttributes (Core.HashMap Types.QueueAttributeName Types.String)
...
instance Core.AWSRequest SetQueueAttributes where
  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqBody =
          Core.toFormBody
            ( Core.pure ("Action", "SetQueueAttributes")
  ...
  response = Response.receiveNull SetQueueAttributesResponse'
