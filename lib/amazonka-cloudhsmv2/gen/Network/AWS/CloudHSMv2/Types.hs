...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CloudHSMv2",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "cloudhsmv2",
                 Core._svcVersion = "2017-04-28", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _CloudHsmInternalFailureException #-}
...
{-# INLINEABLE _CloudHsmServiceException #-}
...
{-# INLINEABLE _CloudHsmInvalidRequestException #-}
...
{-# INLINEABLE _CloudHsmAccessDeniedException #-}
...
{-# INLINEABLE _CloudHsmResourceNotFoundException #-}
...
{-# INLINEABLE _CloudHsmTagException #-}
