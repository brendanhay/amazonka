...
data TaskDefinition = TaskDefinition'
  { -- | The launch type to use with your task. For more information, see <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html Amazon ECS Launch Types> in the /Amazon Elastic Container Service Developer Guide/ .
    ...
    family :: Core.Maybe Types.String,
...
tdCpu :: Lens.Lens' TaskDefinition (Core.Maybe Types.String)
...
tdExecutionRoleArn :: Lens.Lens' TaskDefinition (Core.Maybe Types.String)
...
tdFamily :: Lens.Lens' TaskDefinition (Core.Maybe Types.String)
...
tdMemory :: Lens.Lens' TaskDefinition (Core.Maybe Types.String)
...
tdTaskDefinitionArn :: Lens.Lens' TaskDefinition (Core.Maybe Types.String)
...
tdTaskRoleArn :: Lens.Lens' TaskDefinition (Core.Maybe Types.String)
