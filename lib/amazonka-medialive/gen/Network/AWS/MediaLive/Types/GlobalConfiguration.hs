...
mkGlobalConfiguration
    :: GlobalConfiguration
mkGlobalConfiguration
  = GlobalConfiguration'{initialAudioGain = Core.Nothing,
                         inputEndAction = Core.Nothing, inputLossBehavior = Core.Nothing,
...
{-# INLINEABLE gcInitialAudioGain #-}
{-# DEPRECATED initialAudioGain "Use generic-lens or generic-optics with 'initialAudioGain' instead"  #-}
...
{-# INLINEABLE gcInputEndAction #-}
{-# DEPRECATED inputEndAction "Use generic-lens or generic-optics with 'inputEndAction' instead"  #-}
...
{-# INLINEABLE gcInputLossBehavior #-}
{-# DEPRECATED inputLossBehavior "Use generic-lens or generic-optics with 'inputLossBehavior' instead"  #-}
...
{-# INLINEABLE gcOutputLockingMode #-}
{-# DEPRECATED outputLockingMode "Use generic-lens or generic-optics with 'outputLockingMode' instead"  #-}
...
{-# INLINEABLE gcOutputTimingSource #-}
{-# DEPRECATED outputTimingSource "Use generic-lens or generic-optics with 'outputTimingSource' instead"  #-}
...
{-# INLINEABLE gcSupportLowFramerateInputs #-}
{-# DEPRECATED supportLowFramerateInputs "Use generic-lens or generic-optics with 'supportLowFramerateInputs' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("initialAudioGain" Core..=) Core.<$> initialAudioGain,
                  ...
                  ("supportLowFramerateInputs" Core..=) Core.<$>
          ...
          = Core.withObject "GlobalConfiguration" Core.$
              \ x ->
                GlobalConfiguration' Core.<$>
                  (x Core..:? "initialAudioGain") Core.<*>
                    x Core..:? "inputEndAction"
