...
createUserPool_userPoolTags = Lens.lens (\CreateUserPool' {userPoolTags} -> userPoolTags) (\s@CreateUserPool' {} a -> s {userPoolTags = a} :: CreateUserPool) Prelude.. Lens.mapping Prelude._Coerce

-- | An array of schema attributes for the new user pool. These attributes
-- can be standard or custom attributes.
createUserPool_schema :: Lens.Lens' CreateUserPool (Prelude.Maybe (Prelude.NonEmpty SchemaAttributeType))
createUserPool_schema = Lens.lens (\CreateUserPool' {schema} -> schema) (\s@CreateUserPool' {} a -> s {schema = a} :: CreateUserPool) Prelude.. Lens.mapping Prelude._Coerce

-- | Specifies whether email addresses or phone numbers can be specified as
-- usernames when a user signs up.
createUserPool_usernameAttributes :: Lens.Lens' CreateUserPool (Prelude.Maybe [UsernameAttributeType])
createUserPool_usernameAttributes = Lens.lens (\CreateUserPool' {usernameAttributes} -> usernameAttributes) (\s@CreateUserPool' {} a -> s {usernameAttributes = a} :: CreateUserPool) Prelude.. Lens.mapping Prelude._Coerce
...
createUserPool_autoVerifiedAttributes = Lens.lens (\CreateUserPool' {autoVerifiedAttributes} -> autoVerifiedAttributes) (\s@CreateUserPool' {} a -> s {autoVerifiedAttributes = a} :: CreateUserPool) Prelude.. Lens.mapping Prelude._Coerce
...
createUserPool_aliasAttributes = Lens.lens (\CreateUserPool' {aliasAttributes} -> aliasAttributes) (\s@CreateUserPool' {} a -> s {aliasAttributes = a} :: CreateUserPool) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest CreateUserPool where
...
instance Prelude.ToHeaders CreateUserPool where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AWSCognitoIdentityProviderService.CreateUserPool" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON CreateUserPool where
  toJSON CreateUserPool' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("UserPoolTags" Prelude..=)
              Prelude.<$> userPoolTags,
            ("Schema" Prelude..=) Prelude.<$> schema,
            ("UsernameAttributes" Prelude..=)
              Prelude.<$> usernameAttributes,
            ("EmailVerificationSubject" Prelude..=)
              Prelude.<$> emailVerificationSubject,
            ("AutoVerifiedAttributes" Prelude..=)
              Prelude.<$> autoVerifiedAttributes,
            ("Policies" Prelude..=) Prelude.<$> policies,
            ("AdminCreateUserConfig" Prelude..=)
