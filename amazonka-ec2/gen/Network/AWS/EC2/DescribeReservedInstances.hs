...
-- Reserved Instance (one year or three years), in seconds (@31536000@ |
-- @94608000@). @end@ - The time when the Reserved Instance expires (for
-- example, 2014-08-07T11:54:42.000Z). @fixed-price@ - The purchase price of
-- the Reserved Instance (for example, 9800.0). @instance-type@ - The
...
-- VPC)@). @reserved-instances-id@ - The ID of the Reserved Instance.
-- @start@ - The time at which the Reserved Instance purchase request was
-- placed (for example, 2014-08-07T11:54:42.000Z). @state@ - The state of
-- the Reserved Instance (@pending-payment@ | @active@ | @payment-failed@ |
-- @retired@). @tag@:/key/=/value/ - The key/value combination of a tag
...
-- @tag-key@ filter. @usage-price@ - The usage price of the Reserved
