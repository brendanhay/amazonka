...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "MediaPackage",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "mediapackage",
                 Core._svcVersion = "2017-10-12", Core._svcTimeout = Core.Just 70,
