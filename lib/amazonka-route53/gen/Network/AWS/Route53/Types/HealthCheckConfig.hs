...
instance Core.ToXML HealthCheckConfig where
  toXML HealthCheckConfig {..} =
    Core.toXMLNode "Type" type'
      Core.<> Core.toXMLNode "AlarmIdentifier"
      Core.<$> alarmIdentifier
      Core.<> Core.toXMLNode
        "ChildHealthChecks"
      ...
      Core.<$> inverted
      Core.<> Core.toXMLNode "MeasureLatency"
      Core.<$> measureLatency
      Core.<> Core.toXMLNode "Port"
      Core.<$> port
      Core.<> Core.toXMLNode "Regions" (Core.toXMLList "Region" Core.<$> regions)
      Core.<> Core.toXMLNode "RequestInterval"
      Core.<$> requestInterval
...
instance Core.FromXML HealthCheckConfig where
  parseXML x =
    HealthCheckConfig'
      ...
      Core.<*> ( x Core..@? "ChildHealthChecks"
                   Core..<@> Core.parseXMLList "ChildHealthCheck"
               )
      ...
      Core.<*> (x Core..@? "Port")
      Core.<*> (x Core..@? "Regions" Core..<@> Core.parseXMLNonEmpty "Region")
