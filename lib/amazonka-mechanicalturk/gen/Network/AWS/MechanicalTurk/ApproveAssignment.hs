...
mkApproveAssignment assignmentId
  = ApproveAssignment'{assignmentId,
                       overrideRejection = Core.Nothing, requesterFeedback = Core.Nothing}
...
{-# INLINEABLE aaOverrideRejection #-}
{-# DEPRECATED overrideRejection "Use generic-lens or generic-optics with 'overrideRejection' instead"  #-}
...
aaRequesterFeedback :: Lens.Lens' ApproveAssignment (Core.Maybe Core.Text)
aaRequesterFeedback = Lens.field @"requesterFeedback"
{-# INLINEABLE aaRequesterFeedback #-}
