...
mkInstanceStatusEvent
    :: InstanceStatusEvent
mkInstanceStatusEvent
  = InstanceStatusEvent'{code = Core.Nothing,
                         description = Core.Nothing, instanceEventId = Core.Nothing,
...
iseDescription :: Lens.Lens' InstanceStatusEvent (Core.Maybe Core.Text)
iseDescription = Lens.field @"description"
{-# INLINEABLE iseDescription #-}
...
{-# INLINEABLE iseNotBeforeDeadline #-}
{-# DEPRECATED notBeforeDeadline "Use generic-lens or generic-optics with 'notBeforeDeadline' instead"  #-}

instance Core.FromXML InstanceStatusEvent where
        parseXML x
          = InstanceStatusEvent' Core.<$>
              (x Core..@? "code") Core.<*> x Core..@? "description" Core.<*>
                x Core..@? "instanceEventId"
