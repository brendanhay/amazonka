...
instance AWSRequest PurchaseReservedElasticsearchInstanceOffering where
  type
...
instance Hashable PurchaseReservedElasticsearchInstanceOffering

instance NFData PurchaseReservedElasticsearchInstanceOffering

instance ToHeaders PurchaseReservedElasticsearchInstanceOffering where
  toHeaders = const mempty

instance ToJSON PurchaseReservedElasticsearchInstanceOffering where
...
instance ToPath PurchaseReservedElasticsearchInstanceOffering where
  toPath = const "/2015-01-01/es/purchaseReservedInstanceOffering"

instance ToQuery PurchaseReservedElasticsearchInstanceOffering where
...
data PurchaseReservedElasticsearchInstanceOfferingResponse = PurchaseReservedElasticsearchInstanceOfferingResponse'
  { _preiorsReservedElasticsearchInstanceId ::
      !( Maybe
           Text
       ),
