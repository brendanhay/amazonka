...
mkListJobsByPipeline pipelineId
  = ListJobsByPipeline'{pipelineId, ascending = Core.Nothing,
...
instance Core.AWSRequest ListJobsByPipeline where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListJobsByPipelineResponse' Core.<$>
...
mkListJobsByPipelineResponse responseStatus
  = ListJobsByPipelineResponse'{jobs = Core.Nothing,
...
{-# INLINEABLE ljbprrsNextPageToken #-}
...
{-# INLINEABLE ljbprrsResponseStatus #-}
