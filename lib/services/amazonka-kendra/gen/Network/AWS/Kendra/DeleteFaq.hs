...
-- |
-- Module      : Network.AWS.Kendra.DeleteFaq
...
--
-- 'id', 'deleteFaq_id' - The identifier of the FAQ to remove.
--
-- 'indexId', 'deleteFaq_indexId' - The index to remove the FAQ from.
newDeleteFaq ::
  -- | 'id'
  Prelude.Text ->
  -- | 'indexId'
...
instance Prelude.Hashable DeleteFaq

instance Prelude.NFData DeleteFaq
...
instance Prelude.NFData DeleteFaqResponse
