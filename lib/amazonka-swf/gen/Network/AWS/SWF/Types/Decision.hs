...
{-# INLINEABLE dDecisionType #-}
{-# DEPRECATED decisionType "Use generic-lens or generic-optics with 'decisionType' instead"  #-}
...
{-# INLINEABLE dCancelTimerDecisionAttributes #-}
{-# DEPRECATED cancelTimerDecisionAttributes "Use generic-lens or generic-optics with 'cancelTimerDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dCancelWorkflowExecutionDecisionAttributes #-}
{-# DEPRECATED cancelWorkflowExecutionDecisionAttributes "Use generic-lens or generic-optics with 'cancelWorkflowExecutionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dCompleteWorkflowExecutionDecisionAttributes #-}
{-# DEPRECATED completeWorkflowExecutionDecisionAttributes "Use generic-lens or generic-optics with 'completeWorkflowExecutionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dContinueAsNewWorkflowExecutionDecisionAttributes #-}
{-# DEPRECATED continueAsNewWorkflowExecutionDecisionAttributes "Use generic-lens or generic-optics with 'continueAsNewWorkflowExecutionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dFailWorkflowExecutionDecisionAttributes #-}
{-# DEPRECATED failWorkflowExecutionDecisionAttributes "Use generic-lens or generic-optics with 'failWorkflowExecutionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dRecordMarkerDecisionAttributes #-}
{-# DEPRECATED recordMarkerDecisionAttributes "Use generic-lens or generic-optics with 'recordMarkerDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dRequestCancelActivityTaskDecisionAttributes #-}
{-# DEPRECATED requestCancelActivityTaskDecisionAttributes "Use generic-lens or generic-optics with 'requestCancelActivityTaskDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dRequestCancelExternalWorkflowExecutionDecisionAttributes #-}
{-# DEPRECATED requestCancelExternalWorkflowExecutionDecisionAttributes "Use generic-lens or generic-optics with 'requestCancelExternalWorkflowExecutionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dScheduleActivityTaskDecisionAttributes #-}
{-# DEPRECATED scheduleActivityTaskDecisionAttributes "Use generic-lens or generic-optics with 'scheduleActivityTaskDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dScheduleLambdaFunctionDecisionAttributes #-}
{-# DEPRECATED scheduleLambdaFunctionDecisionAttributes "Use generic-lens or generic-optics with 'scheduleLambdaFunctionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dSignalExternalWorkflowExecutionDecisionAttributes #-}
{-# DEPRECATED signalExternalWorkflowExecutionDecisionAttributes "Use generic-lens or generic-optics with 'signalExternalWorkflowExecutionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dStartChildWorkflowExecutionDecisionAttributes #-}
{-# DEPRECATED startChildWorkflowExecutionDecisionAttributes "Use generic-lens or generic-optics with 'startChildWorkflowExecutionDecisionAttributes' instead"  #-}
...
{-# INLINEABLE dStartTimerDecisionAttributes #-}
{-# DEPRECATED startTimerDecisionAttributes "Use generic-lens or generic-optics with 'startTimerDecisionAttributes' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("decisionType" Core..= decisionType),
                  ("cancelTimerDecisionAttributes" Core..=) Core.<$>
                    cancelTimerDecisionAttributes,
                  ("cancelWorkflowExecutionDecisionAttributes" Core..=) Core.<$>
                    cancelWorkflowExecutionDecisionAttributes,
                  ("completeWorkflowExecutionDecisionAttributes" Core..=) Core.<$>
                    completeWorkflowExecutionDecisionAttributes,
                  ("continueAsNewWorkflowExecutionDecisionAttributes" Core..=)
                    Core.<$> continueAsNewWorkflowExecutionDecisionAttributes,
                  ("failWorkflowExecutionDecisionAttributes" Core..=) Core.<$>
                    failWorkflowExecutionDecisionAttributes,
                  ("recordMarkerDecisionAttributes" Core..=) Core.<$>
                    recordMarkerDecisionAttributes,
                  ("requestCancelActivityTaskDecisionAttributes" Core..=) Core.<$>
                    requestCancelActivityTaskDecisionAttributes,
                  ("requestCancelExternalWorkflowExecutionDecisionAttributes"
                     Core..=)
                    Core.<$> requestCancelExternalWorkflowExecutionDecisionAttributes,
                  ("scheduleActivityTaskDecisionAttributes" Core..=) Core.<$>
                    scheduleActivityTaskDecisionAttributes,
                  ("scheduleLambdaFunctionDecisionAttributes" Core..=) Core.<$>
                    scheduleLambdaFunctionDecisionAttributes,
                  ("signalExternalWorkflowExecutionDecisionAttributes" Core..=)
                    Core.<$> signalExternalWorkflowExecutionDecisionAttributes,
                  ("startChildWorkflowExecutionDecisionAttributes" Core..=) Core.<$>
                    startChildWorkflowExecutionDecisionAttributes,
                  ("startTimerDecisionAttributes" Core..=) Core.<$>
                    startTimerDecisionAttributes])
