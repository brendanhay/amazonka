...
mkReplicaGlobalSecondaryIndexDescription
    :: ReplicaGlobalSecondaryIndexDescription
mkReplicaGlobalSecondaryIndexDescription
  = ReplicaGlobalSecondaryIndexDescription'{indexName = Core.Nothing,
...
{-# INLINEABLE rgsidProvisionedThroughputOverride #-}
...
instance Core.FromJSON ReplicaGlobalSecondaryIndexDescription where
        parseJSON
          = Core.withObject "ReplicaGlobalSecondaryIndexDescription" Core.$
              \ x ->
                ReplicaGlobalSecondaryIndexDescription' Core.<$>
                  (x Core..:? "IndexName") Core.<*>
                    x Core..:? "ProvisionedThroughputOverride"
