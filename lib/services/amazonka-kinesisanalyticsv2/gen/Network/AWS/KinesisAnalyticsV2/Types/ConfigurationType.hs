...
-- |
-- Module      : Network.AWS.KinesisAnalyticsV2.Types.ConfigurationType
...
pattern ConfigurationType_CUSTOM = ConfigurationType' "CUSTOM"

pattern ConfigurationType_DEFAULT :: ConfigurationType
pattern ConfigurationType_DEFAULT = ConfigurationType' "DEFAULT"
