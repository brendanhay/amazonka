...
mkKeyPhrase
    :: KeyPhrase
mkKeyPhrase
  = KeyPhrase'{beginOffset = Core.Nothing, endOffset = Core.Nothing,
               score = Core.Nothing, text = Core.Nothing}
...
kpText :: Lens.Lens' KeyPhrase (Core.Maybe Core.Text)
