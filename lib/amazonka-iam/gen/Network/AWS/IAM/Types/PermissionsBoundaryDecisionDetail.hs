...
{-# INLINEABLE pbddAllowedByPermissionsBoundary #-}
{-# DEPRECATED allowedByPermissionsBoundary "Use generic-lens or generic-optics with 'allowedByPermissionsBoundary' instead"  #-}

instance Core.FromXML PermissionsBoundaryDecisionDetail where
        parseXML x
          = PermissionsBoundaryDecisionDetail' Core.<$>
              (x Core..@? "AllowedByPermissionsBoundary")
