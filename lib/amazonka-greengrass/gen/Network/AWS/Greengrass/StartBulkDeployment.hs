...
mkStartBulkDeployment
    :: Core.Text -- ^ 'executionRoleArn'
    -> Core.Text -- ^ 'inputFileUri'
    -> StartBulkDeployment
mkStartBulkDeployment executionRoleArn inputFileUri
  = StartBulkDeployment'{executionRoleArn, inputFileUri,
                         amznClientToken = Core.Nothing, tags = Core.Nothing}
...
{-# INLINEABLE sbdExecutionRoleArn #-}
...
{-# INLINEABLE sbdInputFileUri #-}
{-# DEPRECATED inputFileUri "Use generic-lens or generic-optics with 'inputFileUri' instead"  #-}
...
instance Core.AWSRequest StartBulkDeployment where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartBulkDeploymentResponse' Core.<$>
                   (x Core..:? "BulkDeploymentArn") Core.<*>
                     x Core..:? "BulkDeploymentId"
...
mkStartBulkDeploymentResponse responseStatus
  = StartBulkDeploymentResponse'{bulkDeploymentArn = Core.Nothing,
                                 bulkDeploymentId = Core.Nothing, responseStatus}
...
{-# INLINEABLE srsBulkDeploymentArn #-}
{-# DEPRECATED bulkDeploymentArn "Use generic-lens or generic-optics with 'bulkDeploymentArn' instead"  #-}
...
{-# INLINEABLE srsBulkDeploymentId #-}
