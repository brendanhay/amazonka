...
data LoadBalancer = LoadBalancer'
  ...
  , configurationOptions :: Core.Maybe (Core.HashMap Types.LoadBalancerAttributeName Core.Text)
...
mkLoadBalancer
    :: LoadBalancer
mkLoadBalancer
  = LoadBalancer'{arn = Core.Nothing,
                  configurationOptions = Core.Nothing, createdAt = Core.Nothing,
                  dnsName = Core.Nothing, healthCheckPath = Core.Nothing,
                  instanceHealthSummary = Core.Nothing, instancePort = Core.Nothing,
                  location = Core.Nothing, name = Core.Nothing,
                  protocol = Core.Nothing, publicPorts = Core.Nothing,
...
lbConfigurationOptions :: Lens.Lens' LoadBalancer (Core.Maybe (Core.HashMap Types.LoadBalancerAttributeName Core.Text))
lbConfigurationOptions = Lens.field @"configurationOptions"
{-# INLINEABLE lbConfigurationOptions #-}
{-# DEPRECATED configurationOptions "Use generic-lens or generic-optics with 'configurationOptions' instead"  #-}
...
{-# INLINEABLE lbInstanceHealthSummary #-}
{-# DEPRECATED instanceHealthSummary "Use generic-lens or generic-optics with 'instanceHealthSummary' instead"  #-}
...
{-# INLINEABLE lbPublicPorts #-}
{-# DEPRECATED publicPorts "Use generic-lens or generic-optics with 'publicPorts' instead"  #-}
...
lbSupportCode :: Lens.Lens' LoadBalancer (Core.Maybe Core.Text)
lbSupportCode = Lens.field @"supportCode"
{-# INLINEABLE lbSupportCode #-}
...
{-# INLINEABLE lbTlsCertificateSummaries #-}
{-# DEPRECATED tlsCertificateSummaries "Use generic-lens or generic-optics with 'tlsCertificateSummaries' instead"  #-}
...
instance Core.FromJSON LoadBalancer where
        parseJSON
          = Core.withObject "LoadBalancer" Core.$
              \ x ->
                LoadBalancer' Core.<$>
                  (x Core..:? "arn") Core.<*> x Core..:? "configurationOptions"
