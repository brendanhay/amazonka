...
data H264Settings = H264Settings'
  { unregisteredSeiTimecode ::
      Lude.Maybe H264UnregisteredSeiTimecode,
    qualityTuningLevel :: Lude.Maybe H264QualityTuningLevel,
    temporalAdaptiveQuantization ::
      Lude.Maybe H264TemporalAdaptiveQuantization,
    ...
    flickerAdaptiveQuantization ::
      Lude.Maybe H264FlickerAdaptiveQuantization,
    ...
    framerateConversionAlgorithm ::
      Lude.Maybe H264FramerateConversionAlgorithm,
    ...
    spatialAdaptiveQuantization ::
      Lude.Maybe H264SpatialAdaptiveQuantization
  }
  deriving stock
    ( Lude.Eq,
      Lude.Ord,
