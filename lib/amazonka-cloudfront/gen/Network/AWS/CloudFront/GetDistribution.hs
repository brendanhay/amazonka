...
gdId :: Lens.Lens' GetDistribution Core.Text
gdId = Lens.field @"id"
{-# INLINEABLE gdId #-}
...
mkGetDistributionResponse responseStatus
  = GetDistributionResponse'{distribution = Core.Nothing,
