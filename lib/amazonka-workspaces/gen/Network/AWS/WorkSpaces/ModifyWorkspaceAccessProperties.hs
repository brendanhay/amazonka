...
mkModifyWorkspaceAccessProperties
    ...
    -> Types.WorkspaceAccessProperties -- ^ 'workspaceAccessProperties'
    -> ModifyWorkspaceAccessProperties
mkModifyWorkspaceAccessProperties resourceId
  workspaceAccessProperties
  = ModifyWorkspaceAccessProperties'{resourceId,
                                     workspaceAccessProperties}
...
{-# INLINEABLE mwapWorkspaceAccessProperties #-}
...
instance Core.ToHeaders ModifyWorkspaceAccessProperties where
        toHeaders ModifyWorkspaceAccessProperties{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest ModifyWorkspaceAccessProperties where
        type Rs ModifyWorkspaceAccessProperties =
             ModifyWorkspaceAccessPropertiesResponse
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 ModifyWorkspaceAccessPropertiesResponse' Core.<$>
...
{-# INLINEABLE mwaprrsResponseStatus #-}
