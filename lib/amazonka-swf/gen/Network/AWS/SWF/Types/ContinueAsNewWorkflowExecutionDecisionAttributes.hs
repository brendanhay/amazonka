...
{-# INLINEABLE canwedaExecutionStartToCloseTimeout #-}
...
{-# INLINEABLE canwedaTaskPriority #-}
...
{-# INLINEABLE canwedaTaskStartToCloseTimeout #-}
...
{-# INLINEABLE canwedaWorkflowTypeVersion #-}
{-# DEPRECATED workflowTypeVersion "Use generic-lens or generic-optics with 'workflowTypeVersion' instead"  #-}
