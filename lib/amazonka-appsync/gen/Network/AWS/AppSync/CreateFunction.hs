...
createFunction ::
  ...
  Text ->
  CreateFunction
createFunction pApiId_ pName_ pDataSourceName_ pFunctionVersion_ =
  CreateFunction'
...
instance ToJSON CreateFunction where
  toJSON CreateFunction' {..} =
    object
      ( catMaybes
          [ ("requestMappingTemplate" .=) <$> _cfRequestMappingTemplate,
            ("responseMappingTemplate" .=) <$> _cfResponseMappingTemplate,
