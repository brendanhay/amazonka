...
mkActionTypeSettings
    :: ActionTypeSettings
mkActionTypeSettings
  = ActionTypeSettings'{entityUrlTemplate = Core.Nothing,
...
{-# INLINEABLE atsEntityUrlTemplate #-}
{-# DEPRECATED entityUrlTemplate "Use generic-lens or generic-optics with 'entityUrlTemplate' instead"  #-}
...
{-# INLINEABLE atsExecutionUrlTemplate #-}
{-# DEPRECATED executionUrlTemplate "Use generic-lens or generic-optics with 'executionUrlTemplate' instead"  #-}
...
{-# INLINEABLE atsRevisionUrlTemplate #-}
{-# DEPRECATED revisionUrlTemplate "Use generic-lens or generic-optics with 'revisionUrlTemplate' instead"  #-}
...
{-# INLINEABLE atsThirdPartyConfigurationUrl #-}
{-# DEPRECATED thirdPartyConfigurationUrl "Use generic-lens or generic-optics with 'thirdPartyConfigurationUrl' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("entityUrlTemplate" Core..=) Core.<$> entityUrlTemplate,
                  ...
                  ("thirdPartyConfigurationUrl" Core..=) Core.<$>
...
instance Core.FromJSON ActionTypeSettings where
        parseJSON
          = Core.withObject "ActionTypeSettings" Core.$
              \ x ->
                ActionTypeSettings' Core.<$>
                  (x Core..:? "entityUrlTemplate") Core.<*>
                    x Core..:? "executionUrlTemplate"
