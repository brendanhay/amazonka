...
mkGPSPointDimension
    :: Types.GPSCoordinates -- ^ 'coordinates'
    -> GPSPointDimension
...
{-# INLINEABLE gpspdCoordinates #-}
{-# DEPRECATED coordinates "Use generic-lens or generic-optics with 'coordinates' instead"  #-}
...
{-# INLINEABLE gpspdRangeInKilometers #-}
{-# DEPRECATED rangeInKilometers "Use generic-lens or generic-optics with 'rangeInKilometers' instead"  #-}
...
instance Core.FromJSON GPSPointDimension where
        parseJSON
          = Core.withObject "GPSPointDimension" Core.$
              \ x ->
                GPSPointDimension' Core.<$>
                  (x Core..: "Coordinates") Core.<*> x Core..:? "RangeInKilometers"
