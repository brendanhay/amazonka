...
{-# INLINEABLE eoUseAwsOwnedKey #-}
{-# DEPRECATED useAwsOwnedKey "Use generic-lens or generic-optics with 'useAwsOwnedKey' instead"  #-}
          ...
          = Core.withObject "EncryptionOptions" Core.$
              \ x ->
                EncryptionOptions' Core.<$>
                  (x Core..: "useAwsOwnedKey") Core.<*> x Core..:? "kmsKeyId"
