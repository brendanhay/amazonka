...
-- |
-- Module      : Network.AWS.EventBridge.Types
...
import Network.AWS.EventBridge.Types.Product
import Network.AWS.EventBridge.Types.Sum
...
eventBridge =
  Service
    { _svcAbbrev = "EventBridge"
    , _svcSigner = v4
    , _svcPrefix = "events"
    , _svcVersion = "2015-10-07"
    , _svcEndpoint = defaultEndpoint eventBridge
    , _svcTimeout = Just 70
    , _svcCheck = statusSuccess
    , _svcError = parseJSONError "EventBridge"
    , _svcRetry = retry
    }
  where
    retry =
...
_ManagedRuleException = _MatchServiceError eventBridge "ManagedRuleException"
...
_PolicyLengthExceededException =
  _MatchServiceError eventBridge "PolicyLengthExceededException"
...
_ResourceAlreadyExistsException =
  _MatchServiceError eventBridge "ResourceAlreadyExistsException"
...
_ConcurrentModificationException =
  _MatchServiceError eventBridge "ConcurrentModificationException"
...
_InvalidEventPatternException =
  _MatchServiceError eventBridge "InvalidEventPatternException"
...
_InternalException = _MatchServiceError eventBridge "InternalException"
...
_ResourceNotFoundException =
  _MatchServiceError eventBridge "ResourceNotFoundException"
...
_InvalidStateException = _MatchServiceError eventBridge "InvalidStateException"
...
_LimitExceededException =
  _MatchServiceError eventBridge "LimitExceededException"
