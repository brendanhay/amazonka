...
{-# INLINEABLE prmscemDestinationReference #-}
...
{-# INLINEABLE prmscemMergeMetadata #-}
...
{-# INLINEABLE prmscemRepositoryName #-}
{-# DEPRECATED repositoryName "Use generic-lens or generic-optics with 'repositoryName' instead"  #-}

instance Core.FromJSON PullRequestMergedStateChangedEventMetadata
         where
        parseJSON
          = Core.withObject "PullRequestMergedStateChangedEventMetadata"
              Core.$
              \ x ->
                PullRequestMergedStateChangedEventMetadata' Core.<$>
                  (x Core..:? "destinationReference") Core.<*>
                    x Core..:? "mergeMetadata"
