...
pmeKey :: Lens.Lens' ParameterMapEntry (Core.Maybe Core.Text)
...
pmeValues :: Lens.Lens' ParameterMapEntry (Core.Maybe [Core.Text])
pmeValues = Lens.field @"values"
{-# INLINEABLE pmeValues #-}
