...
mkGetApplicationDateRangeKpi applicationId kpiName
  = GetApplicationDateRangeKpi'{applicationId, kpiName,
...
instance Core.ToHeaders GetApplicationDateRangeKpi where
        toHeaders GetApplicationDateRangeKpi{..}
...
instance Core.AWSRequest GetApplicationDateRangeKpi where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetApplicationDateRangeKpiResponse' Core.<$>
...
mkGetApplicationDateRangeKpiResponse
    :: Types.ApplicationDateRangeKpiResponse -- ^ 'applicationDateRangeKpiResponse'
    -> Core.Int -- ^ 'responseStatus'
    -> GetApplicationDateRangeKpiResponse
mkGetApplicationDateRangeKpiResponse
  applicationDateRangeKpiResponse responseStatus
...
{-# INLINEABLE gadrkrrsApplicationDateRangeKpiResponse #-}
{-# DEPRECATED applicationDateRangeKpiResponse "Use generic-lens or generic-optics with 'applicationDateRangeKpiResponse' instead"  #-}
...
{-# INLINEABLE gadrkrrsResponseStatus #-}
