...
mkEvent
    :: Event
mkEvent
  = Event'{arn = Core.Nothing, availabilityZone = Core.Nothing,
           endTime = Core.Nothing, eventScopeCode = Core.Nothing,
           eventTypeCategory = Core.Nothing, eventTypeCode = Core.Nothing,
           lastUpdatedTime = Core.Nothing, region = Core.Nothing,
           service = Core.Nothing, startTime = Core.Nothing,
...
instance Core.FromJSON Event where
        parseJSON
          = Core.withObject "Event" Core.$
              \ x ->
                Event' Core.<$>
                  (x Core..:? "arn") Core.<*> x Core..:? "availabilityZone" Core.<*>
                    x Core..:? "endTime"
