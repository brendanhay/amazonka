...
mkActionExecutionResult
    :: ActionExecutionResult
mkActionExecutionResult
  = ActionExecutionResult'{externalExecutionId = Core.Nothing,
...
{-# INLINEABLE aerExternalExecutionId #-}
...
{-# INLINEABLE aerExternalExecutionSummary #-}
{-# DEPRECATED externalExecutionSummary "Use generic-lens or generic-optics with 'externalExecutionSummary' instead"  #-}
...
{-# INLINEABLE aerExternalExecutionUrl #-}
...
instance Core.FromJSON ActionExecutionResult where
        parseJSON
          = Core.withObject "ActionExecutionResult" Core.$
              \ x ->
                ActionExecutionResult' Core.<$>
                  (x Core..:? "externalExecutionId") Core.<*>
                    x Core..:? "externalExecutionSummary"
