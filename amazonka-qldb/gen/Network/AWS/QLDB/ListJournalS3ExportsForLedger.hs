...
instance
  ...
  where
  type
    Rs ListJournalS3ExportsForLedger =
      ListJournalS3ExportsForLedgerResponse
...
instance Prelude.ToPath ListJournalS3ExportsForLedger where
...
listJournalS3ExportsForLedgerResponse_journalS3Exports = Lens.lens (\ListJournalS3ExportsForLedgerResponse' {journalS3Exports} -> journalS3Exports) (\s@ListJournalS3ExportsForLedgerResponse' {} a -> s {journalS3Exports = a} :: ListJournalS3ExportsForLedgerResponse) Prelude.. Lens.mapping Prelude._Coerce
