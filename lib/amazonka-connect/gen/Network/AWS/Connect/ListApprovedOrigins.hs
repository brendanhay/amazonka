...
mkListApprovedOrigins instanceId
  = ListApprovedOrigins'{instanceId, maxResults = Core.Nothing,
...
instance Core.AWSRequest ListApprovedOrigins where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListApprovedOriginsResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "Origins" Core.<*>
...
mkListApprovedOriginsResponse responseStatus
  = ListApprovedOriginsResponse'{nextToken = Core.Nothing,
                                 origins = Core.Nothing, responseStatus}
...
{-# INLINEABLE laorrsResponseStatus #-}
