...
mkJobUpdate
    :: JobUpdate
mkJobUpdate
  = JobUpdate'{allocatedCapacity = Core.Nothing,
               command = Core.Nothing, connections = Core.Nothing,
...
{-# INLINEABLE juAllocatedCapacity #-}
...
{-# INLINEABLE juExecutionProperty #-}
...
{-# INLINEABLE juNonOverridableArguments #-}
...
{-# INLINEABLE juNotificationProperty #-}
...
{-# INLINEABLE juSecurityConfiguration #-}
