...
mkIncreaseNodeGroupsInGlobalReplicationGroup
  ...
  = IncreaseNodeGroupsInGlobalReplicationGroup'{globalReplicationGroupId,
...
ingigrgGlobalReplicationGroupId :: Lens.Lens' IncreaseNodeGroupsInGlobalReplicationGroup Core.Text
ingigrgGlobalReplicationGroupId = Lens.field @"globalReplicationGroupId"
{-# INLINEABLE ingigrgGlobalReplicationGroupId #-}
...
{-# INLINEABLE ingigrgNodeGroupCount #-}
...
{-# INLINEABLE ingigrgApplyImmediately #-}
...
{-# INLINEABLE ingigrgRegionalConfigurations #-}
{-# DEPRECATED regionalConfigurations "Use generic-lens or generic-optics with 'regionalConfigurations' instead"  #-}

instance Core.ToQuery IncreaseNodeGroupsInGlobalReplicationGroup
         where
        toQuery IncreaseNodeGroupsInGlobalReplicationGroup{..}
          = Core.toQueryPair "Action"
              ("IncreaseNodeGroupsInGlobalReplicationGroup" :: Core.Text)
              ...
              Core.<>
              Core.toQueryPair "RegionalConfigurations"
                (Core.maybe Core.mempty (Core.toQueryList "RegionalConfiguration")
                   regionalConfigurations)

instance Core.ToHeaders IncreaseNodeGroupsInGlobalReplicationGroup
         where
        toHeaders _ = Core.pure Core.mempty

instance Core.AWSRequest IncreaseNodeGroupsInGlobalReplicationGroup
         where
        ...
        parseResponse
          = Response.receiveXMLWrapper
              ...
              (\ s h x ->
                 IncreaseNodeGroupsInGlobalReplicationGroupResponse' Core.<$>
...
{-# INLINEABLE ingigrgrrsGlobalReplicationGroup #-}
...
{-# INLINEABLE ingigrgrrsResponseStatus #-}
