...
{-# INLINEABLE stjTransformJobName #-}
...
instance Core.ToHeaders StopTransformJob where
        toHeaders StopTransformJob{..}
          = Core.pure ("X-Amz-Target", "SageMaker.StopTransformJob") Core.<>
...
instance Core.AWSRequest StopTransformJob where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull StopTransformJobResponse'
