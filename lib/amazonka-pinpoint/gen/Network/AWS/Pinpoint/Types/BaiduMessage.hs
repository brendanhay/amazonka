...
mkBaiduMessage
    :: BaiduMessage
mkBaiduMessage
  = BaiduMessage'{action = Core.Nothing, body = Core.Nothing,
                  data' = Core.Nothing, iconReference = Core.Nothing,
                  imageIconUrl = Core.Nothing, imageUrl = Core.Nothing,
                  rawContent = Core.Nothing, silentPush = Core.Nothing,
                  smallImageIconUrl = Core.Nothing, sound = Core.Nothing,
                  substitutions = Core.Nothing, timeToLive = Core.Nothing,
...
{-# INLINEABLE bmSmallImageIconUrl #-}
