...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "S3", Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "s3", Core._svcVersion = "2006-03-01",
...
{-# INLINEABLE _BucketAlreadyOwnedByYou #-}
...
{-# INLINEABLE _ObjectAlreadyInActiveTierError #-}
...
{-# INLINEABLE _BucketAlreadyExists #-}
...
{-# INLINEABLE _ObjectNotInActiveTierError #-}
...
{-# INLINEABLE _InvalidObjectState #-}
