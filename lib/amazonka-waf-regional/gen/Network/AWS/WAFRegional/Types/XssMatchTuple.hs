...
-- | Creates a 'XssMatchTuple' value with any optional fields omitted.
mkXssMatchTuple
    :: Types.FieldToMatch -- ^ 'fieldToMatch'
    -> Types.TextTransformation -- ^ 'textTransformation'
    -> XssMatchTuple
mkXssMatchTuple fieldToMatch textTransformation
...
xmtFieldToMatch :: Lens.Lens' XssMatchTuple Types.FieldToMatch
xmtFieldToMatch = Lens.field @"fieldToMatch"
{-# INLINEABLE xmtFieldToMatch #-}
...
xmtTextTransformation :: Lens.Lens' XssMatchTuple Types.TextTransformation
xmtTextTransformation = Lens.field @"textTransformation"
{-# INLINEABLE xmtTextTransformation #-}
...
instance Core.FromJSON XssMatchTuple where
        parseJSON
          = Core.withObject "XssMatchTuple" Core.$
              \ x ->
                XssMatchTuple' Core.<$>
