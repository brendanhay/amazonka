...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CloudWatchLogs",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "logs",
                 Core._svcVersion = "2014-03-28", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _InvalidSequenceTokenException #-}
...
{-# INLINEABLE _UnrecognizedClientException #-}
...
{-# INLINEABLE _OperationAbortedException #-}
...
{-# INLINEABLE _MalformedQueryException #-}
...
{-# INLINEABLE _DataAlreadyAcceptedException #-}
