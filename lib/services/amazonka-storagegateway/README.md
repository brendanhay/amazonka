...
`2.0` - Derived from API version @2013-06-30@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.StorageGateway](http://hackage.haskell.org/package/amazonka-storagegateway/docs/Network-AWS-StorageGateway.html)
