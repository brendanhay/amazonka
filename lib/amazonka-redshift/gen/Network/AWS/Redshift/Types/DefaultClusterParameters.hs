...
mkDefaultClusterParameters
    :: DefaultClusterParameters
mkDefaultClusterParameters
  = DefaultClusterParameters'{marker = Core.Nothing,
                              parameterGroupFamily = Core.Nothing, parameters = Core.Nothing}

-- | A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned marker value in the @Marker@ parameter and retrying the command. If the @Marker@ field is empty, all response records have been retrieved for the request. 
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dcpMarker :: Lens.Lens' DefaultClusterParameters (Core.Maybe Core.Text)
...
dcpParameterGroupFamily :: Lens.Lens' DefaultClusterParameters (Core.Maybe Core.Text)
dcpParameterGroupFamily = Lens.field @"parameterGroupFamily"
{-# INLINEABLE dcpParameterGroupFamily #-}
...
{-# INLINEABLE dcpParameters #-}
{-# DEPRECATED parameters "Use generic-lens or generic-optics with 'parameters' instead"  #-}

instance Core.FromXML DefaultClusterParameters where
        parseXML x
          = DefaultClusterParameters' Core.<$>
              (x Core..@? "Marker") Core.<*> x Core..@? "ParameterGroupFamily"
                Core.<*>
