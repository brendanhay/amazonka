...
mkResourceChange
    :: ResourceChange
mkResourceChange
  = ResourceChange'{action = Core.Nothing,
                    changeSetId = Core.Nothing, details = Core.Nothing,
                    logicalResourceId = Core.Nothing, moduleInfo = Core.Nothing,
...
instance Core.FromXML ResourceChange where
        parseXML x
          = ResourceChange' Core.<$>
              (x Core..@? "Action") Core.<*> x Core..@? "ChangeSetId" Core.<*>
                x Core..@? "Details" Core..<@> Core.parseXMLList "member"
