...
data MetadataProperties = MetadataProperties'
  { -- | The entity this entity was generated by.
    generatedBy :: Core.Maybe Core.Text,
    -- | The commit ID.
...
-- | The entity this entity was generated by.
metadataProperties_generatedBy :: Lens.Lens' MetadataProperties (Core.Maybe Core.Text)
...
-- | The commit ID.
metadataProperties_commitId :: Lens.Lens' MetadataProperties (Core.Maybe Core.Text)
...
-- | The project ID.
metadataProperties_projectId :: Lens.Lens' MetadataProperties (Core.Maybe Core.Text)
...
-- | The repository.
metadataProperties_repository :: Lens.Lens' MetadataProperties (Core.Maybe Core.Text)
...
instance Core.FromJSON MetadataProperties where
  parseJSON =
    Core.withObject
      ...
      ( \x ->
          MetadataProperties'
            Core.<$> (x Core..:? "GeneratedBy")
            Core.<*> (x Core..:? "CommitId")
            Core.<*> (x Core..:? "ProjectId")
            Core.<*> (x Core..:? "Repository")
      )

instance Core.Hashable MetadataProperties

instance Core.NFData MetadataProperties

instance Core.ToJSON MetadataProperties where
  toJSON MetadataProperties' {..} =
    Core.object
      ( Core.catMaybes
          [ ("GeneratedBy" Core..=) Core.<$> generatedBy,
