...
--
--
-- You can see a list of the event categories for a given SourceType in the <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html Events> topic in the /Amazon RDS User Guide/ or by using the __DescribeEventCategories__ action.
--
module Network.AWS.RDS.ModifyEventSubscription
    (
    -- * Creating a Request
...
--
-- * 'mesEventCategories' - A list of event categories for a SourceType that you want to subscribe to. You can see a list of the categories for a given SourceType in the <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html Events> topic in the /Amazon RDS User Guide/ or by using the __DescribeEventCategories__ action.
--
