...
data GetConnectorDefinitionVersion = GetConnectorDefinitionVersion'
  { _gcdvNextToken                    :: !(Maybe Text)
  , _gcdvConnectorDefinitionId        :: !Text
  , _gcdvConnectorDefinitionVersionId :: !Text
...
--
-- * 'gcdvConnectorDefinitionVersionId' - The ID of the connector definition version.
getConnectorDefinitionVersion
    :: Text -- ^ 'gcdvConnectorDefinitionId'
    -> Text -- ^ 'gcdvConnectorDefinitionVersionId'
    -> GetConnectorDefinitionVersion
getConnectorDefinitionVersion pConnectorDefinitionId_ pConnectorDefinitionVersionId_ =
  GetConnectorDefinitionVersion'
    { _gcdvNextToken = Nothing
    , _gcdvConnectorDefinitionId = pConnectorDefinitionId_
    , _gcdvConnectorDefinitionVersionId = pConnectorDefinitionVersionId_
    }
...
data GetConnectorDefinitionVersionResponse = GetConnectorDefinitionVersionResponse'
  { _gcdvrsDefinition        :: !(Maybe ConnectorDefinitionVersion)
  , _gcdvrsARN               :: !(Maybe Text)
  , _gcdvrsNextToken         :: !(Maybe Text)
