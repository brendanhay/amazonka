...
data BurnInDestinationSettings = BurnInDestinationSettings'
  { -- | Specifies the opacity of the background rectangle. 255 is opaque; 0 is transparent. Leaving this parameter out is equivalent to setting it to 0 (transparent).  All burn-in and DVB-Sub font settings must match.
    ...
    backgroundColor :: Lude.Maybe BurnInBackgroundColor,
    ...
    teletextGridControl :: Lude.Maybe BurnInTeletextGridControl,
    -- | Specifies font outline color. This option is not valid for source captions that are either 608/embedded or teletext. These source settings are already pre-defined by the caption stream. All burn-in and DVB-Sub font settings must match.
    outlineColor :: Lude.Maybe BurnInOutlineColor,
    ...
    shadowColor :: Lude.Maybe BurnInShadowColor,
