...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Snowball",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "snowball",
                 Core._svcVersion = "2016-06-30", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _InvalidResourceException #-}
...
{-# INLINEABLE _UnsupportedAddressException #-}
...
{-# INLINEABLE _ReturnShippingLabelAlreadyExistsException #-}
...
{-# INLINEABLE _KMSRequestFailedException #-}
...
{-# INLINEABLE _InvalidInputCombinationException #-}
...
{-# INLINEABLE _Ec2RequestFailedException #-}
...
{-# INLINEABLE _ClusterLimitExceededException #-}
