...
mkAudioCodecSettings
  = AudioCodecSettings'{aacSettings = Core.Nothing,
                        ac3Settings = Core.Nothing, eac3Settings = Core.Nothing,
                        mp2Settings = Core.Nothing, passThroughSettings = Core.Nothing,
...
{-# INLINEABLE acsPassThroughSettings #-}
{-# DEPRECATED passThroughSettings "Use generic-lens or generic-optics with 'passThroughSettings' instead"  #-}
