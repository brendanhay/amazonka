...
mkRegisterScalableTarget
    ...
    -> RegisterScalableTarget
mkRegisterScalableTarget serviceNamespace resourceId
  scalableDimension
  = RegisterScalableTarget'{serviceNamespace, resourceId,
                            scalableDimension, maxCapacity = Core.Nothing,
                            minCapacity = Core.Nothing, roleARN = Core.Nothing,
...
{-# INLINEABLE rstServiceNamespace #-}
...
{-# INLINEABLE rstScalableDimension #-}
...
instance Core.ToHeaders RegisterScalableTarget where
        toHeaders RegisterScalableTarget{..}
          = Core.pure
...
instance Core.AWSRequest RegisterScalableTarget where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 RegisterScalableTargetResponse' Core.<$>
...
{-# INLINEABLE rstrrsResponseStatus #-}
