  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "GameLift.SearchGameSessions")
...
{-# DEPRECATED sgsrrsGameSessions "Use generic-lens or generic-optics with 'gameSessions' instead." #-}
...
{-# DEPRECATED sgsrrsNextToken "Use generic-lens or generic-optics with 'nextToken' instead." #-}
...
{-# DEPRECATED sgsrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
