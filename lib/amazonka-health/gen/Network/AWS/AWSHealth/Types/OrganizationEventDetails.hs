...
mkOrganizationEventDetails
    :: OrganizationEventDetails
mkOrganizationEventDetails
  = OrganizationEventDetails'{awsAccountId = Core.Nothing,
                              event = Core.Nothing, eventDescription = Core.Nothing,
...
{-# INLINEABLE oedEventDescription #-}
...
instance Core.FromJSON OrganizationEventDetails where
        parseJSON
          = Core.withObject "OrganizationEventDetails" Core.$
              \ x ->
                OrganizationEventDetails' Core.<$>
                  (x Core..:? "awsAccountId") Core.<*> x Core..:? "event" Core.<*>
                    x Core..:? "eventDescription"
