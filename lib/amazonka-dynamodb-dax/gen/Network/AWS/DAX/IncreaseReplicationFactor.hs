...
mkIncreaseReplicationFactor clusterName newReplicationFactor
  = IncreaseReplicationFactor'{clusterName, newReplicationFactor,
...
irfClusterName :: Lens.Lens' IncreaseReplicationFactor Core.Text
irfClusterName = Lens.field @"clusterName"
{-# INLINEABLE irfClusterName #-}
...
{-# INLINEABLE irfNewReplicationFactor #-}
...
irfAvailabilityZones :: Lens.Lens' IncreaseReplicationFactor (Core.Maybe [Core.Text])
irfAvailabilityZones = Lens.field @"availabilityZones"
{-# INLINEABLE irfAvailabilityZones #-}
...
instance Core.ToHeaders IncreaseReplicationFactor where
        toHeaders IncreaseReplicationFactor{..}
          = Core.pure
...
instance Core.AWSRequest IncreaseReplicationFactor where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 IncreaseReplicationFactorResponse' Core.<$>
...
mkIncreaseReplicationFactorResponse responseStatus
  = IncreaseReplicationFactorResponse'{cluster = Core.Nothing,
                                       responseStatus}
...
{-# INLINEABLE irfrrsResponseStatus #-}
