...
mkTerminateRecommendationDetail
    :: TerminateRecommendationDetail
mkTerminateRecommendationDetail
  = TerminateRecommendationDetail'{currencyCode = Core.Nothing,
...
{-# INLINEABLE trdEstimatedMonthlySavings #-}
...
instance Core.FromJSON TerminateRecommendationDetail where
        parseJSON
          = Core.withObject "TerminateRecommendationDetail" Core.$
              \ x ->
                TerminateRecommendationDetail' Core.<$>
                  (x Core..:? "CurrencyCode") Core.<*>
                    x Core..:? "EstimatedMonthlySavings"
