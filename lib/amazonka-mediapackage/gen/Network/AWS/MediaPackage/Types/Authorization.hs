...
mkAuthorization
    :: Core.Text -- ^ 'secretsRoleArn'
    -> Core.Text -- ^ 'cdnIdentifierSecret'
    -> Authorization
...
{-# INLINEABLE aSecretsRoleArn #-}
{-# DEPRECATED secretsRoleArn "Use generic-lens or generic-optics with 'secretsRoleArn' instead"  #-}
...
{-# INLINEABLE aCdnIdentifierSecret #-}
{-# DEPRECATED cdnIdentifierSecret "Use generic-lens or generic-optics with 'cdnIdentifierSecret' instead"  #-}
...
instance Core.FromJSON Authorization where
        parseJSON
          = Core.withObject "Authorization" Core.$
              \ x ->
                Authorization' Core.<$>
                  (x Core..: "secretsRoleArn") Core.<*>
                    x Core..: "cdnIdentifierSecret"
