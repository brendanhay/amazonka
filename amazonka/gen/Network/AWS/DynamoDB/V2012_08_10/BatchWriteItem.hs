...
batchWriteItem :: HashMap Text [WriteRequest] -- ^ '_bwiiRequestItems'
               -> BatchWriteItem
...
data BatchWriteItem = BatchWriteItem
    { _bwiiRequestItems :: HashMap Text [WriteRequest]
...
data BatchWriteItemResponse = BatchWriteItemResponse
    { _bwioUnprocessedItems :: HashMap Text [WriteRequest]
    ...
    , _bwioConsumedCapacity :: [ConsumedCapacity]
      ...
      -- consumed.
    , _bwioItemCollectionMetrics :: HashMap Text [ItemCollectionMetrics]
