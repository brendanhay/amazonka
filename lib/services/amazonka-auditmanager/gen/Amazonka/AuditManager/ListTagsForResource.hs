...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the specified resource.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The list of tags returned by the @ListTagsForResource@ API.
--
