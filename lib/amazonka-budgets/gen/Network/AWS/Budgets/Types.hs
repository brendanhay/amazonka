...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Budgets",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "budgets",
                 Core._svcVersion = "2016-10-20", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _ResourceLockedException #-}
...
{-# INLINEABLE _DuplicateRecordException #-}
...
{-# INLINEABLE _CreationLimitExceededException #-}
