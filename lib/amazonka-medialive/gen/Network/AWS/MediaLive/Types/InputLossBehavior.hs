...
mkInputLossBehavior
    :: InputLossBehavior
mkInputLossBehavior
  = InputLossBehavior'{blackFrameMsec = Core.Nothing,
                       inputLossImageColor = Core.Nothing,
                       inputLossImageSlate = Core.Nothing,
                       inputLossImageType = Core.Nothing, repeatFrameMsec = Core.Nothing}
...
{-# INLINEABLE ilbBlackFrameMsec #-}
{-# DEPRECATED blackFrameMsec "Use generic-lens or generic-optics with 'blackFrameMsec' instead"  #-}
...
{-# INLINEABLE ilbInputLossImageColor #-}
{-# DEPRECATED inputLossImageColor "Use generic-lens or generic-optics with 'inputLossImageColor' instead"  #-}
...
{-# INLINEABLE ilbInputLossImageSlate #-}
{-# DEPRECATED inputLossImageSlate "Use generic-lens or generic-optics with 'inputLossImageSlate' instead"  #-}
...
{-# INLINEABLE ilbInputLossImageType #-}
{-# DEPRECATED inputLossImageType "Use generic-lens or generic-optics with 'inputLossImageType' instead"  #-}
...
{-# INLINEABLE ilbRepeatFrameMsec #-}
{-# DEPRECATED repeatFrameMsec "Use generic-lens or generic-optics with 'repeatFrameMsec' instead"  #-}
          ...
          = Core.withObject "InputLossBehavior" Core.$
              \ x ->
                InputLossBehavior' Core.<$>
                  (x Core..:? "blackFrameMsec") Core.<*>
                    x Core..:? "inputLossImageColor"
