...
{-# INLINEABLE wfrMatchEquals #-}
{-# DEPRECATED matchEquals "Use generic-lens or generic-optics with 'matchEquals' instead"  #-}
...
instance Core.FromJSON WebhookFilterRule where
        parseJSON
          = Core.withObject "WebhookFilterRule" Core.$
              \ x ->
                WebhookFilterRule' Core.<$>
                  (x Core..: "jsonPath") Core.<*> x Core..:? "matchEquals"
