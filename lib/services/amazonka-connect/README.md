...
`2.0` - Derived from API version @2017-08-08@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.Connect](http://hackage.haskell.org/package/amazonka-connect/docs/Amazonka-Connect.html)
