...
mkGrantConstraints
    :: GrantConstraints
mkGrantConstraints
  = GrantConstraints'{encryptionContextEquals = Core.Nothing,
...
{-# INLINEABLE gcEncryptionContextEquals #-}
{-# DEPRECATED encryptionContextEquals "Use generic-lens or generic-optics with 'encryptionContextEquals' instead"  #-}
...
{-# INLINEABLE gcEncryptionContextSubset #-}
{-# DEPRECATED encryptionContextSubset "Use generic-lens or generic-optics with 'encryptionContextSubset' instead"  #-}

instance Core.FromJSON GrantConstraints where
        toJSON GrantConstraints{..}
          = Core.object
              (Core.catMaybes
                 [("EncryptionContextEquals" Core..=) Core.<$>
                    encryptionContextEquals,
                  ("EncryptionContextSubset" Core..=) Core.<$>
...
instance Core.FromJSON GrantConstraints where
        parseJSON
          = Core.withObject "GrantConstraints" Core.$
              \ x ->
                GrantConstraints' Core.<$>
                  (x Core..:? "EncryptionContextEquals") Core.<*>
                    x Core..:? "EncryptionContextSubset"
