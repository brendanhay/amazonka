...
mkCaptureContentTypeHeader
    :: CaptureContentTypeHeader
mkCaptureContentTypeHeader
  = CaptureContentTypeHeader'{csvContentTypes = Core.Nothing,
...
{-# INLINEABLE ccthCsvContentTypes #-}
{-# DEPRECATED csvContentTypes "Use generic-lens or generic-optics with 'csvContentTypes' instead"  #-}
...
{-# INLINEABLE ccthJsonContentTypes #-}
{-# DEPRECATED jsonContentTypes "Use generic-lens or generic-optics with 'jsonContentTypes' instead"  #-}
          ...
          = Core.withObject "CaptureContentTypeHeader" Core.$
              \ x ->
                CaptureContentTypeHeader' Core.<$>
                  (x Core..:? "CsvContentTypes") Core.<*>
                    x Core..:? "JsonContentTypes"
