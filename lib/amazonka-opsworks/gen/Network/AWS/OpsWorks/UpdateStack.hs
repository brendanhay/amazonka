...
usStackId :: Lens.Lens' UpdateStack Types.String
...
usAgentVersion :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usCustomJson :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usDefaultAvailabilityZone :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usDefaultInstanceProfileArn :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usDefaultOs :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usDefaultSshKeyName :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usDefaultSubnetId :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usHostnameTheme :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usName :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
...
usServiceRoleArn :: Lens.Lens' UpdateStack (Core.Maybe Types.String)
