...
--
-- * 'staWorkflowType'
data StartWorkflowExecution = StartWorkflowExecution'{_staTagList :: [Text], _staTaskStartToCloseTimeout :: Maybe Text, _staInput :: Maybe Text, _staExecutionStartToCloseTimeout :: Maybe Text, _staTaskList :: Maybe TaskList, _staTaskPriority :: Maybe Text, _staChildPolicy :: Maybe ChildPolicy, _staDomain :: Text, _staWorkflowId :: Text, _staWorkflowType :: WorkflowType} deriving (Eq, Read, Show)

-- | 'StartWorkflowExecution' smart constructor.
startWorkflowExecution :: Text -> Text -> WorkflowType -> StartWorkflowExecution
startWorkflowExecution pDomain pWorkflowId pWorkflowType = StartWorkflowExecution'{_staTagList = mempty, _staTaskStartToCloseTimeout = Nothing, _staInput = Nothing, _staExecutionStartToCloseTimeout = Nothing, _staTaskList = Nothing, _staTaskPriority = Nothing, _staChildPolicy = Nothing, _staDomain = pDomain, _staWorkflowId = pWorkflowId, _staWorkflowType = pWorkflowType};
...
--
-- * 'swerRunId'
newtype StartWorkflowExecutionResponse = StartWorkflowExecutionResponse'{_swerRunId :: Text} deriving (Eq, Read, Show)

-- | 'StartWorkflowExecutionResponse' smart constructor.
startWorkflowExecutionResponse :: Text -> StartWorkflowExecutionResponse
startWorkflowExecutionResponse pRunId = StartWorkflowExecutionResponse'{_swerRunId = pRunId};
...
-- domain.
swerRunId :: Lens' StartWorkflowExecutionResponse Text
