...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "StorageGateway",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "storagegateway",
                 Core._svcVersion = "2013-06-30", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _InvalidGatewayRequestException #-}
...
{-# INLINEABLE _ServiceUnavailableError #-}
