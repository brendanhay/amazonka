...
mkBatchGetItem
    :: BatchGetItem
mkBatchGetItem
  = BatchGetItem'{requestItems = Core.mempty,
...
{-# INLINEABLE bgiReturnConsumedCapacity #-}
...
mkBatchGetItemResponse responseStatus
  = BatchGetItemResponse'{consumedCapacity = Core.Nothing,
                          responses = Core.Nothing, unprocessedKeys = Core.Nothing,
                          responseStatus}
...
{-# INLINEABLE bgirrsConsumedCapacity #-}
...
{-# INLINEABLE bgirrsUnprocessedKeys #-}
