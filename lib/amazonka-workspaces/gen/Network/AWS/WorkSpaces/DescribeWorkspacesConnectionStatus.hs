...
mkDescribeWorkspacesConnectionStatus
    :: DescribeWorkspacesConnectionStatus
mkDescribeWorkspacesConnectionStatus
  = DescribeWorkspacesConnectionStatus'{nextToken = Core.Nothing,
...
{-# INLINEABLE dwcsWorkspaceIds #-}
{-# DEPRECATED workspaceIds "Use generic-lens or generic-optics with 'workspaceIds' instead"  #-}

instance Core.ToQuery DescribeWorkspacesConnectionStatus where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeWorkspacesConnectionStatus where
        toHeaders DescribeWorkspacesConnectionStatus{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeWorkspacesConnectionStatus where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeWorkspacesConnectionStatusResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*>
                     x Core..:? "WorkspacesConnectionStatus"
...
instance Pager.AWSPager DescribeWorkspacesConnectionStatus where
        page rq rs
          ...
          | Pager.stop
              (rs Lens.^?
                 Lens.field @"workspacesConnectionStatus" Core.. Lens._Just)
            = Core.Nothing
          | Core.otherwise =
            Core.Just
              (rq Core.&
...
mkDescribeWorkspacesConnectionStatusResponse responseStatus
  = DescribeWorkspacesConnectionStatusResponse'{nextToken =
                                                  Core.Nothing,
...
{-# INLINEABLE dwcsrrsWorkspacesConnectionStatus #-}
{-# DEPRECATED workspacesConnectionStatus "Use generic-lens or generic-optics with 'workspacesConnectionStatus' instead"  #-}
...
{-# INLINEABLE dwcsrrsResponseStatus #-}
