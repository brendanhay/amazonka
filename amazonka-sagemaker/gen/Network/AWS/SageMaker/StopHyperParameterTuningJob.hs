...
newtype StopHyperParameterTuningJob = StopHyperParameterTuningJob'
  { _shptjHyperParameterTuningJobName :: Text
...
stopHyperParameterTuningJob
    :: Text -- ^ 'shptjHyperParameterTuningJobName'
    -> StopHyperParameterTuningJob
stopHyperParameterTuningJob pHyperParameterTuningJobName_ =
  StopHyperParameterTuningJob'
    {_shptjHyperParameterTuningJobName = pHyperParameterTuningJobName_}
...
instance Hashable StopHyperParameterTuningJob where

instance NFData StopHyperParameterTuningJob where
...
data StopHyperParameterTuningJobResponse =
  StopHyperParameterTuningJobResponse'
  deriving (Eq, Read, Show, Data, Typeable, Generic)
