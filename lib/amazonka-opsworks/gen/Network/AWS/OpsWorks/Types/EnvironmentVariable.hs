...
evKey :: Lens.Lens' EnvironmentVariable Core.Text
...
{-# INLINEABLE evSecure #-}
{-# DEPRECATED secure "Use generic-lens or generic-optics with 'secure' instead"  #-}
          ...
          = Core.withObject "EnvironmentVariable" Core.$
              \ x ->
                EnvironmentVariable' Core.<$>
                  (x Core..: "Key") Core.<*> x Core..: "Value" Core.<*>
                    x Core..:? "Secure"
