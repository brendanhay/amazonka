...
mkGetMedia
    :: Types.StartSelector -- ^ 'startSelector'
    -> GetMedia
mkGetMedia startSelector
  = GetMedia'{startSelector, streamARN = Core.Nothing,
...
{-# INLINEABLE gmStartSelector #-}
{-# DEPRECATED startSelector "Use generic-lens or generic-optics with 'startSelector' instead"  #-}
...
instance Core.AWSRequest GetMedia where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         Core._rqMethod = Request.POST, Core._rqPath = "/getMedia",
...
mkGetMediaResponse payload responseStatus
  = GetMediaResponse'{contentType = Core.Nothing, payload,
                      responseStatus}
