...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "AWSHealth",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "health",
                 Core._svcVersion = "2016-08-04", Core._svcTimeout = Core.Just 70,
