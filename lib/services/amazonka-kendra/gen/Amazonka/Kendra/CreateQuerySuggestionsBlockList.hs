...
-- Python SDK, see
-- <https://docs.aws.amazon.com/kendra/latest/dg/query-suggestions.html#query-suggestions-blocklist Query suggestions block list>.
module Amazonka.Kendra.CreateQuerySuggestionsBlockList
  ( -- * Creating a Request
...
-- suggestions block list.
--
-- 'description', 'createQuerySuggestionsBlockList_description' - A description for the block list.
--
-- For example, the description \"List of all offensive words that can
-- appear in user queries and need to be blocked from suggestions.\"
--
-- 'tags', 'createQuerySuggestionsBlockList_tags' - A list of key-value pairs that identify or categorize the block list.
-- Tag keys and values can consist of Unicode letters, digits, white space,
-- and any of the following symbols: _ . : \/ = + - \@.
--
...
-- list for.
--
-- 'name', 'createQuerySuggestionsBlockList_name' - A name for the block list.
--
-- For example, the name \'offensive-words\', which includes all offensive
-- words that could appear in user queries and need to be blocked from
-- suggestions.
...
-- <https://docs.aws.amazon.com/kendra/latest/dg/quotas.html Quotas for Amazon Kendra>.
--
-- 'roleArn', 'createQuerySuggestionsBlockList_roleArn' - The Amazon Resource Name (ARN) of an IAM role with permission to access
-- your S3 bucket that contains the block list text file. For more
-- information, see
-- <https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html IAM access roles for Amazon Kendra>.
newCreateQuerySuggestionsBlockList ::
...
-- for backwards compatibility:
--
-- 'id', 'createQuerySuggestionsBlockListResponse_id' - The identifier of the block list.
--
