...
tagRole
    :: Text -- ^ 'trRoleName'
    -> TagRole
tagRole pRoleName_ = TagRole' {_trRoleName = pRoleName_, _trTags = mempty}
...
instance Hashable TagRole where

instance NFData TagRole where
...
instance NFData TagRoleResponse where
