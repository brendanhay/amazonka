...
csEngine :: Lens.Lens' CreateServer Types.String
...
csInstanceType :: Lens.Lens' CreateServer Types.String
...
csEngineModel :: Lens.Lens' CreateServer (Core.Maybe Types.String)
...
csEngineVersion :: Lens.Lens' CreateServer (Core.Maybe Types.String)
...
csSecurityGroupIds :: Lens.Lens' CreateServer (Core.Maybe [Types.String])
...
csSubnetIds :: Lens.Lens' CreateServer (Core.Maybe [Types.String])
...
{-# DEPRECATED csrrsServer "Use generic-lens or generic-optics with 'server' instead." #-}
