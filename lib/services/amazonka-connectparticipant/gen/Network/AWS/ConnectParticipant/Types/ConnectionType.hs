...
-- |
-- Module      : Network.AWS.ConnectParticipant.Types.ConnectionType
...
pattern ConnectionType_CONNECTION_CREDENTIALS = ConnectionType' "CONNECTION_CREDENTIALS"

pattern ConnectionType_WEBSOCKET :: ConnectionType
pattern ConnectionType_WEBSOCKET = ConnectionType' "WEBSOCKET"
