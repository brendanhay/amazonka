...
-- |
-- Module      : Network.AWS.QuickSight.Types.AuroraPostgreSqlParameters
-- Copyright   : (c) 2013-2021 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Network.AWS.QuickSight.Types.AuroraPostgreSqlParameters where
...
instance Prelude.Hashable AuroraPostgreSqlParameters

instance Prelude.NFData AuroraPostgreSqlParameters
