...
{-# INLINEABLE gcdCoreDefinitionId #-}
...
instance Core.AWSRequest GetCoreDefinition where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetCoreDefinitionResponse' Core.<$>
...
mkGetCoreDefinitionResponse responseStatus
  = GetCoreDefinitionResponse'{arn = Core.Nothing,
...
{-# INLINEABLE gcdrrsCreationTimestamp #-}
...
{-# INLINEABLE gcdrrsLastUpdatedTimestamp #-}
...
{-# INLINEABLE gcdrrsLatestVersion #-}
...
{-# INLINEABLE gcdrrsLatestVersionArn #-}
