...
mkContainerSettings
    :: ContainerSettings
mkContainerSettings
  = ContainerSettings'{cmfcSettings = Core.Nothing,
                       container = Core.Nothing, f4vSettings = Core.Nothing,
                       m2tsSettings = Core.Nothing, m3u8Settings = Core.Nothing,
                       movSettings = Core.Nothing, mp4Settings = Core.Nothing,
                       mpdSettings = Core.Nothing, mxfSettings = Core.Nothing}
...
{-# INLINEABLE csCmfcSettings #-}
{-# DEPRECATED cmfcSettings "Use generic-lens or generic-optics with 'cmfcSettings' instead"  #-}
...
{-# INLINEABLE csF4vSettings #-}
{-# DEPRECATED f4vSettings "Use generic-lens or generic-optics with 'f4vSettings' instead"  #-}
...
{-# INLINEABLE csM2tsSettings #-}
{-# DEPRECATED m2tsSettings "Use generic-lens or generic-optics with 'm2tsSettings' instead"  #-}
...
{-# INLINEABLE csMovSettings #-}
{-# DEPRECATED movSettings "Use generic-lens or generic-optics with 'movSettings' instead"  #-}
...
{-# INLINEABLE csMp4Settings #-}
{-# DEPRECATED mp4Settings "Use generic-lens or generic-optics with 'mp4Settings' instead"  #-}
...
{-# INLINEABLE csMpdSettings #-}
{-# DEPRECATED mpdSettings "Use generic-lens or generic-optics with 'mpdSettings' instead"  #-}
...
{-# INLINEABLE csMxfSettings #-}
{-# DEPRECATED mxfSettings "Use generic-lens or generic-optics with 'mxfSettings' instead"  #-}
          ...
          = Core.withObject "ContainerSettings" Core.$
              \ x ->
                ContainerSettings' Core.<$>
                  (x Core..:? "cmfcSettings") Core.<*> x Core..:? "container"
