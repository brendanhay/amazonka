...
mkUpdateInstanceStorageConfig
    ...
    -> UpdateInstanceStorageConfig
mkUpdateInstanceStorageConfig instanceId associationId resourceType
  storageConfig
  = UpdateInstanceStorageConfig'{instanceId, associationId,
...
instance Core.ToHeaders UpdateInstanceStorageConfig where
        toHeaders UpdateInstanceStorageConfig{..}
