...
seaExpr :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaExpr = Lens.lens (expr :: Search -> Lude.Maybe Lude.Text) (\s a -> s {expr = a} :: Search)
{-# DEPRECATED seaExpr "Use generic-lens or generic-optics with 'expr' instead." #-}
...
seaCursor :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaCursor = Lens.lens (cursor :: Search -> Lude.Maybe Lude.Text) (\s a -> s {cursor = a} :: Search)
{-# DEPRECATED seaCursor "Use generic-lens or generic-optics with 'cursor' instead." #-}
...
seaReturn :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaReturn = Lens.lens (return :: Search -> Lude.Maybe Lude.Text) (\s a -> s {return = a} :: Search)
{-# DEPRECATED seaReturn "Use generic-lens or generic-optics with 'return' instead." #-}
...
seaQueryOptions :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaQueryOptions = Lens.lens (queryOptions :: Search -> Lude.Maybe Lude.Text) (\s a -> s {queryOptions = a} :: Search)
{-# DEPRECATED seaQueryOptions "Use generic-lens or generic-optics with 'queryOptions' instead." #-}
...
seaFilterQuery :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaFilterQuery = Lens.lens (filterQuery :: Search -> Lude.Maybe Lude.Text) (\s a -> s {filterQuery = a} :: Search)
{-# DEPRECATED seaFilterQuery "Use generic-lens or generic-optics with 'filterQuery' instead." #-}

-- | Specifies the maximum number of search hits to include in the response.
--
-- /Note:/ Consider using 'size' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
seaSize :: Lens.Lens' Search (Lude.Maybe Lude.Integer)
seaSize = Lens.lens (size :: Search -> Lude.Maybe Lude.Integer) (\s a -> s {size = a} :: Search)
{-# DEPRECATED seaSize "Use generic-lens or generic-optics with 'size' instead." #-}
...
seaQueryParser :: Lens.Lens' Search (Lude.Maybe QueryParser)
seaQueryParser = Lens.lens (queryParser :: Search -> Lude.Maybe QueryParser) (\s a -> s {queryParser = a} :: Search)
{-# DEPRECATED seaQueryParser "Use generic-lens or generic-optics with 'queryParser' instead." #-}
...
seaStart :: Lens.Lens' Search (Lude.Maybe Lude.Integer)
seaStart = Lens.lens (start :: Search -> Lude.Maybe Lude.Integer) (\s a -> s {start = a} :: Search)
{-# DEPRECATED seaStart "Use generic-lens or generic-optics with 'start' instead." #-}
...
seaHighlight :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaHighlight = Lens.lens (highlight :: Search -> Lude.Maybe Lude.Text) (\s a -> s {highlight = a} :: Search)
{-# DEPRECATED seaHighlight "Use generic-lens or generic-optics with 'highlight' instead." #-}
...
seaStats :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaStats = Lens.lens (stats :: Search -> Lude.Maybe Lude.Text) (\s a -> s {stats = a} :: Search)
{-# DEPRECATED seaStats "Use generic-lens or generic-optics with 'stats' instead." #-}
...
seaSort :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaSort = Lens.lens (sort :: Search -> Lude.Maybe Lude.Text) (\s a -> s {sort = a} :: Search)
{-# DEPRECATED seaSort "Use generic-lens or generic-optics with 'sort' instead." #-}
...
seaFacet :: Lens.Lens' Search (Lude.Maybe Lude.Text)
seaFacet = Lens.lens (facet :: Search -> Lude.Maybe Lude.Text) (\s a -> s {facet = a} :: Search)
{-# DEPRECATED seaFacet "Use generic-lens or generic-optics with 'facet' instead." #-}
...
seaPartial :: Lens.Lens' Search (Lude.Maybe Lude.Bool)
seaPartial = Lens.lens (partial :: Search -> Lude.Maybe Lude.Bool) (\s a -> s {partial = a} :: Search)
{-# DEPRECATED seaPartial "Use generic-lens or generic-optics with 'partial' instead." #-}
...
seaQuery :: Lens.Lens' Search Lude.Text
seaQuery = Lens.lens (query :: Search -> Lude.Text) (\s a -> s {query = a} :: Search)
{-# DEPRECATED seaQuery "Use generic-lens or generic-optics with 'query' instead." #-}
...
searsStatus :: Lens.Lens' SearchResponse (Lude.Maybe SearchStatus)
searsStatus = Lens.lens (status :: SearchResponse -> Lude.Maybe SearchStatus) (\s a -> s {status = a} :: SearchResponse)
{-# DEPRECATED searsStatus "Use generic-lens or generic-optics with 'status' instead." #-}
...
searsFacets :: Lens.Lens' SearchResponse (Lude.Maybe (Lude.HashMap Lude.Text (BucketInfo)))
searsFacets = Lens.lens (facets :: SearchResponse -> Lude.Maybe (Lude.HashMap Lude.Text (BucketInfo))) (\s a -> s {facets = a} :: SearchResponse)
{-# DEPRECATED searsFacets "Use generic-lens or generic-optics with 'facets' instead." #-}

-- | The requested field statistics information.
--
-- /Note:/ Consider using 'stats' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
searsStats :: Lens.Lens' SearchResponse (Lude.Maybe (Lude.HashMap Lude.Text (FieldStats)))
searsStats = Lens.lens (stats :: SearchResponse -> Lude.Maybe (Lude.HashMap Lude.Text (FieldStats))) (\s a -> s {stats = a} :: SearchResponse)
{-# DEPRECATED searsStats "Use generic-lens or generic-optics with 'stats' instead." #-}
...
searsHits :: Lens.Lens' SearchResponse (Lude.Maybe Hits)
searsHits = Lens.lens (hits :: SearchResponse -> Lude.Maybe Hits) (\s a -> s {hits = a} :: SearchResponse)
{-# DEPRECATED searsHits "Use generic-lens or generic-optics with 'hits' instead." #-}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
searsResponseStatus :: Lens.Lens' SearchResponse Lude.Int
searsResponseStatus = Lens.lens (responseStatus :: SearchResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: SearchResponse)
{-# DEPRECATED searsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
