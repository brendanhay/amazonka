...
mkAllowedPublishers
    :: Core.NonEmpty Types.Arn -- ^ 'signingProfileVersionArns'
    -> AllowedPublishers
...
{-# INLINEABLE apSigningProfileVersionArns #-}
{-# DEPRECATED signingProfileVersionArns "Use generic-lens or generic-optics with 'signingProfileVersionArns' instead"  #-}
