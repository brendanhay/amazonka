...
`2.0` - Derived from API version @2015-02-02@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.ElastiCache](http://hackage.haskell.org/package/amazonka-elasticache/docs/Amazonka-ElastiCache.html)
