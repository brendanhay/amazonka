...
mkAppCookieStickinessPolicy
    :: AppCookieStickinessPolicy
mkAppCookieStickinessPolicy
  = AppCookieStickinessPolicy'{cookieName = Core.Nothing,
...
instance Core.FromXML AppCookieStickinessPolicy where
        parseXML x
          = AppCookieStickinessPolicy' Core.<$>
              (x Core..@? "CookieName") Core.<*> x Core..@? "PolicyName"
