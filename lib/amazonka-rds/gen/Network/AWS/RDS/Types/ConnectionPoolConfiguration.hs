...
mkConnectionPoolConfiguration
  = ConnectionPoolConfiguration'{connectionBorrowTimeout =
                                   Core.Nothing,
                                 initQuery = Core.Nothing, maxConnectionsPercent = Core.Nothing,
...
{-# INLINEABLE cpcConnectionBorrowTimeout #-}
{-# DEPRECATED connectionBorrowTimeout "Use generic-lens or generic-optics with 'connectionBorrowTimeout' instead"  #-}
...
cpcInitQuery :: Lens.Lens' ConnectionPoolConfiguration (Core.Maybe Core.Text)
cpcInitQuery = Lens.field @"initQuery"
{-# INLINEABLE cpcInitQuery #-}
{-# DEPRECATED initQuery "Use generic-lens or generic-optics with 'initQuery' instead"  #-}
...
{-# INLINEABLE cpcMaxConnectionsPercent #-}
{-# DEPRECATED maxConnectionsPercent "Use generic-lens or generic-optics with 'maxConnectionsPercent' instead"  #-}
...
{-# INLINEABLE cpcMaxIdleConnectionsPercent #-}
{-# DEPRECATED maxIdleConnectionsPercent "Use generic-lens or generic-optics with 'maxIdleConnectionsPercent' instead"  #-}
...
cpcSessionPinningFilters :: Lens.Lens' ConnectionPoolConfiguration (Core.Maybe [Core.Text])
cpcSessionPinningFilters = Lens.field @"sessionPinningFilters"
{-# INLINEABLE cpcSessionPinningFilters #-}
{-# DEPRECATED sessionPinningFilters "Use generic-lens or generic-optics with 'sessionPinningFilters' instead"  #-}

instance Core.ToQuery ConnectionPoolConfiguration where
        toQuery ConnectionPoolConfiguration{..}
          = Core.maybe Core.mempty
              (Core.toQueryPair "ConnectionBorrowTimeout")
              connectionBorrowTimeout
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "InitQuery") initQuery
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "MaxConnectionsPercent")
                maxConnectionsPercent
              Core.<>
              Core.maybe Core.mempty
                (Core.toQueryPair "MaxIdleConnectionsPercent")
                maxIdleConnectionsPercent
              Core.<>
              Core.toQueryPair "SessionPinningFilters"
