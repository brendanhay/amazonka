...
mkEmergencyContact emailAddress
  = EmergencyContact'{emailAddress, contactNotes = Core.Nothing,
...
{-# INLINEABLE ecContactNotes #-}
{-# DEPRECATED contactNotes "Use generic-lens or generic-optics with 'contactNotes' instead"  #-}
          ...
          = Core.withObject "EmergencyContact" Core.$
              \ x ->
                EmergencyContact' Core.<$>
                  (x Core..: "EmailAddress") Core.<*> x Core..:? "ContactNotes"
