...
mkDashboardValidationMessage
    :: DashboardValidationMessage
mkDashboardValidationMessage
  = DashboardValidationMessage'{dataPath = Core.Nothing,
...
{-# INLINEABLE dvmDataPath #-}
{-# DEPRECATED dataPath "Use generic-lens or generic-optics with 'dataPath' instead"  #-}
...
{-# INLINEABLE dvmMessage #-}
{-# DEPRECATED message "Use generic-lens or generic-optics with 'message' instead"  #-}

instance Core.FromXML DashboardValidationMessage where
        parseXML x
          = DashboardValidationMessage' Core.<$>
              (x Core..@? "DataPath") Core.<*> x Core..@? "Message"
