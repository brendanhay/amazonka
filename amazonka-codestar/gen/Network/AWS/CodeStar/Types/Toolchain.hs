...
data Toolchain = Toolchain'
  { -- | The list of parameter overrides to be passed into the toolchain template
    ...
    stackParameters :: Prelude.Maybe (Prelude.HashMap Prelude.Text (Prelude.Sensitive Prelude.Text)),
...
toolchain_stackParameters = Lens.lens (\Toolchain' {stackParameters} -> stackParameters) (\s@Toolchain' {} a -> s {stackParameters = a} :: Toolchain) Prelude.. Lens.mapping Prelude._Coerce
