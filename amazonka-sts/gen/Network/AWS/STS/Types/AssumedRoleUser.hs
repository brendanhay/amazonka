...
-- of the role that is being assumed. The role ID is generated by AWS when
-- the role is created.
assumedRoleUser_assumedRoleId :: Lens.Lens' AssumedRoleUser Core.Text
...
-- <https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html IAM Identifiers>
-- in the /IAM User Guide/.
assumedRoleUser_arn :: Lens.Lens' AssumedRoleUser Core.Text
...
instance Core.FromXML AssumedRoleUser where
  parseXML x =
    AssumedRoleUser'
      Core.<$> (x Core..@ "AssumedRoleId")
      Core.<*> (x Core..@ "Arn")

instance Core.Hashable AssumedRoleUser

instance Core.NFData AssumedRoleUser
