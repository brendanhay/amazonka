...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "SDB",
      Core._svcSigner = Sign.v2,
      Core._svcPrefix = "sdb",
      Core._svcVersion = "2009-04-15",
...
_NoSuchDomain =
  Core._MatchServiceError mkServiceConfig "NoSuchDomain"
    Core.. Core.hasStatues 400
...
_MissingParameter =
  Core._MatchServiceError mkServiceConfig "MissingParameter"
    Core.. Core.hasStatues 400
...
_RequestTimeout =
  Core._MatchServiceError mkServiceConfig "RequestTimeout"
