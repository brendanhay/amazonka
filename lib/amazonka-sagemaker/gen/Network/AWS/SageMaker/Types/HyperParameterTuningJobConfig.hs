...
mkHyperParameterTuningJobConfig
    ...
    -> Types.ResourceLimits -- ^ 'resourceLimits'
    -> HyperParameterTuningJobConfig
mkHyperParameterTuningJobConfig strategy resourceLimits
  = HyperParameterTuningJobConfig'{strategy, resourceLimits,
...
{-# INLINEABLE hptjcResourceLimits #-}
...
{-# INLINEABLE hptjcHyperParameterTuningJobObjective #-}
{-# DEPRECATED hyperParameterTuningJobObjective "Use generic-lens or generic-optics with 'hyperParameterTuningJobObjective' instead"  #-}
...
{-# INLINEABLE hptjcParameterRanges #-}
{-# DEPRECATED parameterRanges "Use generic-lens or generic-optics with 'parameterRanges' instead"  #-}
...
{-# INLINEABLE hptjcTrainingJobEarlyStoppingType #-}
{-# DEPRECATED trainingJobEarlyStoppingType "Use generic-lens or generic-optics with 'trainingJobEarlyStoppingType' instead"  #-}
...
{-# INLINEABLE hptjcTuningJobCompletionCriteria #-}
{-# DEPRECATED tuningJobCompletionCriteria "Use generic-lens or generic-optics with 'tuningJobCompletionCriteria' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("Strategy" Core..= strategy),
                  ...
                  ("HyperParameterTuningJobObjective" Core..=) Core.<$>
                    hyperParameterTuningJobObjective,
                  ("ParameterRanges" Core..=) Core.<$> parameterRanges,
                  ("TrainingJobEarlyStoppingType" Core..=) Core.<$>
                    trainingJobEarlyStoppingType,
                  ("TuningJobCompletionCriteria" Core..=) Core.<$>
          ...
          = Core.withObject "HyperParameterTuningJobConfig" Core.$
              \ x ->
                HyperParameterTuningJobConfig' Core.<$>
                  (x Core..: "Strategy") Core.<*> x Core..: "ResourceLimits" Core.<*>
                    x Core..:? "HyperParameterTuningJobObjective"
