...
--
-- * 'gssSettingId' - The ID of the service setting to get.
getServiceSetting
    :: Text -- ^ 'gssSettingId'
    -> GetServiceSetting
getServiceSetting pSettingId_ = GetServiceSetting' {_gssSettingId = pSettingId_}
...
instance Hashable GetServiceSetting where

instance NFData GetServiceSetting where
...
data GetServiceSettingResponse = GetServiceSettingResponse'
  { _gssrsServiceSetting :: !(Maybe ServiceSetting)
...
getServiceSettingResponse pResponseStatus_ =
  GetServiceSettingResponse'
    {_gssrsServiceSetting = Nothing, _gssrsResponseStatus = pResponseStatus_}
...
instance NFData GetServiceSettingResponse where
