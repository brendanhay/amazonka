...
--
-- * 'dlsDirectoryId' - Identifier (ID) of the directory whose log subscription you want to delete.
deleteLogSubscription
    :: Text -- ^ 'dlsDirectoryId'
    -> DeleteLogSubscription
...
instance Hashable DeleteLogSubscription where

instance NFData DeleteLogSubscription where
...
instance NFData DeleteLogSubscriptionResponse where
