...
instance AWSRequest DeleteConfigurationSetTrackingOptions where
  type
...
instance Hashable DeleteConfigurationSetTrackingOptions

instance NFData DeleteConfigurationSetTrackingOptions

instance ToHeaders DeleteConfigurationSetTrackingOptions where
  toHeaders = const mempty

instance ToPath DeleteConfigurationSetTrackingOptions where
  toPath = const "/"

instance ToQuery DeleteConfigurationSetTrackingOptions where
  toQuery DeleteConfigurationSetTrackingOptions' {..} =
    mconcat
      [ "Action"
          =: ("DeleteConfigurationSetTrackingOptions" :: ByteString),
...
instance NFData DeleteConfigurationSetTrackingOptionsResponse
