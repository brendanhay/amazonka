...
mkReplicationInstance
    :: ReplicationInstance
mkReplicationInstance
  = ReplicationInstance'{allocatedStorage = Core.Nothing,
                         autoMinorVersionUpgrade = Core.Nothing,
                         availabilityZone = Core.Nothing, dnsNameServers = Core.Nothing,
                         engineVersion = Core.Nothing, freeUntil = Core.Nothing,
                         instanceCreateTime = Core.Nothing, kmsKeyId = Core.Nothing,
                         multiAZ = Core.Nothing, pendingModifiedValues = Core.Nothing,
...
{-# INLINEABLE riAutoMinorVersionUpgrade #-}
...
riAvailabilityZone :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
...
riDnsNameServers :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riDnsNameServers = Lens.field @"dnsNameServers"
{-# INLINEABLE riDnsNameServers #-}
...
riEngineVersion :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riEngineVersion = Lens.field @"engineVersion"
{-# INLINEABLE riEngineVersion #-}
...
{-# INLINEABLE riFreeUntil #-}
{-# DEPRECATED freeUntil "Use generic-lens or generic-optics with 'freeUntil' instead"  #-}
...
{-# INLINEABLE riInstanceCreateTime #-}
...
riKmsKeyId :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riKmsKeyId = Lens.field @"kmsKeyId"
{-# INLINEABLE riKmsKeyId #-}
...
{-# INLINEABLE riPendingModifiedValues #-}
...
riPreferredMaintenanceWindow :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riPreferredMaintenanceWindow = Lens.field @"preferredMaintenanceWindow"
{-# INLINEABLE riPreferredMaintenanceWindow #-}
...
{-# INLINEABLE riPubliclyAccessible #-}
...
riReplicationInstanceArn :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riReplicationInstanceArn = Lens.field @"replicationInstanceArn"
{-# INLINEABLE riReplicationInstanceArn #-}
...
riReplicationInstanceClass :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riReplicationInstanceClass = Lens.field @"replicationInstanceClass"
{-# INLINEABLE riReplicationInstanceClass #-}
...
riReplicationInstanceIdentifier :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riReplicationInstanceIdentifier = Lens.field @"replicationInstanceIdentifier"
{-# INLINEABLE riReplicationInstanceIdentifier #-}
...
riReplicationInstancePrivateIpAddress :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riReplicationInstancePrivateIpAddress = Lens.field @"replicationInstancePrivateIpAddress"
{-# INLINEABLE riReplicationInstancePrivateIpAddress #-}
{-# DEPRECATED replicationInstancePrivateIpAddress "Use generic-lens or generic-optics with 'replicationInstancePrivateIpAddress' instead"  #-}
...
riReplicationInstancePrivateIpAddresses :: Lens.Lens' ReplicationInstance (Core.Maybe [Core.Text])
riReplicationInstancePrivateIpAddresses = Lens.field @"replicationInstancePrivateIpAddresses"
{-# INLINEABLE riReplicationInstancePrivateIpAddresses #-}
{-# DEPRECATED replicationInstancePrivateIpAddresses "Use generic-lens or generic-optics with 'replicationInstancePrivateIpAddresses' instead"  #-}
...
riReplicationInstancePublicIpAddress :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riReplicationInstancePublicIpAddress = Lens.field @"replicationInstancePublicIpAddress"
{-# INLINEABLE riReplicationInstancePublicIpAddress #-}
{-# DEPRECATED replicationInstancePublicIpAddress "Use generic-lens or generic-optics with 'replicationInstancePublicIpAddress' instead"  #-}
...
riReplicationInstancePublicIpAddresses :: Lens.Lens' ReplicationInstance (Core.Maybe [Core.Text])
riReplicationInstancePublicIpAddresses = Lens.field @"replicationInstancePublicIpAddresses"
{-# INLINEABLE riReplicationInstancePublicIpAddresses #-}
{-# DEPRECATED replicationInstancePublicIpAddresses "Use generic-lens or generic-optics with 'replicationInstancePublicIpAddresses' instead"  #-}
...
riReplicationInstanceStatus :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riReplicationInstanceStatus = Lens.field @"replicationInstanceStatus"
{-# INLINEABLE riReplicationInstanceStatus #-}
{-# DEPRECATED replicationInstanceStatus "Use generic-lens or generic-optics with 'replicationInstanceStatus' instead"  #-}
...
{-# INLINEABLE riReplicationSubnetGroup #-}
...
riSecondaryAvailabilityZone :: Lens.Lens' ReplicationInstance (Core.Maybe Core.Text)
riSecondaryAvailabilityZone = Lens.field @"secondaryAvailabilityZone"
{-# INLINEABLE riSecondaryAvailabilityZone #-}
...
{-# INLINEABLE riVpcSecurityGroups #-}
