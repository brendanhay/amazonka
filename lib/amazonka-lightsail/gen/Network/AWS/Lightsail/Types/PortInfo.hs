...
mkPortInfo
    :: PortInfo
mkPortInfo
  = PortInfo'{cidrListAliases = Core.Nothing, cidrs = Core.Nothing,
              fromPort = Core.Nothing, protocol = Core.Nothing,
              toPort = Core.Nothing}
...
piCidrListAliases :: Lens.Lens' PortInfo (Core.Maybe [Core.Text])
piCidrListAliases = Lens.field @"cidrListAliases"
{-# INLINEABLE piCidrListAliases #-}
...
piCidrs :: Lens.Lens' PortInfo (Core.Maybe [Core.Text])
