...
instance Core.ToHeaders CreateLaunch where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Core.ToJSON CreateLaunch where
  toJSON CreateLaunch' {..} =
    Core.object
      ( Prelude.catMaybes
...
instance Core.ToPath CreateLaunch where
  toPath CreateLaunch' {..} =
    Prelude.mconcat
      ["/projects/", Core.toBS project, "/launches"]

instance Core.ToQuery CreateLaunch where
