...
cfoaicCallerReference :: Lens.Lens' CloudFrontOriginAccessIdentityConfig Core.Text
cfoaicCallerReference = Lens.field @"callerReference"
{-# INLINEABLE cfoaicCallerReference #-}
...
cfoaicComment :: Lens.Lens' CloudFrontOriginAccessIdentityConfig Core.Text
cfoaicComment = Lens.field @"comment"
{-# INLINEABLE cfoaicComment #-}
...
instance Core.FromXML CloudFrontOriginAccessIdentityConfig where
        parseXML x
          = CloudFrontOriginAccessIdentityConfig' Core.<$>
