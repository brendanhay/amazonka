...
mkProvisioningArtifactPreferences
    :: ProvisioningArtifactPreferences
mkProvisioningArtifactPreferences
  = ProvisioningArtifactPreferences'{stackSetAccounts = Core.Nothing,
...
{-# INLINEABLE papStackSetAccounts #-}
...
instance Core.FromJSON ProvisioningArtifactPreferences where
        parseJSON
          = Core.withObject "ProvisioningArtifactPreferences" Core.$
              \ x ->
                ProvisioningArtifactPreferences' Core.<$>
                  (x Core..:? "StackSetAccounts") Core.<*>
                    x Core..:? "StackSetRegions"
