...
mkEntityRecognizerFilter
    :: EntityRecognizerFilter
mkEntityRecognizerFilter
  = EntityRecognizerFilter'{status = Core.Nothing,
                            submitTimeAfter = Core.Nothing, submitTimeBefore = Core.Nothing}
...
{-# INLINEABLE erfSubmitTimeBefore #-}
