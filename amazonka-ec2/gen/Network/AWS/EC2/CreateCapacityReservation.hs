...
--
-- * 'ccrClientToken' - Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. For more information, see <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html How to Ensure Idempotency> . Constraint: Maximum 64 ASCII characters.
--
...
createCapacityReservation
    :: Text -- ^ 'ccrInstanceType'
    -> CapacityReservationInstancePlatform -- ^ 'ccrInstancePlatform'
    -> Text -- ^ 'ccrAvailabilityZone'
    -> Int -- ^ 'ccrInstanceCount'
    -> CreateCapacityReservation
createCapacityReservation pInstanceType_ pInstancePlatform_ pAvailabilityZone_ pInstanceCount_ =
  CreateCapacityReservation'
    ...
    , _ccrAvailabilityZone = pAvailabilityZone_
...
ccrAvailabilityZone :: Lens' CreateCapacityReservation Text
...
instance Hashable CreateCapacityReservation where

instance NFData CreateCapacityReservation where
