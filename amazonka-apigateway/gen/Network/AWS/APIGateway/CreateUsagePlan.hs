...
createUsagePlan_apiStages = Lens.lens (\CreateUsagePlan' {apiStages} -> apiStages) (\s@CreateUsagePlan' {} a -> s {apiStages = a} :: CreateUsagePlan) Prelude.. Lens.mapping Prelude._Coerce

-- | The key-value map of strings. The valid character set is
-- [a-zA-Z+-=._:\/]. The tag key can be up to 128 characters and must not
-- start with @aws:@. The tag value can be up to 256 characters.
createUsagePlan_tags :: Lens.Lens' CreateUsagePlan (Prelude.Maybe (Prelude.HashMap Prelude.Text Prelude.Text))
createUsagePlan_tags = Lens.lens (\CreateUsagePlan' {tags} -> tags) (\s@CreateUsagePlan' {} a -> s {tags = a} :: CreateUsagePlan) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest CreateUsagePlan where
...
instance Prelude.ToHeaders CreateUsagePlan where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Accept"
...
instance Prelude.ToJSON CreateUsagePlan where
  toJSON CreateUsagePlan' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("apiStages" Prelude..=) Prelude.<$> apiStages,
            ("tags" Prelude..=) Prelude.<$> tags,
            ("description" Prelude..=) Prelude.<$> description,
            ("quota" Prelude..=) Prelude.<$> quota,
            ("throttle" Prelude..=) Prelude.<$> throttle,
            Prelude.Just ("name" Prelude..= name)
          ]
      )

instance Prelude.ToPath CreateUsagePlan where
  toPath = Prelude.const "/usageplans"

instance Prelude.ToQuery CreateUsagePlan where
