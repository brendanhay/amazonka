...
mkRemixSettings
    :: RemixSettings
mkRemixSettings
  = RemixSettings'{channelMapping = Core.Nothing,
...
{-# INLINEABLE rsChannelMapping #-}
{-# DEPRECATED channelMapping "Use generic-lens or generic-optics with 'channelMapping' instead"  #-}
...
instance Core.FromJSON RemixSettings where
        parseJSON
          = Core.withObject "RemixSettings" Core.$
              \ x ->
                RemixSettings' Core.<$>
                  (x Core..:? "channelMapping") Core.<*> x Core..:? "channelsIn"
