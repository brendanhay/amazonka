...
-- |
-- Module      : Network.AWS.DevOpsGuru.Types.CostEstimationStatus
...
pattern CostEstimationStatus_COMPLETED = CostEstimationStatus' "COMPLETED"

pattern CostEstimationStatus_ONGOING :: CostEstimationStatus
pattern CostEstimationStatus_ONGOING = CostEstimationStatus' "ONGOING"
