...
mkGameSession
    :: GameSession
mkGameSession
  = GameSession'{creationTime = Core.Nothing,
                 creatorId = Core.Nothing, currentPlayerSessionCount = Core.Nothing,
                 dnsName = Core.Nothing, fleetArn = Core.Nothing,
                 fleetId = Core.Nothing, gameProperties = Core.Nothing,
                 gameSessionData = Core.Nothing, gameSessionId = Core.Nothing,
                 ipAddress = Core.Nothing, matchmakerData = Core.Nothing,
                 maximumPlayerSessionCount = Core.Nothing, name = Core.Nothing,
                 playerSessionCreationPolicy = Core.Nothing, port = Core.Nothing,
...
{-# INLINEABLE gsCurrentPlayerSessionCount #-}
...
{-# INLINEABLE gsMaximumPlayerSessionCount #-}
...
{-# INLINEABLE gsPlayerSessionCreationPolicy #-}
...
instance Core.FromJSON GameSession where
        parseJSON
          = Core.withObject "GameSession" Core.$
              \ x ->
                GameSession' Core.<$>
                  (x Core..:? "CreationTime") Core.<*> x Core..:? "CreatorId"
