...
mkMemberDefinition
    :: MemberDefinition
mkMemberDefinition
  = MemberDefinition'{cognitoMemberDefinition = Core.Nothing,
...
{-# INLINEABLE mdCognitoMemberDefinition #-}
{-# DEPRECATED cognitoMemberDefinition "Use generic-lens or generic-optics with 'cognitoMemberDefinition' instead"  #-}
...
{-# INLINEABLE mdOidcMemberDefinition #-}
{-# DEPRECATED oidcMemberDefinition "Use generic-lens or generic-optics with 'oidcMemberDefinition' instead"  #-}

instance Core.FromJSON MemberDefinition where
        toJSON MemberDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("CognitoMemberDefinition" Core..=) Core.<$>
...
instance Core.FromJSON MemberDefinition where
        parseJSON
          = Core.withObject "MemberDefinition" Core.$
              \ x ->
                MemberDefinition' Core.<$>
                  (x Core..:? "CognitoMemberDefinition") Core.<*>
                    x Core..:? "OidcMemberDefinition"
