...
mkCertificate
    :: Certificate
mkCertificate
  = Certificate'{arn = Core.Nothing, createdAt = Core.Nothing,
                 domainName = Core.Nothing, domainValidationRecords = Core.Nothing,
                 eligibleToRenew = Core.Nothing, inUseResourceCount = Core.Nothing,
                 issuedAt = Core.Nothing, issuerCA = Core.Nothing,
                 keyAlgorithm = Core.Nothing, name = Core.Nothing,
                 notAfter = Core.Nothing, notBefore = Core.Nothing,
                 renewalSummary = Core.Nothing, requestFailureReason = Core.Nothing,
...
{-# INLINEABLE cfDomainValidationRecords #-}
...
{-# INLINEABLE cfEligibleToRenew #-}
{-# DEPRECATED eligibleToRenew "Use generic-lens or generic-optics with 'eligibleToRenew' instead"  #-}
...
{-# INLINEABLE cfInUseResourceCount #-}
{-# DEPRECATED inUseResourceCount "Use generic-lens or generic-optics with 'inUseResourceCount' instead"  #-}
...
{-# INLINEABLE cfIssuerCA #-}
{-# DEPRECATED issuerCA "Use generic-lens or generic-optics with 'issuerCA' instead"  #-}
...
{-# INLINEABLE cfRequestFailureReason #-}
{-# DEPRECATED requestFailureReason "Use generic-lens or generic-optics with 'requestFailureReason' instead"  #-}
...
{-# INLINEABLE cfSubjectAlternativeNames #-}
...
cfSupportCode :: Lens.Lens' Certificate (Core.Maybe Core.Text)
cfSupportCode = Lens.field @"supportCode"
{-# INLINEABLE cfSupportCode #-}
