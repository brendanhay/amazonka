...
cmvbQueueUrl :: Lens.Lens' ChangeMessageVisibilityBatch Core.Text
cmvbQueueUrl = Lens.field @"queueUrl"
{-# INLINEABLE cmvbQueueUrl #-}
...
instance Core.ToQuery ChangeMessageVisibilityBatch where
        toQuery ChangeMessageVisibilityBatch{..}
          = Core.toQueryPair "Action"
              ("ChangeMessageVisibilityBatch" :: Core.Text)
              Core.<> Core.toQueryPair "Version" ("2012-11-05" :: Core.Text)
              Core.<> Core.toQueryPair "QueueUrl" queueUrl
              Core.<>
              Core.toQueryList "ChangeMessageVisibilityBatchRequestEntry" entries
...
instance Core.AWSRequest ChangeMessageVisibilityBatch where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ChangeMessageVisibilityBatchResult"
              (\ s h x ->
                 ChangeMessageVisibilityBatchResponse' Core.<$>
                   (x Core..@ "ChangeMessageVisibilityBatchResultEntry" Core..@!
                      Core.mempty)
...
mkChangeMessageVisibilityBatchResponse responseStatus
  = ChangeMessageVisibilityBatchResponse'{successful = Core.mempty,
...
{-# INLINEABLE cmvbrrsResponseStatus #-}
