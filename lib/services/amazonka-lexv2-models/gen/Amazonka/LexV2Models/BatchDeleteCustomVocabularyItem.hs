...
instance Core.ToJSON BatchDeleteCustomVocabularyItem where
...
instance Core.ToPath BatchDeleteCustomVocabularyItem where
...
instance Core.ToQuery BatchDeleteCustomVocabularyItem where
