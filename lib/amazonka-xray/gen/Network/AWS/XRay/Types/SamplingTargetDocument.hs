...
mkSamplingTargetDocument
    :: SamplingTargetDocument
mkSamplingTargetDocument
  = SamplingTargetDocument'{fixedRate = Core.Nothing,
                            interval = Core.Nothing, reservoirQuota = Core.Nothing,
                            reservoirQuotaTTL = Core.Nothing, ruleName = Core.Nothing}
...
{-# INLINEABLE stdReservoirQuota #-}
{-# DEPRECATED reservoirQuota "Use generic-lens or generic-optics with 'reservoirQuota' instead"  #-}
...
{-# INLINEABLE stdReservoirQuotaTTL #-}
{-# DEPRECATED reservoirQuotaTTL "Use generic-lens or generic-optics with 'reservoirQuotaTTL' instead"  #-}

-- | The name of the sampling rule.
--
-- /Note:/ Consider using 'ruleName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
stdRuleName :: Lens.Lens' SamplingTargetDocument (Core.Maybe Core.Text)
stdRuleName = Lens.field @"ruleName"
{-# INLINEABLE stdRuleName #-}
...
instance Core.FromJSON SamplingTargetDocument where
        parseJSON
          = Core.withObject "SamplingTargetDocument" Core.$
              \ x ->
                SamplingTargetDocument' Core.<$>
                  (x Core..:? "FixedRate") Core.<*> x Core..:? "Interval" Core.<*>
                    x Core..:? "ReservoirQuota"
