...
mkWorkspaceProperties
    :: WorkspaceProperties
mkWorkspaceProperties
  = WorkspaceProperties'{computeTypeName = Core.Nothing,
                         rootVolumeSizeGib = Core.Nothing, runningMode = Core.Nothing,
...
{-# INLINEABLE wpComputeTypeName #-}
{-# DEPRECATED computeTypeName "Use generic-lens or generic-optics with 'computeTypeName' instead"  #-}
...
{-# INLINEABLE wpRootVolumeSizeGib #-}
{-# DEPRECATED rootVolumeSizeGib "Use generic-lens or generic-optics with 'rootVolumeSizeGib' instead"  #-}
...
{-# INLINEABLE wpRunningMode #-}
{-# DEPRECATED runningMode "Use generic-lens or generic-optics with 'runningMode' instead"  #-}
...
{-# INLINEABLE wpRunningModeAutoStopTimeoutInMinutes #-}
{-# DEPRECATED runningModeAutoStopTimeoutInMinutes "Use generic-lens or generic-optics with 'runningModeAutoStopTimeoutInMinutes' instead"  #-}
...
{-# INLINEABLE wpUserVolumeSizeGib #-}
{-# DEPRECATED userVolumeSizeGib "Use generic-lens or generic-optics with 'userVolumeSizeGib' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("ComputeTypeName" Core..=) Core.<$> computeTypeName,
                  ...
                  ("RunningModeAutoStopTimeoutInMinutes" Core..=) Core.<$>
          ...
          = Core.withObject "WorkspaceProperties" Core.$
              \ x ->
                WorkspaceProperties' Core.<$>
                  (x Core..:? "ComputeTypeName") Core.<*>
                    x Core..:? "RootVolumeSizeGib"
