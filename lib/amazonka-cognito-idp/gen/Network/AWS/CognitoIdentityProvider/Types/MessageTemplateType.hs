...
mkMessageTemplateType
    :: MessageTemplateType
mkMessageTemplateType
  = MessageTemplateType'{emailMessage = Core.Nothing,
                         emailSubject = Core.Nothing, sMSMessage = Core.Nothing}
...
instance Core.FromJSON MessageTemplateType where
        parseJSON
          = Core.withObject "MessageTemplateType" Core.$
              \ x ->
                MessageTemplateType' Core.<$>
                  (x Core..:? "EmailMessage") Core.<*> x Core..:? "EmailSubject"
