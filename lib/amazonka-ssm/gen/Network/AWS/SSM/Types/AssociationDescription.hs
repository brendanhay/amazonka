...
mkAssociationDescription
    :: AssociationDescription
mkAssociationDescription
  = AssociationDescription'{applyOnlyAtCronInterval = Core.Nothing,
                            ...
                            complianceSeverity = Core.Nothing, date = Core.Nothing,
                            ...
                            overview = Core.Nothing, parameters = Core.Nothing,
                            scheduleExpression = Core.Nothing, status = Core.Nothing,
...
{-# INLINEABLE adApplyOnlyAtCronInterval #-}
...
{-# INLINEABLE adAssociationVersion #-}
...
{-# INLINEABLE adAutomationTargetParameterName #-}
...
{-# INLINEABLE adComplianceSeverity #-}
...
{-# INLINEABLE adLastExecutionDate #-}
...
{-# INLINEABLE adLastSuccessfulExecutionDate #-}
{-# DEPRECATED lastSuccessfulExecutionDate "Use generic-lens or generic-optics with 'lastSuccessfulExecutionDate' instead"  #-}
...
{-# INLINEABLE adLastUpdateAssociationDate #-}
{-# DEPRECATED lastUpdateAssociationDate "Use generic-lens or generic-optics with 'lastUpdateAssociationDate' instead"  #-}
...
{-# INLINEABLE adScheduleExpression #-}
