...
mkProxyConfiguration containerName
  = ProxyConfiguration'{containerName, properties = Core.Nothing,
                        type' = Core.Nothing}

-- | The name of the container that will serve as the App Mesh proxy.
--
-- /Note:/ Consider using 'containerName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
pContainerName :: Lens.Lens' ProxyConfiguration Core.Text
          ...
          = Core.withObject "ProxyConfiguration" Core.$
              \ x ->
                ProxyConfiguration' Core.<$>
                  (x Core..: "containerName") Core.<*> x Core..:? "properties"
                    Core.<*> x Core..:? "type"
