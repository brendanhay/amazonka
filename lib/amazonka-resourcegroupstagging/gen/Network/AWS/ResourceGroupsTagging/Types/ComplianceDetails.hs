...
mkComplianceDetails
    :: ComplianceDetails
mkComplianceDetails
  = ComplianceDetails'{complianceStatus = Core.Nothing,
...
{-# INLINEABLE cdKeysWithNoncompliantValues #-}
{-# DEPRECATED keysWithNoncompliantValues "Use generic-lens or generic-optics with 'keysWithNoncompliantValues' instead"  #-}
...
{-# INLINEABLE cdNoncompliantKeys #-}
{-# DEPRECATED noncompliantKeys "Use generic-lens or generic-optics with 'noncompliantKeys' instead"  #-}

instance Core.FromJSON ComplianceDetails where
        parseJSON
          = Core.withObject "ComplianceDetails" Core.$
              \ x ->
                ComplianceDetails' Core.<$>
                  (x Core..:? "ComplianceStatus") Core.<*>
                    x Core..:? "KeysWithNoncompliantValues"
