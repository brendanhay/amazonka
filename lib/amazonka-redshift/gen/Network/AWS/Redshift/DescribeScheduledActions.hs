...
mkDescribeScheduledActions
    :: DescribeScheduledActions
mkDescribeScheduledActions
  = DescribeScheduledActions'{active = Core.Nothing,
                              endTime = Core.Nothing, filters = Core.Nothing,
...
{-# INLINEABLE dsasFilters #-}
{-# DEPRECATED filters "Use generic-lens or generic-optics with 'filters' instead"  #-}

-- | An optional parameter that specifies the starting point to return a set of response records. When the results of a 'DescribeScheduledActions' request exceed the value specified in @MaxRecords@ , AWS returns a value in the @Marker@ field of the response. You can retrieve the next set of response records by providing the returned marker value in the @Marker@ parameter and retrying the request. 
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsasMarker :: Lens.Lens' DescribeScheduledActions (Core.Maybe Core.Text)
dsasMarker = Lens.field @"marker"
{-# INLINEABLE dsasMarker #-}
...
dsasScheduledActionName :: Lens.Lens' DescribeScheduledActions (Core.Maybe Core.Text)
dsasScheduledActionName = Lens.field @"scheduledActionName"
{-# INLINEABLE dsasScheduledActionName #-}
...
{-# INLINEABLE dsasTargetActionType #-}
{-# DEPRECATED targetActionType "Use generic-lens or generic-optics with 'targetActionType' instead"  #-}
...
instance Core.ToQuery DescribeScheduledActions where
        toQuery DescribeScheduledActions{..}
          = Core.toQueryPair "Action"
              ...
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "Active") active
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "EndTime") endTime
              Core.<>
              Core.toQueryPair "Filters"
                (Core.maybe Core.mempty (Core.toQueryList "ScheduledActionFilter")
                   filters)
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "Marker") marker
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "MaxRecords") maxRecords
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "ScheduledActionName")
                scheduledActionName
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "StartTime") startTime
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "TargetActionType")
                targetActionType
          ...
          = Response.receiveXMLWrapper "DescribeScheduledActionsResult"
              (\ s h x ->
                 DescribeScheduledActionsResponse' Core.<$>
                   (x Core..@? "Marker") Core.<*>
                     x Core..@? "ScheduledActions" Core..<@>
                       Core.parseXMLList "ScheduledAction"
...
mkDescribeScheduledActionsResponse responseStatus
  = DescribeScheduledActionsResponse'{marker = Core.Nothing,
                                      scheduledActions = Core.Nothing, responseStatus}

-- | An optional parameter that specifies the starting point to return a set of response records. When the results of a 'DescribeScheduledActions' request exceed the value specified in @MaxRecords@ , AWS returns a value in the @Marker@ field of the response. You can retrieve the next set of response records by providing the returned marker value in the @Marker@ parameter and retrying the request. 
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsarrsMarker :: Lens.Lens' DescribeScheduledActionsResponse (Core.Maybe Core.Text)
dsarrsMarker = Lens.field @"marker"
{-# INLINEABLE dsarrsMarker #-}
{-# DEPRECATED marker "Use generic-lens or generic-optics with 'marker' instead"  #-}
