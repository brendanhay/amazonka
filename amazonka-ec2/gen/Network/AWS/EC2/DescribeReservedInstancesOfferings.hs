...
describeReservedInstancesOfferings_filters = Lens.lens (\DescribeReservedInstancesOfferings' {filters} -> filters) (\s@DescribeReservedInstancesOfferings' {} a -> s {filters = a} :: DescribeReservedInstancesOfferings) Prelude.. Lens.mapping Prelude._Coerce
      ...
      ( \s h x ->
          DescribeReservedInstancesOfferingsResponse'
            Prelude.<$> (x Prelude..@? "nextToken")
              Prelude.<*> ( x Prelude..@? "reservedInstancesOfferingsSet"
  ...
  toQuery DescribeReservedInstancesOfferings' {..} =
    Prelude.mconcat
      [ "Action"
        ...
        "MaxInstanceCount" Prelude.=: maxInstanceCount,
        "MaxResults" Prelude.=: maxResults,
        "IncludeMarketplace" Prelude.=: includeMarketplace,
        ...
        Prelude.toQuery
          ( Prelude.toQueryList "ReservedInstancesOfferingId"
