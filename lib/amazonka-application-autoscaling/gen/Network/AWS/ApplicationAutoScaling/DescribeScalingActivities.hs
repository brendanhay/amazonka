...
desScalableDimension :: Lens.Lens' DescribeScalingActivities (Lude.Maybe ScalableDimension)
desScalableDimension = Lens.lens (scalableDimension :: DescribeScalingActivities -> Lude.Maybe ScalableDimension) (\s a -> s {scalableDimension = a} :: DescribeScalingActivities)
{-# DEPRECATED desScalableDimension "Use generic-lens or generic-optics with 'scalableDimension' instead." #-}
...
desResourceId :: Lens.Lens' DescribeScalingActivities (Lude.Maybe Lude.Text)
desResourceId = Lens.lens (resourceId :: DescribeScalingActivities -> Lude.Maybe Lude.Text) (\s a -> s {resourceId = a} :: DescribeScalingActivities)
{-# DEPRECATED desResourceId "Use generic-lens or generic-optics with 'resourceId' instead." #-}
...
desMaxResults :: Lens.Lens' DescribeScalingActivities (Lude.Maybe Lude.Int)
desMaxResults = Lens.lens (maxResults :: DescribeScalingActivities -> Lude.Maybe Lude.Int) (\s a -> s {maxResults = a} :: DescribeScalingActivities)
...
desServiceNamespace :: Lens.Lens' DescribeScalingActivities ServiceNamespace
desServiceNamespace = Lens.lens (serviceNamespace :: DescribeScalingActivities -> ServiceNamespace) (\s a -> s {serviceNamespace = a} :: DescribeScalingActivities)
{-# DEPRECATED desServiceNamespace "Use generic-lens or generic-optics with 'serviceNamespace' instead." #-}
