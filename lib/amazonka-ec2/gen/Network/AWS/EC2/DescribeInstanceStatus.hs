...
instance AWSPager DescribeInstanceStatus where
  page rq rs
    ...
    | otherwise = Just $ rq & disNextToken .~ rs ^. disrsNextToken
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'disrsInstanceStatuses' - Information about the status of the instances.
--
