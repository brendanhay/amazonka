    ...
    object
      ( catMaybes
          [ ("cluster" .=) <$> _creCluster,
            ...
            ("enableECSManagedTags" .=) <$> _creEnableECSManagedTags,
            ("desiredCount" .=) <$> _creDesiredCount,
            ("loadBalancers" .=) <$> _creLoadBalancers,
            ("role" .=) <$> _creRole,
            ("placementConstraints" .=) <$> _crePlacementConstraints,
            ("placementStrategy" .=) <$> _crePlacementStrategy,
            ("deploymentController" .=) <$> _creDeploymentController,
            ...
            ("networkConfiguration" .=) <$> _creNetworkConfiguration,
            ("serviceRegistries" .=) <$> _creServiceRegistries,
            ("capacityProviderStrategy" .=) <$> _creCapacityProviderStrategy,
            ("tags" .=) <$> _creTags,
            ("deploymentConfiguration" .=) <$> _creDeploymentConfiguration,
