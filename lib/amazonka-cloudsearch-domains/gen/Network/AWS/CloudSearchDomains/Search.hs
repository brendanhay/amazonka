...
mkSearch
    ...
    -> Search
mkSearch query
  = Search'{query, cursor = Core.Nothing, expr = Core.Nothing,
            facet = Core.Nothing, filterQuery = Core.Nothing,
            highlight = Core.Nothing, partial = Core.Nothing,
            queryOptions = Core.Nothing, queryParser = Core.Nothing,
            return = Core.Nothing, size = Core.Nothing, sort = Core.Nothing,
            start = Core.Nothing, stats = Core.Nothing}
...
{-# INLINEABLE sfExpr #-}
{-# DEPRECATED expr "Use generic-lens or generic-optics with 'expr' instead"  #-}
...
{-# INLINEABLE sfFilterQuery #-}
{-# DEPRECATED filterQuery "Use generic-lens or generic-optics with 'filterQuery' instead"  #-}
...
{-# INLINEABLE sfHighlight #-}
{-# DEPRECATED highlight "Use generic-lens or generic-optics with 'highlight' instead"  #-}
...
{-# INLINEABLE sfPartial #-}
{-# DEPRECATED partial "Use generic-lens or generic-optics with 'partial' instead"  #-}
...
{-# INLINEABLE sfQueryOptions #-}
{-# DEPRECATED queryOptions "Use generic-lens or generic-optics with 'queryOptions' instead"  #-}
...
{-# INLINEABLE sfQueryParser #-}
{-# DEPRECATED queryParser "Use generic-lens or generic-optics with 'queryParser' instead"  #-}
...
instance Core.ToQuery Search where
        toQuery Search{..}
          = Core.toQueryPair "q" query Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "cursor") cursor
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "expr") expr
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "facet") facet
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "fq") filterQuery
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "highlight") highlight
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "partial") partial
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "q.options") queryOptions
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "q.parser") queryParser
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "return") return
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "size") size
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "sort") sort
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "start") start
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "stats") stats
...
instance Core.AWSRequest Search where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         Core._rqMethod = Request.GET, Core._rqPath = "/2013-01-01/search",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 SearchResponse' Core.<$>
                   (x Core..:? "facets") Core.<*> x Core..:? "hits" Core.<*>
                     x Core..:? "stats"
                     Core.<*> x Core..:? "status"
...
data SearchResponse = SearchResponse'
  { facets :: Core.Maybe (Core.HashMap Core.Text Types.BucketInfo)
    -- ^ The requested facet information.
  , hits :: Core.Maybe Types.Hits
    -- ^ The documents that match the search criteria.
  , stats :: Core.Maybe (Core.HashMap Core.Text Types.FieldStats)
...
mkSearchResponse responseStatus
  = SearchResponse'{facets = Core.Nothing, hits = Core.Nothing,
                    stats = Core.Nothing, status = Core.Nothing, responseStatus}
...
srsFacets :: Lens.Lens' SearchResponse (Core.Maybe (Core.HashMap Core.Text Types.BucketInfo))
srsFacets = Lens.field @"facets"
{-# INLINEABLE srsFacets #-}
{-# DEPRECATED facets "Use generic-lens or generic-optics with 'facets' instead"  #-}
...
--
-- /Note:/ Consider using 'stats' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
srsStats :: Lens.Lens' SearchResponse (Core.Maybe (Core.HashMap Core.Text Types.FieldStats))
