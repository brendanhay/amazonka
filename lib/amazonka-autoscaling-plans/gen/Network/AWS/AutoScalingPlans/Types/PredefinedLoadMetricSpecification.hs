...
mkPredefinedLoadMetricSpecification
    :: Types.LoadMetricType -- ^ 'predefinedLoadMetricType'
    -> PredefinedLoadMetricSpecification
...
{-# INLINEABLE plmsPredefinedLoadMetricType #-}
{-# DEPRECATED predefinedLoadMetricType "Use generic-lens or generic-optics with 'predefinedLoadMetricType' instead"  #-}
          ...
          = Core.withObject "PredefinedLoadMetricSpecification" Core.$
              \ x ->
                PredefinedLoadMetricSpecification' Core.<$>
                  (x Core..: "PredefinedLoadMetricType") Core.<*>
