...
{-# INLINEABLE mapAddThingsToThingGroupParams #-}
{-# DEPRECATED addThingsToThingGroupParams "Use generic-lens or generic-optics with 'addThingsToThingGroupParams' instead"  #-}
...
{-# INLINEABLE mapEnableIoTLoggingParams #-}
{-# DEPRECATED enableIoTLoggingParams "Use generic-lens or generic-optics with 'enableIoTLoggingParams' instead"  #-}
...
{-# INLINEABLE mapPublishFindingToSnsParams #-}
{-# DEPRECATED publishFindingToSnsParams "Use generic-lens or generic-optics with 'publishFindingToSnsParams' instead"  #-}
...
{-# INLINEABLE mapReplaceDefaultPolicyVersionParams #-}
{-# DEPRECATED replaceDefaultPolicyVersionParams "Use generic-lens or generic-optics with 'replaceDefaultPolicyVersionParams' instead"  #-}
...
{-# INLINEABLE mapUpdateCACertificateParams #-}
{-# DEPRECATED updateCACertificateParams "Use generic-lens or generic-optics with 'updateCACertificateParams' instead"  #-}
...
{-# INLINEABLE mapUpdateDeviceCertificateParams #-}
{-# DEPRECATED updateDeviceCertificateParams "Use generic-lens or generic-optics with 'updateDeviceCertificateParams' instead"  #-}

instance Core.FromJSON MitigationActionParams where
        toJSON MitigationActionParams{..}
          = Core.object
              (Core.catMaybes
                 [("addThingsToThingGroupParams" Core..=) Core.<$>
                    addThingsToThingGroupParams,
                  ("enableIoTLoggingParams" Core..=) Core.<$> enableIoTLoggingParams,
                  ("publishFindingToSnsParams" Core..=) Core.<$>
                    publishFindingToSnsParams,
                  ("replaceDefaultPolicyVersionParams" Core..=) Core.<$>
                    replaceDefaultPolicyVersionParams,
                  ("updateCACertificateParams" Core..=) Core.<$>
                    updateCACertificateParams,
                  ("updateDeviceCertificateParams" Core..=) Core.<$>
...
instance Core.FromJSON MitigationActionParams where
        parseJSON
          = Core.withObject "MitigationActionParams" Core.$
              \ x ->
                MitigationActionParams' Core.<$>
                  (x Core..:? "addThingsToThingGroupParams") Core.<*>
                    x Core..:? "enableIoTLoggingParams"
