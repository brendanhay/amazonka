...
mkIdentityDkimAttributes
    :: Core.Bool -- ^ 'dkimEnabled'
    -> Types.VerificationStatus -- ^ 'dkimVerificationStatus'
    -> IdentityDkimAttributes
mkIdentityDkimAttributes dkimEnabled dkimVerificationStatus
  = IdentityDkimAttributes'{dkimEnabled, dkimVerificationStatus,
...
{-# INLINEABLE idaDkimEnabled #-}
{-# DEPRECATED dkimEnabled "Use generic-lens or generic-optics with 'dkimEnabled' instead"  #-}
...
{-# INLINEABLE idaDkimVerificationStatus #-}
{-# DEPRECATED dkimVerificationStatus "Use generic-lens or generic-optics with 'dkimVerificationStatus' instead"  #-}
...
{-# INLINEABLE idaDkimTokens #-}
{-# DEPRECATED dkimTokens "Use generic-lens or generic-optics with 'dkimTokens' instead"  #-}

instance Core.FromXML IdentityDkimAttributes where
        parseXML x
          = IdentityDkimAttributes' Core.<$>
              (x Core..@ "DkimEnabled") Core.<*>
                x Core..@ "DkimVerificationStatus"
                Core.<*>
                x Core..@? "DkimTokens" Core..<@> Core.parseXMLList "member"
