...
mkOutputConfig
    :: Types.S3OutputLocation -- ^ 's3OutputLocation'
    -> OutputConfig
mkOutputConfig s3OutputLocation
  = OutputConfig'{s3OutputLocation, compilerOptions = Core.Nothing,
                  targetDevice = Core.Nothing, targetPlatform = Core.Nothing}
...
{-# INLINEABLE ocS3OutputLocation #-}
{-# DEPRECATED s3OutputLocation "Use generic-lens or generic-optics with 's3OutputLocation' instead"  #-}
...
{-# INLINEABLE ocCompilerOptions #-}
{-# DEPRECATED compilerOptions "Use generic-lens or generic-optics with 'compilerOptions' instead"  #-}
...
{-# INLINEABLE ocTargetDevice #-}
{-# DEPRECATED targetDevice "Use generic-lens or generic-optics with 'targetDevice' instead"  #-}
...
{-# INLINEABLE ocTargetPlatform #-}
{-# DEPRECATED targetPlatform "Use generic-lens or generic-optics with 'targetPlatform' instead"  #-}
...
instance Core.FromJSON OutputConfig where
        parseJSON
          = Core.withObject "OutputConfig" Core.$
              \ x ->
                OutputConfig' Core.<$>
                  (x Core..: "S3OutputLocation") Core.<*>
                    x Core..:? "CompilerOptions"
