...
mkCPUUtilization
    :: CPUUtilization
mkCPUUtilization
  = CPUUtilization'{iOWait = Core.Nothing, irq = Core.Nothing,
                    idle = Core.Nothing, nice = Core.Nothing,
                    privileged = Core.Nothing, softIRQ = Core.Nothing,
                    system = Core.Nothing, user = Core.Nothing}
...
{-# INLINEABLE cpuuIOWait #-}
{-# DEPRECATED iOWait "Use generic-lens or generic-optics with 'iOWait' instead"  #-}
...
{-# INLINEABLE cpuuIRQ #-}
{-# DEPRECATED irq "Use generic-lens or generic-optics with 'irq' instead"  #-}
...
{-# INLINEABLE cpuuNice #-}
{-# DEPRECATED nice "Use generic-lens or generic-optics with 'nice' instead"  #-}
...
{-# INLINEABLE cpuuSoftIRQ #-}
{-# DEPRECATED softIRQ "Use generic-lens or generic-optics with 'softIRQ' instead"  #-}
...
instance Core.FromXML CPUUtilization where
        parseXML x
          = CPUUtilization' Core.<$>
              (x Core..@? "IOWait") Core.<*> x Core..@? "IRQ" Core.<*>
                x Core..@? "Idle"
                Core.<*> x Core..@? "Nice"
