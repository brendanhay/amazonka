...
instance Core.ToHeaders GetAppReplicationConfiguration where
        toHeaders GetAppReplicationConfiguration{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest GetAppReplicationConfiguration where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetAppReplicationConfigurationResponse' Core.<$>
                   (x Core..:? "serverGroupReplicationConfigurations") Core.<*>
...
{-# INLINEABLE garcrrsServerGroupReplicationConfigurations #-}
