...
mkUnprocessedIdentityId
    :: UnprocessedIdentityId
mkUnprocessedIdentityId
  = UnprocessedIdentityId'{errorCode = Core.Nothing,
...
instance Core.FromJSON UnprocessedIdentityId where
        parseJSON
          = Core.withObject "UnprocessedIdentityId" Core.$
              \ x ->
                UnprocessedIdentityId' Core.<$>
                  (x Core..:? "ErrorCode") Core.<*> x Core..:? "IdentityId"
