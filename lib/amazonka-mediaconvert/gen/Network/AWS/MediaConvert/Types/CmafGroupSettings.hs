...
mkCmafGroupSettings
    :: CmafGroupSettings
mkCmafGroupSettings
  = CmafGroupSettings'{additionalManifests = Core.Nothing,
                       baseUrl = Core.Nothing, clientCache = Core.Nothing,
                       codecSpecification = Core.Nothing, destination = Core.Nothing,
                       destinationSettings = Core.Nothing, encryption = Core.Nothing,
                       fragmentLength = Core.Nothing, manifestCompression = Core.Nothing,
                       manifestDurationFormat = Core.Nothing,
                       minBufferTime = Core.Nothing, minFinalSegmentLength = Core.Nothing,
                       mpdProfile = Core.Nothing, segmentControl = Core.Nothing,
                       segmentLength = Core.Nothing, streamInfResolution = Core.Nothing,
                       writeDashManifest = Core.Nothing, writeHlsManifest = Core.Nothing,
...
{-# INLINEABLE cgsAdditionalManifests #-}
...
{-# INLINEABLE cgsBaseUrl #-}
{-# DEPRECATED baseUrl "Use generic-lens or generic-optics with 'baseUrl' instead"  #-}
...
{-# INLINEABLE cgsCodecSpecification #-}
...
{-# INLINEABLE cgsDestinationSettings #-}
...
{-# INLINEABLE cgsManifestCompression #-}
...
{-# INLINEABLE cgsManifestDurationFormat #-}
...
{-# INLINEABLE cgsMinBufferTime #-}
{-# DEPRECATED minBufferTime "Use generic-lens or generic-optics with 'minBufferTime' instead"  #-}
...
{-# INLINEABLE cgsMinFinalSegmentLength #-}
{-# DEPRECATED minFinalSegmentLength "Use generic-lens or generic-optics with 'minFinalSegmentLength' instead"  #-}
...
{-# INLINEABLE cgsMpdProfile #-}
{-# DEPRECATED mpdProfile "Use generic-lens or generic-optics with 'mpdProfile' instead"  #-}
...
{-# INLINEABLE cgsSegmentControl #-}
{-# DEPRECATED segmentControl "Use generic-lens or generic-optics with 'segmentControl' instead"  #-}
...
{-# INLINEABLE cgsStreamInfResolution #-}
...
{-# INLINEABLE cgsWriteDashManifest #-}
{-# DEPRECATED writeDashManifest "Use generic-lens or generic-optics with 'writeDashManifest' instead"  #-}
...
{-# INLINEABLE cgsWriteHlsManifest #-}
{-# DEPRECATED writeHlsManifest "Use generic-lens or generic-optics with 'writeHlsManifest' instead"  #-}
...
{-# INLINEABLE cgsWriteSegmentTimelineInRepresentation #-}
{-# DEPRECATED writeSegmentTimelineInRepresentation "Use generic-lens or generic-optics with 'writeSegmentTimelineInRepresentation' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalManifests" Core..=) Core.<$> additionalManifests,
                  ...
                  ("writeSegmentTimelineInRepresentation" Core..=) Core.<$>
          ...
          = Core.withObject "CmafGroupSettings" Core.$
              \ x ->
                CmafGroupSettings' Core.<$>
                  (x Core..:? "additionalManifests") Core.<*> x Core..:? "baseUrl"
