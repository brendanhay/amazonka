...
instance Core.AWSRequest NotifyWhenUploaded where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 NotifyWhenUploadedResponse' Core.<$>
...
mkNotifyWhenUploadedResponse responseStatus
  = NotifyWhenUploadedResponse'{fileShareARN = Core.Nothing,
...
{-# INLINEABLE nwurrsNotificationId #-}
...
{-# INLINEABLE nwurrsResponseStatus #-}
