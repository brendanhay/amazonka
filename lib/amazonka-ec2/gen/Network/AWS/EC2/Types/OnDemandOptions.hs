...
mkOnDemandOptions
    :: OnDemandOptions
mkOnDemandOptions
  = OnDemandOptions'{allocationStrategy = Core.Nothing,
...
{-# INLINEABLE odoAllocationStrategy #-}
...
{-# INLINEABLE odoCapacityReservationOptions #-}
...
odoMaxTotalPrice :: Lens.Lens' OnDemandOptions (Core.Maybe Core.Text)
odoMaxTotalPrice = Lens.field @"maxTotalPrice"
{-# INLINEABLE odoMaxTotalPrice #-}
...
{-# INLINEABLE odoMinTargetCapacity #-}
...
{-# INLINEABLE odoSingleAvailabilityZone #-}
...
{-# INLINEABLE odoSingleInstanceType #-}
...
instance Core.FromXML OnDemandOptions where
        parseXML x
          = OnDemandOptions' Core.<$>
              (x Core..@? "allocationStrategy") Core.<*>
                x Core..@? "capacityReservationOptions"
