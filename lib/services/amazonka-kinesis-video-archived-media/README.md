...
Documentation is available via [Hackage](http://hackage.haskell.org/package/amazonka-kinesis-video-archived-media)
...
`amazonka-kinesis-video-archived-media` is released under the [Mozilla Public License Version 2.0](http://www.mozilla.org/MPL/).
