...
data DescribeNotebookInstanceResponse = DescribeNotebookInstanceResponse'
  ...
  , _dnirsAcceleratorTypes :: !(Maybe [NotebookInstanceAcceleratorType])
  , _dnirsNotebookInstanceName :: !(Maybe Text)
  , _dnirsSecurityGroups :: !(Maybe [Text])
  , _dnirsAdditionalCodeRepositories :: !(Maybe [Text])
  ...
  , _dnirsDefaultCodeRepository :: !(Maybe Text)
  , _dnirsVolumeSizeInGB :: !(Maybe Nat)
  , _dnirsKMSKeyId :: !(Maybe Text)
  , _dnirsRootAccess :: !(Maybe RootAccess)
...
-- | A list of the Elastic Inference (EI) instance types associated with this notebook instance. Currently only one EI instance type can be associated with a notebook instance. For more information, see <http://docs.aws.amazon.com/sagemaker/latest/dg/ei.html Using Elastic Inference in Amazon SageMaker> .
