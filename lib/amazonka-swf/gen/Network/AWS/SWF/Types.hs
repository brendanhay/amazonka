...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "SWF", Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "swf", Core._svcVersion = "2012-01-25",
...
{-# INLINEABLE _DomainAlreadyExistsFault #-}
...
{-# INLINEABLE _WorkflowExecutionAlreadyStartedFault #-}
...
{-# INLINEABLE _OperationNotPermittedFault #-}
...
{-# INLINEABLE _UnknownResourceFault #-}
...
{-# INLINEABLE _DefaultUndefinedFault #-}
...
{-# INLINEABLE _TypeDeprecatedFault #-}
...
{-# INLINEABLE _TypeAlreadyExistsFault #-}
...
{-# INLINEABLE _DomainDeprecatedFault #-}
