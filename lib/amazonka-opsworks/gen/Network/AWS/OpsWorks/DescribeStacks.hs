...
dsStackIds :: Lens.Lens' DescribeStacks (Core.Maybe [Core.Text])
dsStackIds = Lens.field @"stackIds"
{-# INLINEABLE dsStackIds #-}
{-# DEPRECATED stackIds "Use generic-lens or generic-optics with 'stackIds' instead"  #-}
          ...
          = Response.receiveJSON
              (\ s h x ->
                 DescribeStacksResponse' Core.<$>
                   (x Core..:? "Stacks") Core.<*> Core.pure (Core.fromEnum s))
