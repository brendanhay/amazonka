...
mkAdminDeleteUserAttributes userPoolId username
  = AdminDeleteUserAttributes'{userPoolId, username,
...
{-# INLINEABLE aduaUserAttributeNames #-}
...
instance Core.AWSRequest AdminDeleteUserAttributes where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 AdminDeleteUserAttributesResponse' Core.<$>
...
{-# INLINEABLE aduarrsResponseStatus #-}
