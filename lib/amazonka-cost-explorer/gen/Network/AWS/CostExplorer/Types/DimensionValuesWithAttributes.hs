...
mkDimensionValuesWithAttributes
    :: DimensionValuesWithAttributes
mkDimensionValuesWithAttributes
  = DimensionValuesWithAttributes'{attributes = Core.Nothing,
                                   value = Core.Nothing}
...
instance Core.FromJSON DimensionValuesWithAttributes where
        parseJSON
          = Core.withObject "DimensionValuesWithAttributes" Core.$
              \ x ->
                DimensionValuesWithAttributes' Core.<$>
                  (x Core..:? "Attributes") Core.<*> x Core..:? "Value"
