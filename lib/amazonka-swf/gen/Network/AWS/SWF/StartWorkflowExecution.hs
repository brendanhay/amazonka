...
mkStartWorkflowExecution domain workflowId workflowType
  = StartWorkflowExecution'{domain, workflowId, workflowType,
                            ...
                            executionStartToCloseTimeout = Core.Nothing, input = Core.Nothing,
                            lambdaRole = Core.Nothing, tagList = Core.Nothing,
...
{-# INLINEABLE sExecutionStartToCloseTimeout #-}
...
{-# INLINEABLE sTaskStartToCloseTimeout #-}
...
instance Core.ToHeaders StartWorkflowExecution where
        toHeaders StartWorkflowExecution{..}
          = Core.pure
...
instance Core.AWSRequest StartWorkflowExecution where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartWorkflowExecutionResponse' Core.<$>
...
mkStartWorkflowExecutionResponse responseStatus
  = StartWorkflowExecutionResponse'{runId = Core.Nothing,
                                    responseStatus}
...
{-# INLINEABLE swerrsResponseStatus #-}
