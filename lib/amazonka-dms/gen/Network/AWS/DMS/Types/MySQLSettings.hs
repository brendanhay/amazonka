...
mkMySQLSettings
    :: MySQLSettings
mkMySQLSettings
  = MySQLSettings'{afterConnectScript = Core.Nothing,
                   databaseName = Core.Nothing, eventsPollInterval = Core.Nothing,
                   maxFileSize = Core.Nothing, parallelLoadThreads = Core.Nothing,
                   password = Core.Nothing, port = Core.Nothing,
                   serverName = Core.Nothing, serverTimezone = Core.Nothing,
                   targetDbType = Core.Nothing, username = Core.Nothing}
...
msqlsAfterConnectScript :: Lens.Lens' MySQLSettings (Core.Maybe Core.Text)
msqlsAfterConnectScript = Lens.field @"afterConnectScript"
{-# INLINEABLE msqlsAfterConnectScript #-}
...
msqlsDatabaseName :: Lens.Lens' MySQLSettings (Core.Maybe Core.Text)
msqlsDatabaseName = Lens.field @"databaseName"
{-# INLINEABLE msqlsDatabaseName #-}
...
{-# INLINEABLE msqlsEventsPollInterval #-}
{-# DEPRECATED eventsPollInterval "Use generic-lens or generic-optics with 'eventsPollInterval' instead"  #-}
...
{-# INLINEABLE msqlsParallelLoadThreads #-}
{-# DEPRECATED parallelLoadThreads "Use generic-lens or generic-optics with 'parallelLoadThreads' instead"  #-}
...
msqlsServerTimezone :: Lens.Lens' MySQLSettings (Core.Maybe Core.Text)
msqlsServerTimezone = Lens.field @"serverTimezone"
{-# INLINEABLE msqlsServerTimezone #-}
{-# DEPRECATED serverTimezone "Use generic-lens or generic-optics with 'serverTimezone' instead"  #-}
...
{-# INLINEABLE msqlsTargetDbType #-}
{-# DEPRECATED targetDbType "Use generic-lens or generic-optics with 'targetDbType' instead"  #-}

-- | Endpoint connection user name.
--
-- /Note:/ Consider using 'username' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
msqlsUsername :: Lens.Lens' MySQLSettings (Core.Maybe Core.Text)
msqlsUsername = Lens.field @"username"
{-# INLINEABLE msqlsUsername #-}
...
instance Core.FromJSON MySQLSettings where
        parseJSON
          = Core.withObject "MySQLSettings" Core.$
              \ x ->
                MySQLSettings' Core.<$>
                  (x Core..:? "AfterConnectScript") Core.<*>
                    x Core..:? "DatabaseName"
