...
data CreateProject = CreateProject'
  { _cpSecondaryArtifacts ::
    ...
    _cpBuildBatchConfig :: !(Maybe ProjectBuildBatchConfig),
    ...
    object
      ( catMaybes
          [ ("secondaryArtifacts" .=) <$> _cpSecondaryArtifacts,
            ...
            ("secondarySourceVersions" .=) <$> _cpSecondarySourceVersions,
            ("queuedTimeoutInMinutes" .=) <$> _cpQueuedTimeoutInMinutes,
            ("cache" .=) <$> _cpCache,
            ("secondarySources" .=) <$> _cpSecondarySources,
            ("sourceVersion" .=) <$> _cpSourceVersion,
            ("vpcConfig" .=) <$> _cpVpcConfig,
            ("logsConfig" .=) <$> _cpLogsConfig,
            ("fileSystemLocations" .=) <$> _cpFileSystemLocations,
