...
mkMotionImageInsertionOffset
    :: MotionImageInsertionOffset
mkMotionImageInsertionOffset
  = MotionImageInsertionOffset'{imageX = Core.Nothing,
                                imageY = Core.Nothing}
...
instance Core.FromJSON MotionImageInsertionOffset where
        parseJSON
          = Core.withObject "MotionImageInsertionOffset" Core.$
              \ x ->
                MotionImageInsertionOffset' Core.<$>
                  (x Core..:? "imageX") Core.<*> x Core..:? "imageY"
