...
mkGetLabelDetection jobId
  = GetLabelDetection'{jobId, maxResults = Core.Nothing,
...
instance Core.AWSRequest GetLabelDetection where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetLabelDetectionResponse' Core.<$>
                   (x Core..:? "JobStatus") Core.<*> x Core..:? "LabelModelVersion"
                     Core.<*> x Core..:? "Labels"
...
mkGetLabelDetectionResponse responseStatus
  = GetLabelDetectionResponse'{jobStatus = Core.Nothing,
                               labelModelVersion = Core.Nothing, labels = Core.Nothing,
...
gldrrsLabelModelVersion :: Lens.Lens' GetLabelDetectionResponse (Core.Maybe Core.Text)
gldrrsLabelModelVersion = Lens.field @"labelModelVersion"
{-# INLINEABLE gldrrsLabelModelVersion #-}
...
{-# INLINEABLE gldrrsStatusMessage #-}
...
{-# INLINEABLE gldrrsVideoMetadata #-}
