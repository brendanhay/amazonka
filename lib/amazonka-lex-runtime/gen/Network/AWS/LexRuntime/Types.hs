...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "LexRuntime",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "runtime.lex",
...
{-# INLINEABLE _NotAcceptableException #-}
...
{-# INLINEABLE _DependencyFailedException #-}
...
{-# INLINEABLE _LoopDetectedException #-}
