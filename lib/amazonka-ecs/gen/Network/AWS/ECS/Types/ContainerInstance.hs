...
mkContainerInstance
    :: ContainerInstance
mkContainerInstance
  = ContainerInstance'{agentConnected = Core.Nothing,
                       agentUpdateStatus = Core.Nothing, attachments = Core.Nothing,
                       attributes = Core.Nothing, capacityProviderName = Core.Nothing,
                       containerInstanceArn = Core.Nothing, ec2InstanceId = Core.Nothing,
                       pendingTasksCount = Core.Nothing, registeredAt = Core.Nothing,
                       registeredResources = Core.Nothing,
                       remainingResources = Core.Nothing,
                       runningTasksCount = Core.Nothing, status = Core.Nothing,
                       statusReason = Core.Nothing, tags = Core.Nothing,
                       version = Core.Nothing, versionInfo = Core.Nothing}
...
{-# INLINEABLE ciAgentConnected #-}
{-# DEPRECATED agentConnected "Use generic-lens or generic-optics with 'agentConnected' instead"  #-}
...
{-# INLINEABLE ciAgentUpdateStatus #-}
{-# DEPRECATED agentUpdateStatus "Use generic-lens or generic-optics with 'agentUpdateStatus' instead"  #-}
...
ciCapacityProviderName :: Lens.Lens' ContainerInstance (Core.Maybe Core.Text)
ciCapacityProviderName = Lens.field @"capacityProviderName"
{-# INLINEABLE ciCapacityProviderName #-}
...
ciContainerInstanceArn :: Lens.Lens' ContainerInstance (Core.Maybe Core.Text)
ciContainerInstanceArn = Lens.field @"containerInstanceArn"
{-# INLINEABLE ciContainerInstanceArn #-}
...
ciEc2InstanceId :: Lens.Lens' ContainerInstance (Core.Maybe Core.Text)
ciEc2InstanceId = Lens.field @"ec2InstanceId"
{-# INLINEABLE ciEc2InstanceId #-}
...
{-# INLINEABLE ciPendingTasksCount #-}
...
{-# INLINEABLE ciRegisteredResources #-}
{-# DEPRECATED registeredResources "Use generic-lens or generic-optics with 'registeredResources' instead"  #-}
...
{-# INLINEABLE ciRemainingResources #-}
{-# DEPRECATED remainingResources "Use generic-lens or generic-optics with 'remainingResources' instead"  #-}
...
{-# INLINEABLE ciRunningTasksCount #-}
...
ciStatus :: Lens.Lens' ContainerInstance (Core.Maybe Core.Text)
...
ciStatusReason :: Lens.Lens' ContainerInstance (Core.Maybe Core.Text)
ciStatusReason = Lens.field @"statusReason"
{-# INLINEABLE ciStatusReason #-}
          ...
          = Core.withObject "ContainerInstance" Core.$
              \ x ->
                ContainerInstance' Core.<$>
                  (x Core..:? "agentConnected") Core.<*>
                    x Core..:? "agentUpdateStatus"
