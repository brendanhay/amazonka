...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "SNS", Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "sns", Core._svcVersion = "2010-03-31",
...
_KMSInvalidStateException
  = Core._MatchServiceError mkServiceConfig "KMSInvalidState" Core..
      Core.hasStatues 400
...
_EndpointDisabledException
  = Core._MatchServiceError mkServiceConfig "EndpointDisabled" Core..
      Core.hasStatues 400
{-# INLINEABLE _EndpointDisabledException #-}
...
{-# INLINEABLE _AuthorizationErrorException #-}
...
_KMSThrottlingException
  = Core._MatchServiceError mkServiceConfig "KMSThrottling" Core..
      Core.hasStatues 400
{-# INLINEABLE _KMSThrottlingException #-}
...
_InvalidParameterException
  = Core._MatchServiceError mkServiceConfig "InvalidParameter" Core..
      Core.hasStatues 400
...
_SubscriptionLimitExceededException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 403
{-# INLINEABLE _SubscriptionLimitExceededException #-}
...
{-# INLINEABLE _PlatformApplicationDisabledException #-}
...
_KMSOptInRequired
  = Core._MatchServiceError mkServiceConfig "KMSOptInRequired" Core..
      Core.hasStatues 403
{-# INLINEABLE _KMSOptInRequired #-}
...
_InternalErrorException
  = Core._MatchServiceError mkServiceConfig "InternalError" Core..
      Core.hasStatues 500
...
_ThrottledException
  = Core._MatchServiceError mkServiceConfig "Throttled" Core..
      Core.hasStatues 429
{-# INLINEABLE _ThrottledException #-}
...
_KMSNotFoundException
  = Core._MatchServiceError mkServiceConfig "KMSNotFound" Core..
      Core.hasStatues 400
...
_NotFoundException
  = Core._MatchServiceError mkServiceConfig "NotFound" Core..
      Core.hasStatues 404
...
_StaleTagException
  = Core._MatchServiceError mkServiceConfig "StaleTag" Core..
      Core.hasStatues 400
{-# INLINEABLE _StaleTagException #-}
...
_KMSDisabledException
  = Core._MatchServiceError mkServiceConfig "KMSDisabled" Core..
      Core.hasStatues 400
...
_TagPolicyException
  = Core._MatchServiceError mkServiceConfig "TagPolicy" Core..
      Core.hasStatues 400
...
_InvalidSecurityException
  = Core._MatchServiceError mkServiceConfig "InvalidSecurity" Core..
      Core.hasStatues 403
{-# INLINEABLE _InvalidSecurityException #-}
...
_TopicLimitExceededException
  = Core._MatchServiceError mkServiceConfig "TopicLimitExceeded"
      Core.. Core.hasStatues 403
{-# INLINEABLE _TopicLimitExceededException #-}
...
_ConcurrentAccessException
  = Core._MatchServiceError mkServiceConfig "ConcurrentAccess" Core..
      Core.hasStatues 400
{-# INLINEABLE _ConcurrentAccessException #-}
...
_TagLimitExceededException
  = Core._MatchServiceError mkServiceConfig "TagLimitExceeded" Core..
      Core.hasStatues 400
...
_FilterPolicyLimitExceededException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 403
{-# INLINEABLE _FilterPolicyLimitExceededException #-}
...
_KMSAccessDeniedException
  = Core._MatchServiceError mkServiceConfig "KMSAccessDenied" Core..
      Core.hasStatues 400
