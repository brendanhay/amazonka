...
mkBudgetedAndActualAmounts
    :: BudgetedAndActualAmounts
mkBudgetedAndActualAmounts
  = BudgetedAndActualAmounts'{actualAmount = Core.Nothing,
                              budgetedAmount = Core.Nothing, timePeriod = Core.Nothing}
...
{-# INLINEABLE baaaActualAmount #-}
{-# DEPRECATED actualAmount "Use generic-lens or generic-optics with 'actualAmount' instead"  #-}
...
{-# INLINEABLE baaaBudgetedAmount #-}
{-# DEPRECATED budgetedAmount "Use generic-lens or generic-optics with 'budgetedAmount' instead"  #-}
...
instance Core.FromJSON BudgetedAndActualAmounts where
        parseJSON
          = Core.withObject "BudgetedAndActualAmounts" Core.$
              \ x ->
                BudgetedAndActualAmounts' Core.<$>
                  (x Core..:? "ActualAmount") Core.<*> x Core..:? "BudgetedAmount"
