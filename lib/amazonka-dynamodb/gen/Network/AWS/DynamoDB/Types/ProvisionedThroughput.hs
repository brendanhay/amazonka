...
mkProvisionedThroughput
    :: Core.Natural -- ^ 'readCapacityUnits'
    -> Core.Natural -- ^ 'writeCapacityUnits'
    -> ProvisionedThroughput
...
{-# INLINEABLE ptReadCapacityUnits #-}
...
{-# INLINEABLE ptWriteCapacityUnits #-}
          ...
          = Core.withObject "ProvisionedThroughput" Core.$
              \ x ->
                ProvisionedThroughput' Core.<$>
                  (x Core..: "ReadCapacityUnits") Core.<*>
                    x Core..: "WriteCapacityUnits"
