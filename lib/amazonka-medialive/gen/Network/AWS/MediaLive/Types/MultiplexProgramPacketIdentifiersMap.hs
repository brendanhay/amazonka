...
mkMultiplexProgramPacketIdentifiersMap
    :: MultiplexProgramPacketIdentifiersMap
mkMultiplexProgramPacketIdentifiersMap
  = MultiplexProgramPacketIdentifiersMap'{audioPids = Core.Nothing,
                                          dvbSubPids = Core.Nothing, dvbTeletextPid = Core.Nothing,
                                          etvPlatformPid = Core.Nothing,
                                          etvSignalPid = Core.Nothing, klvDataPids = Core.Nothing,
                                          pcrPid = Core.Nothing, pmtPid = Core.Nothing,
                                          privateMetadataPid = Core.Nothing,
                                          scte27Pids = Core.Nothing, scte35Pid = Core.Nothing,
                                          timedMetadataPid = Core.Nothing, videoPid = Core.Nothing}
...
{-# INLINEABLE mppimDvbTeletextPid #-}
...
{-# INLINEABLE mppimEtvPlatformPid #-}
...
{-# INLINEABLE mppimPrivateMetadataPid #-}
...
{-# INLINEABLE mppimTimedMetadataPid #-}
...
instance Core.FromJSON MultiplexProgramPacketIdentifiersMap where
        parseJSON
          = Core.withObject "MultiplexProgramPacketIdentifiersMap" Core.$
              \ x ->
                MultiplexProgramPacketIdentifiersMap' Core.<$>
                  (x Core..:? "audioPids") Core.<*> x Core..:? "dvbSubPids" Core.<*>
                    x Core..:? "dvbTeletextPid"
