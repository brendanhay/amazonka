...
--
-- * 'ltfrResourceARN' - The ARN of the CloudWatch Events rule for which you want to view tags.
listTagsForResource
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ltfrrsTags' - The list of tag keys and values associated with the rule you specified
--
