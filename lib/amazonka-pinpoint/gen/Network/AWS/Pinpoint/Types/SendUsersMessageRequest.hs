...
mkSendUsersMessageRequest messageConfiguration
  = SendUsersMessageRequest'{messageConfiguration,
                             users = Core.mempty, context = Core.Nothing,
...
{-# INLINEABLE sumrMessageConfiguration #-}
...
{-# INLINEABLE sumrTemplateConfiguration #-}
