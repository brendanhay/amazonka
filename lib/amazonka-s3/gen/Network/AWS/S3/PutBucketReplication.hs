...
mkPutBucketReplication
    ...
    -> Types.ReplicationConfiguration -- ^ 'replicationConfiguration'
    -> PutBucketReplication
mkPutBucketReplication bucket replicationConfiguration
  = PutBucketReplication'{bucket, replicationConfiguration,
...
{-# INLINEABLE pbrReplicationConfiguration #-}
...
{-# INLINEABLE pbrExpectedBucketOwner #-}
...
instance Core.AWSRequest PutBucketReplication where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull PutBucketReplicationResponse'
