...
mkPasswordPolicy
    :: PasswordPolicy
mkPasswordPolicy
  = PasswordPolicy'{allowUsersToChangePassword = Core.Nothing,
                    expirePasswords = Core.Nothing, hardExpiry = Core.Nothing,
...
{-# INLINEABLE ppAllowUsersToChangePassword #-}
...
{-# INLINEABLE ppExpirePasswords #-}
{-# DEPRECATED expirePasswords "Use generic-lens or generic-optics with 'expirePasswords' instead"  #-}
...
{-# INLINEABLE ppMinimumPasswordLength #-}
...
{-# INLINEABLE ppPasswordReusePrevention #-}
...
{-# INLINEABLE ppRequireLowercaseCharacters #-}
...
{-# INLINEABLE ppRequireUppercaseCharacters #-}
...
instance Core.FromXML PasswordPolicy where
        parseXML x
          = PasswordPolicy' Core.<$>
              (x Core..@? "AllowUsersToChangePassword") Core.<*>
                x Core..@? "ExpirePasswords"
