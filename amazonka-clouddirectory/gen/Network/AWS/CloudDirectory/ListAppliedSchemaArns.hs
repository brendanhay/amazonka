...
instance Prelude.AWSRequest ListAppliedSchemaArns where
  type
...
instance Prelude.ToHeaders ListAppliedSchemaArns where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToJSON ListAppliedSchemaArns where
...
instance Prelude.ToPath ListAppliedSchemaArns where
  toPath =
    Prelude.const
      "/amazonclouddirectory/2017-01-11/schema/applied"

instance Prelude.ToQuery ListAppliedSchemaArns where
...
listAppliedSchemaArnsResponse_schemaArns = Lens.lens (\ListAppliedSchemaArnsResponse' {schemaArns} -> schemaArns) (\s@ListAppliedSchemaArnsResponse' {} a -> s {schemaArns = a} :: ListAppliedSchemaArnsResponse) Prelude.. Lens.mapping Prelude._Coerce
