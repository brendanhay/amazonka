...
mkServiceActionSummary
    :: ServiceActionSummary
mkServiceActionSummary
  = ServiceActionSummary'{definitionType = Core.Nothing,
...
instance Core.FromJSON ServiceActionSummary where
        parseJSON
          = Core.withObject "ServiceActionSummary" Core.$
              \ x ->
                ServiceActionSummary' Core.<$>
                  (x Core..:? "DefinitionType") Core.<*> x Core..:? "Description"
                    Core.<*> x Core..:? "Id"
                    Core.<*> x Core..:? "Name"
