...
mkAllocatePublicVirtualInterface
    ...
    -> Types.NewPublicVirtualInterfaceAllocation -- ^ 'newPublicVirtualInterfaceAllocation'
    -> AllocatePublicVirtualInterface
mkAllocatePublicVirtualInterface connectionId ownerAccount
  newPublicVirtualInterfaceAllocation
  = AllocatePublicVirtualInterface'{connectionId, ownerAccount,
                                    newPublicVirtualInterfaceAllocation}
...
{-# INLINEABLE aNewPublicVirtualInterfaceAllocation #-}
{-# DEPRECATED newPublicVirtualInterfaceAllocation "Use generic-lens or generic-optics with 'newPublicVirtualInterfaceAllocation' instead"  #-}

instance Core.ToQuery AllocatePublicVirtualInterface where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders AllocatePublicVirtualInterface where
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("connectionId" Core..= connectionId),
                  ...
                  Core.Just
                    ("newPublicVirtualInterfaceAllocation" Core..=
                       newPublicVirtualInterfaceAllocation)])
