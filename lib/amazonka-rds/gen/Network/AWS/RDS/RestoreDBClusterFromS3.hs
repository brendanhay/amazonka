...
data RestoreDBClusterFromS3 = RestoreDBClusterFromS3'
  { _rdcfsEngineVersion ::
    ...
    _rdcfsCopyTagsToSnapshot :: !(Maybe Bool),
    _rdcfsDomainIAMRoleName :: !(Maybe Text),
...
--
-- * 'rdcfsDBClusterIdentifier' - The name of the DB cluster to create from the source data in the Amazon S3 bucket. This parameter isn't case-sensitive. Constraints:     * Must contain from 1 to 63 letters, numbers, or hyphens.     * First character must be a letter.     * Can't end with a hyphen or contain two consecutive hyphens. Example: @my-cluster1@
--
-- * 'rdcfsEngine' - The name of the database engine to be used for this DB cluster. Valid Values: @aurora@ (for MySQL 5.6-compatible Aurora), @aurora-mysql@ (for MySQL 5.7-compatible Aurora), and @aurora-postgresql@
--
...
--
-- * 'rdcfsSourceEngineVersion' - The version of the database that the backup files were created from. MySQL versions 5.5, 5.6, and 5.7 are supported.  Example: @5.6.40@ , @5.7.28@
--
...
instance ToQuery RestoreDBClusterFromS3 where
  toQuery RestoreDBClusterFromS3' {..} =
    mconcat
      [ "Action" =: ("RestoreDBClusterFromS3" :: ByteString),
        ...
        "PreferredMaintenanceWindow" =: _rdcfsPreferredMaintenanceWindow,
        "AvailabilityZones"
          =: toQuery
            (toQueryList "AvailabilityZone" <$> _rdcfsAvailabilityZones),
        "CharacterSetName" =: _rdcfsCharacterSetName,
        "KmsKeyId" =: _rdcfsKMSKeyId,
        "PreferredBackupWindow" =: _rdcfsPreferredBackupWindow,
        "BackupRetentionPeriod" =: _rdcfsBackupRetentionPeriod,
        "VpcSecurityGroupIds"
          =: toQuery
            (toQueryList "VpcSecurityGroupId" <$> _rdcfsVPCSecurityGroupIds),
        "DatabaseName" =: _rdcfsDatabaseName,
        "DBClusterParameterGroupName" =: _rdcfsDBClusterParameterGroupName,
        ...
        "EnableCloudwatchLogsExports"
          =: toQuery
            (toQueryList "member" <$> _rdcfsEnableCloudwatchLogsExports),
