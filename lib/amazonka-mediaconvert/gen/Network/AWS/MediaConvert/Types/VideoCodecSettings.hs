...
mkVideoCodecSettings
    :: VideoCodecSettings
mkVideoCodecSettings
  = VideoCodecSettings'{av1Settings = Core.Nothing,
                        avcIntraSettings = Core.Nothing, codec = Core.Nothing,
                        frameCaptureSettings = Core.Nothing, h264Settings = Core.Nothing,
                        h265Settings = Core.Nothing, mpeg2Settings = Core.Nothing,
                        proresSettings = Core.Nothing, vc3Settings = Core.Nothing,
                        vp8Settings = Core.Nothing, vp9Settings = Core.Nothing}
...
{-# INLINEABLE vcsAv1Settings #-}
{-# DEPRECATED av1Settings "Use generic-lens or generic-optics with 'av1Settings' instead"  #-}
...
{-# INLINEABLE vcsAvcIntraSettings #-}
{-# DEPRECATED avcIntraSettings "Use generic-lens or generic-optics with 'avcIntraSettings' instead"  #-}
...
{-# INLINEABLE vcsProresSettings #-}
{-# DEPRECATED proresSettings "Use generic-lens or generic-optics with 'proresSettings' instead"  #-}
...
{-# INLINEABLE vcsVc3Settings #-}
{-# DEPRECATED vc3Settings "Use generic-lens or generic-optics with 'vc3Settings' instead"  #-}
...
{-# INLINEABLE vcsVp8Settings #-}
{-# DEPRECATED vp8Settings "Use generic-lens or generic-optics with 'vp8Settings' instead"  #-}
...
{-# INLINEABLE vcsVp9Settings #-}
{-# DEPRECATED vp9Settings "Use generic-lens or generic-optics with 'vp9Settings' instead"  #-}
          ...
          = Core.withObject "VideoCodecSettings" Core.$
              \ x ->
                VideoCodecSettings' Core.<$>
                  (x Core..:? "av1Settings") Core.<*> x Core..:? "avcIntraSettings"
                    Core.<*> x Core..:? "codec"
