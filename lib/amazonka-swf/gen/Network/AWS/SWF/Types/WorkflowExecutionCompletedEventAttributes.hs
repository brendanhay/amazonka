...
{-# DEPRECATED wResult "Use generic-lens or generic-optics with 'result' instead." #-}

instance Core.FromJSON WorkflowExecutionCompletedEventAttributes where
  parseJSON =
    Core.withObject "WorkflowExecutionCompletedEventAttributes" Core.$
      \x ->
        WorkflowExecutionCompletedEventAttributes'
