...
mkCertificate
  = Certificate'{certificateArn = Core.Nothing,
                 ...
                 certificateType = Core.Nothing, customerOverride = Core.Nothing,
                 customerOverrideValidTill = Core.Nothing,
                 thumbprint = Core.Nothing, validFrom = Core.Nothing,
...
cCertificateType :: Lens.Lens' Certificate (Core.Maybe Core.Text)
cCertificateType = Lens.field @"certificateType"
{-# INLINEABLE cCertificateType #-}
...
{-# INLINEABLE cCustomerOverride #-}
{-# DEPRECATED customerOverride "Use generic-lens or generic-optics with 'customerOverride' instead"  #-}
...
{-# INLINEABLE cCustomerOverrideValidTill #-}
{-# DEPRECATED customerOverrideValidTill "Use generic-lens or generic-optics with 'customerOverrideValidTill' instead"  #-}
...
cThumbprint :: Lens.Lens' Certificate (Core.Maybe Core.Text)
cThumbprint = Lens.field @"thumbprint"
{-# INLINEABLE cThumbprint #-}
{-# DEPRECATED thumbprint "Use generic-lens or generic-optics with 'thumbprint' instead"  #-}
...
{-# INLINEABLE cValidTill #-}
{-# DEPRECATED validTill "Use generic-lens or generic-optics with 'validTill' instead"  #-}

instance Core.FromXML Certificate where
        parseXML x
          = Certificate' Core.<$>
              (x Core..@? "CertificateArn") Core.<*>
                x Core..@? "CertificateIdentifier"
