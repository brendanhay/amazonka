...
data TrainingSpecification = TrainingSpecification'
  { -- | A list of the instance types that this algorithm can use for training.
    ...
    trainingImageDigest :: Lude.Maybe Lude.Text,
    -- | Indicates whether the algorithm supports distributed training. If set to false, buyers can't request more than one instance during training.
    supportsDistributedTraining :: Lude.Maybe Lude.Bool,
    -- | A list of the @HyperParameterSpecification@ objects, that define the supported hyperparameters. This is required if the algorithm supports automatic model tuning.>
    supportedHyperParameters :: Lude.Maybe [HyperParameterSpecification],
    -- | A list of the metrics that the algorithm emits that can be used as the objective metric in a hyperparameter tuning job.
    supportedTuningJobObjectiveMetrics :: Lude.Maybe [HyperParameterTuningJobObjective],
    ...
    trainingChannels :: Lude.NonEmpty ChannelSpecification
  }
