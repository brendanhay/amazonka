...
mkUpdateDataRetention
    ...
    -> Types.UpdateDataRetentionOperation -- ^ 'operation'
    -> Core.Natural -- ^ 'dataRetentionChangeInHours'
    -> UpdateDataRetention
mkUpdateDataRetention currentVersion operation
  dataRetentionChangeInHours
  = UpdateDataRetention'{currentVersion, operation,
                         dataRetentionChangeInHours, streamARN = Core.Nothing,
...
{-# INLINEABLE udrDataRetentionChangeInHours #-}
{-# DEPRECATED dataRetentionChangeInHours "Use generic-lens or generic-optics with 'dataRetentionChangeInHours' instead"  #-}
...
instance Core.AWSRequest UpdateDataRetention where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/updateDataRetention",
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 UpdateDataRetentionResponse' Core.<$>
...
{-# INLINEABLE udrrrsResponseStatus #-}
