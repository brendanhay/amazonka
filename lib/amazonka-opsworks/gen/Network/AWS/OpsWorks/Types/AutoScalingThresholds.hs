...
mkAutoScalingThresholds
    :: AutoScalingThresholds
mkAutoScalingThresholds
  = AutoScalingThresholds'{alarms = Core.Nothing,
                           cpuThreshold = Core.Nothing, ignoreMetricsTime = Core.Nothing,
                           instanceCount = Core.Nothing, loadThreshold = Core.Nothing,
                           memoryThreshold = Core.Nothing, thresholdsWaitTime = Core.Nothing}
...
astAlarms :: Lens.Lens' AutoScalingThresholds (Core.Maybe [Core.Text])
astAlarms = Lens.field @"alarms"
{-# INLINEABLE astAlarms #-}
...
{-# INLINEABLE astCpuThreshold #-}
{-# DEPRECATED cpuThreshold "Use generic-lens or generic-optics with 'cpuThreshold' instead"  #-}
...
{-# INLINEABLE astIgnoreMetricsTime #-}
{-# DEPRECATED ignoreMetricsTime "Use generic-lens or generic-optics with 'ignoreMetricsTime' instead"  #-}
...
{-# INLINEABLE astLoadThreshold #-}
{-# DEPRECATED loadThreshold "Use generic-lens or generic-optics with 'loadThreshold' instead"  #-}
...
{-# INLINEABLE astMemoryThreshold #-}
{-# DEPRECATED memoryThreshold "Use generic-lens or generic-optics with 'memoryThreshold' instead"  #-}
...
{-# INLINEABLE astThresholdsWaitTime #-}
{-# DEPRECATED thresholdsWaitTime "Use generic-lens or generic-optics with 'thresholdsWaitTime' instead"  #-}
...
instance Core.FromJSON AutoScalingThresholds where
        parseJSON
          = Core.withObject "AutoScalingThresholds" Core.$
              \ x ->
                AutoScalingThresholds' Core.<$>
                  (x Core..:? "Alarms") Core.<*> x Core..:? "CpuThreshold" Core.<*>
                    x Core..:? "IgnoreMetricsTime"
