...
cpgnmParameterGroupName :: Lens.Lens' ClusterParameterGroupNameMessage (Core.Maybe Core.Text)
cpgnmParameterGroupName = Lens.field @"parameterGroupName"
{-# INLINEABLE cpgnmParameterGroupName #-}
...
cpgnmParameterGroupStatus :: Lens.Lens' ClusterParameterGroupNameMessage (Core.Maybe Core.Text)
cpgnmParameterGroupStatus = Lens.field @"parameterGroupStatus"
{-# INLINEABLE cpgnmParameterGroupStatus #-}
...
instance Core.FromXML ClusterParameterGroupNameMessage where
        parseXML x
          = ClusterParameterGroupNameMessage' Core.<$>
              (x Core..@? "ParameterGroupName") Core.<*>
                x Core..@? "ParameterGroupStatus"
