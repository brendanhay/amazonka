...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CloudHSM",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "cloudhsm",
                 Core._svcVersion = "2014-05-30", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _CloudHsmInternalException #-}
