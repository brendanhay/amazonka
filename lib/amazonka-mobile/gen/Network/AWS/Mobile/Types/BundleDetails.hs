...
mkBundleDetails
    :: BundleDetails
mkBundleDetails
  = BundleDetails'{availablePlatforms = Core.Nothing,
                   bundleId = Core.Nothing, description = Core.Nothing,
                   iconUrl = Core.Nothing, title = Core.Nothing,
...
{-# INLINEABLE bdAvailablePlatforms #-}
{-# DEPRECATED availablePlatforms "Use generic-lens or generic-optics with 'availablePlatforms' instead"  #-}
...
instance Core.FromJSON BundleDetails where
        parseJSON
          = Core.withObject "BundleDetails" Core.$
              \ x ->
                BundleDetails' Core.<$>
                  (x Core..:? "availablePlatforms") Core.<*> x Core..:? "bundleId"
