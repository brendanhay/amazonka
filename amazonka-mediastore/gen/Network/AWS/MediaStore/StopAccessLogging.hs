...
instance Hashable StopAccessLogging where

instance NFData StopAccessLogging where
...
stopAccessLoggingResponse
    :: Int -- ^ 'salrsResponseStatus'
    -> StopAccessLoggingResponse
stopAccessLoggingResponse pResponseStatus_ =
  StopAccessLoggingResponse' {_salrsResponseStatus = pResponseStatus_}
...
instance NFData StopAccessLoggingResponse where
