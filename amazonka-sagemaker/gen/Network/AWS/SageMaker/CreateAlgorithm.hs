...
data CreateAlgorithm = CreateAlgorithm'
  { _caValidationSpecification :: !(Maybe AlgorithmValidationSpecification)
  , _caInferenceSpecification  :: !(Maybe InferenceSpecification)
...
createAlgorithm
    :: Text -- ^ 'caAlgorithmName'
    -> TrainingSpecification -- ^ 'caTrainingSpecification'
    -> CreateAlgorithm
...
instance Hashable CreateAlgorithm where

instance NFData CreateAlgorithm where
              ...
              (catMaybes
                 [("ValidationSpecification" .=) <$>
                  ...
                  ("AlgorithmDescription" .=) <$>
                    _caAlgorithmDescription,
                  ("CertifyForMarketplace" .=) <$>
                    _caCertifyForMarketplace,
                  Just ("AlgorithmName" .= _caAlgorithmName),
                  Just
                    ("TrainingSpecification" .=
                       _caTrainingSpecification)])
...
createAlgorithmResponse
    ...
    -> Text -- ^ 'carsAlgorithmARN'
    -> CreateAlgorithmResponse
createAlgorithmResponse pResponseStatus_ pAlgorithmARN_ =
  CreateAlgorithmResponse'
    {_carsResponseStatus = pResponseStatus_, _carsAlgorithmARN = pAlgorithmARN_}
...
instance NFData CreateAlgorithmResponse where
