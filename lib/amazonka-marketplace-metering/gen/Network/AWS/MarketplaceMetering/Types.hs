...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "MarketplaceMetering",
                 Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "metering.marketplace",
                 Core._svcVersion = "2016-01-14", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _InvalidEndpointRegionException #-}
...
{-# INLINEABLE _InvalidProductCodeException #-}
...
{-# INLINEABLE _InvalidUsageDimensionException #-}
...
{-# INLINEABLE _PlatformNotSupportedException #-}
...
{-# INLINEABLE _CustomerNotEntitledException #-}
...
{-# INLINEABLE _DuplicateRequestException #-}
...
{-# INLINEABLE _DisabledApiException #-}
...
{-# INLINEABLE _TimestampOutOfBoundsException #-}
...
{-# INLINEABLE _InvalidPublicKeyVersionException #-}
...
{-# INLINEABLE _InternalServiceErrorException #-}
...
{-# INLINEABLE _InvalidTokenException #-}
...
{-# INLINEABLE _InvalidUsageAllocationsException #-}
...
{-# INLINEABLE _InvalidRegionException #-}
...
{-# INLINEABLE _InvalidCustomerIdentifierException #-}
