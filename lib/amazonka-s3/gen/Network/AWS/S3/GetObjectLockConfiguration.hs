...
instance Core.AWSRequest GetObjectLockConfiguration where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 GetObjectLockConfigurationResponse' Core.<$>
...
{-# INLINEABLE golcrrsObjectLockConfiguration #-}
...
{-# INLINEABLE golcrrsResponseStatus #-}
