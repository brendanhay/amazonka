...
diFilters :: Lens.Lens' DescribeInstances (Lude.Maybe [Filter])
diFilters = Lens.lens (filters :: DescribeInstances -> Lude.Maybe [Filter]) (\s a -> s {filters = a} :: DescribeInstances)
{-# DEPRECATED diFilters "Use generic-lens or generic-optics with 'filters' instead." #-}
...
diDryRun :: Lens.Lens' DescribeInstances (Lude.Maybe Lude.Bool)
diDryRun = Lens.lens (dryRun :: DescribeInstances -> Lude.Maybe Lude.Bool) (\s a -> s {dryRun = a} :: DescribeInstances)
{-# DEPRECATED diDryRun "Use generic-lens or generic-optics with 'dryRun' instead." #-}

-- | The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned @NextToken@ value. This value can be between 5 and 1000. You cannot specify this parameter and the instance IDs parameter in the same call.
--
-- /Note:/ Consider using 'maxResults' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
diMaxResults :: Lens.Lens' DescribeInstances (Lude.Maybe Lude.Int)
diMaxResults = Lens.lens (maxResults :: DescribeInstances -> Lude.Maybe Lude.Int) (\s a -> s {maxResults = a} :: DescribeInstances)
