  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "DynamoDB_20120810.PutItem")
...
{-# DEPRECATED pirrsAttributes "Use generic-lens or generic-optics with 'attributes' instead." #-}
...
{-# DEPRECATED pirrsConsumedCapacity "Use generic-lens or generic-optics with 'consumedCapacity' instead." #-}
...
{-# DEPRECATED pirrsItemCollectionMetrics "Use generic-lens or generic-optics with 'itemCollectionMetrics' instead." #-}
