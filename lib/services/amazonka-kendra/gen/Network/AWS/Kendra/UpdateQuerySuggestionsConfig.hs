...
-- |
-- Module      : Network.AWS.Kendra.UpdateQuerySuggestionsConfig
...
-- By default, Amazon Kendra sets this to 180.
--
-- 'indexId', 'updateQuerySuggestionsConfig_indexId' - The identifier of the index you want to update query suggestions
-- settings for.
newUpdateQuerySuggestionsConfig ::
  -- | 'indexId'
  Prelude.Text ->
...
instance Prelude.NFData UpdateQuerySuggestionsConfig
