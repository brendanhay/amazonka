...
mkScan
    ...
    -> Scan
mkScan tableName
  = Scan'{tableName, attributesToGet = Core.Nothing,
          ...
          limit = Core.Nothing, projectionExpression = Core.Nothing,
          returnConsumedCapacity = Core.Nothing, scanFilter = Core.Nothing,
          segment = Core.Nothing, select = Core.Nothing,
...
{-# INLINEABLE sConditionalOperator #-}
...
{-# INLINEABLE sExpressionAttributeNames #-}
...
{-# INLINEABLE sExpressionAttributeValues #-}
...
{-# INLINEABLE sProjectionExpression #-}
...
{-# INLINEABLE sReturnConsumedCapacity #-}
...
{-# INLINEABLE sScanFilter #-}
{-# DEPRECATED scanFilter "Use generic-lens or generic-optics with 'scanFilter' instead"  #-}
...
instance Core.ToHeaders Scan where
        toHeaders Scan{..}
          = Core.pure ("X-Amz-Target", "DynamoDB_20120810.Scan") Core.<>
...
mkScanResponse responseStatus
  = ScanResponse'{consumedCapacity = Core.Nothing,
...
{-# INLINEABLE srrsConsumedCapacity #-}
...
{-# INLINEABLE srrsLastEvaluatedKey #-}
