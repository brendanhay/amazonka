...
instance Hashable UpdateUserPoolDomain

instance NFData UpdateUserPoolDomain
    ...
    object
      ( catMaybes
          [ Just ("Domain" .= _uupdDomain),
            ...
            Just ("CustomDomainConfig" .= _uupdCustomDomainConfig)
          ]
      )
...
instance NFData UpdateUserPoolDomainResponse
