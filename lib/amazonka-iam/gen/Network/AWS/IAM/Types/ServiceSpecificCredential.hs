...
sscCreateDate :: Lens.Lens' ServiceSpecificCredential Lude.ISO8601
sscCreateDate = Lens.lens (createDate :: ServiceSpecificCredential -> Lude.ISO8601) (\s a -> s {createDate = a} :: ServiceSpecificCredential)
