...
instance Core.ToXML CustomOriginConfig where
  toXML CustomOriginConfig {..} =
    Core.toXMLNode "HTTPPort" hTTPPort
      Core.<> Core.toXMLNode "HTTPSPort" hTTPSPort
      Core.<> Core.toXMLNode "OriginProtocolPolicy" originProtocolPolicy
      Core.<> Core.toXMLNode "OriginKeepaliveTimeout"
      Core.<$> originKeepaliveTimeout
      Core.<> Core.toXMLNode "OriginReadTimeout"
      Core.<$> originReadTimeout
      Core.<> Core.toXMLNode "OriginSslProtocols"
      Core.<$> originSslProtocols
