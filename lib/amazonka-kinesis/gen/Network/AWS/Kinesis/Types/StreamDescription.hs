...
mkStreamDescription
    ...
    -> StreamDescription
mkStreamDescription streamName streamARN streamStatus hasMoreShards
  retentionPeriodHours streamCreationTimestamp
  = StreamDescription'{streamName, streamARN, streamStatus,
                       shards = Core.mempty, hasMoreShards, retentionPeriodHours,
                       streamCreationTimestamp, enhancedMonitoring = Core.mempty,
                       encryptionType = Core.Nothing, keyId = Core.Nothing}
...
{-# INLINEABLE sdHasMoreShards #-}
{-# DEPRECATED hasMoreShards "Use generic-lens or generic-optics with 'hasMoreShards' instead"  #-}
...
{-# INLINEABLE sdRetentionPeriodHours #-}
...
{-# INLINEABLE sdStreamCreationTimestamp #-}
...
{-# INLINEABLE sdEnhancedMonitoring #-}
