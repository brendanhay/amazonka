...
mkMultiConditionalSplitActivity
    :: MultiConditionalSplitActivity
mkMultiConditionalSplitActivity
  = MultiConditionalSplitActivity'{branches = Core.Nothing,
...
{-# INLINEABLE mcsaDefaultActivity #-}
{-# DEPRECATED defaultActivity "Use generic-lens or generic-optics with 'defaultActivity' instead"  #-}
...
{-# INLINEABLE mcsaEvaluationWaitTime #-}
...
instance Core.FromJSON MultiConditionalSplitActivity where
        parseJSON
          = Core.withObject "MultiConditionalSplitActivity" Core.$
              \ x ->
                MultiConditionalSplitActivity' Core.<$>
                  (x Core..:? "Branches") Core.<*> x Core..:? "DefaultActivity"
