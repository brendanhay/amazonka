...
{-# INLINEABLE pcorAllowDnsResolutionFromRemoteVpc #-}
...
{-# INLINEABLE pcorAllowEgressFromLocalClassicLinkToRemoteVpc #-}
...
{-# INLINEABLE pcorAllowEgressFromLocalVpcToRemoteClassicLink #-}
...
instance Core.ToQuery PeeringConnectionOptionsRequest where
        toQuery PeeringConnectionOptionsRequest{..}
          = Core.maybe Core.mempty
              (Core.toQueryPair "AllowDnsResolutionFromRemoteVpc")
              allowDnsResolutionFromRemoteVpc
              Core.<>
              Core.maybe Core.mempty
                (Core.toQueryPair "AllowEgressFromLocalClassicLinkToRemoteVpc")
                allowEgressFromLocalClassicLinkToRemoteVpc
              Core.<>
              Core.maybe Core.mempty
                (Core.toQueryPair "AllowEgressFromLocalVpcToRemoteClassicLink")
