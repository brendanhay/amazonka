...
mkDataCaptureConfig
    :: Core.Natural -- ^ 'initialSamplingPercentage'
    -> Types.DestinationS3Uri -- ^ 'destinationS3Uri'
    -> Core.NonEmpty Types.CaptureOption -- ^ 'captureOptions'
    -> DataCaptureConfig
mkDataCaptureConfig initialSamplingPercentage destinationS3Uri
  captureOptions
  = DataCaptureConfig'{initialSamplingPercentage, destinationS3Uri,
                       captureOptions, captureContentTypeHeader = Core.Nothing,
                       enableCapture = Core.Nothing, kmsKeyId = Core.Nothing}
...
{-# INLINEABLE dccInitialSamplingPercentage #-}
{-# DEPRECATED initialSamplingPercentage "Use generic-lens or generic-optics with 'initialSamplingPercentage' instead"  #-}
...
{-# INLINEABLE dccDestinationS3Uri #-}
{-# DEPRECATED destinationS3Uri "Use generic-lens or generic-optics with 'destinationS3Uri' instead"  #-}
...
{-# INLINEABLE dccCaptureOptions #-}
{-# DEPRECATED captureOptions "Use generic-lens or generic-optics with 'captureOptions' instead"  #-}
...
{-# INLINEABLE dccCaptureContentTypeHeader #-}
{-# DEPRECATED captureContentTypeHeader "Use generic-lens or generic-optics with 'captureContentTypeHeader' instead"  #-}
...
{-# INLINEABLE dccEnableCapture #-}
{-# DEPRECATED enableCapture "Use generic-lens or generic-optics with 'enableCapture' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just
                  ...
                  ("CaptureContentTypeHeader" Core..=) Core.<$>
          ...
          = Core.withObject "DataCaptureConfig" Core.$
              \ x ->
                DataCaptureConfig' Core.<$>
                  (x Core..: "InitialSamplingPercentage") Core.<*>
                    x Core..: "DestinationS3Uri"
