...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "EFS", Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "elasticfilesystem",
                 Core._svcVersion = "2015-02-01", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _MountTargetNotFound #-}
...
_SecurityGroupLimitExceeded
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _SecurityGroupLimitExceeded #-}
...
_SecurityGroupNotFound
  = Core._MatchServiceError mkServiceConfig "SecurityGroupNotFound"
      Core.. Core.hasStatues 400
{-# INLINEABLE _SecurityGroupNotFound #-}
...
{-# INLINEABLE _MountTargetConflict #-}
...
_UnsupportedAvailabilityZone
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _UnsupportedAvailabilityZone #-}
...
{-# INLINEABLE _FileSystemLimitExceeded #-}
...
_TooManyRequests
  = Core._MatchServiceError mkServiceConfig "TooManyRequests" Core..
      Core.hasStatues 429
{-# INLINEABLE _TooManyRequests #-}
...
_NetworkInterfaceLimitExceeded
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _NetworkInterfaceLimitExceeded #-}
...
_FileSystemAlreadyExists
  = Core._MatchServiceError mkServiceConfig "FileSystemAlreadyExists"
      Core.. Core.hasStatues 409
{-# INLINEABLE _FileSystemAlreadyExists #-}
...
_FileSystemNotFound
  = Core._MatchServiceError mkServiceConfig "FileSystemNotFound"
      Core.. Core.hasStatues 404
{-# INLINEABLE _FileSystemNotFound #-}
...
_IncorrectFileSystemLifeCycleState
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _IncorrectFileSystemLifeCycleState #-}
...
_BadRequest
  = Core._MatchServiceError mkServiceConfig "BadRequest" Core..
      Core.hasStatues 400
{-# INLINEABLE _BadRequest #-}
...
_NoFreeAddressesInSubnet
  = Core._MatchServiceError mkServiceConfig "NoFreeAddressesInSubnet"
      Core.. Core.hasStatues 409
{-# INLINEABLE _NoFreeAddressesInSubnet #-}
...
_ThroughputLimitExceeded
  = Core._MatchServiceError mkServiceConfig "ThroughputLimitExceeded"
      Core.. Core.hasStatues 400
{-# INLINEABLE _ThroughputLimitExceeded #-}
...
_FileSystemInUse
  = Core._MatchServiceError mkServiceConfig "FileSystemInUse" Core..
      Core.hasStatues 409
{-# INLINEABLE _FileSystemInUse #-}
...
_IncorrectMountTargetState
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _IncorrectMountTargetState #-}
...
_IpAddressInUse
  = Core._MatchServiceError mkServiceConfig "IpAddressInUse" Core..
      Core.hasStatues 409
{-# INLINEABLE _IpAddressInUse #-}
...
_AccessPointNotFound
  = Core._MatchServiceError mkServiceConfig "AccessPointNotFound"
      Core.. Core.hasStatues 404
{-# INLINEABLE _AccessPointNotFound #-}
...
{-# INLINEABLE _InsufficientThroughputCapacity #-}
...
_AccessPointAlreadyExists
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _AccessPointAlreadyExists #-}
...
_AccessPointLimitExceeded
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 403
{-# INLINEABLE _AccessPointLimitExceeded #-}
