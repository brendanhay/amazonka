...
mkTransformFilterCriteria
    :: TransformFilterCriteria
mkTransformFilterCriteria
  = TransformFilterCriteria'{createdAfter = Core.Nothing,
                             createdBefore = Core.Nothing, glueVersion = Core.Nothing,
                             lastModifiedAfter = Core.Nothing,
                             lastModifiedBefore = Core.Nothing, name = Core.Nothing,
...
{-# INLINEABLE tfcLastModifiedAfter #-}
{-# DEPRECATED lastModifiedAfter "Use generic-lens or generic-optics with 'lastModifiedAfter' instead"  #-}
...
{-# INLINEABLE tfcLastModifiedBefore #-}
{-# DEPRECATED lastModifiedBefore "Use generic-lens or generic-optics with 'lastModifiedBefore' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("CreatedAfter" Core..=) Core.<$> createdAfter,
                  ...
                  ("Name" Core..=) Core.<$> name, ("Schema" Core..=) Core.<$> schema,
