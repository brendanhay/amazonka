...
mkSecurityConfiguration
    :: SecurityConfiguration
mkSecurityConfiguration
  = SecurityConfiguration'{createdTimeStamp = Core.Nothing,
                           encryptionConfiguration = Core.Nothing, name = Core.Nothing}
