...
mkThingTypeMetadata
    :: ThingTypeMetadata
mkThingTypeMetadata
  = ThingTypeMetadata'{creationDate = Core.Nothing,
                       deprecated = Core.Nothing, deprecationDate = Core.Nothing}
...
{-# INLINEABLE ttmDeprecated #-}
{-# DEPRECATED deprecated "Use generic-lens or generic-optics with 'deprecated' instead"  #-}
...
instance Core.FromJSON ThingTypeMetadata where
        parseJSON
          = Core.withObject "ThingTypeMetadata" Core.$
              \ x ->
                ThingTypeMetadata' Core.<$>
                  (x Core..:? "creationDate") Core.<*> x Core..:? "deprecated"
