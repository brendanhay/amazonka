...
instance ToJSON UpdateQualificationType where
  toJSON UpdateQualificationType' {..} =
    object
      ( catMaybes
          [ ("TestDurationInSeconds" .=) <$> _uqtTestDurationInSeconds,
            ("QualificationTypeStatus" .=) <$> _uqtQualificationTypeStatus,
            ("AnswerKey" .=) <$> _uqtAnswerKey,
            ("Test" .=) <$> _uqtTest,
            ("AutoGranted" .=) <$> _uqtAutoGranted,
            ("AutoGrantedValue" .=) <$> _uqtAutoGrantedValue,
            ("Description" .=) <$> _uqtDescription,
            ("RetryDelayInSeconds" .=) <$> _uqtRetryDelayInSeconds,
            Just ("QualificationTypeId" .= _uqtQualificationTypeId)
          ]
      )
