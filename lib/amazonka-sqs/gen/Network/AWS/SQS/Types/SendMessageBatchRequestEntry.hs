...
mkSendMessageBatchRequestEntry id messageBody
  = SendMessageBatchRequestEntry'{id, messageBody,
                                  delaySeconds = Core.Nothing, messageAttributes = Core.Nothing,
...
sId :: Lens.Lens' SendMessageBatchRequestEntry Core.Text
sId = Lens.field @"id"
{-# INLINEABLE sId #-}
...
sMessageBody :: Lens.Lens' SendMessageBatchRequestEntry Core.Text
sMessageBody = Lens.field @"messageBody"
{-# INLINEABLE sMessageBody #-}
...
sMessageAttributes :: Lens.Lens' SendMessageBatchRequestEntry (Core.Maybe (Core.HashMap Core.Text Types.MessageAttributeValue))
sMessageAttributes = Lens.field @"messageAttributes"
{-# INLINEABLE sMessageAttributes #-}
...
sMessageDeduplicationId :: Lens.Lens' SendMessageBatchRequestEntry (Core.Maybe Core.Text)
sMessageDeduplicationId = Lens.field @"messageDeduplicationId"
{-# INLINEABLE sMessageDeduplicationId #-}
...
sMessageGroupId :: Lens.Lens' SendMessageBatchRequestEntry (Core.Maybe Core.Text)
sMessageGroupId = Lens.field @"messageGroupId"
{-# INLINEABLE sMessageGroupId #-}
...
{-# INLINEABLE sMessageSystemAttributes #-}
...
instance Core.ToQuery SendMessageBatchRequestEntry where
        toQuery SendMessageBatchRequestEntry{..}
          = Core.toQueryPair "Id" id Core.<>
              Core.toQueryPair "MessageBody" messageBody
              Core.<>
