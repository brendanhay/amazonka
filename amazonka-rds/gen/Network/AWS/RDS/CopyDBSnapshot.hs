...
--
-- For more information about copying snapshots, see <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_CopyDBSnapshot.html Copying a DB Snapshot> in the /Amazon RDS User Guide./
--
module Network.AWS.RDS.CopyDBSnapshot
    (
    -- * Creating a Request
