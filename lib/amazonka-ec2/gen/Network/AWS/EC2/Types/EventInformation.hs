...
data EventInformation = EventInformation'
  { -- | The description of the event.
    ...
    eventSubType :: Core.Maybe Types.String,
...
eiEventDescription :: Lens.Lens' EventInformation (Core.Maybe Types.String)
...
eiEventSubType :: Lens.Lens' EventInformation (Core.Maybe Types.String)
...
eiInstanceId :: Lens.Lens' EventInformation (Core.Maybe Types.String)
