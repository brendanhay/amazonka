  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "AWSWAF_20150824.CreateRule")
...
{-# DEPRECATED crrrsChangeToken "Use generic-lens or generic-optics with 'changeToken' instead." #-}
...
{-# DEPRECATED crrrsRule "Use generic-lens or generic-optics with 'rule' instead." #-}
