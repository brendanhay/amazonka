...
instance ServiceError (Er SQS) where
...
instance ToByteString QueueAttributeName where
    toBS QueueAttributeNameApproximateNumberOfMessages = "ApproximateNumberOfMessages"
    toBS QueueAttributeNameApproximateNumberOfMessagesDelayed = "ApproximateNumberOfMessagesDelayed"
    toBS QueueAttributeNameApproximateNumberOfMessagesNotVisible = "ApproximateNumberOfMessagesNotVisible"
    toBS QueueAttributeNameCreatedTimestamp = "CreatedTimestamp"
    toBS QueueAttributeNameDelaySeconds = "DelaySeconds"
    toBS QueueAttributeNameLastModifiedTimestamp = "LastModifiedTimestamp"
    toBS QueueAttributeNameMaximumMessageSize = "MaximumMessageSize"
    toBS QueueAttributeNameMessageRetentionPeriod = "MessageRetentionPeriod"
    toBS QueueAttributeNamePolicy = "Policy"
    toBS QueueAttributeNameQueueArn = "QueueArn"
    toBS QueueAttributeNameReceiveMessageWaitTimeSeconds = "ReceiveMessageWaitTimeSeconds"
    toBS QueueAttributeNameRedrivePolicy = "RedrivePolicy"
    toBS QueueAttributeNameVisibilityTimeout = "VisibilityTimeout"
...
data Message = Message
    { _nMessageAttributes :: HashMap Text MessageAttributeValue
    ...
    , _nAttributes :: HashMap QueueAttributeName Text
...
data SendMessageBatchRequestEntry = SendMessageBatchRequestEntry
    { _smbreMessageAttributes :: HashMap Text MessageAttributeValue
      -- ^ Each message attribute consists of a Name, Type, and Value. For
      -- more information, see Message Attribute Items.
