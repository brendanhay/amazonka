...
mkUpdateFunctionCode functionName
  = UpdateFunctionCode'{functionName, dryRun = Core.Nothing,
                        publish = Core.Nothing, revisionId = Core.Nothing,
                        s3Bucket = Core.Nothing, s3Key = Core.Nothing,
...
uRevisionId :: Lens.Lens' UpdateFunctionCode (Core.Maybe Core.Text)
uRevisionId = Lens.field @"revisionId"
{-# INLINEABLE uRevisionId #-}
