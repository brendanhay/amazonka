...
Documentation is available via [Hackage](http://hackage.haskell.org/package/amazonka-shield)
...
`amazonka-shield` is released under the [Mozilla Public License Version 2.0](http://www.mozilla.org/MPL/).
