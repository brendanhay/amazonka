...
mkPatchBaselineIdentity
    :: PatchBaselineIdentity
mkPatchBaselineIdentity
  = PatchBaselineIdentity'{baselineDescription = Core.Nothing,
                           baselineId = Core.Nothing, baselineName = Core.Nothing,
                           defaultBaseline = Core.Nothing, operatingSystem = Core.Nothing}
...
{-# INLINEABLE pbiBaselineDescription #-}
{-# DEPRECATED baselineDescription "Use generic-lens or generic-optics with 'baselineDescription' instead"  #-}
...
{-# INLINEABLE pbiBaselineName #-}
{-# DEPRECATED baselineName "Use generic-lens or generic-optics with 'baselineName' instead"  #-}
...
{-# INLINEABLE pbiDefaultBaseline #-}
{-# DEPRECATED defaultBaseline "Use generic-lens or generic-optics with 'defaultBaseline' instead"  #-}
...
instance Core.FromJSON PatchBaselineIdentity where
        parseJSON
          = Core.withObject "PatchBaselineIdentity" Core.$
              \ x ->
                PatchBaselineIdentity' Core.<$>
                  (x Core..:? "BaselineDescription") Core.<*> x Core..:? "BaselineId"
