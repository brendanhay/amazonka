...
mkLogsLocation
    :: LogsLocation
mkLogsLocation
  = LogsLocation'{cloudWatchLogs = Core.Nothing,
                  cloudWatchLogsArn = Core.Nothing, deepLink = Core.Nothing,
                  groupName = Core.Nothing, s3DeepLink = Core.Nothing,
                  s3Logs = Core.Nothing, s3LogsArn = Core.Nothing,
...
llCloudWatchLogsArn :: Lens.Lens' LogsLocation (Core.Maybe Core.Text)
llCloudWatchLogsArn = Lens.field @"cloudWatchLogsArn"
{-# INLINEABLE llCloudWatchLogsArn #-}
{-# DEPRECATED cloudWatchLogsArn "Use generic-lens or generic-optics with 'cloudWatchLogsArn' instead"  #-}
...
llDeepLink :: Lens.Lens' LogsLocation (Core.Maybe Core.Text)
llDeepLink = Lens.field @"deepLink"
{-# INLINEABLE llDeepLink #-}
{-# DEPRECATED deepLink "Use generic-lens or generic-optics with 'deepLink' instead"  #-}

-- | The name of the Amazon CloudWatch Logs group for the build logs.
--
-- /Note:/ Consider using 'groupName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
llGroupName :: Lens.Lens' LogsLocation (Core.Maybe Core.Text)
llGroupName = Lens.field @"groupName"
{-# INLINEABLE llGroupName #-}
...
llS3DeepLink :: Lens.Lens' LogsLocation (Core.Maybe Core.Text)
llS3DeepLink = Lens.field @"s3DeepLink"
{-# INLINEABLE llS3DeepLink #-}
{-# DEPRECATED s3DeepLink "Use generic-lens or generic-optics with 's3DeepLink' instead"  #-}
...
llS3LogsArn :: Lens.Lens' LogsLocation (Core.Maybe Core.Text)
llS3LogsArn = Lens.field @"s3LogsArn"
{-# INLINEABLE llS3LogsArn #-}
{-# DEPRECATED s3LogsArn "Use generic-lens or generic-optics with 's3LogsArn' instead"  #-}

-- | The name of the Amazon CloudWatch Logs stream for the build logs.
--
-- /Note:/ Consider using 'streamName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
llStreamName :: Lens.Lens' LogsLocation (Core.Maybe Core.Text)
llStreamName = Lens.field @"streamName"
{-# INLINEABLE llStreamName #-}
...
instance Core.FromJSON LogsLocation where
        parseJSON
          = Core.withObject "LogsLocation" Core.$
              \ x ->
                LogsLocation' Core.<$>
                  (x Core..:? "cloudWatchLogs") Core.<*>
                    x Core..:? "cloudWatchLogsArn"
