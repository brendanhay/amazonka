...
mdbpgDBParameterGroupName :: Lens.Lens' ModifyDBParameterGroup Core.Text
mdbpgDBParameterGroupName = Lens.field @"dBParameterGroupName"
{-# INLINEABLE mdbpgDBParameterGroupName #-}
...
instance Core.AWSRequest ModifyDBParameterGroup where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ModifyDBParameterGroupResult"
