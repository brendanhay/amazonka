...
-- |
-- Module      : Network.AWS.QuickSight.DescribeAnalysisPermissions
...
instance Prelude.Hashable DescribeAnalysisPermissions

instance Prelude.NFData DescribeAnalysisPermissions
