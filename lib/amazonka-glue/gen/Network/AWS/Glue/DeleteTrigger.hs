...
dtName :: Lens.Lens' DeleteTrigger Lude.Text
dtName = Lens.lens (name :: DeleteTrigger -> Lude.Text) (\s a -> s {name = a} :: DeleteTrigger)
...
--
-- /Note:/ Consider using 'name' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dtfrsName :: Lens.Lens' DeleteTriggerResponse (Lude.Maybe Lude.Text)
dtfrsName = Lens.lens (name :: DeleteTriggerResponse -> Lude.Maybe Lude.Text) (\s a -> s {name = a} :: DeleteTriggerResponse)
{-# DEPRECATED dtfrsName "Use generic-lens or generic-optics with 'name' instead." #-}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dtfrsResponseStatus :: Lens.Lens' DeleteTriggerResponse Lude.Int
dtfrsResponseStatus = Lens.lens (responseStatus :: DeleteTriggerResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: DeleteTriggerResponse)
