...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Shield",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "shield",
                 Core._svcVersion = "2016-06-02", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _LimitsExceededException #-}
...
{-# INLINEABLE _OptimisticLockException #-}
...
{-# INLINEABLE _NoAssociatedRoleException #-}
...
{-# INLINEABLE _LockedSubscriptionException #-}
