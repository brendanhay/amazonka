...
mkCertificateAuthorityConfiguration
    :: Types.KeyAlgorithm -- ^ 'keyAlgorithm'
    -> Types.SigningAlgorithm -- ^ 'signingAlgorithm'
    -> Types.ASN1Subject -- ^ 'subject'
    -> CertificateAuthorityConfiguration
mkCertificateAuthorityConfiguration keyAlgorithm signingAlgorithm
  subject
...
{-# INLINEABLE cacSigningAlgorithm #-}
          ...
          = Core.withObject "CertificateAuthorityConfiguration" Core.$
              \ x ->
                CertificateAuthorityConfiguration' Core.<$>
                  (x Core..: "KeyAlgorithm") Core.<*> x Core..: "SigningAlgorithm"
                    Core.<*> x Core..: "Subject"
