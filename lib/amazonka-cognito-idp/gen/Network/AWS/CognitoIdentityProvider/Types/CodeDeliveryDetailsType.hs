...
mkCodeDeliveryDetailsType
    :: CodeDeliveryDetailsType
mkCodeDeliveryDetailsType
  = CodeDeliveryDetailsType'{attributeName = Core.Nothing,
                             deliveryMedium = Core.Nothing, destination = Core.Nothing}
