...
{-# INLINEABLE avdmApplicationVersion #-}
{-# DEPRECATED applicationVersion "Use generic-lens or generic-optics with 'applicationVersion' instead"  #-}

instance Core.FromXML ApplicationVersionDescriptionMessage where
        parseXML x
          = ApplicationVersionDescriptionMessage' Core.<$>
              (x Core..@? "ApplicationVersion")
