...
mkConnectionInput name connectionType
  = ConnectionInput'{name, connectionType,
                     connectionProperties = Core.mempty, description = Core.Nothing,
...
{-# INLINEABLE ciConnectionProperties #-}
...
{-# INLINEABLE ciPhysicalConnectionRequirements #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("Name" Core..= name),
                  ...
                  ("PhysicalConnectionRequirements" Core..=) Core.<$>
