...
data SubscriberResource = SubscriberResource'
  { -- | You can choose to notify subscribers of new objects with an Amazon
    ...
    -- in your S3 bucket via services like Amazon Athena. This subscription
    ...
    -- | The Amazon Web Services account ID of the account that you are using to
    -- create your Amazon Security Lake account.
...
--
-- 'externalId', 'subscriberResource_externalId' - The external ID of the subscriber. External ID allows the user that is
-- assuming the role to assert the circumstances in which they are
-- operating. It also provides a way for the account owner to permit the
-- role to be assumed only under specific circumstances.
--
...
--
-- 's3BucketArn', 'subscriberResource_s3BucketArn' - The Amazon Resource Name (ARN) for the Amazon S3 bucket.
--
-- 'snsArn', 'subscriberResource_snsArn' - The Amazon Resource Name (ARN) for the Amazon Simple Notification
-- Service.
--
...
--
-- 'subscriptionStatus', 'subscriberResource_subscriptionStatus' - Subscription status of the Amazon Security Lake subscriber account.
--
-- 'updatedAt', 'subscriberResource_updatedAt' - The date and time when the subscription was created.
--
-- 'accountId', 'subscriberResource_accountId' - The Amazon Web Services account ID of the account that you are using to
-- create your Amazon Security Lake account.
--
-- 'sourceTypes', 'subscriberResource_sourceTypes' - Amazon Security Lake supports logs and events collection for the
-- natively-supported Amazon Web Services services. For more information,
-- see the Amazon Security Lake User Guide.
--
