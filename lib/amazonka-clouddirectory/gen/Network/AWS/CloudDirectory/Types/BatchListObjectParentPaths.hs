...
{-# DEPRECATED bloppObjectReference "Use generic-lens or generic-optics with 'objectReference' instead." #-}
...
{-# DEPRECATED bloppMaxResults "Use generic-lens or generic-optics with 'maxResults' instead." #-}
