...
lNextToken :: Lens.Lens' ListFilters (Lude.Maybe Lude.Text)
lNextToken = Lens.lens (nextToken :: ListFilters -> Lude.Maybe Lude.Text) (\s a -> s {nextToken = a} :: ListFilters)
...
lMaxResults :: Lens.Lens' ListFilters (Lude.Maybe Lude.Natural)
lMaxResults = Lens.lens (maxResults :: ListFilters -> Lude.Maybe Lude.Natural) (\s a -> s {maxResults = a} :: ListFilters)
...
lDetectorId :: Lens.Lens' ListFilters Lude.Text
lDetectorId = Lens.lens (detectorId :: ListFilters -> Lude.Text) (\s a -> s {detectorId = a} :: ListFilters)
