...
mkStackEvent stackId eventId stackName timestamp
  = StackEvent'{stackId, eventId, stackName, timestamp,
                clientRequestToken = Core.Nothing,
                logicalResourceId = Core.Nothing,
                physicalResourceId = Core.Nothing,
                resourceProperties = Core.Nothing, resourceStatus = Core.Nothing,
                resourceStatusReason = Core.Nothing, resourceType = Core.Nothing}
...
{-# INLINEABLE seClientRequestToken #-}
...
{-# INLINEABLE seLogicalResourceId #-}
...
{-# INLINEABLE sePhysicalResourceId #-}
...
{-# INLINEABLE seResourceProperties #-}
{-# DEPRECATED resourceProperties "Use generic-lens or generic-optics with 'resourceProperties' instead"  #-}
...
{-# INLINEABLE seResourceStatusReason #-}
...
{-# INLINEABLE seResourceType #-}
{-# DEPRECATED resourceType "Use generic-lens or generic-optics with 'resourceType' instead"  #-}

instance Core.FromXML StackEvent where
        parseXML x
          = StackEvent' Core.<$>
              (x Core..@ "StackId") Core.<*> x Core..@ "EventId" Core.<*>
                x Core..@ "StackName"
