...
instance AWSRequest DescribeNotebookInstanceLifecycleConfig where
  type
...
instance Hashable DescribeNotebookInstanceLifecycleConfig

instance NFData DescribeNotebookInstanceLifecycleConfig

instance ToHeaders DescribeNotebookInstanceLifecycleConfig where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
...
instance ToJSON DescribeNotebookInstanceLifecycleConfig where
...
instance ToPath DescribeNotebookInstanceLifecycleConfig where
  toPath = const "/"

instance ToQuery DescribeNotebookInstanceLifecycleConfig where
...
instance NFData DescribeNotebookInstanceLifecycleConfigResponse
