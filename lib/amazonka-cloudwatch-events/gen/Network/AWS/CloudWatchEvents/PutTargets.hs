...
instance Core.ToHeaders PutTargets where
        toHeaders PutTargets{..}
          = Core.pure ("X-Amz-Target", "AWSEvents.PutTargets") Core.<>
...
mkPutTargetsResponse responseStatus
  = PutTargetsResponse'{failedEntries = Core.Nothing,
...
{-# INLINEABLE ptrrsFailedEntryCount #-}
