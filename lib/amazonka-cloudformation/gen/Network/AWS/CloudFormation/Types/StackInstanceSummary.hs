...
mkStackInstanceSummary
    :: StackInstanceSummary
mkStackInstanceSummary
  = StackInstanceSummary'{account = Core.Nothing,
...
{-# INLINEABLE sisLastDriftCheckTimestamp #-}
...
{-# INLINEABLE sisOrganizationalUnitId #-}
...
{-# INLINEABLE sisStackInstanceStatus #-}
