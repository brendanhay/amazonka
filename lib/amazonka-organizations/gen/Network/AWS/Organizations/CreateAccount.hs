...
{-# INLINEABLE caIamUserAccessToBilling #-}
...
mkCreateAccountResponse responseStatus
  = CreateAccountResponse'{createAccountStatus = Core.Nothing,
                           responseStatus}
...
{-# INLINEABLE carrsCreateAccountStatus #-}
