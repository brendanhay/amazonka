...
mkDescribeBudgetActionsForAccount accountId
  = DescribeBudgetActionsForAccount'{accountId,
...
{-# INLINEABLE dbafaNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery DescribeBudgetActionsForAccount where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeBudgetActionsForAccount where
        toHeaders DescribeBudgetActionsForAccount{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeBudgetActionsForAccount where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeBudgetActionsForAccountResponse' Core.<$>
...
mkDescribeBudgetActionsForAccountResponse responseStatus
  = DescribeBudgetActionsForAccountResponse'{actions = Core.mempty,
...
{-# INLINEABLE dbafarrsResponseStatus #-}
