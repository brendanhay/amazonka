...
mkLogStream
    :: LogStream
mkLogStream
  = LogStream'{arn = Core.Nothing, creationTime = Core.Nothing,
               firstEventTimestamp = Core.Nothing,
               lastEventTimestamp = Core.Nothing,
               lastIngestionTime = Core.Nothing, logStreamName = Core.Nothing,
               storedBytes = Core.Nothing, uploadSequenceToken = Core.Nothing}
...
{-# INLINEABLE lsFirstEventTimestamp #-}
{-# DEPRECATED firstEventTimestamp "Use generic-lens or generic-optics with 'firstEventTimestamp' instead"  #-}
...
{-# INLINEABLE lsLastEventTimestamp #-}
{-# DEPRECATED lastEventTimestamp "Use generic-lens or generic-optics with 'lastEventTimestamp' instead"  #-}
...
{-# INLINEABLE lsLastIngestionTime #-}
{-# DEPRECATED lastIngestionTime "Use generic-lens or generic-optics with 'lastIngestionTime' instead"  #-}
...
{-# INLINEABLE lsUploadSequenceToken #-}
{-# DEPRECATED uploadSequenceToken "Use generic-lens or generic-optics with 'uploadSequenceToken' instead"  #-}
