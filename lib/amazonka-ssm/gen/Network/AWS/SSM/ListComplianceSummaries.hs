...
mkListComplianceSummaries
    :: ListComplianceSummaries
mkListComplianceSummaries
  = ListComplianceSummaries'{filters = Core.Nothing,
...
instance Core.ToHeaders ListComplianceSummaries where
        toHeaders ListComplianceSummaries{..}
...
instance Core.AWSRequest ListComplianceSummaries where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListComplianceSummariesResponse' Core.<$>
                   (x Core..:? "ComplianceSummaryItems") Core.<*>
                     x Core..:? "NextToken"
...
mkListComplianceSummariesResponse responseStatus
  = ListComplianceSummariesResponse'{complianceSummaryItems =
                                       Core.Nothing,
...
{-# INLINEABLE lcsrrsComplianceSummaryItems #-}
{-# DEPRECATED complianceSummaryItems "Use generic-lens or generic-optics with 'complianceSummaryItems' instead"  #-}
