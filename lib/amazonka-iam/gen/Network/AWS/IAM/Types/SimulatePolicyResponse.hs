...
{-# DEPRECATED sprEvaluationResults "Use generic-lens or generic-optics with 'evaluationResults' instead." #-}
...
{-# DEPRECATED sprIsTruncated "Use generic-lens or generic-optics with 'isTruncated' instead." #-}
...
{-# DEPRECATED sprMarker "Use generic-lens or generic-optics with 'marker' instead." #-}
