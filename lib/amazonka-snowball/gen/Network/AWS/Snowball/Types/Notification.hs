...
mkNotification
    :: Notification
mkNotification
  = Notification'{jobStatesToNotify = Core.Nothing,
                  notifyAll = Core.Nothing, snsTopicARN = Core.Nothing}
...
{-# INLINEABLE nJobStatesToNotify #-}
{-# DEPRECATED jobStatesToNotify "Use generic-lens or generic-optics with 'jobStatesToNotify' instead"  #-}
...
{-# INLINEABLE nNotifyAll #-}
{-# DEPRECATED notifyAll "Use generic-lens or generic-optics with 'notifyAll' instead"  #-}
...
instance Core.FromJSON Notification where
        parseJSON
          = Core.withObject "Notification" Core.$
              \ x ->
                Notification' Core.<$>
                  (x Core..:? "JobStatesToNotify") Core.<*> x Core..:? "NotifyAll"
