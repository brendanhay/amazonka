...
mkAgentFilter
    :: AgentFilter
mkAgentFilter
  = AgentFilter'{agentHealths = Core.mempty,
...
{-# INLINEABLE afAgentHealths #-}
{-# DEPRECATED agentHealths "Use generic-lens or generic-optics with 'agentHealths' instead"  #-}
...
{-# INLINEABLE afAgentHealthCodes #-}
{-# DEPRECATED agentHealthCodes "Use generic-lens or generic-optics with 'agentHealthCodes' instead"  #-}
