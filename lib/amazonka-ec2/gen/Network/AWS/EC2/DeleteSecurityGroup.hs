...
dsgfGroupId :: Lens.Lens' DeleteSecurityGroup (Lude.Maybe Lude.Text)
dsgfGroupId = Lens.lens (groupId :: DeleteSecurityGroup -> Lude.Maybe Lude.Text) (\s a -> s {groupId = a} :: DeleteSecurityGroup)
{-# DEPRECATED dsgfGroupId "Use generic-lens or generic-optics with 'groupId' instead." #-}

-- | [EC2-Classic, default VPC] The name of the security group. You can specify either the security group name or the security group ID.
--
-- /Note:/ Consider using 'groupName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsgfGroupName :: Lens.Lens' DeleteSecurityGroup (Lude.Maybe Lude.Text)
dsgfGroupName = Lens.lens (groupName :: DeleteSecurityGroup -> Lude.Maybe Lude.Text) (\s a -> s {groupName = a} :: DeleteSecurityGroup)
{-# DEPRECATED dsgfGroupName "Use generic-lens or generic-optics with 'groupName' instead." #-}

-- | Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is @DryRunOperation@ . Otherwise, it is @UnauthorizedOperation@ .
--
-- /Note:/ Consider using 'dryRun' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsgfDryRun :: Lens.Lens' DeleteSecurityGroup (Lude.Maybe Lude.Bool)
dsgfDryRun = Lens.lens (dryRun :: DeleteSecurityGroup -> Lude.Maybe Lude.Bool) (\s a -> s {dryRun = a} :: DeleteSecurityGroup)
{-# DEPRECATED dsgfDryRun "Use generic-lens or generic-optics with 'dryRun' instead." #-}
