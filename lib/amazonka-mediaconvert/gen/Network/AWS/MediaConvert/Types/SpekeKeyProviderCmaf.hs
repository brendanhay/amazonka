...
mkSpekeKeyProviderCmaf
    :: SpekeKeyProviderCmaf
mkSpekeKeyProviderCmaf
  = SpekeKeyProviderCmaf'{certificateArn = Core.Nothing,
                          dashSignaledSystemIds = Core.Nothing,
                          hlsSignaledSystemIds = Core.Nothing, resourceId = Core.Nothing,
                          url = Core.Nothing}
...
{-# INLINEABLE skpcDashSignaledSystemIds #-}
{-# DEPRECATED dashSignaledSystemIds "Use generic-lens or generic-optics with 'dashSignaledSystemIds' instead"  #-}
...
{-# INLINEABLE skpcHlsSignaledSystemIds #-}
{-# DEPRECATED hlsSignaledSystemIds "Use generic-lens or generic-optics with 'hlsSignaledSystemIds' instead"  #-}
...
instance Core.FromJSON SpekeKeyProviderCmaf where
        parseJSON
          = Core.withObject "SpekeKeyProviderCmaf" Core.$
              \ x ->
                SpekeKeyProviderCmaf' Core.<$>
                  (x Core..:? "certificateArn") Core.<*>
                    x Core..:? "dashSignaledSystemIds"
