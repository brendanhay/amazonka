...
instance ServiceError (Er SES) where
...
instance ToByteString IdentityType where
    toBS IdentityTypeDomain = "Domain"
    toBS IdentityTypeEmailAddress = "EmailAddress"
...
instance ToByteString NotificationType where
    toBS NotificationTypeBounce = "Bounce"
    toBS NotificationTypeComplaint = "Complaint"
    toBS NotificationTypeDelivery = "Delivery"
...
instance ToByteString VerificationStatus where
    toBS VerificationStatusFailed = "Failed"
    toBS VerificationStatusNotStarted = "NotStarted"
    toBS VerificationStatusPending = "Pending"
    toBS VerificationStatusSuccess = "Success"
    toBS VerificationStatusTemporaryFailure = "TemporaryFailure"
