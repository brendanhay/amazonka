...
mkOperation
    :: Operation
mkOperation
  = Operation'{createDate = Core.Nothing, errorCode = Core.Nothing,
               errorMessage = Core.Nothing, id = Core.Nothing,
               status = Core.Nothing, targets = Core.Nothing,
               type' = Core.Nothing, updateDate = Core.Nothing}
...
instance Core.FromJSON Operation where
        parseJSON
          = Core.withObject "Operation" Core.$
              \ x ->
                Operation' Core.<$>
                  (x Core..:? "CreateDate") Core.<*> x Core..:? "ErrorCode" Core.<*>
                    x Core..:? "ErrorMessage"
                    Core.<*> x Core..:? "Id"
                    Core.<*> x Core..:? "Status"
                    Core.<*> x Core..:? "Targets"
