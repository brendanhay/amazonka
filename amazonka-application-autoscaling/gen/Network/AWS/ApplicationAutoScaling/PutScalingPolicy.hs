...
--
-- Learn more about how to work with scaling policies in the <https://docs.aws.amazon.com/autoscaling/application/userguide/what-is-application-auto-scaling.html Application Auto Scaling User Guide> .
--
module Network.AWS.ApplicationAutoScaling.PutScalingPolicy
    (
    -- * Creating a Request
...
--
-- * 'pspPolicyType' - The policy type. This parameter is required if you are creating a scaling policy. For information on which services do not support @StepScaling@ or @TargetTrackingScaling@ , see the information about __Limits__ in <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-step-scaling-policies.html Step Scaling Policies> and <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-target-tracking.html Target Tracking Scaling Policies> in the /Application Auto Scaling User Guide/ .
--
...
-- | The policy type. This parameter is required if you are creating a scaling policy. For information on which services do not support @StepScaling@ or @TargetTrackingScaling@ , see the information about __Limits__ in <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-step-scaling-policies.html Step Scaling Policies> and <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-target-tracking.html Target Tracking Scaling Policies> in the /Application Auto Scaling User Guide/ .
