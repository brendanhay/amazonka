...
mkCreateGlobalCluster
    :: CreateGlobalCluster
mkCreateGlobalCluster
  = CreateGlobalCluster'{databaseName = Core.Nothing,
...
cgcDatabaseName :: Lens.Lens' CreateGlobalCluster (Core.Maybe Core.Text)
cgcDatabaseName = Lens.field @"databaseName"
{-# INLINEABLE cgcDatabaseName #-}
...
{-# INLINEABLE cgcDeletionProtection #-}
...
cgcEngine :: Lens.Lens' CreateGlobalCluster (Core.Maybe Core.Text)
cgcEngine = Lens.field @"engine"
{-# INLINEABLE cgcEngine #-}
{-# DEPRECATED engine "Use generic-lens or generic-optics with 'engine' instead"  #-}

-- | The engine version of the Aurora global database.
--
-- /Note:/ Consider using 'engineVersion' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
cgcEngineVersion :: Lens.Lens' CreateGlobalCluster (Core.Maybe Core.Text)
cgcEngineVersion = Lens.field @"engineVersion"
{-# INLINEABLE cgcEngineVersion #-}
...
cgcGlobalClusterIdentifier :: Lens.Lens' CreateGlobalCluster (Core.Maybe Core.Text)
cgcGlobalClusterIdentifier = Lens.field @"globalClusterIdentifier"
{-# INLINEABLE cgcGlobalClusterIdentifier #-}
...
cgcSourceDBClusterIdentifier :: Lens.Lens' CreateGlobalCluster (Core.Maybe Core.Text)
cgcSourceDBClusterIdentifier = Lens.field @"sourceDBClusterIdentifier"
{-# INLINEABLE cgcSourceDBClusterIdentifier #-}
...
{-# INLINEABLE cgcStorageEncrypted #-}
...
instance Core.ToQuery CreateGlobalCluster where
        toQuery CreateGlobalCluster{..}
          = Core.toQueryPair "Action" ("CreateGlobalCluster" :: Core.Text)
...
instance Core.AWSRequest CreateGlobalCluster where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "CreateGlobalClusterResult"
              (\ s h x ->
                 CreateGlobalClusterResponse' Core.<$>
...
mkCreateGlobalClusterResponse responseStatus
  = CreateGlobalClusterResponse'{globalCluster = Core.Nothing,
                                 responseStatus}
...
{-# INLINEABLE cgcrrsGlobalCluster #-}
...
{-# INLINEABLE cgcrrsResponseStatus #-}
