...
mkNotificationOptions
    :: NotificationOptions
mkNotificationOptions
  = NotificationOptions'{emailMessage = Core.Nothing,
...
{-# INLINEABLE noSendEmail #-}
{-# DEPRECATED sendEmail "Use generic-lens or generic-optics with 'sendEmail' instead"  #-}
