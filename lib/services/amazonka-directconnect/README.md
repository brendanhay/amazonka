...
`2.0` - Derived from API version @2012-10-25@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.DirectConnect](http://hackage.haskell.org/package/amazonka-directconnect/docs/Amazonka-DirectConnect.html)
