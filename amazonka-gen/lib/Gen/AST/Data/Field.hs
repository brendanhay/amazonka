...
fieldList = not . Lens.isn't _List . Comonad.Cofree.unwrap . Lens.view fieldAnn
fieldMap = not . Lens.isn't _Map . Comonad.Cofree.unwrap . Lens.view fieldAnn
fieldLit = not . Lens.isn't _Lit . Comonad.Cofree.unwrap . Lens.view fieldAnn
