...
mkUserPendingChanges
    :: UserPendingChanges
mkUserPendingChanges
  = UserPendingChanges'{consoleAccess = Core.Nothing,
                        groups = Core.Nothing, pendingChange = Core.Nothing}
...
instance Core.FromJSON UserPendingChanges where
        parseJSON
          = Core.withObject "UserPendingChanges" Core.$
              \ x ->
                UserPendingChanges' Core.<$>
                  (x Core..:? "consoleAccess") Core.<*> x Core..:? "groups" Core.<*>
                    x Core..:? "pendingChange"
