...
data DescribeStaleSecurityGroups = DescribeStaleSecurityGroups'
  { _dssgNextToken  :: {-# NOUNPACK #-}!(Maybe Text)
  , _dssgDryRun     :: {-# NOUNPACK #-}!(Maybe Bool)
  , _dssgMaxResults :: {-# NOUNPACK #-}!(Maybe Nat)
  , _dssgVPCId      :: {-# NOUNPACK #-}!Text
...
data DescribeStaleSecurityGroupsResponse = DescribeStaleSecurityGroupsResponse'
  { _dssgrsStaleSecurityGroupSet :: {-# NOUNPACK #-}!(Maybe [StaleSecurityGroup])
  , _dssgrsNextToken :: {-# NOUNPACK #-}!(Maybe Text)
  , _dssgrsResponseStatus :: {-# NOUNPACK #-}!Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
