...
mkTargetTrackingConfiguration targetValue
  = TargetTrackingConfiguration'{targetValue,
                                 ...
                                 scaleInCooldown = Core.Nothing, scaleOutCooldown = Core.Nothing}
...
{-# INLINEABLE ttcCustomizedScalingMetricSpecification #-}
{-# DEPRECATED customizedScalingMetricSpecification "Use generic-lens or generic-optics with 'customizedScalingMetricSpecification' instead"  #-}
...
{-# INLINEABLE ttcEstimatedInstanceWarmup #-}
...
{-# INLINEABLE ttcPredefinedScalingMetricSpecification #-}
{-# DEPRECATED predefinedScalingMetricSpecification "Use generic-lens or generic-optics with 'predefinedScalingMetricSpecification' instead"  #-}
...
{-# INLINEABLE ttcScaleOutCooldown #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("TargetValue" Core..= targetValue),
                  ("CustomizedScalingMetricSpecification" Core..=) Core.<$>
                    customizedScalingMetricSpecification,
                  ("DisableScaleIn" Core..=) Core.<$> disableScaleIn,
                  ("EstimatedInstanceWarmup" Core..=) Core.<$>
                    estimatedInstanceWarmup,
                  ("PredefinedScalingMetricSpecification" Core..=) Core.<$>
              ...
              \ x ->
                TargetTrackingConfiguration' Core.<$>
                  (x Core..: "TargetValue") Core.<*>
                    x Core..:? "CustomizedScalingMetricSpecification"
