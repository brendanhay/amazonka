...
--
-- * 'dcvrFilters' - One or more filters. Filter names and values are case-sensitive.
--
...
instance AWSPager DescribeClientVPNRoutes where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dcvrNextToken .~ rs ^. dcvpnrrsNextToken

instance AWSRequest DescribeClientVPNRoutes where
        type Rs DescribeClientVPNRoutes =
             DescribeClientVPNRoutesResponse
...
instance Hashable DescribeClientVPNRoutes where

instance NFData DescribeClientVPNRoutes where
...
instance NFData DescribeClientVPNRoutesResponse where
