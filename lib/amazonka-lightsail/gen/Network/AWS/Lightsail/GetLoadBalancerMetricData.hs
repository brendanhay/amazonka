...
mkGetLoadBalancerMetricData
    ...
    -> Types.LoadBalancerMetricName -- ^ 'metricName'
    -> Core.Natural -- ^ 'period'
    -> Core.NominalDiffTime -- ^ 'startTime'
    -> Core.NominalDiffTime -- ^ 'endTime'
    -> Types.MetricUnit -- ^ 'unit'
    -> GetLoadBalancerMetricData
mkGetLoadBalancerMetricData loadBalancerName metricName period
  startTime endTime unit
  = GetLoadBalancerMetricData'{loadBalancerName, metricName, period,
...
{-# INLINEABLE glbmdLoadBalancerName #-}
...
instance Core.ToHeaders GetLoadBalancerMetricData where
        toHeaders GetLoadBalancerMetricData{..}
          = Core.pure
...
instance Core.AWSRequest GetLoadBalancerMetricData where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetLoadBalancerMetricDataResponse' Core.<$>
...
mkGetLoadBalancerMetricDataResponse responseStatus
  = GetLoadBalancerMetricDataResponse'{metricData = Core.Nothing,
...
{-# INLINEABLE glbmdrrsResponseStatus #-}
