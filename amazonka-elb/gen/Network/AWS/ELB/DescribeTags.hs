...
newDescribeTags pLoadBalancerNames_ =
  DescribeTags'
    { loadBalancerNames =
        Prelude._Coerce Lens.# pLoadBalancerNames_
    }

-- | The names of the load balancers.
describeTags_loadBalancerNames :: Lens.Lens' DescribeTags (Prelude.NonEmpty Prelude.Text)
describeTags_loadBalancerNames = Lens.lens (\DescribeTags' {loadBalancerNames} -> loadBalancerNames) (\s@DescribeTags' {} a -> s {loadBalancerNames = a} :: DescribeTags) Prelude.. Prelude._Coerce
