...
-- name filtering, see
-- <https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-filtering.html Configuring event notifications using object key name filtering>
