...
`1.6.1` - Derived from API version @2016-02-16@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.Inspector](http://hackage.haskell.org/package/amazonka-inspector/docs/Network-AWS-Inspector.html)
