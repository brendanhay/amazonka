...
mkEventSelector
    :: EventSelector
mkEventSelector
  = EventSelector'{dataResources = Core.Nothing,
...
{-# INLINEABLE esDataResources #-}
{-# DEPRECATED dataResources "Use generic-lens or generic-optics with 'dataResources' instead"  #-}
...
esExcludeManagementEventSources :: Lens.Lens' EventSelector (Core.Maybe [Core.Text])
esExcludeManagementEventSources = Lens.field @"excludeManagementEventSources"
{-# INLINEABLE esExcludeManagementEventSources #-}
{-# DEPRECATED excludeManagementEventSources "Use generic-lens or generic-optics with 'excludeManagementEventSources' instead"  #-}
...
{-# INLINEABLE esIncludeManagementEvents #-}
{-# DEPRECATED includeManagementEvents "Use generic-lens or generic-optics with 'includeManagementEvents' instead"  #-}
...
{-# INLINEABLE esReadWriteType #-}
{-# DEPRECATED readWriteType "Use generic-lens or generic-optics with 'readWriteType' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("DataResources" Core..=) Core.<$> dataResources,
                  ("ExcludeManagementEventSources" Core..=) Core.<$>
                    excludeManagementEventSources,
                  ("IncludeManagementEvents" Core..=) Core.<$>
...
instance Core.FromJSON EventSelector where
        parseJSON
          = Core.withObject "EventSelector" Core.$
              \ x ->
                EventSelector' Core.<$>
                  (x Core..:? "DataResources") Core.<*>
                    x Core..:? "ExcludeManagementEventSources"
