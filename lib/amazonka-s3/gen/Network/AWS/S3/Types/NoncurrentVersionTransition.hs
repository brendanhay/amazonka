...
mkNoncurrentVersionTransition
    ...
    -> Types.TransitionStorageClass -- ^ 'storageClass'
    -> NoncurrentVersionTransition
...
instance Core.ToXML NoncurrentVersionTransition where
        toXML NoncurrentVersionTransition{..}
          = Core.toXMLElement "NoncurrentDays" noncurrentDays Core.<>
              Core.toXMLElement "StorageClass" storageClass

instance Core.FromXML NoncurrentVersionTransition where
        parseXML x
          = NoncurrentVersionTransition' Core.<$>
              (x Core..@ "NoncurrentDays") Core.<*> x Core..@ "StorageClass"
