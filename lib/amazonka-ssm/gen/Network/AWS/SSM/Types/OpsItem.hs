...
mkOpsItem
    :: OpsItem
mkOpsItem
  = OpsItem'{category = Core.Nothing, createdBy = Core.Nothing,
             createdTime = Core.Nothing, description = Core.Nothing,
             lastModifiedBy = Core.Nothing, lastModifiedTime = Core.Nothing,
             notifications = Core.Nothing, operationalData = Core.Nothing,
             opsItemId = Core.Nothing, priority = Core.Nothing,
             relatedOpsItems = Core.Nothing, severity = Core.Nothing,
             source = Core.Nothing, status = Core.Nothing, title = Core.Nothing,
...
{-# INLINEABLE oiDescription #-}
{-# DEPRECATED description "Use generic-lens or generic-optics with 'description' instead"  #-}

-- | The ARN of the AWS account that last updated the OpsItem.
--
-- /Note:/ Consider using 'lastModifiedBy' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
oiLastModifiedBy :: Lens.Lens' OpsItem (Core.Maybe Core.Text)
oiLastModifiedBy = Lens.field @"lastModifiedBy"
{-# INLINEABLE oiLastModifiedBy #-}
...
oiVersion :: Lens.Lens' OpsItem (Core.Maybe Core.Text)
oiVersion = Lens.field @"version"
{-# INLINEABLE oiVersion #-}
...
instance Core.FromJSON OpsItem where
        parseJSON
          = Core.withObject "OpsItem" Core.$
              \ x ->
                OpsItem' Core.<$>
                  (x Core..:? "Category") Core.<*> x Core..:? "CreatedBy" Core.<*>
                    x Core..:? "CreatedTime"
