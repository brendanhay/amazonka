...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Support",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "support",
                 Core._svcVersion = "2013-04-15", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _AttachmentSetExpired #-}
...
{-# INLINEABLE _AttachmentLimitExceeded #-}
...
{-# INLINEABLE _DescribeAttachmentLimitExceeded #-}
...
{-# INLINEABLE _AttachmentSetIdNotFound #-}
...
{-# INLINEABLE _AttachmentSetSizeLimitExceeded #-}
...
{-# INLINEABLE _AttachmentIdNotFound #-}
...
{-# INLINEABLE _CaseCreationLimitExceeded #-}
