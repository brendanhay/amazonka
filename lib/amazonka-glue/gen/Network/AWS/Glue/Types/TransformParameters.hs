...
{-# INLINEABLE tpFindMatchesParameters #-}
{-# DEPRECATED findMatchesParameters "Use generic-lens or generic-optics with 'findMatchesParameters' instead"  #-}
...
instance Core.FromJSON TransformParameters where
        parseJSON
          = Core.withObject "TransformParameters" Core.$
              \ x ->
                TransformParameters' Core.<$>
                  (x Core..: "TransformType") Core.<*>
                    x Core..:? "FindMatchesParameters"
