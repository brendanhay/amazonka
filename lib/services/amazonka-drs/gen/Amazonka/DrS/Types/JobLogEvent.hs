...
module Amazonka.DrS.Types.JobLogEvent
  ( JobLogEvent
      ( ..,
        ...
        JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_END,
        JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_FAILED,
        JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_START,
        JobLogEvent_JOB_CANCEL,
        JobLogEvent_JOB_END,
        JobLogEvent_JOB_START,
        JobLogEvent_LAUNCH_FAILED,
        JobLogEvent_LAUNCH_START,
        JobLogEvent_NETWORK_RECOVERY_FAIL,
        JobLogEvent_SERVER_SKIPPED,
        JobLogEvent_SNAPSHOT_END,
        JobLogEvent_SNAPSHOT_FAIL,
        JobLogEvent_SNAPSHOT_START,
        JobLogEvent_UPDATE_LAUNCH_TEMPLATE_END,
        JobLogEvent_UPDATE_LAUNCH_TEMPLATE_FAILED,
        JobLogEvent_UPDATE_LAUNCH_TEMPLATE_START,
        JobLogEvent_UPDATE_NETWORK_CONFIGURATION_END,
        JobLogEvent_UPDATE_NETWORK_CONFIGURATION_FAILED,
        JobLogEvent_UPDATE_NETWORK_CONFIGURATION_START,
...
pattern JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_END :: JobLogEvent
pattern JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_END = JobLogEvent' "DEPLOY_NETWORK_CONFIGURATION_END"

pattern JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_FAILED :: JobLogEvent
pattern JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_FAILED = JobLogEvent' "DEPLOY_NETWORK_CONFIGURATION_FAILED"

pattern JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_START :: JobLogEvent
pattern JobLogEvent_DEPLOY_NETWORK_CONFIGURATION_START = JobLogEvent' "DEPLOY_NETWORK_CONFIGURATION_START"
...
pattern JobLogEvent_NETWORK_RECOVERY_FAIL :: JobLogEvent
pattern JobLogEvent_NETWORK_RECOVERY_FAIL = JobLogEvent' "NETWORK_RECOVERY_FAIL"
...
pattern JobLogEvent_UPDATE_LAUNCH_TEMPLATE_END :: JobLogEvent
pattern JobLogEvent_UPDATE_LAUNCH_TEMPLATE_END = JobLogEvent' "UPDATE_LAUNCH_TEMPLATE_END"

pattern JobLogEvent_UPDATE_LAUNCH_TEMPLATE_FAILED :: JobLogEvent
pattern JobLogEvent_UPDATE_LAUNCH_TEMPLATE_FAILED = JobLogEvent' "UPDATE_LAUNCH_TEMPLATE_FAILED"

pattern JobLogEvent_UPDATE_LAUNCH_TEMPLATE_START :: JobLogEvent
pattern JobLogEvent_UPDATE_LAUNCH_TEMPLATE_START = JobLogEvent' "UPDATE_LAUNCH_TEMPLATE_START"

pattern JobLogEvent_UPDATE_NETWORK_CONFIGURATION_END :: JobLogEvent
pattern JobLogEvent_UPDATE_NETWORK_CONFIGURATION_END = JobLogEvent' "UPDATE_NETWORK_CONFIGURATION_END"

pattern JobLogEvent_UPDATE_NETWORK_CONFIGURATION_FAILED :: JobLogEvent
pattern JobLogEvent_UPDATE_NETWORK_CONFIGURATION_FAILED = JobLogEvent' "UPDATE_NETWORK_CONFIGURATION_FAILED"

pattern JobLogEvent_UPDATE_NETWORK_CONFIGURATION_START :: JobLogEvent
pattern JobLogEvent_UPDATE_NETWORK_CONFIGURATION_START = JobLogEvent' "UPDATE_NETWORK_CONFIGURATION_START"
