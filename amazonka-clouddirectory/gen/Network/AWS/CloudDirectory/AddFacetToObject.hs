...
--
-- * 'aftoObjectAttributeList' - Attributes on the facet you are adding to the object.
--
-- * 'aftoDirectoryARN' - ARN associated with the 'Directory' where the object resides. For more information, see 'arns' .
--
