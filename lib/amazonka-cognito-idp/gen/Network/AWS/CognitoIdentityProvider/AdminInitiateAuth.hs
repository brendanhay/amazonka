...
mkAdminInitiateAuthResponse responseStatus =
  AdminInitiateAuthResponse'
    { authenticationResult = Core.Nothing,
...
{-# DEPRECATED aiarrsAuthenticationResult "Use generic-lens or generic-optics with 'authenticationResult' instead." #-}
...
{-# DEPRECATED aiarrsChallengeName "Use generic-lens or generic-optics with 'challengeName' instead." #-}
...
{-# DEPRECATED aiarrsChallengeParameters "Use generic-lens or generic-optics with 'challengeParameters' instead." #-}
...
{-# DEPRECATED aiarrsSession "Use generic-lens or generic-optics with 'session' instead." #-}
...
{-# DEPRECATED aiarrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
