...
mkAddHeaderAction
    :: Types.HeaderName -- ^ 'headerName'
    -> Types.HeaderValue -- ^ 'headerValue'
    -> AddHeaderAction
...
instance Core.ToQuery AddHeaderAction where
        toQuery AddHeaderAction{..}
          = Core.toQueryPair "HeaderName" headerName Core.<>
              Core.toQueryPair "HeaderValue" headerValue

instance Core.FromXML AddHeaderAction where
        parseXML x
          = AddHeaderAction' Core.<$>
