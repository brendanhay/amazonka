...
-- |
-- Module      : Network.AWS.ComputeOptimizer.Types.JobFilterName
...
pattern JobFilterName_JobStatus = JobFilterName' "JobStatus"

pattern JobFilterName_ResourceType :: JobFilterName
pattern JobFilterName_ResourceType = JobFilterName' "ResourceType"
