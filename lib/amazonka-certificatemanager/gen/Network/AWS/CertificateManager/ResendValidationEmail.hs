...
mkResendValidationEmail
    ...
    -> Types.DomainNameString -- ^ 'domain'
    -> Types.DomainNameString -- ^ 'validationDomain'
    -> ResendValidationEmail
...
{-# INLINEABLE rveValidationDomain #-}
...
instance Core.ToHeaders ResendValidationEmail where
        toHeaders ResendValidationEmail{..}
          = Core.pure
...
instance Core.AWSRequest ResendValidationEmail where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull ResendValidationEmailResponse'
