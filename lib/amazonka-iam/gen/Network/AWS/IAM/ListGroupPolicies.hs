...
mkListGroupPolicies groupName
  = ListGroupPolicies'{groupName, marker = Core.Nothing,
...
instance Core.AWSRequest ListGroupPolicies where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListGroupPoliciesResult"
              (\ s h x ->
                 ListGroupPoliciesResponse' Core.<$>
...
mkListGroupPoliciesResponse responseStatus
  = ListGroupPoliciesResponse'{policyNames = Core.mempty,
...
{-# INLINEABLE lgprrsResponseStatus #-}
