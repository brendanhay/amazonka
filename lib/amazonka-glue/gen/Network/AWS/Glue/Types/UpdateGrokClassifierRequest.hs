...
mkUpdateGrokClassifierRequest name
  = UpdateGrokClassifierRequest'{name, classification = Core.Nothing,
                                 customPatterns = Core.Nothing, grokPattern = Core.Nothing}
