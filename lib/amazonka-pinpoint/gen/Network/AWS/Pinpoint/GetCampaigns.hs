...
mkGetCampaigns applicationId
  = GetCampaigns'{applicationId, pageSize = Core.Nothing,
                  token = Core.Nothing}
...
{-# INLINEABLE gcrgrsCampaignsResponse #-}
