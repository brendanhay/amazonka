...
mkUpgradeElasticsearchDomain
    ...
    -> Types.ElasticsearchVersionString -- ^ 'targetVersion'
    -> UpgradeElasticsearchDomain
mkUpgradeElasticsearchDomain domainName targetVersion
  = UpgradeElasticsearchDomain'{domainName, targetVersion,
...
{-# INLINEABLE uedPerformCheckOnly #-}
{-# DEPRECATED performCheckOnly "Use generic-lens or generic-optics with 'performCheckOnly' instead"  #-}
...
instance Core.AWSRequest UpgradeElasticsearchDomain where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/2015-01-01/es/upgradeDomain",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpgradeElasticsearchDomainResponse' Core.<$>
                   (x Core..:? "DomainName") Core.<*> x Core..:? "PerformCheckOnly"
...
mkUpgradeElasticsearchDomainResponse responseStatus
  = UpgradeElasticsearchDomainResponse'{domainName = Core.Nothing,
                                        performCheckOnly = Core.Nothing,
                                        targetVersion = Core.Nothing, responseStatus}
...
{-# INLINEABLE uedrrsPerformCheckOnly #-}
{-# DEPRECATED performCheckOnly "Use generic-lens or generic-optics with 'performCheckOnly' instead"  #-}
...
{-# INLINEABLE uedrrsTargetVersion #-}
{-# DEPRECATED targetVersion "Use generic-lens or generic-optics with 'targetVersion' instead"  #-}
...
{-# INLINEABLE uedrrsResponseStatus #-}
