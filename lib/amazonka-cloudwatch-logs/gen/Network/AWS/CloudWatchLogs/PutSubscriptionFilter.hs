...
mkPutSubscriptionFilter
    ...
    -> Types.DestinationArn -- ^ 'destinationArn'
    -> PutSubscriptionFilter
mkPutSubscriptionFilter logGroupName filterName filterPattern
  destinationArn
  = PutSubscriptionFilter'{logGroupName, filterName, filterPattern,
                           destinationArn, distribution = Core.Nothing,
...
instance Core.AWSRequest PutSubscriptionFilter where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull PutSubscriptionFilterResponse'
