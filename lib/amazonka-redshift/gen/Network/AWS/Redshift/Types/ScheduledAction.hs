...
mkScheduledAction
    :: ScheduledAction
mkScheduledAction
  = ScheduledAction'{endTime = Core.Nothing, iamRole = Core.Nothing,
                     nextInvocations = Core.Nothing, schedule = Core.Nothing,
                     scheduledActionDescription = Core.Nothing,
                     scheduledActionName = Core.Nothing, startTime = Core.Nothing,
                     state = Core.Nothing, targetAction = Core.Nothing}
...
saIamRole :: Lens.Lens' ScheduledAction (Core.Maybe Core.Text)
saIamRole = Lens.field @"iamRole"
{-# INLINEABLE saIamRole #-}
...
saSchedule :: Lens.Lens' ScheduledAction (Core.Maybe Core.Text)
saSchedule = Lens.field @"schedule"
{-# INLINEABLE saSchedule #-}
...
saScheduledActionDescription :: Lens.Lens' ScheduledAction (Core.Maybe Core.Text)
saScheduledActionDescription = Lens.field @"scheduledActionDescription"
{-# INLINEABLE saScheduledActionDescription #-}
...
saScheduledActionName :: Lens.Lens' ScheduledAction (Core.Maybe Core.Text)
saScheduledActionName = Lens.field @"scheduledActionName"
{-# INLINEABLE saScheduledActionName #-}
...
instance Core.FromXML ScheduledAction where
        parseXML x
          = ScheduledAction' Core.<$>
              (x Core..@? "EndTime") Core.<*> x Core..@? "IamRole" Core.<*>
                x Core..@? "NextInvocations" Core..<@>
                  Core.parseXMLList "ScheduledActionTime"
