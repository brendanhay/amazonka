    ...
    Response.receiveJSON
      ( \s h x ->
          ListAppComponentRecommendationsResponse'
            ...
            Prelude.<*> ( x Core..?> "componentRecommendations"
                            Core..!@ Prelude.mempty
                        )
      )
...
instance Core.ToJSON ListAppComponentRecommendations where
...
instance Core.ToPath ListAppComponentRecommendations where
  toPath =
    Prelude.const "/list-app-component-recommendations"

instance Core.ToQuery ListAppComponentRecommendations where
