...
mkFilters
    :: Filters
mkFilters
  = Filters'{extendedKeyUsage = Core.Nothing,
             keyTypes = Core.Nothing, keyUsage = Core.Nothing}
...
{-# INLINEABLE fExtendedKeyUsage #-}
{-# DEPRECATED extendedKeyUsage "Use generic-lens or generic-optics with 'extendedKeyUsage' instead"  #-}
...
{-# INLINEABLE fKeyTypes #-}
{-# DEPRECATED keyTypes "Use generic-lens or generic-optics with 'keyTypes' instead"  #-}
