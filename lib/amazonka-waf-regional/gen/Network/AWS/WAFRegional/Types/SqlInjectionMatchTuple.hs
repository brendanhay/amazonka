...
mkSqlInjectionMatchTuple ::
  ...
  TextTransformation ->
  SqlInjectionMatchTuple
mkSqlInjectionMatchTuple pFieldToMatch_ pTextTransformation_ =
  SqlInjectionMatchTuple'
...
simtFieldToMatch :: Lens.Lens' SqlInjectionMatchTuple FieldToMatch
simtFieldToMatch = Lens.lens (fieldToMatch :: SqlInjectionMatchTuple -> FieldToMatch) (\s a -> s {fieldToMatch = a} :: SqlInjectionMatchTuple)
...
simtTextTransformation :: Lens.Lens' SqlInjectionMatchTuple TextTransformation
simtTextTransformation = Lens.lens (textTransformation :: SqlInjectionMatchTuple -> TextTransformation) (\s a -> s {textTransformation = a} :: SqlInjectionMatchTuple)
{-# DEPRECATED simtTextTransformation "Use generic-lens or generic-optics with 'textTransformation' instead." #-}

instance Lude.FromJSON SqlInjectionMatchTuple where
  parseJSON =
    Lude.withObject
      "SqlInjectionMatchTuple"
      ( \x ->
...
instance Lude.ToJSON SqlInjectionMatchTuple where
