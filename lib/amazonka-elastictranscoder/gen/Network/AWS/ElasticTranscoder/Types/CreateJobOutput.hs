...
mkCreateJobOutput
    :: CreateJobOutput
mkCreateJobOutput
  = CreateJobOutput'{albumArt = Core.Nothing,
                     captions = Core.Nothing, composition = Core.Nothing,
                     encryption = Core.Nothing, key = Core.Nothing,
                     presetId = Core.Nothing, rotate = Core.Nothing,
                     segmentDuration = Core.Nothing, thumbnailEncryption = Core.Nothing,
...
{-# INLINEABLE cjoThumbnailEncryption #-}
...
{-# INLINEABLE cjoThumbnailPattern #-}
