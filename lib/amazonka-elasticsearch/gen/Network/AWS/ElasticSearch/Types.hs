...
import Network.AWS.ElasticSearch.Types.CurrentVersion
...
import Network.AWS.ElasticSearch.Types.Description
...
import Network.AWS.ElasticSearch.Types.NewVersion
...
import Network.AWS.ElasticSearch.Types.RolesKey
...
import Network.AWS.ElasticSearch.Types.String
import Network.AWS.ElasticSearch.Types.SubjectKey
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "ElasticSearch",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "es",
      Core._svcVersion = "2015-01-01",
