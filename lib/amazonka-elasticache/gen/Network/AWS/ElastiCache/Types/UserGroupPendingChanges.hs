...
mkUserGroupPendingChanges
    :: UserGroupPendingChanges
mkUserGroupPendingChanges
  = UserGroupPendingChanges'{userIdsToAdd = Core.Nothing,
...
{-# INLINEABLE ugpcUserIdsToRemove #-}
...
instance Core.FromXML UserGroupPendingChanges where
        parseXML x
          = UserGroupPendingChanges' Core.<$>
              (x Core..@? "UserIdsToAdd" Core..<@> Core.parseXMLList "member")
                Core.<*>
                x Core..@? "UserIdsToRemove" Core..<@> Core.parseXMLList "member"
