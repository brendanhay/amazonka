...
mkRequestCertificate domainName
  = RequestCertificate'{domainName,
                        ...
                        idempotencyToken = Core.Nothing, options = Core.Nothing,
...
{-# INLINEABLE rcDomainValidationOptions #-}
...
{-# INLINEABLE rcSubjectAlternativeNames #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("DomainName" Core..= domainName),
                  ...
                  ("DomainValidationOptions" Core..=) Core.<$>
...
instance Core.AWSRequest RequestCertificate where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 RequestCertificateResponse' Core.<$>
...
mkRequestCertificateResponse responseStatus
  = RequestCertificateResponse'{certificateArn = Core.Nothing,
                                responseStatus}
