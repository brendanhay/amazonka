...
mkContinuousExportDescription
    :: ContinuousExportDescription
mkContinuousExportDescription
  = ContinuousExportDescription'{dataSource = Core.Nothing,
...
cedSchemaStorageConfig :: Lens.Lens' ContinuousExportDescription (Core.Maybe (Core.HashMap Types.DatabaseName Core.Text))
cedSchemaStorageConfig = Lens.field @"schemaStorageConfig"
{-# INLINEABLE cedSchemaStorageConfig #-}
...
instance Core.FromJSON ContinuousExportDescription where
        parseJSON
          = Core.withObject "ContinuousExportDescription" Core.$
              \ x ->
                ContinuousExportDescription' Core.<$>
