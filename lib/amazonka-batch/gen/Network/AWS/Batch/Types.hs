...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Batch",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "batch",
                 Core._svcVersion = "2016-08-10", Core._svcTimeout = Core.Just 70,
...
_ServerException
  = Core._MatchServiceError mkServiceConfig "ServerException" Core..
      Core.hasStatues 500
...
_ClientException
  = Core._MatchServiceError mkServiceConfig "ClientException" Core..
      Core.hasStatues 400
