...
cpgnmCacheParameterGroupName :: Lens.Lens' CacheParameterGroupNameMessage (Core.Maybe Core.Text)
cpgnmCacheParameterGroupName = Lens.field @"cacheParameterGroupName"
{-# INLINEABLE cpgnmCacheParameterGroupName #-}
...
instance Core.FromXML CacheParameterGroupNameMessage where
        parseXML x
          = CacheParameterGroupNameMessage' Core.<$>
              (x Core..@? "CacheParameterGroupName")
