...
-- |
-- Module      : Amazonka.InternetMonitor.TagResource
...
--
-- 'resourceArn', 'tagResource_resourceArn' - The Amazon Resource Name (ARN) for a tag that you add to a resource.
-- Tags are supported only for monitors in Amazon CloudWatch Internet
-- Monitor.
--
-- 'tags', 'tagResource_tags' - Tags that you add to a resource. You can add a maximum of 50 tags in
-- Internet Monitor.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
