...
{-# INLINEABLE ikmEncryptedKeyMaterial #-}
{-# DEPRECATED encryptedKeyMaterial "Use generic-lens or generic-optics with 'encryptedKeyMaterial' instead"  #-}
...
{-# INLINEABLE ikmrrsResponseStatus #-}
