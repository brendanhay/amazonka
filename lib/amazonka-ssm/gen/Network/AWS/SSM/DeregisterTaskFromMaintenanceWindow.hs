...
instance AWSRequest DeregisterTaskFromMaintenanceWindow where
  type
...
instance ToHeaders DeregisterTaskFromMaintenanceWindow where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("AmazonSSM.DeregisterTaskFromMaintenanceWindow" :: ByteString),
...
instance NFData DeregisterTaskFromMaintenanceWindowResponse
