...
mkDominantLanguageDetectionJobFilter
    :: DominantLanguageDetectionJobFilter
mkDominantLanguageDetectionJobFilter
  = DominantLanguageDetectionJobFilter'{jobName = Core.Nothing,
...
{-# INLINEABLE dldjfSubmitTimeAfter #-}
...
{-# INLINEABLE dldjfSubmitTimeBefore #-}
