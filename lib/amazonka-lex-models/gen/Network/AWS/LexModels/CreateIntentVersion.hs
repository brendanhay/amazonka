...
civChecksum :: Lens.Lens' CreateIntentVersion (Core.Maybe Core.Text)
civChecksum = Lens.field @"checksum"
{-# INLINEABLE civChecksum #-}
...
instance Core.AWSRequest CreateIntentVersion where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateIntentVersionResponse' Core.<$>
...
mkCreateIntentVersionResponse responseStatus
  = CreateIntentVersionResponse'{checksum = Core.Nothing,
...
--
-- /Note:/ Consider using 'checksum' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
civrrsChecksum :: Lens.Lens' CreateIntentVersionResponse (Core.Maybe Core.Text)
civrrsChecksum = Lens.field @"checksum"
{-# INLINEABLE civrrsChecksum #-}
{-# DEPRECATED checksum "Use generic-lens or generic-optics with 'checksum' instead"  #-}
...
{-# INLINEABLE civrrsConclusionStatement #-}
...
{-# INLINEABLE civrrsConfirmationPrompt #-}
...
{-# INLINEABLE civrrsDialogCodeHook #-}
...
{-# INLINEABLE civrrsFollowUpPrompt #-}
...
{-# INLINEABLE civrrsFulfillmentActivity #-}
...
{-# INLINEABLE civrrsInputContexts #-}
...
{-# INLINEABLE civrrsKendraConfiguration #-}
...
{-# INLINEABLE civrrsLastUpdatedDate #-}
...
{-# INLINEABLE civrrsOutputContexts #-}
...
{-# INLINEABLE civrrsParentIntentSignature #-}
...
{-# INLINEABLE civrrsRejectionStatement #-}
...
{-# INLINEABLE civrrsSampleUtterances #-}
