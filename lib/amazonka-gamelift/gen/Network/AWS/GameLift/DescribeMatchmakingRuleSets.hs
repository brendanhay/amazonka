...
mkDescribeMatchmakingRuleSets
    :: DescribeMatchmakingRuleSets
mkDescribeMatchmakingRuleSets
  = DescribeMatchmakingRuleSets'{limit = Core.Nothing,
...
instance Core.ToHeaders DescribeMatchmakingRuleSets where
        toHeaders DescribeMatchmakingRuleSets{..}
          = Core.pure
...
instance Core.AWSRequest DescribeMatchmakingRuleSets where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeMatchmakingRuleSetsResponse' Core.<$>
                   (x Core..:? "RuleSets" Core..!= Core.mempty) Core.<*>
                     x Core..:? "NextToken"
...
mkDescribeMatchmakingRuleSetsResponse responseStatus
  = DescribeMatchmakingRuleSetsResponse'{ruleSets = Core.mempty,
...
{-# INLINEABLE dmrsrrsResponseStatus #-}
