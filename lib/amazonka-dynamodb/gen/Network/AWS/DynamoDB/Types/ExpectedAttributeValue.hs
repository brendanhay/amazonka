...
-- | Creates a 'ExpectedAttributeValue' value with any optional fields omitted.
mkExpectedAttributeValue
    :: ExpectedAttributeValue
mkExpectedAttributeValue
  = ExpectedAttributeValue'{attributeValueList = Core.Nothing,
                            comparisonOperator = Core.Nothing, exists = Core.Nothing,
                            value = Core.Nothing}
...
eavAttributeValueList :: Lens.Lens' ExpectedAttributeValue (Core.Maybe [Types.AttributeValue])
eavAttributeValueList = Lens.field @"attributeValueList"
{-# INLINEABLE eavAttributeValueList #-}
{-# DEPRECATED attributeValueList "Use generic-lens or generic-optics with 'attributeValueList' instead"  #-}
...
eavComparisonOperator :: Lens.Lens' ExpectedAttributeValue (Core.Maybe Types.ComparisonOperator)
eavComparisonOperator = Lens.field @"comparisonOperator"
{-# INLINEABLE eavComparisonOperator #-}
...
eavExists :: Lens.Lens' ExpectedAttributeValue (Core.Maybe Core.Bool)
eavExists = Lens.field @"exists"
{-# INLINEABLE eavExists #-}
...
eavValue :: Lens.Lens' ExpectedAttributeValue (Core.Maybe Types.AttributeValue)
eavValue = Lens.field @"value"
{-# INLINEABLE eavValue #-}
{-# DEPRECATED value "Use generic-lens or generic-optics with 'value' instead"  #-}

instance Core.FromJSON ExpectedAttributeValue where
