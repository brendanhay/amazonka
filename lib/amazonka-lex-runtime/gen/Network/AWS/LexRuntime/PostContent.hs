      ...
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.toHeaders "Content-Type" contentType
            Core.<> (Core.toHeaders "Accept" accept)
            Core.<> (Core.toHeaders "x-amz-lex-active-contexts" activeContexts)
            Core.<> (Core.toHeaders "x-amz-lex-request-attributes" requestAttributes)
            Core.<> (Core.toHeaders "x-amz-lex-session-attributes" sessionAttributes),
    ...
    Response.receiveBody
      ( \s h x ->
          PostContentResponse'
            ...
            Core.<*> (Core.parseHeaderMaybe "x-amz-lex-alternative-intents" h)
            Core.<*> (Core.pure x)
...
data PostContentResponse = PostContentResponse'
  { -- | A list of active contexts for the session. A context can be set when an intent is fulfilled or by calling the @PostContent@ , @PostText@ , or @PutSession@ operation.
    ...
    alternativeIntents :: Core.Maybe Types.AlternativeIntents,
    ...
    inputTranscript :: Core.Maybe Types.InputTranscript,
    ...
    nluIntentConfidence :: Core.Maybe Types.NluIntentConfidence,
    -- | The sentiment expressed in an utterance.
    --
    -- When the bot is configured to send utterances to Amazon Comprehend for sentiment analysis, this field contains the result of the analysis.
    sentimentResponse :: Core.Maybe Types.String,
...
{-# DEPRECATED pcrrsActiveContexts "Use generic-lens or generic-optics with 'activeContexts' instead." #-}
...
pcrrsAlternativeIntents :: Lens.Lens' PostContentResponse (Core.Maybe Types.AlternativeIntents)
pcrrsAlternativeIntents = Lens.field @"alternativeIntents"
{-# DEPRECATED pcrrsAlternativeIntents "Use generic-lens or generic-optics with 'alternativeIntents' instead." #-}
...
{-# DEPRECATED pcrrsAudioStream "Use generic-lens or generic-optics with 'audioStream' instead." #-}
...
{-# DEPRECATED pcrrsBotVersion "Use generic-lens or generic-optics with 'botVersion' instead." #-}
...
{-# DEPRECATED pcrrsContentType "Use generic-lens or generic-optics with 'contentType' instead." #-}
...
{-# DEPRECATED pcrrsDialogState "Use generic-lens or generic-optics with 'dialogState' instead." #-}
...
pcrrsInputTranscript :: Lens.Lens' PostContentResponse (Core.Maybe Types.InputTranscript)
pcrrsInputTranscript = Lens.field @"inputTranscript"
{-# DEPRECATED pcrrsInputTranscript "Use generic-lens or generic-optics with 'inputTranscript' instead." #-}
...
{-# DEPRECATED pcrrsIntentName "Use generic-lens or generic-optics with 'intentName' instead." #-}
...
{-# DEPRECATED pcrrsMessage "Use generic-lens or generic-optics with 'message' instead." #-}
...
{-# DEPRECATED pcrrsMessageFormat "Use generic-lens or generic-optics with 'messageFormat' instead." #-}
...
pcrrsNluIntentConfidence :: Lens.Lens' PostContentResponse (Core.Maybe Types.NluIntentConfidence)
pcrrsNluIntentConfidence = Lens.field @"nluIntentConfidence"
{-# DEPRECATED pcrrsNluIntentConfidence "Use generic-lens or generic-optics with 'nluIntentConfidence' instead." #-}
...
pcrrsSentimentResponse :: Lens.Lens' PostContentResponse (Core.Maybe Types.String)
pcrrsSentimentResponse = Lens.field @"sentimentResponse"
{-# DEPRECATED pcrrsSentimentResponse "Use generic-lens or generic-optics with 'sentimentResponse' instead." #-}

-- | Map of key/value pairs representing the session-specific context information.
--
-- /Note:/ Consider using 'sessionAttributes' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
pcrrsSessionAttributes :: Lens.Lens' PostContentResponse (Core.Maybe Types.SessionAttributes)
pcrrsSessionAttributes = Lens.field @"sessionAttributes"
{-# DEPRECATED pcrrsSessionAttributes "Use generic-lens or generic-optics with 'sessionAttributes' instead." #-}
...
pcrrsSessionId :: Lens.Lens' PostContentResponse (Core.Maybe Types.SessionId)
pcrrsSessionId = Lens.field @"sessionId"
{-# DEPRECATED pcrrsSessionId "Use generic-lens or generic-optics with 'sessionId' instead." #-}
...
pcrrsSlotToElicit :: Lens.Lens' PostContentResponse (Core.Maybe Types.SlotToElicit)
pcrrsSlotToElicit = Lens.field @"slotToElicit"
{-# DEPRECATED pcrrsSlotToElicit "Use generic-lens or generic-optics with 'slotToElicit' instead." #-}
...
pcrrsSlots :: Lens.Lens' PostContentResponse (Core.Maybe Types.Slots)
pcrrsSlots = Lens.field @"slots"
{-# DEPRECATED pcrrsSlots "Use generic-lens or generic-optics with 'slots' instead." #-}
