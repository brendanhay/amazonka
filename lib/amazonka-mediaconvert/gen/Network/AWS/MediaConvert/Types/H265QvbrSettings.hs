...
mkH265QvbrSettings
    :: H265QvbrSettings
mkH265QvbrSettings
  = H265QvbrSettings'{maxAverageBitrate = Core.Nothing,
...
{-# INLINEABLE hQvbrQualityLevelFineTune #-}
