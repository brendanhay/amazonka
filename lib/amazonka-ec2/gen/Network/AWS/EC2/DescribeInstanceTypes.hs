...
mkDescribeInstanceTypes
    :: DescribeInstanceTypes
mkDescribeInstanceTypes
  = DescribeInstanceTypes'{dryRun = Core.Nothing,
...
instance Core.ToQuery DescribeInstanceTypes where
        toQuery DescribeInstanceTypes{..}
          = Core.toQueryPair "Action" ("DescribeInstanceTypes" :: Core.Text)
...
instance Core.AWSRequest DescribeInstanceTypes where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 DescribeInstanceTypesResponse' Core.<$>
                   (x Core..@? "instanceTypeSet" Core..<@> Core.parseXMLList "item")
...
mkDescribeInstanceTypesResponse responseStatus
  = DescribeInstanceTypesResponse'{instanceTypes = Core.Nothing,
...
{-# INLINEABLE ditrrsInstanceTypes #-}
{-# DEPRECATED instanceTypes "Use generic-lens or generic-optics with 'instanceTypes' instead"  #-}
