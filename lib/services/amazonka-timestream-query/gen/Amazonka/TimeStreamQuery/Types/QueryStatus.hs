...
newQueryStatus =
  QueryStatus'
    { cumulativeBytesScanned =
        Prelude.Nothing,
      cumulativeBytesMetered = Prelude.Nothing,
...
instance Prelude.Hashable QueryStatus where
  hashWithSalt _salt QueryStatus' {..} =
    _salt `Prelude.hashWithSalt` cumulativeBytesScanned
...
instance Prelude.NFData QueryStatus where
  rnf QueryStatus' {..} =
    Prelude.rnf cumulativeBytesScanned
      `Prelude.seq` Prelude.rnf cumulativeBytesMetered
