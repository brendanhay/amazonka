...
--
-- * 'dMaxResults' - The maximum number of results to return in one operation. The maximum value you can specify is 10. To retrieve the remaining results, make another call with the returned @NextToken@ value.
describeAnomalyDetectors
    :: DescribeAnomalyDetectors
describeAnomalyDetectors =
  DescribeAnomalyDetectors'
...
instance AWSRequest DescribeAnomalyDetectors where
        type Rs DescribeAnomalyDetectors =
             DescribeAnomalyDetectorsResponse
        request = postQuery cloudWatch
        response
          = receiveXMLWrapper "DescribeAnomalyDetectorsResult"
              (\ s h x ->
                 DescribeAnomalyDetectorsResponse' <$>
...
instance Hashable DescribeAnomalyDetectors where

instance NFData DescribeAnomalyDetectors where
