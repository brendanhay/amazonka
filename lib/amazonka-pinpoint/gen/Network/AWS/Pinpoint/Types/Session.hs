...
mkSession
    :: Core.Text -- ^ 'startTimestamp'
    -> Core.Text -- ^ 'id'
    -> Session
mkSession startTimestamp id
  = Session'{startTimestamp, id, duration = Core.Nothing,
...
{-# INLINEABLE sfStopTimestamp #-}
{-# DEPRECATED stopTimestamp "Use generic-lens or generic-optics with 'stopTimestamp' instead"  #-}
