...
mkEcsParameters
    :: Types.Arn -- ^ 'taskDefinitionArn'
    -> EcsParameters
mkEcsParameters taskDefinitionArn
  = EcsParameters'{taskDefinitionArn, group = Core.Nothing,
                   launchType = Core.Nothing, networkConfiguration = Core.Nothing,
                   platformVersion = Core.Nothing, taskCount = Core.Nothing}
...
{-# INLINEABLE epTaskDefinitionArn #-}
...
epGroup :: Lens.Lens' EcsParameters (Core.Maybe Core.Text)
...
{-# INLINEABLE epNetworkConfiguration #-}
...
epPlatformVersion :: Lens.Lens' EcsParameters (Core.Maybe Core.Text)
epPlatformVersion = Lens.field @"platformVersion"
{-# INLINEABLE epPlatformVersion #-}
...
instance Core.FromJSON EcsParameters where
        parseJSON
          = Core.withObject "EcsParameters" Core.$
              \ x ->
                EcsParameters' Core.<$>
                  (x Core..: "TaskDefinitionArn") Core.<*> x Core..:? "Group"
