...
mkGetCapacityReservationUsage capacityReservationId
  = GetCapacityReservationUsage'{capacityReservationId,
...
{-# INLINEABLE gcruCapacityReservationId #-}
...
instance Core.AWSRequest GetCapacityReservationUsage where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 GetCapacityReservationUsageResponse' Core.<$>
                   (x Core..@? "availableInstanceCount") Core.<*>
                     x Core..@? "capacityReservationId"
                     Core.<*> x Core..@? "instanceType"
                     Core.<*>
                     x Core..@? "instanceUsageSet" Core..<@> Core.parseXMLList "item"
...
mkGetCapacityReservationUsageResponse responseStatus
  = GetCapacityReservationUsageResponse'{availableInstanceCount =
                                           Core.Nothing,
                                         capacityReservationId = Core.Nothing,
                                         instanceType = Core.Nothing, instanceUsages = Core.Nothing,
                                         nextToken = Core.Nothing, state = Core.Nothing,
                                         totalInstanceCount = Core.Nothing, responseStatus}
...
{-# INLINEABLE gcrurrsAvailableInstanceCount #-}
{-# DEPRECATED availableInstanceCount "Use generic-lens or generic-optics with 'availableInstanceCount' instead"  #-}

-- | The ID of the Capacity Reservation.
--
-- /Note:/ Consider using 'capacityReservationId' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
gcrurrsCapacityReservationId :: Lens.Lens' GetCapacityReservationUsageResponse (Core.Maybe Core.Text)
gcrurrsCapacityReservationId = Lens.field @"capacityReservationId"
{-# INLINEABLE gcrurrsCapacityReservationId #-}
{-# DEPRECATED capacityReservationId "Use generic-lens or generic-optics with 'capacityReservationId' instead"  #-}

-- | The type of instance for which the Capacity Reservation reserves capacity.
--
-- /Note:/ Consider using 'instanceType' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
gcrurrsInstanceType :: Lens.Lens' GetCapacityReservationUsageResponse (Core.Maybe Core.Text)
gcrurrsInstanceType = Lens.field @"instanceType"
{-# INLINEABLE gcrurrsInstanceType #-}
...
{-# INLINEABLE gcrurrsInstanceUsages #-}
{-# DEPRECATED instanceUsages "Use generic-lens or generic-optics with 'instanceUsages' instead"  #-}

-- | The token to use to retrieve the next page of results. This value is @null@ when there are no more results to return.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
gcrurrsNextToken :: Lens.Lens' GetCapacityReservationUsageResponse (Core.Maybe Core.Text)
gcrurrsNextToken = Lens.field @"nextToken"
{-# INLINEABLE gcrurrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE gcrurrsTotalInstanceCount #-}
...
{-# INLINEABLE gcrurrsResponseStatus #-}
