...
mkOverridePullRequestApprovalRules
    ...
    -> Types.OverrideStatus -- ^ 'overrideStatus'
    -> OverridePullRequestApprovalRules
mkOverridePullRequestApprovalRules pullRequestId revisionId
  overrideStatus
  = OverridePullRequestApprovalRules'{pullRequestId, revisionId,
                                      overrideStatus}
...
{-# INLINEABLE oprarOverrideStatus #-}
{-# DEPRECATED overrideStatus "Use generic-lens or generic-optics with 'overrideStatus' instead"  #-}

instance Core.ToQuery OverridePullRequestApprovalRules where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders OverridePullRequestApprovalRules where
        toHeaders OverridePullRequestApprovalRules{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest OverridePullRequestApprovalRules where
        type Rs OverridePullRequestApprovalRules =
             OverridePullRequestApprovalRulesResponse
