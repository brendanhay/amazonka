...
module Network.AWS.EC2.V2014_05_01.DescribeImages where
...
data DescribeImages = DescribeImages
    ...
    , _didtFilters :: [Filter]
      ...
      -- EBS volume (standard | io1). description - The description of the
      -- image (provided during image creation). hypervisor - The
