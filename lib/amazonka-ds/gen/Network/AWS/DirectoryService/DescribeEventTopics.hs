...
mkDescribeEventTopics
    :: DescribeEventTopics
mkDescribeEventTopics
  = DescribeEventTopics'{directoryId = Core.Nothing,
...
{-# INLINEABLE dTopicNames #-}
{-# DEPRECATED topicNames "Use generic-lens or generic-optics with 'topicNames' instead"  #-}
...
instance Core.AWSRequest DescribeEventTopics where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeEventTopicsResponse' Core.<$>
                   (x Core..:? "EventTopics") Core.<*> Core.pure (Core.fromEnum s))
...
mkDescribeEventTopicsResponse responseStatus
  = DescribeEventTopicsResponse'{eventTopics = Core.Nothing,
                                 responseStatus}
...
{-# INLINEABLE detrfrsEventTopics #-}
{-# DEPRECATED eventTopics "Use generic-lens or generic-optics with 'eventTopics' instead"  #-}
...
{-# INLINEABLE detrfrsResponseStatus #-}
