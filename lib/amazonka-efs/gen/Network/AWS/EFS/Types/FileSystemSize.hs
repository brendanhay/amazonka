...
mkFileSystemSize value
  = FileSystemSize'{value, timestamp = Core.Nothing,
                    valueInIA = Core.Nothing, valueInStandard = Core.Nothing}
...
{-# INLINEABLE fssValueInIA #-}
{-# DEPRECATED valueInIA "Use generic-lens or generic-optics with 'valueInIA' instead"  #-}
...
{-# INLINEABLE fssValueInStandard #-}
{-# DEPRECATED valueInStandard "Use generic-lens or generic-optics with 'valueInStandard' instead"  #-}
