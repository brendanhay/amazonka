...
mkEncryptionConfiguration
    :: Types.EncryptionOption -- ^ 'encryptionOption'
    -> EncryptionConfiguration
...
{-# INLINEABLE ecEncryptionOption #-}
{-# DEPRECATED encryptionOption "Use generic-lens or generic-optics with 'encryptionOption' instead"  #-}
...
ecKmsKey :: Lens.Lens' EncryptionConfiguration (Core.Maybe Core.Text)
          ...
          = Core.withObject "EncryptionConfiguration" Core.$
              \ x ->
                EncryptionConfiguration' Core.<$>
                  (x Core..: "EncryptionOption") Core.<*> x Core..:? "KmsKey"
