...
mkScheduleActivityTaskDecisionAttributes activityType activityId
  = ScheduleActivityTaskDecisionAttributes'{activityType, activityId,
                                            ...
                                            taskList = Core.Nothing, taskPriority = Core.Nothing}
...
{-# INLINEABLE satdaHeartbeatTimeout #-}
...
{-# INLINEABLE satdaScheduleToCloseTimeout #-}
...
{-# INLINEABLE satdaScheduleToStartTimeout #-}
...
{-# INLINEABLE satdaStartToCloseTimeout #-}
