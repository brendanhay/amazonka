...
mkImagePermissions
    :: ImagePermissions
mkImagePermissions
  = ImagePermissions'{allowFleet = Core.Nothing,
...
{-# INLINEABLE ipAllowFleet #-}
{-# DEPRECATED allowFleet "Use generic-lens or generic-optics with 'allowFleet' instead"  #-}
...
{-# INLINEABLE ipAllowImageBuilder #-}
{-# DEPRECATED allowImageBuilder "Use generic-lens or generic-optics with 'allowImageBuilder' instead"  #-}
...
instance Core.FromJSON ImagePermissions where
        parseJSON
          = Core.withObject "ImagePermissions" Core.$
              \ x ->
                ImagePermissions' Core.<$>
                  (x Core..:? "allowFleet") Core.<*> x Core..:? "allowImageBuilder"
