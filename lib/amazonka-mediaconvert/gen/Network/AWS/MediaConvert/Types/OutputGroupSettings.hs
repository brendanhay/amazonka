...
mkOutputGroupSettings
    :: OutputGroupSettings
mkOutputGroupSettings
  = OutputGroupSettings'{cmafGroupSettings = Core.Nothing,
                         dashIsoGroupSettings = Core.Nothing,
                         fileGroupSettings = Core.Nothing, hlsGroupSettings = Core.Nothing,
                         msSmoothGroupSettings = Core.Nothing, type' = Core.Nothing}
...
{-# INLINEABLE ogsCmafGroupSettings #-}
{-# DEPRECATED cmafGroupSettings "Use generic-lens or generic-optics with 'cmafGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsDashIsoGroupSettings #-}
{-# DEPRECATED dashIsoGroupSettings "Use generic-lens or generic-optics with 'dashIsoGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsFileGroupSettings #-}
{-# DEPRECATED fileGroupSettings "Use generic-lens or generic-optics with 'fileGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsHlsGroupSettings #-}
{-# DEPRECATED hlsGroupSettings "Use generic-lens or generic-optics with 'hlsGroupSettings' instead"  #-}
...
{-# INLINEABLE ogsMsSmoothGroupSettings #-}
{-# DEPRECATED msSmoothGroupSettings "Use generic-lens or generic-optics with 'msSmoothGroupSettings' instead"  #-}
          ...
          = Core.withObject "OutputGroupSettings" Core.$
              \ x ->
                OutputGroupSettings' Core.<$>
                  (x Core..:? "cmafGroupSettings") Core.<*>
                    x Core..:? "dashIsoGroupSettings"
