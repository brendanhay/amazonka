...
mkKinesisSettings
    :: KinesisSettings
mkKinesisSettings
  = KinesisSettings'{includeControlDetails = Core.Nothing,
                     ...
                     serviceAccessRoleArn = Core.Nothing, streamArn = Core.Nothing}
...
{-# INLINEABLE kIncludeControlDetails #-}
...
{-# INLINEABLE kIncludeNullAndEmpty #-}
...
{-# INLINEABLE kIncludePartitionValue #-}
...
{-# INLINEABLE kIncludeTableAlterOperations #-}
...
{-# INLINEABLE kIncludeTransactionDetails #-}
...
{-# INLINEABLE kPartitionIncludeSchemaTable #-}
...
kServiceAccessRoleArn :: Lens.Lens' KinesisSettings (Core.Maybe Core.Text)
kServiceAccessRoleArn = Lens.field @"serviceAccessRoleArn"
{-# INLINEABLE kServiceAccessRoleArn #-}
...
kStreamArn :: Lens.Lens' KinesisSettings (Core.Maybe Core.Text)
kStreamArn = Lens.field @"streamArn"
{-# INLINEABLE kStreamArn #-}
          ...
          = Core.withObject "KinesisSettings" Core.$
              \ x ->
                KinesisSettings' Core.<$>
                  (x Core..:? "IncludeControlDetails") Core.<*>
                    x Core..:? "IncludeNullAndEmpty"
