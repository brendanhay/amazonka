...
instance AWSRequest DescribeDominantLanguageDetectionJob where
  type
...
instance Hashable DescribeDominantLanguageDetectionJob

instance NFData DescribeDominantLanguageDetectionJob

instance ToHeaders DescribeDominantLanguageDetectionJob where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
...
data DescribeDominantLanguageDetectionJobResponse = DescribeDominantLanguageDetectionJobResponse'
  { _ddldjrsDominantLanguageDetectionJobProperties ::
      !( Maybe
...
instance NFData DescribeDominantLanguageDetectionJobResponse
