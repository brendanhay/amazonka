...
mkStreamDescription
    :: StreamDescription
mkStreamDescription
  = StreamDescription'{creationRequestDateTime = Core.Nothing,
                       keySchema = Core.Nothing, lastEvaluatedShardId = Core.Nothing,
                       shards = Core.Nothing, streamArn = Core.Nothing,
                       streamLabel = Core.Nothing, streamStatus = Core.Nothing,
                       streamViewType = Core.Nothing, tableName = Core.Nothing}
...
{-# INLINEABLE sdCreationRequestDateTime #-}
{-# DEPRECATED creationRequestDateTime "Use generic-lens or generic-optics with 'creationRequestDateTime' instead"  #-}
...
{-# INLINEABLE sdLastEvaluatedShardId #-}
{-# DEPRECATED lastEvaluatedShardId "Use generic-lens or generic-optics with 'lastEvaluatedShardId' instead"  #-}
...
sdStreamLabel :: Lens.Lens' StreamDescription (Core.Maybe Core.Text)
sdStreamLabel = Lens.field @"streamLabel"
{-# INLINEABLE sdStreamLabel #-}
          ...
          = Core.withObject "StreamDescription" Core.$
              \ x ->
                StreamDescription' Core.<$>
                  (x Core..:? "CreationRequestDateTime") Core.<*>
                    x Core..:? "KeySchema"
