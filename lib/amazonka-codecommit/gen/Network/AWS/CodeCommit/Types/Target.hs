...
mkTarget
    ...
    -> Types.ReferenceName -- ^ 'sourceReference'
    -> Target
mkTarget repositoryName sourceReference
  = Target'{repositoryName, sourceReference,
...
{-# INLINEABLE tDestinationReference #-}
