...
mkWorkflowExecutionInfos
    :: WorkflowExecutionInfos
mkWorkflowExecutionInfos
  = WorkflowExecutionInfos'{executionInfos = Core.mempty,
...
{-# INLINEABLE weiExecutionInfos #-}
{-# DEPRECATED executionInfos "Use generic-lens or generic-optics with 'executionInfos' instead"  #-}
...
instance Core.FromJSON WorkflowExecutionInfos where
        parseJSON
          = Core.withObject "WorkflowExecutionInfos" Core.$
              \ x ->
                WorkflowExecutionInfos' Core.<$>
                  (x Core..:? "executionInfos" Core..!= Core.mempty) Core.<*>
