...
newtype DeleteRelationalDatabaseSnapshot = DeleteRelationalDatabaseSnapshot'
  { _drdsRelationalDatabaseSnapshotName :: Text
...
deleteRelationalDatabaseSnapshot
    :: Text -- ^ 'drdsRelationalDatabaseSnapshotName'
    -> DeleteRelationalDatabaseSnapshot
deleteRelationalDatabaseSnapshot pRelationalDatabaseSnapshotName_ =
  DeleteRelationalDatabaseSnapshot'
    {_drdsRelationalDatabaseSnapshotName = pRelationalDatabaseSnapshotName_}
...
instance AWSRequest DeleteRelationalDatabaseSnapshot
         where
...
instance ToHeaders DeleteRelationalDatabaseSnapshot
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DeleteRelationalDatabaseSnapshot
         where
...
instance ToPath DeleteRelationalDatabaseSnapshot
         where
        toPath = const "/"

instance ToQuery DeleteRelationalDatabaseSnapshot
         where
...
data DeleteRelationalDatabaseSnapshotResponse = DeleteRelationalDatabaseSnapshotResponse'
  { _drdsrsOperations     :: !(Maybe [Operation])
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drdsrsOperations' - An object describing the result of your delete relational database snapshot request.
--
...
deleteRelationalDatabaseSnapshotResponse pResponseStatus_ =
  DeleteRelationalDatabaseSnapshotResponse'
    {_drdsrsOperations = Nothing, _drdsrsResponseStatus = pResponseStatus_}
