...
-- |
-- Module      : Network.AWS.Kendra.ListIndices
...
instance Core.AWSRequest ListIndices where
  ...
  response =
    Response.receiveJSON
      ( \s h x ->
          ListIndicesResponse'
            Prelude.<$> ( x Core..?> "IndexConfigurationSummaryItems"
                            Core..!@ Prelude.mempty
                        )
...
instance Core.ToHeaders ListIndices where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Core.=# ( "AWSKendraFrontendService.ListIndices" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
instance Core.ToJSON ListIndices where
  toJSON ListIndices' {..} =
    Core.object
      ( Prelude.catMaybes
...
-- for backwards compatibility:
--
-- 'indexConfigurationSummaryItems', 'listIndicesResponse_indexConfigurationSummaryItems' - An array of summary information for one or more indexes.
--
