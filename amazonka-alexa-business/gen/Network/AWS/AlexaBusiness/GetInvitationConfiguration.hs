...
data GetInvitationConfiguration =
  GetInvitationConfiguration'
...
instance AWSRequest GetInvitationConfiguration where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 GetInvitationConfigurationResponse' <$>
                   (x .?> "ContactEmail") <*> (x .?> "OrganizationName")
                     <*> (x .?> "PrivateSkillIds" .!@ mempty)
                     <*> (pure (fromEnum s)))

instance Hashable GetInvitationConfiguration where

instance NFData GetInvitationConfiguration where
...
data GetInvitationConfigurationResponse = GetInvitationConfigurationResponse'
  { _gicrsContactEmail     :: !(Maybe Text)
  , _gicrsOrganizationName :: !(Maybe Text)
  , _gicrsPrivateSkillIds  :: !(Maybe [Text])
