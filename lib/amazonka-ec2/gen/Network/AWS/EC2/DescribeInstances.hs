...
difDryRun :: Lens.Lens' DescribeInstances (Core.Maybe Core.Bool)
difDryRun = Lens.field @"dryRun"
...
difFilters :: Lens.Lens' DescribeInstances (Core.Maybe [Types.Filter])
difFilters = Lens.field @"filters"
{-# DEPRECATED difFilters "Use generic-lens or generic-optics with 'filters' instead." #-}
...
difInstanceIds :: Lens.Lens' DescribeInstances (Core.Maybe [Types.InstanceId])
difInstanceIds = Lens.field @"instanceIds"
{-# DEPRECATED difInstanceIds "Use generic-lens or generic-optics with 'instanceIds' instead." #-}

-- | The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned @NextToken@ value. This value can be between 5 and 1000. You cannot specify this parameter and the instance IDs parameter in the same call.
--
-- /Note:/ Consider using 'maxResults' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
difMaxResults :: Lens.Lens' DescribeInstances (Core.Maybe Core.Int)
difMaxResults = Lens.field @"maxResults"
{-# DEPRECATED difMaxResults "Use generic-lens or generic-optics with 'maxResults' instead." #-}

-- | The token to request the next page of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
difNextToken :: Lens.Lens' DescribeInstances (Core.Maybe Types.String)
difNextToken = Lens.field @"nextToken"
{-# DEPRECATED difNextToken "Use generic-lens or generic-optics with 'nextToken' instead." #-}
  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqBody =
          Core.toFormBody
            ( Core.pure ("Action", "DescribeInstances")
    ...
    Response.receiveXML
      ( \s h x ->
          DescribeInstancesResponse'
            ...
            Core.<*> (x Core..@? "reservationSet" Core..<@> Core.parseXMLList "item")
...
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dirrsNextToken :: Lens.Lens' DescribeInstancesResponse (Core.Maybe Types.String)
...
dirrsReservations :: Lens.Lens' DescribeInstancesResponse (Core.Maybe [Types.Reservation])
dirrsReservations = Lens.field @"reservations"
{-# DEPRECATED dirrsReservations "Use generic-lens or generic-optics with 'reservations' instead." #-}
