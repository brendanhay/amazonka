...
mkUpdateDomainConfiguration domainConfigurationName
  = UpdateDomainConfiguration'{domainConfigurationName,
...
{-# INLINEABLE udcDomainConfigurationName #-}
...
{-# INLINEABLE udcAuthorizerConfig #-}
...
{-# INLINEABLE udcDomainConfigurationStatus #-}
...
{-# INLINEABLE udcRemoveAuthorizerConfig #-}
{-# DEPRECATED removeAuthorizerConfig "Use generic-lens or generic-optics with 'removeAuthorizerConfig' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("authorizerConfig" Core..=) Core.<$> authorizerConfig,
                  ("domainConfigurationStatus" Core..=) Core.<$>
                    domainConfigurationStatus,
                  ("removeAuthorizerConfig" Core..=) Core.<$>
                    removeAuthorizerConfig])

instance Core.AWSRequest UpdateDomainConfiguration where
        type Rs UpdateDomainConfiguration =
             UpdateDomainConfigurationResponse
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateDomainConfigurationResponse' Core.<$>
...
{-# INLINEABLE udcrrsDomainConfigurationArn #-}
...
{-# INLINEABLE udcrrsDomainConfigurationName #-}
{-# DEPRECATED domainConfigurationName "Use generic-lens or generic-optics with 'domainConfigurationName' instead"  #-}
