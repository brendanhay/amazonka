...
mkAvailSettings
    :: AvailSettings
mkAvailSettings
  = AvailSettings'{scte35SpliceInsert = Core.Nothing,
...
{-# INLINEABLE asScte35SpliceInsert #-}
{-# DEPRECATED scte35SpliceInsert "Use generic-lens or generic-optics with 'scte35SpliceInsert' instead"  #-}
...
{-# INLINEABLE asScte35TimeSignalApos #-}
{-# DEPRECATED scte35TimeSignalApos "Use generic-lens or generic-optics with 'scte35TimeSignalApos' instead"  #-}
...
instance Core.FromJSON AvailSettings where
        parseJSON
          = Core.withObject "AvailSettings" Core.$
              \ x ->
                AvailSettings' Core.<$>
                  (x Core..:? "scte35SpliceInsert") Core.<*>
                    x Core..:? "scte35TimeSignalApos"
