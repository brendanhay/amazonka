...
instance Core.ToXML ResourceRecordSet where
  toXML ResourceRecordSet {..} =
    Core.toXMLNode "Name" name Core.<> Core.toXMLNode "Type" type'
      Core.<> Core.toXMLNode "AliasTarget" Core.<$> aliasTarget
      Core.<> Core.toXMLNode "Failover" Core.<$> failover
      Core.<> Core.toXMLNode "GeoLocation" Core.<$> geoLocation
      Core.<> Core.toXMLNode "HealthCheckId" Core.<$> healthCheckId
      Core.<> Core.toXMLNode "MultiValueAnswer" Core.<$> multiValueAnswer
      Core.<> Core.toXMLNode "Region" Core.<$> region
      Core.<> Core.toXMLNode
        "ResourceRecords"
        (Core.toXMLList "ResourceRecord" Core.<$> resourceRecords)
      Core.<> Core.toXMLNode "SetIdentifier" Core.<$> setIdentifier
      Core.<> Core.toXMLNode "TTL" Core.<$> ttl
      Core.<> Core.toXMLNode "TrafficPolicyInstanceId"
        Core.<$> trafficPolicyInstanceId
      Core.<> Core.toXMLNode "Weight" Core.<$> weight
...
instance Core.FromXML ResourceRecordSet where
  parseXML x =
    ResourceRecordSet'
      ...
      Core.<*> (x Core..@? "Region")
      Core.<*> ( x Core..@? "ResourceRecords"
                   Core..<@> Core.parseXMLNonEmpty "ResourceRecord"
               )
