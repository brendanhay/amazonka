...
mkDescribeWorkspaceImagePermissions imageId
  = DescribeWorkspaceImagePermissions'{imageId,
...
{-# INLINEABLE dwipNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery DescribeWorkspaceImagePermissions where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeWorkspaceImagePermissions where
        toHeaders DescribeWorkspaceImagePermissions{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeWorkspaceImagePermissions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeWorkspaceImagePermissionsResponse' Core.<$>
                   (x Core..:? "ImageId") Core.<*> x Core..:? "ImagePermissions"
...
mkDescribeWorkspaceImagePermissionsResponse responseStatus
  = DescribeWorkspaceImagePermissionsResponse'{imageId =
                                                 Core.Nothing,
...
{-# INLINEABLE dwiprrsImagePermissions #-}
...
{-# INLINEABLE dwiprrsResponseStatus #-}
