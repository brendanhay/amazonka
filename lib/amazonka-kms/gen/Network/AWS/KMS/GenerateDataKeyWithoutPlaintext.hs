...
mkGenerateDataKeyWithoutPlaintext keyId
  = GenerateDataKeyWithoutPlaintext'{keyId,
                                     encryptionContext = Core.Nothing, grantTokens = Core.Nothing,
                                     keySpec = Core.Nothing, numberOfBytes = Core.Nothing}
...
{-# INLINEABLE gdkwpEncryptionContext #-}
...
instance Core.ToHeaders GenerateDataKeyWithoutPlaintext where
...
instance Core.AWSRequest GenerateDataKeyWithoutPlaintext where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GenerateDataKeyWithoutPlaintextResponse' Core.<$>
...
{-# INLINEABLE gdkwprrsCiphertextBlob #-}
...
{-# INLINEABLE gdkwprrsResponseStatus #-}
