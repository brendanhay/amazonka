...
data VpcPeeringConnection = VpcPeeringConnection'
  { -- | The status information about the connection. Status indicates if a
    ...
    status :: Core.Maybe VpcPeeringConnectionStatus,
    ...
    -- created.
    ipV4CidrBlock :: Core.Maybe Core.Text,
    ...
    gameLiftVpcId :: Core.Maybe Core.Text,
...
newVpcPeeringConnection =
  VpcPeeringConnection'
    { status = Core.Nothing,
      ...
      ipV4CidrBlock = Core.Nothing,
      fleetArn = Core.Nothing,
      fleetId = Core.Nothing,
      gameLiftVpcId = Core.Nothing,
      peerVpcId = Core.Nothing
    }

-- | The status information about the connection. Status indicates if a
-- connection is pending, successful, or failed.
vpcPeeringConnection_status :: Lens.Lens' VpcPeeringConnection (Core.Maybe VpcPeeringConnectionStatus)
...
-- with it; these blocks cannot overlap or the peering connection cannot be
-- created.
vpcPeeringConnection_ipV4CidrBlock :: Lens.Lens' VpcPeeringConnection (Core.Maybe Core.Text)
...
-- (<https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html ARN>)
-- associated with the GameLift fleet resource for this connection.
vpcPeeringConnection_fleetArn :: Lens.Lens' VpcPeeringConnection (Core.Maybe Core.Text)
...
-- | A unique identifier for a fleet. This ID determines the ID of the Amazon
-- GameLift VPC for your fleet.
vpcPeeringConnection_fleetId :: Lens.Lens' VpcPeeringConnection (Core.Maybe Core.Text)
...
-- for this connection. This VPC is managed by Amazon GameLift and does not
-- appear in your AWS account.
vpcPeeringConnection_gameLiftVpcId :: Lens.Lens' VpcPeeringConnection (Core.Maybe Core.Text)
...
-- Management Console. Learn more about VPC peering in
-- <https://docs.aws.amazon.com/gamelift/latest/developerguide/vpc-peering.html VPC Peering with Amazon GameLift Fleets>.
vpcPeeringConnection_peerVpcId :: Lens.Lens' VpcPeeringConnection (Core.Maybe Core.Text)
