...
mkSMSChannelResponse platform
  = SMSChannelResponse'{platform, applicationId = Core.Nothing,
...
{-# INLINEABLE smscrLastModifiedBy #-}
...
{-# INLINEABLE smscrLastModifiedDate #-}
...
{-# INLINEABLE smscrPromotionalMessagesPerSecond #-}
{-# DEPRECATED promotionalMessagesPerSecond "Use generic-lens or generic-optics with 'promotionalMessagesPerSecond' instead"  #-}
...
{-# INLINEABLE smscrTransactionalMessagesPerSecond #-}
{-# DEPRECATED transactionalMessagesPerSecond "Use generic-lens or generic-optics with 'transactionalMessagesPerSecond' instead"  #-}
