...
pattern ParticipantTimerType_DISCONNECT_NONCUSTOMER = ParticipantTimerType' "DISCONNECT_NONCUSTOMER"

pattern ParticipantTimerType_IDLE :: ParticipantTimerType
pattern ParticipantTimerType_IDLE = ParticipantTimerType' "IDLE"
