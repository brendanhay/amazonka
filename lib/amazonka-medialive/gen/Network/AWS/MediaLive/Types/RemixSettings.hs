...
mkRemixSettings
    :: RemixSettings
mkRemixSettings
  = RemixSettings'{channelMappings = Core.mempty,
                   channelsIn = Core.Nothing, channelsOut = Core.Nothing}
...
{-# INLINEABLE rsChannelMappings #-}
{-# DEPRECATED channelMappings "Use generic-lens or generic-optics with 'channelMappings' instead"  #-}
...
{-# INLINEABLE rsChannelsIn #-}
{-# DEPRECATED channelsIn "Use generic-lens or generic-optics with 'channelsIn' instead"  #-}
...
{-# INLINEABLE rsChannelsOut #-}
{-# DEPRECATED channelsOut "Use generic-lens or generic-optics with 'channelsOut' instead"  #-}
...
instance Core.FromJSON RemixSettings where
        parseJSON
          = Core.withObject "RemixSettings" Core.$
              \ x ->
                RemixSettings' Core.<$>
                  (x Core..:? "channelMappings" Core..!= Core.mempty) Core.<*>
                    x Core..:? "channelsIn"
