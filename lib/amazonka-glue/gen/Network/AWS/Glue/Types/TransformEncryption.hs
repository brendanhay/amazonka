...
mkTransformEncryption
    :: TransformEncryption
mkTransformEncryption
  = TransformEncryption'{mlUserDataEncryption = Core.Nothing,
...
{-# INLINEABLE teMlUserDataEncryption #-}
{-# DEPRECATED mlUserDataEncryption "Use generic-lens or generic-optics with 'mlUserDataEncryption' instead"  #-}
...
{-# INLINEABLE teTaskRunSecurityConfigurationName #-}
{-# DEPRECATED taskRunSecurityConfigurationName "Use generic-lens or generic-optics with 'taskRunSecurityConfigurationName' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("MlUserDataEncryption" Core..=) Core.<$> mlUserDataEncryption,
                  ("TaskRunSecurityConfigurationName" Core..=) Core.<$>
          ...
          = Core.withObject "TransformEncryption" Core.$
              \ x ->
                TransformEncryption' Core.<$>
                  (x Core..:? "MlUserDataEncryption") Core.<*>
                    x Core..:? "TaskRunSecurityConfigurationName"
