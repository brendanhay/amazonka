...
mkUserProfile
    :: UserProfile
mkUserProfile
  = UserProfile'{allowSelfManagement = Core.Nothing,
                 iamUserArn = Core.Nothing, name = Core.Nothing,
...
{-# INLINEABLE upAllowSelfManagement #-}
...
upSshPublicKey :: Lens.Lens' UserProfile (Core.Maybe Core.Text)
upSshPublicKey = Lens.field @"sshPublicKey"
{-# INLINEABLE upSshPublicKey #-}
...
upSshUsername :: Lens.Lens' UserProfile (Core.Maybe Core.Text)
upSshUsername = Lens.field @"sshUsername"
{-# INLINEABLE upSshUsername #-}
...
instance Core.FromJSON UserProfile where
        parseJSON
          = Core.withObject "UserProfile" Core.$
              \ x ->
                UserProfile' Core.<$>
                  (x Core..:? "AllowSelfManagement") Core.<*> x Core..:? "IamUserArn"
                    Core.<*> x Core..:? "Name"
