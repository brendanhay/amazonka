...
_CannotDeleteException =
  Core._MatchServiceError mkServiceConfig "CannotDelete"
    Core.. Core.hasStatues 400
...
_RuleDoesNotExistException =
  Core._MatchServiceError mkServiceConfig "RuleDoesNotExist"
    Core.. Core.hasStatues 400
...
_MessageRejected =
  Core._MatchServiceError mkServiceConfig "MessageRejected"
    Core.. Core.hasStatues 400
...
_InvalidTemplateException =
  Core._MatchServiceError mkServiceConfig "InvalidTemplate"
    Core.. Core.hasStatues 400
...
_InvalidPolicyException =
  Core._MatchServiceError mkServiceConfig "InvalidPolicy"
    Core.. Core.hasStatues 400
...
_InvalidSnsTopicException =
  Core._MatchServiceError mkServiceConfig "InvalidSnsTopic"
    Core.. Core.hasStatues 400
