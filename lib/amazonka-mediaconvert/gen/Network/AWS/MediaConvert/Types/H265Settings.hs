...
{-# DEPRECATED hAlternateTransferFunctionSei "Use generic-lens or generic-optics with 'alternateTransferFunctionSei' instead." #-}
...
{-# DEPRECATED hSampleAdaptiveOffsetFilterMode "Use generic-lens or generic-optics with 'sampleAdaptiveOffsetFilterMode' instead." #-}
...
{-# DEPRECATED hTemporalIds "Use generic-lens or generic-optics with 'temporalIds' instead." #-}
...
{-# DEPRECATED hTiles "Use generic-lens or generic-optics with 'tiles' instead." #-}
...
{-# DEPRECATED hWriteMp4PackagingType "Use generic-lens or generic-optics with 'writeMp4PackagingType' instead." #-}
