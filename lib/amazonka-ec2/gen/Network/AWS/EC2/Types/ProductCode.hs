...
mkProductCode
    :: ProductCode
mkProductCode
  = ProductCode'{productCodeId = Core.Nothing,
...
pcProductCodeId :: Lens.Lens' ProductCode (Core.Maybe Core.Text)
pcProductCodeId = Lens.field @"productCodeId"
{-# INLINEABLE pcProductCodeId #-}
{-# DEPRECATED productCodeId "Use generic-lens or generic-optics with 'productCodeId' instead"  #-}
...
{-# INLINEABLE pcProductCodeType #-}
{-# DEPRECATED productCodeType "Use generic-lens or generic-optics with 'productCodeType' instead"  #-}

instance Core.FromXML ProductCode where
        parseXML x
          = ProductCode' Core.<$>
              (x Core..@? "productCode") Core.<*> x Core..@? "type"
