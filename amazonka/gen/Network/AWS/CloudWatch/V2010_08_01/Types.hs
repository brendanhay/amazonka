...
instance ServiceError (Er CloudWatch) where
...
instance ToByteString ComparisonOperator where
    toBS ComparisonOperatorGreaterThanOrEqualToThreshold = "GreaterThanOrEqualToThreshold"
    toBS ComparisonOperatorGreaterThanThreshold = "GreaterThanThreshold"
    toBS ComparisonOperatorLessThanOrEqualToThreshold = "LessThanOrEqualToThreshold"
    toBS ComparisonOperatorLessThanThreshold = "LessThanThreshold"
...
instance ToByteString HistoryItemType where
    toBS HistoryItemTypeAction = "Action"
    toBS HistoryItemTypeConfigurationUpdate = "ConfigurationUpdate"
    toBS HistoryItemTypeStateUpdate = "StateUpdate"
...
instance ToByteString StandardUnit where
    toBS StandardUnitBits = "Bits"
    toBS StandardUnitBitsSecond = "Bits/Second"
    toBS StandardUnitBytes = "Bytes"
    toBS StandardUnitBytesSecond = "Bytes/Second"
    toBS StandardUnitCount = "Count"
    toBS StandardUnitCountSecond = "Count/Second"
    toBS StandardUnitGigabits = "Gigabits"
    toBS StandardUnitGigabitsSecond = "Gigabits/Second"
    toBS StandardUnitGigabytes = "Gigabytes"
    toBS StandardUnitGigabytesSecond = "Gigabytes/Second"
    toBS StandardUnitKilobits = "Kilobits"
    toBS StandardUnitKilobitsSecond = "Kilobits/Second"
    toBS StandardUnitKilobytes = "Kilobytes"
    toBS StandardUnitKilobytesSecond = "Kilobytes/Second"
    toBS StandardUnitMegabits = "Megabits"
    toBS StandardUnitMegabitsSecond = "Megabits/Second"
    toBS StandardUnitMegabytes = "Megabytes"
    toBS StandardUnitMegabytesSecond = "Megabytes/Second"
    toBS StandardUnitMicroseconds = "Microseconds"
    toBS StandardUnitMilliseconds = "Milliseconds"
    toBS StandardUnitNone = "None"
    toBS StandardUnitPercent = "Percent"
    toBS StandardUnitSeconds = "Seconds"
    toBS StandardUnitTerabits = "Terabits"
    toBS StandardUnitTerabitsSecond = "Terabits/Second"
    toBS StandardUnitTerabytes = "Terabytes"
    toBS StandardUnitTerabytesSecond = "Terabytes/Second"
...
instance ToByteString StateValue where
    toBS StateValueAlarm = "ALARM"
    toBS StateValueInsufficientData = "INSUFFICIENT_DATA"
    toBS StateValueOk = "OK"
...
instance ToByteString Statistic where
    toBS StatisticAverage = "Average"
    toBS StatisticMaximum = "Maximum"
    toBS StatisticMinimum = "Minimum"
    toBS StatisticSampleCount = "SampleCount"
    toBS StatisticSum = "Sum"
