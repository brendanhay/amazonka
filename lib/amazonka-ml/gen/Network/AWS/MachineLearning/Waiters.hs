...
mkBatchPredictionAvailable
  = Waiter.Wait{Waiter._waitName = "BatchPredictionAvailable",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 30,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "COMPLETED" Waiter.AcceptSuccess
                     (Lens.folding
...
mkDataSourceAvailable
  = Waiter.Wait{Waiter._waitName = "DataSourceAvailable",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 30,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "COMPLETED" Waiter.AcceptSuccess
                     (Lens.folding
...
mkEvaluationAvailable
  = Waiter.Wait{Waiter._waitName = "EvaluationAvailable",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 30,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "COMPLETED" Waiter.AcceptSuccess
                     (Lens.folding
