...
{-# DEPRECATED ctsResources "Use generic-lens or generic-optics with 'resources' instead." #-}
...
{-# DEPRECATED ctsDryRun "Use generic-lens or generic-optics with 'dryRun' instead." #-}
