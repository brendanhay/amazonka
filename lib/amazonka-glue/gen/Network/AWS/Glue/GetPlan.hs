...
data GetPlan = GetPlan'
  { -- | The target tables.
    ...
    additionalPlanOptionsMap :: Lude.Maybe (Lude.HashMap Lude.Text (Lude.Text))
  }
...
gpfrsPythonScript :: Lens.Lens' GetPlanResponse (Lude.Maybe Lude.Text)
gpfrsPythonScript = Lens.lens (pythonScript :: GetPlanResponse -> Lude.Maybe Lude.Text) (\s a -> s {pythonScript = a} :: GetPlanResponse)
{-# DEPRECATED gpfrsPythonScript "Use generic-lens or generic-optics with 'pythonScript' instead." #-}
...
gpfrsScalaCode :: Lens.Lens' GetPlanResponse (Lude.Maybe Lude.Text)
gpfrsScalaCode = Lens.lens (scalaCode :: GetPlanResponse -> Lude.Maybe Lude.Text) (\s a -> s {scalaCode = a} :: GetPlanResponse)
{-# DEPRECATED gpfrsScalaCode "Use generic-lens or generic-optics with 'scalaCode' instead." #-}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
gpfrsResponseStatus :: Lens.Lens' GetPlanResponse Lude.Int
gpfrsResponseStatus = Lens.lens (responseStatus :: GetPlanResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: GetPlanResponse)
