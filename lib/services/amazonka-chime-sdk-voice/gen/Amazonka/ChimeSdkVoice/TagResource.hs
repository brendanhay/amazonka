...
-- |
-- Module      : Amazonka.ChimeSdkVoice.TagResource
...
--
-- 'resourceARN', 'tagResource_resourceARN' - The ARN of the resource being tagged.
--
-- 'tags', 'tagResource_tags' - A list of the tags being added to the resource.
newTagResource ::
  -- | 'resourceARN'
  Prelude.Text ->
  -- | 'tags'
