...
mkKGKeyPairIds
    :: KGKeyPairIds
mkKGKeyPairIds
  = KGKeyPairIds'{keyGroupId = Core.Nothing,
...
kgkpiKeyGroupId :: Lens.Lens' KGKeyPairIds (Core.Maybe Core.Text)
kgkpiKeyGroupId = Lens.field @"keyGroupId"
{-# INLINEABLE kgkpiKeyGroupId #-}
