...
mkNotebookInstanceDeleted
  = Waiter.Wait{Waiter._waitName = "NotebookInstanceDeleted",
...
mkEndpointInService
  = Waiter.Wait{Waiter._waitName = "EndpointInService",
...
mkTransformJobCompletedOrStopped
  = Waiter.Wait{Waiter._waitName = "TransformJobCompletedOrStopped",
...
mkNotebookInstanceInService
  = Waiter.Wait{Waiter._waitName = "NotebookInstanceInService",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 30,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "InService" Waiter.AcceptSuccess
                     (Lens.field @"notebookInstanceStatus"),
...
mkProcessingJobCompletedOrStopped
  = Waiter.Wait{Waiter._waitName = "ProcessingJobCompletedOrStopped",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 60,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "Completed" Waiter.AcceptSuccess
...
mkTrainingJobCompletedOrStopped
  = Waiter.Wait{Waiter._waitName = "TrainingJobCompletedOrStopped",
                Waiter._waitAttempts = 180, Waiter._waitDelay = 120,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "Completed" Waiter.AcceptSuccess
...
mkNotebookInstanceStopped
  = Waiter.Wait{Waiter._waitName = "NotebookInstanceStopped",
                Waiter._waitAttempts = 60, Waiter._waitDelay = 30,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "Stopped" Waiter.AcceptSuccess
                     (Lens.field @"notebookInstanceStatus"),
