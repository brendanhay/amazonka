...
mkUpdateTrafficPolicyInstance
    ...
    -> UpdateTrafficPolicyInstance
mkUpdateTrafficPolicyInstance id ttl trafficPolicyId
  trafficPolicyVersion
  = UpdateTrafficPolicyInstance'{id, ttl, trafficPolicyId,
                                 trafficPolicyVersion}
...
{-# INLINEABLE utpiTrafficPolicyId #-}
...
{-# INLINEABLE utpiTrafficPolicyVersion #-}
...
instance Core.ToXML UpdateTrafficPolicyInstance where
        toXML UpdateTrafficPolicyInstance{..}
          = Core.toXMLElement "TTL" ttl Core.<>
              Core.toXMLElement "TrafficPolicyId" trafficPolicyId
              Core.<>
...
instance Core.AWSRequest UpdateTrafficPolicyInstance where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 UpdateTrafficPolicyInstanceResponse' Core.<$>
...
mkUpdateTrafficPolicyInstanceResponse
    ...
    -> UpdateTrafficPolicyInstanceResponse
mkUpdateTrafficPolicyInstanceResponse trafficPolicyInstance
  responseStatus
...
{-# INLINEABLE utpirrsTrafficPolicyInstance #-}
...
{-# INLINEABLE utpirrsResponseStatus #-}
