...
mkCustomKeyStoresListEntry
    :: CustomKeyStoresListEntry
mkCustomKeyStoresListEntry
  = CustomKeyStoresListEntry'{cloudHsmClusterId = Core.Nothing,
                              connectionErrorCode = Core.Nothing, connectionState = Core.Nothing,
...
{-# INLINEABLE cksleCloudHsmClusterId #-}
...
{-# INLINEABLE cksleConnectionErrorCode #-}
{-# DEPRECATED connectionErrorCode "Use generic-lens or generic-optics with 'connectionErrorCode' instead"  #-}
...
{-# INLINEABLE cksleConnectionState #-}
...
{-# INLINEABLE cksleCustomKeyStoreId #-}
...
{-# INLINEABLE cksleCustomKeyStoreName #-}
...
{-# INLINEABLE cksleTrustAnchorCertificate #-}
...
instance Core.FromJSON CustomKeyStoresListEntry where
        parseJSON
          = Core.withObject "CustomKeyStoresListEntry" Core.$
              \ x ->
                CustomKeyStoresListEntry' Core.<$>
                  (x Core..:? "CloudHsmClusterId") Core.<*>
                    x Core..:? "ConnectionErrorCode"
