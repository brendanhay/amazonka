...
mkListPoliciesGrantingServiceAccessEntry
    :: ListPoliciesGrantingServiceAccessEntry
mkListPoliciesGrantingServiceAccessEntry
  = ListPoliciesGrantingServiceAccessEntry'{policies = Core.Nothing,
...
{-# INLINEABLE lpgsaeServiceNamespace #-}
...
instance Core.FromXML ListPoliciesGrantingServiceAccessEntry where
        parseXML x
          = ListPoliciesGrantingServiceAccessEntry' Core.<$>
