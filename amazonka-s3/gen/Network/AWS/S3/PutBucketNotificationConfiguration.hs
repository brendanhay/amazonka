...
--
-- * 'pbncNotificationConfiguration'
data PutBucketNotificationConfiguration = PutBucketNotificationConfiguration'{_pbncBucket :: BucketName, _pbncNotificationConfiguration :: NotificationConfiguration} deriving (Eq, Read, Show)
...
putBucketNotificationConfiguration pBucket pNotificationConfiguration = PutBucketNotificationConfiguration'{_pbncBucket = pBucket, _pbncNotificationConfiguration = pNotificationConfiguration};
