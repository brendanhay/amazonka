...
createCloudFormationStack
    :: CreateCloudFormationStack
createCloudFormationStack = CreateCloudFormationStack' {_ccfsInstances = mempty}
...
instance Hashable CreateCloudFormationStack where

instance NFData CreateCloudFormationStack where
...
data CreateCloudFormationStackResponse = CreateCloudFormationStackResponse'
  { _ccfsrsOperations     :: !(Maybe [Operation])
  , _ccfsrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccfsrsOperations' - A list of objects describing the API operation.
--
-- * 'ccfsrsResponseStatus' - -- | The response status code.
createCloudFormationStackResponse
    :: Int -- ^ 'ccfsrsResponseStatus'
    -> CreateCloudFormationStackResponse
createCloudFormationStackResponse pResponseStatus_ =
  CreateCloudFormationStackResponse'
    {_ccfsrsOperations = Nothing, _ccfsrsResponseStatus = pResponseStatus_}
