...
-- |
-- Module      : Network.AWS.VoiceId.Types.ExistingEnrollmentAction
...
pattern ExistingEnrollmentAction_OVERWRITE = ExistingEnrollmentAction' "OVERWRITE"

pattern ExistingEnrollmentAction_SKIP :: ExistingEnrollmentAction
pattern ExistingEnrollmentAction_SKIP = ExistingEnrollmentAction' "SKIP"
