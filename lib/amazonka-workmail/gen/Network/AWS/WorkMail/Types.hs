...
import Network.AWS.WorkMail.Types.ErrorMessage
...
import Network.AWS.WorkMail.Types.State
import Network.AWS.WorkMail.Types.String
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "WorkMail",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "workmail",
      Core._svcVersion = "2017-10-01",
