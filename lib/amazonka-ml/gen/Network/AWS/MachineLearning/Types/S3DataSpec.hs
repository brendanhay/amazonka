...
mkS3DataSpec
    :: Types.DataLocationS3 -- ^ 'dataLocationS3'
    -> S3DataSpec
mkS3DataSpec dataLocationS3
  = S3DataSpec'{dataLocationS3, dataRearrangement = Core.Nothing,
                dataSchema = Core.Nothing, dataSchemaLocationS3 = Core.Nothing}
...
{-# INLINEABLE sdsDataRearrangement #-}
...
{-# INLINEABLE sdsDataSchemaLocationS3 #-}
{-# DEPRECATED dataSchemaLocationS3 "Use generic-lens or generic-optics with 'dataSchemaLocationS3' instead"  #-}
