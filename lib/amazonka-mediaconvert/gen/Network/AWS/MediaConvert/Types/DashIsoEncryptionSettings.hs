...
{-# INLINEABLE diesPlaybackDeviceCompatibility #-}
{-# DEPRECATED playbackDeviceCompatibility "Use generic-lens or generic-optics with 'playbackDeviceCompatibility' instead"  #-}
...
{-# INLINEABLE diesSpekeKeyProvider #-}
...
instance Core.FromJSON DashIsoEncryptionSettings where
        toJSON DashIsoEncryptionSettings{..}
          = Core.object
              (Core.catMaybes
                 [("playbackDeviceCompatibility" Core..=) Core.<$>
...
instance Core.FromJSON DashIsoEncryptionSettings where
        parseJSON
          = Core.withObject "DashIsoEncryptionSettings" Core.$
              \ x ->
                DashIsoEncryptionSettings' Core.<$>
                  (x Core..:? "playbackDeviceCompatibility") Core.<*>
