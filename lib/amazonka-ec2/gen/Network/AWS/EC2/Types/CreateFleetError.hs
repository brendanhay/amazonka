...
mkCreateFleetError
    :: CreateFleetError
mkCreateFleetError
  = CreateFleetError'{errorCode = Core.Nothing,
...
{-# INLINEABLE cfeLaunchTemplateAndOverrides #-}
