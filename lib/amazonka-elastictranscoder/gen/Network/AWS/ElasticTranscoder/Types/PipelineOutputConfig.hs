...
mkPipelineOutputConfig
    :: PipelineOutputConfig
mkPipelineOutputConfig
  = PipelineOutputConfig'{bucket = Core.Nothing,
                          permissions = Core.Nothing, storageClass = Core.Nothing}
...
instance Core.FromJSON PipelineOutputConfig where
        parseJSON
          = Core.withObject "PipelineOutputConfig" Core.$
              \ x ->
                PipelineOutputConfig' Core.<$>
                  (x Core..:? "Bucket") Core.<*> x Core..:? "Permissions" Core.<*>
                    x Core..:? "StorageClass"
