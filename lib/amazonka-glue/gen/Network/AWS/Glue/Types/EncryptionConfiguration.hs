...
mkEncryptionConfiguration
    :: EncryptionConfiguration
mkEncryptionConfiguration
  = EncryptionConfiguration'{cloudWatchEncryption = Core.Nothing,
                             jobBookmarksEncryption = Core.Nothing, s3Encryption = Core.Nothing}
...
{-# INLINEABLE ecCloudWatchEncryption #-}
{-# DEPRECATED cloudWatchEncryption "Use generic-lens or generic-optics with 'cloudWatchEncryption' instead"  #-}
...
{-# INLINEABLE ecJobBookmarksEncryption #-}
{-# DEPRECATED jobBookmarksEncryption "Use generic-lens or generic-optics with 'jobBookmarksEncryption' instead"  #-}
...
{-# INLINEABLE ecS3Encryption #-}
{-# DEPRECATED s3Encryption "Use generic-lens or generic-optics with 's3Encryption' instead"  #-}
          ...
          = Core.withObject "EncryptionConfiguration" Core.$
              \ x ->
                EncryptionConfiguration' Core.<$>
                  (x Core..:? "CloudWatchEncryption") Core.<*>
                    x Core..:? "JobBookmarksEncryption"
