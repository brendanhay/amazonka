...
instance Prelude.AWSRequest DescribeMountTargets where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          DescribeMountTargetsResponse'
            ...
            Prelude.<*> ( x Prelude..?> "MountTargets"
...
instance Prelude.ToHeaders DescribeMountTargets where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath DescribeMountTargets where
  toPath = Prelude.const "/2015-02-01/mount-targets"

instance Prelude.ToQuery DescribeMountTargets where
  toQuery DescribeMountTargets' {..} =
    Prelude.mconcat
      [ "MountTargetId" Prelude.=: mountTargetId,
...
describeMountTargetsResponse_mountTargets = Lens.lens (\DescribeMountTargetsResponse' {mountTargets} -> mountTargets) (\s@DescribeMountTargetsResponse' {} a -> s {mountTargets = a} :: DescribeMountTargetsResponse) Prelude.. Lens.mapping Prelude._Coerce
