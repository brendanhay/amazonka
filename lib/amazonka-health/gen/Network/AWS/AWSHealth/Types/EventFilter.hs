...
mkEventFilter
    :: EventFilter
mkEventFilter
  = EventFilter'{availabilityZones = Core.Nothing,
                 endTimes = Core.Nothing, entityArns = Core.Nothing,
                 entityValues = Core.Nothing, eventArns = Core.Nothing,
                 eventStatusCodes = Core.Nothing,
                 eventTypeCategories = Core.Nothing, eventTypeCodes = Core.Nothing,
                 lastUpdatedTimes = Core.Nothing, regions = Core.Nothing,
                 services = Core.Nothing, startTimes = Core.Nothing,
                 tags = Core.Nothing}
...
{-# INLINEABLE eEndTimes #-}
{-# DEPRECATED endTimes "Use generic-lens or generic-optics with 'endTimes' instead"  #-}
...
{-# INLINEABLE eEventTypeCategories #-}
...
{-# INLINEABLE eStartTimes #-}
{-# DEPRECATED startTimes "Use generic-lens or generic-optics with 'startTimes' instead"  #-}
