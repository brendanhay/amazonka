...
mkGlobalSecondaryIndex indexName keySchema projection
  = GlobalSecondaryIndex'{indexName, keySchema, projection,
...
{-# INLINEABLE gsiProvisionedThroughput #-}
