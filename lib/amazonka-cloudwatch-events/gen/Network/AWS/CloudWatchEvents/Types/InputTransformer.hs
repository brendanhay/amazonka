...
mkInputTransformer
    :: Types.InputTemplate -- ^ 'inputTemplate'
    -> InputTransformer
...
{-# INLINEABLE itInputTemplate #-}
{-# DEPRECATED inputTemplate "Use generic-lens or generic-optics with 'inputTemplate' instead"  #-}
...
{-# INLINEABLE itInputPathsMap #-}
{-# DEPRECATED inputPathsMap "Use generic-lens or generic-optics with 'inputPathsMap' instead"  #-}
          ...
          = Core.withObject "InputTransformer" Core.$
              \ x ->
                InputTransformer' Core.<$>
                  (x Core..: "InputTemplate") Core.<*> x Core..:? "InputPathsMap"
