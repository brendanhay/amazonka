...
-- | If the bucket is versioning enabled, you can specify the object version.
s3Object_version :: Lens.Lens' S3Object (Core.Maybe Core.Text)
s3Object_version = Lens.lens (\S3Object' {version} -> version) (\s@S3Object' {} a -> s {version = a} :: S3Object)

-- | S3 object key name.
s3Object_name :: Lens.Lens' S3Object (Core.Maybe Core.Text)
s3Object_name = Lens.lens (\S3Object' {name} -> name) (\s@S3Object' {} a -> s {name = a} :: S3Object)

-- | Name of the S3 bucket.
s3Object_bucket :: Lens.Lens' S3Object (Core.Maybe Core.Text)
...
instance Core.Hashable S3Object

instance Core.NFData S3Object
