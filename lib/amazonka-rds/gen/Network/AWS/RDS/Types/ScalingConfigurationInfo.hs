...
mkScalingConfigurationInfo
    :: ScalingConfigurationInfo
mkScalingConfigurationInfo
  = ScalingConfigurationInfo'{autoPause = Core.Nothing,
...
{-# INLINEABLE sciSecondsUntilAutoPause #-}
...
sciTimeoutAction :: Lens.Lens' ScalingConfigurationInfo (Core.Maybe Core.Text)
sciTimeoutAction = Lens.field @"timeoutAction"
{-# INLINEABLE sciTimeoutAction #-}
...
instance Core.FromXML ScalingConfigurationInfo where
        parseXML x
          = ScalingConfigurationInfo' Core.<$>
              (x Core..@? "AutoPause") Core.<*> x Core..@? "MaxCapacity" Core.<*>
                x Core..@? "MinCapacity"
