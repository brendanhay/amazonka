...
mkMp3Settings
    :: Mp3Settings
mkMp3Settings
  = Mp3Settings'{bitrate = Core.Nothing, channels = Core.Nothing,
                 rateControlMode = Core.Nothing, sampleRate = Core.Nothing,
...
instance Core.FromJSON Mp3Settings where
        parseJSON
          = Core.withObject "Mp3Settings" Core.$
              \ x ->
                Mp3Settings' Core.<$>
                  (x Core..:? "bitrate") Core.<*> x Core..:? "channels" Core.<*>
                    x Core..:? "rateControlMode"
