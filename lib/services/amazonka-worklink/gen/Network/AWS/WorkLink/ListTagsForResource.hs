...
-- |
-- Module      : Network.AWS.WorkLink.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) of the fleet.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  ListTagsForResource
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - The tags attached to the resource. A tag is a key-value pair.
--
