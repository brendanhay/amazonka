...
-- |
-- Module      : Network.AWS.Kendra.BatchGetDocumentStatus
...
instance Prelude.Hashable BatchGetDocumentStatus

instance Prelude.NFData BatchGetDocumentStatus
...
newBatchGetDocumentStatusResponse pHttpStatus_ =
  BatchGetDocumentStatusResponse'
    { errors =
        Prelude.Nothing,
      documentStatusList = Prelude.Nothing,
