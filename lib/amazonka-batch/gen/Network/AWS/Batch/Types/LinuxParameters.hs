...
mkLinuxParameters
    :: LinuxParameters
mkLinuxParameters
  = LinuxParameters'{devices = Core.Nothing,
                     initProcessEnabled = Core.Nothing, maxSwap = Core.Nothing,
                     sharedMemorySize = Core.Nothing, swappiness = Core.Nothing,
                     tmpfs = Core.Nothing}
...
{-# INLINEABLE lpInitProcessEnabled #-}
{-# DEPRECATED initProcessEnabled "Use generic-lens or generic-optics with 'initProcessEnabled' instead"  #-}
...
{-# INLINEABLE lpMaxSwap #-}
{-# DEPRECATED maxSwap "Use generic-lens or generic-optics with 'maxSwap' instead"  #-}
...
{-# INLINEABLE lpSharedMemorySize #-}
{-# DEPRECATED sharedMemorySize "Use generic-lens or generic-optics with 'sharedMemorySize' instead"  #-}
...
{-# INLINEABLE lpSwappiness #-}
{-# DEPRECATED swappiness "Use generic-lens or generic-optics with 'swappiness' instead"  #-}
...
{-# INLINEABLE lpTmpfs #-}
{-# DEPRECATED tmpfs "Use generic-lens or generic-optics with 'tmpfs' instead"  #-}
          ...
          = Core.withObject "LinuxParameters" Core.$
              \ x ->
                LinuxParameters' Core.<$>
                  (x Core..:? "devices") Core.<*> x Core..:? "initProcessEnabled"
                    Core.<*> x Core..:? "maxSwap"
