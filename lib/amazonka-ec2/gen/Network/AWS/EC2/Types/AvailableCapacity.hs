...
mkAvailableCapacity
    :: AvailableCapacity
mkAvailableCapacity
  = AvailableCapacity'{availableInstanceCapacity = Core.Nothing,
...
{-# INLINEABLE acAvailableInstanceCapacity #-}
{-# DEPRECATED availableInstanceCapacity "Use generic-lens or generic-optics with 'availableInstanceCapacity' instead"  #-}
...
{-# INLINEABLE acAvailableVCpus #-}
{-# DEPRECATED availableVCpus "Use generic-lens or generic-optics with 'availableVCpus' instead"  #-}

instance Core.FromXML AvailableCapacity where
        parseXML x
          = AvailableCapacity' Core.<$>
              (x Core..@? "availableInstanceCapacity" Core..<@>
