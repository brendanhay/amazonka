...
{-# INLINEABLE crsrCapacityReservationPreference #-}
...
{-# INLINEABLE crsrCapacityReservationTarget #-}
{-# DEPRECATED capacityReservationTarget "Use generic-lens or generic-optics with 'capacityReservationTarget' instead"  #-}

instance Core.FromXML CapacityReservationSpecificationResponse
         where
        parseXML x
          = CapacityReservationSpecificationResponse' Core.<$>
