...
mkLambdaFunctionFailedEventAttributes
    ...
    -> LambdaFunctionFailedEventAttributes
mkLambdaFunctionFailedEventAttributes scheduledEventId
  startedEventId
...
{-# INLINEABLE lffeaScheduledEventId #-}
...
{-# INLINEABLE lffeaStartedEventId #-}
...
instance Core.FromJSON LambdaFunctionFailedEventAttributes where
        parseJSON
          = Core.withObject "LambdaFunctionFailedEventAttributes" Core.$
              \ x ->
                LambdaFunctionFailedEventAttributes' Core.<$>
