...
mkInventoryDeletionSummary
    :: InventoryDeletionSummary
mkInventoryDeletionSummary
  = InventoryDeletionSummary'{remainingCount = Core.Nothing,
                              summaryItems = Core.Nothing, totalCount = Core.Nothing}
...
{-# INLINEABLE idsSummaryItems #-}
{-# DEPRECATED summaryItems "Use generic-lens or generic-optics with 'summaryItems' instead"  #-}
...
instance Core.FromJSON InventoryDeletionSummary where
        parseJSON
          = Core.withObject "InventoryDeletionSummary" Core.$
              \ x ->
                InventoryDeletionSummary' Core.<$>
                  (x Core..:? "RemainingCount") Core.<*> x Core..:? "SummaryItems"
