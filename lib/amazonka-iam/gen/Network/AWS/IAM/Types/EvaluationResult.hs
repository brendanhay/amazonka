...
mkEvaluationResult
    :: Types.EvalActionName -- ^ 'evalActionName'
    -> Types.PolicyEvaluationDecisionType -- ^ 'evalDecision'
    -> EvaluationResult
mkEvaluationResult evalActionName evalDecision
  = EvaluationResult'{evalActionName, evalDecision,
                      evalDecisionDetails = Core.Nothing,
                      evalResourceName = Core.Nothing, matchedStatements = Core.Nothing,
...
{-# INLINEABLE erEvalActionName #-}
{-# DEPRECATED evalActionName "Use generic-lens or generic-optics with 'evalActionName' instead"  #-}
...
{-# INLINEABLE erEvalDecision #-}
{-# DEPRECATED evalDecision "Use generic-lens or generic-optics with 'evalDecision' instead"  #-}
...
{-# INLINEABLE erEvalDecisionDetails #-}
...
{-# INLINEABLE erMatchedStatements #-}
...
{-# INLINEABLE erMissingContextValues #-}
...
{-# INLINEABLE erOrganizationsDecisionDetail #-}
{-# DEPRECATED organizationsDecisionDetail "Use generic-lens or generic-optics with 'organizationsDecisionDetail' instead"  #-}
...
{-# INLINEABLE erPermissionsBoundaryDecisionDetail #-}
...
{-# INLINEABLE erResourceSpecificResults #-}
{-# DEPRECATED resourceSpecificResults "Use generic-lens or generic-optics with 'resourceSpecificResults' instead"  #-}

instance Core.FromXML EvaluationResult where
        parseXML x
          = EvaluationResult' Core.<$>
              (x Core..@ "EvalActionName") Core.<*> x Core..@ "EvalDecision"
                Core.<*>
                ...
                Core.<*>
                x Core..@? "ResourceSpecificResults" Core..<@>
                  Core.parseXMLList "member"
