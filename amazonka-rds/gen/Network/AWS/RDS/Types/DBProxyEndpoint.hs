...
dbProxyEndpoint_vpcSubnetIds = Lens.lens (\DBProxyEndpoint' {vpcSubnetIds} -> vpcSubnetIds) (\s@DBProxyEndpoint' {} a -> s {vpcSubnetIds = a} :: DBProxyEndpoint) Prelude.. Lens.mapping Lens._Coerce

-- | Provides a list of VPC security groups that the DB proxy endpoint
-- belongs to.
dbProxyEndpoint_vpcSecurityGroupIds :: Lens.Lens' DBProxyEndpoint (Prelude.Maybe [Prelude.Text])
dbProxyEndpoint_vpcSecurityGroupIds = Lens.lens (\DBProxyEndpoint' {vpcSecurityGroupIds} -> vpcSecurityGroupIds) (\s@DBProxyEndpoint' {} a -> s {vpcSecurityGroupIds = a} :: DBProxyEndpoint) Prelude.. Lens.mapping Lens._Coerce
