...
mkApplicationState
    :: ApplicationState
mkApplicationState
  = ApplicationState'{applicationId = Core.Nothing,
                      applicationStatus = Core.Nothing, lastUpdatedTime = Core.Nothing}
...
instance Core.FromJSON ApplicationState where
        parseJSON
          = Core.withObject "ApplicationState" Core.$
              \ x ->
                ApplicationState' Core.<$>
                  (x Core..:? "ApplicationId") Core.<*>
                    x Core..:? "ApplicationStatus"
