...
instance ToHeaders UpdatePatchBaseline where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target" =# ("AmazonSSM.UpdatePatchBaseline" :: ByteString),
      ...
      ( catMaybes
          [ ("Replace" .=) <$> _upbReplace,
            ...
            ("ApprovedPatchesComplianceLevel" .=)
              <$> _upbApprovedPatchesComplianceLevel,
            ("RejectedPatchesAction" .=) <$> _upbRejectedPatchesAction,
...
data UpdatePatchBaselineResponse = UpdatePatchBaselineResponse'
  { _upbrsApprovalRules ::
    ...
    _upbrsOperatingSystem ::
      !(Maybe OperatingSystem),
    _upbrsGlobalFilters ::
      !(Maybe PatchFilterGroup),
    _upbrsApprovedPatchesComplianceLevel ::
      !(Maybe PatchComplianceLevel),
    _upbrsRejectedPatchesAction ::
      !(Maybe PatchAction),
    _upbrsApprovedPatches ::
      !(Maybe [Text]),
    _upbrsApprovedPatchesEnableNonSecurity ::
      !(Maybe Bool),
    _upbrsRejectedPatches ::
      !(Maybe [Text]),
    _upbrsSources ::
      !(Maybe [PatchSource]),
