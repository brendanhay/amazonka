...
instance Core.ToHeaders DescribeEnvironmentStatus where
        toHeaders DescribeEnvironmentStatus{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeEnvironmentStatus where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeEnvironmentStatusResponse' Core.<$>
                   (x Core..:? "message") Core.<*> x Core..:? "status" Core.<*>
...
mkDescribeEnvironmentStatusResponse responseStatus
  = DescribeEnvironmentStatusResponse'{message = Core.Nothing,
                                       status = Core.Nothing, responseStatus}

-- | Any informational message about the status of the environment.
--
-- /Note:/ Consider using 'message' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
desrrsMessage :: Lens.Lens' DescribeEnvironmentStatusResponse (Core.Maybe Core.Text)
desrrsMessage = Lens.field @"message"
{-# INLINEABLE desrrsMessage #-}
