...
instance Hashable ListModelPackages where

instance NFData ListModelPackages where
...
data ListModelPackagesResponse = ListModelPackagesResponse'
  ...
  , _lmprsModelPackageSummaryList :: ![ModelPackageSummary]
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
instance NFData ListModelPackagesResponse where
