...
data BatchDisassociateServiceActionFromProvisioningArtifact = BatchDisassociateServiceActionFromProvisioningArtifact'
  { _bdsafpaAcceptLanguage            :: !(Maybe Text)
  , _bdsafpaServiceActionAssociations :: !(List1 ServiceActionAssociation)
...
batchDisassociateServiceActionFromProvisioningArtifact
    ...
    -> BatchDisassociateServiceActionFromProvisioningArtifact
batchDisassociateServiceActionFromProvisioningArtifact pServiceActionAssociations_ =
  BatchDisassociateServiceActionFromProvisioningArtifact'
    { _bdsafpaAcceptLanguage = Nothing
    , _bdsafpaServiceActionAssociations = _List1 # pServiceActionAssociations_
    }
...
data BatchDisassociateServiceActionFromProvisioningArtifactResponse = BatchDisassociateServiceActionFromProvisioningArtifactResponse'
  { _bdsafparsFailedServiceActionAssociations :: !(Maybe [FailedServiceActionAssociation])
  , _bdsafparsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
batchDisassociateServiceActionFromProvisioningArtifactResponse
    ...
    -> BatchDisassociateServiceActionFromProvisioningArtifactResponse
batchDisassociateServiceActionFromProvisioningArtifactResponse pResponseStatus_ =
  BatchDisassociateServiceActionFromProvisioningArtifactResponse'
    { _bdsafparsFailedServiceActionAssociations = Nothing
    , _bdsafparsResponseStatus = pResponseStatus_
    }
