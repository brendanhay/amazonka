...
mkProtectiveEquipmentBodyPart
    :: ProtectiveEquipmentBodyPart
mkProtectiveEquipmentBodyPart
  = ProtectiveEquipmentBodyPart'{confidence = Core.Nothing,
                                 equipmentDetections = Core.Nothing, name = Core.Nothing}
...
{-# INLINEABLE pebpEquipmentDetections #-}
{-# DEPRECATED equipmentDetections "Use generic-lens or generic-optics with 'equipmentDetections' instead"  #-}
...
instance Core.FromJSON ProtectiveEquipmentBodyPart where
        parseJSON
          = Core.withObject "ProtectiveEquipmentBodyPart" Core.$
              \ x ->
                ProtectiveEquipmentBodyPart' Core.<$>
                  (x Core..:? "Confidence") Core.<*> x Core..:? "EquipmentDetections"
                    Core.<*> x Core..:? "Name"
