...
{-# DEPRECATED rathrrsCancelRequested "Use generic-lens or generic-optics with 'cancelRequested' instead." #-}
...
{-# DEPRECATED rathrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
