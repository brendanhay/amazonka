...
mkOrganization
    :: Organization
mkOrganization
  = Organization'{arn = Core.Nothing,
                  availablePolicyTypes = Core.Nothing, featureSet = Core.Nothing,
                  id = Core.Nothing, masterAccountArn = Core.Nothing,
                  masterAccountEmail = Core.Nothing, masterAccountId = Core.Nothing}
...
{-# INLINEABLE oAvailablePolicyTypes #-}
{-# DEPRECATED availablePolicyTypes "Use generic-lens or generic-optics with 'availablePolicyTypes' instead"  #-}
...
{-# INLINEABLE oMasterAccountArn #-}
{-# DEPRECATED masterAccountArn "Use generic-lens or generic-optics with 'masterAccountArn' instead"  #-}
...
{-# INLINEABLE oMasterAccountEmail #-}
{-# DEPRECATED masterAccountEmail "Use generic-lens or generic-optics with 'masterAccountEmail' instead"  #-}
...
{-# INLINEABLE oMasterAccountId #-}
{-# DEPRECATED masterAccountId "Use generic-lens or generic-optics with 'masterAccountId' instead"  #-}
...
instance Core.FromJSON Organization where
        parseJSON
          = Core.withObject "Organization" Core.$
              \ x ->
                Organization' Core.<$>
                  (x Core..:? "Arn") Core.<*> x Core..:? "AvailablePolicyTypes"
