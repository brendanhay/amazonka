...
mkDescribeScheduledActions serviceNamespace
  = DescribeScheduledActions'{serviceNamespace,
                              ...
                              resourceId = Core.Nothing, scalableDimension = Core.Nothing,
...
{-# INLINEABLE dsasServiceNamespace #-}
...
{-# INLINEABLE dsasScalableDimension #-}
...
instance Core.ToHeaders DescribeScheduledActions where
        toHeaders DescribeScheduledActions{..}
          = Core.pure
              ("X-Amz-Target",
          ...
          = Response.receiveJSON
              (\ s h x ->
                 DescribeScheduledActionsResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "ScheduledActions"
...
mkDescribeScheduledActionsResponse responseStatus
  = DescribeScheduledActionsResponse'{nextToken = Core.Nothing,
                                      scheduledActions = Core.Nothing, responseStatus}
...
{-# INLINEABLE dsarrsScheduledActions #-}
{-# DEPRECATED scheduledActions "Use generic-lens or generic-optics with 'scheduledActions' instead"  #-}
