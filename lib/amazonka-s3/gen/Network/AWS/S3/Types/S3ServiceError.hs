...
mkS3ServiceError
    :: S3ServiceError
mkS3ServiceError
  = S3ServiceError'{code = Core.Nothing, key = Core.Nothing,
                    message = Core.Nothing, versionId = Core.Nothing}
