...
mkKernelGatewayAppSettings
    :: KernelGatewayAppSettings
mkKernelGatewayAppSettings
  = KernelGatewayAppSettings'{customImages = Core.Nothing,
...
{-# INLINEABLE kgasCustomImages #-}
{-# DEPRECATED customImages "Use generic-lens or generic-optics with 'customImages' instead"  #-}
...
{-# INLINEABLE kgasDefaultResourceSpec #-}
          ...
          = Core.withObject "KernelGatewayAppSettings" Core.$
              \ x ->
                KernelGatewayAppSettings' Core.<$>
                  (x Core..:? "CustomImages") Core.<*>
                    x Core..:? "DefaultResourceSpec"
