...
instance Core.ToHeaders SearchDataSets where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Core.ToJSON SearchDataSets where
...
instance Core.ToPath SearchDataSets where
...
instance Core.ToQuery SearchDataSets where
