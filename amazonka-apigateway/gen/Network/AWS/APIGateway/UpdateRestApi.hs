...
updateRestApi_patchOperations = Lens.lens (\UpdateRestApi' {patchOperations} -> patchOperations) (\s@UpdateRestApi' {} a -> s {patchOperations = a} :: UpdateRestApi) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest UpdateRestApi where
...
instance Prelude.ToHeaders UpdateRestApi where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Accept"
...
instance Prelude.ToJSON UpdateRestApi where
...
instance Prelude.ToPath UpdateRestApi where
  toPath UpdateRestApi' {..} =
    Prelude.mconcat
      ["/restapis/", Prelude.toBS restApiId]

instance Prelude.ToQuery UpdateRestApi where
