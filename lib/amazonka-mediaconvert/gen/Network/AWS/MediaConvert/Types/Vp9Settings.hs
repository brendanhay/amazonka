...
mkVp9Settings
    :: Vp9Settings
mkVp9Settings
  = Vp9Settings'{bitrate = Core.Nothing,
...
{-# INLINEABLE vssFramerateControl #-}
...
{-# INLINEABLE vssFramerateConversionAlgorithm #-}
...
{-# INLINEABLE vssFramerateDenominator #-}
...
{-# INLINEABLE vssFramerateNumerator #-}
...
{-# INLINEABLE vssQualityTuningLevel #-}
