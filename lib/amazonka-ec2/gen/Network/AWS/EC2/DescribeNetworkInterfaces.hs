...
dnisNetworkInterfaceIds :: Lens.Lens' DescribeNetworkInterfaces (Lude.Maybe [Lude.Text])
dnisNetworkInterfaceIds = Lens.lens (networkInterfaceIds :: DescribeNetworkInterfaces -> Lude.Maybe [Lude.Text]) (\s a -> s {networkInterfaceIds = a} :: DescribeNetworkInterfaces)
...
dnisFilters :: Lens.Lens' DescribeNetworkInterfaces (Lude.Maybe [Filter])
dnisFilters = Lens.lens (filters :: DescribeNetworkInterfaces -> Lude.Maybe [Filter]) (\s a -> s {filters = a} :: DescribeNetworkInterfaces)
{-# DEPRECATED dnisFilters "Use generic-lens or generic-optics with 'filters' instead." #-}

-- | The token to retrieve the next page of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dnisNextToken :: Lens.Lens' DescribeNetworkInterfaces (Lude.Maybe Lude.Text)
dnisNextToken = Lens.lens (nextToken :: DescribeNetworkInterfaces -> Lude.Maybe Lude.Text) (\s a -> s {nextToken = a} :: DescribeNetworkInterfaces)
...
dnisDryRun :: Lens.Lens' DescribeNetworkInterfaces (Lude.Maybe Lude.Bool)
dnisDryRun = Lens.lens (dryRun :: DescribeNetworkInterfaces -> Lude.Maybe Lude.Bool) (\s a -> s {dryRun = a} :: DescribeNetworkInterfaces)
...
dnisMaxResults :: Lens.Lens' DescribeNetworkInterfaces (Lude.Maybe Lude.Natural)
dnisMaxResults = Lens.lens (maxResults :: DescribeNetworkInterfaces -> Lude.Maybe Lude.Natural) (\s a -> s {maxResults = a} :: DescribeNetworkInterfaces)
...
instance Page.AWSPager DescribeNetworkInterfaces where
  page rq rs
    ...
    | Lude.otherwise =
      Lude.Just Lude.$
        rq
          Lude.& dnisNextToken Lens..~ rs Lens.^. dnirsNextToken
