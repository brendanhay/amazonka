          ...
          = Core.object
              (Core.catMaybes
                 [("Address" Core..=) Core.<$> address,
                  ...
                  ("Id" Core..=) Core.<$> id, ("Location" Core..=) Core.<$> location,
