...
-- |
-- Module      : Network.AWS.LicenseManager.Types.ReportFrequencyType
...
pattern ReportFrequencyType_DAY = ReportFrequencyType' "DAY"

pattern ReportFrequencyType_MONTH :: ReportFrequencyType
pattern ReportFrequencyType_MONTH = ReportFrequencyType' "MONTH"

pattern ReportFrequencyType_WEEK :: ReportFrequencyType
pattern ReportFrequencyType_WEEK = ReportFrequencyType' "WEEK"
