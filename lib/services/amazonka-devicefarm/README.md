...
`2.0` - Derived from API version @2015-06-23@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.DeviceFarm](http://hackage.haskell.org/package/amazonka-devicefarm/docs/Amazonka-DeviceFarm.html)
