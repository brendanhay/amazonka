...
mkTemplateVersionResponse
    ...
    -> TemplateVersionResponse
mkTemplateVersionResponse lastModifiedDate creationDate
  templateName templateType
  = TemplateVersionResponse'{lastModifiedDate, creationDate,
                             templateName, templateType, defaultSubstitutions = Core.Nothing,
...
{-# INLINEABLE tvrLastModifiedDate #-}
...
{-# INLINEABLE tvrDefaultSubstitutions #-}
...
{-# INLINEABLE tvrTemplateDescription #-}
