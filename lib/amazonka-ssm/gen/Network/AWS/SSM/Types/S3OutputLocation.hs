...
mkS3OutputLocation
    :: S3OutputLocation
mkS3OutputLocation
  = S3OutputLocation'{outputS3BucketName = Core.Nothing,
...
{-# INLINEABLE solOutputS3BucketName #-}
...
{-# INLINEABLE solOutputS3KeyPrefix #-}
...
instance Core.FromJSON S3OutputLocation where
        parseJSON
          = Core.withObject "S3OutputLocation" Core.$
              \ x ->
                S3OutputLocation' Core.<$>
                  (x Core..:? "OutputS3BucketName") Core.<*>
                    x Core..:? "OutputS3KeyPrefix"
