...
--
-- * 'lscMarker'
data ListServerCertificates = ListServerCertificates'{_lscPathPrefix :: Text, _lscMaxItems :: Nat, _lscMarker :: Text} deriving (Eq, Read, Show)

-- | 'ListServerCertificates' smart constructor.
listServerCertificates :: Text -> Natural -> Text -> ListServerCertificates
listServerCertificates pPathPrefix pMaxItems pMarker = ListServerCertificates'{_lscPathPrefix = pPathPrefix, _lscMaxItems = _Nat # pMaxItems, _lscMarker = pMarker};
...
lscPathPrefix :: Lens' ListServerCertificates Text
...
lscMaxItems :: Lens' ListServerCertificates Natural
lscMaxItems = lens _lscMaxItems (\ s a -> s{_lscMaxItems = a}) . _Nat;

-- | Use this only when paginating results, and only in a subsequent request
-- after you\'ve received a response where the results are truncated. Set
-- it to the value of the @Marker@ element in the response you just
-- received.
lscMarker :: Lens' ListServerCertificates Text
...
--
-- * 'lscrMarker'
data ListServerCertificatesResponse = ListServerCertificatesResponse'{_lscrIsTruncated :: Maybe Bool, _lscrServerCertificateMetadataList :: [ServerCertificateMetadata], _lscrMarker :: Text} deriving (Eq, Read, Show)

-- | 'ListServerCertificatesResponse' smart constructor.
listServerCertificatesResponse :: [ServerCertificateMetadata] -> Text -> ListServerCertificatesResponse
listServerCertificatesResponse pServerCertificateMetadataList pMarker = ListServerCertificatesResponse'{_lscrIsTruncated = Nothing, _lscrServerCertificateMetadataList = pServerCertificateMetadataList, _lscrMarker = pMarker};
...
-- request.
lscrMarker :: Lens' ListServerCertificatesResponse Text
