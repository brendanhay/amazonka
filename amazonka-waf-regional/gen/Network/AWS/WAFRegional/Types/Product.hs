...
instance FromJSON ExcludedRule where
        parseJSON
          = withObject "ExcludedRule"
              (\ x -> ExcludedRule' <$> (x .: "RuleId"))

instance Hashable ExcludedRule where

instance NFData ExcludedRule where
...
--
--
-- To specify an individual IP address, you specify the four-part IP address followed by a @/32@ , for example, 192.0.2.0/31. To block a range of IP addresses, you can specify /8 or any range between /16 through /32 (for IPv4) or /24, /32, /48, /56, /64, or /128 (for IPv6). For more information about CIDR notation, see the Wikipedia entry <https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing Classless Inter-Domain Routing> .
--
--
...
data LoggingConfiguration = LoggingConfiguration'
  { _lcRedactedFields        :: !(Maybe [FieldToMatch])
  , _lcResourceARN           :: !Text
...
loggingConfiguration
    :: Text -- ^ 'lcResourceARN'
    -> NonEmpty Text -- ^ 'lcLogDestinationConfigs'
    -> LoggingConfiguration
