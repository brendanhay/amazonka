...
mkCloudWatchEncryption
    :: CloudWatchEncryption
mkCloudWatchEncryption
  = CloudWatchEncryption'{cloudWatchEncryptionMode = Core.Nothing,
...
{-# INLINEABLE cweCloudWatchEncryptionMode #-}
{-# DEPRECATED cloudWatchEncryptionMode "Use generic-lens or generic-optics with 'cloudWatchEncryptionMode' instead"  #-}
...
instance Core.FromJSON CloudWatchEncryption where
        toJSON CloudWatchEncryption{..}
          = Core.object
              (Core.catMaybes
                 [("CloudWatchEncryptionMode" Core..=) Core.<$>
          ...
          = Core.withObject "CloudWatchEncryption" Core.$
              \ x ->
                CloudWatchEncryption' Core.<$>
                  (x Core..:? "CloudWatchEncryptionMode") Core.<*>
                    x Core..:? "KmsKeyArn"
