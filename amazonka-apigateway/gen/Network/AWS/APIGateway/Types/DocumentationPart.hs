...
data DocumentationPart = DocumentationPart'
  { -- | The DocumentationPart identifier, generated by API Gateway when the
    ...
    location :: Core.Maybe DocumentationPartLocation
  }
...
-- | The DocumentationPart identifier, generated by API Gateway when the
-- @DocumentationPart@ is created.
documentationPart_id :: Lens.Lens' DocumentationPart (Core.Maybe Core.Text)
...
-- definitions, while the original documentation parts are exported in a
-- OpenAPI extension of @x-amazon-apigateway-documentation@.
documentationPart_properties :: Lens.Lens' DocumentationPart (Core.Maybe Core.Text)
...
-- field is treated as a wildcard and associated documentation content may
-- be inherited by matching entities, unless overridden.
documentationPart_location :: Lens.Lens' DocumentationPart (Core.Maybe DocumentationPartLocation)
...
instance Core.Hashable DocumentationPart

instance Core.NFData DocumentationPart
