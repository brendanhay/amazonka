...
mkRouteTable
    :: RouteTable
mkRouteTable
  = RouteTable'{associations = Core.Nothing, ownerId = Core.Nothing,
                propagatingVgws = Core.Nothing, routeTableId = Core.Nothing,
                routes = Core.Nothing, tags = Core.Nothing, vpcId = Core.Nothing}
...
{-# INLINEABLE rtPropagatingVgws #-}
{-# DEPRECATED propagatingVgws "Use generic-lens or generic-optics with 'propagatingVgws' instead"  #-}
...
rtRouteTableId :: Lens.Lens' RouteTable (Core.Maybe Core.Text)
rtRouteTableId = Lens.field @"routeTableId"
{-# INLINEABLE rtRouteTableId #-}
...
rtVpcId :: Lens.Lens' RouteTable (Core.Maybe Core.Text)
        ...
        parseXML x
          = RouteTable' Core.<$>
              (x Core..@? "associationSet" Core..<@> Core.parseXMLList "item")
                Core.<*> x Core..@? "ownerId"
                Core.<*>
                x Core..@? "propagatingVgwSet" Core..<@> Core.parseXMLList "item"
