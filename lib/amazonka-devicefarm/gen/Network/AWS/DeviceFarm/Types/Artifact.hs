...
mkArtifact
    :: Artifact
mkArtifact
  = Artifact'{arn = Core.Nothing, extension = Core.Nothing,
              name = Core.Nothing, type' = Core.Nothing, url = Core.Nothing}
...
aExtension :: Lens.Lens' Artifact (Core.Maybe Core.Text)
aExtension = Lens.field @"extension"
{-# INLINEABLE aExtension #-}
...
instance Core.FromJSON Artifact where
        parseJSON
          = Core.withObject "Artifact" Core.$
              \ x ->
                Artifact' Core.<$>
                  (x Core..:? "arn") Core.<*> x Core..:? "extension" Core.<*>
                    x Core..:? "name"
                    Core.<*> x Core..:? "type"
                    Core.<*> x Core..:? "url"
