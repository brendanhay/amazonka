...
mkClassifier
    :: Classifier
mkClassifier
  = Classifier'{csvClassifier = Core.Nothing,
...
instance Core.FromJSON Classifier where
        parseJSON
          = Core.withObject "Classifier" Core.$
              \ x ->
                Classifier' Core.<$>
                  (x Core..:? "CsvClassifier") Core.<*> x Core..:? "GrokClassifier"
