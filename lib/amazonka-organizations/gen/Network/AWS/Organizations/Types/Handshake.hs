...
mkHandshake
    :: Handshake
mkHandshake
  = Handshake'{action = Core.Nothing, arn = Core.Nothing,
               expirationTimestamp = Core.Nothing, id = Core.Nothing,
               parties = Core.Nothing, requestedTimestamp = Core.Nothing,
               resources = Core.Nothing, state = Core.Nothing}
...
{-# INLINEABLE hExpirationTimestamp #-}
{-# DEPRECATED expirationTimestamp "Use generic-lens or generic-optics with 'expirationTimestamp' instead"  #-}
...
{-# INLINEABLE hParties #-}
{-# DEPRECATED parties "Use generic-lens or generic-optics with 'parties' instead"  #-}
...
{-# INLINEABLE hRequestedTimestamp #-}
...
instance Core.FromJSON Handshake where
        parseJSON
          = Core.withObject "Handshake" Core.$
              \ x ->
                Handshake' Core.<$>
                  (x Core..:? "Action") Core.<*> x Core..:? "Arn" Core.<*>
                    x Core..:? "ExpirationTimestamp"
                    Core.<*> x Core..:? "Id"
                    Core.<*> x Core..:? "Parties"
