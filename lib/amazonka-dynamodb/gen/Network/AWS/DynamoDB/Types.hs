...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "DynamoDB",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "dynamodb",
                 Core._svcVersion = "2012-08-10", Core._svcTimeout = Core.Just 70,
  ...
  where retry
        ...
        check e
          ...
          | Lens.has
              (Core.hasCode "TransactionInProgressException" Core..
                 Core.hasStatus 400)
              e
...
{-# INLINEABLE _InvalidExportTimeException #-}
...
{-# INLINEABLE _BackupNotFoundException #-}
...
{-# INLINEABLE _TableInUseException #-}
...
{-# INLINEABLE _ExportConflictException #-}
...
{-# INLINEABLE _ContinuousBackupsUnavailableException #-}
...
{-# INLINEABLE _GlobalTableNotFoundException #-}
...
{-# INLINEABLE _TransactionInProgressException #-}
...
{-# INLINEABLE _TransactionCanceledException #-}
...
{-# INLINEABLE _ConditionalCheckFailedException #-}
...
{-# INLINEABLE _GlobalTableAlreadyExistsException #-}
...
{-# INLINEABLE _ReplicaNotFoundException #-}
...
{-# INLINEABLE _TableAlreadyExistsException #-}
...
{-# INLINEABLE _ItemCollectionSizeLimitExceededException #-}
...
{-# INLINEABLE _TableNotFoundException #-}
...
{-# INLINEABLE _IndexNotFoundException #-}
...
{-# INLINEABLE _TransactionConflictException #-}
...
{-# INLINEABLE _BackupInUseException #-}
...
{-# INLINEABLE _DuplicateItemException #-}
...
{-# INLINEABLE _ExportNotFoundException #-}
...
{-# INLINEABLE _PointInTimeRecoveryUnavailableException #-}
...
{-# INLINEABLE _InvalidRestoreTimeException #-}
...
{-# INLINEABLE _ReplicaAlreadyExistsException #-}
