...
mkListClosedWorkflowExecutions domain
  = ListClosedWorkflowExecutions'{domain,
                                  ...
                                  executionFilter = Core.Nothing, maximumPageSize = Core.Nothing,
                                  nextPageToken = Core.Nothing, reverseOrder = Core.Nothing,
                                  startTimeFilter = Core.Nothing, tagFilter = Core.Nothing,
...
{-# INLINEABLE lcweCloseStatusFilter #-}
...
{-# INLINEABLE lcweCloseTimeFilter #-}
...
{-# INLINEABLE lcweExecutionFilter #-}
...
{-# INLINEABLE lcweMaximumPageSize #-}
...
{-# INLINEABLE lcweStartTimeFilter #-}
...
instance Core.ToHeaders ListClosedWorkflowExecutions where
        toHeaders ListClosedWorkflowExecutions{..}
          = Core.pure
              ("X-Amz-Target",
