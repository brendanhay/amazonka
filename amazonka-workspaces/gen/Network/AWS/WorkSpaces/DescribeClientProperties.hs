...
--
-- * 'dcpResourceIds' - The resource identifiers, in the form of directory IDs.
describeClientProperties
    :: NonEmpty Text -- ^ 'dcpResourceIds'
    -> DescribeClientProperties
describeClientProperties pResourceIds_ =
  DescribeClientProperties' {_dcpResourceIds = _List1 # pResourceIds_}
...
data DescribeClientPropertiesResponse = DescribeClientPropertiesResponse'
  { _dcprsClientPropertiesList :: !(Maybe [ClientPropertiesResult])
...
describeClientPropertiesResponse pResponseStatus_ =
  DescribeClientPropertiesResponse'
    { _dcprsClientPropertiesList = Nothing
