...
mkGetApplicationResponse responseStatus
  = GetApplicationResponse'{applicationId = Core.Nothing,
...
{-# INLINEABLE garrsIsVerifiedAuthor #-}
...
{-# INLINEABLE garrsVerifiedAuthorUrl #-}
