...
mkPipelineDeclaration name roleArn
  = PipelineDeclaration'{name, roleArn, stages = Core.mempty,
                         artifactStore = Core.Nothing, artifactStores = Core.Nothing,
...
{-# INLINEABLE pdStages #-}
{-# DEPRECATED stages "Use generic-lens or generic-optics with 'stages' instead"  #-}
...
{-# INLINEABLE pdArtifactStore #-}
{-# DEPRECATED artifactStore "Use generic-lens or generic-optics with 'artifactStore' instead"  #-}
...
{-# INLINEABLE pdArtifactStores #-}
{-# DEPRECATED artifactStores "Use generic-lens or generic-optics with 'artifactStores' instead"  #-}
...
instance Core.FromJSON PipelineDeclaration where
        parseJSON
          = Core.withObject "PipelineDeclaration" Core.$
              \ x ->
                PipelineDeclaration' Core.<$>
                  (x Core..: "name") Core.<*> x Core..: "roleArn" Core.<*>
                    x Core..:? "stages" Core..!= Core.mempty
