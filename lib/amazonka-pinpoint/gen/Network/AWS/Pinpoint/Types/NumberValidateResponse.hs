...
mkNumberValidateResponse
    :: NumberValidateResponse
mkNumberValidateResponse
  = NumberValidateResponse'{carrier = Core.Nothing,
                            city = Core.Nothing, cleansedPhoneNumberE164 = Core.Nothing,
                            cleansedPhoneNumberNational = Core.Nothing, country = Core.Nothing,
                            countryCodeIso2 = Core.Nothing, countryCodeNumeric = Core.Nothing,
                            county = Core.Nothing, originalCountryCodeIso2 = Core.Nothing,
                            originalPhoneNumber = Core.Nothing, phoneType = Core.Nothing,
                            phoneTypeCode = Core.Nothing, timezone = Core.Nothing,
...
{-# INLINEABLE nvrCleansedPhoneNumberE164 #-}
{-# DEPRECATED cleansedPhoneNumberE164 "Use generic-lens or generic-optics with 'cleansedPhoneNumberE164' instead"  #-}
...
{-# INLINEABLE nvrCleansedPhoneNumberNational #-}
{-# DEPRECATED cleansedPhoneNumberNational "Use generic-lens or generic-optics with 'cleansedPhoneNumberNational' instead"  #-}
...
{-# INLINEABLE nvrCountryCodeIso2 #-}
{-# DEPRECATED countryCodeIso2 "Use generic-lens or generic-optics with 'countryCodeIso2' instead"  #-}
...
{-# INLINEABLE nvrCountryCodeNumeric #-}
{-# DEPRECATED countryCodeNumeric "Use generic-lens or generic-optics with 'countryCodeNumeric' instead"  #-}
...
{-# INLINEABLE nvrCounty #-}
{-# DEPRECATED county "Use generic-lens or generic-optics with 'county' instead"  #-}
...
{-# INLINEABLE nvrOriginalCountryCodeIso2 #-}
{-# DEPRECATED originalCountryCodeIso2 "Use generic-lens or generic-optics with 'originalCountryCodeIso2' instead"  #-}
...
{-# INLINEABLE nvrOriginalPhoneNumber #-}
{-# DEPRECATED originalPhoneNumber "Use generic-lens or generic-optics with 'originalPhoneNumber' instead"  #-}
...
{-# INLINEABLE nvrPhoneTypeCode #-}
{-# DEPRECATED phoneTypeCode "Use generic-lens or generic-optics with 'phoneTypeCode' instead"  #-}
...
instance Core.FromJSON NumberValidateResponse where
        parseJSON
          = Core.withObject "NumberValidateResponse" Core.$
              \ x ->
                NumberValidateResponse' Core.<$>
                  (x Core..:? "Carrier") Core.<*> x Core..:? "City" Core.<*>
                    x Core..:? "CleansedPhoneNumberE164"
