...
instance AWSPager DescribeSnapshotSchedules where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dssMarker .~ rs ^. dssrsMarker
...
instance AWSRequest DescribeSnapshotSchedules where
        ...
        response
          = receiveXMLWrapper "DescribeSnapshotSchedulesResult"
              (\ s h x ->
                 DescribeSnapshotSchedulesResponse' <$>
...
instance Hashable DescribeSnapshotSchedules where

instance NFData DescribeSnapshotSchedules where
...
data DescribeSnapshotSchedulesResponse = DescribeSnapshotSchedulesResponse'
  { _dssrsSnapshotSchedules :: !(Maybe [SnapshotSchedule])
...
describeSnapshotSchedulesResponse pResponseStatus_ =
  DescribeSnapshotSchedulesResponse'
    { _dssrsSnapshotSchedules = Nothing
