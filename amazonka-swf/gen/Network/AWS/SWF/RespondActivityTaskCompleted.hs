...
-- | The result of the activity task. It is a free form string that is
-- implementation specific.
respondActivityTaskCompleted_result :: Lens.Lens' RespondActivityTaskCompleted (Core.Maybe Core.Text)
...
-- must also be passed. This enables it to provide its progress and respond
-- with results.
respondActivityTaskCompleted_taskToken :: Lens.Lens' RespondActivityTaskCompleted Core.Text
...
instance Core.Hashable RespondActivityTaskCompleted

instance Core.NFData RespondActivityTaskCompleted
