...
nodegroup_modifiedAt = Lens.lens (\Nodegroup' {modifiedAt} -> modifiedAt) (\s@Nodegroup' {} a -> s {modifiedAt = a} :: Nodegroup) Prelude.. Lens.mapping Prelude._Time
...
nodegroup_createdAt = Lens.lens (\Nodegroup' {createdAt} -> createdAt) (\s@Nodegroup' {} a -> s {createdAt = a} :: Nodegroup) Prelude.. Lens.mapping Prelude._Time
...
nodegroup_labels = Lens.lens (\Nodegroup' {labels} -> labels) (\s@Nodegroup' {} a -> s {labels = a} :: Nodegroup) Prelude.. Lens.mapping Prelude._Coerce
...
nodegroup_tags = Lens.lens (\Nodegroup' {tags} -> tags) (\s@Nodegroup' {} a -> s {tags = a} :: Nodegroup) Prelude.. Lens.mapping Prelude._Coerce

-- | The subnets that were specified for the Auto Scaling group that is
-- associated with your node group.
nodegroup_subnets :: Lens.Lens' Nodegroup (Prelude.Maybe [Prelude.Text])
nodegroup_subnets = Lens.lens (\Nodegroup' {subnets} -> subnets) (\s@Nodegroup' {} a -> s {subnets = a} :: Nodegroup) Prelude.. Lens.mapping Prelude._Coerce
...
nodegroup_instanceTypes = Lens.lens (\Nodegroup' {instanceTypes} -> instanceTypes) (\s@Nodegroup' {} a -> s {instanceTypes = a} :: Nodegroup) Prelude.. Lens.mapping Prelude._Coerce

instance Prelude.FromJSON Nodegroup where
  parseJSON =
    Prelude.withObject
      "Nodegroup"
      ( \x ->
          Nodegroup'
            Prelude.<$> (x Prelude..:? "scalingConfig")
            Prelude.<*> (x Prelude..:? "modifiedAt")
            Prelude.<*> (x Prelude..:? "status")
            Prelude.<*> (x Prelude..:? "capacityType")
            Prelude.<*> (x Prelude..:? "releaseVersion")
            Prelude.<*> (x Prelude..:? "diskSize")
            Prelude.<*> (x Prelude..:? "nodegroupName")
            Prelude.<*> (x Prelude..:? "remoteAccess")
            ...
            Prelude.<*> (x Prelude..:? "amiType")
            Prelude.<*> (x Prelude..:? "clusterName")
            Prelude.<*> (x Prelude..:? "nodegroupArn")
