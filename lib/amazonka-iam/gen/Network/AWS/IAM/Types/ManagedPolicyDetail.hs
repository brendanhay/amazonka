...
mkManagedPolicyDetail
    :: ManagedPolicyDetail
mkManagedPolicyDetail
  = ManagedPolicyDetail'{arn = Core.Nothing,
                         attachmentCount = Core.Nothing, createDate = Core.Nothing,
                         defaultVersionId = Core.Nothing, description = Core.Nothing,
                         isAttachable = Core.Nothing, path = Core.Nothing,
                         permissionsBoundaryUsageCount = Core.Nothing,
                         policyId = Core.Nothing, policyName = Core.Nothing,
                         policyVersionList = Core.Nothing, updateDate = Core.Nothing}
...
{-# INLINEABLE mpdAttachmentCount #-}
{-# DEPRECATED attachmentCount "Use generic-lens or generic-optics with 'attachmentCount' instead"  #-}
...
{-# INLINEABLE mpdDefaultVersionId #-}
...
{-# INLINEABLE mpdIsAttachable #-}
{-# DEPRECATED isAttachable "Use generic-lens or generic-optics with 'isAttachable' instead"  #-}
...
{-# INLINEABLE mpdPermissionsBoundaryUsageCount #-}
{-# DEPRECATED permissionsBoundaryUsageCount "Use generic-lens or generic-optics with 'permissionsBoundaryUsageCount' instead"  #-}
...
{-# INLINEABLE mpdPolicyVersionList #-}
{-# DEPRECATED policyVersionList "Use generic-lens or generic-optics with 'policyVersionList' instead"  #-}
...
instance Core.FromXML ManagedPolicyDetail where
        parseXML x
          = ManagedPolicyDetail' Core.<$>
              (x Core..@? "Arn") Core.<*> x Core..@? "AttachmentCount" Core.<*>
                x Core..@? "CreateDate"
                ...
                Core.<*>
                x Core..@? "PolicyVersionList" Core..<@> Core.parseXMLList "member"
