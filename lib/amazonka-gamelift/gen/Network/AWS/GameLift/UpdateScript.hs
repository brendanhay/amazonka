...
mkUpdateScript scriptId
  = UpdateScript'{scriptId, name = Core.Nothing,
                  storageLocation = Core.Nothing, version = Core.Nothing,
...
instance Core.ToHeaders UpdateScript where
        toHeaders UpdateScript{..}
          = Core.pure ("X-Amz-Target", "GameLift.UpdateScript") Core.<>
