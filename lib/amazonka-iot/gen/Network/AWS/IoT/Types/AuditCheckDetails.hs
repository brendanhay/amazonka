...
mkAuditCheckDetails
    :: AuditCheckDetails
mkAuditCheckDetails
  = AuditCheckDetails'{checkCompliant = Core.Nothing,
                       checkRunStatus = Core.Nothing, errorCode = Core.Nothing,
                       message = Core.Nothing, nonCompliantResourcesCount = Core.Nothing,
...
{-# INLINEABLE acdCheckCompliant #-}
{-# DEPRECATED checkCompliant "Use generic-lens or generic-optics with 'checkCompliant' instead"  #-}
...
{-# INLINEABLE acdCheckRunStatus #-}
{-# DEPRECATED checkRunStatus "Use generic-lens or generic-optics with 'checkRunStatus' instead"  #-}
...
{-# INLINEABLE acdNonCompliantResourcesCount #-}
{-# DEPRECATED nonCompliantResourcesCount "Use generic-lens or generic-optics with 'nonCompliantResourcesCount' instead"  #-}
...
{-# INLINEABLE acdSuppressedNonCompliantResourcesCount #-}
{-# DEPRECATED suppressedNonCompliantResourcesCount "Use generic-lens or generic-optics with 'suppressedNonCompliantResourcesCount' instead"  #-}
...
{-# INLINEABLE acdTotalResourcesCount #-}
{-# DEPRECATED totalResourcesCount "Use generic-lens or generic-optics with 'totalResourcesCount' instead"  #-}

instance Core.FromJSON AuditCheckDetails where
        parseJSON
          = Core.withObject "AuditCheckDetails" Core.$
              \ x ->
                AuditCheckDetails' Core.<$>
                  (x Core..:? "checkCompliant") Core.<*> x Core..:? "checkRunStatus"
