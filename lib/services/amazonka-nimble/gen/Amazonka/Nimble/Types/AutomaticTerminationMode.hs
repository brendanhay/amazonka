...
pattern AutomaticTerminationMode_ACTIVATED = AutomaticTerminationMode' "ACTIVATED"

pattern AutomaticTerminationMode_DEACTIVATED :: AutomaticTerminationMode
pattern AutomaticTerminationMode_DEACTIVATED = AutomaticTerminationMode' "DEACTIVATED"
