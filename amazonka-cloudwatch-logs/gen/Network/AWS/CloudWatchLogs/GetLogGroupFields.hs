...
getLogGroupFields pLogGroupName_ =
  GetLogGroupFields' {_glgfTime = Nothing, _glgfLogGroupName = pLogGroupName_}
...
data GetLogGroupFieldsResponse = GetLogGroupFieldsResponse'
  { _glgfrsLogGroupFields :: !(Maybe [LogGroupField])
...
getLogGroupFieldsResponse pResponseStatus_ =
  GetLogGroupFieldsResponse'
    {_glgfrsLogGroupFields = Nothing, _glgfrsResponseStatus = pResponseStatus_}
