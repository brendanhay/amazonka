...
describeStreamConsumer =
  DescribeStreamConsumer'
    {_dConsumerARN = Nothing, _dStreamARN = Nothing, _dConsumerName = Nothing}
...
data DescribeStreamConsumerResponse = DescribeStreamConsumerResponse'
  ...
  , _dscrsConsumerDescription :: !ConsumerDescription
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeStreamConsumerResponse
    ...
    -> DescribeStreamConsumerResponse
describeStreamConsumerResponse pResponseStatus_ pConsumerDescription_ =
  DescribeStreamConsumerResponse'
