...
putMethod_requestModels = Lens.lens (\PutMethod' {requestModels} -> requestModels) (\s@PutMethod' {} a -> s {requestModels = a} :: PutMethod) Prelude.. Lens.mapping Prelude._Coerce
...
putMethod_requestParameters = Lens.lens (\PutMethod' {requestParameters} -> requestParameters) (\s@PutMethod' {} a -> s {requestParameters = a} :: PutMethod) Prelude.. Lens.mapping Prelude._Coerce
...
putMethod_authorizationScopes = Lens.lens (\PutMethod' {authorizationScopes} -> authorizationScopes) (\s@PutMethod' {} a -> s {authorizationScopes = a} :: PutMethod) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest PutMethod where
...
instance Prelude.ToHeaders PutMethod where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Accept"
...
instance Prelude.ToJSON PutMethod where
  toJSON PutMethod' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("apiKeyRequired" Prelude..=)
              Prelude.<$> apiKeyRequired,
            ("requestModels" Prelude..=)
              Prelude.<$> requestModels,
            ("operationName" Prelude..=)
              Prelude.<$> operationName,
            ("requestValidatorId" Prelude..=)
              Prelude.<$> requestValidatorId,
            ("authorizerId" Prelude..=) Prelude.<$> authorizerId,
            ("requestParameters" Prelude..=)
              Prelude.<$> requestParameters,
            ("authorizationScopes" Prelude..=)
...
instance Prelude.ToPath PutMethod where
  toPath PutMethod' {..} =
    Prelude.mconcat
      [ "/restapis/",
...
instance Prelude.ToQuery PutMethod where
