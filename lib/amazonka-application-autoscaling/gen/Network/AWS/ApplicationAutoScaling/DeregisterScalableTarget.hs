...
derServiceNamespace :: Lens.Lens' DeregisterScalableTarget ServiceNamespace
derServiceNamespace = Lens.lens (serviceNamespace :: DeregisterScalableTarget -> ServiceNamespace) (\s a -> s {serviceNamespace = a} :: DeregisterScalableTarget)
{-# DEPRECATED derServiceNamespace "Use generic-lens or generic-optics with 'serviceNamespace' instead." #-}
...
derResourceId :: Lens.Lens' DeregisterScalableTarget Lude.Text
derResourceId = Lens.lens (resourceId :: DeregisterScalableTarget -> Lude.Text) (\s a -> s {resourceId = a} :: DeregisterScalableTarget)
{-# DEPRECATED derResourceId "Use generic-lens or generic-optics with 'resourceId' instead." #-}
...
derScalableDimension :: Lens.Lens' DeregisterScalableTarget ScalableDimension
derScalableDimension = Lens.lens (scalableDimension :: DeregisterScalableTarget -> ScalableDimension) (\s a -> s {scalableDimension = a} :: DeregisterScalableTarget)
{-# DEPRECATED derScalableDimension "Use generic-lens or generic-optics with 'scalableDimension' instead." #-}
