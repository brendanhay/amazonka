...
-- |
-- Module      : Network.AWS.Connect.Types.AgentStatusState
...
pattern AgentStatusState_DISABLED = AgentStatusState' "DISABLED"

pattern AgentStatusState_ENABLED :: AgentStatusState
pattern AgentStatusState_ENABLED = AgentStatusState' "ENABLED"
