...
mkScalingPolicy
    ...
    -> ScalingPolicy
mkScalingPolicy policyARN policyName serviceNamespace resourceId
  scalableDimension policyType creationTime
  = ScalingPolicy'{policyARN, policyName, serviceNamespace,
                   resourceId, scalableDimension, policyType, creationTime,
                   alarms = Core.Nothing,
...
{-# INLINEABLE spScalableDimension #-}
...
{-# INLINEABLE spStepScalingPolicyConfiguration #-}
{-# DEPRECATED stepScalingPolicyConfiguration "Use generic-lens or generic-optics with 'stepScalingPolicyConfiguration' instead"  #-}
...
{-# INLINEABLE spTargetTrackingScalingPolicyConfiguration #-}
...
instance Core.FromJSON ScalingPolicy where
        parseJSON
          = Core.withObject "ScalingPolicy" Core.$
              \ x ->
                ScalingPolicy' Core.<$>
                  (x Core..: "PolicyARN") Core.<*> x Core..: "PolicyName" Core.<*>
                    x Core..: "ServiceNamespace"
