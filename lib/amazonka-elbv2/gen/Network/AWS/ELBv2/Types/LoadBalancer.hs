...
lbCreatedTime :: Lens.Lens' LoadBalancer (Lude.Maybe Lude.ISO8601)
lbCreatedTime = Lens.lens (createdTime :: LoadBalancer -> Lude.Maybe Lude.ISO8601) (\s a -> s {createdTime = a} :: LoadBalancer)
