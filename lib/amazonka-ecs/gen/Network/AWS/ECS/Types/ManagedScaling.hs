...
mkManagedScaling
    :: ManagedScaling
mkManagedScaling
  = ManagedScaling'{instanceWarmupPeriod = Core.Nothing,
                    maximumScalingStepSize = Core.Nothing,
                    minimumScalingStepSize = Core.Nothing, status = Core.Nothing,
...
{-# INLINEABLE msInstanceWarmupPeriod #-}
{-# DEPRECATED instanceWarmupPeriod "Use generic-lens or generic-optics with 'instanceWarmupPeriod' instead"  #-}
...
{-# INLINEABLE msMaximumScalingStepSize #-}
{-# DEPRECATED maximumScalingStepSize "Use generic-lens or generic-optics with 'maximumScalingStepSize' instead"  #-}
...
{-# INLINEABLE msMinimumScalingStepSize #-}
{-# DEPRECATED minimumScalingStepSize "Use generic-lens or generic-optics with 'minimumScalingStepSize' instead"  #-}
...
instance Core.FromJSON ManagedScaling where
        parseJSON
          = Core.withObject "ManagedScaling" Core.$
              \ x ->
                ManagedScaling' Core.<$>
                  (x Core..:? "instanceWarmupPeriod") Core.<*>
                    x Core..:? "maximumScalingStepSize"
