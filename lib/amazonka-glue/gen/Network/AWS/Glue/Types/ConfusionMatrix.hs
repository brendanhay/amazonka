...
mkConfusionMatrix
    :: ConfusionMatrix
mkConfusionMatrix
  = ConfusionMatrix'{numFalseNegatives = Core.Nothing,
                     numFalsePositives = Core.Nothing, numTrueNegatives = Core.Nothing,
...
{-# INLINEABLE cmNumFalseNegatives #-}
{-# DEPRECATED numFalseNegatives "Use generic-lens or generic-optics with 'numFalseNegatives' instead"  #-}
...
{-# INLINEABLE cmNumFalsePositives #-}
{-# DEPRECATED numFalsePositives "Use generic-lens or generic-optics with 'numFalsePositives' instead"  #-}
...
{-# INLINEABLE cmNumTrueNegatives #-}
{-# DEPRECATED numTrueNegatives "Use generic-lens or generic-optics with 'numTrueNegatives' instead"  #-}
...
{-# INLINEABLE cmNumTruePositives #-}
{-# DEPRECATED numTruePositives "Use generic-lens or generic-optics with 'numTruePositives' instead"  #-}
          ...
          = Core.withObject "ConfusionMatrix" Core.$
              \ x ->
                ConfusionMatrix' Core.<$>
                  (x Core..:? "NumFalseNegatives") Core.<*>
                    x Core..:? "NumFalsePositives"
