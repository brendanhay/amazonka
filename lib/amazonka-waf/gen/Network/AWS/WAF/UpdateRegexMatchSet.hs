...
mkUpdateRegexMatchSet
    ...
    -> Core.NonEmpty Types.RegexMatchSetUpdate -- ^ 'updates'
...
{-# INLINEABLE urmsRegexMatchSetId #-}
...
instance Core.AWSRequest UpdateRegexMatchSet where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateRegexMatchSetResponse' Core.<$>
...
mkUpdateRegexMatchSetResponse responseStatus
  = UpdateRegexMatchSetResponse'{changeToken = Core.Nothing,
                                 responseStatus}
...
{-# INLINEABLE urmsrrsResponseStatus #-}
