...
mkFindMatchesMetrics
    :: FindMatchesMetrics
mkFindMatchesMetrics
  = FindMatchesMetrics'{areaUnderPRCurve = Core.Nothing,
                        confusionMatrix = Core.Nothing, f1 = Core.Nothing,
...
{-# INLINEABLE fmmAreaUnderPRCurve #-}
{-# DEPRECATED areaUnderPRCurve "Use generic-lens or generic-optics with 'areaUnderPRCurve' instead"  #-}
...
{-# INLINEABLE fmmConfusionMatrix #-}
{-# DEPRECATED confusionMatrix "Use generic-lens or generic-optics with 'confusionMatrix' instead"  #-}
...
fmmF1 = Lens.field @"f1"
{-# INLINEABLE fmmF1 #-}
{-# DEPRECATED f1 "Use generic-lens or generic-optics with 'f1' instead"  #-}
...
instance Core.FromJSON FindMatchesMetrics where
        parseJSON
          = Core.withObject "FindMatchesMetrics" Core.$
              \ x ->
                FindMatchesMetrics' Core.<$>
                  (x Core..:? "AreaUnderPRCurve") Core.<*>
                    x Core..:? "ConfusionMatrix"
                    Core.<*> x Core..:? "F1"
