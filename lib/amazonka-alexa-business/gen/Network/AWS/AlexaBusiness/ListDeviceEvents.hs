...
instance AWSPager ListDeviceEvents where
  page rq rs
    ...
    | otherwise = Just $ rq & ldeNextToken .~ rs ^. ldersNextToken
...
instance Hashable ListDeviceEvents

instance NFData ListDeviceEvents
...
instance NFData ListDeviceEventsResponse
