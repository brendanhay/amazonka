...
mkCustomizedScalingMetricSpecification
    ...
    -> Types.MetricNamespace -- ^ 'namespace'
    -> Types.MetricStatistic -- ^ 'statistic'
    -> CustomizedScalingMetricSpecification
mkCustomizedScalingMetricSpecification metricName namespace
  statistic
  = CustomizedScalingMetricSpecification'{metricName, namespace,
