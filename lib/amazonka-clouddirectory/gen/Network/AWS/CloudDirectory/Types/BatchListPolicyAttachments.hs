...
{-# DEPRECATED blpaPolicyReference "Use generic-lens or generic-optics with 'policyReference' instead." #-}
...
{-# DEPRECATED blpaMaxResults "Use generic-lens or generic-optics with 'maxResults' instead." #-}
