...
instance AWSRequest GetReservationPurchaseRecommendation where
  type
...
instance Hashable GetReservationPurchaseRecommendation

instance NFData GetReservationPurchaseRecommendation

instance ToHeaders GetReservationPurchaseRecommendation where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
    ...
    object
      ( catMaybes
          [ ("NextPageToken" .=) <$> _grprNextPageToken,
            ...
            ("ServiceSpecification" .=) <$> _grprServiceSpecification,
            ("AccountScope" .=) <$> _grprAccountScope,
            ("AccountId" .=) <$> _grprAccountId,
            ("PageSize" .=) <$> _grprPageSize,
            ("LookbackPeriodInDays" .=) <$> _grprLookbackPeriodInDays,
...
instance NFData GetReservationPurchaseRecommendationResponse
