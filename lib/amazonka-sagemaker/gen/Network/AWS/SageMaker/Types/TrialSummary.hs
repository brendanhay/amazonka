...
mkTrialSummary
    :: TrialSummary
mkTrialSummary
  = TrialSummary'{creationTime = Core.Nothing,
                  displayName = Core.Nothing, lastModifiedTime = Core.Nothing,
                  trialArn = Core.Nothing, trialName = Core.Nothing,
...
{-# INLINEABLE tsTrialSource #-}
{-# DEPRECATED trialSource "Use generic-lens or generic-optics with 'trialSource' instead"  #-}
