...
mkDocumentDescription
    :: DocumentDescription
mkDocumentDescription
  = DocumentDescription'{attachmentsInformation = Core.Nothing,
                         createdDate = Core.Nothing, defaultVersion = Core.Nothing,
                         description = Core.Nothing, documentFormat = Core.Nothing,
                         documentType = Core.Nothing, documentVersion = Core.Nothing,
                         hash = Core.Nothing, hashType = Core.Nothing,
                         latestVersion = Core.Nothing, name = Core.Nothing,
                         owner = Core.Nothing, parameters = Core.Nothing,
                         platformTypes = Core.Nothing, requires = Core.Nothing,
                         schemaVersion = Core.Nothing, sha1 = Core.Nothing,
                         status = Core.Nothing, statusInformation = Core.Nothing,
                         tags = Core.Nothing, targetType = Core.Nothing,
...
{-# INLINEABLE ddAttachmentsInformation #-}
{-# DEPRECATED attachmentsInformation "Use generic-lens or generic-optics with 'attachmentsInformation' instead"  #-}
...
{-# INLINEABLE ddSha1 #-}
{-# DEPRECATED sha1 "Use generic-lens or generic-optics with 'sha1' instead"  #-}
...
{-# INLINEABLE ddStatusInformation #-}
...
instance Core.FromJSON DocumentDescription where
        parseJSON
          = Core.withObject "DocumentDescription" Core.$
              \ x ->
                DocumentDescription' Core.<$>
                  (x Core..:? "AttachmentsInformation") Core.<*>
                    x Core..:? "CreatedDate"
