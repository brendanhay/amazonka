...
instance Core.ToQuery PutGroupPolicy where
        toQuery PutGroupPolicy{..}
          = Core.toQueryPair "Action" ("PutGroupPolicy" :: Core.Text) Core.<>
...
instance Core.AWSRequest PutGroupPolicy where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull PutGroupPolicyResponse'
