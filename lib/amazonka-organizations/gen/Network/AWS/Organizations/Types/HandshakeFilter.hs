...
mkHandshakeFilter
    :: HandshakeFilter
mkHandshakeFilter
  = HandshakeFilter'{actionType = Core.Nothing,
...
{-# INLINEABLE hfParentHandshakeId #-}
{-# DEPRECATED parentHandshakeId "Use generic-lens or generic-optics with 'parentHandshakeId' instead"  #-}
