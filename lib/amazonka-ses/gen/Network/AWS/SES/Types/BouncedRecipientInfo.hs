...
mkBouncedRecipientInfo recipient
  = BouncedRecipientInfo'{recipient, bounceType = Core.Nothing,
                          recipientArn = Core.Nothing, recipientDsnFields = Core.Nothing}
...
{-# INLINEABLE briRecipient #-}
{-# DEPRECATED recipient "Use generic-lens or generic-optics with 'recipient' instead"  #-}
...
{-# INLINEABLE briBounceType #-}
{-# DEPRECATED bounceType "Use generic-lens or generic-optics with 'bounceType' instead"  #-}
...
{-# INLINEABLE briRecipientArn #-}
{-# DEPRECATED recipientArn "Use generic-lens or generic-optics with 'recipientArn' instead"  #-}
...
{-# INLINEABLE briRecipientDsnFields #-}
{-# DEPRECATED recipientDsnFields "Use generic-lens or generic-optics with 'recipientDsnFields' instead"  #-}

instance Core.ToQuery BouncedRecipientInfo where
        toQuery BouncedRecipientInfo{..}
          = Core.toQueryPair "Recipient" recipient Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "BounceType") bounceType
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "RecipientArn")
                recipientArn
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "RecipientDsnFields")
                recipientDsnFields
