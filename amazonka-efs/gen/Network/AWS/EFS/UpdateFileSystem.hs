...
data UpdateFileSystem = UpdateFileSystem'
  { _ufsProvisionedThroughputInMibps :: !(Maybe Double)
...
--
-- * 'ufsProvisionedThroughputInMibps' - (Optional) The amount of throughput, in MiB/s, that you want to provision for your file system. If you're not updating the amount of provisioned throughput for your file system, you don't need to provide this value in your request.
--
-- * 'ufsThroughputMode' - (Optional) The throughput mode that you want your file system to use. If you're not updating your throughput mode, you don't need to provide this value in your request.
--
