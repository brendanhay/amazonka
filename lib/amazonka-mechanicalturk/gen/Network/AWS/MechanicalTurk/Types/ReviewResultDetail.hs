...
mkReviewResultDetail
    :: ReviewResultDetail
mkReviewResultDetail
  = ReviewResultDetail'{actionId = Core.Nothing, key = Core.Nothing,
                        questionId = Core.Nothing, subjectId = Core.Nothing,
                        subjectType = Core.Nothing, value = Core.Nothing}
...
{-# INLINEABLE rrdQuestionId #-}
{-# DEPRECATED questionId "Use generic-lens or generic-optics with 'questionId' instead"  #-}
...
{-# INLINEABLE rrdSubjectId #-}
{-# DEPRECATED subjectId "Use generic-lens or generic-optics with 'subjectId' instead"  #-}
...
instance Core.FromJSON ReviewResultDetail where
        parseJSON
          = Core.withObject "ReviewResultDetail" Core.$
              \ x ->
                ReviewResultDetail' Core.<$>
                  (x Core..:? "ActionId") Core.<*> x Core..:? "Key" Core.<*>
                    x Core..:? "QuestionId"
