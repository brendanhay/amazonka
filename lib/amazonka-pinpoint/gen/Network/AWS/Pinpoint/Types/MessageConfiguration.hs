...
mkMessageConfiguration
    :: MessageConfiguration
mkMessageConfiguration
  = MessageConfiguration'{aDMMessage = Core.Nothing,
                          aPNSMessage = Core.Nothing, baiduMessage = Core.Nothing,
                          customMessage = Core.Nothing, defaultMessage = Core.Nothing,
          ...
          = Core.withObject "MessageConfiguration" Core.$
              \ x ->
                MessageConfiguration' Core.<$>
                  (x Core..:? "ADMMessage") Core.<*> x Core..:? "APNSMessage"
