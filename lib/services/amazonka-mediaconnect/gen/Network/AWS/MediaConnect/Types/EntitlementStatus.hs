...
-- |
-- Module      : Network.AWS.MediaConnect.Types.EntitlementStatus
...
pattern EntitlementStatus_DISABLED = EntitlementStatus' "DISABLED"

pattern EntitlementStatus_ENABLED :: EntitlementStatus
pattern EntitlementStatus_ENABLED = EntitlementStatus' "ENABLED"
