...
instance Core.AWSRequest ListPhoneNumbersOptedOut where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListPhoneNumbersOptedOutResult"
              (\ s h x ->
                 ListPhoneNumbersOptedOutResponse' Core.<$>
                   (x Core..@? "nextToken") Core.<*>
                     x Core..@? "phoneNumbers" Core..<@> Core.parseXMLList "member"
...
mkListPhoneNumbersOptedOutResponse responseStatus
  = ListPhoneNumbersOptedOutResponse'{nextToken = Core.Nothing,
                                      phoneNumbers = Core.Nothing, responseStatus}

-- | A @NextToken@ string is returned when you call the @ListPhoneNumbersOptedOut@ action if additional records are available after the first page of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
lpnoorrsNextToken :: Lens.Lens' ListPhoneNumbersOptedOutResponse (Core.Maybe Core.Text)
lpnoorrsNextToken = Lens.field @"nextToken"
{-# INLINEABLE lpnoorrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE lpnoorrsPhoneNumbers #-}
...
{-# INLINEABLE lpnoorrsResponseStatus #-}
