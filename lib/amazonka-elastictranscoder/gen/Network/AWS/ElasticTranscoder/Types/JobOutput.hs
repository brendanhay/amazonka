...
data JobOutput = JobOutput'
  { -- | The album art to be associated with the output file, if any.
    ...
    appliedColorSpaceConversion :: Core.Maybe Types.String,
...
joAppliedColorSpaceConversion :: Lens.Lens' JobOutput (Core.Maybe Types.String)
...
joId :: Lens.Lens' JobOutput (Core.Maybe Types.String)
joId = Lens.field @"id"
...
instance Core.FromJSON JobOutput where
  parseJSON =
    Core.withObject "JobOutput" Core.$
      \x ->
        JobOutput'
          Core.<$> (x Core..:? "AlbumArt")
          Core.<*> (x Core..:? "AppliedColorSpaceConversion")
