...
gqaQueueUrl :: Lens.Lens' GetQueueAttributes Types.String
  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqBody =
          Core.toFormBody
            ( Core.pure ("Action", "GetQueueAttributes")
...
gqarrsAttributes :: Lens.Lens' GetQueueAttributesResponse (Core.Maybe (Core.HashMap Types.QueueAttributeName Types.String))
gqarrsAttributes = Lens.field @"attributes"
{-# DEPRECATED gqarrsAttributes "Use generic-lens or generic-optics with 'attributes' instead." #-}
...
{-# DEPRECATED gqarrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
