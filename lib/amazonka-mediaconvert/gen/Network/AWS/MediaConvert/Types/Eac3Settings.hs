...
mkEac3Settings
  = Eac3Settings'{attenuationControl = Core.Nothing,
                  ...
                  lfeControl = Core.Nothing, lfeFilter = Core.Nothing,
                  ...
                  phaseControl = Core.Nothing, sampleRate = Core.Nothing,
...
{-# INLINEABLE esDynamicRangeCompressionLine #-}
...
{-# INLINEABLE esDynamicRangeCompressionRf #-}
