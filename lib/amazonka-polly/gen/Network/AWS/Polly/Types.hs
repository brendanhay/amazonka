...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Polly",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "polly",
                 Core._svcVersion = "2016-06-10", Core._svcTimeout = Core.Just 70,
...
_UnsupportedPlsLanguageException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _UnsupportedPlsLanguageException #-}
...
_InvalidSsmlException
  = Core._MatchServiceError mkServiceConfig "InvalidSsmlException"
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidSsmlException #-}
...
_InvalidSampleRateException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidSampleRateException #-}
...
_EngineNotSupportedException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _EngineNotSupportedException #-}
...
_MaxLexiconsNumberExceededException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _MaxLexiconsNumberExceededException #-}
...
_TextLengthExceededException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _TextLengthExceededException #-}
...
_MaxLexemeLengthExceededException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _MaxLexemeLengthExceededException #-}
...
_InvalidTaskIdException
  = Core._MatchServiceError mkServiceConfig "InvalidTaskIdException"
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidTaskIdException #-}
...
_InvalidLexiconException
  = Core._MatchServiceError mkServiceConfig "InvalidLexiconException"
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidLexiconException #-}
...
_UnsupportedPlsAlphabetException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _UnsupportedPlsAlphabetException #-}
...
_MarksNotSupportedForFormatException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _MarksNotSupportedForFormatException #-}
...
_SynthesisTaskNotFoundException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _SynthesisTaskNotFoundException #-}
...
_SsmlMarksNotSupportedForTextTypeException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _SsmlMarksNotSupportedForTextTypeException #-}
...
_InvalidS3BucketException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidS3BucketException #-}
...
_LexiconSizeExceededException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _LexiconSizeExceededException #-}
...
_LanguageNotSupportedException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _LanguageNotSupportedException #-}
...
{-# INLINEABLE _LexiconNotFoundException #-}
...
_InvalidS3KeyException
  = Core._MatchServiceError mkServiceConfig "InvalidS3KeyException"
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidS3KeyException #-}
