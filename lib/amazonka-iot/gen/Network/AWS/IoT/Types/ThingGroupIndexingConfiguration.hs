...
mkThingGroupIndexingConfiguration
    :: Types.ThingGroupIndexingMode -- ^ 'thingGroupIndexingMode'
    -> ThingGroupIndexingConfiguration
...
{-# INLINEABLE tgicThingGroupIndexingMode #-}
{-# DEPRECATED thingGroupIndexingMode "Use generic-lens or generic-optics with 'thingGroupIndexingMode' instead"  #-}
          ...
          = Core.withObject "ThingGroupIndexingConfiguration" Core.$
              \ x ->
                ThingGroupIndexingConfiguration' Core.<$>
                  (x Core..: "thingGroupIndexingMode") Core.<*>
                    x Core..:? "customFields"
