...
mkGetOrganizationsAccessReport jobId
  = GetOrganizationsAccessReport'{jobId, marker = Core.Nothing,
                                  maxItems = Core.Nothing, sortKey = Core.Nothing}
...
{-# INLINEABLE goarSortKey #-}
{-# DEPRECATED sortKey "Use generic-lens or generic-optics with 'sortKey' instead"  #-}

instance Core.ToQuery GetOrganizationsAccessReport where
        toQuery GetOrganizationsAccessReport{..}
          = Core.toQueryPair "Action"
              ("GetOrganizationsAccessReport" :: Core.Text)
              Core.<> Core.toQueryPair "Version" ("2010-05-08" :: Core.Text)
              Core.<> Core.toQueryPair "JobId" jobId
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "Marker") marker
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "MaxItems") maxItems
              Core.<> Core.maybe Core.mempty (Core.toQueryPair "SortKey") sortKey
...
instance Core.AWSRequest GetOrganizationsAccessReport where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "GetOrganizationsAccessReportResult"
              (\ s h x ->
                 GetOrganizationsAccessReportResponse' Core.<$>
                   (x Core..@ "JobStatus") Core.<*> x Core..@ "JobCreationDate"
                     Core.<*>
                     x Core..@? "AccessDetails" Core..<@> Core.parseXMLList "member"
...
mkGetOrganizationsAccessReportResponse
    ...
    -> GetOrganizationsAccessReportResponse
mkGetOrganizationsAccessReportResponse jobStatus jobCreationDate
  responseStatus
  = GetOrganizationsAccessReportResponse'{jobStatus, jobCreationDate,
                                          accessDetails = Core.Nothing, errorDetails = Core.Nothing,
                                          isTruncated = Core.Nothing,
                                          jobCompletionDate = Core.Nothing, marker = Core.Nothing,
...
{-# INLINEABLE goarrfrsJobCreationDate #-}
...
{-# INLINEABLE goarrfrsAccessDetails #-}
...
{-# INLINEABLE goarrfrsErrorDetails #-}
...
{-# INLINEABLE goarrfrsIsTruncated #-}
...
{-# INLINEABLE goarrfrsJobCompletionDate #-}
...
{-# INLINEABLE goarrfrsNumberOfServicesAccessible #-}
{-# DEPRECATED numberOfServicesAccessible "Use generic-lens or generic-optics with 'numberOfServicesAccessible' instead"  #-}
...
{-# INLINEABLE goarrfrsNumberOfServicesNotAccessed #-}
{-# DEPRECATED numberOfServicesNotAccessed "Use generic-lens or generic-optics with 'numberOfServicesNotAccessed' instead"  #-}
...
{-# INLINEABLE goarrfrsResponseStatus #-}
