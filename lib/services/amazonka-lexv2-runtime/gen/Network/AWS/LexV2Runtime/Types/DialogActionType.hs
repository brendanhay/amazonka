...
-- |
-- Module      : Network.AWS.LexV2Runtime.Types.DialogActionType
...
pattern DialogActionType_None :: DialogActionType
pattern DialogActionType_None = DialogActionType' "None"
