...
mkFailedResource
    :: FailedResource
mkFailedResource
  = FailedResource'{errorCode = Core.Nothing,
                    errorMessage = Core.Nothing, resourceArn = Core.Nothing}
