...
safKMSKeyARN :: Lens.Lens' S3Action (Lude.Maybe Lude.Text)
safKMSKeyARN = Lens.lens (kmsKeyARN :: S3Action -> Lude.Maybe Lude.Text) (\s a -> s {kmsKeyARN = a} :: S3Action)
{-# DEPRECATED safKMSKeyARN "Use generic-lens or generic-optics with 'kmsKeyARN' instead." #-}
...
safBucketName :: Lens.Lens' S3Action Lude.Text
safBucketName = Lens.lens (bucketName :: S3Action -> Lude.Text) (\s a -> s {bucketName = a} :: S3Action)
{-# DEPRECATED safBucketName "Use generic-lens or generic-optics with 'bucketName' instead." #-}

-- | The ARN of the Amazon SNS topic to notify when the message is saved to the Amazon S3 bucket. An example of an Amazon SNS topic ARN is @arn:aws:sns:us-west-2:123456789012:MyTopic@ . For more information about Amazon SNS topics, see the <https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html Amazon SNS Developer Guide> .
--
-- /Note:/ Consider using 'topicARN' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
safTopicARN :: Lens.Lens' S3Action (Lude.Maybe Lude.Text)
safTopicARN = Lens.lens (topicARN :: S3Action -> Lude.Maybe Lude.Text) (\s a -> s {topicARN = a} :: S3Action)
{-# DEPRECATED safTopicARN "Use generic-lens or generic-optics with 'topicARN' instead." #-}
...
safObjectKeyPrefix :: Lens.Lens' S3Action (Lude.Maybe Lude.Text)
safObjectKeyPrefix = Lens.lens (objectKeyPrefix :: S3Action -> Lude.Maybe Lude.Text) (\s a -> s {objectKeyPrefix = a} :: S3Action)
{-# DEPRECATED safObjectKeyPrefix "Use generic-lens or generic-optics with 'objectKeyPrefix' instead." #-}
