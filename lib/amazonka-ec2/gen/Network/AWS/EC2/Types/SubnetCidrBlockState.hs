...
mkSubnetCidrBlockState
    :: SubnetCidrBlockState
mkSubnetCidrBlockState
  = SubnetCidrBlockState'{state = Core.Nothing,
...
{-# INLINEABLE scbsState #-}
{-# DEPRECATED state "Use generic-lens or generic-optics with 'state' instead"  #-}

-- | A message about the status of the CIDR block, if applicable.
--
-- /Note:/ Consider using 'statusMessage' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
scbsStatusMessage :: Lens.Lens' SubnetCidrBlockState (Core.Maybe Core.Text)
scbsStatusMessage = Lens.field @"statusMessage"
{-# INLINEABLE scbsStatusMessage #-}
