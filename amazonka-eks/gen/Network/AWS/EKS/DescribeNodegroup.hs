...
instance Prelude.AWSRequest DescribeNodegroup where
...
instance Prelude.ToHeaders DescribeNodegroup where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath DescribeNodegroup where
...
instance Prelude.ToQuery DescribeNodegroup where
