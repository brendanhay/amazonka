...
mkEncryption
    :: Types.ServerSideEncryption -- ^ 'encryptionType'
    -> Encryption
mkEncryption encryptionType
  = Encryption'{encryptionType, kMSContext = Core.Nothing,
...
instance Core.ToXML Encryption where
        toXML Encryption{..}
          = Core.toXMLElement "EncryptionType" encryptionType Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "KMSContext") kMSContext
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "KMSKeyId") kMSKeyId
