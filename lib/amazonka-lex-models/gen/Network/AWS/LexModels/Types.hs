...
import Network.AWS.LexModels.Types.Checksum
...
import Network.AWS.LexModels.Types.ImportId
...
import Network.AWS.LexModels.Types.String
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "LexModels",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "models.lex",
