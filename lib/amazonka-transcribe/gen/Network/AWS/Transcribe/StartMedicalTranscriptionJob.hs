...
{-# DEPRECATED smtjrrsMedicalTranscriptionJob "Use generic-lens or generic-optics with 'medicalTranscriptionJob' instead." #-}
...
{-# DEPRECATED smtjrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
