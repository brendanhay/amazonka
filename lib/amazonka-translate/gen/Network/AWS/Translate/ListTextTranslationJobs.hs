...
mkListTextTranslationJobs
    :: ListTextTranslationJobs
mkListTextTranslationJobs
  = ListTextTranslationJobs'{filter = Core.Nothing,
...
instance Core.ToHeaders ListTextTranslationJobs where
        toHeaders ListTextTranslationJobs{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest ListTextTranslationJobs where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListTextTranslationJobsResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*>
                     x Core..:? "TextTranslationJobPropertiesList"
...
mkListTextTranslationJobsResponse responseStatus
  = ListTextTranslationJobsResponse'{nextToken = Core.Nothing,
...
{-# INLINEABLE lttjrrsTextTranslationJobPropertiesList #-}
{-# DEPRECATED textTranslationJobPropertiesList "Use generic-lens or generic-optics with 'textTranslationJobPropertiesList' instead"  #-}
...
{-# INLINEABLE lttjrrsResponseStatus #-}
