...
{-# INLINEABLE dmwDeferMaintenanceEndTime #-}
...
dmwDeferMaintenanceIdentifier :: Lens.Lens' DeferredMaintenanceWindow (Core.Maybe Core.Text)
dmwDeferMaintenanceIdentifier = Lens.field @"deferMaintenanceIdentifier"
{-# INLINEABLE dmwDeferMaintenanceIdentifier #-}
...
{-# INLINEABLE dmwDeferMaintenanceStartTime #-}
...
instance Core.FromXML DeferredMaintenanceWindow where
        parseXML x
          = DeferredMaintenanceWindow' Core.<$>
              (x Core..@? "DeferMaintenanceEndTime") Core.<*>
                x Core..@? "DeferMaintenanceIdentifier"
