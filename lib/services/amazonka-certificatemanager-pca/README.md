...
`2.0` - Derived from API version @2017-08-22@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.CertificateManagerPCA](http://hackage.haskell.org/package/amazonka-certificatemanager-pca/docs/Amazonka-CertificateManagerPCA.html)
