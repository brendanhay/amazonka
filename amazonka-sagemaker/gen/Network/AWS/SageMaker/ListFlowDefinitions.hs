...
listFlowDefinitions_creationTimeBefore = Lens.lens (\ListFlowDefinitions' {creationTimeBefore} -> creationTimeBefore) (\s@ListFlowDefinitions' {} a -> s {creationTimeBefore = a} :: ListFlowDefinitions) Prelude.. Lens.mapping Prelude._Time

-- | A filter that returns only flow definitions with a creation time greater
-- than or equal to the specified timestamp.
listFlowDefinitions_creationTimeAfter :: Lens.Lens' ListFlowDefinitions (Prelude.Maybe Prelude.UTCTime)
listFlowDefinitions_creationTimeAfter = Lens.lens (\ListFlowDefinitions' {creationTimeAfter} -> creationTimeAfter) (\s@ListFlowDefinitions' {} a -> s {creationTimeAfter = a} :: ListFlowDefinitions) Prelude.. Lens.mapping Prelude._Time
...
instance Prelude.AWSRequest ListFlowDefinitions where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          ListFlowDefinitionsResponse'
            ...
            Prelude.<*> ( x Prelude..?> "FlowDefinitionSummaries"
...
instance Prelude.ToHeaders ListFlowDefinitions where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "SageMaker.ListFlowDefinitions" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON ListFlowDefinitions where
...
instance Prelude.ToPath ListFlowDefinitions where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListFlowDefinitions where
...
listFlowDefinitionsResponse_flowDefinitionSummaries = Lens.lens (\ListFlowDefinitionsResponse' {flowDefinitionSummaries} -> flowDefinitionSummaries) (\s@ListFlowDefinitionsResponse' {} a -> s {flowDefinitionSummaries = a} :: ListFlowDefinitionsResponse) Prelude.. Prelude._Coerce
