...
mkVideoDescription name
  = VideoDescription'{name, codecSettings = Core.Nothing,
                      height = Core.Nothing, respondToAfd = Core.Nothing,
                      scalingBehavior = Core.Nothing, sharpness = Core.Nothing,
                      width = Core.Nothing}
...
{-# INLINEABLE vdRespondToAfd #-}
{-# DEPRECATED respondToAfd "Use generic-lens or generic-optics with 'respondToAfd' instead"  #-}
...
{-# INLINEABLE vdScalingBehavior #-}
{-# DEPRECATED scalingBehavior "Use generic-lens or generic-optics with 'scalingBehavior' instead"  #-}
          ...
          = Core.withObject "VideoDescription" Core.$
              \ x ->
                VideoDescription' Core.<$>
                  (x Core..: "name") Core.<*> x Core..:? "codecSettings" Core.<*>
                    x Core..:? "height"
