...
data ScalingInstruction = ScalingInstruction'
  { -- | The scalable dimension associated with the resource.
    ...
    scheduledActionBufferTime :: Lude.Maybe Lude.Natural,
    ...
    -- The range is 1-100.
    predictiveScalingMaxCapacityBuffer :: Lude.Maybe Lude.Int,
    ...
    scalingPolicyUpdateBehavior :: Lude.Maybe ScalingPolicyUpdateBehavior,
    ...
    customizedLoadMetricSpecification :: Lude.Maybe CustomizedLoadMetricSpecification,
    ...
    predictiveScalingMode :: Lude.Maybe PredictiveScalingMode,
    ...
    --
    -- Only valid when configuring predictive scaling.
    predictiveScalingMaxCapacityBehavior :: Lude.Maybe PredictiveScalingMaxCapacityBehavior,
    ...
    predefinedLoadMetricSpecification :: Lude.Maybe PredefinedLoadMetricSpecification
  }
