...
mkVersioningConfiguration
    :: VersioningConfiguration
mkVersioningConfiguration
  = VersioningConfiguration'{maxVersions = Core.Nothing,
...
{-# INLINEABLE vcMaxVersions #-}
{-# DEPRECATED maxVersions "Use generic-lens or generic-optics with 'maxVersions' instead"  #-}
          ...
          = Core.withObject "VersioningConfiguration" Core.$
              \ x ->
                VersioningConfiguration' Core.<$>
                  (x Core..:? "maxVersions") Core.<*> x Core..:? "unlimited"
