...
mkPutBucketLogging
    ...
    -> Types.BucketLoggingStatus -- ^ 'bucketLoggingStatus'
    -> PutBucketLogging
...
{-# INLINEABLE pblBucketLoggingStatus #-}
{-# DEPRECATED bucketLoggingStatus "Use generic-lens or generic-optics with 'bucketLoggingStatus' instead"  #-}
...
instance Core.AWSRequest PutBucketLogging where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull PutBucketLoggingResponse'
