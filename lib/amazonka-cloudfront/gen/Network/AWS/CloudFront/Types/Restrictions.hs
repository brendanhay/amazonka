...
mkRestrictions
    :: Types.GeoRestriction -- ^ 'geoRestriction'
    -> Restrictions
...
{-# INLINEABLE rGeoRestriction #-}
{-# DEPRECATED geoRestriction "Use generic-lens or generic-optics with 'geoRestriction' instead"  #-}

instance Core.ToXML Restrictions where
        toXML Restrictions{..}
          = Core.toXMLElement "GeoRestriction" geoRestriction
