...
mkGlobalSecondaryIndexInfo
    :: GlobalSecondaryIndexInfo
mkGlobalSecondaryIndexInfo
  = GlobalSecondaryIndexInfo'{indexName = Core.Nothing,
...
{-# INLINEABLE gsiiProvisionedThroughput #-}
