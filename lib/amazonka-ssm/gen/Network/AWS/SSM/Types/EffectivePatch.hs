...
{-# INLINEABLE epPatch #-}
{-# DEPRECATED patch "Use generic-lens or generic-optics with 'patch' instead"  #-}
...
{-# INLINEABLE epPatchStatus #-}
{-# DEPRECATED patchStatus "Use generic-lens or generic-optics with 'patchStatus' instead"  #-}
...
instance Core.FromJSON EffectivePatch where
        parseJSON
          = Core.withObject "EffectivePatch" Core.$
              \ x ->
                EffectivePatch' Core.<$>
                  (x Core..:? "Patch") Core.<*> x Core..:? "PatchStatus"
