...
{-# INLINEABLE spprsCurrentOnDemandSpend #-}
{-# DEPRECATED currentOnDemandSpend "Use generic-lens or generic-optics with 'currentOnDemandSpend' instead"  #-}
...
{-# INLINEABLE spprsDailyCommitmentToPurchase #-}
{-# DEPRECATED dailyCommitmentToPurchase "Use generic-lens or generic-optics with 'dailyCommitmentToPurchase' instead"  #-}
...
{-# INLINEABLE spprsEstimatedMonthlySavingsAmount #-}
...
{-# INLINEABLE spprsEstimatedOnDemandCostWithCurrentCommitment #-}
...
{-# INLINEABLE spprsEstimatedSavingsAmount #-}
...
{-# INLINEABLE spprsEstimatedSavingsPercentage #-}
...
{-# INLINEABLE spprsEstimatedTotalCost #-}
{-# DEPRECATED estimatedTotalCost "Use generic-lens or generic-optics with 'estimatedTotalCost' instead"  #-}
...
{-# INLINEABLE spprsHourlyCommitmentToPurchase #-}
...
{-# INLINEABLE spprsTotalRecommendationCount #-}
{-# DEPRECATED totalRecommendationCount "Use generic-lens or generic-optics with 'totalRecommendationCount' instead"  #-}

instance Core.FromJSON SavingsPlansPurchaseRecommendationSummary
         where
        parseJSON
          = Core.withObject "SavingsPlansPurchaseRecommendationSummary"
              Core.$
              \ x ->
                SavingsPlansPurchaseRecommendationSummary' Core.<$>
                  (x Core..:? "CurrencyCode") Core.<*>
                    x Core..:? "CurrentOnDemandSpend"
