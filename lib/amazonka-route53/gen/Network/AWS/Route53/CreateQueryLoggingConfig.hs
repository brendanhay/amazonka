...
mkCreateQueryLoggingConfig hostedZoneId cloudWatchLogsLogGroupArn
  = CreateQueryLoggingConfig'{hostedZoneId,
...
{-# INLINEABLE cqlcCloudWatchLogsLogGroupArn #-}
...
instance Core.ToXML CreateQueryLoggingConfig where
        toXML CreateQueryLoggingConfig{..}
          = Core.toXMLElement "HostedZoneId" hostedZoneId Core.<>
              Core.toXMLElement "CloudWatchLogsLogGroupArn"
                cloudWatchLogsLogGroupArn
        toXMLDocument
          = Core.newXMLDocument
...
instance Core.AWSRequest CreateQueryLoggingConfig where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/2013-04-01/queryloggingconfig",
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 CreateQueryLoggingConfigResponse' Core.<$>
...
mkCreateQueryLoggingConfigResponse
    ...
    -> CreateQueryLoggingConfigResponse
mkCreateQueryLoggingConfigResponse queryLoggingConfig location
  responseStatus
  = CreateQueryLoggingConfigResponse'{queryLoggingConfig, location,
                                      responseStatus}
...
{-# INLINEABLE cqlcrrsQueryLoggingConfig #-}
...
{-# INLINEABLE cqlcrrsResponseStatus #-}
