...
import Network.AWS.CloudSearch.Types.JapaneseTokenizationDictionary
...
import Network.AWS.CloudSearch.Types.SortExpression
...
import Network.AWS.CloudSearch.Types.StemmingDictionary
import Network.AWS.CloudSearch.Types.Stopwords
...
import Network.AWS.CloudSearch.Types.Synonyms
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "CloudSearch",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "cloudsearch",
...
_DisabledOperationException =
  Core._MatchServiceError mkServiceConfig "DisabledAction"
...
_InvalidTypeException =
  Core._MatchServiceError mkServiceConfig "InvalidType"
    Core.. Core.hasStatues 409
