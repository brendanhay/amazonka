...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "DataPipeline",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "datapipeline",
                 Core._svcVersion = "2012-10-29", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _PipelineDeletedException #-}
...
{-# INLINEABLE _TaskNotFoundException #-}
