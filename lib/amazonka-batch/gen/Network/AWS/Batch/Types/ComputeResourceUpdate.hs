...
mkComputeResourceUpdate
    :: ComputeResourceUpdate
mkComputeResourceUpdate
  = ComputeResourceUpdate'{desiredvCpus = Core.Nothing,
                           maxvCpus = Core.Nothing, minvCpus = Core.Nothing}
