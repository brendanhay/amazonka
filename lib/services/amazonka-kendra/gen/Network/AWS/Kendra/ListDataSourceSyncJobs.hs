...
-- |
-- Module      : Network.AWS.Kendra.ListDataSourceSyncJobs
...
-- can use this pagination token to retrieve the next set of jobs.
--
-- 'statusFilter', 'listDataSourceSyncJobs_statusFilter' - When specified, only returns synchronization jobs with the @Status@
-- field equal to the specified status.
--
...
-- actual results.
--
-- 'id', 'listDataSourceSyncJobs_id' - The identifier of the data source.
--
-- 'indexId', 'listDataSourceSyncJobs_indexId' - The identifier of the index that contains the data source.
newListDataSourceSyncJobs ::
  -- | 'id'
  Prelude.Text ->
  -- | 'indexId'
...
instance Prelude.Hashable ListDataSourceSyncJobs

instance Prelude.NFData ListDataSourceSyncJobs
...
-- for backwards compatibility:
--
-- 'history', 'listDataSourceSyncJobsResponse_history' - A history of synchronization jobs for the data source.
--
