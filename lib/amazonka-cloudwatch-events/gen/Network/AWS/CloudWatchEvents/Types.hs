...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CloudWatchEvents",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "events",
                 Core._svcVersion = "2015-10-07", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _ManagedRuleException #-}
...
{-# INLINEABLE _IllegalStatusException #-}
...
{-# INLINEABLE _OperationDisabledException #-}
...
{-# INLINEABLE _InvalidEventPatternException #-}
