...
module Network.AWS.SWF.V2012_01_25.RespondActivityTaskFailed
    ...
    -- ** Request constructor
    , mkRespondActivityTaskFailedInput
    -- ** Request lenses
    , ratfiTaskToken
    , ratfiReason
    , ratfiDetails
...
mkRespondActivityTaskFailedInput :: Text -- ^ 'ratfiTaskToken'
                                 -> RespondActivityTaskFailed
mkRespondActivityTaskFailedInput p1 = RespondActivityTaskFailed
    { _ratfiTaskToken = p1
    , _ratfiReason = Nothing
    , _ratfiDetails = Nothing
    }
{-# INLINE mkRespondActivityTaskFailedInput #-}
...
ratfiTaskToken = lens _ratfiTaskToken (\s a -> s { _ratfiTaskToken = a })
{-# INLINE ratfiTaskToken #-}

-- | Description of the error that may assist in diagnostics.
ratfiReason :: Lens' RespondActivityTaskFailed (Maybe Text)
ratfiReason = lens _ratfiReason (\s a -> s { _ratfiReason = a })
{-# INLINE ratfiReason #-}

-- | Optional detailed information about the failure.
ratfiDetails :: Lens' RespondActivityTaskFailed (Maybe Text)
ratfiDetails = lens _ratfiDetails (\s a -> s { _ratfiDetails = a })
{-# INLINE ratfiDetails #-}
