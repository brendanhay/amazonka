...
import Network.AWS.ElasticBeanstalk.Types.Name
...
import Network.AWS.ElasticBeanstalk.Types.ServiceRole
...
import Network.AWS.ElasticBeanstalk.Types.String
...
import Network.AWS.ElasticBeanstalk.Types.Version
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "ElasticBeanstalk",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "elasticbeanstalk",
      Core._svcVersion = "2010-12-01",
