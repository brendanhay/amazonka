...
mkTestGridSessionArtifact
    :: TestGridSessionArtifact
mkTestGridSessionArtifact
  = TestGridSessionArtifact'{filename = Core.Nothing,
...
tgsaFilename :: Lens.Lens' TestGridSessionArtifact (Core.Maybe Core.Text)
tgsaFilename = Lens.field @"filename"
{-# INLINEABLE tgsaFilename #-}
...
tgsaUrl :: Lens.Lens' TestGridSessionArtifact (Core.Maybe Core.Text)
...
instance Core.FromJSON TestGridSessionArtifact where
        parseJSON
          = Core.withObject "TestGridSessionArtifact" Core.$
              \ x ->
                TestGridSessionArtifact' Core.<$>
                  (x Core..:? "filename") Core.<*> x Core..:? "type" Core.<*>
                    x Core..:? "url"
