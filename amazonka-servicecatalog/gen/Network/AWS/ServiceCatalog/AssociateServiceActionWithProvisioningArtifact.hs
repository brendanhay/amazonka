...
data AssociateServiceActionWithProvisioningArtifact = AssociateServiceActionWithProvisioningArtifact'
  { _asawpaAcceptLanguage         :: !(Maybe Text)
  , _asawpaProductId              :: !Text
  , _asawpaProvisioningArtifactId :: !Text
  , _asawpaServiceActionId        :: !Text
...
associateServiceActionWithProvisioningArtifact
    ...
    -> AssociateServiceActionWithProvisioningArtifact
associateServiceActionWithProvisioningArtifact pProductId_ pProvisioningArtifactId_ pServiceActionId_ =
  AssociateServiceActionWithProvisioningArtifact'
    { _asawpaAcceptLanguage = Nothing
    , _asawpaProductId = pProductId_
    , _asawpaProvisioningArtifactId = pProvisioningArtifactId_
...
associateServiceActionWithProvisioningArtifactResponse
    ...
    -> AssociateServiceActionWithProvisioningArtifactResponse
associateServiceActionWithProvisioningArtifactResponse pResponseStatus_ =
  AssociateServiceActionWithProvisioningArtifactResponse'
    {_asawparsResponseStatus = pResponseStatus_}
