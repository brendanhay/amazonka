...
mkPutThirdPartyJobSuccessResult jobId clientToken
  = PutThirdPartyJobSuccessResult'{jobId, clientToken,
                                   continuationToken = Core.Nothing, currentRevision = Core.Nothing,
...
{-# INLINEABLE ptpjsrContinuationToken #-}
...
{-# INLINEABLE ptpjsrCurrentRevision #-}
...
{-# INLINEABLE ptpjsrExecutionDetails #-}
