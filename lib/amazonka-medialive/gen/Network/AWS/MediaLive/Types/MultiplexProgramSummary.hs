...
mkMultiplexProgramSummary
    :: MultiplexProgramSummary
mkMultiplexProgramSummary
  = MultiplexProgramSummary'{channelId = Core.Nothing,
...
instance Core.FromJSON MultiplexProgramSummary where
        parseJSON
          = Core.withObject "MultiplexProgramSummary" Core.$
              \ x ->
                MultiplexProgramSummary' Core.<$>
                  (x Core..:? "channelId") Core.<*> x Core..:? "programName"
