...
data CopyDBSnapshot = CopyDBSnapshot'
  { -- | The external custom Availability Zone (CAZ) identifier for the target CAZ.
    ...
    targetCustomAvailabilityZone :: Lude.Maybe Lude.Text,
...
cdbsrsDBSnapshot :: Lens.Lens' CopyDBSnapshotResponse (Lude.Maybe DBSnapshot)
cdbsrsDBSnapshot = Lens.lens (dbSnapshot :: CopyDBSnapshotResponse -> Lude.Maybe DBSnapshot) (\s a -> s {dbSnapshot = a} :: CopyDBSnapshotResponse)
{-# DEPRECATED cdbsrsDBSnapshot "Use generic-lens or generic-optics with 'dbSnapshot' instead." #-}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
cdbsrsResponseStatus :: Lens.Lens' CopyDBSnapshotResponse Lude.Int
cdbsrsResponseStatus = Lens.lens (responseStatus :: CopyDBSnapshotResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: CopyDBSnapshotResponse)
