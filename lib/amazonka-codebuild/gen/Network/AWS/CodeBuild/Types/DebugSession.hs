...
mkDebugSession
    :: DebugSession
mkDebugSession
  = DebugSession'{sessionEnabled = Core.Nothing,
...
{-# INLINEABLE dsSessionEnabled #-}
{-# DEPRECATED sessionEnabled "Use generic-lens or generic-optics with 'sessionEnabled' instead"  #-}
...
{-# INLINEABLE dsSessionTarget #-}
{-# DEPRECATED sessionTarget "Use generic-lens or generic-optics with 'sessionTarget' instead"  #-}
...
instance Core.FromJSON DebugSession where
        parseJSON
          = Core.withObject "DebugSession" Core.$
              \ x ->
                DebugSession' Core.<$>
                  (x Core..:? "sessionEnabled") Core.<*> x Core..:? "sessionTarget"
