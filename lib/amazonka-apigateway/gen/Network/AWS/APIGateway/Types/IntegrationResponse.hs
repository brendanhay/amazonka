...
ifContentHandling :: Lens.Lens' IntegrationResponse (Lude.Maybe ContentHandlingStrategy)
ifContentHandling = Lens.lens (contentHandling :: IntegrationResponse -> Lude.Maybe ContentHandlingStrategy) (\s a -> s {contentHandling = a} :: IntegrationResponse)
{-# DEPRECATED ifContentHandling "Use generic-lens or generic-optics with 'contentHandling' instead." #-}
...
ifResponseTemplates :: Lens.Lens' IntegrationResponse (Lude.Maybe (Lude.HashMap Lude.Text (Lude.Text)))
ifResponseTemplates = Lens.lens (responseTemplates :: IntegrationResponse -> Lude.Maybe (Lude.HashMap Lude.Text (Lude.Text))) (\s a -> s {responseTemplates = a} :: IntegrationResponse)
{-# DEPRECATED ifResponseTemplates "Use generic-lens or generic-optics with 'responseTemplates' instead." #-}
...
ifSelectionPattern :: Lens.Lens' IntegrationResponse (Lude.Maybe Lude.Text)
ifSelectionPattern = Lens.lens (selectionPattern :: IntegrationResponse -> Lude.Maybe Lude.Text) (\s a -> s {selectionPattern = a} :: IntegrationResponse)
{-# DEPRECATED ifSelectionPattern "Use generic-lens or generic-optics with 'selectionPattern' instead." #-}

-- | Specifies the status code that is used to map the integration response to an existing 'MethodResponse' .
--
-- /Note:/ Consider using 'statusCode' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
ifStatusCode :: Lens.Lens' IntegrationResponse (Lude.Maybe Lude.Text)
ifStatusCode = Lens.lens (statusCode :: IntegrationResponse -> Lude.Maybe Lude.Text) (\s a -> s {statusCode = a} :: IntegrationResponse)
{-# DEPRECATED ifStatusCode "Use generic-lens or generic-optics with 'statusCode' instead." #-}
...
ifResponseParameters :: Lens.Lens' IntegrationResponse (Lude.Maybe (Lude.HashMap Lude.Text (Lude.Text)))
ifResponseParameters = Lens.lens (responseParameters :: IntegrationResponse -> Lude.Maybe (Lude.HashMap Lude.Text (Lude.Text))) (\s a -> s {responseParameters = a} :: IntegrationResponse)
{-# DEPRECATED ifResponseParameters "Use generic-lens or generic-optics with 'responseParameters' instead." #-}
