...
newtype DescribeHyperParameterTuningJob = DescribeHyperParameterTuningJob'
  { _dhptjHyperParameterTuningJobName :: Text
...
--
-- * 'dhptjHyperParameterTuningJobName' - The name of the tuning job to describe.
describeHyperParameterTuningJob
    :: Text -- ^ 'dhptjHyperParameterTuningJobName'
    -> DescribeHyperParameterTuningJob
describeHyperParameterTuningJob pHyperParameterTuningJobName_ =
  DescribeHyperParameterTuningJob'
    {_dhptjHyperParameterTuningJobName = pHyperParameterTuningJobName_}
...
instance AWSRequest DescribeHyperParameterTuningJob
         where
...
instance NFData DescribeHyperParameterTuningJob where

instance ToHeaders DescribeHyperParameterTuningJob
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery DescribeHyperParameterTuningJob
         where
...
data DescribeHyperParameterTuningJobResponse = DescribeHyperParameterTuningJobResponse'
  { _dhptjrsFailureReason :: !(Maybe Text)
  , _dhptjrsLastModifiedTime :: !(Maybe POSIX)
  , _dhptjrsBestTrainingJob :: !(Maybe HyperParameterTrainingJobSummary)
  , _dhptjrsHyperParameterTuningEndTime :: !(Maybe POSIX)
  , _dhptjrsOverallBestTrainingJob :: !(Maybe HyperParameterTrainingJobSummary)
  , _dhptjrsWarmStartConfig :: !(Maybe HyperParameterTuningJobWarmStartConfig)
  , _dhptjrsResponseStatus :: !Int
  , _dhptjrsHyperParameterTuningJobName :: !Text
  , _dhptjrsHyperParameterTuningJobARN :: !Text
  , _dhptjrsHyperParameterTuningJobConfig :: !HyperParameterTuningJobConfig
  , _dhptjrsTrainingJobDefinition :: !HyperParameterTrainingJobDefinition
  , _dhptjrsHyperParameterTuningJobStatus :: !HyperParameterTuningJobStatus
  , _dhptjrsCreationTime :: !POSIX
  , _dhptjrsTrainingJobStatusCounters :: !TrainingJobStatusCounters
  , _dhptjrsObjectiveStatusCounters :: !ObjectiveStatusCounters
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeHyperParameterTuningJobResponse
    :: Int -- ^ 'dhptjrsResponseStatus'
    -> Text -- ^ 'dhptjrsHyperParameterTuningJobName'
    -> Text -- ^ 'dhptjrsHyperParameterTuningJobARN'
    -> HyperParameterTuningJobConfig -- ^ 'dhptjrsHyperParameterTuningJobConfig'
    -> HyperParameterTrainingJobDefinition -- ^ 'dhptjrsTrainingJobDefinition'
    -> HyperParameterTuningJobStatus -- ^ 'dhptjrsHyperParameterTuningJobStatus'
    -> UTCTime -- ^ 'dhptjrsCreationTime'
    -> TrainingJobStatusCounters -- ^ 'dhptjrsTrainingJobStatusCounters'
    -> ObjectiveStatusCounters -- ^ 'dhptjrsObjectiveStatusCounters'
    -> DescribeHyperParameterTuningJobResponse
describeHyperParameterTuningJobResponse pResponseStatus_ pHyperParameterTuningJobName_ pHyperParameterTuningJobARN_ pHyperParameterTuningJobConfig_ pTrainingJobDefinition_ pHyperParameterTuningJobStatus_ pCreationTime_ pTrainingJobStatusCounters_ pObjectiveStatusCounters_ =
  DescribeHyperParameterTuningJobResponse'
    { _dhptjrsFailureReason = Nothing
    ...
    , _dhptjrsHyperParameterTuningJobName = pHyperParameterTuningJobName_
    , _dhptjrsHyperParameterTuningJobARN = pHyperParameterTuningJobARN_
    , _dhptjrsHyperParameterTuningJobConfig = pHyperParameterTuningJobConfig_
    , _dhptjrsTrainingJobDefinition = pTrainingJobDefinition_
    , _dhptjrsHyperParameterTuningJobStatus = pHyperParameterTuningJobStatus_
    , _dhptjrsCreationTime = _Time # pCreationTime_
    , _dhptjrsTrainingJobStatusCounters = pTrainingJobStatusCounters_
    , _dhptjrsObjectiveStatusCounters = pObjectiveStatusCounters_
    }
...
dhptjrsTrainingJobDefinition :: Lens' DescribeHyperParameterTuningJobResponse HyperParameterTrainingJobDefinition
