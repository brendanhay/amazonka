...
instance AWSRequest DisassociateClientVPNTargetNetwork where
  type
...
instance ToQuery DisassociateClientVPNTargetNetwork where
  toQuery DisassociateClientVPNTargetNetwork' {..} =
    mconcat
      [ "Action" =: ("DisassociateClientVpnTargetNetwork" :: ByteString),
...
instance NFData DisassociateClientVPNTargetNetworkResponse
