...
mkStartSigningJobParameter
    :: StartSigningJobParameter
mkStartSigningJobParameter
  = StartSigningJobParameter'{destination = Core.Nothing,
...
{-# INLINEABLE ssjpSigningProfileName #-}
{-# DEPRECATED signingProfileName "Use generic-lens or generic-optics with 'signingProfileName' instead"  #-}
...
{-# INLINEABLE ssjpSigningProfileParameter #-}
{-# DEPRECATED signingProfileParameter "Use generic-lens or generic-optics with 'signingProfileParameter' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("destination" Core..=) Core.<$> destination,
                  ...
                  ("signingProfileParameter" Core..=) Core.<$>
          ...
          = Core.withObject "StartSigningJobParameter" Core.$
              \ x ->
                StartSigningJobParameter' Core.<$>
                  (x Core..:? "destination") Core.<*> x Core..:? "signingProfileName"
