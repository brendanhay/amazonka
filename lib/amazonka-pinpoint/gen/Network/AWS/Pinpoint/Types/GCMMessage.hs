...
{-# DEPRECATED gcmmAction "Use generic-lens or generic-optics with 'action' instead." #-}
...
{-# DEPRECATED gcmmBody "Use generic-lens or generic-optics with 'body' instead." #-}
...
{-# DEPRECATED gcmmCollapseKey "Use generic-lens or generic-optics with 'collapseKey' instead." #-}
...
{-# DEPRECATED gcmmData "Use generic-lens or generic-optics with 'data'' instead." #-}
...
{-# DEPRECATED gcmmIconReference "Use generic-lens or generic-optics with 'iconReference' instead." #-}
...
{-# DEPRECATED gcmmImageIconUrl "Use generic-lens or generic-optics with 'imageIconUrl' instead." #-}
...
{-# DEPRECATED gcmmImageUrl "Use generic-lens or generic-optics with 'imageUrl' instead." #-}
...
{-# DEPRECATED gcmmPriority "Use generic-lens or generic-optics with 'priority' instead." #-}
...
{-# DEPRECATED gcmmRawContent "Use generic-lens or generic-optics with 'rawContent' instead." #-}
...
{-# DEPRECATED gcmmRestrictedPackageName "Use generic-lens or generic-optics with 'restrictedPackageName' instead." #-}
...
{-# DEPRECATED gcmmSilentPush "Use generic-lens or generic-optics with 'silentPush' instead." #-}
...
{-# DEPRECATED gcmmSmallImageIconUrl "Use generic-lens or generic-optics with 'smallImageIconUrl' instead." #-}
...
{-# DEPRECATED gcmmSound "Use generic-lens or generic-optics with 'sound' instead." #-}
...
{-# DEPRECATED gcmmSubstitutions "Use generic-lens or generic-optics with 'substitutions' instead." #-}
...
{-# DEPRECATED gcmmTimeToLive "Use generic-lens or generic-optics with 'timeToLive' instead." #-}
...
{-# DEPRECATED gcmmTitle "Use generic-lens or generic-optics with 'title' instead." #-}
...
{-# DEPRECATED gcmmUrl "Use generic-lens or generic-optics with 'url' instead." #-}
