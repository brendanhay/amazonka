...
mkMotionImageInserter
    :: MotionImageInserter
mkMotionImageInserter
  = MotionImageInserter'{framerate = Core.Nothing,
                         input = Core.Nothing, insertionMode = Core.Nothing,
                         offset = Core.Nothing, playback = Core.Nothing,
...
{-# INLINEABLE miiInsertionMode #-}
{-# DEPRECATED insertionMode "Use generic-lens or generic-optics with 'insertionMode' instead"  #-}
...
{-# INLINEABLE miiPlayback #-}
{-# DEPRECATED playback "Use generic-lens or generic-optics with 'playback' instead"  #-}
          ...
          = Core.withObject "MotionImageInserter" Core.$
              \ x ->
                MotionImageInserter' Core.<$>
                  (x Core..:? "framerate") Core.<*> x Core..:? "input" Core.<*>
                    x Core..:? "insertionMode"
                    Core.<*> x Core..:? "offset"
