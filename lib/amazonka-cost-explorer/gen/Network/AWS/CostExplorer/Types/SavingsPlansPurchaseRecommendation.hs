...
mkSavingsPlansPurchaseRecommendation
    :: SavingsPlansPurchaseRecommendation
mkSavingsPlansPurchaseRecommendation
  = SavingsPlansPurchaseRecommendation'{accountScope = Core.Nothing,
                                        ...
                                        savingsPlansType = Core.Nothing, termInYears = Core.Nothing}
...
{-# INLINEABLE spprLookbackPeriodInDays #-}
...
{-# INLINEABLE spprSavingsPlansPurchaseRecommendationDetails #-}
{-# DEPRECATED savingsPlansPurchaseRecommendationDetails "Use generic-lens or generic-optics with 'savingsPlansPurchaseRecommendationDetails' instead"  #-}
...
{-# INLINEABLE spprSavingsPlansPurchaseRecommendationSummary #-}
{-# DEPRECATED savingsPlansPurchaseRecommendationSummary "Use generic-lens or generic-optics with 'savingsPlansPurchaseRecommendationSummary' instead"  #-}
...
{-# INLINEABLE spprSavingsPlansType #-}
...
instance Core.FromJSON SavingsPlansPurchaseRecommendation where
        parseJSON
          = Core.withObject "SavingsPlansPurchaseRecommendation" Core.$
              \ x ->
                SavingsPlansPurchaseRecommendation' Core.<$>
                  (x Core..:? "AccountScope") Core.<*>
