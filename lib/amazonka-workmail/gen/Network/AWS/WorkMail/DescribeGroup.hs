...
mkDescribeGroupResponse responseStatus
  = DescribeGroupResponse'{disabledDate = Core.Nothing,
                           email = Core.Nothing, enabledDate = Core.Nothing,
                           groupId = Core.Nothing, name = Core.Nothing, state = Core.Nothing,
                           responseStatus}
