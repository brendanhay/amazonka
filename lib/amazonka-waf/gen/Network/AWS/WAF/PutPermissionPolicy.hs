...
instance Core.ToHeaders PutPermissionPolicy where
        toHeaders PutPermissionPolicy{..}
          = Core.pure ("X-Amz-Target", "AWSWAF_20150824.PutPermissionPolicy")
...
instance Core.AWSRequest PutPermissionPolicy where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 PutPermissionPolicyResponse' Core.<$>
...
{-# INLINEABLE ppprrsResponseStatus #-}
