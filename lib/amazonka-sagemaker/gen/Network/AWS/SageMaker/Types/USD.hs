...
mkUSD
    :: USD
mkUSD
  = USD'{cents = Core.Nothing, dollars = Core.Nothing,
...
{-# INLINEABLE usdCents #-}
{-# DEPRECATED cents "Use generic-lens or generic-optics with 'cents' instead"  #-}
...
{-# INLINEABLE usdDollars #-}
{-# DEPRECATED dollars "Use generic-lens or generic-optics with 'dollars' instead"  #-}
...
{-# INLINEABLE usdTenthFractionsOfACent #-}
{-# DEPRECATED tenthFractionsOfACent "Use generic-lens or generic-optics with 'tenthFractionsOfACent' instead"  #-}
...
instance Core.FromJSON USD where
        parseJSON
          = Core.withObject "USD" Core.$
              \ x ->
                USD' Core.<$>
                  (x Core..:? "Cents") Core.<*> x Core..:? "Dollars" Core.<*>
                    x Core..:? "TenthFractionsOfACent"
