    ...
    object
      ( catMaybes
          [ ("HITReviewPolicy" .=) <$> _chitwhittHITReviewPolicy,
            ("UniqueRequestToken" .=) <$> _chitwhittUniqueRequestToken,
            ("RequesterAnnotation" .=) <$> _chitwhittRequesterAnnotation,
            ("MaxAssignments" .=) <$> _chitwhittMaxAssignments,
            ("HITLayoutId" .=) <$> _chitwhittHITLayoutId,
            ("HITLayoutParameters" .=) <$> _chitwhittHITLayoutParameters,
            ("Question" .=) <$> _chitwhittQuestion,
            ("AssignmentReviewPolicy" .=) <$> _chitwhittAssignmentReviewPolicy,
            Just ("HITTypeId" .= _chitwhittHITTypeId),
            Just ("LifetimeInSeconds" .= _chitwhittLifetimeInSeconds)
          ]
      )
