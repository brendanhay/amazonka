...
instance AWSRequest EnableTransitGatewayRouteTablePropagation where
  type
...
instance Hashable EnableTransitGatewayRouteTablePropagation

instance NFData EnableTransitGatewayRouteTablePropagation

instance ToHeaders EnableTransitGatewayRouteTablePropagation where
  toHeaders = const mempty

instance ToPath EnableTransitGatewayRouteTablePropagation where
  toPath = const "/"

instance ToQuery EnableTransitGatewayRouteTablePropagation where
  toQuery EnableTransitGatewayRouteTablePropagation' {..} =
    mconcat
      [ "Action"
          =: ("EnableTransitGatewayRouteTablePropagation" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        "DryRun" =: _etgrtpDryRun,
        "TransitGatewayRouteTableId" =: _etgrtpTransitGatewayRouteTableId,
        "TransitGatewayAttachmentId" =: _etgrtpTransitGatewayAttachmentId
      ]
...
enableTransitGatewayRouteTablePropagationResponse pResponseStatus_ =
  EnableTransitGatewayRouteTablePropagationResponse'
    { _etgrtprsPropagation =
        Nothing,
      _etgrtprsResponseStatus = pResponseStatus_
    }
...
instance NFData EnableTransitGatewayRouteTablePropagationResponse
