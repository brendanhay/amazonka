...
-- |
-- Module      : Network.AWS.LexV2Models.UpdateExport
...
instance Prelude.Hashable UpdateExport

instance Prelude.NFData UpdateExport
...
-- a bot locale.
--
-- 'fileFormat', 'updateExportResponse_fileFormat' - The file format used for the files that define the resource.
--
...
instance Prelude.NFData UpdateExportResponse
