...
mkSchemaVersionErrorItem
    :: SchemaVersionErrorItem
mkSchemaVersionErrorItem
  = SchemaVersionErrorItem'{errorDetails = Core.Nothing,
...
instance Core.FromJSON SchemaVersionErrorItem where
        parseJSON
          = Core.withObject "SchemaVersionErrorItem" Core.$
              \ x ->
                SchemaVersionErrorItem' Core.<$>
                  (x Core..:? "ErrorDetails") Core.<*> x Core..:? "VersionNumber"
