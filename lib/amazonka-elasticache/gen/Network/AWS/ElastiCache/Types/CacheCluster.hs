...
mkCacheCluster
  = CacheCluster'{arn = Core.Nothing,
                  ...
                  cacheClusterId = Core.Nothing, cacheClusterStatus = Core.Nothing,
                  cacheNodeType = Core.Nothing, cacheNodes = Core.Nothing,
                  ...
                  configurationEndpoint = Core.Nothing, engine = Core.Nothing,
                  engineVersion = Core.Nothing,
                  notificationConfiguration = Core.Nothing,
                  numCacheNodes = Core.Nothing, pendingModifiedValues = Core.Nothing,
                  preferredAvailabilityZone = Core.Nothing,
                  preferredMaintenanceWindow = Core.Nothing,
                  preferredOutpostArn = Core.Nothing,
                  replicationGroupId = Core.Nothing, securityGroups = Core.Nothing,
...
ccARN :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
...
{-# INLINEABLE ccAtRestEncryptionEnabled #-}
...
{-# INLINEABLE ccAuthTokenLastModifiedDate #-}
...
{-# INLINEABLE ccAutoMinorVersionUpgrade #-}
...
{-# INLINEABLE ccCacheClusterCreateTime #-}
...
ccCacheClusterId :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccCacheClusterId = Lens.field @"cacheClusterId"
{-# INLINEABLE ccCacheClusterId #-}
...
ccCacheClusterStatus :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccCacheClusterStatus = Lens.field @"cacheClusterStatus"
{-# INLINEABLE ccCacheClusterStatus #-}
...
ccCacheNodeType :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccCacheNodeType = Lens.field @"cacheNodeType"
{-# INLINEABLE ccCacheNodeType #-}
...
{-# INLINEABLE ccCacheNodes #-}
{-# DEPRECATED cacheNodes "Use generic-lens or generic-optics with 'cacheNodes' instead"  #-}
...
{-# INLINEABLE ccCacheParameterGroup #-}
...
{-# INLINEABLE ccCacheSecurityGroups #-}
...
ccCacheSubnetGroupName :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccCacheSubnetGroupName = Lens.field @"cacheSubnetGroupName"
{-# INLINEABLE ccCacheSubnetGroupName #-}
...
ccClientDownloadLandingPage :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccClientDownloadLandingPage = Lens.field @"clientDownloadLandingPage"
{-# INLINEABLE ccClientDownloadLandingPage #-}
{-# DEPRECATED clientDownloadLandingPage "Use generic-lens or generic-optics with 'clientDownloadLandingPage' instead"  #-}
...
{-# INLINEABLE ccConfigurationEndpoint #-}
...
ccEngine :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
...
ccEngineVersion :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
...
{-# INLINEABLE ccNotificationConfiguration #-}
...
{-# INLINEABLE ccPendingModifiedValues #-}
...
ccPreferredAvailabilityZone :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccPreferredAvailabilityZone = Lens.field @"preferredAvailabilityZone"
{-# INLINEABLE ccPreferredAvailabilityZone #-}
...
ccPreferredMaintenanceWindow :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
...
ccPreferredOutpostArn :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccPreferredOutpostArn = Lens.field @"preferredOutpostArn"
{-# INLINEABLE ccPreferredOutpostArn #-}
...
ccReplicationGroupId :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccReplicationGroupId = Lens.field @"replicationGroupId"
{-# INLINEABLE ccReplicationGroupId #-}
...
{-# INLINEABLE ccSnapshotRetentionLimit #-}
...
ccSnapshotWindow :: Lens.Lens' CacheCluster (Core.Maybe Core.Text)
ccSnapshotWindow = Lens.field @"snapshotWindow"
{-# INLINEABLE ccSnapshotWindow #-}
...
{-# INLINEABLE ccTransitEncryptionEnabled #-}
        ...
        parseXML x
          = CacheCluster' Core.<$>
              (x Core..@? "ARN") Core.<*> x Core..@? "AtRestEncryptionEnabled"
                ...
                Core.<*>
                x Core..@? "CacheNodes" Core..<@> Core.parseXMLList "CacheNode"
