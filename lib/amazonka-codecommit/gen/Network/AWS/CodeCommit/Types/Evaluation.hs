...
mkEvaluation
    :: Evaluation
mkEvaluation
  = Evaluation'{approvalRulesNotSatisfied = Core.Nothing,
                approvalRulesSatisfied = Core.Nothing, approved = Core.Nothing,
...
{-# INLINEABLE eApprovalRulesNotSatisfied #-}
{-# DEPRECATED approvalRulesNotSatisfied "Use generic-lens or generic-optics with 'approvalRulesNotSatisfied' instead"  #-}
...
{-# INLINEABLE eApprovalRulesSatisfied #-}
{-# DEPRECATED approvalRulesSatisfied "Use generic-lens or generic-optics with 'approvalRulesSatisfied' instead"  #-}
...
{-# INLINEABLE eApproved #-}
{-# DEPRECATED approved "Use generic-lens or generic-optics with 'approved' instead"  #-}
...
instance Core.FromJSON Evaluation where
        parseJSON
          = Core.withObject "Evaluation" Core.$
              \ x ->
                Evaluation' Core.<$>
                  (x Core..:? "approvalRulesNotSatisfied") Core.<*>
                    x Core..:? "approvalRulesSatisfied"
