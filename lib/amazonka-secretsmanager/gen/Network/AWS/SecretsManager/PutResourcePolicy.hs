...
mkPutResourcePolicy secretId resourcePolicy
  = PutResourcePolicy'{secretId, resourcePolicy,
...
{-# INLINEABLE prpBlockPublicPolicy #-}
...
mkPutResourcePolicyResponse responseStatus
  = PutResourcePolicyResponse'{arn = Core.Nothing,
