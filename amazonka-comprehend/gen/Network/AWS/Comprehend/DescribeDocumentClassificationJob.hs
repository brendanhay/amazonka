...
instance AWSRequest DescribeDocumentClassificationJob
         where
...
instance ToHeaders DescribeDocumentClassificationJob
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DescribeDocumentClassificationJob
         where
        toJSON DescribeDocumentClassificationJob'{..}
          = object (catMaybes [Just ("JobId" .= _ddcjJobId)])

instance ToPath DescribeDocumentClassificationJob
         where
        toPath = const "/"

instance ToQuery DescribeDocumentClassificationJob
         where
