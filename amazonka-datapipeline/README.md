...
`1.6.1` - Derived from API version @2012-10-29@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.DataPipeline](http://hackage.haskell.org/package/amazonka-datapipeline/docs/Network-AWS-DataPipeline.html)
