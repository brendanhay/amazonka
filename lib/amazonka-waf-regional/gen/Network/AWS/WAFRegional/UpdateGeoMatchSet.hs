...
mkUpdateGeoMatchSet
    ...
    -> Core.NonEmpty Types.GeoMatchSetUpdate -- ^ 'updates'
    -> UpdateGeoMatchSet
...
instance Core.AWSRequest UpdateGeoMatchSet where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateGeoMatchSetResponse' Core.<$>
...
mkUpdateGeoMatchSetResponse responseStatus
  = UpdateGeoMatchSetResponse'{changeToken = Core.Nothing,
                               responseStatus}
...
{-# INLINEABLE ugmsrrsResponseStatus #-}
