...
mkSharedDirectory
    :: SharedDirectory
mkSharedDirectory
  = SharedDirectory'{createdDateTime = Core.Nothing,
                     lastUpdatedDateTime = Core.Nothing, ownerAccountId = Core.Nothing,
                     ownerDirectoryId = Core.Nothing, shareMethod = Core.Nothing,
                     shareNotes = Core.Nothing, shareStatus = Core.Nothing,
                     sharedAccountId = Core.Nothing, sharedDirectoryId = Core.Nothing}
...
{-# INLINEABLE sdLastUpdatedDateTime #-}
...
{-# INLINEABLE sdSharedDirectoryId #-}
...
instance Core.FromJSON SharedDirectory where
        parseJSON
          = Core.withObject "SharedDirectory" Core.$
              \ x ->
                SharedDirectory' Core.<$>
                  (x Core..:? "CreatedDateTime") Core.<*>
                    x Core..:? "LastUpdatedDateTime"
