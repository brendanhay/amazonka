...
mkNotification notificationType comparisonOperator threshold
  = Notification'{notificationType, comparisonOperator, threshold,
                  notificationState = Core.Nothing, thresholdType = Core.Nothing}
...
{-# INLINEABLE nComparisonOperator #-}
...
{-# INLINEABLE nNotificationState #-}
{-# DEPRECATED notificationState "Use generic-lens or generic-optics with 'notificationState' instead"  #-}
...
{-# INLINEABLE nThresholdType #-}
{-# DEPRECATED thresholdType "Use generic-lens or generic-optics with 'thresholdType' instead"  #-}
...
instance Core.FromJSON Notification where
        parseJSON
          = Core.withObject "Notification" Core.$
              \ x ->
                Notification' Core.<$>
                  (x Core..: "NotificationType") Core.<*>
                    x Core..: "ComparisonOperator"
