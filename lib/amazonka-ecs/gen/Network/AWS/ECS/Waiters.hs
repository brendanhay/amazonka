...
mkServicesInactive
  = Waiter.Wait{Waiter._waitName = "ServicesInactive",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAny "MISSING" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"failures" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"reason" Core.. Lens._Just),
                   Waiter.matchAny "INACTIVE" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"services" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkTasksRunning
  = Waiter.Wait{Waiter._waitName = "TasksRunning",
                Waiter._waitAttempts = 100, Waiter._waitDelay = 6,
                Waiter._waitAcceptors =
                  [Waiter.matchAny "STOPPED" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"tasks" Core.. Lens._Just Core.. Lens.to Core.toList))
                        Core.. Lens.field @"lastStatus" Core.. Lens._Just),
                   Waiter.matchAny "MISSING" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"failures" Core.. Lens._Just Core..
...
mkTasksStopped
  = Waiter.Wait{Waiter._waitName = "TasksStopped",
                Waiter._waitAttempts = 100, Waiter._waitDelay = 6,
                Waiter._waitAcceptors =
