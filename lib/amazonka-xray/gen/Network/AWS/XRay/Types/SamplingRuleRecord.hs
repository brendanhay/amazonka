...
mkSamplingRuleRecord
    :: SamplingRuleRecord
mkSamplingRuleRecord
  = SamplingRuleRecord'{createdAt = Core.Nothing,
                        modifiedAt = Core.Nothing, samplingRule = Core.Nothing}
...
{-# INLINEABLE srrModifiedAt #-}
{-# DEPRECATED modifiedAt "Use generic-lens or generic-optics with 'modifiedAt' instead"  #-}
...
instance Core.FromJSON SamplingRuleRecord where
        parseJSON
          = Core.withObject "SamplingRuleRecord" Core.$
              \ x ->
                SamplingRuleRecord' Core.<$>
                  (x Core..:? "CreatedAt") Core.<*> x Core..:? "ModifiedAt" Core.<*>
                    x Core..:? "SamplingRule"
