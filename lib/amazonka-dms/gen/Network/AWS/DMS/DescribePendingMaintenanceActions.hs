    ...
    object
      ( catMaybes
          [ ("Filters" .=) <$> _dpmaFilters,
            ...
            ("ReplicationInstanceArn" .=) <$> _dpmaReplicationInstanceARN
          ]
      )
...
data DescribePendingMaintenanceActionsResponse = DescribePendingMaintenanceActionsResponse'
  { _dpmarsPendingMaintenanceActions ::
      !( Maybe
...
instance NFData DescribePendingMaintenanceActionsResponse
