...
-- |
-- Module      : Network.AWS.LexV2Models.UpdateResourcePolicy
...
instance Prelude.Hashable UpdateResourcePolicy

instance Prelude.NFData UpdateResourcePolicy
...
instance Prelude.NFData UpdateResourcePolicyResponse
