...
mkCmafEncryptionSettings
    :: CmafEncryptionSettings
mkCmafEncryptionSettings
  = CmafEncryptionSettings'{constantInitializationVector =
                              Core.Nothing,
                            encryptionMethod = Core.Nothing,
                            initializationVectorInManifest = Core.Nothing,
                            spekeKeyProvider = Core.Nothing, staticKeyProvider = Core.Nothing,
                            type' = Core.Nothing}
...
{-# INLINEABLE cesConstantInitializationVector #-}
...
{-# INLINEABLE cesEncryptionMethod #-}
...
{-# INLINEABLE cesInitializationVectorInManifest #-}
{-# DEPRECATED initializationVectorInManifest "Use generic-lens or generic-optics with 'initializationVectorInManifest' instead"  #-}
...
{-# INLINEABLE cesSpekeKeyProvider #-}
...
{-# INLINEABLE cesStaticKeyProvider #-}
{-# DEPRECATED staticKeyProvider "Use generic-lens or generic-optics with 'staticKeyProvider' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("constantInitializationVector" Core..=) Core.<$>
                  ...
                  ("initializationVectorInManifest" Core..=) Core.<$>
...
instance Core.FromJSON CmafEncryptionSettings where
        parseJSON
          = Core.withObject "CmafEncryptionSettings" Core.$
              \ x ->
                CmafEncryptionSettings' Core.<$>
                  (x Core..:? "constantInitializationVector") Core.<*>
                    x Core..:? "encryptionMethod"
