...
instance Core.AWSRequest DeleteKnownHostKeys where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DeleteKnownHostKeysResponse' Core.<$>
...
mkDeleteKnownHostKeysResponse responseStatus
  = DeleteKnownHostKeysResponse'{operations = Core.Nothing,
                                 responseStatus}
...
{-# INLINEABLE dkhkrrsResponseStatus #-}
