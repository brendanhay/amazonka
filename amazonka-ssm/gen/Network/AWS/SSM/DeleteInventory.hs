...
instance Prelude.AWSRequest DeleteInventory where
...
instance Prelude.ToHeaders DeleteInventory where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("AmazonSSM.DeleteInventory" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON DeleteInventory where
  toJSON DeleteInventory' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("DryRun" Prelude..=) Prelude.<$> dryRun,
            ("SchemaDeleteOption" Prelude..=)
...
instance Prelude.ToPath DeleteInventory where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DeleteInventory where
