...
mkVp8Settings
    :: Vp8Settings
mkVp8Settings
  = Vp8Settings'{bitrate = Core.Nothing,
                 ...
                 hrdBufferSize = Core.Nothing, maxBitrate = Core.Nothing,
...
{-# INLINEABLE vFramerateConversionAlgorithm #-}
...
{-# INLINEABLE vFramerateDenominator #-}
...
{-# INLINEABLE vFramerateNumerator #-}
...
{-# INLINEABLE vQualityTuningLevel #-}
...
instance Core.FromJSON Vp8Settings where
        parseJSON
          = Core.withObject "Vp8Settings" Core.$
              \ x ->
                Vp8Settings' Core.<$>
                  (x Core..:? "bitrate") Core.<*> x Core..:? "framerateControl"
