...
mkDescribeAssociation
    :: DescribeAssociation
mkDescribeAssociation
  = DescribeAssociation'{associationId = Core.Nothing,
                         associationVersion = Core.Nothing, instanceId = Core.Nothing,
                         name = Core.Nothing}
...
{-# INLINEABLE daAssociationVersion #-}
...
instance Core.AWSRequest DescribeAssociation where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeAssociationResponse' Core.<$>
...
{-# INLINEABLE darfrsAssociationDescription #-}
