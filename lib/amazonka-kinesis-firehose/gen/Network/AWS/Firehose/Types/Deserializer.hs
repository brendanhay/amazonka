...
mkDeserializer
    :: Deserializer
mkDeserializer
  = Deserializer'{hiveJsonSerDe = Core.Nothing,
...
{-# INLINEABLE dHiveJsonSerDe #-}
{-# DEPRECATED hiveJsonSerDe "Use generic-lens or generic-optics with 'hiveJsonSerDe' instead"  #-}
...
{-# INLINEABLE dOpenXJsonSerDe #-}
{-# DEPRECATED openXJsonSerDe "Use generic-lens or generic-optics with 'openXJsonSerDe' instead"  #-}
...
instance Core.FromJSON Deserializer where
        parseJSON
          = Core.withObject "Deserializer" Core.$
              \ x ->
                Deserializer' Core.<$>
                  (x Core..:? "HiveJsonSerDe") Core.<*> x Core..:? "OpenXJsonSerDe"
