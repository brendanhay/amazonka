...
--
-- By default, the spend limit is set to the maximum allowed by Amazon SNS. If you want to exceed the maximum, contact <https://aws.amazon.com/premiumsupport/ AWS Support> or your AWS sales representative for a service limit increase.
--
...
--
-- For an example bucket policy and usage report, see <http://docs.aws.amazon.com/sns/latest/dg/sms_stats.html Monitoring SMS Activity> in the /Amazon SNS Developer Guide/.
...
setSMSAttributesResponse pResponseStatus_ =
    SetSMSAttributesResponse'
    { _ssmsarsResponseStatus = pResponseStatus_
    }
