...
{-# INLINEABLE rclpNewGameSessionsPerCreator #-}
{-# DEPRECATED newGameSessionsPerCreator "Use generic-lens or generic-optics with 'newGameSessionsPerCreator' instead"  #-}
...
{-# INLINEABLE rclpPolicyPeriodInMinutes #-}
{-# DEPRECATED policyPeriodInMinutes "Use generic-lens or generic-optics with 'policyPeriodInMinutes' instead"  #-}

instance Core.FromJSON ResourceCreationLimitPolicy where
        toJSON ResourceCreationLimitPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("NewGameSessionsPerCreator" Core..=) Core.<$>
          ...
          = Core.withObject "ResourceCreationLimitPolicy" Core.$
              \ x ->
                ResourceCreationLimitPolicy' Core.<$>
                  (x Core..:? "NewGameSessionsPerCreator") Core.<*>
                    x Core..:? "PolicyPeriodInMinutes"
