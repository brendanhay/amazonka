  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "TrentService.ReEncrypt")
...
{-# DEPRECATED rerrsCiphertextBlob "Use generic-lens or generic-optics with 'ciphertextBlob' instead." #-}
...
{-# DEPRECATED rerrsDestinationEncryptionAlgorithm "Use generic-lens or generic-optics with 'destinationEncryptionAlgorithm' instead." #-}
...
{-# DEPRECATED rerrsKeyId "Use generic-lens or generic-optics with 'keyId' instead." #-}
...
{-# DEPRECATED rerrsSourceEncryptionAlgorithm "Use generic-lens or generic-optics with 'sourceEncryptionAlgorithm' instead." #-}
...
{-# DEPRECATED rerrsSourceKeyId "Use generic-lens or generic-optics with 'sourceKeyId' instead." #-}
...
{-# DEPRECATED rerrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
