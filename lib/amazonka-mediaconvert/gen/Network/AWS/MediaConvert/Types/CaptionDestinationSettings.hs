...
{-# INLINEABLE cdsImscDestinationSettings #-}
{-# DEPRECATED imscDestinationSettings "Use generic-lens or generic-optics with 'imscDestinationSettings' instead"  #-}
...
{-# INLINEABLE cdsSccDestinationSettings #-}
{-# DEPRECATED sccDestinationSettings "Use generic-lens or generic-optics with 'sccDestinationSettings' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("burninDestinationSettings" Core..=) Core.<$>
                  ...
                  ("imscDestinationSettings" Core..=) Core.<$>
          ...
          = Core.withObject "CaptionDestinationSettings" Core.$
              \ x ->
                CaptionDestinationSettings' Core.<$>
                  (x Core..:? "burninDestinationSettings") Core.<*>
                    x Core..:? "destinationType"
