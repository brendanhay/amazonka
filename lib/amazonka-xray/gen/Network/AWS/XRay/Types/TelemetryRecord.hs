...
{-# INLINEABLE trBackendConnectionErrors #-}
{-# DEPRECATED backendConnectionErrors "Use generic-lens or generic-optics with 'backendConnectionErrors' instead"  #-}
...
{-# INLINEABLE trSegmentsReceivedCount #-}
{-# DEPRECATED segmentsReceivedCount "Use generic-lens or generic-optics with 'segmentsReceivedCount' instead"  #-}
...
{-# INLINEABLE trSegmentsRejectedCount #-}
{-# DEPRECATED segmentsRejectedCount "Use generic-lens or generic-optics with 'segmentsRejectedCount' instead"  #-}
...
{-# INLINEABLE trSegmentsSentCount #-}
{-# DEPRECATED segmentsSentCount "Use generic-lens or generic-optics with 'segmentsSentCount' instead"  #-}
...
{-# INLINEABLE trSegmentsSpilloverCount #-}
{-# DEPRECATED segmentsSpilloverCount "Use generic-lens or generic-optics with 'segmentsSpilloverCount' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("Timestamp" Core..= timestamp),
                  ("BackendConnectionErrors" Core..=) Core.<$>
                  ...
                  ("SegmentsSpilloverCount" Core..=) Core.<$>
