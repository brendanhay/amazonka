...
mkGetCommandInvocation commandId instanceId
  = GetCommandInvocation'{commandId, instanceId,
...
{-# INLINEABLE gciPluginName #-}
{-# DEPRECATED pluginName "Use generic-lens or generic-optics with 'pluginName' instead"  #-}

instance Core.ToQuery GetCommandInvocation where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders GetCommandInvocation where
        toHeaders GetCommandInvocation{..}
...
instance Core.AWSRequest GetCommandInvocation where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetCommandInvocationResponse' Core.<$>
...
mkGetCommandInvocationResponse responseStatus
  = GetCommandInvocationResponse'{cloudWatchOutputConfig =
                                  ...
                                  executionStartDateTime = Core.Nothing, instanceId = Core.Nothing,
                                  pluginName = Core.Nothing, responseCode = Core.Nothing,
                                  standardErrorContent = Core.Nothing,
                                  standardErrorUrl = Core.Nothing,
                                  standardOutputContent = Core.Nothing,
                                  standardOutputUrl = Core.Nothing, status = Core.Nothing,
                                  statusDetails = Core.Nothing, responseStatus}
...
{-# INLINEABLE gcirrsCloudWatchOutputConfig #-}
...
{-# INLINEABLE gcirrsDocumentVersion #-}
...
{-# INLINEABLE gcirrsExecutionElapsedTime #-}
{-# DEPRECATED executionElapsedTime "Use generic-lens or generic-optics with 'executionElapsedTime' instead"  #-}
...
{-# INLINEABLE gcirrsExecutionEndDateTime #-}
{-# DEPRECATED executionEndDateTime "Use generic-lens or generic-optics with 'executionEndDateTime' instead"  #-}
...
{-# INLINEABLE gcirrsExecutionStartDateTime #-}
{-# DEPRECATED executionStartDateTime "Use generic-lens or generic-optics with 'executionStartDateTime' instead"  #-}
...
{-# INLINEABLE gcirrsStandardErrorContent #-}
{-# DEPRECATED standardErrorContent "Use generic-lens or generic-optics with 'standardErrorContent' instead"  #-}
...
{-# INLINEABLE gcirrsStandardErrorUrl #-}
{-# DEPRECATED standardErrorUrl "Use generic-lens or generic-optics with 'standardErrorUrl' instead"  #-}
...
{-# INLINEABLE gcirrsStandardOutputContent #-}
{-# DEPRECATED standardOutputContent "Use generic-lens or generic-optics with 'standardOutputContent' instead"  #-}
...
{-# INLINEABLE gcirrsStandardOutputUrl #-}
{-# DEPRECATED standardOutputUrl "Use generic-lens or generic-optics with 'standardOutputUrl' instead"  #-}
...
{-# INLINEABLE gcirrsStatusDetails #-}
