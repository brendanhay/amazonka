...
mkCreateFileSystem creationToken
  = CreateFileSystem'{creationToken, encrypted = Core.Nothing,
                      kmsKeyId = Core.Nothing, performanceMode = Core.Nothing,
                      provisionedThroughputInMibps = Core.Nothing, tags = Core.Nothing,
...
{-# INLINEABLE cfsProvisionedThroughputInMibps #-}
