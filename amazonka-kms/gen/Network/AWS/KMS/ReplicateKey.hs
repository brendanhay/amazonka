...
replicateKey_tags = Lens.lens (\ReplicateKey' {tags} -> tags) (\s@ReplicateKey' {} a -> s {tags = a} :: ReplicateKey) Prelude.. Lens.mapping Lens._Coerce
...
newReplicateKeyResponse pHttpStatus_ =
  ReplicateKeyResponse'
    { replicaTags =
      ...
      replicaKeyMetadata = Prelude.Nothing,
...
replicateKeyResponse_replicaTags = Lens.lens (\ReplicateKeyResponse' {replicaTags} -> replicaTags) (\s@ReplicateKeyResponse' {} a -> s {replicaTags = a} :: ReplicateKeyResponse) Prelude.. Lens.mapping Lens._Coerce
