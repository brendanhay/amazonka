...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Inspector",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "inspector",
                 Core._svcVersion = "2016-02-16", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _AssessmentRunInProgressException #-}
...
{-# INLINEABLE _PreviewGenerationInProgressException #-}
...
{-# INLINEABLE _AgentsAlreadyRunningAssessmentException #-}
...
{-# INLINEABLE _InvalidCrossAccountRoleException #-}
...
{-# INLINEABLE _ServiceTemporarilyUnavailableException #-}
