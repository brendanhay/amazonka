...
instance ToQuery CreateTransitGatewayRouteTable where
  toQuery CreateTransitGatewayRouteTable' {..} =
    mconcat
      [ "Action" =: ("CreateTransitGatewayRouteTable" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        toQuery
          (toQueryList "TagSpecifications" <$> _ctgrtTagSpecifications),
        "DryRun" =: _ctgrtDryRun,
...
data CreateTransitGatewayRouteTableResponse = CreateTransitGatewayRouteTableResponse'
  { _ctgrtrsTransitGatewayRouteTable ::
      !( Maybe
...
instance NFData CreateTransitGatewayRouteTableResponse
