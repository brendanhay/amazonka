...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CloudSearchDomains",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "cloudsearchdomain",
...
{-# INLINEABLE _DocumentServiceException #-}
