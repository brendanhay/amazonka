...
batchGetItem :: HashMap Text KeysAndAttributes -- ^ '_bgiiRequestItems'
             -> BatchGetItem
...
data BatchGetItem = BatchGetItem
    { _bgiiRequestItems :: HashMap Text KeysAndAttributes
...
data BatchGetItemResponse = BatchGetItemResponse
    { _bgioUnprocessedKeys :: HashMap Text KeysAndAttributes
      ...
      -- is used.
    , _bgioResponses :: HashMap Text [HashMap Text AttributeValue]
