...
mkCloudWatchLoggingOptions
    :: CloudWatchLoggingOptions
mkCloudWatchLoggingOptions
  = CloudWatchLoggingOptions'{enabled = Core.Nothing,
                              logGroupName = Core.Nothing, logStreamName = Core.Nothing}
          ...
          = Core.withObject "CloudWatchLoggingOptions" Core.$
              \ x ->
                CloudWatchLoggingOptions' Core.<$>
                  (x Core..:? "Enabled") Core.<*> x Core..:? "LogGroupName" Core.<*>
