...
mkConnection
    :: Connection
mkConnection
  = Connection'{connectionProperties = Core.Nothing,
                connectionType = Core.Nothing, creationTime = Core.Nothing,
                description = Core.Nothing, lastUpdatedBy = Core.Nothing,
                lastUpdatedTime = Core.Nothing, matchCriteria = Core.Nothing,
                name = Core.Nothing, physicalConnectionRequirements = Core.Nothing}
...
{-# INLINEABLE cfConnectionProperties #-}
{-# DEPRECATED connectionProperties "Use generic-lens or generic-optics with 'connectionProperties' instead"  #-}
...
{-# INLINEABLE cfPhysicalConnectionRequirements #-}
{-# DEPRECATED physicalConnectionRequirements "Use generic-lens or generic-optics with 'physicalConnectionRequirements' instead"  #-}
...
instance Core.FromJSON Connection where
        parseJSON
          = Core.withObject "Connection" Core.$
              \ x ->
                Connection' Core.<$>
                  (x Core..:? "ConnectionProperties") Core.<*>
                    x Core..:? "ConnectionType"
