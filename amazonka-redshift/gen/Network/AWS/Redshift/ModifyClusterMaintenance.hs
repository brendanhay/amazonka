...
data ModifyClusterMaintenance = ModifyClusterMaintenance'
  { _mcmDeferMaintenanceEndTime    :: !(Maybe ISO8601)
  , _mcmDeferMaintenance           :: !(Maybe Bool)
  , _mcmDeferMaintenanceDuration   :: !(Maybe Int)
  , _mcmDeferMaintenanceStartTime  :: !(Maybe ISO8601)
  , _mcmDeferMaintenanceIdentifier :: !(Maybe Text)
...
--
-- * 'mcmDeferMaintenanceDuration' - An integer indicating the duration of the maintenance window in days. If you specify a duration, you can't specify an end time. The duration must be 14 days or less.
--
...
data ModifyClusterMaintenanceResponse = ModifyClusterMaintenanceResponse'
  { _mcmrsCluster        :: !(Maybe Cluster)
  , _mcmrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
modifyClusterMaintenanceResponse pResponseStatus_ =
  ModifyClusterMaintenanceResponse'
    {_mcmrsCluster = Nothing, _mcmrsResponseStatus = pResponseStatus_}
