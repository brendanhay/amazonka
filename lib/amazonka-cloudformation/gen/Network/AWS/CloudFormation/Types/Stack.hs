...
mkStack stackName creationTime stackStatus
  = Stack'{stackName, creationTime, stackStatus,
           capabilities = Core.Nothing, changeSetId = Core.Nothing,
           deletionTime = Core.Nothing, description = Core.Nothing,
           disableRollback = Core.Nothing, driftInformation = Core.Nothing,
           enableTerminationProtection = Core.Nothing,
           lastUpdatedTime = Core.Nothing, notificationARNs = Core.Nothing,
           outputs = Core.Nothing, parameters = Core.Nothing,
           parentId = Core.Nothing, roleARN = Core.Nothing,
           rollbackConfiguration = Core.Nothing, rootId = Core.Nothing,
           stackId = Core.Nothing, stackStatusReason = Core.Nothing,
...
{-# INLINEABLE sfEnableTerminationProtection #-}
...
{-# INLINEABLE sfRollbackConfiguration #-}
...
{-# INLINEABLE sfStackStatusReason #-}
