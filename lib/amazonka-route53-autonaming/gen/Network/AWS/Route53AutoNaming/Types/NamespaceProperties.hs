...
mkNamespaceProperties
    :: NamespaceProperties
mkNamespaceProperties
  = NamespaceProperties'{dnsProperties = Core.Nothing,
...
{-# INLINEABLE npDnsProperties #-}
{-# DEPRECATED dnsProperties "Use generic-lens or generic-optics with 'dnsProperties' instead"  #-}
...
{-# INLINEABLE npHttpProperties #-}
{-# DEPRECATED httpProperties "Use generic-lens or generic-optics with 'httpProperties' instead"  #-}

instance Core.FromJSON NamespaceProperties where
        parseJSON
          = Core.withObject "NamespaceProperties" Core.$
              \ x ->
                NamespaceProperties' Core.<$>
                  (x Core..:? "DnsProperties") Core.<*> x Core..:? "HttpProperties"
