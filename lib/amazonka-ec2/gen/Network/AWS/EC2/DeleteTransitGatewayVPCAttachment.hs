...
instance ToQuery DeleteTransitGatewayVPCAttachment where
  toQuery DeleteTransitGatewayVPCAttachment' {..} =
    mconcat
      [ "Action" =: ("DeleteTransitGatewayVpcAttachment" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        "DryRun" =: _dtgvaDryRun,
        "TransitGatewayAttachmentId" =: _dtgvaTransitGatewayAttachmentId
      ]
...
data DeleteTransitGatewayVPCAttachmentResponse = DeleteTransitGatewayVPCAttachmentResponse'
  { _dtgvpcarsTransitGatewayVPCAttachment ::
      !( Maybe
...
instance NFData DeleteTransitGatewayVPCAttachmentResponse
