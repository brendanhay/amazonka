...
deleteVPCEndpointConnectionNotifications =
  DeleteVPCEndpointConnectionNotifications'
    { _dvecnDryRun = Nothing,
      _dvecnConnectionNotificationIds = mempty
    }
...
instance AWSRequest DeleteVPCEndpointConnectionNotifications where
  type
...
instance Hashable DeleteVPCEndpointConnectionNotifications

instance NFData DeleteVPCEndpointConnectionNotifications

instance ToHeaders DeleteVPCEndpointConnectionNotifications where
  toHeaders = const mempty

instance ToPath DeleteVPCEndpointConnectionNotifications where
  toPath = const "/"

instance ToQuery DeleteVPCEndpointConnectionNotifications where
  toQuery DeleteVPCEndpointConnectionNotifications' {..} =
    mconcat
      [ "Action"
          =: ("DeleteVpcEndpointConnectionNotifications" :: ByteString),
...
deleteVPCEndpointConnectionNotificationsResponse pResponseStatus_ =
  DeleteVPCEndpointConnectionNotificationsResponse'
    { _dvecnrsUnsuccessful =
        Nothing,
      _dvecnrsResponseStatus = pResponseStatus_
    }
...
instance NFData DeleteVPCEndpointConnectionNotificationsResponse
