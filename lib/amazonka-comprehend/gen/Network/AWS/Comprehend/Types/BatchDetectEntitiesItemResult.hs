...
mkBatchDetectEntitiesItemResult
    :: BatchDetectEntitiesItemResult
mkBatchDetectEntitiesItemResult
  = BatchDetectEntitiesItemResult'{entities = Core.Nothing,
                                   index = Core.Nothing}
...
instance Core.FromJSON BatchDetectEntitiesItemResult where
        parseJSON
          = Core.withObject "BatchDetectEntitiesItemResult" Core.$
              \ x ->
                BatchDetectEntitiesItemResult' Core.<$>
                  (x Core..:? "Entities") Core.<*> x Core..:? "Index"
