...
module Network.AWS.EC2.V2014_05_01.DescribeInstances where
...
data DescribeInstances = DescribeInstances
    ...
    , _disFilters :: [Filter]
      ...
      -- of the instance (ovm | xen). image-id - The ID of the image used
      -- to launch the instance. instance-id - The ID of the instance.
      -- instance-lifecycle - Indicates whether this is a Spot Instance
      -- (spot). instance-state-code - The state of the instance, as a
      -- 16-bit unsigned integer. The high byte is an opaque internal
      ...
      -- and 80 (stopped). instance-state-name - The state of the instance
      ...
      -- tag-key filter. virtualization-type - The virtualization type of
      -- the instance (paravirtual | hvm). vpc-id - The ID of the VPC that
      -- the instance is running in. network-interface.description - The
