...
-- |
-- Module      : Amazonka.SSM.Types.NotificationType
...
pattern NotificationType_Command = NotificationType' "Command"

pattern NotificationType_Invocation :: NotificationType
pattern NotificationType_Invocation = NotificationType' "Invocation"
