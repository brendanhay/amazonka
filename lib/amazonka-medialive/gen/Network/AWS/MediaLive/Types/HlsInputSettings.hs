...
mkHlsInputSettings
    :: HlsInputSettings
mkHlsInputSettings
  = HlsInputSettings'{bandwidth = Core.Nothing,
                      bufferSegments = Core.Nothing, retries = Core.Nothing,
...
{-# INLINEABLE hisBufferSegments #-}
{-# DEPRECATED bufferSegments "Use generic-lens or generic-optics with 'bufferSegments' instead"  #-}
...
{-# INLINEABLE hisRetries #-}
{-# DEPRECATED retries "Use generic-lens or generic-optics with 'retries' instead"  #-}
          ...
          = Core.withObject "HlsInputSettings" Core.$
              \ x ->
                HlsInputSettings' Core.<$>
                  (x Core..:? "bandwidth") Core.<*> x Core..:? "bufferSegments"
                    Core.<*> x Core..:? "retries"
