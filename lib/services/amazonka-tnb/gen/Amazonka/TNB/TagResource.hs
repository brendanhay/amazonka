...
-- |
-- Module      : Amazonka.TNB.TagResource
...
--
-- 'resourceArn', 'tagResource_resourceArn' - Resource ARN.
--
-- 'tags', 'tagResource_tags' - A tag is a label that you assign to an Amazon Web Services resource.
-- Each tag consists of a key and an optional value. You can use tags to
-- search and filter your resources or track your Amazon Web Services
-- costs.
newTagResource ::
