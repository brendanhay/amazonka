...
mkResourceIdentifierSummary
    :: ResourceIdentifierSummary
mkResourceIdentifierSummary
  = ResourceIdentifierSummary'{logicalResourceIds = Core.Nothing,
                               resourceIdentifiers = Core.Nothing, resourceType = Core.Nothing}
...
{-# INLINEABLE risLogicalResourceIds #-}
...
{-# INLINEABLE risResourceIdentifiers #-}
...
{-# INLINEABLE risResourceType #-}
{-# DEPRECATED resourceType "Use generic-lens or generic-optics with 'resourceType' instead"  #-}

instance Core.FromXML ResourceIdentifierSummary where
        parseXML x
          = ResourceIdentifierSummary' Core.<$>
              (x Core..@? "LogicalResourceIds" Core..<@>
                 Core.parseXMLNonEmpty "member")
                Core.<*>
                x Core..@? "ResourceIdentifiers" Core..<@>
