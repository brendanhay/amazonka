...
-- |
-- Module      : Network.AWS.ServiceCatalogAppRegistry.GetAssociatedResource
...
instance Prelude.Hashable GetAssociatedResource

instance Prelude.NFData GetAssociatedResource
