...
mkScope
    :: Scope
mkScope
  = Scope'{complianceResourceId = Core.Nothing,
           complianceResourceTypes = Core.Nothing, tagKey = Core.Nothing,
...
{-# INLINEABLE sComplianceResourceId #-}
...
{-# INLINEABLE sComplianceResourceTypes #-}
{-# DEPRECATED complianceResourceTypes "Use generic-lens or generic-optics with 'complianceResourceTypes' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("ComplianceResourceId" Core..=) Core.<$> complianceResourceId,
                  ("ComplianceResourceTypes" Core..=) Core.<$>
...
instance Core.FromJSON Scope where
        parseJSON
          = Core.withObject "Scope" Core.$
              \ x ->
                Scope' Core.<$>
                  (x Core..:? "ComplianceResourceId") Core.<*>
                    x Core..:? "ComplianceResourceTypes"
                    Core.<*> x Core..:? "TagKey"
