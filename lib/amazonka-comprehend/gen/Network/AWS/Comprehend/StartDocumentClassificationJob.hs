...
mkStartDocumentClassificationJob
    ...
    -> StartDocumentClassificationJob
mkStartDocumentClassificationJob documentClassifierArn
  inputDataConfig outputDataConfig dataAccessRoleArn
  = StartDocumentClassificationJob'{documentClassifierArn,
                                    inputDataConfig, outputDataConfig, dataAccessRoleArn,
...
{-# INLINEABLE sdcjDocumentClassifierArn #-}
...
{-# INLINEABLE sdcjInputDataConfig #-}
...
{-# INLINEABLE sdcjOutputDataConfig #-}
...
{-# INLINEABLE sdcjDataAccessRoleArn #-}
...
{-# INLINEABLE sdcjClientRequestToken #-}
...
instance Core.ToHeaders StartDocumentClassificationJob where
        toHeaders StartDocumentClassificationJob{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest StartDocumentClassificationJob where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartDocumentClassificationJobResponse' Core.<$>
...
mkStartDocumentClassificationJobResponse responseStatus
  = StartDocumentClassificationJobResponse'{jobId = Core.Nothing,
...
{-# INLINEABLE sdcjrrsResponseStatus #-}
