...
mkLinuxParameters
    :: LinuxParameters
mkLinuxParameters
  = LinuxParameters'{capabilities = Core.Nothing,
                     devices = Core.Nothing, initProcessEnabled = Core.Nothing,
                     maxSwap = Core.Nothing, sharedMemorySize = Core.Nothing,
                     swappiness = Core.Nothing, tmpfs = Core.Nothing}
          ...
          = Core.withObject "LinuxParameters" Core.$
              \ x ->
                LinuxParameters' Core.<$>
                  (x Core..:? "capabilities") Core.<*> x Core..:? "devices" Core.<*>
                    x Core..:? "initProcessEnabled"
                    Core.<*> x Core..:? "maxSwap"
