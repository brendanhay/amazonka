...
-- |
-- Module      : Amazonka.CognitoIdentityProvider.Types.MessageActionType
...
pattern MessageActionType_RESEND = MessageActionType' "RESEND"

pattern MessageActionType_SUPPRESS :: MessageActionType
pattern MessageActionType_SUPPRESS = MessageActionType' "SUPPRESS"
