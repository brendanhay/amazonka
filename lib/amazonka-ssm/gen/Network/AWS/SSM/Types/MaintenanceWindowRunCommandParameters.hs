...
{-# INLINEABLE mwrcpCloudWatchOutputConfig #-}
...
{-# INLINEABLE mwrcpDocumentHashType #-}
...
{-# INLINEABLE mwrcpDocumentVersion #-}
...
{-# INLINEABLE mwrcpNotificationConfig #-}
...
{-# INLINEABLE mwrcpOutputS3BucketName #-}
...
{-# INLINEABLE mwrcpOutputS3KeyPrefix #-}
...
{-# INLINEABLE mwrcpServiceRoleArn #-}
...
{-# INLINEABLE mwrcpTimeoutSeconds #-}
...
instance Core.FromJSON MaintenanceWindowRunCommandParameters where
        toJSON MaintenanceWindowRunCommandParameters{..}
          = Core.object
              (Core.catMaybes
                 [("CloudWatchOutputConfig" Core..=) Core.<$>
...
instance Core.FromJSON MaintenanceWindowRunCommandParameters where
        parseJSON
          = Core.withObject "MaintenanceWindowRunCommandParameters" Core.$
              \ x ->
                MaintenanceWindowRunCommandParameters' Core.<$>
                  (x Core..:? "CloudWatchOutputConfig") Core.<*> x Core..:? "Comment"
