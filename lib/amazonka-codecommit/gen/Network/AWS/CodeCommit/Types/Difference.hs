...
mkDifference
    :: Difference
mkDifference
  = Difference'{afterBlob = Core.Nothing, beforeBlob = Core.Nothing,
...
{-# INLINEABLE dAfterBlob #-}
{-# DEPRECATED afterBlob "Use generic-lens or generic-optics with 'afterBlob' instead"  #-}
...
{-# INLINEABLE dBeforeBlob #-}
{-# DEPRECATED beforeBlob "Use generic-lens or generic-optics with 'beforeBlob' instead"  #-}
...
instance Core.FromJSON Difference where
        parseJSON
          = Core.withObject "Difference" Core.$
              \ x ->
                Difference' Core.<$>
                  (x Core..:? "afterBlob") Core.<*> x Core..:? "beforeBlob" Core.<*>
                    x Core..:? "changeType"
