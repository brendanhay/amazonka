...
-- | Amazon Resource Name (ARN) of the input Amazon Kinesis Firehose delivery
-- stream to read.
kinesisFirehoseInputUpdate_resourceARNUpdate :: Lens.Lens' KinesisFirehoseInputUpdate (Core.Maybe Core.Text)
...
-- the stream on your behalf. You need to grant the necessary permissions
-- to this role.
kinesisFirehoseInputUpdate_roleARNUpdate :: Lens.Lens' KinesisFirehoseInputUpdate (Core.Maybe Core.Text)
...
instance Core.Hashable KinesisFirehoseInputUpdate

instance Core.NFData KinesisFirehoseInputUpdate
