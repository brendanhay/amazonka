...
instance AWSPager DescribeTransitGatewayVPCAttachments where
  page rq rs
    | stop (rs ^. dtgvarsNextToken) = Nothing
    | stop (rs ^. dtgvarsTransitGatewayVPCAttachments) = Nothing
    | otherwise =
      Just $ rq & dtgvpcaNextToken .~ rs ^. dtgvarsNextToken

instance AWSRequest DescribeTransitGatewayVPCAttachments where
  type
...
instance Hashable DescribeTransitGatewayVPCAttachments

instance NFData DescribeTransitGatewayVPCAttachments

instance ToHeaders DescribeTransitGatewayVPCAttachments where
...
instance ToQuery DescribeTransitGatewayVPCAttachments where
  toQuery DescribeTransitGatewayVPCAttachments' {..} =
    mconcat
      [ "Action"
          =: ("DescribeTransitGatewayVpcAttachments" :: ByteString),
...
data DescribeTransitGatewayVPCAttachmentsResponse = DescribeTransitGatewayVPCAttachmentsResponse'
  { _dtgvarsTransitGatewayVPCAttachments ::
      !( Maybe
...
instance NFData DescribeTransitGatewayVPCAttachmentsResponse
