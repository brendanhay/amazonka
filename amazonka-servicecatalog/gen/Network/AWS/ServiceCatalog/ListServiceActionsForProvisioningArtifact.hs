...
data ListServiceActionsForProvisioningArtifact = ListServiceActionsForProvisioningArtifact'
  { _lsafpaAcceptLanguage         :: !(Maybe Text)
  , _lsafpaPageToken              :: !(Maybe Text)
  , _lsafpaPageSize               :: !(Maybe Nat)
  , _lsafpaProductId              :: !Text
  , _lsafpaProvisioningArtifactId :: !Text
...
listServiceActionsForProvisioningArtifact
    ...
    -> ListServiceActionsForProvisioningArtifact
listServiceActionsForProvisioningArtifact pProductId_ pProvisioningArtifactId_ =
  ListServiceActionsForProvisioningArtifact'
    { _lsafpaAcceptLanguage = Nothing
    , _lsafpaPageToken = Nothing
    , _lsafpaPageSize = Nothing
    , _lsafpaProductId = pProductId_
    , _lsafpaProvisioningArtifactId = pProvisioningArtifactId_
    }
...
data ListServiceActionsForProvisioningArtifactResponse = ListServiceActionsForProvisioningArtifactResponse'
  { _lsafparsNextPageToken          :: !(Maybe Text)
  , _lsafparsServiceActionSummaries :: !(Maybe [ServiceActionSummary])
  , _lsafparsResponseStatus         :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
listServiceActionsForProvisioningArtifactResponse pResponseStatus_ =
  ListServiceActionsForProvisioningArtifactResponse'
    { _lsafparsNextPageToken = Nothing
