...
mkRegexMatchTuple fieldToMatch textTransformation regexPatternSetId
  = RegexMatchTuple'{fieldToMatch, textTransformation,
                     regexPatternSetId}
...
{-# INLINEABLE rmtTextTransformation #-}
...
{-# INLINEABLE rmtRegexPatternSetId #-}
