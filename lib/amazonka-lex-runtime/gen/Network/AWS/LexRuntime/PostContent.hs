  ...
  toHeaders PostContent' {..} =
    mconcat
      [ "Accept" =# _pcAccept,
        ...
        "x-amz-lex-request-attributes" =# _pcRequestAttributes,
        "x-amz-lex-session-attributes" =# _pcSessionAttributes,
...
data PostContentResponse = PostContentResponse'
  { _pcrsSentimentResponse ::
      !(Maybe Text),
    _pcrsNluIntentConfidence :: !(Maybe Text),
    _pcrsSlots :: !(Maybe Text),
    _pcrsIntentName :: !(Maybe Text),
    _pcrsBotVersion :: !(Maybe Text),
    _pcrsDialogState :: !(Maybe DialogState),
    _pcrsActiveContexts :: !(Maybe (Sensitive Text)),
    _pcrsAlternativeIntents :: !(Maybe Text),
...
postContentResponse pResponseStatus_ pAudioStream_ =
  PostContentResponse'
    { _pcrsSentimentResponse = Nothing,
