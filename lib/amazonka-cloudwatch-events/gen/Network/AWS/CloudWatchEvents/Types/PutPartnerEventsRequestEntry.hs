...
mkPutPartnerEventsRequestEntry
    :: PutPartnerEventsRequestEntry
mkPutPartnerEventsRequestEntry
  = PutPartnerEventsRequestEntry'{detail = Core.Nothing,
                                  detailType = Core.Nothing, resources = Core.Nothing,
                                  source = Core.Nothing, time = Core.Nothing}
...
ppereDetail :: Lens.Lens' PutPartnerEventsRequestEntry (Core.Maybe Core.Text)
ppereDetail = Lens.field @"detail"
{-# INLINEABLE ppereDetail #-}
...
ppereDetailType :: Lens.Lens' PutPartnerEventsRequestEntry (Core.Maybe Core.Text)
ppereDetailType = Lens.field @"detailType"
{-# INLINEABLE ppereDetailType #-}
