...
-- |
-- Module      : Network.AWS.LexV2Models.BuildBotLocale
...
instance Prelude.Hashable BuildBotLocale

instance Prelude.NFData BuildBotLocale
...
instance Prelude.NFData BuildBotLocaleResponse
