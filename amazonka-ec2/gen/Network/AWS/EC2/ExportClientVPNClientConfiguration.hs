...
instance ToHeaders ExportClientVPNClientConfiguration
         where
        toHeaders = const mempty

instance ToPath ExportClientVPNClientConfiguration
         where
        toPath = const "/"

instance ToQuery ExportClientVPNClientConfiguration
         where
