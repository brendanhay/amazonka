...
instance ToQuery RestoreFromClusterSnapshot where
  toQuery RestoreFromClusterSnapshot' {..} =
    mconcat
      [ "Action" =: ("RestoreFromClusterSnapshot" :: ByteString),
        "Version" =: ("2012-12-01" :: ByteString),
        "ManualSnapshotRetentionPeriod"
          =: _rfcsManualSnapshotRetentionPeriod,
        "EnhancedVpcRouting" =: _rfcsEnhancedVPCRouting,
        "AdditionalInfo" =: _rfcsAdditionalInfo,
        "SnapshotScheduleIdentifier" =: _rfcsSnapshotScheduleIdentifier,
        ...
        "VpcSecurityGroupIds"
          =: toQuery
            (toQueryList "VpcSecurityGroupId" <$> _rfcsVPCSecurityGroupIds),
        "IamRoles" =: toQuery (toQueryList "IamRoleArn" <$> _rfcsIAMRoles),
