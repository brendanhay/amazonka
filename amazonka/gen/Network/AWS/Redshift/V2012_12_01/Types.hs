...
instance ServiceError (Er Redshift) where
...
instance ToByteString SourceType where
    toBS SourceTypeCluster = "cluster"
    toBS SourceTypeClusterParameterGroup = "cluster-parameter-group"
    toBS SourceTypeClusterSecurityGroup = "cluster-security-group"
    toBS SourceTypeClusterSnapshot = "cluster-snapshot"
