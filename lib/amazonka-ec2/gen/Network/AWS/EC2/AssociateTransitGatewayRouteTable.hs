...
mkAssociateTransitGatewayRouteTable
    ...
    -> AssociateTransitGatewayRouteTable
mkAssociateTransitGatewayRouteTable transitGatewayRouteTableId
  transitGatewayAttachmentId
  = AssociateTransitGatewayRouteTable'{transitGatewayRouteTableId,
...
{-# INLINEABLE atgrtTransitGatewayRouteTableId #-}
...
{-# INLINEABLE atgrtTransitGatewayAttachmentId #-}
...
{-# INLINEABLE atgrtDryRun #-}
{-# DEPRECATED dryRun "Use generic-lens or generic-optics with 'dryRun' instead"  #-}

instance Core.ToQuery AssociateTransitGatewayRouteTable where
        toQuery AssociateTransitGatewayRouteTable{..}
          = Core.toQueryPair "Action"
              ("AssociateTransitGatewayRouteTable" :: Core.Text)
...
instance Core.ToHeaders AssociateTransitGatewayRouteTable where
...
instance Core.AWSRequest AssociateTransitGatewayRouteTable where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 AssociateTransitGatewayRouteTableResponse' Core.<$>
...
mkAssociateTransitGatewayRouteTableResponse responseStatus
  = AssociateTransitGatewayRouteTableResponse'{association =
                                                 Core.Nothing,
                                               responseStatus}
...
{-# INLINEABLE atgrtrrsAssociation #-}
...
{-# INLINEABLE atgrtrrsResponseStatus #-}
