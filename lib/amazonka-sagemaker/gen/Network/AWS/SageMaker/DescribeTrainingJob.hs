...
instance Core.AWSRequest DescribeTrainingJob where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeTrainingJobResponse' Core.<$>
...
mkDescribeTrainingJobResponse
    ...
    -> Types.SecondaryStatus -- ^ 'secondaryStatus'
    ...
    -> DescribeTrainingJobResponse
mkDescribeTrainingJobResponse trainingJobName trainingJobArn
  modelArtifacts trainingJobStatus secondaryStatus
  algorithmSpecification resourceConfig stoppingCondition
  creationTime responseStatus
  = DescribeTrainingJobResponse'{trainingJobName, trainingJobArn,
                                 modelArtifacts, trainingJobStatus, secondaryStatus,
                                 algorithmSpecification, resourceConfig, stoppingCondition,
                                 ...
                                 lastModifiedTime = Core.Nothing, outputDataConfig = Core.Nothing,
                                 roleArn = Core.Nothing, secondaryStatusTransitions = Core.Nothing,
                                 ...
                                 vpcConfig = Core.Nothing, responseStatus}
...
{-# INLINEABLE dtjrfrsTrainingJobName #-}
{-# DEPRECATED trainingJobName "Use generic-lens or generic-optics with 'trainingJobName' instead"  #-}
...
{-# INLINEABLE dtjrfrsTrainingJobArn #-}
...
{-# INLINEABLE dtjrfrsModelArtifacts #-}
...
{-# INLINEABLE dtjrfrsTrainingJobStatus #-}
...
{-# INLINEABLE dtjrfrsSecondaryStatus #-}
...
{-# INLINEABLE dtjrfrsAlgorithmSpecification #-}
...
{-# INLINEABLE dtjrfrsResourceConfig #-}
...
{-# INLINEABLE dtjrfrsStoppingCondition #-}
...
{-# INLINEABLE dtjrfrsCreationTime #-}
...
{-# INLINEABLE dtjrfrsAutoMLJobArn #-}
...
{-# INLINEABLE dtjrfrsBillableTimeInSeconds #-}
...
{-# INLINEABLE dtjrfrsCheckpointConfig #-}
...
{-# INLINEABLE dtjrfrsDebugHookConfig #-}
...
{-# INLINEABLE dtjrfrsDebugRuleConfigurations #-}
...
{-# INLINEABLE dtjrfrsDebugRuleEvaluationStatuses #-}
...
{-# INLINEABLE dtjrfrsEnableInterContainerTrafficEncryption #-}
...
{-# INLINEABLE dtjrfrsEnableManagedSpotTraining #-}
...
{-# INLINEABLE dtjrfrsEnableNetworkIsolation #-}
...
{-# INLINEABLE dtjrfrsExperimentConfig #-}
...
{-# INLINEABLE dtjrfrsFailureReason #-}
...
{-# INLINEABLE dtjrfrsFinalMetricDataList #-}
...
{-# INLINEABLE dtjrfrsHyperParameters #-}
...
{-# INLINEABLE dtjrfrsInputDataConfig #-}
...
{-# INLINEABLE dtjrfrsLabelingJobArn #-}
...
{-# INLINEABLE dtjrfrsLastModifiedTime #-}
...
{-# INLINEABLE dtjrfrsOutputDataConfig #-}
...
{-# INLINEABLE dtjrfrsSecondaryStatusTransitions #-}
...
{-# INLINEABLE dtjrfrsTensorBoardOutputConfig #-}
...
{-# INLINEABLE dtjrfrsTrainingEndTime #-}
...
{-# INLINEABLE dtjrfrsTrainingStartTime #-}
...
{-# INLINEABLE dtjrfrsTrainingTimeInSeconds #-}
...
{-# INLINEABLE dtjrfrsTuningJobArn #-}
...
{-# INLINEABLE dtjrfrsResponseStatus #-}
