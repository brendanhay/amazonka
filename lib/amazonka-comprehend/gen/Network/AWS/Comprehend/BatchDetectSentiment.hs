...
instance Core.ToHeaders BatchDetectSentiment where
        toHeaders BatchDetectSentiment{..}
          = Core.pure
...
instance Core.AWSRequest BatchDetectSentiment where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 BatchDetectSentimentResponse' Core.<$>
...
mkBatchDetectSentimentResponse responseStatus
  = BatchDetectSentimentResponse'{resultList = Core.mempty,
...
{-# INLINEABLE bdsrrsResponseStatus #-}
