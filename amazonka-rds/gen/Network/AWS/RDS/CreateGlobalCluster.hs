...
--
-- * 'cgcDeletionProtection' - The deletion protection setting for the new global database. The global database can't be deleted when this value is set to true.
--
...
--
-- * 'cgcEngine' - Provides the name of the database engine to be used for this DB cluster.
--
...
instance AWSRequest CreateGlobalCluster where
        type Rs CreateGlobalCluster =
             CreateGlobalClusterResponse
        request = postQuery rds
        response
          = receiveXMLWrapper "CreateGlobalClusterResult"
              (\ s h x ->
                 CreateGlobalClusterResponse' <$>
                   (x .@? "GlobalCluster") <*> (pure (fromEnum s)))

instance Hashable CreateGlobalCluster where

instance NFData CreateGlobalCluster where
...
data CreateGlobalClusterResponse = CreateGlobalClusterResponse'
  { _cgcrsGlobalCluster  :: !(Maybe GlobalCluster)
...
createGlobalClusterResponse
    :: Int -- ^ 'cgcrsResponseStatus'
    -> CreateGlobalClusterResponse
createGlobalClusterResponse pResponseStatus_ =
  CreateGlobalClusterResponse'
    {_cgcrsGlobalCluster = Nothing, _cgcrsResponseStatus = pResponseStatus_}
...
instance NFData CreateGlobalClusterResponse where
