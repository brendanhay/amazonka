...
{-# INLINEABLE ddcgfDirectConnectGatewayId #-}
...
instance Core.AWSRequest DeleteDirectConnectGateway where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DeleteDirectConnectGatewayResponse' Core.<$>
...
mkDeleteDirectConnectGatewayResponse responseStatus
  = DeleteDirectConnectGatewayResponse'{directConnectGateway =
                                          Core.Nothing,
                                        responseStatus}
...
{-# INLINEABLE ddcgrfrsDirectConnectGateway #-}
...
{-# INLINEABLE ddcgrfrsResponseStatus #-}
