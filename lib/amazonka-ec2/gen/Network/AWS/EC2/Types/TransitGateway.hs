...
tgCreationTime :: Lens.Lens' TransitGateway (Lude.Maybe Lude.ISO8601)
tgCreationTime = Lens.lens (creationTime :: TransitGateway -> Lude.Maybe Lude.ISO8601) (\s a -> s {creationTime = a} :: TransitGateway)
