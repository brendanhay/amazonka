...
mkResourceViolation
    :: ResourceViolation
mkResourceViolation
  = ResourceViolation'{awsEc2InstanceViolation = Core.Nothing,
...
{-# INLINEABLE rvAwsEc2InstanceViolation #-}
{-# DEPRECATED awsEc2InstanceViolation "Use generic-lens or generic-optics with 'awsEc2InstanceViolation' instead"  #-}
...
{-# INLINEABLE rvAwsEc2NetworkInterfaceViolation #-}
{-# DEPRECATED awsEc2NetworkInterfaceViolation "Use generic-lens or generic-optics with 'awsEc2NetworkInterfaceViolation' instead"  #-}
...
{-# INLINEABLE rvAwsVPCSecurityGroupViolation #-}
{-# DEPRECATED awsVPCSecurityGroupViolation "Use generic-lens or generic-optics with 'awsVPCSecurityGroupViolation' instead"  #-}
...
{-# INLINEABLE rvNetworkFirewallMissingExpectedRTViolation #-}
{-# DEPRECATED networkFirewallMissingExpectedRTViolation "Use generic-lens or generic-optics with 'networkFirewallMissingExpectedRTViolation' instead"  #-}
...
{-# INLINEABLE rvNetworkFirewallMissingFirewallViolation #-}
{-# DEPRECATED networkFirewallMissingFirewallViolation "Use generic-lens or generic-optics with 'networkFirewallMissingFirewallViolation' instead"  #-}
...
{-# INLINEABLE rvNetworkFirewallMissingSubnetViolation #-}
{-# DEPRECATED networkFirewallMissingSubnetViolation "Use generic-lens or generic-optics with 'networkFirewallMissingSubnetViolation' instead"  #-}
...
{-# INLINEABLE rvNetworkFirewallPolicyModifiedViolation #-}
{-# DEPRECATED networkFirewallPolicyModifiedViolation "Use generic-lens or generic-optics with 'networkFirewallPolicyModifiedViolation' instead"  #-}

instance Core.FromJSON ResourceViolation where
        parseJSON
          = Core.withObject "ResourceViolation" Core.$
              \ x ->
                ResourceViolation' Core.<$>
                  (x Core..:? "AwsEc2InstanceViolation") Core.<*>
                    x Core..:? "AwsEc2NetworkInterfaceViolation"
