...
--
-- 'wirelessDeviceIdEventTopic', 'messageDeliveryStatusEventConfiguration_wirelessDeviceIdEventTopic' - Enum to denote whether the wireless device id device registration state
-- event topic is enabled or disabled.
--
