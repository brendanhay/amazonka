...
mkProcessingJob
    :: ProcessingJob
mkProcessingJob
  = ProcessingJob'{appSpecification = Core.Nothing,
                   autoMLJobArn = Core.Nothing, creationTime = Core.Nothing,
                   environment = Core.Nothing, exitMessage = Core.Nothing,
                   experimentConfig = Core.Nothing, failureReason = Core.Nothing,
                   lastModifiedTime = Core.Nothing,
                   monitoringScheduleArn = Core.Nothing, networkConfig = Core.Nothing,
                   processingEndTime = Core.Nothing, processingInputs = Core.Nothing,
                   processingJobArn = Core.Nothing, processingJobName = Core.Nothing,
...
{-# INLINEABLE pjMonitoringScheduleArn #-}
...
{-# INLINEABLE pjProcessingEndTime #-}
...
{-# INLINEABLE pjProcessingJobName #-}
...
{-# INLINEABLE pjProcessingJobStatus #-}
...
{-# INLINEABLE pjProcessingOutputConfig #-}
...
{-# INLINEABLE pjProcessingResources #-}
...
{-# INLINEABLE pjProcessingStartTime #-}
...
{-# INLINEABLE pjStoppingCondition #-}
...
instance Core.FromJSON ProcessingJob where
        parseJSON
          = Core.withObject "ProcessingJob" Core.$
              \ x ->
                ProcessingJob' Core.<$>
                  (x Core..:? "AppSpecification") Core.<*> x Core..:? "AutoMLJobArn"
