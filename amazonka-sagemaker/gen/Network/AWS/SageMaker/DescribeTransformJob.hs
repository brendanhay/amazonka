...
instance Prelude.AWSRequest DescribeTransformJob where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          DescribeTransformJobResponse'
            ...
            Prelude.<*> (x Prelude..?> "TransformStartTime")
            ...
            Prelude.<*> (x Prelude..?> "ModelClientConfig")
            Prelude.<*> (x Prelude..?> "TransformEndTime")
            Prelude.<*> (x Prelude..?> "DataProcessing")
...
instance Prelude.ToHeaders DescribeTransformJob where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "SageMaker.DescribeTransformJob" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON DescribeTransformJob where
...
instance Prelude.ToPath DescribeTransformJob where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DescribeTransformJob where
...
data DescribeTransformJobResponse = DescribeTransformJobResponse'
  { -- | The Amazon Resource Name (ARN) of the Amazon SageMaker Ground Truth
    ...
    -- @TransformEndTime@.
    transformStartTime :: Prelude.Maybe Prelude.POSIX,
...
describeTransformJobResponse_transformStartTime = Lens.lens (\DescribeTransformJobResponse' {transformStartTime} -> transformStartTime) (\s@DescribeTransformJobResponse' {} a -> s {transformStartTime = a} :: DescribeTransformJobResponse) Prelude.. Lens.mapping Prelude._Time
...
describeTransformJobResponse_environment = Lens.lens (\DescribeTransformJobResponse' {environment} -> environment) (\s@DescribeTransformJobResponse' {} a -> s {environment = a} :: DescribeTransformJobResponse) Prelude.. Lens.mapping Prelude._Coerce
...
describeTransformJobResponse_transformEndTime = Lens.lens (\DescribeTransformJobResponse' {transformEndTime} -> transformEndTime) (\s@DescribeTransformJobResponse' {} a -> s {transformEndTime = a} :: DescribeTransformJobResponse) Prelude.. Lens.mapping Prelude._Time
...
describeTransformJobResponse_creationTime = Lens.lens (\DescribeTransformJobResponse' {creationTime} -> creationTime) (\s@DescribeTransformJobResponse' {} a -> s {creationTime = a} :: DescribeTransformJobResponse) Prelude.. Prelude._Time
