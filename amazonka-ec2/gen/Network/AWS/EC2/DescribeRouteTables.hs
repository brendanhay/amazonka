...
-- association. 'association.main' - Indicates whether the route table is
-- the main route table for the VPC. 'route-table-id' - The ID of the route
-- table. 'route.destination-cidr-block' - The CIDR range specified in a
-- route in the table. 'route.gateway-id' - The ID of a gateway specified in
-- a route in the table. 'route.instance-id' - The ID of an instance
-- specified in a route in the table. 'route.origin' - Describes how the
-- route was created. 'CreateRouteTable' indicates that the route was
...
-- 'EnableVgwRoutePropagation' indicates that the route was propagated by
-- route propagation. 'route.state' - The state of a route in the route
