...
mkFailedQueuedPurchaseDeletion
    :: FailedQueuedPurchaseDeletion
mkFailedQueuedPurchaseDeletion
  = FailedQueuedPurchaseDeletion'{error = Core.Nothing,
...
fqpdReservedInstancesId :: Lens.Lens' FailedQueuedPurchaseDeletion (Core.Maybe Core.Text)
fqpdReservedInstancesId = Lens.field @"reservedInstancesId"
{-# INLINEABLE fqpdReservedInstancesId #-}
...
instance Core.FromXML FailedQueuedPurchaseDeletion where
        parseXML x
          = FailedQueuedPurchaseDeletion' Core.<$>
              (x Core..@? "error") Core.<*> x Core..@? "reservedInstancesId"
