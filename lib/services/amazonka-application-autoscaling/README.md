...
`2.0` - Derived from API version @2016-02-06@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.ApplicationAutoScaling](http://hackage.haskell.org/package/amazonka-application-autoscaling/docs/Amazonka-ApplicationAutoScaling.html)
