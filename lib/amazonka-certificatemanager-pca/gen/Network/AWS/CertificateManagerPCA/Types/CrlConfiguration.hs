...
mkCrlConfiguration enabled
  = CrlConfiguration'{enabled, customCname = Core.Nothing,
                      expirationInDays = Core.Nothing, s3BucketName = Core.Nothing}
...
{-# INLINEABLE ccCustomCname #-}
{-# DEPRECATED customCname "Use generic-lens or generic-optics with 'customCname' instead"  #-}
...
{-# INLINEABLE ccExpirationInDays #-}
{-# DEPRECATED expirationInDays "Use generic-lens or generic-optics with 'expirationInDays' instead"  #-}
          ...
          = Core.withObject "CrlConfiguration" Core.$
              \ x ->
                CrlConfiguration' Core.<$>
                  (x Core..: "Enabled") Core.<*> x Core..:? "CustomCname" Core.<*>
                    x Core..:? "ExpirationInDays"
