...
mkKendraConfiguration
    :: Types.KendraIndexArn -- ^ 'kendraIndex'
    -> Types.Role -- ^ 'role\''
    -> KendraConfiguration
mkKendraConfiguration kendraIndex role'
  = KendraConfiguration'{kendraIndex, role',
...
{-# INLINEABLE kcKendraIndex #-}
{-# DEPRECATED kendraIndex "Use generic-lens or generic-optics with 'kendraIndex' instead"  #-}
...
{-# INLINEABLE kcQueryFilterString #-}
{-# DEPRECATED queryFilterString "Use generic-lens or generic-optics with 'queryFilterString' instead"  #-}
          ...
          = Core.withObject "KendraConfiguration" Core.$
              \ x ->
                KendraConfiguration' Core.<$>
                  (x Core..: "kendraIndex") Core.<*> x Core..: "role" Core.<*>
                    x Core..:? "queryFilterString"
