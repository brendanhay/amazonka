...
`2.0` - Derived from API version @2014-11-06@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.SSM](http://hackage.haskell.org/package/amazonka-ssm/docs/Amazonka-SSM.html)
