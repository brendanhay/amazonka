...
-- |
-- Module      : Amazonka.ApplicationAutoScaling.UntagResource
...
--
-- 'resourceARN', 'untagResource_resourceARN' - Identifies the Application Auto Scaling scalable target from which to
-- remove tags.
--
-- For example:
-- @arn:aws:application-autoscaling:us-east-1:123456789012:scalable-target\/1234abcd56ab78cd901ef1234567890ab123@
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "AnyScaleFrontendService.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
