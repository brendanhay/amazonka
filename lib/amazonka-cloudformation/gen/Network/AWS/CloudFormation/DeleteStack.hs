...
data DeleteStack = DeleteStack'
  { -- | For stacks in the @DELETE_FAILED@ state, a list of resource logical IDs that are associated with the resources you want to retain. During deletion, AWS CloudFormation deletes the stack but does not delete the retained resources.
    ...
    retainResources :: Lude.Maybe [Lude.Text],
...
dRetainResources :: Lens.Lens' DeleteStack (Lude.Maybe [Lude.Text])
dRetainResources = Lens.lens (retainResources :: DeleteStack -> Lude.Maybe [Lude.Text]) (\s a -> s {retainResources = a} :: DeleteStack)
{-# DEPRECATED dRetainResources "Use generic-lens or generic-optics with 'retainResources' instead." #-}
...
dClientRequestToken :: Lens.Lens' DeleteStack (Lude.Maybe Lude.Text)
dClientRequestToken = Lens.lens (clientRequestToken :: DeleteStack -> Lude.Maybe Lude.Text) (\s a -> s {clientRequestToken = a} :: DeleteStack)
{-# DEPRECATED dClientRequestToken "Use generic-lens or generic-optics with 'clientRequestToken' instead." #-}
...
dRoleARN :: Lens.Lens' DeleteStack (Lude.Maybe Lude.Text)
dRoleARN = Lens.lens (roleARN :: DeleteStack -> Lude.Maybe Lude.Text) (\s a -> s {roleARN = a} :: DeleteStack)
{-# DEPRECATED dRoleARN "Use generic-lens or generic-optics with 'roleARN' instead." #-}

-- | The name or the unique stack ID that is associated with the stack.
--
-- /Note:/ Consider using 'stackName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dStackName :: Lens.Lens' DeleteStack Lude.Text
dStackName = Lens.lens (stackName :: DeleteStack -> Lude.Text) (\s a -> s {stackName = a} :: DeleteStack)
