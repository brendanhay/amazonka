...
data HostKeyAttributes = HostKeyAttributes'
  { -- | The SSH host key algorithm or the RDP certificate format.
    ...
    algorithm :: Core.Maybe Types.String,
    ...
    fingerprintSHA1 :: Core.Maybe Types.String,
    ...
    fingerprintSHA256 :: Core.Maybe Types.String,
    ...
    publicKey :: Core.Maybe Types.String,
...
hkaAlgorithm :: Lens.Lens' HostKeyAttributes (Core.Maybe Types.String)
...
hkaFingerprintSHA1 :: Lens.Lens' HostKeyAttributes (Core.Maybe Types.String)
...
hkaFingerprintSHA256 :: Lens.Lens' HostKeyAttributes (Core.Maybe Types.String)
...
hkaPublicKey :: Lens.Lens' HostKeyAttributes (Core.Maybe Types.String)
