...
mkListInstanceProfilesForRole roleName
  = ListInstanceProfilesForRole'{roleName, marker = Core.Nothing,
...
instance Core.AWSRequest ListInstanceProfilesForRole where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListInstanceProfilesForRoleResult"
              (\ s h x ->
                 ListInstanceProfilesForRoleResponse' Core.<$>
...
{-# INLINEABLE lipfrrrsInstanceProfiles #-}
...
{-# INLINEABLE lipfrrrsIsTruncated #-}
...
{-# INLINEABLE lipfrrrsResponseStatus #-}
