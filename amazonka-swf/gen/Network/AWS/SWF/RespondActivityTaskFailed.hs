...
-- | Detailed information about the failure.
respondActivityTaskFailed_details :: Lens.Lens' RespondActivityTaskFailed (Core.Maybe Core.Text)
...
-- | Description of the error that may assist in diagnostics.
respondActivityTaskFailed_reason :: Lens.Lens' RespondActivityTaskFailed (Core.Maybe Core.Text)
...
-- must also be passed. This enables it to provide its progress and respond
-- with results.
respondActivityTaskFailed_taskToken :: Lens.Lens' RespondActivityTaskFailed Core.Text
...
instance Core.Hashable RespondActivityTaskFailed

instance Core.NFData RespondActivityTaskFailed
