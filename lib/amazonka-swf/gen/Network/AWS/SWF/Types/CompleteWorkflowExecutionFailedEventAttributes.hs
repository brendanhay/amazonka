...
mkCompleteWorkflowExecutionFailedEventAttributes
    :: Types.CompleteWorkflowExecutionFailedCause -- ^ 'cause'
    -> Core.Integer -- ^ 'decisionTaskCompletedEventId'
    -> CompleteWorkflowExecutionFailedEventAttributes
mkCompleteWorkflowExecutionFailedEventAttributes cause
...
{-# INLINEABLE cDecisionTaskCompletedEventId #-}
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "CompleteWorkflowExecutionFailedEventAttributes"
              Core.$
              \ x ->
                CompleteWorkflowExecutionFailedEventAttributes' Core.<$>
                  (x Core..: "cause") Core.<*>
