...
-- |
-- Module      : Network.AWS.Kendra.BatchDeleteDocument
...
instance Prelude.Hashable BatchDeleteDocument

instance Prelude.NFData BatchDeleteDocument
...
instance Prelude.NFData BatchDeleteDocumentResponse
