...
mkCreateGovCloudAccount email accountName
  = CreateGovCloudAccount'{email, accountName,
                           iamUserAccessToBilling = Core.Nothing, roleName = Core.Nothing,
                           tags = Core.Nothing}
...
{-# INLINEABLE cgcaIamUserAccessToBilling #-}
{-# DEPRECATED iamUserAccessToBilling "Use generic-lens or generic-optics with 'iamUserAccessToBilling' instead"  #-}
...
instance Core.ToHeaders CreateGovCloudAccount where
        toHeaders CreateGovCloudAccount{..}
          = Core.pure
...
instance Core.AWSRequest CreateGovCloudAccount where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateGovCloudAccountResponse' Core.<$>
...
{-# INLINEABLE cgcarrsCreateAccountStatus #-}
