...
mkListHostedZonesByName
    :: ListHostedZonesByName
mkListHostedZonesByName
  = ListHostedZonesByName'{dNSName = Core.Nothing,
                           hostedZoneId = Core.Nothing, maxItems = Core.Nothing}
...
instance Core.AWSRequest ListHostedZonesByName where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/2013-04-01/hostedzonesbyname",
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 ListHostedZonesByNameResponse' Core.<$>
...
mkListHostedZonesByNameResponse isTruncated maxItems responseStatus
  = ListHostedZonesByNameResponse'{hostedZones = Core.mempty,
                                   isTruncated, maxItems, dNSName = Core.Nothing,
                                   hostedZoneId = Core.Nothing, nextDNSName = Core.Nothing,
                                   nextHostedZoneId = Core.Nothing, responseStatus}
...
{-# INLINEABLE lhzbnrrsHostedZones #-}
...
{-# INLINEABLE lhzbnrrsIsTruncated #-}
...
{-# INLINEABLE lhzbnrrsHostedZoneId #-}
{-# DEPRECATED hostedZoneId "Use generic-lens or generic-optics with 'hostedZoneId' instead"  #-}
...
{-# INLINEABLE lhzbnrrsNextDNSName #-}
{-# DEPRECATED nextDNSName "Use generic-lens or generic-optics with 'nextDNSName' instead"  #-}
...
{-# INLINEABLE lhzbnrrsNextHostedZoneId #-}
{-# DEPRECATED nextHostedZoneId "Use generic-lens or generic-optics with 'nextHostedZoneId' instead"  #-}
...
{-# INLINEABLE lhzbnrrsResponseStatus #-}
