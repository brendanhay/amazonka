...
-- |
-- Module      : Network.AWS.LexV2Models.CreateBotLocale
...
instance Prelude.Hashable CreateBotLocale

instance Prelude.NFData CreateBotLocale
...
instance Prelude.NFData CreateBotLocaleResponse
