...
mkHlsCdnSettings
    :: HlsCdnSettings
mkHlsCdnSettings
  = HlsCdnSettings'{hlsAkamaiSettings = Core.Nothing,
...
{-# INLINEABLE hcsHlsAkamaiSettings #-}
{-# DEPRECATED hlsAkamaiSettings "Use generic-lens or generic-optics with 'hlsAkamaiSettings' instead"  #-}
...
{-# INLINEABLE hcsHlsBasicPutSettings #-}
{-# DEPRECATED hlsBasicPutSettings "Use generic-lens or generic-optics with 'hlsBasicPutSettings' instead"  #-}
...
{-# INLINEABLE hcsHlsMediaStoreSettings #-}
{-# DEPRECATED hlsMediaStoreSettings "Use generic-lens or generic-optics with 'hlsMediaStoreSettings' instead"  #-}
...
{-# INLINEABLE hcsHlsWebdavSettings #-}
{-# DEPRECATED hlsWebdavSettings "Use generic-lens or generic-optics with 'hlsWebdavSettings' instead"  #-}
...
instance Core.FromJSON HlsCdnSettings where
        parseJSON
          = Core.withObject "HlsCdnSettings" Core.$
              \ x ->
                HlsCdnSettings' Core.<$>
                  (x Core..:? "hlsAkamaiSettings") Core.<*>
                    x Core..:? "hlsBasicPutSettings"
