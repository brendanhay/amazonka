...
mkSetLoadBasedAutoScaling layerId
  = SetLoadBasedAutoScaling'{layerId, downScaling = Core.Nothing,
                             enable = Core.Nothing, upScaling = Core.Nothing}
...
slbasLayerId :: Lens.Lens' SetLoadBasedAutoScaling Core.Text
slbasLayerId = Lens.field @"layerId"
{-# INLINEABLE slbasLayerId #-}
...
instance Core.ToHeaders SetLoadBasedAutoScaling where
        toHeaders SetLoadBasedAutoScaling{..}
          = Core.pure
