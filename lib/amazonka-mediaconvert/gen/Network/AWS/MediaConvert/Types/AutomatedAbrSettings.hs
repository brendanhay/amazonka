...
mkAutomatedAbrSettings
    :: AutomatedAbrSettings
mkAutomatedAbrSettings
  = AutomatedAbrSettings'{maxAbrBitrate = Core.Nothing,
                          maxRenditions = Core.Nothing, minAbrBitrate = Core.Nothing}
...
{-# INLINEABLE aasMaxAbrBitrate #-}
{-# DEPRECATED maxAbrBitrate "Use generic-lens or generic-optics with 'maxAbrBitrate' instead"  #-}
...
{-# INLINEABLE aasMaxRenditions #-}
{-# DEPRECATED maxRenditions "Use generic-lens or generic-optics with 'maxRenditions' instead"  #-}
...
{-# INLINEABLE aasMinAbrBitrate #-}
{-# DEPRECATED minAbrBitrate "Use generic-lens or generic-optics with 'minAbrBitrate' instead"  #-}
...
instance Core.FromJSON AutomatedAbrSettings where
        parseJSON
          = Core.withObject "AutomatedAbrSettings" Core.$
              \ x ->
                AutomatedAbrSettings' Core.<$>
                  (x Core..:? "maxAbrBitrate") Core.<*> x Core..:? "maxRenditions"
