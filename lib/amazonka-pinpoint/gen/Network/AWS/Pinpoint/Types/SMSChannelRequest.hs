...
{-# DEPRECATED sSenderId "Use generic-lens or generic-optics with 'senderId' instead." #-}
...
{-# DEPRECATED sShortCode "Use generic-lens or generic-optics with 'shortCode' instead." #-}
