...
{-# INLINEABLE csParentShards #-}
{-# DEPRECATED parentShards "Use generic-lens or generic-optics with 'parentShards' instead"  #-}
        ...
        parseJSON
          = Core.withObject "ChildShard" Core.$
              \ x ->
                ChildShard' Core.<$>
                  (x Core..: "ShardId") Core.<*>
                    x Core..:? "ParentShards" Core..!= Core.mempty
