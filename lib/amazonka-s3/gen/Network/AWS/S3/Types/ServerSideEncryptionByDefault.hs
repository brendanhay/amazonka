...
mkServerSideEncryptionByDefault
    :: Types.ServerSideEncryption -- ^ 'sSEAlgorithm'
    -> ServerSideEncryptionByDefault
...
{-# INLINEABLE ssebdSSEAlgorithm #-}
{-# DEPRECATED sSEAlgorithm "Use generic-lens or generic-optics with 'sSEAlgorithm' instead"  #-}
...
{-# INLINEABLE ssebdKMSMasterKeyID #-}
...
instance Core.ToXML ServerSideEncryptionByDefault where
        toXML ServerSideEncryptionByDefault{..}
          = Core.toXMLElement "SSEAlgorithm" sSEAlgorithm Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "KMSMasterKeyID")
                kMSMasterKeyID

instance Core.FromXML ServerSideEncryptionByDefault where
        parseXML x
          = ServerSideEncryptionByDefault' Core.<$>
              (x Core..@ "SSEAlgorithm") Core.<*> x Core..@? "KMSMasterKeyID"
