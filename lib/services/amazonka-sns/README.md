...
`1.6.1` - Derived from API version @2010-03-31@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.SNS](http://hackage.haskell.org/package/amazonka-sns/docs/Network-AWS-SNS.html)
