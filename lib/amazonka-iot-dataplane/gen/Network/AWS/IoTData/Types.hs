...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "IoTData",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "data.iot",
                 Core._svcVersion = "2015-05-28", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _RequestEntityTooLargeException #-}
...
{-# INLINEABLE _MethodNotAllowedException #-}
...
{-# INLINEABLE _UnsupportedDocumentEncodingException #-}
