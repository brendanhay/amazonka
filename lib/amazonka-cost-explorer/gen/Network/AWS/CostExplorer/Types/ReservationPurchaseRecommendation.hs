...
mkReservationPurchaseRecommendation
    :: ReservationPurchaseRecommendation
mkReservationPurchaseRecommendation
  = ReservationPurchaseRecommendation'{accountScope = Core.Nothing,
...
{-# INLINEABLE rprLookbackPeriodInDays #-}
...
{-# INLINEABLE rprRecommendationDetails #-}
{-# DEPRECATED recommendationDetails "Use generic-lens or generic-optics with 'recommendationDetails' instead"  #-}
...
{-# INLINEABLE rprRecommendationSummary #-}
{-# DEPRECATED recommendationSummary "Use generic-lens or generic-optics with 'recommendationSummary' instead"  #-}
...
{-# INLINEABLE rprServiceSpecification #-}
...
instance Core.FromJSON ReservationPurchaseRecommendation where
        parseJSON
          = Core.withObject "ReservationPurchaseRecommendation" Core.$
              \ x ->
                ReservationPurchaseRecommendation' Core.<$>
