...
listPermissions
    :: Text -- ^ 'lpCertificateAuthorityARN'
    -> ListPermissions
...
instance Hashable ListPermissions where

instance NFData ListPermissions where
...
instance NFData ListPermissionsResponse where
