...
describeExclusions
    :: NonEmpty Text -- ^ 'deExclusionARNs'
    -> DescribeExclusions
describeExclusions pExclusionARNs_ =
  DescribeExclusions'
    {_deLocale = Nothing, _deExclusionARNs = _List1 # pExclusionARNs_}
...
instance Hashable DescribeExclusions where

instance NFData DescribeExclusions where
...
data DescribeExclusionsResponse = DescribeExclusionsResponse'
  ...
  , _dersExclusions     :: !(Map Text Exclusion)
  , _dersFailedItems    :: !(Map Text FailedItemDetails)
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
instance NFData DescribeExclusionsResponse where
