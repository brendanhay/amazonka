...
instance AWSPager DescribeEffectiveInstanceAssociations where
  page rq rs
    | stop (rs ^. deiarsNextToken) = Nothing
    | stop (rs ^. deiarsAssociations) = Nothing
    | otherwise = Just $ rq & deiaNextToken .~ rs ^. deiarsNextToken

instance AWSRequest DescribeEffectiveInstanceAssociations where
  type
...
instance Hashable DescribeEffectiveInstanceAssociations

instance NFData DescribeEffectiveInstanceAssociations

instance ToHeaders DescribeEffectiveInstanceAssociations where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("AmazonSSM.DescribeEffectiveInstanceAssociations" :: ByteString),
...
instance ToQuery DescribeEffectiveInstanceAssociations where
...
instance NFData DescribeEffectiveInstanceAssociationsResponse
