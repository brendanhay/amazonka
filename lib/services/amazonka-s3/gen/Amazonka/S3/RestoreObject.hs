...
--         required. For all but the largest archived objects (250 MB+),
--         data accessed using Expedited retrievals is typically made
--         available within 1–5 minutes. Provisioned capacity ensures that
--         retrieval capacity for Expedited retrievals is available when
--         you need it. Expedited retrievals and provisioned capacity are
--         not available for objects stored in the S3 Glacier Deep Archive
--         storage class or S3 Intelligent-Tiering Deep Archive tier.
--
--     -   @Standard@ - Standard retrievals allow you to access any of your
--         archived objects within several hours. This is the default
--         option for retrieval requests that do not specify the retrieval
--         option. Standard retrievals typically finish within 3–5 hours
--         for objects stored in the S3 Glacier Flexible Retrieval Flexible
--         Retrieval storage class or S3 Intelligent-Tiering Archive tier.
--         They typically finish within 12 hours for objects stored in the
--         S3 Glacier Deep Archive storage class or S3 Intelligent-Tiering
--         Deep Archive tier. Standard retrievals are free for objects
--         stored in S3 Intelligent-Tiering.
--
--     -   @Bulk@ - Bulk retrievals free for objects stored in the S3
--         Glacier Flexible Retrieval and S3 Intelligent-Tiering storage
--         classes, enabling you to retrieve large amounts, even petabytes,
--         of data at no cost. Bulk retrievals typically finish within 5–12
--         hours for objects stored in the S3 Glacier Flexible Retrieval
--         Flexible Retrieval storage class or S3 Intelligent-Tiering
--         Archive tier. Bulk retrievals are also the lowest-cost retrieval
--         option when restoring objects from S3 Glacier Deep Archive. They
