...
mkCompareFaces
    :: Types.Image -- ^ 'sourceImage'
    -> Types.Image -- ^ 'targetImage'
    -> CompareFaces
mkCompareFaces sourceImage targetImage
  = CompareFaces'{sourceImage, targetImage,
                  qualityFilter = Core.Nothing, similarityThreshold = Core.Nothing}
...
{-# INLINEABLE cfSourceImage #-}
{-# DEPRECATED sourceImage "Use generic-lens or generic-optics with 'sourceImage' instead"  #-}
...
{-# INLINEABLE cfTargetImage #-}
{-# DEPRECATED targetImage "Use generic-lens or generic-optics with 'targetImage' instead"  #-}
...
{-# INLINEABLE cfSimilarityThreshold #-}
{-# DEPRECATED similarityThreshold "Use generic-lens or generic-optics with 'similarityThreshold' instead"  #-}
...
instance Core.AWSRequest CompareFaces where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CompareFacesResponse' Core.<$>
                   (x Core..:? "FaceMatches") Core.<*> x Core..:? "SourceImageFace"
...
{-# INLINEABLE cfrrsSourceImageFace #-}
{-# DEPRECATED sourceImageFace "Use generic-lens or generic-optics with 'sourceImageFace' instead"  #-}
...
{-# INLINEABLE cfrrsSourceImageOrientationCorrection #-}
{-# DEPRECATED sourceImageOrientationCorrection "Use generic-lens or generic-optics with 'sourceImageOrientationCorrection' instead"  #-}
...
{-# INLINEABLE cfrrsTargetImageOrientationCorrection #-}
{-# DEPRECATED targetImageOrientationCorrection "Use generic-lens or generic-optics with 'targetImageOrientationCorrection' instead"  #-}
...
{-# INLINEABLE cfrrsUnmatchedFaces #-}
{-# DEPRECATED unmatchedFaces "Use generic-lens or generic-optics with 'unmatchedFaces' instead"  #-}
