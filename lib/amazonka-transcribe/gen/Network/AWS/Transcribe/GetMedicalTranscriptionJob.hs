...
{-# INLINEABLE gmtjMedicalTranscriptionJobName #-}
...
instance Core.ToHeaders GetMedicalTranscriptionJob where
        toHeaders GetMedicalTranscriptionJob{..}
          = Core.pure
...
instance Core.AWSRequest GetMedicalTranscriptionJob where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetMedicalTranscriptionJobResponse' Core.<$>
...
{-# INLINEABLE gmtjrrsMedicalTranscriptionJob #-}
...
{-# INLINEABLE gmtjrrsResponseStatus #-}
