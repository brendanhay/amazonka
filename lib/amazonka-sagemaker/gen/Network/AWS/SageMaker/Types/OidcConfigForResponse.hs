...
mkOidcConfigForResponse
    :: OidcConfigForResponse
mkOidcConfigForResponse
  = OidcConfigForResponse'{authorizationEndpoint = Core.Nothing,
                           clientId = Core.Nothing, issuer = Core.Nothing,
                           jwksUri = Core.Nothing, logoutEndpoint = Core.Nothing,
                           tokenEndpoint = Core.Nothing, userInfoEndpoint = Core.Nothing}
...
{-# INLINEABLE ocfrAuthorizationEndpoint #-}
...
{-# INLINEABLE ocfrUserInfoEndpoint #-}
...
instance Core.FromJSON OidcConfigForResponse where
        parseJSON
          = Core.withObject "OidcConfigForResponse" Core.$
              \ x ->
                OidcConfigForResponse' Core.<$>
                  (x Core..:? "AuthorizationEndpoint") Core.<*> x Core..:? "ClientId"
                    Core.<*> x Core..:? "Issuer"
                    Core.<*> x Core..:? "JwksUri"
