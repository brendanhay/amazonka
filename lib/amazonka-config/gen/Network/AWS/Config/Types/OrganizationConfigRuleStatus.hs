...
mkOrganizationConfigRuleStatus
    ...
    -> Types.OrganizationRuleStatus -- ^ 'organizationRuleStatus'
    -> OrganizationConfigRuleStatus
mkOrganizationConfigRuleStatus organizationConfigRuleName
  organizationRuleStatus
  = OrganizationConfigRuleStatus'{organizationConfigRuleName,
                                  organizationRuleStatus, errorCode = Core.Nothing,
...
{-# INLINEABLE ocrsOrganizationConfigRuleName #-}
...
{-# INLINEABLE ocrsOrganizationRuleStatus #-}
{-# DEPRECATED organizationRuleStatus "Use generic-lens or generic-optics with 'organizationRuleStatus' instead"  #-}

-- | An error code that is returned when organization config rule creation or deletion has failed.
--
-- /Note:/ Consider using 'errorCode' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
ocrsErrorCode :: Lens.Lens' OrganizationConfigRuleStatus (Core.Maybe Core.Text)
ocrsErrorCode = Lens.field @"errorCode"
{-# INLINEABLE ocrsErrorCode #-}
{-# DEPRECATED errorCode "Use generic-lens or generic-optics with 'errorCode' instead"  #-}

-- | An error message indicating that organization config rule creation or deletion failed due to an error.
--
-- /Note:/ Consider using 'errorMessage' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
ocrsErrorMessage :: Lens.Lens' OrganizationConfigRuleStatus (Core.Maybe Core.Text)
ocrsErrorMessage = Lens.field @"errorMessage"
{-# INLINEABLE ocrsErrorMessage #-}
...
instance Core.FromJSON OrganizationConfigRuleStatus where
        parseJSON
          = Core.withObject "OrganizationConfigRuleStatus" Core.$
              \ x ->
                OrganizationConfigRuleStatus' Core.<$>
                  (x Core..: "OrganizationConfigRuleName") Core.<*>
                    x Core..: "OrganizationRuleStatus"
