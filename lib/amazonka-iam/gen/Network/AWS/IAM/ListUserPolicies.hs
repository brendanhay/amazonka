...
mkListUserPolicies userName
  = ListUserPolicies'{userName, marker = Core.Nothing,
...
instance Core.AWSRequest ListUserPolicies where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListUserPoliciesResult"
              (\ s h x ->
                 ListUserPoliciesResponse' Core.<$>
...
mkListUserPoliciesResponse responseStatus
  = ListUserPoliciesResponse'{policyNames = Core.mempty,
