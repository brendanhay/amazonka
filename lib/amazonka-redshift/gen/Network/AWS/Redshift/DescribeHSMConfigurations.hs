...
dhsmcTagValues :: Lens.Lens' DescribeHSMConfigurations (Lude.Maybe [Lude.Text])
dhsmcTagValues = Lens.lens (tagValues :: DescribeHSMConfigurations -> Lude.Maybe [Lude.Text]) (\s a -> s {tagValues = a} :: DescribeHSMConfigurations)
{-# DEPRECATED dhsmcTagValues "Use generic-lens or generic-optics with 'tagValues' instead." #-}
...
dhsmcHSMConfigurationIdentifier :: Lens.Lens' DescribeHSMConfigurations (Lude.Maybe Lude.Text)
dhsmcHSMConfigurationIdentifier = Lens.lens (hsmConfigurationIdentifier :: DescribeHSMConfigurations -> Lude.Maybe Lude.Text) (\s a -> s {hsmConfigurationIdentifier = a} :: DescribeHSMConfigurations)
...
dhsmcTagKeys :: Lens.Lens' DescribeHSMConfigurations (Lude.Maybe [Lude.Text])
dhsmcTagKeys = Lens.lens (tagKeys :: DescribeHSMConfigurations -> Lude.Maybe [Lude.Text]) (\s a -> s {tagKeys = a} :: DescribeHSMConfigurations)
{-# DEPRECATED dhsmcTagKeys "Use generic-lens or generic-optics with 'tagKeys' instead." #-}

-- | An optional parameter that specifies the starting point to return a set of response records. When the results of a 'DescribeHsmConfigurations' request exceed the value specified in @MaxRecords@ , AWS returns a value in the @Marker@ field of the response. You can retrieve the next set of response records by providing the returned marker value in the @Marker@ parameter and retrying the request.
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dhsmcMarker :: Lens.Lens' DescribeHSMConfigurations (Lude.Maybe Lude.Text)
dhsmcMarker = Lens.lens (marker :: DescribeHSMConfigurations -> Lude.Maybe Lude.Text) (\s a -> s {marker = a} :: DescribeHSMConfigurations)
{-# DEPRECATED dhsmcMarker "Use generic-lens or generic-optics with 'marker' instead." #-}
...
dhsmcMaxRecords :: Lens.Lens' DescribeHSMConfigurations (Lude.Maybe Lude.Int)
dhsmcMaxRecords = Lens.lens (maxRecords :: DescribeHSMConfigurations -> Lude.Maybe Lude.Int) (\s a -> s {maxRecords = a} :: DescribeHSMConfigurations)
{-# DEPRECATED dhsmcMaxRecords "Use generic-lens or generic-optics with 'maxRecords' instead." #-}
...
instance Page.AWSPager DescribeHSMConfigurations where
  page rq rs
    ...
    | Lude.otherwise =
      Lude.Just Lude.$
        rq
          Lude.& dhsmcMarker Lens..~ rs Lens.^. dhcrsMarker
