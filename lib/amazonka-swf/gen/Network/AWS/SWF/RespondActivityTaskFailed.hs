...
mkRespondActivityTaskFailed taskToken
  = RespondActivityTaskFailed'{taskToken, details = Core.Nothing,
                               reason = Core.Nothing}
...
instance Core.ToHeaders RespondActivityTaskFailed where
        toHeaders RespondActivityTaskFailed{..}
          = Core.pure
...
instance Core.AWSRequest RespondActivityTaskFailed where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveNull RespondActivityTaskFailedResponse'
