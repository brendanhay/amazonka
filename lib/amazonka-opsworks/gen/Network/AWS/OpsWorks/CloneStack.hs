...
mkCloneStack
    :: Core.Text -- ^ 'sourceStackId'
    -> Core.Text -- ^ 'serviceRoleArn'
    -> CloneStack
mkCloneStack sourceStackId serviceRoleArn
  = CloneStack'{sourceStackId, serviceRoleArn,
                agentVersion = Core.Nothing, attributes = Core.Nothing,
                chefConfiguration = Core.Nothing, cloneAppIds = Core.Nothing,
                ...
                region = Core.Nothing, useCustomCookbooks = Core.Nothing,
...
cSourceStackId :: Lens.Lens' CloneStack Core.Text
cSourceStackId = Lens.field @"sourceStackId"
{-# INLINEABLE cSourceStackId #-}
{-# DEPRECATED sourceStackId "Use generic-lens or generic-optics with 'sourceStackId' instead"  #-}
...
cServiceRoleArn :: Lens.Lens' CloneStack Core.Text
cServiceRoleArn = Lens.field @"serviceRoleArn"
{-# INLINEABLE cServiceRoleArn #-}
...
cAgentVersion :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
cAgentVersion = Lens.field @"agentVersion"
{-# INLINEABLE cAgentVersion #-}
...
cCloneAppIds :: Lens.Lens' CloneStack (Core.Maybe [Core.Text])
cCloneAppIds = Lens.field @"cloneAppIds"
{-# INLINEABLE cCloneAppIds #-}
{-# DEPRECATED cloneAppIds "Use generic-lens or generic-optics with 'cloneAppIds' instead"  #-}
...
{-# INLINEABLE cClonePermissions #-}
{-# DEPRECATED clonePermissions "Use generic-lens or generic-optics with 'clonePermissions' instead"  #-}
...
{-# INLINEABLE cConfigurationManager #-}
...
{-# INLINEABLE cCustomCookbooksSource #-}
...
cCustomJson :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
cCustomJson = Lens.field @"customJson"
{-# INLINEABLE cCustomJson #-}
...
cDefaultAvailabilityZone :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
cDefaultAvailabilityZone = Lens.field @"defaultAvailabilityZone"
{-# INLINEABLE cDefaultAvailabilityZone #-}
...
cDefaultInstanceProfileArn :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
cDefaultInstanceProfileArn = Lens.field @"defaultInstanceProfileArn"
{-# INLINEABLE cDefaultInstanceProfileArn #-}
...
cDefaultOs :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
cDefaultOs = Lens.field @"defaultOs"
{-# INLINEABLE cDefaultOs #-}
...
{-# INLINEABLE cDefaultRootDeviceType #-}
...
cDefaultSshKeyName :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
cDefaultSshKeyName = Lens.field @"defaultSshKeyName"
{-# INLINEABLE cDefaultSshKeyName #-}
...
cDefaultSubnetId :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
cDefaultSubnetId = Lens.field @"defaultSubnetId"
{-# INLINEABLE cDefaultSubnetId #-}
...
cRegion :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
...
{-# INLINEABLE cUseCustomCookbooks #-}
...
{-# INLINEABLE cUseOpsworksSecurityGroups #-}
...
cVpcId :: Lens.Lens' CloneStack (Core.Maybe Core.Text)
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("SourceStackId" Core..= sourceStackId),
                  ...
                  ("Name" Core..=) Core.<$> name, ("Region" Core..=) Core.<$> region,
...
crsStackId :: Lens.Lens' CloneStackResponse (Core.Maybe Core.Text)
crsStackId = Lens.field @"stackId"
{-# INLINEABLE crsStackId #-}
