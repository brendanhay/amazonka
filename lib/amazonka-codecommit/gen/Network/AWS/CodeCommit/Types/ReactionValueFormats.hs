...
mkReactionValueFormats
    :: ReactionValueFormats
mkReactionValueFormats
  = ReactionValueFormats'{emoji = Core.Nothing,
                          shortCode = Core.Nothing, unicode = Core.Nothing}
...
{-# INLINEABLE rvfEmoji #-}
{-# DEPRECATED emoji "Use generic-lens or generic-optics with 'emoji' instead"  #-}
...
{-# INLINEABLE rvfUnicode #-}
{-# DEPRECATED unicode "Use generic-lens or generic-optics with 'unicode' instead"  #-}

instance Core.FromJSON ReactionValueFormats where
        parseJSON
          = Core.withObject "ReactionValueFormats" Core.$
              \ x ->
                ReactionValueFormats' Core.<$>
                  (x Core..:? "emoji") Core.<*> x Core..:? "shortCode" Core.<*>
                    x Core..:? "unicode"
