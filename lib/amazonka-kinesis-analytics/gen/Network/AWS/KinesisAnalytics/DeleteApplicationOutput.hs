...
mkDeleteApplicationOutput
    ...
    -> Types.OutputId -- ^ 'outputId'
    -> DeleteApplicationOutput
mkDeleteApplicationOutput applicationName
  currentApplicationVersionId outputId
  = DeleteApplicationOutput'{applicationName,
                             currentApplicationVersionId, outputId}
...
{-# INLINEABLE daoCurrentApplicationVersionId #-}
...
instance Core.AWSRequest DeleteApplicationOutput where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 DeleteApplicationOutputResponse' Core.<$>
