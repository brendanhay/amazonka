...
mkNoiseReducerTemporalFilterSettings
    :: NoiseReducerTemporalFilterSettings
mkNoiseReducerTemporalFilterSettings
  = NoiseReducerTemporalFilterSettings'{aggressiveMode =
                                          Core.Nothing,
                                        postTemporalSharpening = Core.Nothing, speed = Core.Nothing,
...
{-# INLINEABLE nrtfsAggressiveMode #-}
{-# DEPRECATED aggressiveMode "Use generic-lens or generic-optics with 'aggressiveMode' instead"  #-}
...
{-# INLINEABLE nrtfsPostTemporalSharpening #-}
{-# DEPRECATED postTemporalSharpening "Use generic-lens or generic-optics with 'postTemporalSharpening' instead"  #-}
...
{-# INLINEABLE nrtfsSpeed #-}
{-# DEPRECATED speed "Use generic-lens or generic-optics with 'speed' instead"  #-}
...
instance Core.FromJSON NoiseReducerTemporalFilterSettings where
        parseJSON
          = Core.withObject "NoiseReducerTemporalFilterSettings" Core.$
              \ x ->
                NoiseReducerTemporalFilterSettings' Core.<$>
                  (x Core..:? "aggressiveMode") Core.<*>
                    x Core..:? "postTemporalSharpening"
                    Core.<*> x Core..:? "speed"
