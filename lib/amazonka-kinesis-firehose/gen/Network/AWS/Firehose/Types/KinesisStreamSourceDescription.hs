...
mkKinesisStreamSourceDescription
  = KinesisStreamSourceDescription'{deliveryStartTimestamp =
                                      Core.Nothing,
                                    kinesisStreamARN = Core.Nothing, roleARN = Core.Nothing}
...
{-# INLINEABLE kssdDeliveryStartTimestamp #-}
{-# DEPRECATED deliveryStartTimestamp "Use generic-lens or generic-optics with 'deliveryStartTimestamp' instead"  #-}
...
{-# INLINEABLE kssdKinesisStreamARN #-}
...
instance Core.FromJSON KinesisStreamSourceDescription where
        parseJSON
          = Core.withObject "KinesisStreamSourceDescription" Core.$
              \ x ->
                KinesisStreamSourceDescription' Core.<$>
                  (x Core..:? "DeliveryStartTimestamp") Core.<*>
                    x Core..:? "KinesisStreamARN"
                    Core.<*> x Core..:? "RoleARN"
