...
import Network.AWS.DeviceFarm.Types.Locale
...
import Network.AWS.DeviceFarm.Types.String
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "DeviceFarm",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "devicefarm",
      Core._svcVersion = "2015-06-23",
