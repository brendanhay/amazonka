...
mkChildWorkflowExecutionCanceledEventAttributes
    ...
    -> ChildWorkflowExecutionCanceledEventAttributes
mkChildWorkflowExecutionCanceledEventAttributes workflowExecution
...
{-# INLINEABLE cweceaWorkflowExecution #-}
...
{-# INLINEABLE cweceaInitiatedEventId #-}
...
{-# INLINEABLE cweceaStartedEventId #-}
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ChildWorkflowExecutionCanceledEventAttributes"
              Core.$
              \ x ->
                ChildWorkflowExecutionCanceledEventAttributes' Core.<$>
