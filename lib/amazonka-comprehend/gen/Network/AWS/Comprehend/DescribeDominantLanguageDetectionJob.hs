...
{-# INLINEABLE ddldjJobId #-}
{-# DEPRECATED jobId "Use generic-lens or generic-optics with 'jobId' instead"  #-}

instance Core.ToQuery DescribeDominantLanguageDetectionJob where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeDominantLanguageDetectionJob where
        toHeaders DescribeDominantLanguageDetectionJob{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeDominantLanguageDetectionJob where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeDominantLanguageDetectionJobResponse' Core.<$>
                   (x Core..:? "DominantLanguageDetectionJobProperties") Core.<*>
...
{-# INLINEABLE ddldjrrsDominantLanguageDetectionJobProperties #-}
{-# DEPRECATED dominantLanguageDetectionJobProperties "Use generic-lens or generic-optics with 'dominantLanguageDetectionJobProperties' instead"  #-}
...
{-# INLINEABLE ddldjrrsResponseStatus #-}
