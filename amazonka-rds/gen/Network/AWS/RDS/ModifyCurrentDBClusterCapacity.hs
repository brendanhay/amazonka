...
data ModifyCurrentDBClusterCapacity = ModifyCurrentDBClusterCapacity'
  { _mcdccTimeoutAction        :: !(Maybe Text)
  , _mcdccCapacity             :: !(Maybe Int)
  , _mcdccSecondsBeforeTimeout :: !(Maybe Int)
  , _mcdccDBClusterIdentifier  :: !Text
...
--
-- * 'mcdccCapacity' - The DB cluster capacity. Constraints:     * Value must be @2@ , @4@ , @8@ , @16@ , @32@ , @64@ , @128@ , or @256@ .
--
...
--
-- * 'mcdccDBClusterIdentifier' - The DB cluster identifier for the cluster being modified. This parameter is not case-sensitive. Constraints:     * Must match the identifier of an existing DB cluster.
modifyCurrentDBClusterCapacity
    :: Text -- ^ 'mcdccDBClusterIdentifier'
    -> ModifyCurrentDBClusterCapacity
...
instance AWSRequest ModifyCurrentDBClusterCapacity
         where
...
instance NFData ModifyCurrentDBClusterCapacity where

instance ToHeaders ModifyCurrentDBClusterCapacity
         where
...
data ModifyCurrentDBClusterCapacityResponse = ModifyCurrentDBClusterCapacityResponse'
  { _mcdccrsDBClusterIdentifier  :: !(Maybe Text)
  , _mcdccrsTimeoutAction        :: !(Maybe Text)
  , _mcdccrsCurrentCapacity      :: !(Maybe Int)
  , _mcdccrsPendingCapacity      :: !(Maybe Int)
  , _mcdccrsSecondsBeforeTimeout :: !(Maybe Int)
  , _mcdccrsResponseStatus       :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
modifyCurrentDBClusterCapacityResponse
    :: Int -- ^ 'mcdccrsResponseStatus'
    -> ModifyCurrentDBClusterCapacityResponse
modifyCurrentDBClusterCapacityResponse pResponseStatus_ =
  ModifyCurrentDBClusterCapacityResponse'
    { _mcdccrsDBClusterIdentifier = Nothing
