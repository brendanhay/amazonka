...
mkListAWSServiceAccessForOrganization
    :: ListAWSServiceAccessForOrganization
mkListAWSServiceAccessForOrganization
  = ListAWSServiceAccessForOrganization'{maxResults = Core.Nothing,
...
{-# INLINEABLE lawssafoNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery ListAWSServiceAccessForOrganization where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders ListAWSServiceAccessForOrganization where
        toHeaders ListAWSServiceAccessForOrganization{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest ListAWSServiceAccessForOrganization where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListAWSServiceAccessForOrganizationResponse' Core.<$>
                   (x Core..:? "EnabledServicePrincipals") Core.<*>
                     x Core..:? "NextToken"
...
instance Pager.AWSPager ListAWSServiceAccessForOrganization where
        page rq rs
          ...
          | Pager.stop
              (rs Lens.^?
                 Lens.field @"enabledServicePrincipals" Core.. Lens._Just)
            = Core.Nothing
          | Core.otherwise =
            Core.Just
              (rq Core.&
...
{-# INLINEABLE lawssaforrsEnabledServicePrincipals #-}
{-# DEPRECATED enabledServicePrincipals "Use generic-lens or generic-optics with 'enabledServicePrincipals' instead"  #-}
...
{-# INLINEABLE lawssaforrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE lawssaforrsResponseStatus #-}
