...
module Network.AWS.SWF.V2012_01_25.RecordActivityTaskHeartbeat where
...
recordActivityTaskHeartbeat :: Text -- ^ '_rathiTaskToken'
...
makeLenses ''RecordActivityTaskHeartbeat
...
makeLenses ''RecordActivityTaskHeartbeatResponse
