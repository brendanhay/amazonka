...
mkBooleanColumnStatisticsData
    :: Core.Natural -- ^ 'numberOfTrues'
    -> Core.Natural -- ^ 'numberOfFalses'
    -> Core.Natural -- ^ 'numberOfNulls'
    -> BooleanColumnStatisticsData
mkBooleanColumnStatisticsData numberOfTrues numberOfFalses
  numberOfNulls
  = BooleanColumnStatisticsData'{numberOfTrues, numberOfFalses,
                                 numberOfNulls}
...
{-# INLINEABLE bNumberOfTrues #-}
{-# DEPRECATED numberOfTrues "Use generic-lens or generic-optics with 'numberOfTrues' instead"  #-}
...
{-# INLINEABLE bNumberOfFalses #-}
{-# DEPRECATED numberOfFalses "Use generic-lens or generic-optics with 'numberOfFalses' instead"  #-}
          ...
          = Core.withObject "BooleanColumnStatisticsData" Core.$
              \ x ->
                BooleanColumnStatisticsData' Core.<$>
                  (x Core..: "NumberOfTrues") Core.<*> x Core..: "NumberOfFalses"
