...
dsgFilters :: Lens.Lens' DescribeSecurityGroups (Lude.Maybe [Filter])
dsgFilters = Lens.lens (filters :: DescribeSecurityGroups -> Lude.Maybe [Filter]) (\s a -> s {filters = a} :: DescribeSecurityGroups)
{-# DEPRECATED dsgFilters "Use generic-lens or generic-optics with 'filters' instead." #-}
...
dsgGroupNames :: Lens.Lens' DescribeSecurityGroups (Lude.Maybe [Lude.Text])
dsgGroupNames = Lens.lens (groupNames :: DescribeSecurityGroups -> Lude.Maybe [Lude.Text]) (\s a -> s {groupNames = a} :: DescribeSecurityGroups)
{-# DEPRECATED dsgGroupNames "Use generic-lens or generic-optics with 'groupNames' instead." #-}
...
dsgGroupIds :: Lens.Lens' DescribeSecurityGroups (Lude.Maybe [Lude.Text])
dsgGroupIds = Lens.lens (groupIds :: DescribeSecurityGroups -> Lude.Maybe [Lude.Text]) (\s a -> s {groupIds = a} :: DescribeSecurityGroups)
{-# DEPRECATED dsgGroupIds "Use generic-lens or generic-optics with 'groupIds' instead." #-}

-- | The token to request the next page of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsgNextToken :: Lens.Lens' DescribeSecurityGroups (Lude.Maybe Lude.Text)
dsgNextToken = Lens.lens (nextToken :: DescribeSecurityGroups -> Lude.Maybe Lude.Text) (\s a -> s {nextToken = a} :: DescribeSecurityGroups)
{-# DEPRECATED dsgNextToken "Use generic-lens or generic-optics with 'nextToken' instead." #-}

-- | Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is @DryRunOperation@ . Otherwise, it is @UnauthorizedOperation@ .
--
-- /Note:/ Consider using 'dryRun' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsgDryRun :: Lens.Lens' DescribeSecurityGroups (Lude.Maybe Lude.Bool)
dsgDryRun = Lens.lens (dryRun :: DescribeSecurityGroups -> Lude.Maybe Lude.Bool) (\s a -> s {dryRun = a} :: DescribeSecurityGroups)
{-# DEPRECATED dsgDryRun "Use generic-lens or generic-optics with 'dryRun' instead." #-}

-- | The maximum number of results to return in a single call. To retrieve the remaining results, make another request with the returned @NextToken@ value. This value can be between 5 and 1000. If this parameter is not specified, then all results are returned.
--
-- /Note:/ Consider using 'maxResults' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsgMaxResults :: Lens.Lens' DescribeSecurityGroups (Lude.Maybe Lude.Natural)
dsgMaxResults = Lens.lens (maxResults :: DescribeSecurityGroups -> Lude.Maybe Lude.Natural) (\s a -> s {maxResults = a} :: DescribeSecurityGroups)
...
instance Page.AWSPager DescribeSecurityGroups where
  page rq rs
    ...
    | Lude.otherwise =
      Lude.Just Lude.$
        rq
          Lude.& dsgNextToken Lens..~ rs Lens.^. dsgrsNextToken
