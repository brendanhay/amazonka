...
mkQualificationRequirement
    :: Core.Text -- ^ 'qualificationTypeId'
    -> Types.Comparator -- ^ 'comparator'
    -> QualificationRequirement
mkQualificationRequirement qualificationTypeId comparator
  = QualificationRequirement'{qualificationTypeId, comparator,
                              actionsGuarded = Core.Nothing, integerValues = Core.Nothing,
                              localeValues = Core.Nothing, requiredToPreview = Core.Nothing}
...
qrQualificationTypeId :: Lens.Lens' QualificationRequirement Core.Text
qrQualificationTypeId = Lens.field @"qualificationTypeId"
{-# INLINEABLE qrQualificationTypeId #-}
...
{-# INLINEABLE qrActionsGuarded #-}
{-# DEPRECATED actionsGuarded "Use generic-lens or generic-optics with 'actionsGuarded' instead"  #-}
...
{-# INLINEABLE qrIntegerValues #-}
{-# DEPRECATED integerValues "Use generic-lens or generic-optics with 'integerValues' instead"  #-}
...
{-# INLINEABLE qrLocaleValues #-}
{-# DEPRECATED localeValues "Use generic-lens or generic-optics with 'localeValues' instead"  #-}
...
{-# INLINEABLE qrRequiredToPreview #-}
{-# DEPRECATED requiredToPreview "Use generic-lens or generic-optics with 'requiredToPreview' instead"  #-}
...
instance Core.FromJSON QualificationRequirement where
        parseJSON
          = Core.withObject "QualificationRequirement" Core.$
              \ x ->
                QualificationRequirement' Core.<$>
                  (x Core..: "QualificationTypeId") Core.<*> x Core..: "Comparator"
