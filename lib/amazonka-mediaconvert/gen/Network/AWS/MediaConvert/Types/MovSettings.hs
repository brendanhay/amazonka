...
mkMovSettings
    :: MovSettings
mkMovSettings
  = MovSettings'{clapAtom = Core.Nothing, cslgAtom = Core.Nothing,
                 mpeg2FourCCControl = Core.Nothing, paddingControl = Core.Nothing,
...
{-# INLINEABLE msClapAtom #-}
{-# DEPRECATED clapAtom "Use generic-lens or generic-optics with 'clapAtom' instead"  #-}
...
{-# INLINEABLE msMpeg2FourCCControl #-}
{-# DEPRECATED mpeg2FourCCControl "Use generic-lens or generic-optics with 'mpeg2FourCCControl' instead"  #-}
...
{-# INLINEABLE msPaddingControl #-}
{-# DEPRECATED paddingControl "Use generic-lens or generic-optics with 'paddingControl' instead"  #-}
...
instance Core.FromJSON MovSettings where
        parseJSON
          = Core.withObject "MovSettings" Core.$
              \ x ->
                MovSettings' Core.<$>
                  (x Core..:? "clapAtom") Core.<*> x Core..:? "cslgAtom" Core.<*>
                    x Core..:? "mpeg2FourCCControl"
