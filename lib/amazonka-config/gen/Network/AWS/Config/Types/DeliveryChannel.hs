...
mkDeliveryChannel
    :: DeliveryChannel
mkDeliveryChannel
  = DeliveryChannel'{configSnapshotDeliveryProperties = Core.Nothing,
                     name = Core.Nothing, s3BucketName = Core.Nothing,
                     s3KeyPrefix = Core.Nothing, snsTopicARN = Core.Nothing}
...
{-# INLINEABLE dcConfigSnapshotDeliveryProperties #-}
{-# DEPRECATED configSnapshotDeliveryProperties "Use generic-lens or generic-optics with 'configSnapshotDeliveryProperties' instead"  #-}
...
dcS3BucketName :: Lens.Lens' DeliveryChannel (Core.Maybe Core.Text)
dcS3BucketName = Lens.field @"s3BucketName"
{-# INLINEABLE dcS3BucketName #-}
...
dcS3KeyPrefix :: Lens.Lens' DeliveryChannel (Core.Maybe Core.Text)
dcS3KeyPrefix = Lens.field @"s3KeyPrefix"
{-# INLINEABLE dcS3KeyPrefix #-}
...
dcSnsTopicARN :: Lens.Lens' DeliveryChannel (Core.Maybe Core.Text)
dcSnsTopicARN = Lens.field @"snsTopicARN"
{-# INLINEABLE dcSnsTopicARN #-}
...
instance Core.FromJSON DeliveryChannel where
        toJSON DeliveryChannel{..}
          = Core.object
              (Core.catMaybes
                 [("configSnapshotDeliveryProperties" Core..=) Core.<$>
...
instance Core.FromJSON DeliveryChannel where
        parseJSON
          = Core.withObject "DeliveryChannel" Core.$
              \ x ->
                DeliveryChannel' Core.<$>
                  (x Core..:? "configSnapshotDeliveryProperties") Core.<*>
                    x Core..:? "name"
