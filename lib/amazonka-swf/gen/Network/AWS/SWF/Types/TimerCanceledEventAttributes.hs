...
mkTimerCanceledEventAttributes
    ...
    -> TimerCanceledEventAttributes
mkTimerCanceledEventAttributes timerId startedEventId
  decisionTaskCompletedEventId
  = TimerCanceledEventAttributes'{timerId, startedEventId,
                                  decisionTaskCompletedEventId}
...
{-# INLINEABLE tceaDecisionTaskCompletedEventId #-}
...
instance Core.FromJSON TimerCanceledEventAttributes where
        parseJSON
          = Core.withObject "TimerCanceledEventAttributes" Core.$
              \ x ->
                TimerCanceledEventAttributes' Core.<$>
                  (x Core..: "timerId") Core.<*> x Core..: "startedEventId" Core.<*>
