...
mkDeviceFilter
    :: DeviceFilter
mkDeviceFilter
  = DeviceFilter'{attribute = Core.Nothing, operator = Core.Nothing,
                  values = Core.Nothing}
...
dfValues :: Lens.Lens' DeviceFilter (Core.Maybe [Core.Text])
