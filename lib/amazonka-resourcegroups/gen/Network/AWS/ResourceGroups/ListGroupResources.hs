...
mkListGroupResources
    :: ListGroupResources
mkListGroupResources
  = ListGroupResources'{filters = Core.Nothing, group = Core.Nothing,
...
instance Core.AWSRequest ListGroupResources where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/list-group-resources",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListGroupResourcesResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "QueryErrors" Core.<*>
                     x Core..:? "ResourceIdentifiers"
...
mkListGroupResourcesResponse responseStatus
  = ListGroupResourcesResponse'{nextToken = Core.Nothing,
                                queryErrors = Core.Nothing, resourceIdentifiers = Core.Nothing,
                                responseStatus}
...
{-# INLINEABLE lgrrrsQueryErrors #-}
{-# DEPRECATED queryErrors "Use generic-lens or generic-optics with 'queryErrors' instead"  #-}
...
{-# INLINEABLE lgrrrsResourceIdentifiers #-}
...
{-# INLINEABLE lgrrrsResponseStatus #-}
