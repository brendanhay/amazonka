...
mkAlarmConfiguration
    :: AlarmConfiguration
mkAlarmConfiguration
  = AlarmConfiguration'{alarms = Core.Nothing,
                        enabled = Core.Nothing, ignorePollAlarmFailure = Core.Nothing}
...
{-# INLINEABLE acIgnorePollAlarmFailure #-}
{-# DEPRECATED ignorePollAlarmFailure "Use generic-lens or generic-optics with 'ignorePollAlarmFailure' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("alarms" Core..=) Core.<$> alarms,
                  ...
                  ("ignorePollAlarmFailure" Core..=) Core.<$>
          ...
          = Core.withObject "AlarmConfiguration" Core.$
              \ x ->
                AlarmConfiguration' Core.<$>
                  (x Core..:? "alarms") Core.<*> x Core..:? "enabled" Core.<*>
                    x Core..:? "ignorePollAlarmFailure"
