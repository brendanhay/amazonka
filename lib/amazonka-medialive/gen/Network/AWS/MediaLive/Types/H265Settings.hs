...
mkH265Settings framerateNumerator framerateDenominator
  = H265Settings'{framerateNumerator, framerateDenominator,
                  adaptiveQuantization = Core.Nothing, afdSignaling = Core.Nothing,
                  alternativeTransferFunction = Core.Nothing, bitrate = Core.Nothing,
                  bufSize = Core.Nothing, colorMetadata = Core.Nothing,
                  colorSpaceSettings = Core.Nothing, filterSettings = Core.Nothing,
                  fixedAfd = Core.Nothing, flickerAq = Core.Nothing,
                  gopClosedCadence = Core.Nothing, gopSize = Core.Nothing,
                  gopSizeUnits = Core.Nothing, level = Core.Nothing,
                  lookAheadRateControl = Core.Nothing, maxBitrate = Core.Nothing,
                  minIInterval = Core.Nothing, parDenominator = Core.Nothing,
                  parNumerator = Core.Nothing, profile = Core.Nothing,
                  qvbrQualityLevel = Core.Nothing, rateControlMode = Core.Nothing,
                  scanType = Core.Nothing, sceneChangeDetect = Core.Nothing,
                  slices = Core.Nothing, tier = Core.Nothing,
...
{-# INLINEABLE hAlternativeTransferFunction #-}
{-# DEPRECATED alternativeTransferFunction "Use generic-lens or generic-optics with 'alternativeTransferFunction' instead"  #-}
...
{-# INLINEABLE hColorSpaceSettings #-}
...
{-# INLINEABLE hLookAheadRateControl #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("framerateNumerator" Core..= framerateNumerator),
                  ...
                  ("alternativeTransferFunction" Core..=) Core.<$>
                  ...
                  ("slices" Core..=) Core.<$> slices, ("tier" Core..=) Core.<$> tier,
