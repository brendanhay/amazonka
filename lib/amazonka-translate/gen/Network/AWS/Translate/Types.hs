...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Translate",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "translate",
                 Core._svcVersion = "2017-07-01", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _UnsupportedLanguagePairException #-}
...
{-# INLINEABLE _DetectedLanguageLowConfidenceException #-}
