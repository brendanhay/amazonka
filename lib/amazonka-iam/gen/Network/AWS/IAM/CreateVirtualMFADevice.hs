...
mkCreateVirtualMFADevice
    :: Types.VirtualMFADeviceName -- ^ 'virtualMFADeviceName'
    -> CreateVirtualMFADevice
...
{-# INLINEABLE cvmfadVirtualMFADeviceName #-}
{-# DEPRECATED virtualMFADeviceName "Use generic-lens or generic-optics with 'virtualMFADeviceName' instead"  #-}
...
instance Core.ToQuery CreateVirtualMFADevice where
        toQuery CreateVirtualMFADevice{..}
          = Core.toQueryPair "Action" ("CreateVirtualMFADevice" :: Core.Text)
              Core.<> Core.toQueryPair "Version" ("2010-05-08" :: Core.Text)
              Core.<>
              Core.toQueryPair "VirtualMFADeviceName" virtualMFADeviceName
...
instance Core.AWSRequest CreateVirtualMFADevice where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "CreateVirtualMFADeviceResult"
              (\ s h x ->
                 CreateVirtualMFADeviceResponse' Core.<$>
                   (x Core..@ "VirtualMFADevice") Core.<*>
...
mkCreateVirtualMFADeviceResponse
    :: Types.VirtualMFADevice -- ^ 'virtualMFADevice'
...
{-# INLINEABLE cvmfadrrsVirtualMFADevice #-}
{-# DEPRECATED virtualMFADevice "Use generic-lens or generic-optics with 'virtualMFADevice' instead"  #-}
...
{-# INLINEABLE cvmfadrrsResponseStatus #-}
