...
mkListAccountAliases
    :: ListAccountAliases
mkListAccountAliases
  = ListAccountAliases'{marker = Core.Nothing,
...
instance Core.AWSRequest ListAccountAliases where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ListAccountAliasesResult"
              (\ s h x ->
                 ListAccountAliasesResponse' Core.<$>
                   (x Core..@ "AccountAliases" Core..@! Core.mempty Core..<@>
...
mkListAccountAliasesResponse responseStatus
  = ListAccountAliasesResponse'{accountAliases = Core.mempty,
...
{-# INLINEABLE laarrsAccountAliases #-}
{-# DEPRECATED accountAliases "Use generic-lens or generic-optics with 'accountAliases' instead"  #-}
...
{-# INLINEABLE laarrsResponseStatus #-}
