...
mkListQueryLoggingConfigs
    :: ListQueryLoggingConfigs
mkListQueryLoggingConfigs
  = ListQueryLoggingConfigs'{hostedZoneId = Core.Nothing,
...
instance Core.AWSRequest ListQueryLoggingConfigs where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 ListQueryLoggingConfigsResponse' Core.<$>
                   (x Core..@ "QueryLoggingConfigs" Core..@! Core.mempty Core..<@>
                      Core.parseXMLList "QueryLoggingConfig")
...
{-# INLINEABLE lqlcrrsQueryLoggingConfigs #-}
{-# DEPRECATED queryLoggingConfigs "Use generic-lens or generic-optics with 'queryLoggingConfigs' instead"  #-}
...
{-# INLINEABLE lqlcrrsResponseStatus #-}
