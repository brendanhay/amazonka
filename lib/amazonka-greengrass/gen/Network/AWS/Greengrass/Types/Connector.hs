...
{-# INLINEABLE cfConnectorArn #-}
{-# DEPRECATED connectorArn "Use generic-lens or generic-optics with 'connectorArn' instead"  #-}
...
instance Core.FromJSON Connector where
        parseJSON
          = Core.withObject "Connector" Core.$
              \ x ->
                Connector' Core.<$>
                  (x Core..: "ConnectorArn") Core.<*> x Core..: "Id" Core.<*>
                    x Core..:? "Parameters"
