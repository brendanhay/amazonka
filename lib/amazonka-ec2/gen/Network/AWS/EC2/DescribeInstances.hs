...
mkDescribeInstances
    :: DescribeInstances
mkDescribeInstances
  = DescribeInstances'{dryRun = Core.Nothing, filters = Core.Nothing,
              ...
              (\ s h x ->
                 DescribeInstancesResponse' Core.<$>
                   (x Core..@? "nextToken") Core.<*>
                     x Core..@? "reservationSet" Core..<@> Core.parseXMLList "item"
...
mkDescribeInstancesResponse responseStatus
  = DescribeInstancesResponse'{nextToken = Core.Nothing,
                               reservations = Core.Nothing, responseStatus}

-- | The token to use to retrieve the next page of results. This value is @null@ when there are no more results to return.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dirrsNextToken :: Lens.Lens' DescribeInstancesResponse (Core.Maybe Core.Text)
