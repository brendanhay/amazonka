...
mkRelationalDatabaseHardware
    :: RelationalDatabaseHardware
mkRelationalDatabaseHardware
  = RelationalDatabaseHardware'{cpuCount = Core.Nothing,
                                diskSizeInGb = Core.Nothing, ramSizeInGb = Core.Nothing}
...
instance Core.FromJSON RelationalDatabaseHardware where
        parseJSON
          = Core.withObject "RelationalDatabaseHardware" Core.$
              \ x ->
                RelationalDatabaseHardware' Core.<$>
                  (x Core..:? "cpuCount") Core.<*> x Core..:? "diskSizeInGb" Core.<*>
                    x Core..:? "ramSizeInGb"
