...
mkFailedCreateWorkspaceRequest
    :: FailedCreateWorkspaceRequest
mkFailedCreateWorkspaceRequest
  = FailedCreateWorkspaceRequest'{errorCode = Core.Nothing,
                                  errorMessage = Core.Nothing, workspaceRequest = Core.Nothing}
...
{-# INLINEABLE fcwrWorkspaceRequest #-}
{-# DEPRECATED workspaceRequest "Use generic-lens or generic-optics with 'workspaceRequest' instead"  #-}

instance Core.FromJSON FailedCreateWorkspaceRequest where
        parseJSON
          = Core.withObject "FailedCreateWorkspaceRequest" Core.$
              \ x ->
                FailedCreateWorkspaceRequest' Core.<$>
