...
{-# INLINEABLE ccpCachePolicyConfig #-}
...
instance Core.AWSRequest CreateCachePolicy where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 CreateCachePolicyResponse' Core.<$>
...
mkCreateCachePolicyResponse responseStatus
  = CreateCachePolicyResponse'{cachePolicy = Core.Nothing,
