...
instance AWSRequest UpdateConfigurationSetTrackingOptions where
  type
...
instance Hashable UpdateConfigurationSetTrackingOptions

instance NFData UpdateConfigurationSetTrackingOptions

instance ToHeaders UpdateConfigurationSetTrackingOptions where
  toHeaders = const mempty

instance ToPath UpdateConfigurationSetTrackingOptions where
  toPath = const "/"

instance ToQuery UpdateConfigurationSetTrackingOptions where
  toQuery UpdateConfigurationSetTrackingOptions' {..} =
    mconcat
      [ "Action"
          =: ("UpdateConfigurationSetTrackingOptions" :: ByteString),
...
instance NFData UpdateConfigurationSetTrackingOptionsResponse
