...
-- |
-- Module      : Network.AWS.SSOAdmin.DescribePermissionSet
...
instance Prelude.Hashable DescribePermissionSet

instance Prelude.NFData DescribePermissionSet
...
instance Prelude.NFData DescribePermissionSetResponse
