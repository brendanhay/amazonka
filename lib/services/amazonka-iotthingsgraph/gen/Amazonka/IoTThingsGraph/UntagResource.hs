...
-- |
-- Module      : Amazonka.IoTThingsGraph.UntagResource
...
data UntagResource = UntagResource'
  { -- | The Amazon Resource Name (ARN) of the resource whose tags are to be
    ...
    -- <https://docs.aws.amazon.com/cli/latest/userguide/cli-usage-parameters.html#cli-using-param-json Using JSON for Parameters>
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The Amazon Resource Name (ARN) of the resource whose tags are to be
-- removed.
--
...
instance Prelude.Hashable UntagResource where
  hashWithSalt salt' UntagResource' {..} =
...
instance Core.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Core.=# ( "IotThingsGraphFrontEndService.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
