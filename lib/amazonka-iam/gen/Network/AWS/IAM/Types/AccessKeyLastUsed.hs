...
mkAccessKeyLastUsed
    :: Core.UTCTime -- ^ 'lastUsedDate'
    -> Types.StringType -- ^ 'serviceName'
    -> Types.StringType -- ^ 'region'
    -> AccessKeyLastUsed
