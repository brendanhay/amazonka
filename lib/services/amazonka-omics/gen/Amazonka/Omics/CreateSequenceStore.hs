...
--
-- 'fallbackLocation', 'createSequenceStore_fallbackLocation' - An S3 location that is used to store files that have failed a direct
-- upload.
--
...
-- | An S3 location that is used to store files that have failed a direct
-- upload.
createSequenceStore_fallbackLocation :: Lens.Lens' CreateSequenceStore (Prelude.Maybe Prelude.Text)
createSequenceStore_fallbackLocation = Lens.lens (\CreateSequenceStore' {fallbackLocation} -> fallbackLocation) (\s@CreateSequenceStore' {} a -> s {fallbackLocation = a} :: CreateSequenceStore)
    ...
    Data.object
      ( Prelude.catMaybes
          [ ("clientToken" Data..=) Prelude.<$> clientToken,
            ...
            ("fallbackLocation" Data..=)
              Prelude.<$> fallbackLocation,
...
--
-- 'fallbackLocation', 'createSequenceStoreResponse_fallbackLocation' - An S3 location that is used to store files that have failed a direct
-- upload.
--
...
-- | An S3 location that is used to store files that have failed a direct
-- upload.
createSequenceStoreResponse_fallbackLocation :: Lens.Lens' CreateSequenceStoreResponse (Prelude.Maybe Prelude.Text)
createSequenceStoreResponse_fallbackLocation = Lens.lens (\CreateSequenceStoreResponse' {fallbackLocation} -> fallbackLocation) (\s@CreateSequenceStoreResponse' {} a -> s {fallbackLocation = a} :: CreateSequenceStoreResponse)
