...
mkRoom
    :: Room
mkRoom
  = Room'{description = Core.Nothing, profileArn = Core.Nothing,
          providerCalendarId = Core.Nothing, roomArn = Core.Nothing,
...
{-# INLINEABLE rProviderCalendarId #-}
