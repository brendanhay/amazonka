...
--
-- 'annotationFields', 'variantImportJobItem_annotationFields' - The annotation schema generated by the parsed annotation data.
--
...
-- | The annotation schema generated by the parsed annotation data.
variantImportJobItem_annotationFields :: Lens.Lens' VariantImportJobItem (Prelude.Maybe (Prelude.HashMap Prelude.Text Prelude.Text))
variantImportJobItem_annotationFields = Lens.lens (\VariantImportJobItem' {annotationFields} -> annotationFields) (\s@VariantImportJobItem' {} a -> s {annotationFields = a} :: VariantImportJobItem) Prelude.. Lens.mapping Lens.coerced
