...
instance Core.AWSRequest ListServerCertificates where
  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqBody =
          Core.toFormBody
            ( Core.pure ("Action", "ListServerCertificates")
  ...
  response =
    Response.receiveXMLWrapper
      ...
      ( \s h x ->
          ListServerCertificatesResponse'
            Core.<$> ( x Core..@? "ServerCertificateMetadataList" Core..@! Core.mempty
...
{-# DEPRECATED lscrrsServerCertificateMetadataList "Use generic-lens or generic-optics with 'serverCertificateMetadataList' instead." #-}
...
{-# DEPRECATED lscrrsIsTruncated "Use generic-lens or generic-optics with 'isTruncated' instead." #-}
