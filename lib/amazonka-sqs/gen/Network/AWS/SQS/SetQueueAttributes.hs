...
data SetQueueAttributes = SetQueueAttributes'
  { -- | A map of attributes to set.
    ...
    attributes :: Lude.HashMap QueueAttributeName (Lude.Text),
...
mkSetQueueAttributes ::
  ...
  Lude.Text ->
  SetQueueAttributes
mkSetQueueAttributes pQueueURL_ =
  SetQueueAttributes'
...
sqaAttributes :: Lens.Lens' SetQueueAttributes (Lude.HashMap QueueAttributeName (Lude.Text))
sqaAttributes = Lens.lens (attributes :: SetQueueAttributes -> Lude.HashMap QueueAttributeName (Lude.Text)) (\s a -> s {attributes = a} :: SetQueueAttributes)
{-# DEPRECATED sqaAttributes "Use generic-lens or generic-optics with 'attributes' instead." #-}
...
sqaQueueURL :: Lens.Lens' SetQueueAttributes Lude.Text
sqaQueueURL = Lens.lens (queueURL :: SetQueueAttributes -> Lude.Text) (\s a -> s {queueURL = a} :: SetQueueAttributes)
{-# DEPRECATED sqaQueueURL "Use generic-lens or generic-optics with 'queueURL' instead." #-}

instance Lude.AWSRequest SetQueueAttributes where
  type Rs SetQueueAttributes = SetQueueAttributesResponse
  request = Req.postQuery sqsService
  response = Res.receiveNull SetQueueAttributesResponse'

instance Lude.ToHeaders SetQueueAttributes where
  toHeaders = Lude.const Lude.mempty

instance Lude.ToPath SetQueueAttributes where
  toPath = Lude.const "/"

instance Lude.ToQuery SetQueueAttributes where
  toQuery SetQueueAttributes' {..} =
    Lude.mconcat
      [ "Action" Lude.=: ("SetQueueAttributes" :: Lude.ByteString),
        "Version" Lude.=: ("2012-11-05" :: Lude.ByteString),
        Lude.toQueryMap "Attribute" "Name" "Value" attributes,
