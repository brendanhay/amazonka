...
mkNumberValidateRequest
    :: NumberValidateRequest
mkNumberValidateRequest
  = NumberValidateRequest'{isoCountryCode = Core.Nothing,
...
{-# INLINEABLE nvrIsoCountryCode #-}
{-# DEPRECATED isoCountryCode "Use generic-lens or generic-optics with 'isoCountryCode' instead"  #-}
