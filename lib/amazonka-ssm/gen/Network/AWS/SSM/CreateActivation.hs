...
mkCreateActivation iamRole
  = CreateActivation'{iamRole, defaultInstanceName = Core.Nothing,
                      description = Core.Nothing, expirationDate = Core.Nothing,
                      registrationLimit = Core.Nothing, tags = Core.Nothing}
...
{-# INLINEABLE caDefaultInstanceName #-}
...
{-# INLINEABLE caRegistrationLimit #-}
...
instance Core.ToHeaders CreateActivation where
        toHeaders CreateActivation{..}
          = Core.pure ("X-Amz-Target", "AmazonSSM.CreateActivation") Core.<>
...
instance Core.AWSRequest CreateActivation where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateActivationResponse' Core.<$>
                   (x Core..:? "ActivationCode") Core.<*> x Core..:? "ActivationId"
...
mkCreateActivationResponse responseStatus
  = CreateActivationResponse'{activationCode = Core.Nothing,
                              activationId = Core.Nothing, responseStatus}
...
{-# INLINEABLE crsActivationCode #-}
{-# DEPRECATED activationCode "Use generic-lens or generic-optics with 'activationCode' instead"  #-}
