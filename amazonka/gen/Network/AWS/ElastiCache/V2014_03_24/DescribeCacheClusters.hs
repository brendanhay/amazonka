...
-- &MaxRecords=100 &Version=2014-03-24 &ShowCacheNodeInfo=false
-- &SignatureVersion=2 &SignatureMethod=HmacSHA256
-- &Timestamp=2014-03-27T02%3A55%3A54.654Z &AWSAccessKeyId=YOUR-ACCESS-KEY
...
module Network.AWS.ElastiCache.V2014_03_24.DescribeCacheClusters where
...
instance AWSRequest DescribeCacheClusters where
    ...
    response _ = cursorResponse $ \hs xml ->
        pure DescribeCacheClustersResponse
            <*> xml %| "CacheClusterList"
            <*> xml %|? "String"
