...
mkApplicationUpdate
    :: ApplicationUpdate
mkApplicationUpdate
  = ApplicationUpdate'{applicationCodeUpdate = Core.Nothing,
                       cloudWatchLoggingOptionUpdates = Core.Nothing,
                       inputUpdates = Core.Nothing, outputUpdates = Core.Nothing,
...
{-# INLINEABLE auApplicationCodeUpdate #-}
{-# DEPRECATED applicationCodeUpdate "Use generic-lens or generic-optics with 'applicationCodeUpdate' instead"  #-}
...
{-# INLINEABLE auCloudWatchLoggingOptionUpdates #-}
{-# DEPRECATED cloudWatchLoggingOptionUpdates "Use generic-lens or generic-optics with 'cloudWatchLoggingOptionUpdates' instead"  #-}
...
{-# INLINEABLE auInputUpdates #-}
{-# DEPRECATED inputUpdates "Use generic-lens or generic-optics with 'inputUpdates' instead"  #-}
...
{-# INLINEABLE auOutputUpdates #-}
{-# DEPRECATED outputUpdates "Use generic-lens or generic-optics with 'outputUpdates' instead"  #-}
...
{-# INLINEABLE auReferenceDataSourceUpdates #-}
{-# DEPRECATED referenceDataSourceUpdates "Use generic-lens or generic-optics with 'referenceDataSourceUpdates' instead"  #-}
