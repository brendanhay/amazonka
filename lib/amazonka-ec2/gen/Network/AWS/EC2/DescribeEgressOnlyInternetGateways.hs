...
mkDescribeEgressOnlyInternetGateways
    :: DescribeEgressOnlyInternetGateways
mkDescribeEgressOnlyInternetGateways
  = DescribeEgressOnlyInternetGateways'{dryRun = Core.Nothing,
...
{-# INLINEABLE deoigEgressOnlyInternetGatewayIds #-}
{-# DEPRECATED egressOnlyInternetGatewayIds "Use generic-lens or generic-optics with 'egressOnlyInternetGatewayIds' instead"  #-}
...
{-# INLINEABLE deoigMaxResults #-}
{-# DEPRECATED maxResults "Use generic-lens or generic-optics with 'maxResults' instead"  #-}

-- | The token for the next page of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
deoigNextToken :: Lens.Lens' DescribeEgressOnlyInternetGateways (Core.Maybe Core.Text)
deoigNextToken = Lens.field @"nextToken"
{-# INLINEABLE deoigNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery DescribeEgressOnlyInternetGateways where
        toQuery DescribeEgressOnlyInternetGateways{..}
          = Core.toQueryPair "Action"
              ("DescribeEgressOnlyInternetGateways" :: Core.Text)
...
instance Core.ToHeaders DescribeEgressOnlyInternetGateways where
...
instance Core.AWSRequest DescribeEgressOnlyInternetGateways where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 DescribeEgressOnlyInternetGatewaysResponse' Core.<$>
                   (x Core..@? "egressOnlyInternetGatewaySet" Core..<@>
...
instance Pager.AWSPager DescribeEgressOnlyInternetGateways where
        page rq rs
          ...
          | Pager.stop
              (rs Lens.^?
                 Lens.field @"egressOnlyInternetGateways" Core.. Lens._Just)
            = Core.Nothing
          | Core.otherwise =
            Core.Just
              (rq Core.&
...
{-# INLINEABLE deoigrrsEgressOnlyInternetGateways #-}
{-# DEPRECATED egressOnlyInternetGateways "Use generic-lens or generic-optics with 'egressOnlyInternetGateways' instead"  #-}

-- | The token to use to retrieve the next page of results. This value is @null@ when there are no more results to return.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
deoigrrsNextToken :: Lens.Lens' DescribeEgressOnlyInternetGatewaysResponse (Core.Maybe Core.Text)
deoigrrsNextToken = Lens.field @"nextToken"
{-# INLINEABLE deoigrrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE deoigrrsResponseStatus #-}
