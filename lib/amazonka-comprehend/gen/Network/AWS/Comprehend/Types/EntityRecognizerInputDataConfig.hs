...
mkEntityRecognizerInputDataConfig
    :: EntityRecognizerInputDataConfig
mkEntityRecognizerInputDataConfig
  = EntityRecognizerInputDataConfig'{entityTypes = Core.mempty,
                                     annotations = Core.Nothing, augmentedManifests = Core.Nothing,
                                     dataFormat = Core.Nothing, documents = Core.Nothing,
...
{-# INLINEABLE eridcAugmentedManifests #-}
...
{-# INLINEABLE eridcEntityList #-}
{-# DEPRECATED entityList "Use generic-lens or generic-optics with 'entityList' instead"  #-}
...
instance Core.FromJSON EntityRecognizerInputDataConfig where
        parseJSON
          = Core.withObject "EntityRecognizerInputDataConfig" Core.$
              \ x ->
                EntityRecognizerInputDataConfig' Core.<$>
                  (x Core..:? "EntityTypes" Core..!= Core.mempty) Core.<*>
                    x Core..:? "Annotations"
