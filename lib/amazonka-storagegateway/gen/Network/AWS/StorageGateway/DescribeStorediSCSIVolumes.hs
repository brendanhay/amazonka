...
{-# DEPRECATED dsscsivrrsStorediSCSIVolumes "Use generic-lens or generic-optics with 'storediSCSIVolumes' instead." #-}
...
{-# DEPRECATED dsscsivrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
