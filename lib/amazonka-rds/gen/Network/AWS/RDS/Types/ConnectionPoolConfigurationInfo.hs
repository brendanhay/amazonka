...
{-# INLINEABLE cpciConnectionBorrowTimeout #-}
...
cpciInitQuery :: Lens.Lens' ConnectionPoolConfigurationInfo (Core.Maybe Core.Text)
cpciInitQuery = Lens.field @"initQuery"
{-# INLINEABLE cpciInitQuery #-}
...
{-# INLINEABLE cpciMaxConnectionsPercent #-}
...
{-# INLINEABLE cpciMaxIdleConnectionsPercent #-}
...
cpciSessionPinningFilters :: Lens.Lens' ConnectionPoolConfigurationInfo (Core.Maybe [Core.Text])
cpciSessionPinningFilters = Lens.field @"sessionPinningFilters"
{-# INLINEABLE cpciSessionPinningFilters #-}
...
instance Core.FromXML ConnectionPoolConfigurationInfo where
        parseXML x
          = ConnectionPoolConfigurationInfo' Core.<$>
              (x Core..@? "ConnectionBorrowTimeout") Core.<*>
                x Core..@? "InitQuery"
                Core.<*> x Core..@? "MaxConnectionsPercent"
                Core.<*> x Core..@? "MaxIdleConnectionsPercent"
                Core.<*>
                x Core..@? "SessionPinningFilters" Core..<@>
