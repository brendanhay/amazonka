...
mkInferenceSpecification
    :: Core.NonEmpty Types.ModelPackageContainerDefinition -- ^ 'containers'
    -> Core.NonEmpty Types.TransformInstanceType -- ^ 'supportedTransformInstanceTypes'
    -> InferenceSpecification
...
{-# INLINEABLE isSupportedTransformInstanceTypes #-}
{-# DEPRECATED supportedTransformInstanceTypes "Use generic-lens or generic-optics with 'supportedTransformInstanceTypes' instead"  #-}
...
{-# INLINEABLE isSupportedRealtimeInferenceInstanceTypes #-}
{-# DEPRECATED supportedRealtimeInferenceInstanceTypes "Use generic-lens or generic-optics with 'supportedRealtimeInferenceInstanceTypes' instead"  #-}
...
{-# INLINEABLE isSupportedContentTypes #-}
...
{-# INLINEABLE isSupportedResponseMIMETypes #-}
{-# DEPRECATED supportedResponseMIMETypes "Use generic-lens or generic-optics with 'supportedResponseMIMETypes' instead"  #-}
          ...
          = Core.withObject "InferenceSpecification" Core.$
              \ x ->
                InferenceSpecification' Core.<$>
                  (x Core..: "Containers") Core.<*>
                    x Core..: "SupportedTransformInstanceTypes"
                    Core.<*>
                    x Core..:? "SupportedRealtimeInferenceInstanceTypes" Core..!=
                      Core.mempty
                    Core.<*> x Core..:? "SupportedContentTypes" Core..!= Core.mempty
                    Core.<*>
                    x Core..:? "SupportedResponseMIMETypes" Core..!= Core.mempty
