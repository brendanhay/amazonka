...
mkCommit
    :: Commit
mkCommit
  = Commit'{additionalData = Core.Nothing, author = Core.Nothing,
            commitId = Core.Nothing, committer = Core.Nothing,
            message = Core.Nothing, parents = Core.Nothing,
            treeId = Core.Nothing}
...
{-# INLINEABLE cAdditionalData #-}
{-# DEPRECATED additionalData "Use generic-lens or generic-optics with 'additionalData' instead"  #-}
...
{-# INLINEABLE cCommitter #-}
{-# DEPRECATED committer "Use generic-lens or generic-optics with 'committer' instead"  #-}
...
instance Core.FromJSON Commit where
        parseJSON
          = Core.withObject "Commit" Core.$
              \ x ->
                Commit' Core.<$>
                  (x Core..:? "additionalData") Core.<*> x Core..:? "author" Core.<*>
                    x Core..:? "commitId"
