...
mkDescribeExclusions
    :: Core.NonEmpty Types.Arn -- ^ 'exclusionArns'
    -> DescribeExclusions
...
{-# INLINEABLE deExclusionArns #-}
{-# DEPRECATED exclusionArns "Use generic-lens or generic-optics with 'exclusionArns' instead"  #-}
...
instance Core.AWSRequest DescribeExclusions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeExclusionsResponse' Core.<$>
                   (x Core..:? "exclusions" Core..!= Core.mempty) Core.<*>
...
mkDescribeExclusionsResponse responseStatus
  = DescribeExclusionsResponse'{exclusions = Core.mempty,
...
{-# INLINEABLE derrsExclusions #-}
{-# DEPRECATED exclusions "Use generic-lens or generic-optics with 'exclusions' instead"  #-}
