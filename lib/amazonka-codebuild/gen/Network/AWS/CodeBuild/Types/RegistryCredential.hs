...
mkRegistryCredential
    ...
    -> Types.CredentialProviderType -- ^ 'credentialProvider'
    -> RegistryCredential
...
{-# INLINEABLE rcCredentialProvider #-}
{-# DEPRECATED credentialProvider "Use generic-lens or generic-optics with 'credentialProvider' instead"  #-}
          ...
          = Core.withObject "RegistryCredential" Core.$
              \ x ->
                RegistryCredential' Core.<$>
                  (x Core..: "credential") Core.<*> x Core..: "credentialProvider"
