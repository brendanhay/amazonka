...
mkEndpointFilter
    :: EndpointFilter
mkEndpointFilter
  = EndpointFilter'{creationTimeAfter = Core.Nothing,
                    creationTimeBefore = Core.Nothing, modelArn = Core.Nothing,
                    status = Core.Nothing}
...
{-# INLINEABLE efCreationTimeAfter #-}
...
{-# INLINEABLE efCreationTimeBefore #-}
