...
data PostContent = PostContent'
  { -- | You pass this value as the @x-amz-lex-session-attributes@ HTTP header.
    ...
    sessionAttributes :: Prelude.Maybe (Prelude.Sensitive Prelude.Text),
    ...
    requestAttributes :: Prelude.Maybe (Prelude.Sensitive Prelude.Text),
    ...
    activeContexts :: Prelude.Maybe (Prelude.Sensitive Prelude.Text),
    ...
    -- data locally.
    inputStream :: Prelude.HashedBody
  }
...
postContent_sessionAttributes = Lens.lens (\PostContent' {sessionAttributes} -> sessionAttributes) (\s@PostContent' {} a -> s {sessionAttributes = a} :: PostContent) Prelude.. Lens.mapping Prelude._Sensitive
...
postContent_requestAttributes = Lens.lens (\PostContent' {requestAttributes} -> requestAttributes) (\s@PostContent' {} a -> s {requestAttributes = a} :: PostContent) Prelude.. Lens.mapping Prelude._Sensitive
...
postContent_activeContexts = Lens.lens (\PostContent' {activeContexts} -> activeContexts) (\s@PostContent' {} a -> s {activeContexts = a} :: PostContent) Prelude.. Lens.mapping Prelude._Sensitive
...
instance Prelude.AWSRequest PostContent where
  ...
  response =
    Response.receiveBody
      ( \s h x ->
          PostContentResponse'
            Prelude.<$> (h Prelude..#? "x-amz-lex-dialog-state")
            Prelude.<*> (h Prelude..#? "x-amz-lex-session-attributes")
            Prelude.<*> (h Prelude..#? "Content-Type")
            Prelude.<*> (h Prelude..#? "x-amz-lex-message")
            Prelude.<*> (h Prelude..#? "x-amz-lex-session-id")
            Prelude.<*> (h Prelude..#? "x-amz-lex-intent-name")
            Prelude.<*> (h Prelude..#? "x-amz-lex-bot-version")
            Prelude.<*> (h Prelude..#? "x-amz-lex-input-transcript")
            Prelude.<*> (h Prelude..#? "x-amz-lex-message-format")
            Prelude.<*> (h Prelude..#? "x-amz-lex-slots")
            Prelude.<*> (h Prelude..#? "x-amz-lex-nlu-intent-confidence")
            Prelude.<*> (h Prelude..#? "x-amz-lex-sentiment")
            Prelude.<*> (h Prelude..#? "x-amz-lex-slot-to-elicit")
            Prelude.<*> (h Prelude..#? "x-amz-lex-active-contexts")
            Prelude.<*> (h Prelude..#? "x-amz-lex-alternative-intents")
            Prelude.<*> (Prelude.pure (Prelude.fromEnum s))
            Prelude.<*> (Prelude.pure x)
      )

instance Prelude.ToBody PostContent where
  toBody PostContent' {..} = Prelude.toBody inputStream

instance Prelude.ToHeaders PostContent where
...
instance Prelude.ToPath PostContent where
  toPath PostContent' {..} =
    Prelude.mconcat
      [ "/bot/",
...
instance Prelude.ToQuery PostContent where
...
postContentResponse_message = Lens.lens (\PostContentResponse' {message} -> message) (\s@PostContentResponse' {} a -> s {message = a} :: PostContentResponse) Prelude.. Lens.mapping Prelude._Sensitive
...
postContentResponse_activeContexts = Lens.lens (\PostContentResponse' {activeContexts} -> activeContexts) (\s@PostContentResponse' {} a -> s {activeContexts = a} :: PostContentResponse) Prelude.. Lens.mapping Prelude._Sensitive
...
-- the intent, and sent a message to convey to the user. Then Amazon Lex
-- sends that message in the response.
postContentResponse_audioStream :: Lens.Lens' PostContentResponse Prelude.RsBody
