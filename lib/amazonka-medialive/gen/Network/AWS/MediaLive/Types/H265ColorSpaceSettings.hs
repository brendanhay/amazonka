...
mkH265ColorSpaceSettings
    :: H265ColorSpaceSettings
mkH265ColorSpaceSettings
  = H265ColorSpaceSettings'{colorSpacePassthroughSettings =
                              Core.Nothing,
                            hdr10Settings = Core.Nothing, rec601Settings = Core.Nothing,
...
{-# INLINEABLE hColorSpacePassthroughSettings #-}
...
{-# INLINEABLE hHdr10Settings #-}
{-# DEPRECATED hdr10Settings "Use generic-lens or generic-optics with 'hdr10Settings' instead"  #-}
...
instance Core.FromJSON H265ColorSpaceSettings where
        parseJSON
          = Core.withObject "H265ColorSpaceSettings" Core.$
              \ x ->
                H265ColorSpaceSettings' Core.<$>
                  (x Core..:? "colorSpacePassthroughSettings") Core.<*>
                    x Core..:? "hdr10Settings"
