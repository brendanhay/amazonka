...
-- specify the minimum viable UploadPart request.
...
instance AWSRequest UploadPart where
    ...
    request  = put
fromList [("payload",Null),("name",String "UploadPartResponse"),("shape",Object fromList [("streaming",Bool False),("location",String "body"),("required",Bool False),("name",String "UploadPartOutput"),("documentation",Null),("common",Object fromList [("streaming",Bool False),("location",String "body"),("required",Bool False),("name",String "UploadPartOutput"),("documentation",Null),("location_name",String "UploadPartOutput"),("xml_name",String "UploadPartOutput")]),("location_name",String "UploadPartOutput"),("xml_name",String "UploadPartOutput"),("fields",Object fromList [("ETag",Object fromList [("streaming",Bool False),("location",String "header"),("pattern",Null),("required",Bool False),("min_length",Number 0.0),("max_length",Number 0.0),("name",String "ETag"),("documentation",String "Entity tag for the uploaded object."),("common",Object fromList [("streaming",Bool False),("location",String "header"),("required",Bool False),("name",String "ETag"),("documentation",String "Entity tag for the uploaded object."),("location_name",String "ETag"),("xml_name",String "ETag")]),("location_name",String "ETag"),("type",String "Text"),("xml_name",String "ETag")]),("SSECustomerAlgorithm",Object fromList [("streaming",Bool False),("location",String "header"),("pattern",Null),("required",Bool False),("min_length",Number 0.0),("max_length",Number 0.0),("name",String "SSECustomerAlgorithm"),("documentation",String "If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used."),("common",Object fromList [("streaming",Bool False),("location",String "header"),("required",Bool False),("name",String "SSECustomerAlgorithm"),("documentation",String "If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used."),("location_name",String "x-amz-server-side-encryption-customer-algorithm"),("xml_name",String "SSECustomerAlgorithm")]),("location_name",String "x-amz-server-side-encryption-customer-algorithm"),("type",String "Text"),("xml_name",String "SSECustomerAlgorithm")]),("SSECustomerKeyMD5",Object fromList [("streaming",Bool False),("location",String "header"),("pattern",Null),("required",Bool False),("min_length",Number 0.0),("max_length",Number 0.0),("name",String "SSECustomerKeyMD5"),("documentation",String "If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round trip message integrity verification of the customer-provided encryption key."),("common",Object fromList [("streaming",Bool False),("location",String "header"),("required",Bool False),("name",String "SSECustomerKeyMD5"),("documentation",String "If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round trip message integrity verification of the customer-provided encryption key."),("location_name",String "x-amz-server-side-encryption-customer-key-MD5"),("xml_name",String "SSECustomerKeyMD5")]),("location_name",String "x-amz-server-side-encryption-customer-key-MD5"),("type",String "Text"),("xml_name",String "SSECustomerKeyMD5")]),("ServerSideEncryption",Object fromList [("streaming",Bool False),("location",String "header"),("values",Object fromList [("ServerSideEncryptionAES256",String "AES256")]),("required",Bool False),("name",String "ServerSideEncryption"),("documentation",String "The Server-side encryption algorithm used when storing this object in S3."),("common",Object fromList [("streaming",Bool False),("location",String "header"),("required",Bool False),("name",String "ServerSideEncryption"),("documentation",String "The Server-side encryption algorithm used when storing this object in S3."),("location_name",String "x-amz-server-side-encryption"),("xml_name",String "ServerSideEncryption")]),("location_name",String "x-amz-server-side-encryption"),("xml_name",String "ServerSideEncryption")])])]),("fields",Array (fromList [Object fromList [("streaming",Bool False),("location",String "header"),("default",Bool False),("monoid",Bool False),("required",Bool False),("name",String "ETag"),("documentation",String "Entity tag for the uploaded object."),("location_name",String "ETag"),("type",String "Maybe ETag"),("xml_name",String "ETag"),("prefixed",String "upoETag")],Object fromList [("streaming",Bool False),("location",String "header"),("default",Bool False),("monoid",Bool False),("required",Bool False),("name",String "SSECustomerAlgorithm"),("documentation",String "If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used."),("location_name",String "x-amz-server-side-encryption-customer-algorithm"),("type",String "Maybe Text"),("xml_name",String "SSECustomerAlgorithm"),("prefixed",String "upoSSECustomerAlgorithm")],Object fromList [("streaming",Bool False),("location",String "header"),("default",Bool False),("monoid",Bool False),("required",Bool False),("name",String "SSECustomerKeyMD5"),("documentation",String "If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round trip message integrity verification of the customer-provided encryption key."),("location_name",String "x-amz-server-side-encryption-customer-key-MD5"),("type",String "Maybe Text"),("xml_name",String "SSECustomerKeyMD5"),("prefixed",String "upoSSECustomerKeyMD5")],Object fromList [("streaming",Bool False),("location",String "header"),("default",Bool False),("monoid",Bool False),("required",Bool False),("name",String "ServerSideEncryption"),("documentation",String "The Server-side encryption algorithm used when storing this object in S3."),("location_name",String "x-amz-server-side-encryption"),("type",String "Maybe ServerSideEncryption"),("xml_name",String "ServerSideEncryption"),("prefixed",String "upoServerSideEncryption")]]))]
