...
mkFSxWindowsFileServerAuthorizationConfig
    ...
    -> Core.Text -- ^ 'domain'
    -> FSxWindowsFileServerAuthorizationConfig
mkFSxWindowsFileServerAuthorizationConfig credentialsParameter
  domain
...
fswfsacCredentialsParameter :: Lens.Lens' FSxWindowsFileServerAuthorizationConfig Core.Text
fswfsacCredentialsParameter = Lens.field @"credentialsParameter"
{-# INLINEABLE fswfsacCredentialsParameter #-}
...
fswfsacDomain :: Lens.Lens' FSxWindowsFileServerAuthorizationConfig Core.Text
fswfsacDomain = Lens.field @"domain"
{-# INLINEABLE fswfsacDomain #-}
{-# DEPRECATED domain "Use generic-lens or generic-optics with 'domain' instead"  #-}

instance Core.FromJSON FSxWindowsFileServerAuthorizationConfig
         where
...
instance Core.FromJSON FSxWindowsFileServerAuthorizationConfig
        ...
        parseJSON
          = Core.withObject "FSxWindowsFileServerAuthorizationConfig" Core.$
              \ x ->
                FSxWindowsFileServerAuthorizationConfig' Core.<$>
                  (x Core..: "credentialsParameter") Core.<*> x Core..: "domain"
