...
mkCopySnapshot
    ...
    -> Core.Text -- ^ 'sourceSnapshotId'
    -> CopySnapshot
mkCopySnapshot sourceRegion sourceSnapshotId
  = CopySnapshot'{sourceRegion, sourceSnapshotId,
                  description = Core.Nothing, destinationRegion = Core.Nothing,
...
csfSourceRegion :: Lens.Lens' CopySnapshot Core.Text
csfSourceRegion = Lens.field @"sourceRegion"
{-# INLINEABLE csfSourceRegion #-}
...
csfSourceSnapshotId :: Lens.Lens' CopySnapshot Core.Text
csfSourceSnapshotId = Lens.field @"sourceSnapshotId"
{-# INLINEABLE csfSourceSnapshotId #-}
...
csfDescription :: Lens.Lens' CopySnapshot (Core.Maybe Core.Text)
...
csfDestinationRegion :: Lens.Lens' CopySnapshot (Core.Maybe Core.Text)
csfDestinationRegion = Lens.field @"destinationRegion"
{-# INLINEABLE csfDestinationRegion #-}
...
csfPresignedUrl :: Lens.Lens' CopySnapshot (Core.Maybe Core.Text)
csfPresignedUrl = Lens.field @"presignedUrl"
{-# INLINEABLE csfPresignedUrl #-}
...
{-# INLINEABLE csfTagSpecifications #-}
...
instance Core.ToQuery CopySnapshot where
        toQuery CopySnapshot{..}
          = Core.toQueryPair "Action" ("CopySnapshot" :: Core.Text) Core.<>
              ...
              Core.<> Core.toQueryPair "SourceSnapshotId" sourceSnapshotId
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "Description") description
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "DestinationRegion")
                destinationRegion
...
mkCopySnapshotResponse responseStatus
  = CopySnapshotResponse'{snapshotId = Core.Nothing,
                          tags = Core.Nothing, responseStatus}

-- | The ID of the new snapshot.
--
-- /Note:/ Consider using 'snapshotId' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
csrfrsSnapshotId :: Lens.Lens' CopySnapshotResponse (Core.Maybe Core.Text)
csrfrsSnapshotId = Lens.field @"snapshotId"
{-# INLINEABLE csrfrsSnapshotId #-}
