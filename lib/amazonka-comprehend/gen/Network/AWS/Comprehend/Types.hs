...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Comprehend",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "comprehend",
                 Core._svcVersion = "2017-11-27", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _BatchSizeLimitExceededException #-}
...
{-# INLINEABLE _UnsupportedLanguageException #-}
...
{-# INLINEABLE _TooManyTagKeysException #-}
...
{-# INLINEABLE _InvalidFilterException #-}
...
{-# INLINEABLE _KmsKeyValidationException #-}
...
{-# INLINEABLE _TextSizeLimitExceededException #-}
