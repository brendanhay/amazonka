...
mkTimeBasedCanary
    :: TimeBasedCanary
mkTimeBasedCanary
  = TimeBasedCanary'{canaryInterval = Core.Nothing,
...
{-# INLINEABLE tbcCanaryInterval #-}
{-# DEPRECATED canaryInterval "Use generic-lens or generic-optics with 'canaryInterval' instead"  #-}
...
{-# INLINEABLE tbcCanaryPercentage #-}
{-# DEPRECATED canaryPercentage "Use generic-lens or generic-optics with 'canaryPercentage' instead"  #-}
          ...
          = Core.withObject "TimeBasedCanary" Core.$
              \ x ->
                TimeBasedCanary' Core.<$>
                  (x Core..:? "canaryInterval") Core.<*>
                    x Core..:? "canaryPercentage"
