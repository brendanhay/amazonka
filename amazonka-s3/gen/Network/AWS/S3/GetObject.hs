...
data GetObjectResponse = GetObjectResponse
    ...
    , _gorMetadata                :: Map "entry" "key" "value" Text Text
...
instance ToXMLRoot GetObject where
    toXMLRoot = const (element "GetObject" [])
...
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorAcceptRanges","name":"_gorAcceptRanges","shape":"AcceptRanges","locationName":"accept-ranges","documentation":null,"typeExposed":"Maybe Text","type":"Maybe Text"}
        <$> h ~:? "accept-ranges"
{"location":null,"iso":null,"lensMapping":null,"default":"<error>","flattened":false,"required":true,"lens":"gorBody","name":"_gorBody","shape":"Body","locationName":"Body","documentation":"Object data.","typeExposed":"RsBody","type":"RsBody"}
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorCacheControl","name":"_gorCacheControl","shape":"CacheControl","locationName":"Cache-Control","documentation":"Specifies caching behavior along the request/reply chain.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "Cache-Control"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorContentDisposition","name":"_gorContentDisposition","shape":"ContentDisposition","locationName":"Content-Disposition","documentation":"Specifies presentational information for the object.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "Content-Disposition"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorContentEncoding","name":"_gorContentEncoding","shape":"ContentEncoding","locationName":"Content-Encoding","documentation":"Specifies what content encodings have been applied to the object and thus what decoding mechanisms must be applied to obtain the media-type referenced by the Content-Type header field.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "Content-Encoding"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorContentLanguage","name":"_gorContentLanguage","shape":"ContentLanguage","locationName":"Content-Language","documentation":"The language the content is in.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "Content-Language"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorContentLength","name":"_gorContentLength","shape":"ContentLength","locationName":"Content-Length","documentation":"Size of the body in bytes.","typeExposed":"Maybe Int","type":"Maybe Int"}
        <*> h ~:? "Content-Length"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorContentType","name":"_gorContentType","shape":"ContentType","locationName":"Content-Type","documentation":"A standard MIME type describing the format of the object data.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "Content-Type"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorDeleteMarker","name":"_gorDeleteMarker","shape":"DeleteMarker","locationName":"x-amz-delete-marker","documentation":"Specifies whether the object retrieved was (true) or was not (false) a Delete Marker. If false, this response header does not appear in the response.","typeExposed":"Maybe Bool","type":"Maybe Bool"}
        <*> h ~:? "x-amz-delete-marker"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorETag","name":"_gorETag","shape":"ETag","locationName":"ETag","documentation":"An ETag is an opaque identifier assigned by a web server to a specific version of a resource found at a URL","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "ETag"
{"location":"header","iso":null,"lensMapping":"mapping _Time","default":"Nothing","flattened":false,"required":false,"lens":"gorExpiration","name":"_gorExpiration","shape":"Expiration","locationName":"x-amz-expiration","documentation":"If the object expiration is configured (see PUT Bucket lifecycle), the response includes this header. It includes the expiry-date and rule-id key value pairs providing object expiration information. The value of the rule-id is URL encoded.","typeExposed":"Maybe UTCTime","type":"Maybe RFC822"}
        <*> h ~:? "x-amz-expiration"
{"location":"header","iso":null,"lensMapping":"mapping _Time","default":"Nothing","flattened":false,"required":false,"lens":"gorExpires","name":"_gorExpires","shape":"Expires","locationName":"Expires","documentation":"The date and time at which the object is no longer cacheable.","typeExposed":"Maybe UTCTime","type":"Maybe RFC822"}
        <*> h ~:? "Expires"
{"location":"header","iso":null,"lensMapping":"mapping _Time","default":"Nothing","flattened":false,"required":false,"lens":"gorLastModified","name":"_gorLastModified","shape":"LastModified","locationName":"Last-Modified","documentation":"Last modified date of the object","typeExposed":"Maybe UTCTime","type":"Maybe RFC822"}
        <*> h ~:? "Last-Modified"
{"location":"headers","iso":"_Map","lensMapping":"_Map","default":"mempty","flattened":false,"required":true,"lens":"gorMetadata","name":"_gorMetadata","shape":"Metadata","locationName":"x-amz-meta-","documentation":"A map of metadata to store with the object in S3.","typeExposed":"HashMap Text Text","type":"Map \"entry\" \"key\" \"value\" Text Text"}
        <*> h ~:: "x-amz-meta-"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorMissingMeta","name":"_gorMissingMeta","shape":"MissingMeta","locationName":"x-amz-missing-meta","documentation":"This is set to the number of metadata entries not returned in x-amz-meta headers. This can happen if you create metadata using an API like SOAP that supports more flexible metadata than the REST API. For example, using SOAP, you can create metadata whose values are not legal HTTP headers.","typeExposed":"Maybe Int","type":"Maybe Int"}
        <*> h ~:? "x-amz-missing-meta"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorRestore","name":"_gorRestore","shape":"Restore","locationName":"x-amz-restore","documentation":"Provides information about object restoration operation and expiration time of the restored object copy.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "x-amz-restore"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorSSECustomerAlgorithm","name":"_gorSSECustomerAlgorithm","shape":"SSECustomerAlgorithm","locationName":"x-amz-server-side-encryption-customer-algorithm","documentation":"If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "x-amz-server-side-encryption-customer-algorithm"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorSSECustomerKeyMD5","name":"_gorSSECustomerKeyMD5","shape":"SSECustomerKeyMD5","locationName":"x-amz-server-side-encryption-customer-key-MD5","documentation":"If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round trip message integrity verification of the customer-provided encryption key.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "x-amz-server-side-encryption-customer-key-MD5"
{"location":"header","iso":null,"lensMapping":"mapping _Sensitive","default":"Nothing","flattened":false,"required":false,"lens":"gorSSEKMSKeyId","name":"_gorSSEKMSKeyId","shape":"SSEKMSKeyId","locationName":"x-amz-server-side-encryption-aws-kms-key-id","documentation":"If present, specifies the AWS KMS key used to encrypt the object.","typeExposed":"Maybe Text","type":"Maybe (Sensitive Text)"}
        <*> h ~:? "x-amz-server-side-encryption-aws-kms-key-id"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorServerSideEncryption","name":"_gorServerSideEncryption","shape":"ServerSideEncryption","locationName":"x-amz-server-side-encryption","documentation":"The Server-side encryption algorithm used when storing this object in S3 (e.g., AES256, aws:kms).","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "x-amz-server-side-encryption"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorVersionId","name":"_gorVersionId","shape":"ObjectVersionId","locationName":"x-amz-version-id","documentation":"Version of the object.","typeExposed":"Maybe Text","type":"Maybe Text"}
        <*> h ~:? "x-amz-version-id"
{"location":"header","iso":null,"lensMapping":null,"default":"Nothing","flattened":false,"required":false,"lens":"gorWebsiteRedirectLocation","name":"_gorWebsiteRedirectLocation","shape":"WebsiteRedirectLocation","locationName":"x-amz-website-redirect-location","documentation":"If the bucket is configured as a website, redirects requests for this object to another object in the same bucket or to an external URL. Amazon S3 stores the value of this header in the object metadata.","typeExposed":"Maybe Text","type":"Maybe Text"}
