...
mkRespondDecisionTaskCompleted taskToken
  = RespondDecisionTaskCompleted'{taskToken,
                                  decisions = Core.Nothing, executionContext = Core.Nothing}
...
{-# INLINEABLE rdtcDecisions #-}
{-# DEPRECATED decisions "Use generic-lens or generic-optics with 'decisions' instead"  #-}
...
{-# INLINEABLE rdtcExecutionContext #-}
...
instance Core.ToHeaders RespondDecisionTaskCompleted where
        toHeaders RespondDecisionTaskCompleted{..}
          = Core.pure
              ("X-Amz-Target",
