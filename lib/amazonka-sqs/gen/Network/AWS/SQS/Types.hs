...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "SQS", Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "sqs", Core._svcVersion = "2012-11-05",
...
{-# INLINEABLE _InvalidBatchEntryId #-}
...
_TooManyEntriesInBatchRequest
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _TooManyEntriesInBatchRequest #-}
...
_QueueDeletedRecently
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _QueueDeletedRecently #-}
...
{-# INLINEABLE _InvalidAttributeName #-}
...
_UnsupportedOperation
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _UnsupportedOperation #-}
...
{-# INLINEABLE _InvalidMessageContents #-}
...
_BatchRequestTooLong
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _BatchRequestTooLong #-}
...
_OverLimit
  = Core._MatchServiceError mkServiceConfig "OverLimit" Core..
      Core.hasStatues 403
{-# INLINEABLE _OverLimit #-}
...
{-# INLINEABLE _PurgeQueueInProgress #-}
...
{-# INLINEABLE _ReceiptHandleIsInvalid #-}
...
_BatchEntryIdsNotDistinct
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _BatchEntryIdsNotDistinct #-}
...
_MessageNotInflight
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _MessageNotInflight #-}
