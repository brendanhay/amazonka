...
-- |
-- Module      : Network.AWS.ConnectParticipant.Types.ScanDirection
...
pattern ScanDirection_BACKWARD = ScanDirection' "BACKWARD"

pattern ScanDirection_FORWARD :: ScanDirection
pattern ScanDirection_FORWARD = ScanDirection' "FORWARD"
