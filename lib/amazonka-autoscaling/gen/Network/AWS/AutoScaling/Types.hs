...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "AutoScaling",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "autoscaling",
                 Core._svcVersion = "2011-01-01", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _InstanceRefreshInProgressFault #-}
...
_AlreadyExistsFault
  = Core._MatchServiceError mkServiceConfig "AlreadyExists" Core..
      Core.hasStatues 400
{-# INLINEABLE _AlreadyExistsFault #-}
...
_ResourceInUseFault
  = Core._MatchServiceError mkServiceConfig "ResourceInUse" Core..
      Core.hasStatues 400
{-# INLINEABLE _ResourceInUseFault #-}
...
_ScalingActivityInProgressFault
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _ScalingActivityInProgressFault #-}
...
{-# INLINEABLE _ResourceContentionFault #-}
...
_ServiceLinkedRoleFailure
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 500
{-# INLINEABLE _ServiceLinkedRoleFailure #-}
...
_ActiveInstanceRefreshNotFoundFault
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _ActiveInstanceRefreshNotFoundFault #-}
