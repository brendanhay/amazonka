...
mkIndexFaces collectionId image
  = IndexFaces'{collectionId, image,
                detectionAttributes = Core.Nothing, externalImageId = Core.Nothing,
                maxFaces = Core.Nothing, qualityFilter = Core.Nothing}
...
{-# INLINEABLE ifDetectionAttributes #-}
{-# DEPRECATED detectionAttributes "Use generic-lens or generic-optics with 'detectionAttributes' instead"  #-}
...
instance Core.AWSRequest IndexFaces where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 IndexFacesResponse' Core.<$>
                   (x Core..:? "FaceModelVersion") Core.<*> x Core..:? "FaceRecords"
...
mkIndexFacesResponse responseStatus
  = IndexFacesResponse'{faceModelVersion = Core.Nothing,
                        faceRecords = Core.Nothing, orientationCorrection = Core.Nothing,
                        unindexedFaces = Core.Nothing, responseStatus}
...
ifrrsFaceModelVersion :: Lens.Lens' IndexFacesResponse (Core.Maybe Core.Text)
ifrrsFaceModelVersion = Lens.field @"faceModelVersion"
{-# INLINEABLE ifrrsFaceModelVersion #-}
...
{-# INLINEABLE ifrrsFaceRecords #-}
{-# DEPRECATED faceRecords "Use generic-lens or generic-optics with 'faceRecords' instead"  #-}
...
{-# INLINEABLE ifrrsOrientationCorrection #-}
...
{-# INLINEABLE ifrrsUnindexedFaces #-}
{-# DEPRECATED unindexedFaces "Use generic-lens or generic-optics with 'unindexedFaces' instead"  #-}
...
{-# INLINEABLE ifrrsResponseStatus #-}
