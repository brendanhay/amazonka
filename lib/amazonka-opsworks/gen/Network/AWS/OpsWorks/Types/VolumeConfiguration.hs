...
mkVolumeConfiguration
    :: Core.Text -- ^ 'mountPoint'
    -> Core.Int -- ^ 'numberOfDisks'
    -> Core.Int -- ^ 'size'
    -> VolumeConfiguration
mkVolumeConfiguration mountPoint numberOfDisks size
  = VolumeConfiguration'{mountPoint, numberOfDisks, size,
                         encrypted = Core.Nothing, iops = Core.Nothing,
                         raidLevel = Core.Nothing, volumeType = Core.Nothing}
...
vcMountPoint :: Lens.Lens' VolumeConfiguration Core.Text
vcMountPoint = Lens.field @"mountPoint"
{-# INLINEABLE vcMountPoint #-}
...
vcVolumeType :: Lens.Lens' VolumeConfiguration (Core.Maybe Core.Text)
vcVolumeType = Lens.field @"volumeType"
{-# INLINEABLE vcVolumeType #-}
...
instance Core.FromJSON VolumeConfiguration where
        parseJSON
          = Core.withObject "VolumeConfiguration" Core.$
              \ x ->
                VolumeConfiguration' Core.<$>
                  (x Core..: "MountPoint") Core.<*> x Core..: "NumberOfDisks"
                    Core.<*> x Core..: "Size"
