...
aiaAuthParameters :: Lens' AdminInitiateAuth (Maybe (HashMap Text (Text)))
aiaAuthParameters = lens _aiaAuthParameters (\s a -> s {_aiaAuthParameters = a}) . mapping (_Sensitive . _Map)
