  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "GameLift.CreateBuild")
...
{-# DEPRECATED cbrrsBuild "Use generic-lens or generic-optics with 'build' instead." #-}
...
{-# DEPRECATED cbrrsStorageLocation "Use generic-lens or generic-optics with 'storageLocation' instead." #-}
...
{-# DEPRECATED cbrrsUploadCredentials "Use generic-lens or generic-optics with 'uploadCredentials' instead." #-}
