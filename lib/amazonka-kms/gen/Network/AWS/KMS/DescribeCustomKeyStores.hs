  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "TrentService.DescribeCustomKeyStores")
...
{-# DEPRECATED drsCustomKeyStores "Use generic-lens or generic-optics with 'customKeyStores' instead." #-}
...
{-# DEPRECATED drsTruncated "Use generic-lens or generic-optics with 'truncated' instead." #-}
