...
instance Pager.AWSPager ListFargateProfiles where
  page rq rs
    | Pager.stop
        ( rs
...
instance Prelude.AWSRequest ListFargateProfiles where
  type
    Rs ListFargateProfiles =
      ListFargateProfilesResponse
    ...
    Response.receiveJSON
      ( \s h x ->
          ListFargateProfilesResponse'
            ...
            Prelude.<*> ( x Prelude..?> "fargateProfileNames"
...
instance Prelude.ToHeaders ListFargateProfiles where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath ListFargateProfiles where
...
instance Prelude.ToQuery ListFargateProfiles where
...
listFargateProfilesResponse_fargateProfileNames = Lens.lens (\ListFargateProfilesResponse' {fargateProfileNames} -> fargateProfileNames) (\s@ListFargateProfilesResponse' {} a -> s {fargateProfileNames = a} :: ListFargateProfilesResponse) Prelude.. Lens.mapping Prelude._Coerce
