...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Route53",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "route53",
                 Core._svcVersion = "2013-04-01", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _HealthCheckVersionMismatch #-}
...
{-# INLINEABLE _NoSuchQueryLoggingConfig #-}
...
{-# INLINEABLE _HostedZoneNotPrivate #-}
...
{-# INLINEABLE _HostedZoneNotEmpty #-}
...
_TrafficPolicyInstanceAlreadyExists
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _TrafficPolicyInstanceAlreadyExists #-}
...
_ConflictingTypes
  = Core._MatchServiceError mkServiceConfig "ConflictingTypes" Core..
      Core.hasStatues 400
{-# INLINEABLE _ConflictingTypes #-}
...
_QueryLoggingConfigAlreadyExists
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _QueryLoggingConfigAlreadyExists #-}
...
_ConcurrentModification
  = Core._MatchServiceError mkServiceConfig "ConcurrentModification"
      Core.. Core.hasStatues 400
{-# INLINEABLE _ConcurrentModification #-}
...
{-# INLINEABLE _DelegationSetAlreadyReusable #-}
...
_InsufficientCloudWatchLogsResourcePolicy
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _InsufficientCloudWatchLogsResourcePolicy #-}
...
_NoSuchCloudWatchLogsLogGroup
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 404
{-# INLINEABLE _NoSuchCloudWatchLogsLogGroup #-}
...
_PriorRequestNotComplete
  = Core._MatchServiceError mkServiceConfig "PriorRequestNotComplete"
      Core.. Core.hasStatues 400
{-# INLINEABLE _PriorRequestNotComplete #-}
...
{-# INLINEABLE _InvalidChangeBatch #-}
...
_TooManyVPCAssociationAuthorizations
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _TooManyVPCAssociationAuthorizations #-}
...
_TrafficPolicyAlreadyExists
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _TrafficPolicyAlreadyExists #-}
...
_InvalidTrafficPolicyDocument
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidTrafficPolicyDocument #-}
...
_InvalidPaginationToken
  = Core._MatchServiceError mkServiceConfig "InvalidPaginationToken"
      Core.. Core.hasStatues 400
{-# INLINEABLE _InvalidPaginationToken #-}
...
{-# INLINEABLE _DelegationSetNotReusable #-}
...
_NoSuchTrafficPolicy
  = Core._MatchServiceError mkServiceConfig "NoSuchTrafficPolicy"
      Core.. Core.hasStatues 404
{-# INLINEABLE _NoSuchTrafficPolicy #-}
...
{-# INLINEABLE _HostedZoneNotFound #-}
...
{-# INLINEABLE _DelegationSetInUse #-}
...
{-# INLINEABLE _NoSuchDelegationSet #-}
...
_HealthCheckAlreadyExists
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _HealthCheckAlreadyExists #-}
...
_TooManyTrafficPolicies
  = Core._MatchServiceError mkServiceConfig "TooManyTrafficPolicies"
      Core.. Core.hasStatues 400
{-# INLINEABLE _TooManyTrafficPolicies #-}
...
_VPCAssociationAuthorizationNotFound
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 404
{-# INLINEABLE _VPCAssociationAuthorizationNotFound #-}
...
{-# INLINEABLE _DelegationSetNotAvailable #-}
...
_VPCAssociationNotFound
  = Core._MatchServiceError mkServiceConfig "VPCAssociationNotFound"
      Core.. Core.hasStatues 404
{-# INLINEABLE _VPCAssociationNotFound #-}
...
_NoSuchChange
  = Core._MatchServiceError mkServiceConfig "NoSuchChange" Core..
      Core.hasStatues 404
{-# INLINEABLE _NoSuchChange #-}
...
_TooManyTrafficPolicyInstances
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _TooManyTrafficPolicyInstances #-}
...
_NoSuchTrafficPolicyInstance
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 404
{-# INLINEABLE _NoSuchTrafficPolicyInstance #-}
...
_IncompatibleVersion
  = Core._MatchServiceError mkServiceConfig "IncompatibleVersion"
      Core.. Core.hasStatues 400
{-# INLINEABLE _IncompatibleVersion #-}
...
_PublicZoneVPCAssociation
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _PublicZoneVPCAssociation #-}
...
_NoSuchHostedZone
  = Core._MatchServiceError mkServiceConfig "NoSuchHostedZone" Core..
      Core.hasStatues 404
{-# INLINEABLE _NoSuchHostedZone #-}
...
_TooManyHostedZones
  = Core._MatchServiceError mkServiceConfig "TooManyHostedZones"
      Core.. Core.hasStatues 400
{-# INLINEABLE _TooManyHostedZones #-}
...
_HealthCheckInUse
  = Core._MatchServiceError mkServiceConfig "HealthCheckInUse" Core..
      Core.hasStatues 400
{-# INLINEABLE _HealthCheckInUse #-}
...
{-# INLINEABLE _DelegationSetAlreadyCreated #-}
...
{-# INLINEABLE _ConflictingDomainExists #-}
...
_LastVPCAssociation
  = Core._MatchServiceError mkServiceConfig "LastVPCAssociation"
      Core.. Core.hasStatues 400
{-# INLINEABLE _LastVPCAssociation #-}
...
{-# INLINEABLE _TooManyHealthChecks #-}
...
_TrafficPolicyInUse
  = Core._MatchServiceError mkServiceConfig "TrafficPolicyInUse"
      Core.. Core.hasStatues 400
{-# INLINEABLE _TrafficPolicyInUse #-}
...
_InvalidVPCId
  = Core._MatchServiceError mkServiceConfig "InvalidVPCId" Core..
      Core.hasStatues 400
{-# INLINEABLE _InvalidVPCId #-}
...
_HostedZoneAlreadyExists
  = Core._MatchServiceError mkServiceConfig "HostedZoneAlreadyExists"
      Core.. Core.hasStatues 409
{-# INLINEABLE _HostedZoneAlreadyExists #-}
...
_TooManyTrafficPolicyVersionsForCurrentPolicy
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _TooManyTrafficPolicyVersionsForCurrentPolicy #-}
