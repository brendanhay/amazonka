...
mkSolutionStackDescription
    :: SolutionStackDescription
mkSolutionStackDescription
  = SolutionStackDescription'{permittedFileTypes = Core.Nothing,
...
{-# INLINEABLE ssdPermittedFileTypes #-}
{-# DEPRECATED permittedFileTypes "Use generic-lens or generic-optics with 'permittedFileTypes' instead"  #-}
...
{-# INLINEABLE ssdSolutionStackName #-}
...
instance Core.FromXML SolutionStackDescription where
        parseXML x
          = SolutionStackDescription' Core.<$>
              (x Core..@? "PermittedFileTypes" Core..<@>
