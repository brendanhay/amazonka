...
data ServiceSpecificCredential = ServiceSpecificCredential'
  { -- | The date and time, in
    ...
    servicePassword :: Core.Sensitive Core.Text,
...
-- <http://www.iso.org/iso/iso8601 ISO 8601 date-time format>, when the
-- service-specific credential were created.
serviceSpecificCredential_createDate :: Lens.Lens' ServiceSpecificCredential Core.UTCTime
serviceSpecificCredential_createDate = Lens.lens (\ServiceSpecificCredential' {createDate} -> createDate) (\s@ServiceSpecificCredential' {} a -> s {createDate = a} :: ServiceSpecificCredential) Core.. Core._Time

-- | The name of the service associated with the service-specific credential.
serviceSpecificCredential_serviceName :: Lens.Lens' ServiceSpecificCredential Core.Text
...
-- number of the AWS account, as in @jane-at-123456789012@, for example.
-- This value cannot be configured by the user.
serviceSpecificCredential_serviceUserName :: Lens.Lens' ServiceSpecificCredential Core.Text
...
-- | The generated password for the service-specific credential.
serviceSpecificCredential_servicePassword :: Lens.Lens' ServiceSpecificCredential Core.Text
serviceSpecificCredential_servicePassword = Lens.lens (\ServiceSpecificCredential' {servicePassword} -> servicePassword) (\s@ServiceSpecificCredential' {} a -> s {servicePassword = a} :: ServiceSpecificCredential) Core.. Core._Sensitive

-- | The unique identifier for the service-specific credential.
serviceSpecificCredential_serviceSpecificCredentialId :: Lens.Lens' ServiceSpecificCredential Core.Text
...
-- | The name of the IAM user associated with the service-specific
-- credential.
serviceSpecificCredential_userName :: Lens.Lens' ServiceSpecificCredential Core.Text
...
instance Core.Hashable ServiceSpecificCredential

instance Core.NFData ServiceSpecificCredential
