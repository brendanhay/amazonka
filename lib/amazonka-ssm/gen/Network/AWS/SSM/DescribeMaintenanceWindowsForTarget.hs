...
mkDescribeMaintenanceWindowsForTarget resourceType
  = DescribeMaintenanceWindowsForTarget'{targets = Core.mempty,
                                         resourceType, maxResults = Core.Nothing,
...
{-# INLINEABLE dmwftNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery DescribeMaintenanceWindowsForTarget where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeMaintenanceWindowsForTarget where
        toHeaders DescribeMaintenanceWindowsForTarget{..}
          = Core.pure
...
instance Core.AWSRequest DescribeMaintenanceWindowsForTarget where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeMaintenanceWindowsForTargetResponse' Core.<$>
...
mkDescribeMaintenanceWindowsForTargetResponse responseStatus
  = DescribeMaintenanceWindowsForTargetResponse'{nextToken =
                                                   Core.Nothing,
...
{-# INLINEABLE dmwftrrsWindowIdentities #-}
...
{-# INLINEABLE dmwftrrsResponseStatus #-}
