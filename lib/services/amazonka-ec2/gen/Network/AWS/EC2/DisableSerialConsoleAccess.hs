...
-- |
-- Module      : Network.AWS.EC2.DisableSerialConsoleAccess
...
instance Prelude.Hashable DisableSerialConsoleAccess

instance Prelude.NFData DisableSerialConsoleAccess
