...
mkModuleInfo
    :: ModuleInfo
mkModuleInfo
  = ModuleInfo'{logicalIdHierarchy = Core.Nothing,
...
{-# INLINEABLE miLogicalIdHierarchy #-}
{-# DEPRECATED logicalIdHierarchy "Use generic-lens or generic-optics with 'logicalIdHierarchy' instead"  #-}
...
{-# INLINEABLE miTypeHierarchy #-}
{-# DEPRECATED typeHierarchy "Use generic-lens or generic-optics with 'typeHierarchy' instead"  #-}

instance Core.FromXML ModuleInfo where
        parseXML x
          = ModuleInfo' Core.<$>
              (x Core..@? "LogicalIdHierarchy") Core.<*>
                x Core..@? "TypeHierarchy"
