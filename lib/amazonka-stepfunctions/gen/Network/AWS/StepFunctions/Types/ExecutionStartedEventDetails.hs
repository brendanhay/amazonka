...
mkExecutionStartedEventDetails
    :: ExecutionStartedEventDetails
mkExecutionStartedEventDetails
  = ExecutionStartedEventDetails'{input = Core.Nothing,
                                  inputDetails = Core.Nothing, roleArn = Core.Nothing}
...
instance Core.FromJSON ExecutionStartedEventDetails where
        parseJSON
          = Core.withObject "ExecutionStartedEventDetails" Core.$
              \ x ->
                ExecutionStartedEventDetails' Core.<$>
                  (x Core..:? "input") Core.<*> x Core..:? "inputDetails" Core.<*>
                    x Core..:? "roleArn"
