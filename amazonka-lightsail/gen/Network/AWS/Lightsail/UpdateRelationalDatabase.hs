...
data UpdateRelationalDatabase = UpdateRelationalDatabase'
  { _urdMasterUserPassword         :: !(Maybe (Sensitive Text))
  , _urdPubliclyAccessible         :: !(Maybe Bool)
  , _urdEnableBackupRetention      :: !(Maybe Bool)
  , _urdPreferredMaintenanceWindow :: !(Maybe Text)
  , _urdPreferredBackupWindow      :: !(Maybe Text)
  , _urdApplyImmediately           :: !(Maybe Bool)
  , _urdRotateMasterUserPassword   :: !(Maybe Bool)
  , _urdDisableBackupRetention     :: !(Maybe Bool)
...
data UpdateRelationalDatabaseResponse = UpdateRelationalDatabaseResponse'
  { _urdrsOperations     :: !(Maybe [Operation])
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'urdrsOperations' - An object describing the result of your update relational database request.
--
...
updateRelationalDatabaseResponse pResponseStatus_ =
  UpdateRelationalDatabaseResponse'
    {_urdrsOperations = Nothing, _urdrsResponseStatus = pResponseStatus_}
