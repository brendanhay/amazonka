...
mkProjection
    :: Projection
mkProjection
  = Projection'{nonKeyAttributes = Core.Nothing,
...
{-# INLINEABLE pNonKeyAttributes #-}
{-# DEPRECATED nonKeyAttributes "Use generic-lens or generic-optics with 'nonKeyAttributes' instead"  #-}
...
{-# INLINEABLE pProjectionType #-}
{-# DEPRECATED projectionType "Use generic-lens or generic-optics with 'projectionType' instead"  #-}
...
instance Core.FromJSON Projection where
        parseJSON
          = Core.withObject "Projection" Core.$
              \ x ->
                Projection' Core.<$>
                  (x Core..:? "NonKeyAttributes") Core.<*>
                    x Core..:? "ProjectionType"
