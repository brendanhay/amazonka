...
newCorsRule pAllowedOrigins_ =
  CorsRule'
    { allowedMethods = Prelude.Nothing,
      ...
      allowedOrigins =
        Prelude._Coerce Lens.# pAllowedOrigins_,
...
corsRule_allowedMethods = Lens.lens (\CorsRule' {allowedMethods} -> allowedMethods) (\s@CorsRule' {} a -> s {allowedMethods = a} :: CorsRule) Prelude.. Lens.mapping Prelude._Coerce
