...
instance Core.AWSRequest BatchPutMessage where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         Core._rqMethod = Request.POST, Core._rqPath = "/messages/batch",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 BatchPutMessageResponse' Core.<$>
                   (x Core..:? "batchPutMessageErrorEntries") Core.<*>
...
{-# INLINEABLE bpmrrsBatchPutMessageErrorEntries #-}
{-# DEPRECATED batchPutMessageErrorEntries "Use generic-lens or generic-optics with 'batchPutMessageErrorEntries' instead"  #-}
...
{-# INLINEABLE bpmrrsResponseStatus #-}
