...
{-# INLINEABLE rprsTotalEstimatedMonthlySavingsAmount #-}
{-# DEPRECATED totalEstimatedMonthlySavingsAmount "Use generic-lens or generic-optics with 'totalEstimatedMonthlySavingsAmount' instead"  #-}
...
{-# INLINEABLE rprsTotalEstimatedMonthlySavingsPercentage #-}
{-# DEPRECATED totalEstimatedMonthlySavingsPercentage "Use generic-lens or generic-optics with 'totalEstimatedMonthlySavingsPercentage' instead"  #-}

instance Core.FromJSON ReservationPurchaseRecommendationSummary
         where
        parseJSON
          = Core.withObject "ReservationPurchaseRecommendationSummary" Core.$
              \ x ->
                ReservationPurchaseRecommendationSummary' Core.<$>
                  (x Core..:? "CurrencyCode") Core.<*>
                    x Core..:? "TotalEstimatedMonthlySavingsAmount"
