  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "SageMaker.CreateLabelingJob")
...
{-# DEPRECATED cljrrsLabelingJobArn "Use generic-lens or generic-optics with 'labelingJobArn' instead." #-}
...
{-# DEPRECATED cljrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
