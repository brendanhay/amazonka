...
-- |
-- Module      : Amazonka.Neptune.Types.ClusterPendingModifiedValues
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.Neptune.Types.ClusterPendingModifiedValues where
...
data ClusterPendingModifiedValues = ClusterPendingModifiedValues'
  { -- | The allocated storage size in gibibytes (GiB) for database engines. For
    -- Neptune, @AllocatedStorage@ always returns 1, because Neptune DB cluster
...
--
-- 'allocatedStorage', 'clusterPendingModifiedValues_allocatedStorage' - The allocated storage size in gibibytes (GiB) for database engines. For
-- Neptune, @AllocatedStorage@ always returns 1, because Neptune DB cluster
-- storage size isn\'t fixed, but instead automatically adjusts as needed.
--
...
-- only for non-Aurora Multi-AZ DB clusters.
--
-- 'pendingCloudwatchLogsExports', 'clusterPendingModifiedValues_pendingCloudwatchLogsExports' - This @PendingCloudwatchLogsExports@ structure specifies pending changes
-- to which CloudWatch logs are enabled and which are disabled.
