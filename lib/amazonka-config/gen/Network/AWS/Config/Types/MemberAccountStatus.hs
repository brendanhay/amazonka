...
mkMemberAccountStatus
    ...
    -> Types.MemberAccountRuleStatus -- ^ 'memberAccountRuleStatus'
    -> MemberAccountStatus
mkMemberAccountStatus accountId configRuleName
  memberAccountRuleStatus
  = MemberAccountStatus'{accountId, configRuleName,
                         memberAccountRuleStatus, errorCode = Core.Nothing,
...
{-# INLINEABLE masMemberAccountRuleStatus #-}
{-# DEPRECATED memberAccountRuleStatus "Use generic-lens or generic-optics with 'memberAccountRuleStatus' instead"  #-}

-- | An error code that is returned when config rule creation or deletion failed in the member account.
--
-- /Note:/ Consider using 'errorCode' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
masErrorCode :: Lens.Lens' MemberAccountStatus (Core.Maybe Core.Text)
masErrorCode = Lens.field @"errorCode"
{-# INLINEABLE masErrorCode #-}
{-# DEPRECATED errorCode "Use generic-lens or generic-optics with 'errorCode' instead"  #-}

-- | An error message indicating that config rule account creation or deletion has failed due to an error in the member account.
--
-- /Note:/ Consider using 'errorMessage' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
masErrorMessage :: Lens.Lens' MemberAccountStatus (Core.Maybe Core.Text)
masErrorMessage = Lens.field @"errorMessage"
{-# INLINEABLE masErrorMessage #-}
...
instance Core.FromJSON MemberAccountStatus where
        parseJSON
          = Core.withObject "MemberAccountStatus" Core.$
              \ x ->
                MemberAccountStatus' Core.<$>
                  (x Core..: "AccountId") Core.<*> x Core..: "ConfigRuleName"
