...
import Network.AWS.Athena.Types.StateChangeReason
import Network.AWS.Athena.Types.StatementType
import Network.AWS.Athena.Types.String
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "Athena",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "athena",
      Core._svcVersion = "2017-05-18",
