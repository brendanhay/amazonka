...
mkSearchRecord
    :: SearchRecord
mkSearchRecord
  = SearchRecord'{experiment = Core.Nothing,
                  trainingJob = Core.Nothing, trial = Core.Nothing,
...
{-# INLINEABLE srExperiment #-}
{-# DEPRECATED experiment "Use generic-lens or generic-optics with 'experiment' instead"  #-}
...
{-# INLINEABLE srTrial #-}
{-# DEPRECATED trial "Use generic-lens or generic-optics with 'trial' instead"  #-}
...
{-# INLINEABLE srTrialComponent #-}
{-# DEPRECATED trialComponent "Use generic-lens or generic-optics with 'trialComponent' instead"  #-}
...
instance Core.FromJSON SearchRecord where
        parseJSON
          = Core.withObject "SearchRecord" Core.$
              \ x ->
                SearchRecord' Core.<$>
                  (x Core..:? "Experiment") Core.<*> x Core..:? "TrainingJob"
                    Core.<*> x Core..:? "Trial"
