...
mkCreateFleet name eC2InstanceType =
  CreateFleet'
    { name,
      ...
      eC2InboundPermissions = Core.Nothing,
  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "GameLift.CreateFleet")
...
{-# DEPRECATED cfrrsFleetAttributes "Use generic-lens or generic-optics with 'fleetAttributes' instead." #-}
