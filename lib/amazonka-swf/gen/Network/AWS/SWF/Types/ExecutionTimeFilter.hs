...
mkExecutionTimeFilter
    :: Core.NominalDiffTime -- ^ 'oldestDate'
    -> ExecutionTimeFilter
...
{-# INLINEABLE etfOldestDate #-}
{-# DEPRECATED oldestDate "Use generic-lens or generic-optics with 'oldestDate' instead"  #-}
...
{-# INLINEABLE etfLatestDate #-}
{-# DEPRECATED latestDate "Use generic-lens or generic-optics with 'latestDate' instead"  #-}
