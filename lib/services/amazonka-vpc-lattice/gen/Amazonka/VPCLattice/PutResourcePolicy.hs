...
-- |
-- Module      : Amazonka.VPCLattice.PutResourcePolicy
...
--
-- 'policy', 'putResourcePolicy_policy' - An IAM policy. The policy string in JSON must not contain newlines or
-- blank lines.
--
-- 'resourceArn', 'putResourcePolicy_resourceArn' - The ID or Amazon Resource Name (ARN) of the service network or service
-- for which the policy is created.
newPutResourcePolicy ::
  -- | 'policy'
  Prelude.Text ->
