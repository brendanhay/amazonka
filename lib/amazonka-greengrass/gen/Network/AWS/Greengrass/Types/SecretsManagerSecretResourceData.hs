...
mkSecretsManagerSecretResourceData
    :: SecretsManagerSecretResourceData
mkSecretsManagerSecretResourceData
  = SecretsManagerSecretResourceData'{arn = Core.Nothing,
...
{-# INLINEABLE smsrdAdditionalStagingLabelsToDownload #-}
{-# DEPRECATED additionalStagingLabelsToDownload "Use generic-lens or generic-optics with 'additionalStagingLabelsToDownload' instead"  #-}
...
instance Core.FromJSON SecretsManagerSecretResourceData where
        toJSON SecretsManagerSecretResourceData{..}
          = Core.object
              (Core.catMaybes
                 [("ARN" Core..=) Core.<$> arn,
                  ("AdditionalStagingLabelsToDownload" Core..=) Core.<$>
          ...
          = Core.withObject "SecretsManagerSecretResourceData" Core.$
              \ x ->
                SecretsManagerSecretResourceData' Core.<$>
                  (x Core..:? "ARN") Core.<*>
                    x Core..:? "AdditionalStagingLabelsToDownload"
