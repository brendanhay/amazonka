...
{-# INLINEABLE rcGameSessionActivationTimeoutSeconds #-}
{-# DEPRECATED gameSessionActivationTimeoutSeconds "Use generic-lens or generic-optics with 'gameSessionActivationTimeoutSeconds' instead"  #-}
...
{-# INLINEABLE rcMaxConcurrentGameSessionActivations #-}
{-# DEPRECATED maxConcurrentGameSessionActivations "Use generic-lens or generic-optics with 'maxConcurrentGameSessionActivations' instead"  #-}
...
{-# INLINEABLE rcServerProcesses #-}
{-# DEPRECATED serverProcesses "Use generic-lens or generic-optics with 'serverProcesses' instead"  #-}

instance Core.FromJSON RuntimeConfiguration where
        toJSON RuntimeConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("GameSessionActivationTimeoutSeconds" Core..=) Core.<$>
                    gameSessionActivationTimeoutSeconds,
                  ("MaxConcurrentGameSessionActivations" Core..=) Core.<$>
          ...
          = Core.withObject "RuntimeConfiguration" Core.$
              \ x ->
                RuntimeConfiguration' Core.<$>
                  (x Core..:? "GameSessionActivationTimeoutSeconds") Core.<*>
                    x Core..:? "MaxConcurrentGameSessionActivations"
