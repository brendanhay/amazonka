...
instance AWSRequest DisableTransitGatewayRouteTablePropagation where
  type
...
instance Hashable DisableTransitGatewayRouteTablePropagation

instance NFData DisableTransitGatewayRouteTablePropagation

instance ToHeaders DisableTransitGatewayRouteTablePropagation where
  toHeaders = const mempty

instance ToPath DisableTransitGatewayRouteTablePropagation where
  toPath = const "/"

instance ToQuery DisableTransitGatewayRouteTablePropagation where
  toQuery DisableTransitGatewayRouteTablePropagation' {..} =
    mconcat
      [ "Action"
          =: ("DisableTransitGatewayRouteTablePropagation" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        "DryRun" =: _dtgrtpDryRun,
        "TransitGatewayRouteTableId" =: _dtgrtpTransitGatewayRouteTableId,
        "TransitGatewayAttachmentId" =: _dtgrtpTransitGatewayAttachmentId
      ]
...
disableTransitGatewayRouteTablePropagationResponse pResponseStatus_ =
  DisableTransitGatewayRouteTablePropagationResponse'
    { _dtgrtprsPropagation =
        Nothing,
      _dtgrtprsResponseStatus = pResponseStatus_
    }
...
instance NFData DisableTransitGatewayRouteTablePropagationResponse
