...
mkTopicConfiguration topicArn
  = TopicConfiguration'{topicArn, events = Core.mempty,
...
instance Core.ToXML TopicConfiguration where
        toXML TopicConfiguration{..}
          = Core.toXMLElement "Topic" topicArn Core.<>
...
instance Core.FromXML TopicConfiguration where
        parseXML x
          = TopicConfiguration' Core.<$>
              (x Core..@ "Topic") Core.<*> x Core..@ "Event" Core..@! Core.mempty
                Core.<*> x Core..@? "Filter"
                Core.<*> x Core..@? "Id"
