...
mkFindMatchesParameters
    :: FindMatchesParameters
mkFindMatchesParameters
  = FindMatchesParameters'{accuracyCostTradeoff = Core.Nothing,
...
{-# INLINEABLE fmpAccuracyCostTradeoff #-}
{-# DEPRECATED accuracyCostTradeoff "Use generic-lens or generic-optics with 'accuracyCostTradeoff' instead"  #-}
...
{-# INLINEABLE fmpEnforceProvidedLabels #-}
{-# DEPRECATED enforceProvidedLabels "Use generic-lens or generic-optics with 'enforceProvidedLabels' instead"  #-}
...
{-# INLINEABLE fmpPrecisionRecallTradeoff #-}
{-# DEPRECATED precisionRecallTradeoff "Use generic-lens or generic-optics with 'precisionRecallTradeoff' instead"  #-}
...
{-# INLINEABLE fmpPrimaryKeyColumnName #-}
{-# DEPRECATED primaryKeyColumnName "Use generic-lens or generic-optics with 'primaryKeyColumnName' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("AccuracyCostTradeoff" Core..=) Core.<$> accuracyCostTradeoff,
                  ...
                  ("PrecisionRecallTradeoff" Core..=) Core.<$>
          ...
          = Core.withObject "FindMatchesParameters" Core.$
              \ x ->
                FindMatchesParameters' Core.<$>
                  (x Core..:? "AccuracyCostTradeoff") Core.<*>
                    x Core..:? "EnforceProvidedLabels"
