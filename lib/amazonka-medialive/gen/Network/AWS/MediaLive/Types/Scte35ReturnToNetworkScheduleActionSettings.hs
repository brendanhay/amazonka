...
{-# INLINEABLE srtnsasSpliceEventId #-}
{-# DEPRECATED spliceEventId "Use generic-lens or generic-optics with 'spliceEventId' instead"  #-}

instance Core.FromJSON Scte35ReturnToNetworkScheduleActionSettings
         where
...
instance Core.FromJSON Scte35ReturnToNetworkScheduleActionSettings
         where
        parseJSON
          = Core.withObject "Scte35ReturnToNetworkScheduleActionSettings"
              Core.$
              \ x ->
                Scte35ReturnToNetworkScheduleActionSettings' Core.<$>
                  (x Core..: "spliceEventId")
