...
{-# INLINEABLE dtpCurrentRateInMegaBytesPerSecond #-}
{-# DEPRECATED currentRateInMegaBytesPerSecond "Use generic-lens or generic-optics with 'currentRateInMegaBytesPerSecond' instead"  #-}
...
{-# INLINEABLE dtpDataTransferredInMegaBytes #-}
{-# DEPRECATED dataTransferredInMegaBytes "Use generic-lens or generic-optics with 'dataTransferredInMegaBytes' instead"  #-}
...
{-# INLINEABLE dtpElapsedTimeInSeconds #-}
...
{-# INLINEABLE dtpEstimatedTimeToCompletionInSeconds #-}
...
dtpStatus :: Lens.Lens' DataTransferProgress (Core.Maybe Core.Text)
dtpStatus = Lens.field @"status"
{-# INLINEABLE dtpStatus #-}
...
{-# INLINEABLE dtpTotalDataInMegaBytes #-}
...
instance Core.FromXML DataTransferProgress where
        parseXML x
          = DataTransferProgress' Core.<$>
              (x Core..@? "CurrentRateInMegaBytesPerSecond") Core.<*>
                x Core..@? "DataTransferredInMegaBytes"
