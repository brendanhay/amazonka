...
instance Core.AWSRequest RetrieveTapeArchive where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 RetrieveTapeArchiveResponse' Core.<$>
...
mkRetrieveTapeArchiveResponse responseStatus
  = RetrieveTapeArchiveResponse'{tapeARN = Core.Nothing,
                                 responseStatus}
...
{-# INLINEABLE rtarrsResponseStatus #-}
