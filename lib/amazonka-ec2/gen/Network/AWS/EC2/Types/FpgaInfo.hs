...
{-# INLINEABLE fiFpgas #-}
{-# DEPRECATED fpgas "Use generic-lens or generic-optics with 'fpgas' instead"  #-}
...
{-# INLINEABLE fiTotalFpgaMemoryInMiB #-}
{-# DEPRECATED totalFpgaMemoryInMiB "Use generic-lens or generic-optics with 'totalFpgaMemoryInMiB' instead"  #-}

instance Core.FromXML FpgaInfo where
        parseXML x
          = FpgaInfo' Core.<$>
              (x Core..@? "fpgas" Core..<@> Core.parseXMLList "item") Core.<*>
                x Core..@? "totalFpgaMemoryInMiB"
