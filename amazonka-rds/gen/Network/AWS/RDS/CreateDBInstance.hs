...
--
-- -   Can\'t be set to 0 if the DB instance is a source to read replicas
createDBInstance_backupRetentionPeriod :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
...
-- DB cluster can be deleted even when deletion protection is enabled for
-- the DB cluster.
createDBInstance_deletionProtection :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
-- Not applicable. The encryption for DB instances is managed by the DB
-- cluster.
createDBInstance_storageEncrypted :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
--
-- -   Must be at least 30 minutes.
createDBInstance_preferredBackupWindow :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.html Using Amazon Performance Insights>
-- in the /Amazon Relational Database Service User Guide/.
createDBInstance_enablePerformanceInsights :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
--
-- Default: The default DB security group for the database engine.
createDBInstance_dbSecurityGroups :: Lens.Lens' CreateDBInstance (Core.Maybe [Core.Text])
createDBInstance_dbSecurityGroups = Lens.lens (\CreateDBInstance' {dbSecurityGroups} -> dbSecurityGroups) (\s@CreateDBInstance' {} a -> s {dbSecurityGroups = a} :: CreateDBInstance) Core.. Lens.mapping Lens._Coerce
...
-- <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PIOPS.StorageTypes.html#USER_PIOPS.Autoscaling Managing capacity automatically with Amazon RDS storage autoscaling>
-- in the /Amazon RDS User Guide/.
createDBInstance_maxAllocatedStorage :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
...
-- <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.html IAM Database Authentication for MySQL and PostgreSQL>
-- in the /Amazon RDS User Guide./
createDBInstance_enableIAMDatabaseAuthentication :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
--
-- Possible values are @postgresql@ and @upgrade@.
createDBInstance_enableCloudwatchLogsExports :: Lens.Lens' CreateDBInstance (Core.Maybe [Core.Text])
createDBInstance_enableCloudwatchLogsExports = Lens.lens (\CreateDBInstance' {enableCloudwatchLogsExports} -> enableCloudwatchLogsExports) (\s@CreateDBInstance' {} a -> s {enableCloudwatchLogsExports = a} :: CreateDBInstance) Core.. Lens.mapping Lens._Coerce
...
--
-- Default: @io1@ if the @Iops@ parameter is specified, otherwise @gp2@
createDBInstance_storageType :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
--
-- Valid Values: @0, 1, 5, 10, 15, 30, 60@
createDBInstance_monitoringInterval :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
...
-- can\'t be removed from a DB instance once it is associated with a DB
-- instance
createDBInstance_optionGroupName :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/kerberos-authentication.html Kerberos Authentication>
-- in the /Amazon RDS User Guide/.
createDBInstance_domain :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- If @MonitoringInterval@ is set to a value other than 0, then you must
-- supply a @MonitoringRoleArn@ value.
createDBInstance_monitoringRoleArn :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
--
-- If there is no DB subnet group, then it is a non-VPC DB instance.
createDBInstance_dbSubnetGroupName :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- | The name of the NCHAR character set for the Oracle DB instance.
createDBInstance_ncharCharacterSetName :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
--
-- Constraints: Must contain from 8 to 128 characters.
createDBInstance_masterUserPassword :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
--
-- -   Can\'t be a reserved word for the chosen database engine.
createDBInstance_masterUsername :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- You can\'t set the @AvailabilityZone@ parameter if the DB instance is a
-- Multi-AZ deployment.
createDBInstance_multiAZ :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
-- -   If the subnets are part of a VPC that has an Internet gateway
--     attached to it, the DB instance is public.
createDBInstance_publiclyAccessible :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
-- Default: The default EC2 VPC security group for the DB subnet group\'s
-- VPC.
createDBInstance_vpcSecurityGroupIds :: Lens.Lens' CreateDBInstance (Core.Maybe [Core.Text])
createDBInstance_vpcSecurityGroupIds = Lens.lens (\CreateDBInstance' {vpcSecurityGroupIds} -> vpcSecurityGroupIds) (\s@CreateDBInstance' {} a -> s {vpcSecurityGroupIds = a} :: CreateDBInstance) Core.. Lens.mapping Lens._Coerce
...
-- account. Your AWS account has a different default CMK for each AWS
-- Region.
createDBInstance_performanceInsightsKMSKeyId :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- default CMK for your AWS account. Your AWS account has a different
-- default CMK for each AWS Region.
createDBInstance_kmsKeyId :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
--
-- -   Can\'t end with a hyphen or contain two consecutive hyphens
createDBInstance_dbParameterGroupName :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- For more information about RDS on VMware, see the
-- <https://docs.aws.amazon.com/AmazonRDS/latest/RDSonVMwareUserGuide/rds-on-vmware.html RDS on VMware User Guide.>
createDBInstance_availabilityZone :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- | The identifier of the DB cluster that the instance will belong to.
createDBInstance_dbClusterIdentifier :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_PostgreSQL.html#PostgreSQL.Concepts Amazon RDS for PostgreSQL versions and extensions>
-- in the /Amazon RDS User Guide./
createDBInstance_engineVersion :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
--
-- Constraints: Minimum 30-minute window.
createDBInstance_preferredMaintenanceWindow :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- Not applicable. The character set is managed by the DB cluster. For more
-- information, see @CreateDBCluster@.
createDBInstance_characterSetName :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- | The amount of time, in days, to retain Performance Insights data. Valid
-- values are 7 or 731 (2 years).
createDBInstance_performanceInsightsRetentionPeriod :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
...
-- Valid values: @license-included@ | @bring-your-own-license@ |
-- @general-public-license@
createDBInstance_licenseModel :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- | The password for the given ARN from the key store in order to access the
-- device.
createDBInstance_tdeCredentialPassword :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
--
-- Valid Values: 0 - 15
createDBInstance_promotionTier :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
...
-- | Tags to assign to the DB instance.
createDBInstance_tags :: Lens.Lens' CreateDBInstance (Core.Maybe [Tag])
createDBInstance_tags = Lens.lens (\CreateDBInstance' {tags} -> tags) (\s@CreateDBInstance' {} a -> s {tags = a} :: CreateDBInstance) Core.. Lens.mapping Lens._Coerce

-- | The number of CPU cores and the number of threads per core for the DB
-- instance class of the DB instance.
createDBInstance_processorFeatures :: Lens.Lens' CreateDBInstance (Core.Maybe [ProcessorFeature])
createDBInstance_processorFeatures = Lens.lens (\CreateDBInstance' {processorFeatures} -> processorFeatures) (\s@CreateDBInstance' {} a -> s {processorFeatures = a} :: CreateDBInstance) Core.. Lens.mapping Lens._Coerce
...
--
-- Type: Integer
createDBInstance_port :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
...
--
-- -   It can\'t be a word reserved by the database engine.
createDBInstance_dbName :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
createDBInstance_dbName = Lens.lens (\CreateDBInstance' {dbName} -> dbName) (\s@CreateDBInstance' {} a -> s {dbName = a} :: CreateDBInstance)

-- | Specify the name of the IAM role to be used when making API calls to the
-- Directory Service.
createDBInstance_domainIAMRoleName :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- | The ARN from the key store with which to associate the instance for TDE
-- encryption.
createDBInstance_tdeCredentialArn :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- <https://docs.aws.amazon.com/outposts/latest/userguide/outposts-networking-components.html#ip-addressing Customer-owned IP addresses>
-- in the /AWS Outposts User Guide/.
createDBInstance_enableCustomerOwnedIp :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
-- supported only by
-- <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_SQLServer.html#SQLServer.Concepts.General.TimeZone Microsoft SQL Server>.
createDBInstance_timezone :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Text)
...
-- Setting this value for an Aurora DB instance has no effect on the DB
-- cluster setting.
createDBInstance_copyTagsToSnapshot :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
--
--     -   Web and Express editions: Must be an integer from 20 to 1024.
createDBInstance_allocatedStorage :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
...
-- instance. For SQL Server DB instances, must be a multiple between 1 and
-- 50 of the storage amount for the DB instance.
createDBInstance_iops :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Int)
createDBInstance_iops = Lens.lens (\CreateDBInstance' {iops} -> iops) (\s@CreateDBInstance' {} a -> s {iops = a} :: CreateDBInstance)

-- | A value that indicates whether minor engine upgrades are applied
-- automatically to the DB instance during the maintenance window. By
-- default, minor engine upgrades are applied automatically.
createDBInstance_autoMinorVersionUpgrade :: Lens.Lens' CreateDBInstance (Core.Maybe Core.Bool)
...
--
-- Example: @mydbinstance@
createDBInstance_dbInstanceIdentifier :: Lens.Lens' CreateDBInstance Core.Text
...
-- <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.html DB Instance Class>
-- in the /Amazon RDS User Guide./
createDBInstance_dbInstanceClass :: Lens.Lens' CreateDBInstance Core.Text
...
--
-- -   @sqlserver-web@
createDBInstance_engine :: Lens.Lens' CreateDBInstance Core.Text
...
instance Core.Hashable CreateDBInstance

instance Core.NFData CreateDBInstance
...
instance Core.ToQuery CreateDBInstance where
  toQuery CreateDBInstance' {..} =
    Core.mconcat
      [ "Action"
          Core.=: ("CreateDBInstance" :: Core.ByteString),
...
-- | Undocumented member.
createDBInstanceResponse_dbInstance :: Lens.Lens' CreateDBInstanceResponse (Core.Maybe DBInstance)
...
-- | The response's http status code.
createDBInstanceResponse_httpStatus :: Lens.Lens' CreateDBInstanceResponse Core.Int
...
instance Core.NFData CreateDBInstanceResponse
