...
mkCustomErrorResponse errorCode
  = CustomErrorResponse'{errorCode,
                         errorCachingMinTTL = Core.Nothing, responseCode = Core.Nothing,
...
{-# INLINEABLE cerErrorCachingMinTTL #-}
{-# DEPRECATED errorCachingMinTTL "Use generic-lens or generic-optics with 'errorCachingMinTTL' instead"  #-}
...
cerResponseCode :: Lens.Lens' CustomErrorResponse (Core.Maybe Core.Text)
cerResponseCode = Lens.field @"responseCode"
{-# INLINEABLE cerResponseCode #-}
...
cerResponsePagePath :: Lens.Lens' CustomErrorResponse (Core.Maybe Core.Text)
cerResponsePagePath = Lens.field @"responsePagePath"
{-# INLINEABLE cerResponsePagePath #-}
{-# DEPRECATED responsePagePath "Use generic-lens or generic-optics with 'responsePagePath' instead"  #-}

instance Core.ToXML CustomErrorResponse where
        toXML CustomErrorResponse{..}
          = Core.toXMLElement "ErrorCode" errorCode Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "ErrorCachingMinTTL")
                errorCachingMinTTL
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "ResponseCode")
                responseCode
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "ResponsePagePath")
                responsePagePath

instance Core.FromXML CustomErrorResponse where
        parseXML x
          = CustomErrorResponse' Core.<$>
              (x Core..@ "ErrorCode") Core.<*> x Core..@? "ErrorCachingMinTTL"
