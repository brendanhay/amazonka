...
mkHumanLoopRequestSource
    :: Types.AwsManagedHumanLoopRequestSource -- ^ 'awsManagedHumanLoopRequestSource'
    -> HumanLoopRequestSource
...
{-# INLINEABLE hlrsAwsManagedHumanLoopRequestSource #-}
{-# DEPRECATED awsManagedHumanLoopRequestSource "Use generic-lens or generic-optics with 'awsManagedHumanLoopRequestSource' instead"  #-}
...
instance Core.FromJSON HumanLoopRequestSource where
        toJSON HumanLoopRequestSource{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just
                    ("AwsManagedHumanLoopRequestSource" Core..=
          ...
          = Core.withObject "HumanLoopRequestSource" Core.$
              \ x ->
                HumanLoopRequestSource' Core.<$>
                  (x Core..: "AwsManagedHumanLoopRequestSource")
