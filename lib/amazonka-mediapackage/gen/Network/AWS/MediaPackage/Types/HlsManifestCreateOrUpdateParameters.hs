...
mkHlsManifestCreateOrUpdateParameters id
  = HlsManifestCreateOrUpdateParameters'{id,
                                         adMarkers = Core.Nothing, adTriggers = Core.Nothing,
...
{-# INLINEABLE hmcoupAdsOnDeliveryRestrictions #-}
...
{-# INLINEABLE hmcoupIncludeIframeOnlyStream #-}
...
{-# INLINEABLE hmcoupPlaylistWindowSeconds #-}
...
{-# INLINEABLE hmcoupProgramDateTimeIntervalSeconds #-}
