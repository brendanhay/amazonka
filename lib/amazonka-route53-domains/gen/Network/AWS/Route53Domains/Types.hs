...
import Network.AWS.Route53Domains.Types.Availability
...
import Network.AWS.Route53Domains.Types.String
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "Route53Domains",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "route53domains",
      Core._svcVersion = "2014-05-15",
