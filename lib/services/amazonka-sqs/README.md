...
`2.0` - Derived from API version @2012-11-05@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.SQS](http://hackage.haskell.org/package/amazonka-sqs/docs/Network-AWS-SQS.html)
