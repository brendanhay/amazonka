...
mkSavingsPlansUtilizationByTime timePeriod utilization
  = SavingsPlansUtilizationByTime'{timePeriod, utilization,
...
{-# INLINEABLE spubtAmortizedCommitment #-}
...
instance Core.FromJSON SavingsPlansUtilizationByTime where
        parseJSON
          = Core.withObject "SavingsPlansUtilizationByTime" Core.$
              \ x ->
                SavingsPlansUtilizationByTime' Core.<$>
                  (x Core..: "TimePeriod") Core.<*> x Core..: "Utilization" Core.<*>
                    x Core..:? "AmortizedCommitment"
                    Core.<*> x Core..:? "Savings"
