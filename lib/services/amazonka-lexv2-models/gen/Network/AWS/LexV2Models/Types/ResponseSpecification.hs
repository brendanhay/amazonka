...
-- |
-- Module      : Network.AWS.LexV2Models.Types.ResponseSpecification
-- Copyright   : (c) 2013-2021 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Network.AWS.LexV2Models.Types.ResponseSpecification where
...
instance Core.FromJSON ResponseSpecification where
  parseJSON =
    Core.withObject
      "ResponseSpecification"
      ( \x ->
...
instance Prelude.Hashable ResponseSpecification

instance Prelude.NFData ResponseSpecification

instance Core.ToJSON ResponseSpecification where
