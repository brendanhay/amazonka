...
mkHlsAkamaiSettings
    :: HlsAkamaiSettings
mkHlsAkamaiSettings
  = HlsAkamaiSettings'{connectionRetryInterval = Core.Nothing,
                       filecacheDuration = Core.Nothing, httpTransferMode = Core.Nothing,
                       numRetries = Core.Nothing, restartDelay = Core.Nothing,
                       salt = Core.Nothing, token = Core.Nothing}
...
{-# INLINEABLE hasConnectionRetryInterval #-}
...
{-# INLINEABLE hasFilecacheDuration #-}
...
{-# INLINEABLE hasHttpTransferMode #-}
{-# DEPRECATED httpTransferMode "Use generic-lens or generic-optics with 'httpTransferMode' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("connectionRetryInterval" Core..=) Core.<$>
                  ...
                  ("salt" Core..=) Core.<$> salt, ("token" Core..=) Core.<$> token])
