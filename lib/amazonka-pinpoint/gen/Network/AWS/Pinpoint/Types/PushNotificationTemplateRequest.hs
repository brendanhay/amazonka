...
mkPushNotificationTemplateRequest
    :: PushNotificationTemplateRequest
mkPushNotificationTemplateRequest
  = PushNotificationTemplateRequest'{adm = Core.Nothing,
                                     apns = Core.Nothing, baidu = Core.Nothing,
...
{-# INLINEABLE pDefaultSubstitutions #-}
...
{-# INLINEABLE pTemplateDescription #-}
...
instance Core.FromJSON PushNotificationTemplateRequest where
        toJSON PushNotificationTemplateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("ADM" Core..=) Core.<$> adm, ("APNS" Core..=) Core.<$> apns,
