...
module Network.AWS.SWF.V2012_01_25.RespondActivityTaskFailed where
...
-- | Minimum specification for a 'RespondActivityTaskFailed' request.
respondActivityTaskFailed :: Text -- ^ '_ratfiTaskToken'
...
data RespondActivityTaskFailed = RespondActivityTaskFailed
    ...
    , _ratfiDetails :: Maybe Text
      -- ^ Optional detailed information about the failure.
    , _ratfiReason :: Maybe Text
      -- ^ Description of the error that may assist in diagnostics.
    } deriving (Generic)

makeLenses ''RespondActivityTaskFailed
...
makeLenses ''RespondActivityTaskFailedResponse
