...
mkAnyInstanceInService
  = Waiter.Wait{Waiter._waitName = "AnyInstanceInService",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAny "InService" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"instanceStates" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkInstanceDeregistered
  = Waiter.Wait{Waiter._waitName = "InstanceDeregistered",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "OutOfService" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"instanceStates" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkInstanceInService
  = Waiter.Wait{Waiter._waitName = "InstanceInService",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "InService" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"instanceStates" Core.. Lens._Just Core..
                              Lens.to Core.toList))
