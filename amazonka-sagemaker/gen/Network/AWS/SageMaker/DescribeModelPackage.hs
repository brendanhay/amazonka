...
instance Hashable DescribeModelPackage where

instance NFData DescribeModelPackage where
...
data DescribeModelPackageResponse = DescribeModelPackageResponse'
  { _dmprsSourceAlgorithmSpecification :: !(Maybe SourceAlgorithmSpecification)
  , _dmprsModelPackageDescription :: !(Maybe Text)
  , _dmprsValidationSpecification :: !(Maybe ModelPackageValidationSpecification)
  , _dmprsInferenceSpecification :: !(Maybe InferenceSpecification)
  , _dmprsCertifyForMarketplace :: !(Maybe Bool)
  , _dmprsResponseStatus :: !Int
  , _dmprsModelPackageName :: !Text
  , _dmprsModelPackageARN :: !Text
  , _dmprsCreationTime :: !POSIX
  , _dmprsModelPackageStatus :: !ModelPackageStatus
  , _dmprsModelPackageStatusDetails :: !ModelPackageStatusDetails
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeModelPackageResponse
    ...
    -> Text -- ^ 'dmprsModelPackageName'
    -> Text -- ^ 'dmprsModelPackageARN'
    -> UTCTime -- ^ 'dmprsCreationTime'
    -> ModelPackageStatus -- ^ 'dmprsModelPackageStatus'
    -> ModelPackageStatusDetails -- ^ 'dmprsModelPackageStatusDetails'
    -> DescribeModelPackageResponse
describeModelPackageResponse pResponseStatus_ pModelPackageName_ pModelPackageARN_ pCreationTime_ pModelPackageStatus_ pModelPackageStatusDetails_ =
  DescribeModelPackageResponse'
    { _dmprsSourceAlgorithmSpecification = Nothing
...
instance NFData DescribeModelPackageResponse where
