...
mkOrganizationManagedRuleMetadata
    :: Types.RuleIdentifier -- ^ 'ruleIdentifier'
    -> OrganizationManagedRuleMetadata
...
{-# INLINEABLE omrmRuleIdentifier #-}
{-# DEPRECATED ruleIdentifier "Use generic-lens or generic-optics with 'ruleIdentifier' instead"  #-}
...
{-# INLINEABLE omrmInputParameters #-}
...
{-# INLINEABLE omrmMaximumExecutionFrequency #-}
...
{-# INLINEABLE omrmResourceIdScope #-}
...
{-# INLINEABLE omrmResourceTypesScope #-}
          ...
          = Core.withObject "OrganizationManagedRuleMetadata" Core.$
              \ x ->
                OrganizationManagedRuleMetadata' Core.<$>
                  (x Core..: "RuleIdentifier") Core.<*> x Core..:? "Description"
