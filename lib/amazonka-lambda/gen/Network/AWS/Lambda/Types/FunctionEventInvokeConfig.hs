...
mkFunctionEventInvokeConfig
    :: FunctionEventInvokeConfig
mkFunctionEventInvokeConfig
  = FunctionEventInvokeConfig'{destinationConfig = Core.Nothing,
...
{-# INLINEABLE feicDestinationConfig #-}
...
{-# INLINEABLE feicMaximumEventAgeInSeconds #-}
...
{-# INLINEABLE feicMaximumRetryAttempts #-}
...
instance Core.FromJSON FunctionEventInvokeConfig where
        parseJSON
          = Core.withObject "FunctionEventInvokeConfig" Core.$
              \ x ->
                FunctionEventInvokeConfig' Core.<$>
                  (x Core..:? "DestinationConfig") Core.<*> x Core..:? "FunctionArn"
