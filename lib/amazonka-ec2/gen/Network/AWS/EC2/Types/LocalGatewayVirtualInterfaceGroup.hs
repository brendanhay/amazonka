...
mkLocalGatewayVirtualInterfaceGroup
    :: LocalGatewayVirtualInterfaceGroup
mkLocalGatewayVirtualInterfaceGroup
  = LocalGatewayVirtualInterfaceGroup'{localGatewayId = Core.Nothing,
...
lgvigLocalGatewayId :: Lens.Lens' LocalGatewayVirtualInterfaceGroup (Core.Maybe Core.Text)
lgvigLocalGatewayId = Lens.field @"localGatewayId"
{-# INLINEABLE lgvigLocalGatewayId #-}
...
{-# INLINEABLE lgvigLocalGatewayVirtualInterfaceGroupId #-}
...
{-# INLINEABLE lgvigLocalGatewayVirtualInterfaceIds #-}
...
lgvigOwnerId :: Lens.Lens' LocalGatewayVirtualInterfaceGroup (Core.Maybe Core.Text)
lgvigOwnerId = Lens.field @"ownerId"
{-# INLINEABLE lgvigOwnerId #-}
...
{-# INLINEABLE lgvigTags #-}
{-# DEPRECATED tags "Use generic-lens or generic-optics with 'tags' instead"  #-}

instance Core.FromXML LocalGatewayVirtualInterfaceGroup where
        parseXML x
          = LocalGatewayVirtualInterfaceGroup' Core.<$>
              (x Core..@? "localGatewayId") Core.<*>
                x Core..@? "localGatewayVirtualInterfaceGroupId"
                Core.<*>
                x Core..@? "localGatewayVirtualInterfaceIdSet" Core..<@>
