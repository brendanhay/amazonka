...
newtype BatchDeleteClusterSnapshots = BatchDeleteClusterSnapshots'
  { _bdcsIdentifiers :: [DeleteClusterSnapshotMessage]
...
instance Hashable BatchDeleteClusterSnapshots where

instance NFData BatchDeleteClusterSnapshots where
        ...
        toQuery BatchDeleteClusterSnapshots'{..}
          = mconcat
              ["Action" =:
               ...
               "Identifiers" =:
                 toQueryList "DeleteClusterSnapshotMessage"
                   _bdcsIdentifiers]
...
data BatchDeleteClusterSnapshotsResponse = BatchDeleteClusterSnapshotsResponse'
  { _bdcsrsResources      :: !(Maybe [Text])
  , _bdcsrsErrors         :: !(Maybe [SnapshotErrorMessage])
  , _bdcsrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
