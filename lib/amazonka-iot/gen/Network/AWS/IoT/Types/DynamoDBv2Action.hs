...
{-# INLINEABLE dPutItem #-}
{-# DEPRECATED putItem "Use generic-lens or generic-optics with 'putItem' instead"  #-}
...
instance Core.FromJSON DynamoDBv2Action where
        parseJSON
          = Core.withObject "DynamoDBv2Action" Core.$
              \ x ->
                DynamoDBv2Action' Core.<$>
                  (x Core..: "roleArn") Core.<*> x Core..: "putItem"
