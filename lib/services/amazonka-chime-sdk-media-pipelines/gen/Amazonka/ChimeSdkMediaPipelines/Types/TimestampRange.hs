...
-- |
-- Module      : Amazonka.ChimeSdkMediaPipelines.Types.TimestampRange
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.ChimeSdkMediaPipelines.Types.TimestampRange where
...
--
-- 'startTimestamp', 'timestampRange_startTimestamp' - The starting timestamp for the specified range.
--
-- 'endTimestamp', 'timestampRange_endTimestamp' - The ending timestamp for the specified range.
newTimestampRange ::
  -- | 'startTimestamp'
  Prelude.UTCTime ->
  -- | 'endTimestamp'
...
instance Data.FromJSON TimestampRange where
  parseJSON =
    Data.withObject
      "TimestampRange"
      ( \x ->
