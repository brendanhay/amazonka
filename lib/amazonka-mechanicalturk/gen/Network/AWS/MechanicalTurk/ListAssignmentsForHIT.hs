...
mkListAssignmentsForHIT hITId
  = ListAssignmentsForHIT'{hITId, assignmentStatuses = Core.Nothing,
...
{-# INLINEABLE lafhitAssignmentStatuses #-}
{-# DEPRECATED assignmentStatuses "Use generic-lens or generic-optics with 'assignmentStatuses' instead"  #-}
...
instance Core.ToHeaders ListAssignmentsForHIT where
        toHeaders ListAssignmentsForHIT{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest ListAssignmentsForHIT where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListAssignmentsForHITResponse' Core.<$>
                   (x Core..:? "Assignments") Core.<*> x Core..:? "NextToken" Core.<*>
                     x Core..:? "NumResults"
...
mkListAssignmentsForHITResponse responseStatus
  = ListAssignmentsForHITResponse'{assignments = Core.Nothing,
...
{-# INLINEABLE lafhitrrsAssignments #-}
{-# DEPRECATED assignments "Use generic-lens or generic-optics with 'assignments' instead"  #-}
...
{-# INLINEABLE lafhitrrsNumResults #-}
...
{-# INLINEABLE lafhitrrsResponseStatus #-}
