...
-- |
-- Module      : Network.AWS.LexV2Models.CreateIntent
...
instance Prelude.Hashable CreateIntent

instance Prelude.NFData CreateIntent
...
instance Prelude.NFData CreateIntentResponse
