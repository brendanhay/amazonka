...
-- |
-- Module      : Amazonka.PinpointSmsVoiceV2.Types.MessageType
...
pattern MessageType_PROMOTIONAL = MessageType' "PROMOTIONAL"

pattern MessageType_TRANSACTIONAL :: MessageType
pattern MessageType_TRANSACTIONAL = MessageType' "TRANSACTIONAL"
