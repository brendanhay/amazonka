...
import qualified Network.AWS.WAFRegional.Types.Country as Types
import qualified Network.AWS.WAFRegional.Types.HTTPHeader as Types
import qualified Network.AWS.WAFRegional.Types.HTTPMethod as Types
import qualified Network.AWS.WAFRegional.Types.HTTPVersion as Types
import qualified Network.AWS.WAFRegional.Types.IPString as Types
import qualified Network.AWS.WAFRegional.Types.URI as Types
...
mkHTTPRequest
    :: HTTPRequest
mkHTTPRequest
  = HTTPRequest'{clientIP = Core.Nothing, country = Core.Nothing,
                 hTTPVersion = Core.Nothing, headers = Core.Nothing,
                 method = Core.Nothing, uri = Core.Nothing}
...
instance Core.FromJSON HTTPRequest where
        parseJSON
          = Core.withObject "HTTPRequest" Core.$
              \ x ->
                HTTPRequest' Core.<$>
                  (x Core..:? "ClientIP") Core.<*> x Core..:? "Country" Core.<*>
                    x Core..:? "HTTPVersion"
                    Core.<*> x Core..:? "Headers"
                    Core.<*> x Core..:? "Method"
                    Core.<*> x Core..:? "URI"
