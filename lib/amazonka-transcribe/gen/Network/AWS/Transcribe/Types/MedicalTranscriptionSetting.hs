...
{-# INLINEABLE mtsChannelIdentification #-}
...
{-# INLINEABLE mtsMaxSpeakerLabels #-}
...
{-# INLINEABLE mtsShowAlternatives #-}
...
{-# INLINEABLE mtsShowSpeakerLabels #-}
...
instance Core.FromJSON MedicalTranscriptionSetting where
        parseJSON
          = Core.withObject "MedicalTranscriptionSetting" Core.$
              \ x ->
                MedicalTranscriptionSetting' Core.<$>
