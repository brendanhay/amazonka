...
mkCSVMappingParameters
    :: Types.RecordRowDelimiter -- ^ 'recordRowDelimiter'
    -> Types.RecordColumnDelimiter -- ^ 'recordColumnDelimiter'
    -> CSVMappingParameters
...
{-# INLINEABLE csvmpRecordRowDelimiter #-}
{-# DEPRECATED recordRowDelimiter "Use generic-lens or generic-optics with 'recordRowDelimiter' instead"  #-}
...
{-# INLINEABLE csvmpRecordColumnDelimiter #-}
{-# DEPRECATED recordColumnDelimiter "Use generic-lens or generic-optics with 'recordColumnDelimiter' instead"  #-}
          ...
          = Core.withObject "CSVMappingParameters" Core.$
              \ x ->
                CSVMappingParameters' Core.<$>
                  (x Core..: "RecordRowDelimiter") Core.<*>
                    x Core..: "RecordColumnDelimiter"
