...
mkGroupInformation
    :: GroupInformation
mkGroupInformation
  = GroupInformation'{arn = Core.Nothing,
...
{-# INLINEABLE giCreationTimestamp #-}
...
{-# INLINEABLE giLastUpdatedTimestamp #-}
