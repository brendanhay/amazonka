...
mkCreatePermission
    ...
    -> Core.NonEmpty Types.ActionType -- ^ 'actions'
    -> CreatePermission
mkCreatePermission certificateAuthorityArn principal actions
  = CreatePermission'{certificateAuthorityArn, principal, actions,
...
{-# INLINEABLE cpCertificateAuthorityArn #-}
...
instance Core.AWSRequest CreatePermission where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull CreatePermissionResponse'
