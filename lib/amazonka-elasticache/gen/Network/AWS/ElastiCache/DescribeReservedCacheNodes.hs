...
mkDescribeReservedCacheNodes
    :: DescribeReservedCacheNodes
mkDescribeReservedCacheNodes
  = DescribeReservedCacheNodes'{cacheNodeType = Core.Nothing,
...
drcnCacheNodeType :: Lens.Lens' DescribeReservedCacheNodes (Core.Maybe Core.Text)
drcnCacheNodeType = Lens.field @"cacheNodeType"
{-# INLINEABLE drcnCacheNodeType #-}
...
drcnDuration :: Lens.Lens' DescribeReservedCacheNodes (Core.Maybe Core.Text)
drcnDuration = Lens.field @"duration"
{-# INLINEABLE drcnDuration #-}
{-# DEPRECATED duration "Use generic-lens or generic-optics with 'duration' instead"  #-}

-- | An optional marker returned from a prior request. Use this marker for pagination of results from this operation. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by @MaxRecords@ .
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
drcnMarker :: Lens.Lens' DescribeReservedCacheNodes (Core.Maybe Core.Text)
drcnMarker = Lens.field @"marker"
{-# INLINEABLE drcnMarker #-}
...
drcnOfferingType :: Lens.Lens' DescribeReservedCacheNodes (Core.Maybe Core.Text)
drcnOfferingType = Lens.field @"offeringType"
{-# INLINEABLE drcnOfferingType #-}
...
drcnProductDescription :: Lens.Lens' DescribeReservedCacheNodes (Core.Maybe Core.Text)
drcnProductDescription = Lens.field @"productDescription"
{-# INLINEABLE drcnProductDescription #-}
...
drcnReservedCacheNodeId :: Lens.Lens' DescribeReservedCacheNodes (Core.Maybe Core.Text)
drcnReservedCacheNodeId = Lens.field @"reservedCacheNodeId"
{-# INLINEABLE drcnReservedCacheNodeId #-}
...
drcnReservedCacheNodesOfferingId :: Lens.Lens' DescribeReservedCacheNodes (Core.Maybe Core.Text)
drcnReservedCacheNodesOfferingId = Lens.field @"reservedCacheNodesOfferingId"
{-# INLINEABLE drcnReservedCacheNodesOfferingId #-}
...
instance Core.ToQuery DescribeReservedCacheNodes where
        toQuery DescribeReservedCacheNodes{..}
          = Core.toQueryPair "Action"
              ("DescribeReservedCacheNodes" :: Core.Text)
...
instance Core.AWSRequest DescribeReservedCacheNodes where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "DescribeReservedCacheNodesResult"
              (\ s h x ->
                 DescribeReservedCacheNodesResponse' Core.<$>
                   (x Core..@? "Marker") Core.<*>
                     x Core..@? "ReservedCacheNodes" Core..<@>
                       Core.parseXMLList "ReservedCacheNode"
...
mkDescribeReservedCacheNodesResponse responseStatus
  = DescribeReservedCacheNodesResponse'{marker = Core.Nothing,
                                        reservedCacheNodes = Core.Nothing, responseStatus}

-- | Provides an identifier to allow retrieval of paginated results.
--
-- /Note:/ Consider using 'marker' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
drcnrrsMarker :: Lens.Lens' DescribeReservedCacheNodesResponse (Core.Maybe Core.Text)
drcnrrsMarker = Lens.field @"marker"
{-# INLINEABLE drcnrrsMarker #-}
{-# DEPRECATED marker "Use generic-lens or generic-optics with 'marker' instead"  #-}
...
{-# INLINEABLE drcnrrsReservedCacheNodes #-}
{-# DEPRECATED reservedCacheNodes "Use generic-lens or generic-optics with 'reservedCacheNodes' instead"  #-}
...
{-# INLINEABLE drcnrrsResponseStatus #-}
