...
-- |
-- Module      : Network.AWS.LexV2Models.CreateResourcePolicy
...
instance Prelude.Hashable CreateResourcePolicy

instance Prelude.NFData CreateResourcePolicy
...
instance Prelude.NFData CreateResourcePolicyResponse
