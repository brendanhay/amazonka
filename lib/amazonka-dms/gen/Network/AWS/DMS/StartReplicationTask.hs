...
{-# INLINEABLE srtStartReplicationTaskType #-}
{-# DEPRECATED startReplicationTaskType "Use generic-lens or generic-optics with 'startReplicationTaskType' instead"  #-}
...
srtCdcStartPosition :: Lens.Lens' StartReplicationTask (Core.Maybe Core.Text)
srtCdcStartPosition = Lens.field @"cdcStartPosition"
{-# INLINEABLE srtCdcStartPosition #-}
...
srtCdcStopPosition :: Lens.Lens' StartReplicationTask (Core.Maybe Core.Text)
srtCdcStopPosition = Lens.field @"cdcStopPosition"
{-# INLINEABLE srtCdcStopPosition #-}
...
instance Core.AWSRequest StartReplicationTask where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartReplicationTaskResponse' Core.<$>
...
mkStartReplicationTaskResponse responseStatus
  = StartReplicationTaskResponse'{replicationTask = Core.Nothing,
                                  responseStatus}
...
{-# INLINEABLE srtrrsReplicationTask #-}
...
{-# INLINEABLE srtrrsResponseStatus #-}
