...
{-# INLINEABLE ljdaContentClassifiers #-}
{-# DEPRECATED contentClassifiers "Use generic-lens or generic-optics with 'contentClassifiers' instead"  #-}
...
instance Core.FromJSON LabelingJobDataAttributes where
        parseJSON
          = Core.withObject "LabelingJobDataAttributes" Core.$
              \ x ->
                LabelingJobDataAttributes' Core.<$>
                  (x Core..:? "ContentClassifiers")
