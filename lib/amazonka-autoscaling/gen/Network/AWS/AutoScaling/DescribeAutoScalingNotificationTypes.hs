...
instance Hashable DescribeAutoScalingNotificationTypes

instance NFData DescribeAutoScalingNotificationTypes

instance ToHeaders DescribeAutoScalingNotificationTypes where
...
instance ToQuery DescribeAutoScalingNotificationTypes where
  toQuery =
    const
      ( mconcat
          [ "Action"
              =: ("DescribeAutoScalingNotificationTypes" :: ByteString),
...
data DescribeAutoScalingNotificationTypesResponse = DescribeAutoScalingNotificationTypesResponse'
  { _dasntrsAutoScalingNotificationTypes ::
      !( Maybe
           [Text]
       ),
...
instance NFData DescribeAutoScalingNotificationTypesResponse
