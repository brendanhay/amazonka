...
ubdS3Bucket :: Lens.Lens' UserBucketDetails (Core.Maybe Core.Text)
ubdS3Bucket = Lens.field @"s3Bucket"
{-# INLINEABLE ubdS3Bucket #-}
...
ubdS3Key :: Lens.Lens' UserBucketDetails (Core.Maybe Core.Text)
