...
module Network.AWS.ApplicationAutoScaling.DeleteScalingPolicy
  ( -- * Creating a request
    ...
    -- ** Request lenses
    dspfScalableDimension,
    dspfResourceId,
    dspfPolicyName,
    dspfServiceNamespace,
...
dspfScalableDimension :: Lens.Lens' DeleteScalingPolicy ScalableDimension
dspfScalableDimension = Lens.lens (scalableDimension :: DeleteScalingPolicy -> ScalableDimension) (\s a -> s {scalableDimension = a} :: DeleteScalingPolicy)
{-# DEPRECATED dspfScalableDimension "Use generic-lens or generic-optics with 'scalableDimension' instead." #-}
...
dspfResourceId :: Lens.Lens' DeleteScalingPolicy Lude.Text
dspfResourceId = Lens.lens (resourceId :: DeleteScalingPolicy -> Lude.Text) (\s a -> s {resourceId = a} :: DeleteScalingPolicy)
{-# DEPRECATED dspfResourceId "Use generic-lens or generic-optics with 'resourceId' instead." #-}

-- | The name of the scaling policy.
--
-- /Note:/ Consider using 'policyName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dspfPolicyName :: Lens.Lens' DeleteScalingPolicy Lude.Text
dspfPolicyName = Lens.lens (policyName :: DeleteScalingPolicy -> Lude.Text) (\s a -> s {policyName = a} :: DeleteScalingPolicy)
{-# DEPRECATED dspfPolicyName "Use generic-lens or generic-optics with 'policyName' instead." #-}
...
dspfServiceNamespace :: Lens.Lens' DeleteScalingPolicy ServiceNamespace
dspfServiceNamespace = Lens.lens (serviceNamespace :: DeleteScalingPolicy -> ServiceNamespace) (\s a -> s {serviceNamespace = a} :: DeleteScalingPolicy)
{-# DEPRECATED dspfServiceNamespace "Use generic-lens or generic-optics with 'serviceNamespace' instead." #-}
...
instance Lude.ToHeaders DeleteScalingPolicy where
  toHeaders =
    Lude.const
      ( Lude.mconcat
          [ "X-Amz-Target"
              Lude.=# ("AnyScaleFrontendService.DeleteScalingPolicy" :: Lude.ByteString),
            "Content-Type"
...
mkDeleteScalingPolicyResponse ::
  ...
  Lude.Int ->
  DeleteScalingPolicyResponse
mkDeleteScalingPolicyResponse pResponseStatus_ =
  DeleteScalingPolicyResponse' {responseStatus = pResponseStatus_}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsprsResponseStatus :: Lens.Lens' DeleteScalingPolicyResponse Lude.Int
dsprsResponseStatus = Lens.lens (responseStatus :: DeleteScalingPolicyResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: DeleteScalingPolicyResponse)
