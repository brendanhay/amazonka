...
data CloudHSMObjectState = Updating | Degraded | Ready deriving (Eq, Ord, Read, Show, Enum, Generic)
...
data HSMStatus = HSRunning | HSUpdating | HSTerminated | HSPending | HSTerminating | HSSuspended | HSDegraded deriving (Eq, Ord, Read, Show, Enum, Generic)
...
data SubscriptionType = Production deriving (Eq, Ord, Read, Show, Enum, Generic)
