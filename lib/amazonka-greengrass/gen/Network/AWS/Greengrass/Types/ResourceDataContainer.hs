...
mkResourceDataContainer
    :: ResourceDataContainer
mkResourceDataContainer
  = ResourceDataContainer'{localDeviceResourceData = Core.Nothing,
...
{-# INLINEABLE rdcLocalDeviceResourceData #-}
{-# DEPRECATED localDeviceResourceData "Use generic-lens or generic-optics with 'localDeviceResourceData' instead"  #-}
...
{-# INLINEABLE rdcLocalVolumeResourceData #-}
{-# DEPRECATED localVolumeResourceData "Use generic-lens or generic-optics with 'localVolumeResourceData' instead"  #-}
...
{-# INLINEABLE rdcS3MachineLearningModelResourceData #-}
{-# DEPRECATED s3MachineLearningModelResourceData "Use generic-lens or generic-optics with 's3MachineLearningModelResourceData' instead"  #-}
...
{-# INLINEABLE rdcSageMakerMachineLearningModelResourceData #-}
{-# DEPRECATED sageMakerMachineLearningModelResourceData "Use generic-lens or generic-optics with 'sageMakerMachineLearningModelResourceData' instead"  #-}
...
{-# INLINEABLE rdcSecretsManagerSecretResourceData #-}
{-# DEPRECATED secretsManagerSecretResourceData "Use generic-lens or generic-optics with 'secretsManagerSecretResourceData' instead"  #-}

instance Core.FromJSON ResourceDataContainer where
        toJSON ResourceDataContainer{..}
          = Core.object
              (Core.catMaybes
                 [("LocalDeviceResourceData" Core..=) Core.<$>
                    localDeviceResourceData,
                  ("LocalVolumeResourceData" Core..=) Core.<$>
                    localVolumeResourceData,
                  ("S3MachineLearningModelResourceData" Core..=) Core.<$>
                    s3MachineLearningModelResourceData,
                  ("SageMakerMachineLearningModelResourceData" Core..=) Core.<$>
                    sageMakerMachineLearningModelResourceData,
                  ("SecretsManagerSecretResourceData" Core..=) Core.<$>
...
instance Core.FromJSON ResourceDataContainer where
        parseJSON
          = Core.withObject "ResourceDataContainer" Core.$
              \ x ->
                ResourceDataContainer' Core.<$>
                  (x Core..:? "LocalDeviceResourceData") Core.<*>
                    x Core..:? "LocalVolumeResourceData"
