...
mkOffering
    :: Offering
mkOffering
  = Offering'{arn = Core.Nothing, currencyCode = Core.Nothing,
              duration = Core.Nothing, durationUnits = Core.Nothing,
              fixedPrice = Core.Nothing, offeringDescription = Core.Nothing,
              offeringId = Core.Nothing, offeringType = Core.Nothing,
              region = Core.Nothing, resourceSpecification = Core.Nothing,
...
{-# INLINEABLE oOfferingDescription #-}
...
{-# INLINEABLE oResourceSpecification #-}
