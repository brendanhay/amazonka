...
pattern GetCampaignStateBatchFailureCode_ResourceNotFound = GetCampaignStateBatchFailureCode' "ResourceNotFound"

pattern GetCampaignStateBatchFailureCode_UnknownError :: GetCampaignStateBatchFailureCode
pattern GetCampaignStateBatchFailureCode_UnknownError = GetCampaignStateBatchFailureCode' "UnknownError"
