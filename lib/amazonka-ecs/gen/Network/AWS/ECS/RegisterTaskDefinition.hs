...
rtdFamily :: Lens.Lens' RegisterTaskDefinition Types.String
...
rtdCpu :: Lens.Lens' RegisterTaskDefinition (Core.Maybe Types.String)
...
rtdExecutionRoleArn :: Lens.Lens' RegisterTaskDefinition (Core.Maybe Types.String)
...
rtdMemory :: Lens.Lens' RegisterTaskDefinition (Core.Maybe Types.String)
...
rtdTaskRoleArn :: Lens.Lens' RegisterTaskDefinition (Core.Maybe Types.String)
...
{-# DEPRECATED rtdrrsTags "Use generic-lens or generic-optics with 'tags' instead." #-}
...
{-# DEPRECATED rtdrrsTaskDefinition "Use generic-lens or generic-optics with 'taskDefinition' instead." #-}
...
{-# DEPRECATED rtdrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
