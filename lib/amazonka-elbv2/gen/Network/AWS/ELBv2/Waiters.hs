...
mkLoadBalancersDeleted
  = Waiter.Wait{Waiter._waitName = "LoadBalancersDeleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "active" Waiter.AcceptRetry
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"loadBalancers" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core..
                        Lens.field @"state" Core.. Lens._Just Core..
...
mkTargetDeregistered
  = Waiter.Wait{Waiter._waitName = "TargetDeregistered",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchError "InvalidTarget" Waiter.AcceptSuccess,
                   Waiter.matchAll "unused" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"targetHealthDescriptions" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core..
                        Lens.field @"targetHealth" Core.. Lens._Just Core..
                          Lens.field @"state" Core.. Lens._Just)]}

-- | Polls 'Network.AWS.ELBv2.DescribeLoadBalancers' every 15 seconds until a successful state is reached. An error is returned after 40 failed checks.
mkLoadBalancerAvailable :: Waiter.Wait DescribeLoadBalancers
mkLoadBalancerAvailable
  = Waiter.Wait{Waiter._waitName = "LoadBalancerAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "active" Waiter.AcceptSuccess
                     (Lens.folding
                        ...
                        Lens.field @"state" Core.. Lens._Just Core..
                          Lens.field @"code" Core.. Lens._Just),
                   Waiter.matchAny "provisioning" Waiter.AcceptRetry
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"loadBalancers" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkTargetInService
  = Waiter.Wait{Waiter._waitName = "TargetInService",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "healthy" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"targetHealthDescriptions" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkLoadBalancerExists
  = Waiter.Wait{Waiter._waitName = "LoadBalancerExists",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
