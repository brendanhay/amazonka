...
--
-- * 'ceVersionLabel'
data CreateEnvironment = CreateEnvironment'{_ceOptionsToRemove :: [OptionSpecification], _ceOptionSettings :: [ConfigurationOptionSetting], _ceTier :: Maybe EnvironmentTier, _ceSolutionStackName :: Maybe Text, _ceDescription :: Maybe Text, _ceTags :: [Tag], _ceApplicationName :: Text, _ceEnvironmentName :: Text, _ceCNAMEPrefix :: Text, _ceTemplateName :: Text, _ceVersionLabel :: Text} deriving (Eq, Read, Show)

-- | 'CreateEnvironment' smart constructor.
createEnvironment :: Text -> Text -> Text -> Text -> Text -> CreateEnvironment
createEnvironment pApplicationName pEnvironmentName pCNAMEPrefix pTemplateName pVersionLabel = CreateEnvironment'{_ceOptionsToRemove = mempty, _ceOptionSettings = mempty, _ceTier = Nothing, _ceSolutionStackName = Nothing, _ceDescription = Nothing, _ceTags = mempty, _ceApplicationName = pApplicationName, _ceEnvironmentName = pEnvironmentName, _ceCNAMEPrefix = pCNAMEPrefix, _ceTemplateName = pTemplateName, _ceVersionLabel = pVersionLabel};
...
ceCNAMEPrefix :: Lens' CreateEnvironment Text
...
ceTemplateName :: Lens' CreateEnvironment Text
...
ceVersionLabel :: Lens' CreateEnvironment Text
