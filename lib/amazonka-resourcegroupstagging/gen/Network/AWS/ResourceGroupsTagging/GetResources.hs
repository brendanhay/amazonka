...
mkGetResourcesResponse responseStatus =
  GetResourcesResponse'
    { paginationToken = Core.Nothing,
      resourceTagMappingList = Core.Nothing,
      responseStatus
    }
...
{-# DEPRECATED grrrsPaginationToken "Use generic-lens or generic-optics with 'paginationToken' instead." #-}
...
{-# DEPRECATED grrrsResourceTagMappingList "Use generic-lens or generic-optics with 'resourceTagMappingList' instead." #-}
