...
--
--
-- For more information, see <ses/latest/DeveloperGuide/configure-custom-open-click-domains.html Configuring Custom Domains to Handle Open and Click Tracking> in the /Amazon SES Developer Guide/ .
--
--
