...
mkInputAttachment
    :: InputAttachment
mkInputAttachment
  = InputAttachment'{automaticInputFailoverSettings = Core.Nothing,
                     inputAttachmentName = Core.Nothing, inputId = Core.Nothing,
...
{-# INLINEABLE iaAutomaticInputFailoverSettings #-}
{-# DEPRECATED automaticInputFailoverSettings "Use generic-lens or generic-optics with 'automaticInputFailoverSettings' instead"  #-}
...
{-# INLINEABLE iaInputAttachmentName #-}
{-# DEPRECATED inputAttachmentName "Use generic-lens or generic-optics with 'inputAttachmentName' instead"  #-}
...
{-# INLINEABLE iaInputSettings #-}
{-# DEPRECATED inputSettings "Use generic-lens or generic-optics with 'inputSettings' instead"  #-}

instance Core.FromJSON InputAttachment where
        toJSON InputAttachment{..}
          = Core.object
              (Core.catMaybes
                 [("automaticInputFailoverSettings" Core..=) Core.<$>
...
instance Core.FromJSON InputAttachment where
        parseJSON
          = Core.withObject "InputAttachment" Core.$
              \ x ->
                InputAttachment' Core.<$>
                  (x Core..:? "automaticInputFailoverSettings") Core.<*>
                    x Core..:? "inputAttachmentName"
                    Core.<*> x Core..:? "inputId"
