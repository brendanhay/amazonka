...
mkAudioParameters
    :: AudioParameters
mkAudioParameters
  = AudioParameters'{audioPackingMode = Core.Nothing,
                     bitRate = Core.Nothing, channels = Core.Nothing,
                     codec = Core.Nothing, codecOptions = Core.Nothing,
...
{-# INLINEABLE apAudioPackingMode #-}
{-# DEPRECATED audioPackingMode "Use generic-lens or generic-optics with 'audioPackingMode' instead"  #-}
...
instance Core.FromJSON AudioParameters where
        parseJSON
          = Core.withObject "AudioParameters" Core.$
              \ x ->
                AudioParameters' Core.<$>
                  (x Core..:? "AudioPackingMode") Core.<*> x Core..:? "BitRate"
