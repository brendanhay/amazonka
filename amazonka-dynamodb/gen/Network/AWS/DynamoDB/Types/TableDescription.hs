...
data TableDescription = TableDescription'
  { -- | Represents the version of
    ...
    -- will be returned.
    localSecondaryIndexes :: Core.Maybe [LocalSecondaryIndexDescription],
    -- | Contains details for the restore.
    restoreSummary :: Core.Maybe RestoreSummary,
    ...
    -- If the table is in the @DELETING@ state, no information about indexes
    -- will be returned.
    globalSecondaryIndexes :: Core.Maybe [GlobalSecondaryIndexDescription],
    ...
    billingModeSummary :: Core.Maybe BillingModeSummary,
    ...
    archivalSummary :: Core.Maybe ArchivalSummary,
    ...
    replicas :: Core.Maybe [ReplicaDescription],
    ...
    latestStreamArn :: Core.Maybe Core.Text
  }
...
-- <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GlobalTables.html global tables>
-- in use, if the table is replicated across AWS Regions.
tableDescription_globalTableVersion :: Lens.Lens' TableDescription (Core.Maybe Core.Text)
...
-- If the table is in the @DELETING@ state, no information about indexes
-- will be returned.
tableDescription_localSecondaryIndexes :: Lens.Lens' TableDescription (Core.Maybe [LocalSecondaryIndexDescription])
tableDescription_localSecondaryIndexes = Lens.lens (\TableDescription' {localSecondaryIndexes} -> localSecondaryIndexes) (\s@TableDescription' {} a -> s {localSecondaryIndexes = a} :: TableDescription) Core.. Lens.mapping Lens._Coerce

-- | Contains details for the restore.
tableDescription_restoreSummary :: Lens.Lens' TableDescription (Core.Maybe RestoreSummary)
...
-- | The current DynamoDB Streams configuration for the table.
tableDescription_streamSpecification :: Lens.Lens' TableDescription (Core.Maybe StreamSpecification)
...
-- If the table is in the @DELETING@ state, no information about indexes
-- will be returned.
tableDescription_globalSecondaryIndexes :: Lens.Lens' TableDescription (Core.Maybe [GlobalSecondaryIndexDescription])
tableDescription_globalSecondaryIndexes = Lens.lens (\TableDescription' {globalSecondaryIndexes} -> globalSecondaryIndexes) (\s@TableDescription' {} a -> s {globalSecondaryIndexes = a} :: TableDescription) Core.. Lens.mapping Lens._Coerce

-- | The name of the table.
tableDescription_tableName :: Lens.Lens' TableDescription (Core.Maybe Core.Text)
...
-- <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html#DataModelPrimaryKey Primary Key>
-- in the /Amazon DynamoDB Developer Guide/.
tableDescription_keySchema :: Lens.Lens' TableDescription (Core.Maybe (Core.NonEmpty KeySchemaElement))
tableDescription_keySchema = Lens.lens (\TableDescription' {keySchema} -> keySchema) (\s@TableDescription' {} a -> s {keySchema = a} :: TableDescription) Core.. Lens.mapping Lens._Coerce

-- | The Amazon Resource Name (ARN) that uniquely identifies the table.
tableDescription_tableArn :: Lens.Lens' TableDescription (Core.Maybe Core.Text)
...
-- | Unique identifier for the table for which the backup was created.
tableDescription_tableId :: Lens.Lens' TableDescription (Core.Maybe Core.Text)
...
--
-- -   @AttributeType@ - The data type for the attribute.
tableDescription_attributeDefinitions :: Lens.Lens' TableDescription (Core.Maybe [AttributeDefinition])
tableDescription_attributeDefinitions = Lens.lens (\TableDescription' {attributeDefinitions} -> attributeDefinitions) (\s@TableDescription' {} a -> s {attributeDefinitions = a} :: TableDescription) Core.. Lens.mapping Lens._Coerce

-- | The total size of the specified table, in bytes. DynamoDB updates this
-- value approximately every six hours. Recent changes might not be
-- reflected in this value.
tableDescription_tableSizeBytes :: Lens.Lens' TableDescription (Core.Maybe Core.Integer)
...
-- | Contains the details for the read\/write capacity mode.
tableDescription_billingModeSummary :: Lens.Lens' TableDescription (Core.Maybe BillingModeSummary)
...
--
-- -   @StreamLabel@
tableDescription_latestStreamLabel :: Lens.Lens' TableDescription (Core.Maybe Core.Text)
...
-- | Contains information about the table archive.
tableDescription_archivalSummary :: Lens.Lens' TableDescription (Core.Maybe ArchivalSummary)
...
-- approximately every six hours. Recent changes might not be reflected in
-- this value.
tableDescription_itemCount :: Lens.Lens' TableDescription (Core.Maybe Core.Integer)
...
-- | The description of the server-side encryption status on the specified
-- table.
tableDescription_sSEDescription :: Lens.Lens' TableDescription (Core.Maybe SSEDescription)
...
-- | Represents replicas of the table.
tableDescription_replicas :: Lens.Lens' TableDescription (Core.Maybe [ReplicaDescription])
tableDescription_replicas = Lens.lens (\TableDescription' {replicas} -> replicas) (\s@TableDescription' {} a -> s {replicas = a} :: TableDescription) Core.. Lens.mapping Lens._Coerce

-- | The date and time when the table was created, in
-- <http://www.epochconverter.com/ UNIX epoch time> format.
tableDescription_creationDateTime :: Lens.Lens' TableDescription (Core.Maybe Core.UTCTime)
tableDescription_creationDateTime = Lens.lens (\TableDescription' {creationDateTime} -> creationDateTime) (\s@TableDescription' {} a -> s {creationDateTime = a} :: TableDescription) Core.. Lens.mapping Core._Time
...
-- -   @ARCHIVED@ - The table has been archived. See the ArchivalReason for
--     more information.
tableDescription_tableStatus :: Lens.Lens' TableDescription (Core.Maybe TableStatus)
...
-- | The provisioned throughput settings for the table, consisting of read
-- and write capacity units, along with data about increases and decreases.
tableDescription_provisionedThroughput :: Lens.Lens' TableDescription (Core.Maybe ProvisionedThroughputDescription)
...
-- | The Amazon Resource Name (ARN) that uniquely identifies the latest
-- stream for this table.
tableDescription_latestStreamArn :: Lens.Lens' TableDescription (Core.Maybe Core.Text)
...
instance Core.Hashable TableDescription

instance Core.NFData TableDescription
