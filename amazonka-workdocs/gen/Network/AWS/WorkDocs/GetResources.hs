...
data GetResources = GetResources'
  { _grAuthenticationToken :: !(Maybe (Sensitive Text))
...
--
-- * 'grAuthenticationToken' - The Amazon WorkDocs authentication token. Do not set this field when using administrative API actions, as in accessing the API operation using AWS credentials.
--
