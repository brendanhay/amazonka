...
mkLabelingJobOutput
    :: Types.S3Uri -- ^ 'outputDatasetS3Uri'
    -> LabelingJobOutput
...
{-# INLINEABLE ljoOutputDatasetS3Uri #-}
{-# DEPRECATED outputDatasetS3Uri "Use generic-lens or generic-optics with 'outputDatasetS3Uri' instead"  #-}
...
{-# INLINEABLE ljoFinalActiveLearningModelArn #-}
{-# DEPRECATED finalActiveLearningModelArn "Use generic-lens or generic-optics with 'finalActiveLearningModelArn' instead"  #-}

instance Core.FromJSON LabelingJobOutput where
        parseJSON
          = Core.withObject "LabelingJobOutput" Core.$
              \ x ->
                LabelingJobOutput' Core.<$>
                  (x Core..: "OutputDatasetS3Uri") Core.<*>
                    x Core..:? "FinalActiveLearningModelArn"
