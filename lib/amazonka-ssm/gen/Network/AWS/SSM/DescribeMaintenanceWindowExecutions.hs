...
mkDescribeMaintenanceWindowExecutions windowId
  = DescribeMaintenanceWindowExecutions'{windowId,
...
{-# INLINEABLE dmweNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery DescribeMaintenanceWindowExecutions where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeMaintenanceWindowExecutions where
        toHeaders DescribeMaintenanceWindowExecutions{..}
          = Core.pure
...
instance Core.AWSRequest DescribeMaintenanceWindowExecutions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeMaintenanceWindowExecutionsResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "WindowExecutions"
...
mkDescribeMaintenanceWindowExecutionsResponse responseStatus
  = DescribeMaintenanceWindowExecutionsResponse'{nextToken =
                                                   Core.Nothing,
                                                 windowExecutions = Core.Nothing, responseStatus}
...
{-# INLINEABLE dmwerrsWindowExecutions #-}
{-# DEPRECATED windowExecutions "Use generic-lens or generic-optics with 'windowExecutions' instead"  #-}
...
{-# INLINEABLE dmwerrsResponseStatus #-}
