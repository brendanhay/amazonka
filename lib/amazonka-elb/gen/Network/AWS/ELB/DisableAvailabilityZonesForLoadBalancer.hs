...
instance Hashable DisableAvailabilityZonesForLoadBalancer

instance NFData DisableAvailabilityZonesForLoadBalancer

instance ToHeaders DisableAvailabilityZonesForLoadBalancer where
...
instance ToQuery DisableAvailabilityZonesForLoadBalancer where
  toQuery DisableAvailabilityZonesForLoadBalancer' {..} =
    mconcat
      [ "Action"
          =: ("DisableAvailabilityZonesForLoadBalancer" :: ByteString),
...
instance NFData DisableAvailabilityZonesForLoadBalancerResponse
