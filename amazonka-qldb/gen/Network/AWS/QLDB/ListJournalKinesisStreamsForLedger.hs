...
instance
  ...
  where
  type
    Rs ListJournalKinesisStreamsForLedger =
      ListJournalKinesisStreamsForLedgerResponse
...
listJournalKinesisStreamsForLedgerResponse_streams = Lens.lens (\ListJournalKinesisStreamsForLedgerResponse' {streams} -> streams) (\s@ListJournalKinesisStreamsForLedgerResponse' {} a -> s {streams = a} :: ListJournalKinesisStreamsForLedgerResponse) Prelude.. Lens.mapping Prelude._Coerce
