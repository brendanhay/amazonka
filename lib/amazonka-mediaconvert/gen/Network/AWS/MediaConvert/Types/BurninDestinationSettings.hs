...
mkBurninDestinationSettings
  = BurninDestinationSettings'{alignment = Core.Nothing,
                               ...
                               shadowYOffset = Core.Nothing, teletextSpacing = Core.Nothing,
...
{-# INLINEABLE bdsBackgroundOpacity #-}
