...
{-# INLINEABLE pitrdEarliestRestorableDateTime #-}
{-# DEPRECATED earliestRestorableDateTime "Use generic-lens or generic-optics with 'earliestRestorableDateTime' instead"  #-}
...
{-# INLINEABLE pitrdLatestRestorableDateTime #-}
{-# DEPRECATED latestRestorableDateTime "Use generic-lens or generic-optics with 'latestRestorableDateTime' instead"  #-}
...
{-# INLINEABLE pitrdPointInTimeRecoveryStatus #-}
{-# DEPRECATED pointInTimeRecoveryStatus "Use generic-lens or generic-optics with 'pointInTimeRecoveryStatus' instead"  #-}

instance Core.FromJSON PointInTimeRecoveryDescription where
        parseJSON
          = Core.withObject "PointInTimeRecoveryDescription" Core.$
              \ x ->
                PointInTimeRecoveryDescription' Core.<$>
                  (x Core..:? "EarliestRestorableDateTime") Core.<*>
                    x Core..:? "LatestRestorableDateTime"
