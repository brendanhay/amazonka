...
dugUserGroupId :: Lens.Lens' DeleteUserGroup Core.Text
dugUserGroupId = Lens.field @"userGroupId"
{-# INLINEABLE dugUserGroupId #-}
...
instance Core.ToQuery DeleteUserGroup where
        toQuery DeleteUserGroup{..}
          = Core.toQueryPair "Action" ("DeleteUserGroup" :: Core.Text)
...
instance Core.AWSRequest DeleteUserGroup where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "DeleteUserGroupResult"
