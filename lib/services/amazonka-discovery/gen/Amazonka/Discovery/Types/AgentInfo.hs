...
-- account. Information includes agent IDs, IP addresses, media access
-- control (MAC) addresses, agent or collector status, hostname where the
-- agent resides, and agent version for each agent.
--
...
--
-- 'agentId', 'agentInfo_agentId' - The agent or collector ID.
--
-- 'agentNetworkInfoList', 'agentInfo_agentNetworkInfoList' - Network details about the host where the agent or collector resides.
--
-- 'agentType', 'agentInfo_agentType' - Type of agent.
--
-- 'collectionStatus', 'agentInfo_collectionStatus' - Status of the collection process for an agent.
--
-- 'connectorId', 'agentInfo_connectorId' - The ID of the connector.
--
-- 'health', 'agentInfo_health' - The health of the agent.
--
-- 'hostName', 'agentInfo_hostName' - The name of the host where the agent or collector resides. The host can
-- be a server or virtual machine.
--
-- 'lastHealthPingTime', 'agentInfo_lastHealthPingTime' - Time since agent health was reported.
--
-- 'registeredTime', 'agentInfo_registeredTime' - Agent\'s first registration timestamp in UTC.
--
-- 'version', 'agentInfo_version' - The agent or collector version.
newAgentInfo ::
  AgentInfo
newAgentInfo =
  AgentInfo'
