...
mkGetDevicePoolCompatibility
    :: Types.DevicePoolArn -- ^ 'devicePoolArn'
    -> GetDevicePoolCompatibility
mkGetDevicePoolCompatibility devicePoolArn
  = GetDevicePoolCompatibility'{devicePoolArn, appArn = Core.Nothing,
                                configuration = Core.Nothing, test = Core.Nothing,
...
{-# INLINEABLE gdpcTestType #-}
{-# DEPRECATED testType "Use generic-lens or generic-optics with 'testType' instead"  #-}

instance Core.ToQuery GetDevicePoolCompatibility where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders GetDevicePoolCompatibility where
        toHeaders GetDevicePoolCompatibility{..}
          = Core.pure
...
instance Core.AWSRequest GetDevicePoolCompatibility where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetDevicePoolCompatibilityResponse' Core.<$>
                   (x Core..:? "compatibleDevices") Core.<*>
                     x Core..:? "incompatibleDevices"
...
mkGetDevicePoolCompatibilityResponse responseStatus
  = GetDevicePoolCompatibilityResponse'{compatibleDevices =
                                          Core.Nothing,
                                        incompatibleDevices = Core.Nothing, responseStatus}
...
{-# INLINEABLE gdpcrrsCompatibleDevices #-}
{-# DEPRECATED compatibleDevices "Use generic-lens or generic-optics with 'compatibleDevices' instead"  #-}
...
{-# INLINEABLE gdpcrrsIncompatibleDevices #-}
{-# DEPRECATED incompatibleDevices "Use generic-lens or generic-optics with 'incompatibleDevices' instead"  #-}
...
{-# INLINEABLE gdpcrrsResponseStatus #-}
