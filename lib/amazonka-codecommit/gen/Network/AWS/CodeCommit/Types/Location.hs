...
mkLocation
    :: Location
mkLocation
  = Location'{filePath = Core.Nothing, filePosition = Core.Nothing,
...
{-# INLINEABLE lFilePosition #-}
{-# DEPRECATED filePosition "Use generic-lens or generic-optics with 'filePosition' instead"  #-}
...
{-# INLINEABLE lRelativeFileVersion #-}
{-# DEPRECATED relativeFileVersion "Use generic-lens or generic-optics with 'relativeFileVersion' instead"  #-}
...
instance Core.FromJSON Location where
        parseJSON
          = Core.withObject "Location" Core.$
              \ x ->
                Location' Core.<$>
                  (x Core..:? "filePath") Core.<*> x Core..:? "filePosition" Core.<*>
                    x Core..:? "relativeFileVersion"
