...
{-# INLINEABLE gotExpectedBucketOwner #-}
...
instance Core.ToQuery GetObjectTorrent where
        toQuery GetObjectTorrent{..}
          = Core.toQueryPair "torrent" ("" :: Core.Text)
...
mkGetObjectTorrentResponse body responseStatus
  = GetObjectTorrentResponse'{body, requestCharged = Core.Nothing,
                              responseStatus}
...
{-# INLINEABLE gotrrsRequestCharged #-}
...
{-# INLINEABLE gotrrsResponseStatus #-}
