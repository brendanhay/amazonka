...
{-# INLINEABLE amljccMaxAutoMLJobRuntimeInSeconds #-}
{-# DEPRECATED maxAutoMLJobRuntimeInSeconds "Use generic-lens or generic-optics with 'maxAutoMLJobRuntimeInSeconds' instead"  #-}
...
{-# INLINEABLE amljccMaxCandidates #-}
{-# DEPRECATED maxCandidates "Use generic-lens or generic-optics with 'maxCandidates' instead"  #-}
...
{-# INLINEABLE amljccMaxRuntimePerTrainingJobInSeconds #-}
{-# DEPRECATED maxRuntimePerTrainingJobInSeconds "Use generic-lens or generic-optics with 'maxRuntimePerTrainingJobInSeconds' instead"  #-}

instance Core.FromJSON AutoMLJobCompletionCriteria where
        toJSON AutoMLJobCompletionCriteria{..}
          = Core.object
              (Core.catMaybes
                 [("MaxAutoMLJobRuntimeInSeconds" Core..=) Core.<$>
                    maxAutoMLJobRuntimeInSeconds,
                  ("MaxCandidates" Core..=) Core.<$> maxCandidates,
                  ("MaxRuntimePerTrainingJobInSeconds" Core..=) Core.<$>
...
instance Core.FromJSON AutoMLJobCompletionCriteria where
        parseJSON
          = Core.withObject "AutoMLJobCompletionCriteria" Core.$
              \ x ->
                AutoMLJobCompletionCriteria' Core.<$>
                  (x Core..:? "MaxAutoMLJobRuntimeInSeconds") Core.<*>
                    x Core..:? "MaxCandidates"
