...
-- Module      : Network.AWS.EC2.V2014_05_01.ModifyVolumeAttribute
...
module Network.AWS.EC2.V2014_05_01.ModifyVolumeAttribute where
...
data ModifyVolumeAttribute = ModifyVolumeAttribute
    ...
    , _mvarAutoEnableIO :: AttributeBooleanValue
