...
job_queueTransitions = Lens.lens (\Job' {queueTransitions} -> queueTransitions) (\s@Job' {} a -> s {queueTransitions = a} :: Job) Prelude.. Lens.mapping Prelude._Coerce
...
job_userMetadata = Lens.lens (\Job' {userMetadata} -> userMetadata) (\s@Job' {} a -> s {userMetadata = a} :: Job) Prelude.. Lens.mapping Prelude._Coerce
...
job_hopDestinations = Lens.lens (\Job' {hopDestinations} -> hopDestinations) (\s@Job' {} a -> s {hopDestinations = a} :: Job) Prelude.. Lens.mapping Prelude._Coerce
...
job_outputGroupDetails = Lens.lens (\Job' {outputGroupDetails} -> outputGroupDetails) (\s@Job' {} a -> s {outputGroupDetails = a} :: Job) Prelude.. Lens.mapping Prelude._Coerce
    ...
    Prelude.withObject
      ...
      ( \x ->
          Job'
            ...
            Prelude.<*> (x Prelude..:? "billingTagsSource")
            Prelude.<*> (x Prelude..:? "status")
            Prelude.<*> (x Prelude..:? "accelerationStatus")
            Prelude.<*> (x Prelude..:? "retryCount")
            Prelude.<*> ( x Prelude..:? "queueTransitions"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "arn")
            Prelude.<*> (x Prelude..:? "id")
            Prelude.<*> (x Prelude..:? "jobPercentComplete")
            ...
            Prelude.<*> (x Prelude..:? "simulateReservedQueue")
            ...
            Prelude.<*> ( x Prelude..:? "outputGroupDetails"
                            Prelude..!= Prelude.mempty
                        )
