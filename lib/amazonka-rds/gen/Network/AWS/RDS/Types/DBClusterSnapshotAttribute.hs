...
mkDBClusterSnapshotAttribute
    :: DBClusterSnapshotAttribute
mkDBClusterSnapshotAttribute
  = DBClusterSnapshotAttribute'{attributeName = Core.Nothing,
...
dbcsaAttributeName :: Lens.Lens' DBClusterSnapshotAttribute (Core.Maybe Core.Text)
dbcsaAttributeName = Lens.field @"attributeName"
{-# INLINEABLE dbcsaAttributeName #-}
...
dbcsaAttributeValues :: Lens.Lens' DBClusterSnapshotAttribute (Core.Maybe [Core.Text])
dbcsaAttributeValues = Lens.field @"attributeValues"
{-# INLINEABLE dbcsaAttributeValues #-}
...
instance Core.FromXML DBClusterSnapshotAttribute where
        parseXML x
          = DBClusterSnapshotAttribute' Core.<$>
