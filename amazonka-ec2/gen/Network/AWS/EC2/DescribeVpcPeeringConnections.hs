...
-- | One or more filters. @accepter-vpc-info.cidr-block@ - The CIDR block of
-- the peer VPC. @accepter-vpc-info.owner-id@ - The AWS account ID of the
-- owner of the peer VPC. @accepter-vpc-info.vpc-id@ - The ID of the peer
-- VPC. @expiration-time@ - The expiration date and time for the VPC peering
-- connection. @requester-vpc-info.cidr-block@ - The CIDR block of the
-- requester's VPC. @requester-vpc-info.owner-id@ - The AWS account ID of
-- the owner of the requester VPC. @requester-vpc-info.vpc-id@ - The ID of
...
-- provides more information about the status of the VPC peering connection,
-- if applicable. @tag@:/key/=/value/ - The key/value combination of a tag
...
-- @tag-key@ filter. @vpc-peering-connection-id@ - The ID of the VPC peering
-- connection.
