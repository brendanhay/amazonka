...
{-# INLINEABLE pfcscCodeSigningConfigArn #-}
...
instance Core.AWSRequest PutFunctionCodeSigningConfig where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 PutFunctionCodeSigningConfigResponse' Core.<$>
...
mkPutFunctionCodeSigningConfigResponse
    ...
    -> PutFunctionCodeSigningConfigResponse
mkPutFunctionCodeSigningConfigResponse codeSigningConfigArn
...
{-# INLINEABLE pfcscrrsCodeSigningConfigArn #-}
{-# DEPRECATED codeSigningConfigArn "Use generic-lens or generic-optics with 'codeSigningConfigArn' instead"  #-}
...
{-# INLINEABLE pfcscrrsFunctionName #-}
{-# DEPRECATED functionName "Use generic-lens or generic-optics with 'functionName' instead"  #-}
...
{-# INLINEABLE pfcscrrsResponseStatus #-}
