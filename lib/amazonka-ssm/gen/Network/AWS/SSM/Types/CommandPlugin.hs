...
mkCommandPlugin
    :: CommandPlugin
mkCommandPlugin
  = CommandPlugin'{name = Core.Nothing, output = Core.Nothing,
                   outputS3BucketName = Core.Nothing,
                   outputS3KeyPrefix = Core.Nothing, outputS3Region = Core.Nothing,
                   responseCode = Core.Nothing, responseFinishDateTime = Core.Nothing,
...
{-# INLINEABLE cpOutputS3BucketName #-}
...
{-# INLINEABLE cpOutputS3KeyPrefix #-}
...
{-# INLINEABLE cpResponseFinishDateTime #-}
{-# DEPRECATED responseFinishDateTime "Use generic-lens or generic-optics with 'responseFinishDateTime' instead"  #-}
...
{-# INLINEABLE cpResponseStartDateTime #-}
{-# DEPRECATED responseStartDateTime "Use generic-lens or generic-optics with 'responseStartDateTime' instead"  #-}
...
{-# INLINEABLE cpStandardOutputUrl #-}
