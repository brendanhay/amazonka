...
associateDRTRole
    :: Text -- ^ 'adrtrRoleARN'
    -> AssociateDRTRole
associateDRTRole pRoleARN_ = AssociateDRTRole' {_adrtrRoleARN = pRoleARN_}
...
associateDRTRoleResponse pResponseStatus_ =
  AssociateDRTRoleResponse' {_adrtrrsResponseStatus = pResponseStatus_}
