...
mkMp4Settings
    :: Mp4Settings
mkMp4Settings
  = Mp4Settings'{audioDuration = Core.Nothing,
                 cslgAtom = Core.Nothing, cttsVersion = Core.Nothing,
                 freeSpaceBox = Core.Nothing, moovPlacement = Core.Nothing,
...
{-# INLINEABLE mCslgAtom #-}
{-# DEPRECATED cslgAtom "Use generic-lens or generic-optics with 'cslgAtom' instead"  #-}
...
{-# INLINEABLE mCttsVersion #-}
{-# DEPRECATED cttsVersion "Use generic-lens or generic-optics with 'cttsVersion' instead"  #-}
...
{-# INLINEABLE mFreeSpaceBox #-}
{-# DEPRECATED freeSpaceBox "Use generic-lens or generic-optics with 'freeSpaceBox' instead"  #-}
...
{-# INLINEABLE mMp4MajorBrand #-}
{-# DEPRECATED mp4MajorBrand "Use generic-lens or generic-optics with 'mp4MajorBrand' instead"  #-}
...
instance Core.FromJSON Mp4Settings where
        parseJSON
          = Core.withObject "Mp4Settings" Core.$
              \ x ->
                Mp4Settings' Core.<$>
                  (x Core..:? "audioDuration") Core.<*> x Core..:? "cslgAtom"
