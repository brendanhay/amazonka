...
mkListLogSubscriptions
    :: ListLogSubscriptions
mkListLogSubscriptions
  = ListLogSubscriptions'{directoryId = Core.Nothing,
...
instance Core.ToHeaders ListLogSubscriptions where
        toHeaders ListLogSubscriptions{..}
          = Core.pure
...
instance Core.AWSRequest ListLogSubscriptions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListLogSubscriptionsResponse' Core.<$>
                   (x Core..:? "LogSubscriptions") Core.<*> x Core..:? "NextToken"
...
mkListLogSubscriptionsResponse responseStatus
  = ListLogSubscriptionsResponse'{logSubscriptions = Core.Nothing,
...
{-# INLINEABLE llsrrsLogSubscriptions #-}
{-# DEPRECATED logSubscriptions "Use generic-lens or generic-optics with 'logSubscriptions' instead"  #-}
...
{-# INLINEABLE llsrrsResponseStatus #-}
