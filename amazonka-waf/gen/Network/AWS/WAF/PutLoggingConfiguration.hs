...
newtype PutLoggingConfiguration = PutLoggingConfiguration'
  { _plcLoggingConfiguration :: LoggingConfiguration
...
putLoggingConfiguration
    :: LoggingConfiguration -- ^ 'plcLoggingConfiguration'
    -> PutLoggingConfiguration
putLoggingConfiguration pLoggingConfiguration_ =
  PutLoggingConfiguration' {_plcLoggingConfiguration = pLoggingConfiguration_}
...
instance AWSRequest PutLoggingConfiguration where
        type Rs PutLoggingConfiguration =
             PutLoggingConfigurationResponse
...
instance Hashable PutLoggingConfiguration where

instance NFData PutLoggingConfiguration where
...
data PutLoggingConfigurationResponse = PutLoggingConfigurationResponse'
  { _plcrsLoggingConfiguration :: !(Maybe LoggingConfiguration)
  , _plcrsResponseStatus       :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
putLoggingConfigurationResponse
    :: Int -- ^ 'plcrsResponseStatus'
    -> PutLoggingConfigurationResponse
putLoggingConfigurationResponse pResponseStatus_ =
  PutLoggingConfigurationResponse'
    { _plcrsLoggingConfiguration = Nothing
...
instance NFData PutLoggingConfigurationResponse where
