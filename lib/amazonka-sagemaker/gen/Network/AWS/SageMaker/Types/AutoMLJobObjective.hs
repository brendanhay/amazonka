...
-- | Creates a 'AutoMLJobObjective' value with any optional fields omitted.
mkAutoMLJobObjective ::
  -- | 'metricName'
  Types.AutoMLMetricEnum ->
  AutoMLJobObjective
mkAutoMLJobObjective metricName = AutoMLJobObjective' {metricName}
...
amljoMetricName :: Lens.Lens' AutoMLJobObjective Types.AutoMLMetricEnum
amljoMetricName = Lens.field @"metricName"
...
instance Core.FromJSON AutoMLJobObjective where
  toJSON AutoMLJobObjective {..} =
    Core.object
      (Core.catMaybes [Core.Just ("MetricName" Core..= metricName)])

instance Core.FromJSON AutoMLJobObjective where
  parseJSON =
    Core.withObject "AutoMLJobObjective" Core.$
      \x -> AutoMLJobObjective' Core.<$> (x Core..: "MetricName")
