...
data ContainerDefinition = ContainerDefinition'
  { -- | The command that is passed to the container. This parameter maps to @Cmd@ in the <https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate Create a container> section of the <https://docs.docker.com/engine/api/v1.35/ Docker Remote API> and the @COMMAND@ parameter to <https://docs.docker.com/engine/reference/run/#security-configuration docker run> . For more information, see <https://docs.docker.com/engine/reference/builder/#cmd https://docs.docker.com/engine/reference/builder/#cmd> . If there are multiple arguments, each argument should be a separated string in the array.
    ...
    dnsSearchDomains :: Core.Maybe [Types.String],
    ...
    dnsServers :: Core.Maybe [Types.String],
    ...
    dockerLabels :: Core.Maybe (Core.HashMap Types.String Types.String),
    ...
    dockerSecurityOptions :: Core.Maybe [Types.String],
    ...
    entryPoint :: Core.Maybe [Types.String],
    ...
    workingDirectory :: Core.Maybe Types.String
  }
...
cdCommand :: Lens.Lens' ContainerDefinition (Core.Maybe [Types.String])
...
cdDnsSearchDomains :: Lens.Lens' ContainerDefinition (Core.Maybe [Types.String])
...
cdDnsServers :: Lens.Lens' ContainerDefinition (Core.Maybe [Types.String])
...
cdDockerLabels :: Lens.Lens' ContainerDefinition (Core.Maybe (Core.HashMap Types.String Types.String))
...
cdDockerSecurityOptions :: Lens.Lens' ContainerDefinition (Core.Maybe [Types.String])
...
cdEntryPoint :: Lens.Lens' ContainerDefinition (Core.Maybe [Types.String])
...
cdHostname :: Lens.Lens' ContainerDefinition (Core.Maybe Types.String)
...
cdImage :: Lens.Lens' ContainerDefinition (Core.Maybe Types.String)
...
cdLinks :: Lens.Lens' ContainerDefinition (Core.Maybe [Types.String])
...
cdName :: Lens.Lens' ContainerDefinition (Core.Maybe Types.String)
...
cdUser :: Lens.Lens' ContainerDefinition (Core.Maybe Types.String)
...
cdWorkingDirectory :: Lens.Lens' ContainerDefinition (Core.Maybe Types.String)
