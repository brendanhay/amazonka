...
instance Hashable LaunchTemplateElasticInferenceAccelerator

instance NFData LaunchTemplateElasticInferenceAccelerator

instance ToQuery LaunchTemplateElasticInferenceAccelerator where
  toQuery LaunchTemplateElasticInferenceAccelerator' {..} =
    mconcat ["Count" =: _lteiaCount, "Type" =: _lteiaType]
