...
-- |
-- Module      : Network.AWS.LexV2Models.DeleteImport
...
instance Prelude.Hashable DeleteImport

instance Prelude.NFData DeleteImport

instance Core.ToHeaders DeleteImport where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Core.ToPath DeleteImport where
  toPath DeleteImport' {..} =
    Prelude.mconcat
      ["/imports/", Core.toBS importId, "/"]

instance Core.ToQuery DeleteImport where
...
data DeleteImportResponse = DeleteImportResponse'
  { -- | The unique identifier of the deleted import.
    ...
    -- import will no longer be returned by the operation and calls to the with
...
instance Prelude.NFData DeleteImportResponse
