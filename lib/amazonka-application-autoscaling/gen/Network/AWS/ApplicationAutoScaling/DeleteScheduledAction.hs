...
delrsResponseStatus :: Lens.Lens' DeleteScheduledActionResponse Lude.Int
delrsResponseStatus = Lens.lens (responseStatus :: DeleteScheduledActionResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: DeleteScheduledActionResponse)
