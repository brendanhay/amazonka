...
mkGetHostReservationPurchasePreview offeringId
  = GetHostReservationPurchasePreview'{hostIdSet = Core.mempty,
                                       offeringId}
...
instance Core.AWSRequest GetHostReservationPurchasePreview where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 GetHostReservationPurchasePreviewResponse' Core.<$>
                   (x Core..@? "currencyCode") Core.<*>
                     x Core..@? "purchase" Core..<@> Core.parseXMLList "item"
...
{-# INLINEABLE ghrpprrsCurrencyCode #-}
...
ghrpprrsTotalHourlyPrice :: Lens.Lens' GetHostReservationPurchasePreviewResponse (Core.Maybe Core.Text)
ghrpprrsTotalHourlyPrice = Lens.field @"totalHourlyPrice"
{-# INLINEABLE ghrpprrsTotalHourlyPrice #-}
...
ghrpprrsTotalUpfrontPrice :: Lens.Lens' GetHostReservationPurchasePreviewResponse (Core.Maybe Core.Text)
ghrpprrsTotalUpfrontPrice = Lens.field @"totalUpfrontPrice"
{-# INLINEABLE ghrpprrsTotalUpfrontPrice #-}
...
{-# INLINEABLE ghrpprrsResponseStatus #-}
