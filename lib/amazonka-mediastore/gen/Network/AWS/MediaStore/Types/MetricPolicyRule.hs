...
mkMetricPolicyRule
    ...
    -> Types.ObjectGroupName -- ^ 'objectGroupName'
    -> MetricPolicyRule
...
{-# INLINEABLE mprObjectGroup #-}
{-# DEPRECATED objectGroup "Use generic-lens or generic-optics with 'objectGroup' instead"  #-}
...
{-# INLINEABLE mprObjectGroupName #-}
{-# DEPRECATED objectGroupName "Use generic-lens or generic-optics with 'objectGroupName' instead"  #-}
...
instance Core.FromJSON MetricPolicyRule where
        parseJSON
          = Core.withObject "MetricPolicyRule" Core.$
              \ x ->
                MetricPolicyRule' Core.<$>
                  (x Core..: "ObjectGroup") Core.<*> x Core..: "ObjectGroupName"
