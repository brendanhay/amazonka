...
mkOpsItemSummary
    :: OpsItemSummary
mkOpsItemSummary
  = OpsItemSummary'{category = Core.Nothing,
                    createdBy = Core.Nothing, createdTime = Core.Nothing,
                    lastModifiedBy = Core.Nothing, lastModifiedTime = Core.Nothing,
                    operationalData = Core.Nothing, opsItemId = Core.Nothing,
                    priority = Core.Nothing, severity = Core.Nothing,
...
{-# INLINEABLE oisLastModifiedTime #-}
