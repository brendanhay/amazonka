...
startTranscriptionJob_languageOptions = Lens.lens (\StartTranscriptionJob' {languageOptions} -> languageOptions) (\s@StartTranscriptionJob' {} a -> s {languageOptions = a} :: StartTranscriptionJob) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest StartTranscriptionJob where
  type
...
instance Prelude.ToHeaders StartTranscriptionJob where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "Transcribe.StartTranscriptionJob" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON StartTranscriptionJob where
...
instance Prelude.ToPath StartTranscriptionJob where
  toPath = Prelude.const "/"

instance Prelude.ToQuery StartTranscriptionJob where
