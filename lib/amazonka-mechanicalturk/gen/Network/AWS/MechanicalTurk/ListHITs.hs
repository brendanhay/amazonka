...
mkListHITsResponse responseStatus
  = ListHITsResponse'{hITs = Core.Nothing, nextToken = Core.Nothing,
                      numResults = Core.Nothing, responseStatus}
...
{-# INLINEABLE lhitrrsResponseStatus #-}
