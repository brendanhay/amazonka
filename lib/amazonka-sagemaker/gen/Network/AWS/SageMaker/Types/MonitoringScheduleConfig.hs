...
mkMonitoringScheduleConfig
    :: Types.MonitoringJobDefinition -- ^ 'monitoringJobDefinition'
    -> MonitoringScheduleConfig
...
{-# INLINEABLE mscMonitoringJobDefinition #-}
{-# DEPRECATED monitoringJobDefinition "Use generic-lens or generic-optics with 'monitoringJobDefinition' instead"  #-}
...
{-# INLINEABLE mscScheduleConfig #-}
{-# DEPRECATED scheduleConfig "Use generic-lens or generic-optics with 'scheduleConfig' instead"  #-}
...
instance Core.FromJSON MonitoringScheduleConfig where
        parseJSON
          = Core.withObject "MonitoringScheduleConfig" Core.$
              \ x ->
                MonitoringScheduleConfig' Core.<$>
                  (x Core..: "MonitoringJobDefinition") Core.<*>
                    x Core..:? "ScheduleConfig"
