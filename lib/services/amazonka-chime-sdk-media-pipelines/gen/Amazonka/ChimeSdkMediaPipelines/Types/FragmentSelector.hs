...
-- |
-- Module      : Amazonka.ChimeSdkMediaPipelines.Types.FragmentSelector
-- Copyright   : (c) 2013-2023 Brendan Hay
-- License     : Mozilla Public License, v. 2.0.
-- Maintainer  : Brendan Hay <brendan.g.hay+amazonka@gmail.com>
-- Stability   : auto-generated
-- Portability : non-portable (GHC extensions)
module Amazonka.ChimeSdkMediaPipelines.Types.FragmentSelector where
...
data FragmentSelector = FragmentSelector'
  { -- | The origin of the timestamps to use, @Server@ or @Producer@. For more
    -- information, see
    -- <kinesisvideostreams/latest/dg/API_dataplane_StartSelector.html#KinesisVideo-Type-dataplane_StartSelector-StartSelectorType StartSelectorType>
...
--
-- 'fragmentSelectorType', 'fragmentSelector_fragmentSelectorType' - The origin of the timestamps to use, @Server@ or @Producer@. For more
-- information, see
-- <kinesisvideostreams/latest/dg/API_dataplane_StartSelector.html#KinesisVideo-Type-dataplane_StartSelector-StartSelectorType StartSelectorType>
-- in the /Amazon Kinesis Video Streams Developer Guide/.
--
...
instance Data.FromJSON FragmentSelector where
  parseJSON =
    Data.withObject
      "FragmentSelector"
      ( \x ->
          FragmentSelector'
            Prelude.<$> (x Data..: "FragmentSelectorType")
            Prelude.<*> (x Data..: "TimestampRange")
      )
