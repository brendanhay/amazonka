...
mkPutJobSuccessResult jobId
  = PutJobSuccessResult'{jobId, continuationToken = Core.Nothing,
                         currentRevision = Core.Nothing, executionDetails = Core.Nothing,
...
{-# INLINEABLE pjsrContinuationToken #-}
...
{-# INLINEABLE pjsrCurrentRevision #-}
...
{-# INLINEABLE pjsrExecutionDetails #-}
{-# DEPRECATED executionDetails "Use generic-lens or generic-optics with 'executionDetails' instead"  #-}
...
{-# INLINEABLE pjsrOutputVariables #-}
...
instance Core.AWSRequest PutJobSuccessResult where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull PutJobSuccessResultResponse'
