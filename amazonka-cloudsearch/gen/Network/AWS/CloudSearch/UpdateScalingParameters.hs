...
updateScalingParametersResponse :: Status -> ScalingParametersStatus -> UpdateScalingParametersResponse
...
-- | FIXME: Undocumented member.
usprStatus :: Lens' UpdateScalingParametersResponse Status
