...
dtacsCheckIds :: Lens.Lens' DescribeTrustedAdvisorCheckSummaries [Core.Text]
dtacsCheckIds = Lens.field @"checkIds"
{-# INLINEABLE dtacsCheckIds #-}
{-# DEPRECATED checkIds "Use generic-lens or generic-optics with 'checkIds' instead"  #-}

instance Core.ToQuery DescribeTrustedAdvisorCheckSummaries where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeTrustedAdvisorCheckSummaries where
        toHeaders DescribeTrustedAdvisorCheckSummaries{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeTrustedAdvisorCheckSummaries where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeTrustedAdvisorCheckSummariesResponse' Core.<$>
                   (x Core..:? "summaries" Core..!= Core.mempty) Core.<*>
...
{-# INLINEABLE dtacsrrsResponseStatus #-}
