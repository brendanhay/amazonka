...
`2.0` - Derived from API version @2013-11-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.CloudTrail](http://hackage.haskell.org/package/amazonka-cloudtrail/docs/Amazonka-CloudTrail.html)
