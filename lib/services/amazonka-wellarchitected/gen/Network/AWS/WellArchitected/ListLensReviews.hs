...
-- |
-- Module      : Network.AWS.WellArchitected.ListLensReviews
...
instance Prelude.Hashable ListLensReviews

instance Prelude.NFData ListLensReviews
...
instance Prelude.NFData ListLensReviewsResponse
