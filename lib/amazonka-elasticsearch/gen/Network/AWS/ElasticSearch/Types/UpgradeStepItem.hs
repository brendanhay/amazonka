...
mkUpgradeStepItem
    :: UpgradeStepItem
mkUpgradeStepItem
  = UpgradeStepItem'{issues = Core.Nothing,
                     progressPercent = Core.Nothing, upgradeStep = Core.Nothing,
...
{-# INLINEABLE usiIssues #-}
{-# DEPRECATED issues "Use generic-lens or generic-optics with 'issues' instead"  #-}
...
{-# INLINEABLE usiUpgradeStepStatus #-}
{-# DEPRECATED upgradeStepStatus "Use generic-lens or generic-optics with 'upgradeStepStatus' instead"  #-}

instance Core.FromJSON UpgradeStepItem where
        parseJSON
          = Core.withObject "UpgradeStepItem" Core.$
              \ x ->
                UpgradeStepItem' Core.<$>
                  (x Core..:? "Issues") Core.<*> x Core..:? "ProgressPercent"
