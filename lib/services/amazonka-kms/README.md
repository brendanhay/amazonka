...
`2.0` - Derived from API version @2014-11-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.KMS](http://hackage.haskell.org/package/amazonka-kms/docs/Amazonka-KMS.html)
