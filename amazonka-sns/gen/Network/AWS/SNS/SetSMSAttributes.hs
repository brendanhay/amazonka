...
--
-- For an example bucket policy and usage report, see <http://docs.aws.amazon.com/sns/latest/dg/sms_stats.html Viewing Statistics About SMS Message Delivery> in the /Amazon SNS Developer Guide/.
