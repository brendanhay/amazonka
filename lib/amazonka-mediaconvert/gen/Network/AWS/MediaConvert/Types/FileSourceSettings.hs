...
mkFileSourceSettings
    :: FileSourceSettings
mkFileSourceSettings
  = FileSourceSettings'{convert608To708 = Core.Nothing,
                        framerate = Core.Nothing, sourceFile = Core.Nothing,
...
{-# INLINEABLE fssTimeDelta #-}
{-# DEPRECATED timeDelta "Use generic-lens or generic-optics with 'timeDelta' instead"  #-}
          ...
          = Core.withObject "FileSourceSettings" Core.$
              \ x ->
                FileSourceSettings' Core.<$>
                  (x Core..:? "convert608To708") Core.<*> x Core..:? "framerate"
