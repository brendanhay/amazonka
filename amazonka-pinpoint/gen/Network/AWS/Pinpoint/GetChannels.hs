...
--
-- * 'gcsApplicationId' - The unique ID of your Amazon Pinpoint application.
getChannels
    :: Text -- ^ 'gcsApplicationId'
    -> GetChannels
getChannels pApplicationId_ = GetChannels' {_gcsApplicationId = pApplicationId_}
...
instance Hashable GetChannels where

instance NFData GetChannels where
...
instance ToPath GetChannels where
        toPath GetChannels'{..}
          = mconcat
              ["/v1/apps/", toBS _gcsApplicationId, "/channels"]
...
getChannelsResponse
    ...
    -> ChannelsResponse -- ^ 'gcsrsChannelsResponse'
    -> GetChannelsResponse
...
instance NFData GetChannelsResponse where
