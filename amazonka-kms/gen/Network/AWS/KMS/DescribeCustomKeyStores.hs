...
--
-- Gets information about <http://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html custom key stores> in the account and region.
--
--
...
--
-- For help repairing your custom key store, see the <http://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore-html Troubleshooting Custom Key Stores> topic in the /AWS Key Management Service Developer Guide/ .
--
module Network.AWS.KMS.DescribeCustomKeyStores
    (
    -- * Creating a Request
...
data DescribeCustomKeyStores = DescribeCustomKeyStores'
  { _dckssCustomKeyStoreName :: !(Maybe Text)
...
data DescribeCustomKeyStoresResponse = DescribeCustomKeyStoresResponse'
  { _dckssrsTruncated       :: !(Maybe Bool)
  , _dckssrsNextMarker      :: !(Maybe Text)
  , _dckssrsCustomKeyStores :: !(Maybe [CustomKeyStoresListEntry])
  , _dckssrsResponseStatus  :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dckssrsTruncated' - A flag that indicates whether there are more items in the list. When this value is true, the list in this response is truncated. To get more items, pass the value of the @NextMarker@ element in this response to the @Marker@ parameter in a subsequent request.
--
