...
mkSearchResources resourceQuery
  = SearchResources'{resourceQuery, maxResults = Core.Nothing,
...
instance Core.AWSRequest SearchResources where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         Core._rqMethod = Request.POST, Core._rqPath = "/resources/search",
...
mkSearchResourcesResponse responseStatus
  = SearchResourcesResponse'{nextToken = Core.Nothing,
...
{-# INLINEABLE srrrsResourceIdentifiers #-}
