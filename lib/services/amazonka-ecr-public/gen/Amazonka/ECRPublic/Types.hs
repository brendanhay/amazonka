...
_RepositoryCatalogDataNotFoundException :: (Core.AsError a) => Lens.Fold a Core.ServiceError
_RepositoryCatalogDataNotFoundException =
  Core._MatchServiceError
    defaultService
...
-- | The upload can\'t be found, or the specified upload ID isn\'t valid for
-- this repository.
