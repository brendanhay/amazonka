...
mkPutSecretValue secretId
  = PutSecretValue'{secretId, clientRequestToken = Core.Nothing,
...
{-# INLINEABLE psvClientRequestToken #-}
...
mkPutSecretValueResponse responseStatus
  = PutSecretValueResponse'{arn = Core.Nothing, name = Core.Nothing,
...
{-# INLINEABLE psvrrsVersionStages #-}
{-# DEPRECATED versionStages "Use generic-lens or generic-optics with 'versionStages' instead"  #-}
...
{-# INLINEABLE psvrrsResponseStatus #-}
