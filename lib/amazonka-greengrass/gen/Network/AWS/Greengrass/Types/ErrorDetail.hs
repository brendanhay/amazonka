...
mkErrorDetail
    :: ErrorDetail
mkErrorDetail
  = ErrorDetail'{detailedErrorCode = Core.Nothing,
...
{-# INLINEABLE edDetailedErrorCode #-}
{-# DEPRECATED detailedErrorCode "Use generic-lens or generic-optics with 'detailedErrorCode' instead"  #-}
...
{-# INLINEABLE edDetailedErrorMessage #-}
{-# DEPRECATED detailedErrorMessage "Use generic-lens or generic-optics with 'detailedErrorMessage' instead"  #-}
...
instance Core.FromJSON ErrorDetail where
        parseJSON
          = Core.withObject "ErrorDetail" Core.$
              \ x ->
                ErrorDetail' Core.<$>
                  (x Core..:? "DetailedErrorCode") Core.<*>
                    x Core..:? "DetailedErrorMessage"
