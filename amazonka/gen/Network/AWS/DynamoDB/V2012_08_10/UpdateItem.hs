...
updateItem :: HashMap Text AttributeValue -- ^ '_uiiKey'
           -> Text -- ^ '_uiiTableName'
           -> UpdateItem
...
data UpdateItem = UpdateItem
    ...
    , _uiiExpected :: HashMap Text ExpectedAttributeValue
...
data UpdateItemResponse = UpdateItemResponse
    { _uioAttributes :: HashMap Text AttributeValue
