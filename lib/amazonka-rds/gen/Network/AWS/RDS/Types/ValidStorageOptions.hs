...
vsoStorageType :: Lens.Lens' ValidStorageOptions (Core.Maybe Types.StorageType)
...
instance Core.FromXML ValidStorageOptions where
  parseXML x =
    ValidStorageOptions'
      Core.<$> ( x Core..@? "IopsToStorageRatio"
                   Core..<@> Core.parseXMLList "DoubleRange"
               )
      Core.<*> (x Core..@? "ProvisionedIops" Core..<@> Core.parseXMLList "Range")
      Core.<*> (x Core..@? "StorageSize" Core..<@> Core.parseXMLList "Range")
