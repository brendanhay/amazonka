...
mkResourceDataSyncS3Destination
    ...
    -> Types.ResourceDataSyncS3Format -- ^ 'syncFormat'
    -> Types.ResourceDataSyncS3Region -- ^ 'region'
    -> ResourceDataSyncS3Destination
mkResourceDataSyncS3Destination bucketName syncFormat region
  = ResourceDataSyncS3Destination'{bucketName, syncFormat, region,
                                   aWSKMSKeyARN = Core.Nothing,
                                   destinationDataSharing = Core.Nothing, prefix = Core.Nothing}
...
{-# INLINEABLE rdssdSyncFormat #-}
{-# DEPRECATED syncFormat "Use generic-lens or generic-optics with 'syncFormat' instead"  #-}
...
{-# INLINEABLE rdssdDestinationDataSharing #-}
{-# DEPRECATED destinationDataSharing "Use generic-lens or generic-optics with 'destinationDataSharing' instead"  #-}
...
instance Core.FromJSON ResourceDataSyncS3Destination where
        parseJSON
          = Core.withObject "ResourceDataSyncS3Destination" Core.$
              \ x ->
                ResourceDataSyncS3Destination' Core.<$>
                  (x Core..: "BucketName") Core.<*> x Core..: "SyncFormat" Core.<*>
                    x Core..: "Region"
