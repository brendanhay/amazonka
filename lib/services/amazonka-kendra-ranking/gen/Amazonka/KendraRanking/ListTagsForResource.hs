...
-- |
-- Module      : Amazonka.KendraRanking.ListTagsForResource
...
-- execution plan. A rescore execution plan is an Amazon Kendra Intelligent
...
--
-- 'resourceARN', 'listTagsForResource_resourceARN' - The Amazon Resource Name (ARN) of the rescore execution plan to get a
-- list of tags for.
newListTagsForResource ::
  -- | 'resourceARN'
  Prelude.Text ->
...
instance Data.ToHeaders ListTagsForResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "AWSKendraRerankingFrontendService.ListTagsForResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
-- for backwards compatibility:
--
-- 'tags', 'listTagsForResourceResponse_tags' - A list of tags associated with the rescore execution plan.
--
