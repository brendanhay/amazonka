...
mkQueryExecution
    :: QueryExecution
mkQueryExecution
  = QueryExecution'{query = Core.Nothing,
                    queryExecutionContext = Core.Nothing,
                    queryExecutionId = Core.Nothing,
                    resultConfiguration = Core.Nothing, statementType = Core.Nothing,
...
{-# INLINEABLE qeQueryExecutionContext #-}
...
{-# INLINEABLE qeResultConfiguration #-}
...
{-# INLINEABLE qeStatementType #-}
{-# DEPRECATED statementType "Use generic-lens or generic-optics with 'statementType' instead"  #-}
...
instance Core.FromJSON QueryExecution where
        parseJSON
          = Core.withObject "QueryExecution" Core.$
              \ x ->
                QueryExecution' Core.<$>
                  (x Core..:? "Query") Core.<*> x Core..:? "QueryExecutionContext"
