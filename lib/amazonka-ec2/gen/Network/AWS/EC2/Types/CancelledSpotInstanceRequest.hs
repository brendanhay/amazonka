...
csirSpotInstanceRequestId :: Lens.Lens' CancelledSpotInstanceRequest (Core.Maybe Core.Text)
csirSpotInstanceRequestId = Lens.field @"spotInstanceRequestId"
{-# INLINEABLE csirSpotInstanceRequestId #-}
...
{-# INLINEABLE csirState #-}
{-# DEPRECATED state "Use generic-lens or generic-optics with 'state' instead"  #-}

instance Core.FromXML CancelledSpotInstanceRequest where
        parseXML x
          = CancelledSpotInstanceRequest' Core.<$>
              (x Core..@? "spotInstanceRequestId") Core.<*> x Core..@? "state"
