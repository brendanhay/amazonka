...
mkStack
    ...
    -> Stack
mkStack name
  = Stack'{name, accessEndpoints = Core.Nothing,
           applicationSettings = Core.Nothing, arn = Core.Nothing,
           ...
           stackErrors = Core.Nothing, storageConnectors = Core.Nothing,
           userSettings = Core.Nothing}

-- | The name of the stack.
--
-- /Note:/ Consider using 'name' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
sName :: Lens.Lens' Stack Core.Text
...
{-# INLINEABLE sApplicationSettings #-}
...
sDisplayName :: Lens.Lens' Stack (Core.Maybe Core.Text)
sDisplayName = Lens.field @"displayName"
{-# INLINEABLE sDisplayName #-}
...
{-# INLINEABLE sStackErrors #-}
{-# DEPRECATED stackErrors "Use generic-lens or generic-optics with 'stackErrors' instead"  #-}
