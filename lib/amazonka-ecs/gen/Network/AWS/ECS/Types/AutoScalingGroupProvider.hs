...
asgpAutoScalingGroupArn :: Lens.Lens' AutoScalingGroupProvider Core.Text
asgpAutoScalingGroupArn = Lens.field @"autoScalingGroupArn"
{-# INLINEABLE asgpAutoScalingGroupArn #-}
...
{-# INLINEABLE asgpManagedTerminationProtection #-}
...
instance Core.FromJSON AutoScalingGroupProvider where
        parseJSON
          = Core.withObject "AutoScalingGroupProvider" Core.$
              \ x ->
                AutoScalingGroupProvider' Core.<$>
                  (x Core..: "autoScalingGroupArn") Core.<*>
                    x Core..:? "managedScaling"
