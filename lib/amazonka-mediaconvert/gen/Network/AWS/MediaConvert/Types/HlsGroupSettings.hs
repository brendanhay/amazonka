...
mkHlsGroupSettings
    :: HlsGroupSettings
mkHlsGroupSettings
  = HlsGroupSettings'{adMarkers = Core.Nothing,
                      additionalManifests = Core.Nothing, audioOnlyHeader = Core.Nothing,
                      baseUrl = Core.Nothing, captionLanguageMappings = Core.Nothing,
                      ...
                      directoryStructure = Core.Nothing, encryption = Core.Nothing,
                      manifestCompression = Core.Nothing,
                      manifestDurationFormat = Core.Nothing,
                      minFinalSegmentLength = Core.Nothing,
                      minSegmentLength = Core.Nothing, outputSelection = Core.Nothing,
                      programDateTime = Core.Nothing,
                      programDateTimePeriod = Core.Nothing,
                      segmentControl = Core.Nothing, segmentLength = Core.Nothing,
...
{-# INLINEABLE hgsAdditionalManifests #-}
...
{-# INLINEABLE hgsAudioOnlyHeader #-}
{-# DEPRECATED audioOnlyHeader "Use generic-lens or generic-optics with 'audioOnlyHeader' instead"  #-}
...
{-# INLINEABLE hgsDestinationSettings #-}
...
{-# INLINEABLE hgsMinFinalSegmentLength #-}
          ...
          = Core.withObject "HlsGroupSettings" Core.$
              \ x ->
                HlsGroupSettings' Core.<$>
                  (x Core..:? "adMarkers") Core.<*> x Core..:? "additionalManifests"
