...
{-# INLINEABLE csfrsiCurrentSpotFleetRequestState #-}
{-# DEPRECATED currentSpotFleetRequestState "Use generic-lens or generic-optics with 'currentSpotFleetRequestState' instead"  #-}
...
{-# INLINEABLE csfrsiPreviousSpotFleetRequestState #-}
{-# DEPRECATED previousSpotFleetRequestState "Use generic-lens or generic-optics with 'previousSpotFleetRequestState' instead"  #-}
...
csfrsiSpotFleetRequestId :: Lens.Lens' CancelSpotFleetRequestsSuccessItem (Core.Maybe Core.Text)
csfrsiSpotFleetRequestId = Lens.field @"spotFleetRequestId"
{-# INLINEABLE csfrsiSpotFleetRequestId #-}
...
instance Core.FromXML CancelSpotFleetRequestsSuccessItem where
        parseXML x
          = CancelSpotFleetRequestsSuccessItem' Core.<$>
              (x Core..@? "currentSpotFleetRequestState") Core.<*>
                x Core..@? "previousSpotFleetRequestState"
