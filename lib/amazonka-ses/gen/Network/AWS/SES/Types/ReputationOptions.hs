...
mkReputationOptions
    :: ReputationOptions
mkReputationOptions
  = ReputationOptions'{lastFreshStart = Core.Nothing,
...
{-# INLINEABLE roLastFreshStart #-}
{-# DEPRECATED lastFreshStart "Use generic-lens or generic-optics with 'lastFreshStart' instead"  #-}
...
{-# INLINEABLE roReputationMetricsEnabled #-}
{-# DEPRECATED reputationMetricsEnabled "Use generic-lens or generic-optics with 'reputationMetricsEnabled' instead"  #-}
...
{-# INLINEABLE roSendingEnabled #-}
{-# DEPRECATED sendingEnabled "Use generic-lens or generic-optics with 'sendingEnabled' instead"  #-}

instance Core.FromXML ReputationOptions where
        parseXML x
          = ReputationOptions' Core.<$>
              (x Core..@? "LastFreshStart") Core.<*>
                x Core..@? "ReputationMetricsEnabled"
