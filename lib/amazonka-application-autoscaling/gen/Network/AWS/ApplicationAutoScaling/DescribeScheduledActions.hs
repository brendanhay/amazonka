...
dScalableDimension :: Lens.Lens' DescribeScheduledActions (Lude.Maybe ScalableDimension)
dScalableDimension = Lens.lens (scalableDimension :: DescribeScheduledActions -> Lude.Maybe ScalableDimension) (\s a -> s {scalableDimension = a} :: DescribeScheduledActions)
{-# DEPRECATED dScalableDimension "Use generic-lens or generic-optics with 'scalableDimension' instead." #-}
...
dResourceId :: Lens.Lens' DescribeScheduledActions (Lude.Maybe Lude.Text)
dResourceId = Lens.lens (resourceId :: DescribeScheduledActions -> Lude.Maybe Lude.Text) (\s a -> s {resourceId = a} :: DescribeScheduledActions)
...
dServiceNamespace :: Lens.Lens' DescribeScheduledActions ServiceNamespace
dServiceNamespace = Lens.lens (serviceNamespace :: DescribeScheduledActions -> ServiceNamespace) (\s a -> s {serviceNamespace = a} :: DescribeScheduledActions)
{-# DEPRECATED dServiceNamespace "Use generic-lens or generic-optics with 'serviceNamespace' instead." #-}

-- | The token for the next set of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dNextToken :: Lens.Lens' DescribeScheduledActions (Lude.Maybe Lude.Text)
dNextToken = Lens.lens (nextToken :: DescribeScheduledActions -> Lude.Maybe Lude.Text) (\s a -> s {nextToken = a} :: DescribeScheduledActions)
...
dScheduledActionNames :: Lens.Lens' DescribeScheduledActions (Lude.Maybe [Lude.Text])
dScheduledActionNames = Lens.lens (scheduledActionNames :: DescribeScheduledActions -> Lude.Maybe [Lude.Text]) (\s a -> s {scheduledActionNames = a} :: DescribeScheduledActions)
{-# DEPRECATED dScheduledActionNames "Use generic-lens or generic-optics with 'scheduledActionNames' instead." #-}
...
dMaxResults :: Lens.Lens' DescribeScheduledActions (Lude.Maybe Lude.Int)
dMaxResults = Lens.lens (maxResults :: DescribeScheduledActions -> Lude.Maybe Lude.Int) (\s a -> s {maxResults = a} :: DescribeScheduledActions)
...
instance Page.AWSPager DescribeScheduledActions where
  page rq rs
    ...
    | Lude.otherwise =
      Lude.Just Lude.$
        rq
          Lude.& dNextToken Lens..~ rs Lens.^. dsarsNextToken
