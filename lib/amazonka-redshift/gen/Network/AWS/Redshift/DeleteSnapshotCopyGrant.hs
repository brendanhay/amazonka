...
dscgSnapshotCopyGrantName :: Lens.Lens' DeleteSnapshotCopyGrant Lude.Text
dscgSnapshotCopyGrantName = Lens.lens (snapshotCopyGrantName :: DeleteSnapshotCopyGrant -> Lude.Text) (\s a -> s {snapshotCopyGrantName = a} :: DeleteSnapshotCopyGrant)
