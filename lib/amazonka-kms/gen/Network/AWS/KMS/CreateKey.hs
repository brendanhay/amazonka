...
mkCreateKey
    :: CreateKey
mkCreateKey
  = CreateKey'{bypassPolicyLockoutSafetyCheck = Core.Nothing,
               customKeyStoreId = Core.Nothing,
               customerMasterKeySpec = Core.Nothing, description = Core.Nothing,
               keyUsage = Core.Nothing, origin = Core.Nothing,
               policy = Core.Nothing, tags = Core.Nothing}
...
{-# INLINEABLE ckBypassPolicyLockoutSafetyCheck #-}
{-# DEPRECATED bypassPolicyLockoutSafetyCheck "Use generic-lens or generic-optics with 'bypassPolicyLockoutSafetyCheck' instead"  #-}
...
{-# INLINEABLE ckCustomerMasterKeySpec #-}
...
instance Core.ToHeaders CreateKey where
        toHeaders CreateKey{..}
          = Core.pure ("X-Amz-Target", "TrentService.CreateKey") Core.<>
...
instance Core.FromJSON CreateKey where
        toJSON CreateKey{..}
          = Core.object
              (Core.catMaybes
                 [("BypassPolicyLockoutSafetyCheck" Core..=) Core.<$>
...
{-# INLINEABLE ckrrsResponseStatus #-}
