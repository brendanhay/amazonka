...
mkUpdateNFSFileShare fileShareARN
  = UpdateNFSFileShare'{fileShareARN, cacheAttributes = Core.Nothing,
...
{-# INLINEABLE unfsfsCacheAttributes #-}
...
{-# INLINEABLE unfsfsDefaultStorageClass #-}
...
{-# INLINEABLE unfsfsFileShareName #-}
...
{-# INLINEABLE unfsfsGuessMIMETypeEnabled #-}
...
{-# INLINEABLE unfsfsNFSFileShareDefaults #-}
...
{-# INLINEABLE unfsfsNotificationPolicy #-}
...
{-# INLINEABLE unfsfsRequesterPays #-}
...
instance Core.AWSRequest UpdateNFSFileShare where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateNFSFileShareResponse' Core.<$>
...
mkUpdateNFSFileShareResponse responseStatus
  = UpdateNFSFileShareResponse'{fileShareARN = Core.Nothing,
                                responseStatus}
...
{-# INLINEABLE unfsfsrrsFileShareARN #-}
{-# DEPRECATED fileShareARN "Use generic-lens or generic-optics with 'fileShareARN' instead"  #-}
...
{-# INLINEABLE unfsfsrrsResponseStatus #-}
