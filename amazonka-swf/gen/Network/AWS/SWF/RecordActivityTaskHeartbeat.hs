...
-- taskHeartbeatTimeout is specified in RegisterActivityType>. This action
-- does not in itself create an event in the workflow execution history.
-- However, if the task times out, the workflow execution history will contain
