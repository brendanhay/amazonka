...
mkAutoScalingPolicyDescription
    :: AutoScalingPolicyDescription
mkAutoScalingPolicyDescription
  = AutoScalingPolicyDescription'{constraints = Core.Nothing,
                                  rules = Core.Nothing, status = Core.Nothing}
          ...
          = Core.withObject "AutoScalingPolicyDescription" Core.$
              \ x ->
                AutoScalingPolicyDescription' Core.<$>
                  (x Core..:? "Constraints") Core.<*> x Core..:? "Rules" Core.<*>
                    x Core..:? "Status"
