...
mkChangeInfo
    :: Types.ResourceId -- ^ 'id'
    -> Types.ChangeStatus -- ^ 'status'
    -> Core.UTCTime -- ^ 'submittedAt'
    -> ChangeInfo
...
{-# INLINEABLE ciSubmittedAt #-}
{-# DEPRECATED submittedAt "Use generic-lens or generic-optics with 'submittedAt' instead"  #-}
