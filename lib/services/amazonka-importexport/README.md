...
`2.0` - Derived from API version @2010-06-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.ImportExport](http://hackage.haskell.org/package/amazonka-importexport/docs/Amazonka-ImportExport.html)
