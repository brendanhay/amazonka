...
mkEmbeddedDestinationSettings
    :: EmbeddedDestinationSettings
mkEmbeddedDestinationSettings
  = EmbeddedDestinationSettings'{destination608ChannelNumber =
                                   Core.Nothing,
...
{-# INLINEABLE edsDestination608ChannelNumber #-}
{-# DEPRECATED destination608ChannelNumber "Use generic-lens or generic-optics with 'destination608ChannelNumber' instead"  #-}
...
{-# INLINEABLE edsDestination708ServiceNumber #-}
{-# DEPRECATED destination708ServiceNumber "Use generic-lens or generic-optics with 'destination708ServiceNumber' instead"  #-}

instance Core.FromJSON EmbeddedDestinationSettings where
        toJSON EmbeddedDestinationSettings{..}
          = Core.object
              (Core.catMaybes
                 [("destination608ChannelNumber" Core..=) Core.<$>
                    destination608ChannelNumber,
                  ("destination708ServiceNumber" Core..=) Core.<$>
          ...
          = Core.withObject "EmbeddedDestinationSettings" Core.$
              \ x ->
                EmbeddedDestinationSettings' Core.<$>
                  (x Core..:? "destination608ChannelNumber") Core.<*>
                    x Core..:? "destination708ServiceNumber"
