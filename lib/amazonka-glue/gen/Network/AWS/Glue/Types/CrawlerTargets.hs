...
mkCrawlerTargets
    :: CrawlerTargets
mkCrawlerTargets
  = CrawlerTargets'{catalogTargets = Core.Nothing,
                    dynamoDBTargets = Core.Nothing, jdbcTargets = Core.Nothing,
                    mongoDBTargets = Core.Nothing, s3Targets = Core.Nothing}
...
{-# INLINEABLE ctCatalogTargets #-}
{-# DEPRECATED catalogTargets "Use generic-lens or generic-optics with 'catalogTargets' instead"  #-}
...
{-# INLINEABLE ctDynamoDBTargets #-}
{-# DEPRECATED dynamoDBTargets "Use generic-lens or generic-optics with 'dynamoDBTargets' instead"  #-}
...
{-# INLINEABLE ctJdbcTargets #-}
{-# DEPRECATED jdbcTargets "Use generic-lens or generic-optics with 'jdbcTargets' instead"  #-}
...
{-# INLINEABLE ctMongoDBTargets #-}
{-# DEPRECATED mongoDBTargets "Use generic-lens or generic-optics with 'mongoDBTargets' instead"  #-}
...
{-# INLINEABLE ctS3Targets #-}
{-# DEPRECATED s3Targets "Use generic-lens or generic-optics with 's3Targets' instead"  #-}
...
instance Core.FromJSON CrawlerTargets where
        parseJSON
          = Core.withObject "CrawlerTargets" Core.$
              \ x ->
                CrawlerTargets' Core.<$>
                  (x Core..:? "CatalogTargets") Core.<*> x Core..:? "DynamoDBTargets"
