...
mkRedshiftDestinationUpdate
  = RedshiftDestinationUpdate'{cloudWatchLoggingOptions =
                                 Core.Nothing,
                               clusterJDBCURL = Core.Nothing, copyCommand = Core.Nothing,
                               password = Core.Nothing, processingConfiguration = Core.Nothing,
                               retryOptions = Core.Nothing, roleARN = Core.Nothing,
                               s3BackupMode = Core.Nothing, s3BackupUpdate = Core.Nothing,
                               s3Update = Core.Nothing, username = Core.Nothing}
...
{-# INLINEABLE rduCloudWatchLoggingOptions #-}
...
{-# INLINEABLE rduProcessingConfiguration #-}
