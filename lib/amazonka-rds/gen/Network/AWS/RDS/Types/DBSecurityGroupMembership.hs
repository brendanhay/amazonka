...
mkDBSecurityGroupMembership
    :: DBSecurityGroupMembership
mkDBSecurityGroupMembership
  = DBSecurityGroupMembership'{dBSecurityGroupName = Core.Nothing,
                               status = Core.Nothing}
...
dbsgmDBSecurityGroupName :: Lens.Lens' DBSecurityGroupMembership (Core.Maybe Core.Text)
dbsgmDBSecurityGroupName = Lens.field @"dBSecurityGroupName"
{-# INLINEABLE dbsgmDBSecurityGroupName #-}
...
dbsgmStatus :: Lens.Lens' DBSecurityGroupMembership (Core.Maybe Core.Text)
dbsgmStatus = Lens.field @"status"
{-# INLINEABLE dbsgmStatus #-}
{-# DEPRECATED status "Use generic-lens or generic-optics with 'status' instead"  #-}

instance Core.FromXML DBSecurityGroupMembership where
        parseXML x
          = DBSecurityGroupMembership' Core.<$>
              (x Core..@? "DBSecurityGroupName") Core.<*> x Core..@? "Status"
