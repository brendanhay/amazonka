...
mkRevisionTarget
    :: RevisionTarget
mkRevisionTarget
  = RevisionTarget'{databaseRevision = Core.Nothing,
...
rtDatabaseRevision :: Lens.Lens' RevisionTarget (Core.Maybe Core.Text)
rtDatabaseRevision = Lens.field @"databaseRevision"
{-# INLINEABLE rtDatabaseRevision #-}
{-# DEPRECATED databaseRevision "Use generic-lens or generic-optics with 'databaseRevision' instead"  #-}
...
{-# INLINEABLE rtDatabaseRevisionReleaseDate #-}
...
rtDescription :: Lens.Lens' RevisionTarget (Core.Maybe Core.Text)
rtDescription = Lens.field @"description"
{-# INLINEABLE rtDescription #-}
{-# DEPRECATED description "Use generic-lens or generic-optics with 'description' instead"  #-}

instance Core.FromXML RevisionTarget where
        parseXML x
          = RevisionTarget' Core.<$>
              (x Core..@? "DatabaseRevision") Core.<*>
                x Core..@? "DatabaseRevisionReleaseDate"
