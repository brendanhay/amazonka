...
mkAuditSuppression checkName resourceIdentifier
  = AuditSuppression'{checkName, resourceIdentifier,
...
{-# INLINEABLE asResourceIdentifier #-}
...
{-# INLINEABLE asSuppressIndefinitely #-}
...
instance Core.FromJSON AuditSuppression where
        parseJSON
          = Core.withObject "AuditSuppression" Core.$
              \ x ->
                AuditSuppression' Core.<$>
                  (x Core..: "checkName") Core.<*> x Core..: "resourceIdentifier"
