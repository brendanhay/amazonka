...
-- | Creates a 'DeregisterScalableTarget' value with any optional fields omitted.
mkDeregisterScalableTarget
    :: Types.ServiceNamespace -- ^ 'serviceNamespace'
    -> Types.ResourceIdMaxLen1600 -- ^ 'resourceId'
    -> Types.ScalableDimension -- ^ 'scalableDimension'
    -> DeregisterScalableTarget
mkDeregisterScalableTarget serviceNamespace resourceId
  scalableDimension
  = DeregisterScalableTarget'{serviceNamespace, resourceId,
                              scalableDimension}
...
dstfServiceNamespace :: Lens.Lens' DeregisterScalableTarget Types.ServiceNamespace
dstfServiceNamespace = Lens.field @"serviceNamespace"
{-# INLINEABLE dstfServiceNamespace #-}
...
dstfResourceId :: Lens.Lens' DeregisterScalableTarget Types.ResourceIdMaxLen1600
dstfResourceId = Lens.field @"resourceId"
{-# INLINEABLE dstfResourceId #-}
...
dstfScalableDimension :: Lens.Lens' DeregisterScalableTarget Types.ScalableDimension
dstfScalableDimension = Lens.field @"scalableDimension"
{-# INLINEABLE dstfScalableDimension #-}
...
instance Core.ToHeaders DeregisterScalableTarget where
        toHeaders DeregisterScalableTarget{..}
          = Core.pure
              ("X-Amz-Target",
               "AnyScaleFrontendService.DeregisterScalableTarget")
              Core.<> Core.pure ("Content-Type", "application/x-amz-json-1.1")

instance Core.FromJSON DeregisterScalableTarget where
...
instance Core.AWSRequest DeregisterScalableTarget where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 DeregisterScalableTargetResponse' Core.<$>
...
-- | Creates a 'DeregisterScalableTargetResponse' value with any optional fields omitted.
mkDeregisterScalableTargetResponse
    :: Core.Int -- ^ 'responseStatus'
    -> DeregisterScalableTargetResponse
mkDeregisterScalableTargetResponse responseStatus
  = DeregisterScalableTargetResponse'{responseStatus}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dstrrsResponseStatus :: Lens.Lens' DeregisterScalableTargetResponse Core.Int
