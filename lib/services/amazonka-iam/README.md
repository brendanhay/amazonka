...
`1.6.1` - Derived from API version @2010-05-08@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.IAM](http://hackage.haskell.org/package/amazonka-iam/docs/Network-AWS-IAM.html)
