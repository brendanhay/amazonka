...
mkInput
    ...
    -> Types.SourceSchema -- ^ 'inputSchema'
    -> Input
mkInput namePrefix inputSchema
  = Input'{namePrefix, inputSchema, inputParallelism = Core.Nothing,
...
{-# INLINEABLE iInputProcessingConfiguration #-}
...
{-# INLINEABLE iKinesisFirehoseInput #-}
{-# DEPRECATED kinesisFirehoseInput "Use generic-lens or generic-optics with 'kinesisFirehoseInput' instead"  #-}
...
{-# INLINEABLE iKinesisStreamsInput #-}
{-# DEPRECATED kinesisStreamsInput "Use generic-lens or generic-optics with 'kinesisStreamsInput' instead"  #-}
