...
mkListFragments streamName
  = ListFragments'{streamName, fragmentSelector = Core.Nothing,
...
{-# INLINEABLE lfFragmentSelector #-}
{-# DEPRECATED fragmentSelector "Use generic-lens or generic-optics with 'fragmentSelector' instead"  #-}
...
instance Core.AWSRequest ListFragments where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         Core._rqMethod = Request.POST, Core._rqPath = "/listFragments",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListFragmentsResponse' Core.<$>
                   (x Core..:? "Fragments") Core.<*> x Core..:? "NextToken" Core.<*>
...
mkListFragmentsResponse responseStatus
  = ListFragmentsResponse'{fragments = Core.Nothing,
