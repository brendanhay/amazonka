...
mkJobTemplateSettings
    :: JobTemplateSettings
mkJobTemplateSettings
  = JobTemplateSettings'{adAvailOffset = Core.Nothing,
...
{-# INLINEABLE jtsMotionImageInserter #-}
...
{-# INLINEABLE jtsNielsenConfiguration #-}
...
{-# INLINEABLE jtsNielsenNonLinearWatermark #-}
...
{-# INLINEABLE jtsTimedMetadataInsertion #-}
