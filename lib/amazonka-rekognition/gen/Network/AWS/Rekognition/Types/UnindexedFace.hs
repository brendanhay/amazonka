...
{-# INLINEABLE ufFaceDetail #-}
{-# DEPRECATED faceDetail "Use generic-lens or generic-optics with 'faceDetail' instead"  #-}
...
{-# INLINEABLE ufReasons #-}
{-# DEPRECATED reasons "Use generic-lens or generic-optics with 'reasons' instead"  #-}
...
instance Core.FromJSON UnindexedFace where
        parseJSON
          = Core.withObject "UnindexedFace" Core.$
              \ x ->
                UnindexedFace' Core.<$>
                  (x Core..:? "FaceDetail") Core.<*> x Core..:? "Reasons"
