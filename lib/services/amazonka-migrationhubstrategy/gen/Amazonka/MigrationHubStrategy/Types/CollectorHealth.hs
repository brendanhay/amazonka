...
pattern CollectorHealth_COLLECTOR_HEALTHY = CollectorHealth' "COLLECTOR_HEALTHY"

pattern CollectorHealth_COLLECTOR_UNHEALTHY :: CollectorHealth
pattern CollectorHealth_COLLECTOR_UNHEALTHY = CollectorHealth' "COLLECTOR_UNHEALTHY"
