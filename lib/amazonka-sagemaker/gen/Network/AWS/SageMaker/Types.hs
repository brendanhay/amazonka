...
import Network.AWS.SageMaker.Types.OutputName
...
import Network.AWS.SageMaker.Types.String
...
import Network.AWS.SageMaker.Types.SubDomain
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "SageMaker",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "api.sagemaker",
      Core._svcVersion = "2017-07-24",
