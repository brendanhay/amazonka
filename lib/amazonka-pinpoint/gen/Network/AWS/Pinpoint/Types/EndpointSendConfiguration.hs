...
mkEndpointSendConfiguration
    :: EndpointSendConfiguration
mkEndpointSendConfiguration
  = EndpointSendConfiguration'{bodyOverride = Core.Nothing,
                               context = Core.Nothing, rawContent = Core.Nothing,
                               substitutions = Core.Nothing, titleOverride = Core.Nothing}
