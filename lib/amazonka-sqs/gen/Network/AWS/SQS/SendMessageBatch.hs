...
smbQueueUrl :: Lens.Lens' SendMessageBatch Core.Text
smbQueueUrl = Lens.field @"queueUrl"
{-# INLINEABLE smbQueueUrl #-}
...
instance Core.ToQuery SendMessageBatch where
        toQuery SendMessageBatch{..}
          = Core.toQueryPair "Action" ("SendMessageBatch" :: Core.Text)
...
instance Core.AWSRequest SendMessageBatch where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "SendMessageBatchResult"
              (\ s h x ->
                 SendMessageBatchResponse' Core.<$>
                   (x Core..@ "SendMessageBatchResultEntry" Core..@! Core.mempty)
...
mkSendMessageBatchResponse responseStatus
  = SendMessageBatchResponse'{successful = Core.mempty,
