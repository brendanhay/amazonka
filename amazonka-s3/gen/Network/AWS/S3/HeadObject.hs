...
-- | Return the object only if it has not been modified since the specified
-- time, otherwise return a 412 (precondition failed).
headObject_ifUnmodifiedSince :: Lens.Lens' HeadObject (Core.Maybe Core.UTCTime)
headObject_ifUnmodifiedSince = Lens.lens (\HeadObject' {ifUnmodifiedSince} -> ifUnmodifiedSince) (\s@HeadObject' {} a -> s {ifUnmodifiedSince = a} :: HeadObject) Core.. Lens.mapping Core._Time
...
-- Amazon S3 doesn\'t support retrieving multiple ranges of data per @GET@
-- request.
headObject_range :: Lens.Lens' HeadObject (Core.Maybe Core.Text)
headObject_range = Lens.lens (\HeadObject' {range} -> range) (\s@HeadObject' {} a -> s {range = a} :: HeadObject)

-- | Return the object only if it has been modified since the specified time,
-- otherwise return a 304 (not modified).
headObject_ifModifiedSince :: Lens.Lens' HeadObject (Core.Maybe Core.UTCTime)
headObject_ifModifiedSince = Lens.lens (\HeadObject' {ifModifiedSince} -> ifModifiedSince) (\s@HeadObject' {} a -> s {ifModifiedSince = a} :: HeadObject) Core.. Lens.mapping Core._Time

-- | The account id of the expected bucket owner. If the bucket is owned by a
-- different account, the request will fail with an HTTP
-- @403 (Access Denied)@ error.
headObject_expectedBucketOwner :: Lens.Lens' HeadObject (Core.Maybe Core.Text)
...
-- 1321. Amazon S3 uses this header for a message integrity check to ensure
-- that the encryption key was transmitted without error.
headObject_sSECustomerKeyMD5 :: Lens.Lens' HeadObject (Core.Maybe Core.Text)
...
-- | VersionId used to reference a specific version of the object.
headObject_versionId :: Lens.Lens' HeadObject (Core.Maybe ObjectVersionId)
headObject_versionId = Lens.lens (\HeadObject' {versionId} -> versionId) (\s@HeadObject' {} a -> s {versionId = a} :: HeadObject)

-- | Return the object only if its entity tag (ETag) is the same as the one
-- specified, otherwise return a 412 (precondition failed).
headObject_ifMatch :: Lens.Lens' HeadObject (Core.Maybe Core.Text)
...
-- | Undocumented member.
headObject_requestPayer :: Lens.Lens' HeadObject (Core.Maybe RequestPayer)
...
-- appropriate for use with the algorithm specified in the
-- @x-amz-server-side-encryption-customer-algorithm@ header.
headObject_sSECustomerKey :: Lens.Lens' HeadObject (Core.Maybe Core.Text)
headObject_sSECustomerKey = Lens.lens (\HeadObject' {sSECustomerKey} -> sSECustomerKey) (\s@HeadObject' {} a -> s {sSECustomerKey = a} :: HeadObject) Core.. Lens.mapping Core._Sensitive
    ...
    Response.receiveEmpty
      ( \s h x ->
          HeadObjectResponse'
            ...
            Core.<*> (h Core..#? "x-amz-archive-status")
...
instance Core.Hashable HeadObject

instance Core.NFData HeadObject
...
data HeadObjectResponse = HeadObjectResponse'
  { -- | An ETag is an opaque identifier assigned by a web server to a specific
    ...
    archiveStatus :: Core.Maybe ArchiveStatus,
...
-- | An ETag is an opaque identifier assigned by a web server to a specific
-- version of a resource found at a URL.
headObjectResponse_eTag :: Lens.Lens' HeadObjectResponse (Core.Maybe ETag)
headObjectResponse_eTag = Lens.lens (\HeadObjectResponse' {eTag} -> eTag) (\s@HeadObjectResponse' {} a -> s {eTag = a} :: HeadObjectResponse)

-- | Undocumented member.
headObjectResponse_requestCharged :: Lens.Lens' HeadObjectResponse (Core.Maybe RequestCharged)
...
-- | The count of parts this object has.
headObjectResponse_partsCount :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Int)
...
-- object to another object in the same bucket or to an external URL.
-- Amazon S3 stores the value of this header in the object metadata.
headObjectResponse_websiteRedirectLocation :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- | A standard MIME type describing the format of the object data.
headObjectResponse_contentType :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- | Specifies presentational information for the object.
headObjectResponse_contentDisposition :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- | The archive state of the head object.
headObjectResponse_archiveStatus :: Lens.Lens' HeadObjectResponse (Core.Maybe ArchiveStatus)
...
-- Delete Marker. If false, this response header does not appear in the
-- response.
headObjectResponse_deleteMarker :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Bool)
...
-- key-value pairs providing object expiration information. The value of
-- the rule-id is URL encoded.
headObjectResponse_expiration :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- | The language the content is in.
headObjectResponse_contentLanguage :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- For more information, see
-- <https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html Replication>.
headObjectResponse_replicationStatus :: Lens.Lens' HeadObjectResponse (Core.Maybe ReplicationStatus)
...
-- | A map of metadata to store with the object in S3.
headObjectResponse_metadata :: Lens.Lens' HeadObjectResponse (Core.HashMap Core.Text Core.Text)
headObjectResponse_metadata = Lens.lens (\HeadObjectResponse' {metadata} -> metadata) (\s@HeadObjectResponse' {} a -> s {metadata = a} :: HeadObjectResponse) Core.. Lens._Coerce

-- | Size of the body in bytes.
headObjectResponse_contentLength :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Integer)
...
-- thus what decoding mechanisms must be applied to obtain the media-type
-- referenced by the Content-Type header field.
headObjectResponse_contentEncoding :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- symmetric customer managed customer master key (CMK) that was used for
-- the object.
headObjectResponse_sSEKMSKeyId :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
headObjectResponse_sSEKMSKeyId = Lens.lens (\HeadObjectResponse' {sSEKMSKeyId} -> sSEKMSKeyId) (\s@HeadObjectResponse' {} a -> s {sSEKMSKeyId = a} :: HeadObjectResponse) Core.. Lens.mapping Core._Sensitive

-- | If server-side encryption with a customer-provided encryption key was
-- requested, the response will include this header to provide round-trip
-- message integrity verification of the customer-provided encryption key.
headObjectResponse_sSECustomerKeyMD5 :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- For more information, see
-- <https://docs.aws.amazon.com/AmazonS3/latest/dev/storage-class-intro.html Storage Classes>.
headObjectResponse_storageClass :: Lens.Lens' HeadObjectResponse (Core.Maybe StorageClass)
...
-- | Version of the object.
headObjectResponse_versionId :: Lens.Lens' HeadObjectResponse (Core.Maybe ObjectVersionId)
...
-- | Indicates that a range of bytes was specified.
headObjectResponse_acceptRanges :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- | Indicates whether the object uses an S3 Bucket Key for server-side
-- encryption with AWS KMS (SSE-KMS).
headObjectResponse_bucketKeyEnabled :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Bool)
...
-- encryption algorithm used when storing this object in Amazon S3 (for
-- example, AES256, aws:kms).
headObjectResponse_serverSideEncryption :: Lens.Lens' HeadObjectResponse (Core.Maybe ServerSideEncryption)
...
-- For example, using SOAP, you can create metadata whose values are not
-- legal HTTP headers.
headObjectResponse_missingMeta :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Int)
...
-- Object Lock, see
-- <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html Object Lock>.
headObjectResponse_objectLockLegalHoldStatus :: Lens.Lens' HeadObjectResponse (Core.Maybe ObjectLockLegalHoldStatus)
...
-- requested, the response will include this header confirming the
-- encryption algorithm used.
headObjectResponse_sSECustomerAlgorithm :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- | Creation date of the object.
headObjectResponse_lastModified :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.UTCTime)
headObjectResponse_lastModified = Lens.lens (\HeadObjectResponse' {lastModified} -> lastModified) (\s@HeadObjectResponse' {} a -> s {lastModified = a} :: HeadObjectResponse) Core.. Lens.mapping Core._Time

-- | Specifies caching behavior along the request\/reply chain.
headObjectResponse_cacheControl :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- | The date and time at which the object is no longer cacheable.
headObjectResponse_expires :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.UTCTime)
headObjectResponse_expires = Lens.lens (\HeadObjectResponse' {expires} -> expires) (\s@HeadObjectResponse' {} a -> s {expires = a} :: HeadObjectResponse) Core.. Lens.mapping Core._Time
...
-- For more information about archiving objects, see
-- <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html#lifecycle-transition-general-considerations Transitioning Objects: General Considerations>.
headObjectResponse_restore :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.Text)
...
-- permission. For more information about S3 Object Lock, see
-- <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html Object Lock>.
headObjectResponse_objectLockMode :: Lens.Lens' HeadObjectResponse (Core.Maybe ObjectLockMode)
...
-- header is only returned if the requester has the @s3:GetObjectRetention@
-- permission.
headObjectResponse_objectLockRetainUntilDate :: Lens.Lens' HeadObjectResponse (Core.Maybe Core.UTCTime)
headObjectResponse_objectLockRetainUntilDate = Lens.lens (\HeadObjectResponse' {objectLockRetainUntilDate} -> objectLockRetainUntilDate) (\s@HeadObjectResponse' {} a -> s {objectLockRetainUntilDate = a} :: HeadObjectResponse) Core.. Lens.mapping Core._Time

-- | The response's http status code.
headObjectResponse_httpStatus :: Lens.Lens' HeadObjectResponse Core.Int
...
instance Core.NFData HeadObjectResponse
