...
mkWorkspaceCreationProperties
  = WorkspaceCreationProperties'{customSecurityGroupId =
                                   Core.Nothing,
                                 defaultOu = Core.Nothing, enableInternetAccess = Core.Nothing,
...
{-# INLINEABLE wcpCustomSecurityGroupId #-}
...
{-# INLINEABLE wcpEnableInternetAccess #-}
...
{-# INLINEABLE wcpEnableMaintenanceMode #-}
...
{-# INLINEABLE wcpUserEnabledAsLocalAdministrator #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("CustomSecurityGroupId" Core..=) Core.<$> customSecurityGroupId,
                  ...
                  ("UserEnabledAsLocalAdministrator" Core..=) Core.<$>
