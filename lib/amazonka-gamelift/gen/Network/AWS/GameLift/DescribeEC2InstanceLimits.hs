...
{-# INLINEABLE decilEC2InstanceType #-}
...
instance Core.ToHeaders DescribeEC2InstanceLimits where
        toHeaders DescribeEC2InstanceLimits{..}
...
instance Core.AWSRequest DescribeEC2InstanceLimits where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeEC2InstanceLimitsResponse' Core.<$>
                   (x Core..:? "EC2InstanceLimits") Core.<*>
...
mkDescribeEC2InstanceLimitsResponse responseStatus
  = DescribeEC2InstanceLimitsResponse'{eC2InstanceLimits =
                                         Core.Nothing,
                                       responseStatus}
...
{-# INLINEABLE decilrrsEC2InstanceLimits #-}
{-# DEPRECATED eC2InstanceLimits "Use generic-lens or generic-optics with 'eC2InstanceLimits' instead"  #-}
...
{-# INLINEABLE decilrrsResponseStatus #-}
