...
`1.6.1` - Derived from API version @2010-08-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.CloudWatch](http://hackage.haskell.org/package/amazonka-cloudwatch/docs/Network-AWS-CloudWatch.html)
