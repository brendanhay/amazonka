...
mkRemediationParameterValue
    :: RemediationParameterValue
mkRemediationParameterValue
  = RemediationParameterValue'{resourceValue = Core.Nothing,
...
{-# INLINEABLE rpvResourceValue #-}
{-# DEPRECATED resourceValue "Use generic-lens or generic-optics with 'resourceValue' instead"  #-}
...
{-# INLINEABLE rpvStaticValue #-}
{-# DEPRECATED staticValue "Use generic-lens or generic-optics with 'staticValue' instead"  #-}
...
instance Core.FromJSON RemediationParameterValue where
        parseJSON
          = Core.withObject "RemediationParameterValue" Core.$
              \ x ->
                RemediationParameterValue' Core.<$>
                  (x Core..:? "ResourceValue") Core.<*> x Core..:? "StaticValue"
