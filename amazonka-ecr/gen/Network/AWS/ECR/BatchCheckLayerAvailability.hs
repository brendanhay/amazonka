  ...
  pLayerDigests_ =
    BatchCheckLayerAvailability'
      { registryId =
        ...
        layerDigests =
          Prelude._Coerce Lens.# pLayerDigests_
      }
...
batchCheckLayerAvailability_layerDigests = Lens.lens (\BatchCheckLayerAvailability' {layerDigests} -> layerDigests) (\s@BatchCheckLayerAvailability' {} a -> s {layerDigests = a} :: BatchCheckLayerAvailability) Prelude.. Prelude._Coerce
