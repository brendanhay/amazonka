...
_InvalidJobIdException =
    _MatchServiceError importExport "InvalidJobIdException"
...
_ExpiredJobIdException =
    _MatchServiceError importExport "ExpiredJobIdException"
...
_NoSuchBucketException =
    _MatchServiceError importExport "NoSuchBucketException"
