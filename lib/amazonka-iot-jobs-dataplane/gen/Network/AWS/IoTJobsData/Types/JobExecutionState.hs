...
mkJobExecutionState
    :: JobExecutionState
mkJobExecutionState
  = JobExecutionState'{status = Core.Nothing,
                       statusDetails = Core.Nothing, versionNumber = Core.Nothing}
...
instance Core.FromJSON JobExecutionState where
        parseJSON
          = Core.withObject "JobExecutionState" Core.$
              \ x ->
                JobExecutionState' Core.<$>
                  (x Core..:? "status") Core.<*> x Core..:? "statusDetails" Core.<*>
                    x Core..:? "versionNumber"
