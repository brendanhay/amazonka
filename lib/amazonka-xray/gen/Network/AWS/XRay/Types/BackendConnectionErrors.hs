...
mkBackendConnectionErrors
    :: BackendConnectionErrors
mkBackendConnectionErrors
  = BackendConnectionErrors'{connectionRefusedCount = Core.Nothing,
                             hTTPCode4XXCount = Core.Nothing, hTTPCode5XXCount = Core.Nothing,
                             otherCount = Core.Nothing, timeoutCount = Core.Nothing,
...
{-# INLINEABLE bceConnectionRefusedCount #-}
{-# DEPRECATED connectionRefusedCount "Use generic-lens or generic-optics with 'connectionRefusedCount' instead"  #-}
...
{-# INLINEABLE bceHTTPCode4XXCount #-}
{-# DEPRECATED hTTPCode4XXCount "Use generic-lens or generic-optics with 'hTTPCode4XXCount' instead"  #-}
...
{-# INLINEABLE bceHTTPCode5XXCount #-}
{-# DEPRECATED hTTPCode5XXCount "Use generic-lens or generic-optics with 'hTTPCode5XXCount' instead"  #-}
...
{-# INLINEABLE bceTimeoutCount #-}
{-# DEPRECATED timeoutCount "Use generic-lens or generic-optics with 'timeoutCount' instead"  #-}
...
{-# INLINEABLE bceUnknownHostCount #-}
{-# DEPRECATED unknownHostCount "Use generic-lens or generic-optics with 'unknownHostCount' instead"  #-}

instance Core.FromJSON BackendConnectionErrors where
        toJSON BackendConnectionErrors{..}
          = Core.object
              (Core.catMaybes
                 [("ConnectionRefusedCount" Core..=) Core.<$>
