...
instance Prelude.AWSRequest GetEmailChannel where
...
instance Prelude.ToHeaders GetEmailChannel where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath GetEmailChannel where
...
instance Prelude.ToQuery GetEmailChannel where
