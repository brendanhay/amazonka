...
mkListMailboxPermissions organizationId entityId
  = ListMailboxPermissions'{organizationId, entityId,
...
instance Core.ToHeaders ListMailboxPermissions where
        toHeaders ListMailboxPermissions{..}
          = Core.pure
...
instance Core.AWSRequest ListMailboxPermissions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListMailboxPermissionsResponse' Core.<$>
...
mkListMailboxPermissionsResponse responseStatus
  = ListMailboxPermissionsResponse'{nextToken = Core.Nothing,
