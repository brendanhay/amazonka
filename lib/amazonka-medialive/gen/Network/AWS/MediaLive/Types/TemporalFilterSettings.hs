...
mkTemporalFilterSettings
    :: TemporalFilterSettings
mkTemporalFilterSettings
  = TemporalFilterSettings'{postFilterSharpening = Core.Nothing,
...
{-# INLINEABLE tfsPostFilterSharpening #-}
{-# DEPRECATED postFilterSharpening "Use generic-lens or generic-optics with 'postFilterSharpening' instead"  #-}
          ...
          = Core.withObject "TemporalFilterSettings" Core.$
              \ x ->
                TemporalFilterSettings' Core.<$>
                  (x Core..:? "postFilterSharpening") Core.<*> x Core..:? "strength"
