...
instance AWSRequest GetCompatibleElasticsearchVersions where
  type
...
data GetCompatibleElasticsearchVersionsResponse = GetCompatibleElasticsearchVersionsResponse'
  { _gcevrsCompatibleElasticsearchVersions ::
      !( Maybe
...
instance NFData GetCompatibleElasticsearchVersionsResponse
