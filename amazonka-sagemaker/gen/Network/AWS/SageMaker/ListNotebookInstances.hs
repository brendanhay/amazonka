...
data ListNotebookInstances = ListNotebookInstances'
  { -- | A filter that returns only notebook instances that were modified before
    ...
    sortOrder :: Core.Maybe NotebookInstanceSortOrder,
    ...
    additionalCodeRepositoryEquals :: Core.Maybe Core.Text,
    ...
    -- string.
    defaultCodeRepositoryContains :: Core.Maybe Core.Text,
    -- | The field to sort results by. The default is @Name@.
    sortBy :: Core.Maybe NotebookInstanceSortKey,
    -- | A filter that returns only notebook instances with the specified status.
    statusEquals :: Core.Maybe NotebookInstanceStatus,
    ...
    notebookInstanceLifecycleConfigNameContains :: Core.Maybe Core.Text,
...
newListNotebookInstances =
  ListNotebookInstances'
    { lastModifiedTimeBefore =
      ...
      additionalCodeRepositoryEquals = Core.Nothing,
...
-- | A filter that returns only notebook instances that were modified before
-- the specified time (timestamp).
listNotebookInstances_lastModifiedTimeBefore :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.UTCTime)
listNotebookInstances_lastModifiedTimeBefore = Lens.lens (\ListNotebookInstances' {lastModifiedTimeBefore} -> lastModifiedTimeBefore) (\s@ListNotebookInstances' {} a -> s {lastModifiedTimeBefore = a} :: ListNotebookInstances) Core.. Lens.mapping Core._Time

-- | The sort order for results.
listNotebookInstances_sortOrder :: Lens.Lens' ListNotebookInstances (Core.Maybe NotebookInstanceSortOrder)
...
-- response is truncated, you must use the same values for the filer and
-- sort order in the next request.
listNotebookInstances_nextToken :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.Text)
...
-- | A string in the notebook instances\' name. This filter returns only
-- notebook instances whose name contains the specified string.
listNotebookInstances_nameContains :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.Text)
...
-- | A filter that returns only notebook instances with associated with the
-- specified git repository.
listNotebookInstances_additionalCodeRepositoryEquals :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.Text)
...
-- | The maximum number of notebook instances to return.
listNotebookInstances_maxResults :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.Natural)
...
-- | A filter that returns only notebook instances that were created before
-- the specified time (timestamp).
listNotebookInstances_creationTimeBefore :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.UTCTime)
listNotebookInstances_creationTimeBefore = Lens.lens (\ListNotebookInstances' {creationTimeBefore} -> creationTimeBefore) (\s@ListNotebookInstances' {} a -> s {creationTimeBefore = a} :: ListNotebookInstances) Core.. Lens.mapping Core._Time

-- | A filter that returns only notebook instances that were modified after
-- the specified time (timestamp).
listNotebookInstances_lastModifiedTimeAfter :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.UTCTime)
listNotebookInstances_lastModifiedTimeAfter = Lens.lens (\ListNotebookInstances' {lastModifiedTimeAfter} -> lastModifiedTimeAfter) (\s@ListNotebookInstances' {} a -> s {lastModifiedTimeAfter = a} :: ListNotebookInstances) Core.. Lens.mapping Core._Time

-- | A string in the name or URL of a Git repository associated with this
-- notebook instance. This filter returns only notebook instances
-- associated with a git repository with a name that contains the specified
-- string.
listNotebookInstances_defaultCodeRepositoryContains :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.Text)
...
-- | The field to sort results by. The default is @Name@.
listNotebookInstances_sortBy :: Lens.Lens' ListNotebookInstances (Core.Maybe NotebookInstanceSortKey)
...
-- | A filter that returns only notebook instances with the specified status.
listNotebookInstances_statusEquals :: Lens.Lens' ListNotebookInstances (Core.Maybe NotebookInstanceStatus)
...
-- notebook instances associated with a lifecycle configuration with a name
-- that contains the specified string.
listNotebookInstances_notebookInstanceLifecycleConfigNameContains :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.Text)
...
-- | A filter that returns only notebook instances that were created after
-- the specified time (timestamp).
listNotebookInstances_creationTimeAfter :: Lens.Lens' ListNotebookInstances (Core.Maybe Core.UTCTime)
listNotebookInstances_creationTimeAfter = Lens.lens (\ListNotebookInstances' {creationTimeAfter} -> creationTimeAfter) (\s@ListNotebookInstances' {} a -> s {creationTimeAfter = a} :: ListNotebookInstances) Core.. Lens.mapping Core._Time
    ...
    Response.receiveJSON
      ( \s h x ->
          ListNotebookInstancesResponse'
            ...
            Core.<*> (x Core..?> "NotebookInstances" Core..!@ Core.mempty)
            Core.<*> (Core.pure (Core.fromEnum s))
      )

instance Core.Hashable ListNotebookInstances

instance Core.NFData ListNotebookInstances
...
data ListNotebookInstancesResponse = ListNotebookInstancesResponse'
  { -- | If the response to the previous @ListNotebookInstances@ request was
    ...
    -- instance.
    notebookInstances :: Core.Maybe [NotebookInstanceSummary],
...
-- truncated, Amazon SageMaker returns this token. To retrieve the next set
-- of notebook instances, use the token in the next request.
listNotebookInstancesResponse_nextToken :: Lens.Lens' ListNotebookInstancesResponse (Core.Maybe Core.Text)
...
-- | An array of @NotebookInstanceSummary@ objects, one for each notebook
-- instance.
listNotebookInstancesResponse_notebookInstances :: Lens.Lens' ListNotebookInstancesResponse (Core.Maybe [NotebookInstanceSummary])
listNotebookInstancesResponse_notebookInstances = Lens.lens (\ListNotebookInstancesResponse' {notebookInstances} -> notebookInstances) (\s@ListNotebookInstancesResponse' {} a -> s {notebookInstances = a} :: ListNotebookInstancesResponse) Core.. Lens.mapping Lens._Coerce

-- | The response's http status code.
listNotebookInstancesResponse_httpStatus :: Lens.Lens' ListNotebookInstancesResponse Core.Int
...
instance Core.NFData ListNotebookInstancesResponse
