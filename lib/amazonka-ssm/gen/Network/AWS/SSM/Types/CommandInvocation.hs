...
mkCommandInvocation
    :: CommandInvocation
mkCommandInvocation
  = CommandInvocation'{cloudWatchOutputConfig = Core.Nothing,
                       commandId = Core.Nothing, commandPlugins = Core.Nothing,
                       comment = Core.Nothing, documentName = Core.Nothing,
                       documentVersion = Core.Nothing, instanceId = Core.Nothing,
                       instanceName = Core.Nothing, notificationConfig = Core.Nothing,
                       requestedDateTime = Core.Nothing, serviceRole = Core.Nothing,
                       standardErrorUrl = Core.Nothing, standardOutputUrl = Core.Nothing,
...
{-# INLINEABLE ciCloudWatchOutputConfig #-}
...
{-# INLINEABLE ciCommandPlugins #-}
{-# DEPRECATED commandPlugins "Use generic-lens or generic-optics with 'commandPlugins' instead"  #-}
...
{-# INLINEABLE ciNotificationConfig #-}
...
{-# INLINEABLE ciRequestedDateTime #-}
...
{-# INLINEABLE ciStandardOutputUrl #-}
...
{-# INLINEABLE ciTraceOutput #-}
{-# DEPRECATED traceOutput "Use generic-lens or generic-optics with 'traceOutput' instead"  #-}

instance Core.FromJSON CommandInvocation where
        parseJSON
          = Core.withObject "CommandInvocation" Core.$
              \ x ->
                CommandInvocation' Core.<$>
