...
mkUpdate
    :: Types.UpdateExpression -- ^ 'updateExpression'
    -> Types.TableName -- ^ 'tableName'
    -> Update
mkUpdate updateExpression tableName
  = Update'{key = Core.mempty, updateExpression, tableName,
...
{-# INLINEABLE uConditionExpression #-}
...
{-# INLINEABLE uExpressionAttributeNames #-}
...
{-# INLINEABLE uExpressionAttributeValues #-}
...
{-# INLINEABLE uReturnValuesOnConditionCheckFailure #-}
