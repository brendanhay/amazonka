...
getItem_expressionAttributeNames = Lens.lens (\GetItem' {expressionAttributeNames} -> expressionAttributeNames) (\s@GetItem' {} a -> s {expressionAttributeNames = a} :: GetItem) Prelude.. Lens.mapping Prelude._Coerce
...
getItem_attributesToGet = Lens.lens (\GetItem' {attributesToGet} -> attributesToGet) (\s@GetItem' {} a -> s {attributesToGet = a} :: GetItem) Prelude.. Lens.mapping Prelude._Coerce
...
getItem_key = Lens.lens (\GetItem' {key} -> key) (\s@GetItem' {} a -> s {key = a} :: GetItem) Prelude.. Prelude._Coerce

instance Prelude.AWSRequest GetItem where
...
instance Prelude.ToHeaders GetItem where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("DynamoDB_20120810.GetItem" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON GetItem where
  toJSON GetItem' {..} =
    Prelude.object
      ( Prelude.catMaybes
...
instance Prelude.ToPath GetItem where
  toPath = Prelude.const "/"

instance Prelude.ToQuery GetItem where
...
getItemResponse_item = Lens.lens (\GetItemResponse' {item} -> item) (\s@GetItemResponse' {} a -> s {item = a} :: GetItemResponse) Prelude.. Lens.mapping Prelude._Coerce
