...
{-# INLINEABLE rdsuReferenceSchemaUpdate #-}
{-# DEPRECATED referenceSchemaUpdate "Use generic-lens or generic-optics with 'referenceSchemaUpdate' instead"  #-}
...
{-# INLINEABLE rdsuS3ReferenceDataSourceUpdate #-}
{-# DEPRECATED s3ReferenceDataSourceUpdate "Use generic-lens or generic-optics with 's3ReferenceDataSourceUpdate' instead"  #-}
...
{-# INLINEABLE rdsuTableNameUpdate #-}
{-# DEPRECATED tableNameUpdate "Use generic-lens or generic-optics with 'tableNameUpdate' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("ReferenceId" Core..= referenceId),
                  ...
                  ("S3ReferenceDataSourceUpdate" Core..=) Core.<$>
