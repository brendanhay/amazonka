...
data RemoveRoleFromDBInstance = RemoveRoleFromDBInstance'
  { _rrfdiDBInstanceIdentifier :: !Text
  , _rrfdiRoleARN              :: !Text
...
removeRoleFromDBInstance
    :: Text -- ^ 'rrfdiDBInstanceIdentifier'
    -> Text -- ^ 'rrfdiRoleARN'
    -> Text -- ^ 'rrfdiFeatureName'
    -> RemoveRoleFromDBInstance
removeRoleFromDBInstance pDBInstanceIdentifier_ pRoleARN_ pFeatureName_ =
  RemoveRoleFromDBInstance'
    { _rrfdiDBInstanceIdentifier = pDBInstanceIdentifier_
...
instance AWSRequest RemoveRoleFromDBInstance where
        type Rs RemoveRoleFromDBInstance =
             RemoveRoleFromDBInstanceResponse
        request = postQuery rds
        response
          = receiveNull RemoveRoleFromDBInstanceResponse'

instance Hashable RemoveRoleFromDBInstance where

instance NFData RemoveRoleFromDBInstance where
...
data RemoveRoleFromDBInstanceResponse =
  RemoveRoleFromDBInstanceResponse'
  deriving (Eq, Read, Show, Data, Typeable, Generic)
