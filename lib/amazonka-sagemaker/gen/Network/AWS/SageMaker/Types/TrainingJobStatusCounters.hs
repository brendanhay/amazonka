...
mkTrainingJobStatusCounters
    :: TrainingJobStatusCounters
mkTrainingJobStatusCounters
  = TrainingJobStatusCounters'{completed = Core.Nothing,
                               inProgress = Core.Nothing, nonRetryableError = Core.Nothing,
                               retryableError = Core.Nothing, stopped = Core.Nothing}
...
{-# INLINEABLE tjscNonRetryableError #-}
{-# DEPRECATED nonRetryableError "Use generic-lens or generic-optics with 'nonRetryableError' instead"  #-}
...
{-# INLINEABLE tjscRetryableError #-}
{-# DEPRECATED retryableError "Use generic-lens or generic-optics with 'retryableError' instead"  #-}
...
instance Core.FromJSON TrainingJobStatusCounters where
        parseJSON
          = Core.withObject "TrainingJobStatusCounters" Core.$
              \ x ->
                TrainingJobStatusCounters' Core.<$>
                  (x Core..:? "Completed") Core.<*> x Core..:? "InProgress" Core.<*>
                    x Core..:? "NonRetryableError"
