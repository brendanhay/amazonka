...
-- Storage Gateway Concepts>). In the request, you specify the gateway Amazon
-- Resource Name (ARN) to which you want to add cache, and one or more disk
-- IDs that you want to configure as cache.
--
