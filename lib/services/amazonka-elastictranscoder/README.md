...
`2.0` - Derived from API version @2012-09-25@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.ElasticTranscoder](http://hackage.haskell.org/package/amazonka-elastictranscoder/docs/Amazonka-ElasticTranscoder.html)
