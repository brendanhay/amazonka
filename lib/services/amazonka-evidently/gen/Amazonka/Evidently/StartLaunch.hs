...
instance Core.ToHeaders StartLaunch where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Core.ToJSON StartLaunch where
  toJSON = Prelude.const (Core.Object Prelude.mempty)

instance Core.ToPath StartLaunch where
  toPath StartLaunch' {..} =
    Prelude.mconcat
      [ "/projects/",
        Core.toBS project,
...
instance Core.ToQuery StartLaunch where
