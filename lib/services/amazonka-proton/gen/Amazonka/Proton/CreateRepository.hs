...
-- <https://docs.aws.amazon.com/proton/latest/adminguide/using-service-linked-roles.html service-linked role>
-- for you.
--
...
-- <https://docs.aws.amazon.com/proton/latest/adminguide/ag-template-bundles.html Template bundles>,
-- and
...
data CreateRepository = CreateRepository'
  { -- | An optional list of metadata items that you can associate with the
    ...
    -- <https://docs.aws.amazon.com/proton/latest/adminguide/setting-up-for-service.html Setting up for Proton>
    -- in the /Proton Administrator Guide/.
...
-- (Amazon Web Services KMS) key.
--
-- 'connectionArn', 'createRepository_connectionArn' - The Amazon Resource Name (ARN) of your Amazon Web Services CodeStar
-- connection. For more information, see
-- <https://docs.aws.amazon.com/proton/latest/adminguide/setting-up-for-service.html Setting up for Proton>
-- in the /Proton Administrator Guide/.
--
...
--
-- 'repository', 'createRepositoryResponse_repository' - The repository detail data that\'s returned by Proton.
newCreateRepositoryResponse ::
  -- | 'httpStatus'
  Prelude.Int ->
  -- | 'repository'
