...
-- |
-- Module      : Network.AWS.AppRunner.Types.ConfigurationSource
...
pattern ConfigurationSource_API = ConfigurationSource' "API"

pattern ConfigurationSource_REPOSITORY :: ConfigurationSource
pattern ConfigurationSource_REPOSITORY = ConfigurationSource' "REPOSITORY"
