...
mkPipelineExecutionSummary
    :: PipelineExecutionSummary
mkPipelineExecutionSummary
  = PipelineExecutionSummary'{lastUpdateTime = Core.Nothing,
                              pipelineExecutionId = Core.Nothing, sourceRevisions = Core.Nothing,
                              startTime = Core.Nothing, status = Core.Nothing,
                              stopTrigger = Core.Nothing, trigger = Core.Nothing}
...
{-# INLINEABLE pesPipelineExecutionId #-}
...
{-# INLINEABLE pesSourceRevisions #-}
{-# DEPRECATED sourceRevisions "Use generic-lens or generic-optics with 'sourceRevisions' instead"  #-}
...
{-# INLINEABLE pesStopTrigger #-}
{-# DEPRECATED stopTrigger "Use generic-lens or generic-optics with 'stopTrigger' instead"  #-}
...
instance Core.FromJSON PipelineExecutionSummary where
        parseJSON
          = Core.withObject "PipelineExecutionSummary" Core.$
              \ x ->
                PipelineExecutionSummary' Core.<$>
                  (x Core..:? "lastUpdateTime") Core.<*>
