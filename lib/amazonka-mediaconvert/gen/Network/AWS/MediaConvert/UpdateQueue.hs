...
mkUpdateQueue
    ...
    -> UpdateQueue
mkUpdateQueue name
  = UpdateQueue'{name, description = Core.Nothing,
                 reservationPlanSettings = Core.Nothing, status = Core.Nothing}
...
{-# INLINEABLE uqReservationPlanSettings #-}
...
{-# INLINEABLE uqrrsResponseStatus #-}
