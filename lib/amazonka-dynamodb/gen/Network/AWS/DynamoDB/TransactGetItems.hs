...
mkTransactGetItems
    :: Core.NonEmpty Types.TransactGetItem -- ^ 'transactItems'
    -> TransactGetItems
...
{-# INLINEABLE tgiReturnConsumedCapacity #-}
...
instance Core.AWSRequest TransactGetItems where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 TransactGetItemsResponse' Core.<$>
                   (x Core..:? "ConsumedCapacity") Core.<*> x Core..:? "Responses"
...
mkTransactGetItemsResponse responseStatus
  = TransactGetItemsResponse'{consumedCapacity = Core.Nothing,
                              responses = Core.Nothing, responseStatus}
...
{-# INLINEABLE tgirrsConsumedCapacity #-}
...
{-# INLINEABLE tgirrsResponseStatus #-}
