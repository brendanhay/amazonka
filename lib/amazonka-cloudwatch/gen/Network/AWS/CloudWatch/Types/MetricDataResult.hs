...
mkMetricDataResult
    :: MetricDataResult
mkMetricDataResult
  = MetricDataResult'{id = Core.Nothing, label = Core.Nothing,
                      messages = Core.Nothing, statusCode = Core.Nothing,
                      timestamps = Core.Nothing, values = Core.Nothing}
...
{-# INLINEABLE mdrTimestamps #-}
{-# DEPRECATED timestamps "Use generic-lens or generic-optics with 'timestamps' instead"  #-}
