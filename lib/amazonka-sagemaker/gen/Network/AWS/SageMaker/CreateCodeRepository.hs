...
{-# INLINEABLE ccrCodeRepositoryName #-}
...
instance Core.ToHeaders CreateCodeRepository where
        toHeaders CreateCodeRepository{..}
...
instance Core.AWSRequest CreateCodeRepository where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateCodeRepositoryResponse' Core.<$>
...
{-# INLINEABLE ccrrrsCodeRepositoryArn #-}
