...
mkListSignalingChannels
    :: ListSignalingChannels
mkListSignalingChannels
  = ListSignalingChannels'{channelNameCondition = Core.Nothing,
...
{-# INLINEABLE lscChannelNameCondition #-}
{-# DEPRECATED channelNameCondition "Use generic-lens or generic-optics with 'channelNameCondition' instead"  #-}
...
instance Core.AWSRequest ListSignalingChannels where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/listSignalingChannels",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListSignalingChannelsResponse' Core.<$>
                   (x Core..:? "ChannelInfoList") Core.<*> x Core..:? "NextToken"
...
mkListSignalingChannelsResponse responseStatus
  = ListSignalingChannelsResponse'{channelInfoList = Core.Nothing,
...
{-# INLINEABLE lscrrsChannelInfoList #-}
{-# DEPRECATED channelInfoList "Use generic-lens or generic-optics with 'channelInfoList' instead"  #-}
