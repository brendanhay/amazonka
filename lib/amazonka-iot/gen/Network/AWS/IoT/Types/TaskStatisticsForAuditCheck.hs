...
mkTaskStatisticsForAuditCheck
    :: TaskStatisticsForAuditCheck
mkTaskStatisticsForAuditCheck
  = TaskStatisticsForAuditCheck'{canceledFindingsCount =
                                   Core.Nothing,
...
{-# INLINEABLE tsfacCanceledFindingsCount #-}
{-# DEPRECATED canceledFindingsCount "Use generic-lens or generic-optics with 'canceledFindingsCount' instead"  #-}
...
{-# INLINEABLE tsfacFailedFindingsCount #-}
{-# DEPRECATED failedFindingsCount "Use generic-lens or generic-optics with 'failedFindingsCount' instead"  #-}
...
{-# INLINEABLE tsfacSkippedFindingsCount #-}
{-# DEPRECATED skippedFindingsCount "Use generic-lens or generic-optics with 'skippedFindingsCount' instead"  #-}
...
{-# INLINEABLE tsfacSucceededFindingsCount #-}
{-# DEPRECATED succeededFindingsCount "Use generic-lens or generic-optics with 'succeededFindingsCount' instead"  #-}
...
{-# INLINEABLE tsfacTotalFindingsCount #-}
{-# DEPRECATED totalFindingsCount "Use generic-lens or generic-optics with 'totalFindingsCount' instead"  #-}

instance Core.FromJSON TaskStatisticsForAuditCheck where
        parseJSON
          = Core.withObject "TaskStatisticsForAuditCheck" Core.$
              \ x ->
                TaskStatisticsForAuditCheck' Core.<$>
                  (x Core..:? "canceledFindingsCount") Core.<*>
                    x Core..:? "failedFindingsCount"
