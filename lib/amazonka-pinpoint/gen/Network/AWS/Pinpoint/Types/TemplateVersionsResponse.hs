...
{-# DEPRECATED tvrItem "Use generic-lens or generic-optics with 'item' instead." #-}
...
{-# DEPRECATED tvrMessage "Use generic-lens or generic-optics with 'message' instead." #-}
...
{-# DEPRECATED tvrNextToken "Use generic-lens or generic-optics with 'nextToken' instead." #-}
...
{-# DEPRECATED tvrRequestID "Use generic-lens or generic-optics with 'requestID' instead." #-}
