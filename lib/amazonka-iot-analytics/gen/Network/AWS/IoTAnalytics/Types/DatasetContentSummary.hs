...
mkDatasetContentSummary
    :: DatasetContentSummary
mkDatasetContentSummary
  = DatasetContentSummary'{completionTime = Core.Nothing,
                           creationTime = Core.Nothing, scheduleTime = Core.Nothing,
...
{-# INLINEABLE dcsScheduleTime #-}
{-# DEPRECATED scheduleTime "Use generic-lens or generic-optics with 'scheduleTime' instead"  #-}
