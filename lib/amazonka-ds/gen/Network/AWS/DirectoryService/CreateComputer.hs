...
mkCreateComputer
    ...
    -> Types.ComputerName -- ^ 'computerName'
    -> Types.Password -- ^ 'password'
    -> CreateComputer
mkCreateComputer directoryId computerName password
  = CreateComputer'{directoryId, computerName, password,
...
{-# INLINEABLE ccComputerAttributes #-}
{-# DEPRECATED computerAttributes "Use generic-lens or generic-optics with 'computerAttributes' instead"  #-}
...
{-# INLINEABLE ccOrganizationalUnitDistinguishedName #-}
...
instance Core.AWSRequest CreateComputer where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateComputerResponse' Core.<$>
                   (x Core..:? "Computer") Core.<*> Core.pure (Core.fromEnum s))
...
{-# INLINEABLE ccrrsComputer #-}
{-# DEPRECATED computer "Use generic-lens or generic-optics with 'computer' instead"  #-}
