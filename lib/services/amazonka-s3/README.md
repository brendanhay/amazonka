...
`2.0` - Derived from API version @2006-03-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.S3](http://hackage.haskell.org/package/amazonka-s3/docs/Amazonka-S3.html)
