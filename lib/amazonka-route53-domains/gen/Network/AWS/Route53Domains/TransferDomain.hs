...
mkTransferDomain
    ...
    -> TransferDomain
mkTransferDomain domainName durationInYears adminContact
  registrantContact techContact
  = TransferDomain'{domainName, durationInYears, adminContact,
                    registrantContact, techContact, authCode = Core.Nothing,
                    autoRenew = Core.Nothing, idnLangCode = Core.Nothing,
...
{-# INLINEABLE tdRegistrantContact #-}
...
{-# INLINEABLE tdPrivacyProtectAdminContact #-}
...
{-# INLINEABLE tdPrivacyProtectRegistrantContact #-}
...
{-# INLINEABLE tdPrivacyProtectTechContact #-}
...
{-# INLINEABLE tdrrsResponseStatus #-}
