...
instance ToQuery AcceptTransitGatewayVPCAttachment where
  toQuery AcceptTransitGatewayVPCAttachment' {..} =
    mconcat
      [ "Action" =: ("AcceptTransitGatewayVpcAttachment" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        "DryRun" =: _atgvaDryRun,
        "TransitGatewayAttachmentId" =: _atgvaTransitGatewayAttachmentId
      ]
...
data AcceptTransitGatewayVPCAttachmentResponse = AcceptTransitGatewayVPCAttachmentResponse'
  { _atgvarsTransitGatewayVPCAttachment ::
      !( Maybe
...
instance NFData AcceptTransitGatewayVPCAttachmentResponse
