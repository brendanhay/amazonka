...
instance Hashable DeleteKnownHostKeys where

instance NFData DeleteKnownHostKeys where
...
data DeleteKnownHostKeysResponse = DeleteKnownHostKeysResponse'
  { _dkhkrsOperations     :: !(Maybe [Operation])
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dkhkrsOperations' - A list of objects describing the API operation.
--
-- * 'dkhkrsResponseStatus' - -- | The response status code.
deleteKnownHostKeysResponse
    :: Int -- ^ 'dkhkrsResponseStatus'
    -> DeleteKnownHostKeysResponse
deleteKnownHostKeysResponse pResponseStatus_ =
  DeleteKnownHostKeysResponse'
    {_dkhkrsOperations = Nothing, _dkhkrsResponseStatus = pResponseStatus_}
...
instance NFData DeleteKnownHostKeysResponse where
