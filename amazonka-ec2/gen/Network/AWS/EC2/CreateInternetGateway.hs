...
--
--
-- For more information about your VPC and internet gateway, see the <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/ Amazon Virtual Private Cloud User Guide> .
--
module Network.AWS.EC2.CreateInternetGateway
    (
    -- * Creating a Request
