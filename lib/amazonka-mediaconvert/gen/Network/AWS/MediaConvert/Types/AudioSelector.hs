...
mkAudioSelector
    :: AudioSelector
mkAudioSelector
  = AudioSelector'{customLanguageCode = Core.Nothing,
                   defaultSelection = Core.Nothing,
                   externalAudioFileInput = Core.Nothing, languageCode = Core.Nothing,
                   offset = Core.Nothing, pids = Core.Nothing,
                   programSelection = Core.Nothing, remixSettings = Core.Nothing,
                   selectorType = Core.Nothing, tracks = Core.Nothing}
...
{-# INLINEABLE asCustomLanguageCode #-}
...
{-# INLINEABLE asDefaultSelection #-}
{-# DEPRECATED defaultSelection "Use generic-lens or generic-optics with 'defaultSelection' instead"  #-}
...
{-# INLINEABLE asExternalAudioFileInput #-}
{-# DEPRECATED externalAudioFileInput "Use generic-lens or generic-optics with 'externalAudioFileInput' instead"  #-}
...
{-# INLINEABLE asPids #-}
{-# DEPRECATED pids "Use generic-lens or generic-optics with 'pids' instead"  #-}
...
{-# INLINEABLE asProgramSelection #-}
{-# DEPRECATED programSelection "Use generic-lens or generic-optics with 'programSelection' instead"  #-}
...
{-# INLINEABLE asSelectorType #-}
{-# DEPRECATED selectorType "Use generic-lens or generic-optics with 'selectorType' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("customLanguageCode" Core..=) Core.<$> customLanguageCode,
                  ...
                  ("offset" Core..=) Core.<$> offset, ("pids" Core..=) Core.<$> pids,
