...
-- | The IPv6 address.
networkInterfaceIpv6Address_ipv6Address :: Lens.Lens' NetworkInterfaceIpv6Address (Core.Maybe Core.Text)
...
instance Core.Hashable NetworkInterfaceIpv6Address

instance Core.NFData NetworkInterfaceIpv6Address
