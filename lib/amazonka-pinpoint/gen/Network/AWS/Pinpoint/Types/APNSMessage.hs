...
mkAPNSMessage =
  APNSMessage'
    { aPNSPushType = Core.Nothing,
      action = Core.Nothing,
      badge = Core.Nothing,
      body = Core.Nothing,
      category = Core.Nothing,
      collapseId = Core.Nothing,
      data' = Core.Nothing,
...
{-# DEPRECATED apnsmAPNSPushType "Use generic-lens or generic-optics with 'aPNSPushType' instead." #-}
...
{-# DEPRECATED apnsmAction "Use generic-lens or generic-optics with 'action' instead." #-}
...
{-# DEPRECATED apnsmBadge "Use generic-lens or generic-optics with 'badge' instead." #-}
...
{-# DEPRECATED apnsmBody "Use generic-lens or generic-optics with 'body' instead." #-}
...
{-# DEPRECATED apnsmCategory "Use generic-lens or generic-optics with 'category' instead." #-}
...
{-# DEPRECATED apnsmCollapseId "Use generic-lens or generic-optics with 'collapseId' instead." #-}
...
{-# DEPRECATED apnsmData "Use generic-lens or generic-optics with 'data'' instead." #-}
...
{-# DEPRECATED apnsmMediaUrl "Use generic-lens or generic-optics with 'mediaUrl' instead." #-}
...
{-# DEPRECATED apnsmPreferredAuthenticationMethod "Use generic-lens or generic-optics with 'preferredAuthenticationMethod' instead." #-}
...
{-# DEPRECATED apnsmPriority "Use generic-lens or generic-optics with 'priority' instead." #-}
...
{-# DEPRECATED apnsmRawContent "Use generic-lens or generic-optics with 'rawContent' instead." #-}
...
{-# DEPRECATED apnsmSilentPush "Use generic-lens or generic-optics with 'silentPush' instead." #-}
...
{-# DEPRECATED apnsmSound "Use generic-lens or generic-optics with 'sound' instead." #-}
...
{-# DEPRECATED apnsmSubstitutions "Use generic-lens or generic-optics with 'substitutions' instead." #-}
...
{-# DEPRECATED apnsmThreadId "Use generic-lens or generic-optics with 'threadId' instead." #-}
...
{-# DEPRECATED apnsmTimeToLive "Use generic-lens or generic-optics with 'timeToLive' instead." #-}
...
{-# DEPRECATED apnsmTitle "Use generic-lens or generic-optics with 'title' instead." #-}
...
{-# DEPRECATED apnsmUrl "Use generic-lens or generic-optics with 'url' instead." #-}
      ...
      ( Core.catMaybes
          [ ("APNSPushType" Core..=) Core.<$> aPNSPushType,
            ...
            ("PreferredAuthenticationMethod" Core..=)
              Core.<$> preferredAuthenticationMethod,
