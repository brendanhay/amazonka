...
mkCreateMultipartUpload bucket key
  = CreateMultipartUpload'{bucket, key, acl = Core.Nothing,
                           cacheControl = Core.Nothing, contentDisposition = Core.Nothing,
                           contentEncoding = Core.Nothing, contentLanguage = Core.Nothing,
                           contentType = Core.Nothing, expectedBucketOwner = Core.Nothing,
                           expires = Core.Nothing, grantFullControl = Core.Nothing,
                           grantRead = Core.Nothing, grantReadACP = Core.Nothing,
                           grantWriteACP = Core.Nothing, metadata = Core.mempty,
                           ...
                           tagging = Core.Nothing, websiteRedirectLocation = Core.Nothing}
...
{-# INLINEABLE cmuContentDisposition #-}
...
{-# INLINEABLE cmuExpectedBucketOwner #-}
...
{-# INLINEABLE cmuGrantFullControl #-}
...
{-# INLINEABLE cmuObjectLockLegalHoldStatus #-}
...
{-# INLINEABLE cmuObjectLockRetainUntilDate #-}
...
{-# INLINEABLE cmuSSECustomerAlgorithm #-}
...
{-# INLINEABLE cmuSSECustomerKeyMD5 #-}
...
{-# INLINEABLE cmuSSEKMSEncryptionContext #-}
...
{-# INLINEABLE cmuServerSideEncryption #-}
...
{-# INLINEABLE cmuWebsiteRedirectLocation #-}
...
instance Core.ToQuery CreateMultipartUpload where
        toQuery CreateMultipartUpload{..}
          = Core.toQueryPair "uploads" ("" :: Core.Text)
...
instance Core.AWSRequest CreateMultipartUpload where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 CreateMultipartUploadResponse' Core.<$>
...
mkCreateMultipartUploadResponse responseStatus
  = CreateMultipartUploadResponse'{abortDate = Core.Nothing,
                                   abortRuleId = Core.Nothing, bucket = Core.Nothing,
                                   key = Core.Nothing, requestCharged = Core.Nothing,
                                   sSECustomerAlgorithm = Core.Nothing,
                                   sSECustomerKeyMD5 = Core.Nothing,
                                   sSEKMSEncryptionContext = Core.Nothing,
                                   sSEKMSKeyId = Core.Nothing, serverSideEncryption = Core.Nothing,
...
{-# INLINEABLE cmurrsRequestCharged #-}
...
{-# INLINEABLE cmurrsSSECustomerAlgorithm #-}
{-# DEPRECATED sSECustomerAlgorithm "Use generic-lens or generic-optics with 'sSECustomerAlgorithm' instead"  #-}
...
{-# INLINEABLE cmurrsSSECustomerKeyMD5 #-}
{-# DEPRECATED sSECustomerKeyMD5 "Use generic-lens or generic-optics with 'sSECustomerKeyMD5' instead"  #-}
...
{-# INLINEABLE cmurrsSSEKMSEncryptionContext #-}
{-# DEPRECATED sSEKMSEncryptionContext "Use generic-lens or generic-optics with 'sSEKMSEncryptionContext' instead"  #-}
...
{-# INLINEABLE cmurrsServerSideEncryption #-}
{-# DEPRECATED serverSideEncryption "Use generic-lens or generic-optics with 'serverSideEncryption' instead"  #-}
...
{-# INLINEABLE cmurrsResponseStatus #-}
