...
mkDescribeEnvironmentManagedActions
    :: DescribeEnvironmentManagedActions
mkDescribeEnvironmentManagedActions
  = DescribeEnvironmentManagedActions'{environmentId = Core.Nothing,
                                       environmentName = Core.Nothing, status = Core.Nothing}

-- | The environment ID of the target environment.
--
-- /Note:/ Consider using 'environmentId' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
demaEnvironmentId :: Lens.Lens' DescribeEnvironmentManagedActions (Core.Maybe Core.Text)
demaEnvironmentId = Lens.field @"environmentId"
{-# INLINEABLE demaEnvironmentId #-}
...
demaEnvironmentName :: Lens.Lens' DescribeEnvironmentManagedActions (Core.Maybe Core.Text)
demaEnvironmentName = Lens.field @"environmentName"
{-# INLINEABLE demaEnvironmentName #-}
...
{-# INLINEABLE demaStatus #-}
{-# DEPRECATED status "Use generic-lens or generic-optics with 'status' instead"  #-}

instance Core.ToQuery DescribeEnvironmentManagedActions where
        toQuery DescribeEnvironmentManagedActions{..}
          = Core.toQueryPair "Action"
              ("DescribeEnvironmentManagedActions" :: Core.Text)
...
instance Core.ToHeaders DescribeEnvironmentManagedActions where
...
instance Core.AWSRequest DescribeEnvironmentManagedActions where
        ...
        parseResponse
          = Response.receiveXMLWrapper
              ...
              (\ s h x ->
                 DescribeEnvironmentManagedActionsResponse' Core.<$>
                   (x Core..@? "ManagedActions" Core..<@>
...
mkDescribeEnvironmentManagedActionsResponse responseStatus
  = DescribeEnvironmentManagedActionsResponse'{managedActions =
                                                 Core.Nothing,
                                               responseStatus}
...
{-# INLINEABLE demarrsManagedActions #-}
{-# DEPRECATED managedActions "Use generic-lens or generic-optics with 'managedActions' instead"  #-}
...
{-# INLINEABLE demarrsResponseStatus #-}
