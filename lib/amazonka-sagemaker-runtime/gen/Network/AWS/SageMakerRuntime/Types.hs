...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "SageMakerRuntime",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "runtime.sagemaker",
                 Core._svcVersion = "2017-05-13", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _ServiceUnavailable #-}
...
_ModelError
  = Core._MatchServiceError mkServiceConfig "ModelError" Core..
      Core.hasStatues 424
{-# INLINEABLE _ModelError #-}
...
_InternalFailure
  = Core._MatchServiceError mkServiceConfig "InternalFailure" Core..
      Core.hasStatues 500
{-# INLINEABLE _InternalFailure #-}
...
_ValidationError
  = Core._MatchServiceError mkServiceConfig "ValidationError" Core..
      Core.hasStatues 400
{-# INLINEABLE _ValidationError #-}
