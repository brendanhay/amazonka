...
mkEndpointSummary
    ...
    -> EndpointSummary
mkEndpointSummary endpointName endpointArn creationTime
  lastModifiedTime endpointStatus
  = EndpointSummary'{endpointName, endpointArn, creationTime,
                     lastModifiedTime, endpointStatus}
