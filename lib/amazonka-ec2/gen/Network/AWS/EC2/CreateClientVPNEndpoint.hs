...
instance ToQuery CreateClientVPNEndpoint where
  toQuery CreateClientVPNEndpoint' {..} =
    mconcat
      [ "Action" =: ("CreateClientVpnEndpoint" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        toQuery (toQueryList "SecurityGroupId" <$> _ccveSecurityGroupIds),
        ...
        toQuery
          (toQueryList "TagSpecification" <$> _ccveTagSpecifications),
        toQuery (toQueryList "DnsServers" <$> _ccveDNSServers),
        ...
        toQueryList "Authentication" _ccveAuthenticationOptions,
