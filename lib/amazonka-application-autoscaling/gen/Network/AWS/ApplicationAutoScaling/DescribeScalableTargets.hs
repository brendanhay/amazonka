...
mkDescribeScalableTargets serviceNamespace
  = DescribeScalableTargets'{serviceNamespace,
                             ...
                             resourceIds = Core.Nothing, scalableDimension = Core.Nothing}
...
{-# INLINEABLE dstServiceNamespace #-}
...
{-# INLINEABLE dstScalableDimension #-}
...
instance Core.ToHeaders DescribeScalableTargets where
        toHeaders DescribeScalableTargets{..}
          = Core.pure
...
instance Core.AWSRequest DescribeScalableTargets where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeScalableTargetsResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "ScalableTargets"
...
mkDescribeScalableTargetsResponse responseStatus
  = DescribeScalableTargetsResponse'{nextToken = Core.Nothing,
                                     scalableTargets = Core.Nothing, responseStatus}
...
{-# INLINEABLE dstrfrsScalableTargets #-}
{-# DEPRECATED scalableTargets "Use generic-lens or generic-optics with 'scalableTargets' instead"  #-}
...
{-# INLINEABLE dstrfrsResponseStatus #-}
