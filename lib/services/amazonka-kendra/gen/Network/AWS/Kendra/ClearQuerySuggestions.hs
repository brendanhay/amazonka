...
-- |
-- Module      : Network.AWS.Kendra.ClearQuerySuggestions
...
instance Prelude.Hashable ClearQuerySuggestions

instance Prelude.NFData ClearQuerySuggestions
...
instance Prelude.NFData ClearQuerySuggestionsResponse
