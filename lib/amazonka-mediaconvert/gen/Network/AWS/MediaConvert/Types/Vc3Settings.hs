...
mkVc3Settings
    :: Vc3Settings
mkVc3Settings
  = Vc3Settings'{framerateControl = Core.Nothing,
...
{-# INLINEABLE vsFramerateConversionAlgorithm #-}
...
{-# INLINEABLE vsFramerateDenominator #-}
...
{-# INLINEABLE vsFramerateNumerator #-}
...
{-# INLINEABLE vsVc3Class #-}
{-# DEPRECATED vc3Class "Use generic-lens or generic-optics with 'vc3Class' instead"  #-}
...
instance Core.FromJSON Vc3Settings where
        parseJSON
          = Core.withObject "Vc3Settings" Core.$
              \ x ->
                Vc3Settings' Core.<$>
                  (x Core..:? "framerateControl") Core.<*>
                    x Core..:? "framerateConversionAlgorithm"
