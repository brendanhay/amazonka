...
mkSSEDescription
    :: SSEDescription
mkSSEDescription
  = SSEDescription'{inaccessibleEncryptionDateTime = Core.Nothing,
                    kMSMasterKeyArn = Core.Nothing, sSEType = Core.Nothing,
                    status = Core.Nothing}
...
{-# INLINEABLE ssedInaccessibleEncryptionDateTime #-}
{-# DEPRECATED inaccessibleEncryptionDateTime "Use generic-lens or generic-optics with 'inaccessibleEncryptionDateTime' instead"  #-}
...
{-# INLINEABLE ssedKMSMasterKeyArn #-}
...
{-# INLINEABLE ssedSSEType #-}
{-# DEPRECATED sSEType "Use generic-lens or generic-optics with 'sSEType' instead"  #-}
...
instance Core.FromJSON SSEDescription where
        parseJSON
          = Core.withObject "SSEDescription" Core.$
              \ x ->
                SSEDescription' Core.<$>
                  (x Core..:? "InaccessibleEncryptionDateTime") Core.<*>
                    x Core..:? "KMSMasterKeyArn"
                    Core.<*> x Core..:? "SSEType"
                    Core.<*> x Core..:? "Status"
