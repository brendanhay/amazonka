...
-- |
-- Module      : Network.AWS.Kendra.PutPrincipalMapping
...
instance Prelude.Hashable PutPrincipalMapping

instance Prelude.NFData PutPrincipalMapping
...
instance Prelude.NFData PutPrincipalMappingResponse
