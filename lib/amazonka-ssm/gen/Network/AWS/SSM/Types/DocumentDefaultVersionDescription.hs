...
mkDocumentDefaultVersionDescription
    :: DocumentDefaultVersionDescription
mkDocumentDefaultVersionDescription
  = DocumentDefaultVersionDescription'{defaultVersion = Core.Nothing,
                                       defaultVersionName = Core.Nothing, name = Core.Nothing}
...
{-# INLINEABLE ddvdDefaultVersionName #-}
{-# DEPRECATED defaultVersionName "Use generic-lens or generic-optics with 'defaultVersionName' instead"  #-}
...
instance Core.FromJSON DocumentDefaultVersionDescription where
        parseJSON
          = Core.withObject "DocumentDefaultVersionDescription" Core.$
              \ x ->
                DocumentDefaultVersionDescription' Core.<$>
                  (x Core..:? "DefaultVersion") Core.<*>
                    x Core..:? "DefaultVersionName"
                    Core.<*> x Core..:? "Name"
