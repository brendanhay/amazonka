...
mkTimecodeConfig
    :: Types.TimecodeConfigSource -- ^ 'source'
    -> TimecodeConfig
...
{-# INLINEABLE tcSyncThreshold #-}
{-# DEPRECATED syncThreshold "Use generic-lens or generic-optics with 'syncThreshold' instead"  #-}
...
instance Core.FromJSON TimecodeConfig where
        parseJSON
          = Core.withObject "TimecodeConfig" Core.$
              \ x ->
                TimecodeConfig' Core.<$>
                  (x Core..: "source") Core.<*> x Core..:? "syncThreshold"
