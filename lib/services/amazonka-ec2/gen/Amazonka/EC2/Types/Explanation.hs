...
instance Prelude.NFData Explanation where
  rnf Explanation' {..} =
    Prelude.rnf destination
      ...
      `Prelude.seq` Prelude.rnf vpcPeeringConnection
      ...
      `Prelude.seq` Prelude.rnf loadBalancerTargetPort
      `Prelude.seq` Prelude.rnf packetField
