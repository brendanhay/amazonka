...
aPNSMessage_data = Lens.lens (\APNSMessage' {data'} -> data') (\s@APNSMessage' {} a -> s {data' = a} :: APNSMessage) Prelude.. Lens.mapping Prelude._Coerce
...
aPNSMessage_substitutions = Lens.lens (\APNSMessage' {substitutions} -> substitutions) (\s@APNSMessage' {} a -> s {substitutions = a} :: APNSMessage) Prelude.. Lens.mapping Prelude._Coerce
