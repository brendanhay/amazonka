...
mkCopyObject bucket copySource key
  = CopyObject'{bucket, copySource, key, acl = Core.Nothing,
                ...
                expectedSourceBucketOwner = Core.Nothing, expires = Core.Nothing,
                grantFullControl = Core.Nothing, grantRead = Core.Nothing,
                grantReadACP = Core.Nothing, grantWriteACP = Core.Nothing,
                metadata = Core.mempty, metadataDirective = Core.Nothing,
                ...
                sSEKMSEncryptionContext = Core.Nothing, sSEKMSKeyId = Core.Nothing,
                serverSideEncryption = Core.Nothing, storageClass = Core.Nothing,
                tagging = Core.Nothing, taggingDirective = Core.Nothing,
...
{-# INLINEABLE coContentDisposition #-}
...
{-# INLINEABLE coCopySourceIfMatch #-}
...
{-# INLINEABLE coCopySourceIfModifiedSince #-}
...
{-# INLINEABLE coCopySourceIfNoneMatch #-}
...
{-# INLINEABLE coCopySourceIfUnmodifiedSince #-}
...
{-# INLINEABLE coCopySourceSSECustomerAlgorithm #-}
...
{-# INLINEABLE coCopySourceSSECustomerKey #-}
...
{-# INLINEABLE coCopySourceSSECustomerKeyMD5 #-}
...
{-# INLINEABLE coExpectedBucketOwner #-}
...
{-# INLINEABLE coExpectedSourceBucketOwner #-}
...
{-# INLINEABLE coMetadataDirective #-}
{-# DEPRECATED metadataDirective "Use generic-lens or generic-optics with 'metadataDirective' instead"  #-}
...
{-# INLINEABLE coObjectLockLegalHoldStatus #-}
...
{-# INLINEABLE coObjectLockRetainUntilDate #-}
...
{-# INLINEABLE coSSECustomerAlgorithm #-}
...
{-# INLINEABLE coSSECustomerKeyMD5 #-}
...
{-# INLINEABLE coSSEKMSEncryptionContext #-}
{-# DEPRECATED sSEKMSEncryptionContext "Use generic-lens or generic-optics with 'sSEKMSEncryptionContext' instead"  #-}
...
{-# INLINEABLE coServerSideEncryption #-}
...
{-# INLINEABLE coTaggingDirective #-}
{-# DEPRECATED taggingDirective "Use generic-lens or generic-optics with 'taggingDirective' instead"  #-}
...
{-# INLINEABLE coWebsiteRedirectLocation #-}
...
instance Core.ToHeaders CopyObject where
        toHeaders CopyObject{..}
          = Core.toHeaders "x-amz-copy-source" copySource Core.<>
              ...
              Core.<>
              Core.toHeaders "x-amz-object-lock-legal-hold"
                objectLockLegalHoldStatus
              Core.<> Core.toHeaders "x-amz-object-lock-mode" objectLockMode
              Core.<>
              Core.toHeaders "x-amz-object-lock-retain-until-date"
              ...
              Core.toHeaders "x-amz-server-side-encryption-customer-key-MD5"
                sSECustomerKeyMD5
              Core.<>
              Core.toHeaders "x-amz-server-side-encryption-context"
                sSEKMSEncryptionContext
              Core.<>
              Core.toHeaders "x-amz-server-side-encryption-aws-kms-key-id"
                sSEKMSKeyId
              Core.<>
              Core.toHeaders "x-amz-server-side-encryption" serverSideEncryption
              ...
              Core.<>
              Core.toHeaders "x-amz-website-redirect-location"
                 ...
                 CopyObjectResponse' Core.<$>
                   (Core.parseXML x) Core.<*>
                     ...
                     Core.parseHeaderMaybe
                       ...
                       h
                     Core.<*>
                     Core.parseHeaderMaybe "x-amz-server-side-encryption-context" h
                     Core.<*>
...
mkCopyObjectResponse responseStatus
  = CopyObjectResponse'{copyObjectResult = Core.Nothing,
                        copySourceVersionId = Core.Nothing, expiration = Core.Nothing,
...
{-# INLINEABLE corrsCopyObjectResult #-}
{-# DEPRECATED copyObjectResult "Use generic-lens or generic-optics with 'copyObjectResult' instead"  #-}
...
{-# INLINEABLE corrsCopySourceVersionId #-}
...
{-# INLINEABLE corrsRequestCharged #-}
...
{-# INLINEABLE corrsSSECustomerAlgorithm #-}
{-# DEPRECATED sSECustomerAlgorithm "Use generic-lens or generic-optics with 'sSECustomerAlgorithm' instead"  #-}
...
{-# INLINEABLE corrsSSECustomerKeyMD5 #-}
{-# DEPRECATED sSECustomerKeyMD5 "Use generic-lens or generic-optics with 'sSECustomerKeyMD5' instead"  #-}
...
{-# INLINEABLE corrsSSEKMSEncryptionContext #-}
{-# DEPRECATED sSEKMSEncryptionContext "Use generic-lens or generic-optics with 'sSEKMSEncryptionContext' instead"  #-}
...
{-# INLINEABLE corrsServerSideEncryption #-}
{-# DEPRECATED serverSideEncryption "Use generic-lens or generic-optics with 'serverSideEncryption' instead"  #-}
