...
_DBClusterSnapshotAlreadyExistsFault =
    _MatchServiceError rds "DBClusterSnapshotAlreadyExistsFault" .
    hasStatus 400
...
_ProvisionedIOPSNotAvailableInAZFault =
    _MatchServiceError rds "ProvisionedIopsNotAvailableInAZFault" .
    hasStatus 400
...
_ReservedDBInstancesOfferingNotFoundFault =
    _MatchServiceError rds "ReservedDBInstancesOfferingNotFound" .
    hasStatus 404
...
_SNSInvalidTopicFault =
    _MatchServiceError rds "SNSInvalidTopic" . hasStatus 400
