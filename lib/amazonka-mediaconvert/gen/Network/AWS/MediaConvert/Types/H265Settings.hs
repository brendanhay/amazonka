...
data H265Settings = H265Settings'
  { unregisteredSeiTimecode ::
      Lude.Maybe H265UnregisteredSeiTimecode,
    qualityTuningLevel :: Lude.Maybe H265QualityTuningLevel,
    temporalAdaptiveQuantization ::
      Lude.Maybe H265TemporalAdaptiveQuantization,
    ...
    alternateTransferFunctionSei ::
      Lude.Maybe H265AlternateTransferFunctionSei,
    ...
    spatialAdaptiveQuantization ::
      Lude.Maybe H265SpatialAdaptiveQuantization
  }
  deriving stock
    ( Lude.Eq,
      Lude.Ord,
