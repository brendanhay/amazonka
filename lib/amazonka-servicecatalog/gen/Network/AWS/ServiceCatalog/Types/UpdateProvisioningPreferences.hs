...
mkUpdateProvisioningPreferences
    :: UpdateProvisioningPreferences
mkUpdateProvisioningPreferences
  = UpdateProvisioningPreferences'{stackSetAccounts = Core.Nothing,
...
{-# INLINEABLE uppStackSetAccounts #-}
...
{-# INLINEABLE uppStackSetFailureToleranceCount #-}
...
{-# INLINEABLE uppStackSetFailureTolerancePercentage #-}
...
{-# INLINEABLE uppStackSetMaxConcurrencyCount #-}
...
{-# INLINEABLE uppStackSetMaxConcurrencyPercentage #-}
...
{-# INLINEABLE uppStackSetOperationType #-}
{-# DEPRECATED stackSetOperationType "Use generic-lens or generic-optics with 'stackSetOperationType' instead"  #-}
