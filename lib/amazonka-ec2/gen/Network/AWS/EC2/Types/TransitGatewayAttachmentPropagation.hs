...
mkTransitGatewayAttachmentPropagation
    :: TransitGatewayAttachmentPropagation
mkTransitGatewayAttachmentPropagation
  = TransitGatewayAttachmentPropagation'{state = Core.Nothing,
...
{-# INLINEABLE tgapState #-}
{-# DEPRECATED state "Use generic-lens or generic-optics with 'state' instead"  #-}

-- | The ID of the propagation route table.
--
-- /Note:/ Consider using 'transitGatewayRouteTableId' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
tgapTransitGatewayRouteTableId :: Lens.Lens' TransitGatewayAttachmentPropagation (Core.Maybe Core.Text)
tgapTransitGatewayRouteTableId = Lens.field @"transitGatewayRouteTableId"
{-# INLINEABLE tgapTransitGatewayRouteTableId #-}
...
instance Core.FromXML TransitGatewayAttachmentPropagation where
        parseXML x
          = TransitGatewayAttachmentPropagation' Core.<$>
              (x Core..@? "state") Core.<*>
