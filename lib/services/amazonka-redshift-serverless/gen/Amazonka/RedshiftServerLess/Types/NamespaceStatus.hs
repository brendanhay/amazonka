...
-- |
-- Module      : Amazonka.RedshiftServerLess.Types.NamespaceStatus
...
module Amazonka.RedshiftServerLess.Types.NamespaceStatus
  ( NamespaceStatus
      ( ..,
        NamespaceStatus_AVAILABLE,
        NamespaceStatus_DELETING,
        NamespaceStatus_MODIFYING
      ),
  )
where
...
pattern NamespaceStatus_AVAILABLE = NamespaceStatus' "AVAILABLE"
...
pattern NamespaceStatus_MODIFYING = NamespaceStatus' "MODIFYING"
