...
--
-- * 'laMaxResults' - The maximum number of results to return in a single call. The default value is 50. To retrieve the remaining results, make another call with the returned @NextToken@ value.
listApps
    :: ListApps
listApps =
  ListApps'
    {_laAppIds = Nothing, _laNextToken = Nothing, _laMaxResults = Nothing}
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'larsApps' - A list of application summaries.
--
