...
mkAddThingsToThingGroupParams
    :: Core.NonEmpty Types.ThingGroupName -- ^ 'thingGroupNames'
    -> AddThingsToThingGroupParams
...
{-# INLINEABLE atttgpThingGroupNames #-}
...
{-# INLINEABLE atttgpOverrideDynamicGroups #-}
          ...
          = Core.withObject "AddThingsToThingGroupParams" Core.$
              \ x ->
                AddThingsToThingGroupParams' Core.<$>
                  (x Core..: "thingGroupNames") Core.<*>
                    x Core..:? "overrideDynamicGroups"
