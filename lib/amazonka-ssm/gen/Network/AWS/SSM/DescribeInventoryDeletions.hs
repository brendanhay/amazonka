...
mkDescribeInventoryDeletions
    :: DescribeInventoryDeletions
mkDescribeInventoryDeletions
  = DescribeInventoryDeletions'{deletionId = Core.Nothing,
...
instance Core.ToHeaders DescribeInventoryDeletions where
        toHeaders DescribeInventoryDeletions{..}
          = Core.pure
...
instance Core.AWSRequest DescribeInventoryDeletions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeInventoryDeletionsResponse' Core.<$>
                   (x Core..:? "InventoryDeletions") Core.<*> x Core..:? "NextToken"
...
mkDescribeInventoryDeletionsResponse responseStatus
  = DescribeInventoryDeletionsResponse'{inventoryDeletions =
                                          Core.Nothing,
...
{-# INLINEABLE didrrsInventoryDeletions #-}
{-# DEPRECATED inventoryDeletions "Use generic-lens or generic-optics with 'inventoryDeletions' instead"  #-}
