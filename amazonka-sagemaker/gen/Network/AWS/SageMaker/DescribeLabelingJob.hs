...
instance Hashable DescribeLabelingJob where

instance NFData DescribeLabelingJob where
...
data DescribeLabelingJobResponse = DescribeLabelingJobResponse'
  { _dljrsFailureReason               :: !(Maybe Text)
  , _dljrsLabelingJobAlgorithmsConfig :: !(Maybe LabelingJobAlgorithmsConfig)
  , _dljrsLabelCategoryConfigS3URI    :: !(Maybe Text)
  , _dljrsStoppingConditions          :: !(Maybe LabelingJobStoppingConditions)
  , _dljrsLabelAttributeName          :: !(Maybe Text)
  , _dljrsLabelingJobOutput           :: !(Maybe LabelingJobOutput)
  , _dljrsTags                        :: !(Maybe [Tag])
  , _dljrsResponseStatus              :: !Int
  , _dljrsLabelingJobStatus           :: !LabelingJobStatus
  , _dljrsLabelCounters               :: !LabelCounters
  ...
  , _dljrsInputConfig                 :: !LabelingJobInputConfig
  , _dljrsOutputConfig                :: !LabelingJobOutputConfig
  , _dljrsRoleARN                     :: !Text
  , _dljrsHumanTaskConfig             :: !HumanTaskConfig
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
--
-- * 'dljrsLabelCategoryConfigS3URI' - The S3 location of the JSON file that defines the categories used to label data objects. The file is a JSON structure in the following format: @{@  @"document-version": "2018-11-28"@  @"labels": [@  @{@  @"label": "/label 1/ "@  @},@  @{@  @"label": "/label 2/ "@  @},@  @...@  @{@  @"label": "/label n/ "@  @}@  @]@  @}@
--
...
--
-- * 'dljrsTags' - An array of key/value pairs. For more information, see <http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html#allocation-what Using Cost Allocation Tags> in the /AWS Billing and Cost Management User Guide/ .
--
...
describeLabelingJobResponse
    :: Int -- ^ 'dljrsResponseStatus'
    -> LabelingJobStatus -- ^ 'dljrsLabelingJobStatus'
    -> LabelCounters -- ^ 'dljrsLabelCounters'
    -> UTCTime -- ^ 'dljrsCreationTime'
    -> UTCTime -- ^ 'dljrsLastModifiedTime'
    -> Text -- ^ 'dljrsJobReferenceCode'
    -> Text -- ^ 'dljrsLabelingJobName'
    -> Text -- ^ 'dljrsLabelingJobARN'
    -> LabelingJobInputConfig -- ^ 'dljrsInputConfig'
    -> LabelingJobOutputConfig -- ^ 'dljrsOutputConfig'
    -> Text -- ^ 'dljrsRoleARN'
    -> HumanTaskConfig -- ^ 'dljrsHumanTaskConfig'
    -> DescribeLabelingJobResponse
describeLabelingJobResponse pResponseStatus_ pLabelingJobStatus_ pLabelCounters_ pCreationTime_ pLastModifiedTime_ pJobReferenceCode_ pLabelingJobName_ pLabelingJobARN_ pInputConfig_ pOutputConfig_ pRoleARN_ pHumanTaskConfig_ =
  DescribeLabelingJobResponse'
...
instance NFData DescribeLabelingJobResponse where
