...
mkAudioDescription
    :: AudioDescription
mkAudioDescription
  = AudioDescription'{audioChannelTaggingSettings = Core.Nothing,
                      audioNormalizationSettings = Core.Nothing,
                      audioSourceName = Core.Nothing, audioType = Core.Nothing,
                      audioTypeControl = Core.Nothing, codecSettings = Core.Nothing,
...
{-# INLINEABLE adAudioChannelTaggingSettings #-}
{-# DEPRECATED audioChannelTaggingSettings "Use generic-lens or generic-optics with 'audioChannelTaggingSettings' instead"  #-}
...
{-# INLINEABLE adAudioSourceName #-}
{-# DEPRECATED audioSourceName "Use generic-lens or generic-optics with 'audioSourceName' instead"  #-}
...
{-# INLINEABLE adCustomLanguageCode #-}
...
instance Core.FromJSON AudioDescription where
        toJSON AudioDescription{..}
          = Core.object
              (Core.catMaybes
                 [("audioChannelTaggingSettings" Core..=) Core.<$>
          ...
          = Core.withObject "AudioDescription" Core.$
              \ x ->
                AudioDescription' Core.<$>
                  (x Core..:? "audioChannelTaggingSettings") Core.<*>
