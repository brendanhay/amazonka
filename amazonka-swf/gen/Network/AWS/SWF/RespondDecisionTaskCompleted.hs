...
-- specifies the list of decisions made while processing the task. A
...
-- decisions in the @decisions@ parameter. Each of the decisions has one or
-- more parameters, much like a regular API call. To allow for policies to be
-- as readable as possible, you can express permissions on decisions as if
-- they were actual API calls, including applying conditions to some
...
-- | The @taskToken@ from the DecisionTask>. The @taskToken@ is generated by
