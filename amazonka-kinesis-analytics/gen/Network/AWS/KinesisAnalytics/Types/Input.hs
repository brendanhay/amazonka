...
data Input = Input'
  { -- | Describes the number of in-application streams to create.
    ...
    -- required.
    kinesisFirehoseInput :: Core.Maybe KinesisFirehoseInput,
    ...
    -- Note: Either @KinesisStreamsInput@ or @KinesisFirehoseInput@ is
    -- required.
    kinesisStreamsInput :: Core.Maybe KinesisStreamsInput,
    -- | The
...
-- (see
-- <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html Configuring Application Input>.
input_inputParallelism :: Lens.Lens' Input (Core.Maybe InputParallelism)
...
-- Note: Either @KinesisStreamsInput@ or @KinesisFirehoseInput@ is
-- required.
input_kinesisFirehoseInput :: Lens.Lens' Input (Core.Maybe KinesisFirehoseInput)
...
-- Note: Either @KinesisStreamsInput@ or @KinesisFirehoseInput@ is
-- required.
input_kinesisStreamsInput :: Lens.Lens' Input (Core.Maybe KinesisStreamsInput)
...
-- Currently, the only input processing configuration available is
-- <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputLambdaProcessor.html InputLambdaProcessor>.
input_inputProcessingConfiguration :: Lens.Lens' Input (Core.Maybe InputProcessingConfiguration)
...
-- specified) in-application streams with names
-- \"MyInApplicationStream_001,\" \"MyInApplicationStream_002,\" and so on.
input_namePrefix :: Lens.Lens' Input Core.Text
    ...
    Core.object
      ( Core.catMaybes
          [ ("InputParallelism" Core..=)
              Core.<$> inputParallelism,
            ("KinesisFirehoseInput" Core..=)
              Core.<$> kinesisFirehoseInput,
            ("KinesisStreamsInput" Core..=)
              Core.<$> kinesisStreamsInput,
