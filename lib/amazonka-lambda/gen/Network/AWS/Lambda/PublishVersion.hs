...
mkPublishVersion functionName
  = PublishVersion'{functionName, codeSha256 = Core.Nothing,
                    description = Core.Nothing, revisionId = Core.Nothing}
...
pvCodeSha256 :: Lens.Lens' PublishVersion (Core.Maybe Core.Text)
pvCodeSha256 = Lens.field @"codeSha256"
{-# INLINEABLE pvCodeSha256 #-}
...
{-# INLINEABLE pvDescription #-}
{-# DEPRECATED description "Use generic-lens or generic-optics with 'description' instead"  #-}

-- | Only update the function if the revision ID matches the ID that's specified. Use this option to avoid publishing a version if the function configuration has changed since you last updated it.
--
-- /Note:/ Consider using 'revisionId' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
pvRevisionId :: Lens.Lens' PublishVersion (Core.Maybe Core.Text)
pvRevisionId = Lens.field @"revisionId"
{-# INLINEABLE pvRevisionId #-}
