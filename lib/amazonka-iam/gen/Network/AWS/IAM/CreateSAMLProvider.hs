...
mkCreateSAMLProvider
    :: Types.SAMLMetadataDocument -- ^ 'sAMLMetadataDocument'
    -> Types.Name -- ^ 'name'
    -> CreateSAMLProvider
...
{-# INLINEABLE csamlpSAMLMetadataDocument #-}
...
instance Core.AWSRequest CreateSAMLProvider where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "CreateSAMLProviderResult"
              (\ s h x ->
                 CreateSAMLProviderResponse' Core.<$>
...
mkCreateSAMLProviderResponse responseStatus
  = CreateSAMLProviderResponse'{sAMLProviderArn = Core.Nothing,
                                responseStatus}
...
{-# INLINEABLE csamlprrsSAMLProviderArn #-}
...
{-# INLINEABLE csamlprrsResponseStatus #-}
