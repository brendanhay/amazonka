...
`2.0` - Derived from API version @2014-11-13@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.ECS](http://hackage.haskell.org/package/amazonka-ecs/docs/Amazonka-ECS.html)
