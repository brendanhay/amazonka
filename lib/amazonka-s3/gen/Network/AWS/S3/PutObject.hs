...
mkPutObject bucket key body
  = PutObject'{bucket, key, acl = Core.Nothing, body,
...
{-# INLINEABLE poContentDisposition #-}
...
{-# INLINEABLE poExpectedBucketOwner #-}
...
{-# INLINEABLE poObjectLockLegalHoldStatus #-}
...
{-# INLINEABLE poObjectLockRetainUntilDate #-}
...
{-# INLINEABLE poSSECustomerAlgorithm #-}
...
{-# INLINEABLE poSSECustomerKeyMD5 #-}
...
{-# INLINEABLE poSSEKMSEncryptionContext #-}
...
{-# INLINEABLE poServerSideEncryption #-}
...
{-# INLINEABLE poWebsiteRedirectLocation #-}
...
mkPutObjectResponse responseStatus
  = PutObjectResponse'{eTag = Core.Nothing,
                       expiration = Core.Nothing, requestCharged = Core.Nothing,
...
{-# INLINEABLE porrsRequestCharged #-}
...
{-# INLINEABLE porrsSSECustomerAlgorithm #-}
{-# DEPRECATED sSECustomerAlgorithm "Use generic-lens or generic-optics with 'sSECustomerAlgorithm' instead"  #-}
...
{-# INLINEABLE porrsSSECustomerKeyMD5 #-}
{-# DEPRECATED sSECustomerKeyMD5 "Use generic-lens or generic-optics with 'sSECustomerKeyMD5' instead"  #-}
...
{-# INLINEABLE porrsSSEKMSEncryptionContext #-}
{-# DEPRECATED sSEKMSEncryptionContext "Use generic-lens or generic-optics with 'sSEKMSEncryptionContext' instead"  #-}
...
{-# INLINEABLE porrsServerSideEncryption #-}
{-# DEPRECATED serverSideEncryption "Use generic-lens or generic-optics with 'serverSideEncryption' instead"  #-}
