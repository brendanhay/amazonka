...
mkNotebookExecutionSummary
    :: NotebookExecutionSummary
mkNotebookExecutionSummary
  = NotebookExecutionSummary'{editorId = Core.Nothing,
                              endTime = Core.Nothing, notebookExecutionId = Core.Nothing,
                              notebookExecutionName = Core.Nothing, startTime = Core.Nothing,
                              status = Core.Nothing}
...
{-# INLINEABLE nesNotebookExecutionId #-}
...
{-# INLINEABLE nesNotebookExecutionName #-}
...
instance Core.FromJSON NotebookExecutionSummary where
        parseJSON
          = Core.withObject "NotebookExecutionSummary" Core.$
              \ x ->
                NotebookExecutionSummary' Core.<$>
                  (x Core..:? "EditorId") Core.<*> x Core..:? "EndTime" Core.<*>
                    x Core..:? "NotebookExecutionId"
