...
deleteVolume
    :: Text -- ^ 'delVolumeARN'
    -> DeleteVolume
deleteVolume pVolumeARN_ = DeleteVolume' {_delVolumeARN = pVolumeARN_}
...
deleteVolumeResponse pResponseStatus_ =
  DeleteVolumeResponse'
    {_dvvrsVolumeARN = Nothing, _dvvrsResponseStatus = pResponseStatus_}
