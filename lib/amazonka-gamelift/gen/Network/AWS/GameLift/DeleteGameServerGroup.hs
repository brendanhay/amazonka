...
{-# INLINEABLE dgsgGameServerGroupName #-}
...
{-# INLINEABLE dgsgDeleteOption #-}
{-# DEPRECATED deleteOption "Use generic-lens or generic-optics with 'deleteOption' instead"  #-}

instance Core.ToQuery DeleteGameServerGroup where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DeleteGameServerGroup where
        toHeaders DeleteGameServerGroup{..}
...
instance Core.AWSRequest DeleteGameServerGroup where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DeleteGameServerGroupResponse' Core.<$>
...
mkDeleteGameServerGroupResponse responseStatus
  = DeleteGameServerGroupResponse'{gameServerGroup = Core.Nothing,
                                   responseStatus}
...
{-# INLINEABLE dgsgrrsGameServerGroup #-}
...
{-# INLINEABLE dgsgrrsResponseStatus #-}
