...
instance ServiceError (Er EMR) where
...
data ClusterTimeline = ClusterTimeline
    { _cuReadyDateTime :: Maybe POSIXTime
      -- ^ The date and time when the cluster was ready to execute steps.
    , _cuCreationDateTime :: Maybe POSIXTime
      -- ^ The creation date and time of the cluster.
    , _cuEndDateTime :: Maybe POSIXTime
...
data InstanceGroupDetail = InstanceGroupDetail
    ...
    , _igdReadyDateTime :: Maybe POSIXTime
...
data InstanceGroupTimeline = InstanceGroupTimeline
    { _igvReadyDateTime :: Maybe POSIXTime
      -- ^ The date and time when the instance group became ready to perform
      -- tasks.
    , _igvCreationDateTime :: Maybe POSIXTime
      -- ^ The creation date and time of the instance group.
    , _igvEndDateTime :: Maybe POSIXTime
...
data InstanceTimeline = InstanceTimeline
    { _iihReadyDateTime :: Maybe POSIXTime
      -- ^ The date and time when the instance was ready to perform tasks.
    , _iihCreationDateTime :: Maybe POSIXTime
      -- ^ The creation date and time of the instance.
    , _iihEndDateTime :: Maybe POSIXTime
...
data JobFlowExecutionStatusDetail = JobFlowExecutionStatusDetail
    ...
    , _jfesdReadyDateTime :: Maybe POSIXTime
      -- ^ The date and time when the job flow was ready to start running
      -- bootstrap actions.
    , _jfesdLastStateChangeReason :: Maybe Text
      -- ^ Description of the job flow last changed state.
    , _jfesdCreationDateTime :: POSIXTime
      -- ^ The creation date and time of the job flow.
    , _jfesdEndDateTime :: Maybe POSIXTime
      -- ^ The completion date and time of the job flow.
    , _jfesdStartDateTime :: Maybe POSIXTime
...
data StepExecutionStatusDetail = StepExecutionStatusDetail
    ...
    , _sesdCreationDateTime :: POSIXTime
      -- ^ The creation date and time of the step.
    , _sesdEndDateTime :: Maybe POSIXTime
      -- ^ The completion date and time of the step.
    , _sesdStartDateTime :: Maybe POSIXTime
...
data StepTimeline = StepTimeline
    { _suCreationDateTime :: Maybe POSIXTime
      -- ^ The date and time when the cluster step was created.
    , _suEndDateTime :: Maybe POSIXTime
      -- ^ The date and time when the cluster step execution completed or
      -- failed.
    , _suStartDateTime :: Maybe POSIXTime
