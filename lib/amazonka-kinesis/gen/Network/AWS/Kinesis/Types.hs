...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Kinesis",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "kinesis",
                 Core._svcVersion = "2013-12-02", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _ExpiredIteratorException #-}
