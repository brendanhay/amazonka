...
instance Core.ToXML UpdateHealthCheck where
  toXML UpdateHealthCheck {..} =
    Core.toXMLNode "AlarmIdentifier" Core.<$> alarmIdentifier
      Core.<> Core.toXMLNode
        "ChildHealthChecks"
        (Core.toXMLList "ChildHealthCheck" Core.<$> childHealthChecks)
      Core.<> Core.toXMLNode "Disabled"
      Core.<$> disabled
      Core.<> Core.toXMLNode "EnableSNI"
      Core.<$> enableSNI
      Core.<> Core.toXMLNode "FailureThreshold"
      Core.<$> failureThreshold
      Core.<> Core.toXMLNode "FullyQualifiedDomainName"
      Core.<$> fullyQualifiedDomainName
      Core.<> Core.toXMLNode "HealthCheckVersion"
      Core.<$> healthCheckVersion
      Core.<> Core.toXMLNode "HealthThreshold"
      Core.<$> healthThreshold
      Core.<> Core.toXMLNode "IPAddress"
      Core.<$> iPAddress
      Core.<> Core.toXMLNode "InsufficientDataHealthStatus"
      Core.<$> insufficientDataHealthStatus
      Core.<> Core.toXMLNode "Inverted"
      Core.<$> inverted
      Core.<> Core.toXMLNode "Port"
      Core.<$> port
      Core.<> Core.toXMLNode "Regions" (Core.toXMLList "Region" Core.<$> regions)
      Core.<> Core.toXMLNode
        "ResetElements"
        (Core.toXMLList "ResettableElementName" Core.<$> resetElements)
      Core.<> Core.toXMLNode "ResourcePath"
      Core.<$> resourcePath
      Core.<> Core.toXMLNode "SearchString"
      Core.<$> searchString
  toXMLDocument =
    Core.mkXMLElement
...
{-# DEPRECATED uhcrrsHealthCheck "Use generic-lens or generic-optics with 'healthCheck' instead." #-}
...
{-# DEPRECATED uhcrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
