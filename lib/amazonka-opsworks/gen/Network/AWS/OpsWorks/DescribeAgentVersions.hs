...
mkDescribeAgentVersions
    :: DescribeAgentVersions
mkDescribeAgentVersions
  = DescribeAgentVersions'{configurationManager = Core.Nothing,
...
{-# INLINEABLE davConfigurationManager #-}
...
davStackId :: Lens.Lens' DescribeAgentVersions (Core.Maybe Core.Text)
davStackId = Lens.field @"stackId"
{-# INLINEABLE davStackId #-}
...
instance Core.ToHeaders DescribeAgentVersions where
        toHeaders DescribeAgentVersions{..}
          = Core.pure
...
instance Core.AWSRequest DescribeAgentVersions where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeAgentVersionsResponse' Core.<$>
                   (x Core..:? "AgentVersions") Core.<*> Core.pure (Core.fromEnum s))
...
mkDescribeAgentVersionsResponse responseStatus
  = DescribeAgentVersionsResponse'{agentVersions = Core.Nothing,
                                   responseStatus}
...
{-# INLINEABLE davrrsAgentVersions #-}
{-# DEPRECATED agentVersions "Use generic-lens or generic-optics with 'agentVersions' instead"  #-}
