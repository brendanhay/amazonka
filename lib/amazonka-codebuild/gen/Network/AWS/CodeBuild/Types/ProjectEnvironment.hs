...
mkProjectEnvironment
    :: Types.EnvironmentType -- ^ 'type\''
    -> Types.NonEmptyString -- ^ 'image'
    -> Types.ComputeType -- ^ 'computeType'
    -> ProjectEnvironment
mkProjectEnvironment type' image computeType
  = ProjectEnvironment'{type', image, computeType,
                        certificate = Core.Nothing, environmentVariables = Core.Nothing,
                        imagePullCredentialsType = Core.Nothing,
                        privilegedMode = Core.Nothing, registryCredential = Core.Nothing}
...
{-# INLINEABLE peEnvironmentVariables #-}
{-# DEPRECATED environmentVariables "Use generic-lens or generic-optics with 'environmentVariables' instead"  #-}
...
{-# INLINEABLE peImagePullCredentialsType #-}
{-# DEPRECATED imagePullCredentialsType "Use generic-lens or generic-optics with 'imagePullCredentialsType' instead"  #-}
...
{-# INLINEABLE pePrivilegedMode #-}
{-# DEPRECATED privilegedMode "Use generic-lens or generic-optics with 'privilegedMode' instead"  #-}
...
{-# INLINEABLE peRegistryCredential #-}
{-# DEPRECATED registryCredential "Use generic-lens or generic-optics with 'registryCredential' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("type" Core..= type'),
                  ...
                  ("imagePullCredentialsType" Core..=) Core.<$>
...
instance Core.FromJSON ProjectEnvironment where
        parseJSON
          = Core.withObject "ProjectEnvironment" Core.$
              \ x ->
                ProjectEnvironment' Core.<$>
                  (x Core..: "type") Core.<*> x Core..: "image" Core.<*>
                    x Core..: "computeType"
