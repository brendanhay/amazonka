...
data Integration = Integration'
  { -- | Specifies the integration's HTTP method type.
    ...
    requestTemplates :: Lude.Maybe (Lude.HashMap Lude.Text (Lude.Text)),
    ...
    requestParameters :: Lude.Maybe (Lude.HashMap Lude.Text (Lude.Text)),
    ...
    integrationResponses :: Lude.Maybe (Lude.HashMap Lude.Text (IntegrationResponse)),
