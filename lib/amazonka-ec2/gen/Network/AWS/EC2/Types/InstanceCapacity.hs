...
mkInstanceCapacity
    :: InstanceCapacity
mkInstanceCapacity
  = InstanceCapacity'{availableCapacity = Core.Nothing,
                      instanceType = Core.Nothing, totalCapacity = Core.Nothing}
...
{-# INLINEABLE icAvailableCapacity #-}
...
icInstanceType :: Lens.Lens' InstanceCapacity (Core.Maybe Core.Text)
icInstanceType = Lens.field @"instanceType"
{-# INLINEABLE icInstanceType #-}
...
{-# INLINEABLE icTotalCapacity #-}
{-# DEPRECATED totalCapacity "Use generic-lens or generic-optics with 'totalCapacity' instead"  #-}

instance Core.FromXML InstanceCapacity where
        parseXML x
          = InstanceCapacity' Core.<$>
              (x Core..@? "availableCapacity") Core.<*> x Core..@? "instanceType"
