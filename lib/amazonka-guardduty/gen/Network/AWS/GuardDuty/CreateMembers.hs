...
mkCreateMembers
    ...
    -> Core.NonEmpty Types.AccountDetail -- ^ 'accountDetails'
    -> CreateMembers
...
{-# INLINEABLE cmAccountDetails #-}
{-# DEPRECATED accountDetails "Use generic-lens or generic-optics with 'accountDetails' instead"  #-}

instance Core.ToQuery CreateMembers where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders CreateMembers where
        toHeaders CreateMembers{..}
...
mkCreateMembersResponse responseStatus
  = CreateMembersResponse'{unprocessedAccounts = Core.mempty,
                           responseStatus}
...
{-# INLINEABLE cmrrsUnprocessedAccounts #-}
