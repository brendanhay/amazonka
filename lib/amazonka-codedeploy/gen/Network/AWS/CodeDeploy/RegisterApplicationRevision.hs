...
mkRegisterApplicationRevision applicationName revision
  = RegisterApplicationRevision'{applicationName, revision,
...
instance Core.ToHeaders RegisterApplicationRevision where
        toHeaders RegisterApplicationRevision{..}
          = Core.pure
