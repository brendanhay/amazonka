...
mkS3DataSource s3DataType s3Uri
  = S3DataSource'{s3DataType, s3Uri, attributeNames = Core.Nothing,
...
{-# INLINEABLE sdsS3DataDistributionType #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("S3DataType" Core..= s3DataType),
                  ...
                  ("S3DataDistributionType" Core..=) Core.<$>
...
instance Core.FromJSON S3DataSource where
        parseJSON
          = Core.withObject "S3DataSource" Core.$
              \ x ->
                S3DataSource' Core.<$>
                  (x Core..: "S3DataType") Core.<*> x Core..: "S3Uri" Core.<*>
                    x Core..:? "AttributeNames"
