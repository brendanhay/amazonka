...
mkConfigurationOptionDescription
    :: ConfigurationOptionDescription
mkConfigurationOptionDescription
  = ConfigurationOptionDescription'{changeSeverity = Core.Nothing,
                                    defaultValue = Core.Nothing, maxLength = Core.Nothing,
                                    maxValue = Core.Nothing, minValue = Core.Nothing,
                                    name = Core.Nothing, namespace = Core.Nothing,
                                    regex = Core.Nothing, userDefined = Core.Nothing,
                                    valueOptions = Core.Nothing, valueType = Core.Nothing}
...
{-# INLINEABLE codChangeSeverity #-}
{-# DEPRECATED changeSeverity "Use generic-lens or generic-optics with 'changeSeverity' instead"  #-}
...
{-# INLINEABLE codUserDefined #-}
{-# DEPRECATED userDefined "Use generic-lens or generic-optics with 'userDefined' instead"  #-}
...
{-# INLINEABLE codValueOptions #-}
{-# DEPRECATED valueOptions "Use generic-lens or generic-optics with 'valueOptions' instead"  #-}
...
{-# INLINEABLE codValueType #-}
{-# DEPRECATED valueType "Use generic-lens or generic-optics with 'valueType' instead"  #-}

instance Core.FromXML ConfigurationOptionDescription where
        parseXML x
          = ConfigurationOptionDescription' Core.<$>
              (x Core..@? "ChangeSeverity") Core.<*> x Core..@? "DefaultValue"
                ...
                Core.<*>
                x Core..@? "ValueOptions" Core..<@> Core.parseXMLList "member"
