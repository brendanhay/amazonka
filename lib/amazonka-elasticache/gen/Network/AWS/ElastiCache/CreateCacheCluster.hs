...
data CreateCacheCluster = CreateCacheCluster'
  { _cccEngineVersion ::
    ...
    _cccOutpostMode :: !(Maybe OutpostMode),
    ...
    _cccPreferredOutpostARNs :: !(Maybe [Text]),
    _cccAZMode :: !(Maybe AZMode),
    _cccSnapshotName :: !(Maybe Text),
    _cccPreferredOutpostARN :: !(Maybe Text),
  ...
  toQuery CreateCacheCluster' {..} =
    mconcat
      [ "Action" =: ("CreateCacheCluster" :: ByteString),
        ...
        "SecurityGroupIds"
          =: toQuery (toQueryList "SecurityGroupId" <$> _cccSecurityGroupIds),
        "SnapshotArns"
          =: toQuery (toQueryList "SnapshotArn" <$> _cccSnapshotARNs),
        ...
        "PreferredOutpostArns"
          =: toQuery
            (toQueryList "PreferredOutpostArn" <$> _cccPreferredOutpostARNs),
        "AZMode" =: _cccAZMode,
