...
-- this value for OpenID Connect ID tokens, such as @accounts.google.com@.
-- Do not include URL schemes and port numbers. Currently, @www.amazon.com@
-- and @graph.facebook.com@ are supported.
...
-- @WebIdentityToken@ (pairwise identifier). If an OpenID Connect ID token
-- was submitted in the @WebIdentityToken@, this value is returned by the
