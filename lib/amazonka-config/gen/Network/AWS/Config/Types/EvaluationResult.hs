...
{-# INLINEABLE erConfigRuleInvokedTime #-}
...
{-# INLINEABLE erEvaluationResultIdentifier #-}
...
{-# INLINEABLE erResultRecordedTime #-}
...
erResultToken :: Lens.Lens' EvaluationResult (Core.Maybe Core.Text)
erResultToken = Lens.field @"resultToken"
{-# INLINEABLE erResultToken #-}
          ...
          = Core.withObject "EvaluationResult" Core.$
              \ x ->
                EvaluationResult' Core.<$>
                  (x Core..:? "Annotation") Core.<*> x Core..:? "ComplianceType"
