...
mkHlsEncryptionSettings
    :: HlsEncryptionSettings
mkHlsEncryptionSettings
  = HlsEncryptionSettings'{constantInitializationVector =
                             Core.Nothing,
                           encryptionMethod = Core.Nothing,
                           initializationVectorInManifest = Core.Nothing,
                           offlineEncrypted = Core.Nothing, spekeKeyProvider = Core.Nothing,
                           staticKeyProvider = Core.Nothing, type' = Core.Nothing}
...
{-# INLINEABLE hesConstantInitializationVector #-}
...
{-# INLINEABLE hesEncryptionMethod #-}
...
{-# INLINEABLE hesInitializationVectorInManifest #-}
...
{-# INLINEABLE hesOfflineEncrypted #-}
{-# DEPRECATED offlineEncrypted "Use generic-lens or generic-optics with 'offlineEncrypted' instead"  #-}
...
{-# INLINEABLE hesSpekeKeyProvider #-}
...
{-# INLINEABLE hesStaticKeyProvider #-}
