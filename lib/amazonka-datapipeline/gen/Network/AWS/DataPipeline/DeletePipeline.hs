...
newtype DeletePipeline = DeletePipeline' {pipelineId :: Lude.Text}
  deriving stock
    ( Lude.Eq,
      Lude.Ord,
      Lude.Read,
...
dpPipelineId :: Lens.Lens' DeletePipeline Lude.Text
dpPipelineId = Lens.lens (pipelineId :: DeletePipeline -> Lude.Text) (\s a -> s {pipelineId = a} :: DeletePipeline)
