...
mkListAlgorithms
    :: ListAlgorithms
mkListAlgorithms
  = ListAlgorithms'{creationTimeAfter = Core.Nothing,
...
{-# INLINEABLE lCreationTimeBefore #-}
...
instance Core.ToHeaders ListAlgorithms where
        toHeaders ListAlgorithms{..}
          = Core.pure ("X-Amz-Target", "SageMaker.ListAlgorithms") Core.<>
...
instance Core.AWSRequest ListAlgorithms where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListAlgorithmsResponse' Core.<$>
                   (x Core..:? "AlgorithmSummaryList" Core..!= Core.mempty) Core.<*>
                     x Core..:? "NextToken"
...
mkListAlgorithmsResponse responseStatus
  = ListAlgorithmsResponse'{algorithmSummaryList = Core.mempty,
...
{-# INLINEABLE larfrsAlgorithmSummaryList #-}
{-# DEPRECATED algorithmSummaryList "Use generic-lens or generic-optics with 'algorithmSummaryList' instead"  #-}
...
{-# INLINEABLE larfrsResponseStatus #-}
