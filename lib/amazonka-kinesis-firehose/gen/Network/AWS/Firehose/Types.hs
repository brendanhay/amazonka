...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "Firehose",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "firehose",
                 Core._svcVersion = "2015-08-04", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _InvalidKMSResourceException #-}
