...
mkCreateAppImageConfig appImageConfigName
  = CreateAppImageConfig'{appImageConfigName,
                          kernelGatewayImageConfig = Core.Nothing, tags = Core.Nothing}
...
{-# INLINEABLE caicAppImageConfigName #-}
...
{-# INLINEABLE caicKernelGatewayImageConfig #-}
...
instance Core.ToHeaders CreateAppImageConfig where
        toHeaders CreateAppImageConfig{..}
...
instance Core.AWSRequest CreateAppImageConfig where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateAppImageConfigResponse' Core.<$>
...
mkCreateAppImageConfigResponse responseStatus
  = CreateAppImageConfigResponse'{appImageConfigArn = Core.Nothing,
                                  responseStatus}
...
{-# INLINEABLE caicrrsAppImageConfigArn #-}
...
{-# INLINEABLE caicrrsResponseStatus #-}
