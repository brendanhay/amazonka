...
-- |
-- Module      : Network.AWS.AppFlow.Types.ConnectionMode
...
pattern ConnectionMode_Private = ConnectionMode' "Private"

pattern ConnectionMode_Public :: ConnectionMode
pattern ConnectionMode_Public = ConnectionMode' "Public"
