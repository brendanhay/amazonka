...
mkSavingsPlansCoverageData
    :: SavingsPlansCoverageData
mkSavingsPlansCoverageData
  = SavingsPlansCoverageData'{coveragePercentage = Core.Nothing,
...
{-# INLINEABLE spcdCoveragePercentage #-}
{-# DEPRECATED coveragePercentage "Use generic-lens or generic-optics with 'coveragePercentage' instead"  #-}
...
{-# INLINEABLE spcdSpendCoveredBySavingsPlans #-}
{-# DEPRECATED spendCoveredBySavingsPlans "Use generic-lens or generic-optics with 'spendCoveredBySavingsPlans' instead"  #-}
...
{-# INLINEABLE spcdTotalCost #-}
{-# DEPRECATED totalCost "Use generic-lens or generic-optics with 'totalCost' instead"  #-}

instance Core.FromJSON SavingsPlansCoverageData where
        parseJSON
          = Core.withObject "SavingsPlansCoverageData" Core.$
              \ x ->
                SavingsPlansCoverageData' Core.<$>
                  (x Core..:? "CoveragePercentage") Core.<*>
                    x Core..:? "OnDemandCost"
