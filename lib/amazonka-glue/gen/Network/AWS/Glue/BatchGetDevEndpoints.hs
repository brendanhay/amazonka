...
mkBatchGetDevEndpoints
    :: Core.NonEmpty Types.GenericString -- ^ 'devEndpointNames'
    -> BatchGetDevEndpoints
...
{-# INLINEABLE bgdeDevEndpointNames #-}
...
instance Core.ToHeaders BatchGetDevEndpoints where
        toHeaders BatchGetDevEndpoints{..}
...
instance Core.AWSRequest BatchGetDevEndpoints where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 BatchGetDevEndpointsResponse' Core.<$>
                   (x Core..:? "DevEndpoints") Core.<*>
                     x Core..:? "DevEndpointsNotFound"
...
mkBatchGetDevEndpointsResponse responseStatus
  = BatchGetDevEndpointsResponse'{devEndpoints = Core.Nothing,
                                  devEndpointsNotFound = Core.Nothing, responseStatus}
...
{-# INLINEABLE bgderrsDevEndpoints #-}
...
{-# INLINEABLE bgderrsDevEndpointsNotFound #-}
{-# DEPRECATED devEndpointsNotFound "Use generic-lens or generic-optics with 'devEndpointsNotFound' instead"  #-}
...
{-# INLINEABLE bgderrsResponseStatus #-}
