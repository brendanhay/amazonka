...
-- |
-- Module      : Amazonka.CleanRooms.ListTagsForResource
...
--
-- 'resourceArn', 'listTagsForResource_resourceArn' - The Amazon Resource Name (ARN) associated with the resource you want to
-- list tags on.
newListTagsForResource ::
  -- | 'resourceArn'
  Prelude.Text ->
...
--
-- 'tags', 'listTagsForResourceResponse_tags' - A map of objects specifying each key name and value.
newListTagsForResourceResponse ::
  -- | 'httpStatus'
  Prelude.Int ->
  ListTagsForResourceResponse
