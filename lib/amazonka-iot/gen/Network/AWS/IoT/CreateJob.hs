...
--
-- * 'cjNamespaceId' - The namespace used to indicate that a job is a customer-managed job. When you specify a value for this parameter, AWS IoT Core sends jobs notifications to MQTT topics that contain the value in the following format. @> aws/things//THING_NAME/ /jobs//JOB_ID/ /notify-namespace-/NAMESPACE_ID/ /@
--
...
cjNamespaceId :: Lens' CreateJob (Maybe Text)
cjNamespaceId = lens _cjNamespaceId (\s a -> s {_cjNamespaceId = a})
...
instance ToPath CreateJob where
  toPath CreateJob' {..} = mconcat ["/jobs/", toBS _cjJobId]
