...
{-# DEPRECATED lhforrsHandshakes "Use generic-lens or generic-optics with 'handshakes' instead." #-}
...
{-# DEPRECATED lhforrsNextToken "Use generic-lens or generic-optics with 'nextToken' instead." #-}
...
{-# DEPRECATED lhforrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
