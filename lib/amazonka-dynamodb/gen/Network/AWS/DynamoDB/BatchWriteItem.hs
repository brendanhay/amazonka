...
mkBatchWriteItem
    :: BatchWriteItem
mkBatchWriteItem
  = BatchWriteItem'{requestItems = Core.mempty,
...
{-# INLINEABLE bwiRequestItems #-}
{-# DEPRECATED requestItems "Use generic-lens or generic-optics with 'requestItems' instead"  #-}
...
{-# INLINEABLE bwiReturnConsumedCapacity #-}
...
{-# INLINEABLE bwiReturnItemCollectionMetrics #-}
...
mkBatchWriteItemResponse responseStatus
  = BatchWriteItemResponse'{consumedCapacity = Core.Nothing,
                            itemCollectionMetrics = Core.Nothing,
                            unprocessedItems = Core.Nothing, responseStatus}
...
{-# INLINEABLE bwirrsConsumedCapacity #-}
...
{-# INLINEABLE bwirrsItemCollectionMetrics #-}
...
{-# INLINEABLE bwirrsUnprocessedItems #-}
{-# DEPRECATED unprocessedItems "Use generic-lens or generic-optics with 'unprocessedItems' instead"  #-}
...
{-# INLINEABLE bwirrsResponseStatus #-}
