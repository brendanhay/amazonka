...
mkMonitoringBaselineConfig
    :: MonitoringBaselineConfig
mkMonitoringBaselineConfig
  = MonitoringBaselineConfig'{constraintsResource = Core.Nothing,
...
{-# INLINEABLE mbcConstraintsResource #-}
{-# DEPRECATED constraintsResource "Use generic-lens or generic-optics with 'constraintsResource' instead"  #-}
...
{-# INLINEABLE mbcStatisticsResource #-}
{-# DEPRECATED statisticsResource "Use generic-lens or generic-optics with 'statisticsResource' instead"  #-}
...
instance Core.FromJSON MonitoringBaselineConfig where
        parseJSON
          = Core.withObject "MonitoringBaselineConfig" Core.$
              \ x ->
                MonitoringBaselineConfig' Core.<$>
                  (x Core..:? "ConstraintsResource") Core.<*>
                    x Core..:? "StatisticsResource"
