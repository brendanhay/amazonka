...
{-# INLINEABLE gblcExpectedBucketOwner #-}
{-# DEPRECATED expectedBucketOwner "Use generic-lens or generic-optics with 'expectedBucketOwner' instead"  #-}

instance Core.ToQuery GetBucketLifecycleConfiguration where
        toQuery GetBucketLifecycleConfiguration{..}
          = Core.toQueryPair "lifecycle" ("" :: Core.Text)

instance Core.ToHeaders GetBucketLifecycleConfiguration where
...
instance Core.AWSRequest GetBucketLifecycleConfiguration where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 GetBucketLifecycleConfigurationResponse' Core.<$>
...
mkGetBucketLifecycleConfigurationResponse responseStatus
  = GetBucketLifecycleConfigurationResponse'{rules = Core.Nothing,
                                             responseStatus}
...
{-# INLINEABLE gblcrrsResponseStatus #-}
