...
mkStartContentModeration video
  = StartContentModeration'{video, clientRequestToken = Core.Nothing,
...
{-# INLINEABLE scmClientRequestToken #-}
...
{-# INLINEABLE scmNotificationChannel #-}
...
instance Core.ToHeaders StartContentModeration where
        toHeaders StartContentModeration{..}
          = Core.pure
...
instance Core.AWSRequest StartContentModeration where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartContentModerationResponse' Core.<$>
...
mkStartContentModerationResponse responseStatus
  = StartContentModerationResponse'{jobId = Core.Nothing,
                                    responseStatus}
...
{-# INLINEABLE scmrrsResponseStatus #-}
