...
mkSearchProfiles
    :: SearchProfiles
mkSearchProfiles
  = SearchProfiles'{filters = Core.Nothing,
...
instance Core.AWSRequest SearchProfiles where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 SearchProfilesResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "Profiles" Core.<*>
                     x Core..:? "TotalCount"
...
mkSearchProfilesResponse responseStatus
  = SearchProfilesResponse'{nextToken = Core.Nothing,
                            profiles = Core.Nothing, totalCount = Core.Nothing, responseStatus}
...
{-# INLINEABLE sprrsProfiles #-}
{-# DEPRECATED profiles "Use generic-lens or generic-optics with 'profiles' instead"  #-}
