...
mkBulkEmailDestinationStatus
    :: BulkEmailDestinationStatus
mkBulkEmailDestinationStatus
  = BulkEmailDestinationStatus'{error = Core.Nothing,
                                messageId = Core.Nothing, status = Core.Nothing}
...
{-# INLINEABLE bedsStatus #-}
{-# DEPRECATED status "Use generic-lens or generic-optics with 'status' instead"  #-}

instance Core.FromXML BulkEmailDestinationStatus where
        parseXML x
          = BulkEmailDestinationStatus' Core.<$>
              (x Core..@? "Error") Core.<*> x Core..@? "MessageId" Core.<*>
                x Core..@? "Status"
