  ...
  toQuery ReplaceRoute' {..} =
    mconcat
      [ "Action" =: ("ReplaceRoute" :: ByteString),
        ...
        "EgressOnlyInternetGatewayId" =: _rrEgressOnlyInternetGatewayId,
        "DestinationIpv6CidrBlock" =: _rrDestinationIPv6CidrBlock,
        ...
        "DestinationPrefixListId" =: _rrDestinationPrefixListId,
        "DryRun" =: _rrDryRun,
