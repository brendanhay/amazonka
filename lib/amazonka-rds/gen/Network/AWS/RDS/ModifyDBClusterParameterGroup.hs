...
mdbcpgDBClusterParameterGroupName :: Lens.Lens' ModifyDBClusterParameterGroup Core.Text
mdbcpgDBClusterParameterGroupName = Lens.field @"dBClusterParameterGroupName"
{-# INLINEABLE mdbcpgDBClusterParameterGroupName #-}
...
instance Core.AWSRequest ModifyDBClusterParameterGroup where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "ModifyDBClusterParameterGroupResult"
