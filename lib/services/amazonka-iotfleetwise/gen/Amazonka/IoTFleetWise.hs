...
--
-- Amazon Web Services IoT FleetWise is in preview release and is subject
-- to change. We recommend that you use the service only with test data,
-- and not in production environments.
--
-- While Amazon Web Services IoT FleetWise is in preview, you must download
-- the preview Amazon Web Services SDK and CLI to use the API operations
-- for this service. These API operations aren\'t available in the public
-- Amazon Web Services SDK or CLI. For more information, see
-- <https://docs.aws.amazon.com/iot-fleetwise/latest/developerguide/preview-sdk-cli.html Preview Amazon Web Services SDK and CLI>
