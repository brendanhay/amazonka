...
mkDisableAvailabilityZonesForLoadBalancer loadBalancerName
  = DisableAvailabilityZonesForLoadBalancer'{loadBalancerName,
...
{-# INLINEABLE dazflbLoadBalancerName #-}
...
{-# INLINEABLE dazflbAvailabilityZones #-}
{-# DEPRECATED availabilityZones "Use generic-lens or generic-optics with 'availabilityZones' instead"  #-}

instance Core.ToQuery DisableAvailabilityZonesForLoadBalancer where
        toQuery DisableAvailabilityZonesForLoadBalancer{..}
          = Core.toQueryPair "Action"
              ("DisableAvailabilityZonesForLoadBalancer" :: Core.Text)
...
instance Core.ToHeaders DisableAvailabilityZonesForLoadBalancer
         where
        toHeaders _ = Core.pure Core.mempty

instance Core.AWSRequest DisableAvailabilityZonesForLoadBalancer
         where
        ...
        parseResponse
          = Response.receiveXMLWrapper
              ...
              (\ s h x ->
                 DisableAvailabilityZonesForLoadBalancerResponse' Core.<$>
...
mkDisableAvailabilityZonesForLoadBalancerResponse responseStatus
  = DisableAvailabilityZonesForLoadBalancerResponse'{availabilityZones
                                                       = Core.Nothing,
                                                     responseStatus}
...
{-# INLINEABLE dazflbrrsAvailabilityZones #-}
{-# DEPRECATED availabilityZones "Use generic-lens or generic-optics with 'availabilityZones' instead"  #-}
...
{-# INLINEABLE dazflbrrsResponseStatus #-}
