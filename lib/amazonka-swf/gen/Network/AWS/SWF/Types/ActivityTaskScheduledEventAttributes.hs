...
mkActivityTaskScheduledEventAttributes
    ...
    -> ActivityTaskScheduledEventAttributes
mkActivityTaskScheduledEventAttributes activityType activityId
  taskList decisionTaskCompletedEventId
  = ActivityTaskScheduledEventAttributes'{activityType, activityId,
                                          taskList, decisionTaskCompletedEventId,
                                          control = Core.Nothing, heartbeatTimeout = Core.Nothing,
                                          input = Core.Nothing,
...
{-# INLINEABLE atseaDecisionTaskCompletedEventId #-}
...
{-# INLINEABLE atseaHeartbeatTimeout #-}
...
{-# INLINEABLE atseaScheduleToCloseTimeout #-}
{-# DEPRECATED scheduleToCloseTimeout "Use generic-lens or generic-optics with 'scheduleToCloseTimeout' instead"  #-}
...
{-# INLINEABLE atseaScheduleToStartTimeout #-}
{-# DEPRECATED scheduleToStartTimeout "Use generic-lens or generic-optics with 'scheduleToStartTimeout' instead"  #-}
...
{-# INLINEABLE atseaStartToCloseTimeout #-}
...
instance Core.FromJSON ActivityTaskScheduledEventAttributes where
        parseJSON
          = Core.withObject "ActivityTaskScheduledEventAttributes" Core.$
              \ x ->
                ActivityTaskScheduledEventAttributes' Core.<$>
