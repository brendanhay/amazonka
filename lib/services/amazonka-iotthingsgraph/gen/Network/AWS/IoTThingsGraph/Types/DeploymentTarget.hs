...
-- |
-- Module      : Network.AWS.IoTThingsGraph.Types.DeploymentTarget
...
pattern DeploymentTarget_CLOUD = DeploymentTarget' "CLOUD"

pattern DeploymentTarget_GREENGRASS :: DeploymentTarget
pattern DeploymentTarget_GREENGRASS = DeploymentTarget' "GREENGRASS"
