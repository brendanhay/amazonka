...
instance Core.ToXML PublicAccessBlockConfiguration where
  toXML PublicAccessBlockConfiguration {..} =
    Core.toXMLNode "BlockPublicAcls" Core.<$> blockPublicAcls
      Core.<> Core.toXMLNode "BlockPublicPolicy"
      Core.<$> blockPublicPolicy
      Core.<> Core.toXMLNode "IgnorePublicAcls"
      Core.<$> ignorePublicAcls
      Core.<> Core.toXMLNode "RestrictPublicBuckets"
