...
mkGenericAttachment
    :: GenericAttachment
mkGenericAttachment
  = GenericAttachment'{attachmentLinkUrl = Core.Nothing,
                       buttons = Core.Nothing, imageUrl = Core.Nothing,
...
{-# INLINEABLE gaAttachmentLinkUrl #-}
{-# DEPRECATED attachmentLinkUrl "Use generic-lens or generic-optics with 'attachmentLinkUrl' instead"  #-}
...
{-# INLINEABLE gaButtons #-}
{-# DEPRECATED buttons "Use generic-lens or generic-optics with 'buttons' instead"  #-}
...
{-# INLINEABLE gaSubTitle #-}
{-# DEPRECATED subTitle "Use generic-lens or generic-optics with 'subTitle' instead"  #-}
...
instance Core.FromJSON GenericAttachment where
        parseJSON
          = Core.withObject "GenericAttachment" Core.$
              \ x ->
                GenericAttachment' Core.<$>
                  (x Core..:? "attachmentLinkUrl") Core.<*> x Core..:? "buttons"
