...
-- service is set to 'true'. This action resets the 'taskHeartbeatTimeout'
-- clock. The 'taskHeartbeatTimeout' is specified in 'RegisterActivityType'.
...
-- from the last heartbeat generated by the activity worker. If the
