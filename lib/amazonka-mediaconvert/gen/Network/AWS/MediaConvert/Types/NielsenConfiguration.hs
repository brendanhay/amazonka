...
mkNielsenConfiguration
    :: NielsenConfiguration
mkNielsenConfiguration
  = NielsenConfiguration'{breakoutCode = Core.Nothing,
...
{-# INLINEABLE ncBreakoutCode #-}
{-# DEPRECATED breakoutCode "Use generic-lens or generic-optics with 'breakoutCode' instead"  #-}
          ...
          = Core.withObject "NielsenConfiguration" Core.$
              \ x ->
                NielsenConfiguration' Core.<$>
                  (x Core..:? "breakoutCode") Core.<*> x Core..:? "distributorId"
