...
data LogSettingsResponse = LogSettingsResponse'
  { -- | The Amazon Resource Name (ARN) of the CloudWatch Logs log group or S3
    ...
    -- specified.
    resourcePrefix :: Core.Maybe Core.Text
  }
...
-- | The Amazon Resource Name (ARN) of the CloudWatch Logs log group or S3
-- bucket where the logs are delivered.
logSettingsResponse_resourceArn :: Lens.Lens' LogSettingsResponse (Core.Maybe Core.Text)
...
-- | The type of logging that is enabled.
logSettingsResponse_logType :: Lens.Lens' LogSettingsResponse (Core.Maybe LogType)
...
-- | The Amazon Resource Name (ARN) of the key used to encrypt audio logs in
-- an S3 bucket.
logSettingsResponse_kmsKeyArn :: Lens.Lens' LogSettingsResponse (Core.Maybe Core.Text)
...
-- | The destination where logs are delivered.
logSettingsResponse_destination :: Lens.Lens' LogSettingsResponse (Core.Maybe Destination)
...
-- is the prefix of the log stream name within the log group that you
-- specified.
logSettingsResponse_resourcePrefix :: Lens.Lens' LogSettingsResponse (Core.Maybe Core.Text)
...
instance Core.Hashable LogSettingsResponse

instance Core.NFData LogSettingsResponse
