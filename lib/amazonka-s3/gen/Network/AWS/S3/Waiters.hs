...
mkObjectNotExists
  = Waiter.Wait{Waiter._waitName = "ObjectNotExists",
...
mkBucketExists
  = Waiter.Wait{Waiter._waitName = "BucketExists",
                Waiter._waitAttempts = 20, Waiter._waitDelay = 5,
                Waiter._waitAcceptors =
...
mkObjectExists
  = Waiter.Wait{Waiter._waitName = "ObjectExists",
                Waiter._waitAttempts = 20, Waiter._waitDelay = 5,
                Waiter._waitAcceptors =
                  [Waiter.matchStatus 200 Waiter.AcceptSuccess,
                   Waiter.matchStatus 404 Waiter.AcceptRetry]}
...
mkBucketNotExists
  = Waiter.Wait{Waiter._waitName = "BucketNotExists",
                Waiter._waitAttempts = 20, Waiter._waitDelay = 5,
                Waiter._waitAcceptors =
                  [Waiter.matchStatus 404 Waiter.AcceptSuccess]}
