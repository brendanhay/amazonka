...
--
-- * 'swerRunId'
newtype StartWorkflowExecutionResponse = StartWorkflowExecutionResponse'{_swerRunId :: Maybe Text} deriving (Eq, Read, Show)

-- | 'StartWorkflowExecutionResponse' smart constructor.
startWorkflowExecutionResponse :: StartWorkflowExecutionResponse
startWorkflowExecutionResponse = StartWorkflowExecutionResponse'{_swerRunId = Nothing};
