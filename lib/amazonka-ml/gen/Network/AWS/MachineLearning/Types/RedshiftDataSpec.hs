...
mkRedshiftDataSpec
    :: Types.RedshiftDatabase -- ^ 'databaseInformation'
    -> Types.RedshiftSelectSqlQuery -- ^ 'selectSqlQuery'
    -> Types.RedshiftDatabaseCredentials -- ^ 'databaseCredentials'
    -> Types.S3Url -- ^ 's3StagingLocation'
    -> RedshiftDataSpec
mkRedshiftDataSpec databaseInformation selectSqlQuery
  databaseCredentials s3StagingLocation
  = RedshiftDataSpec'{databaseInformation, selectSqlQuery,
                      databaseCredentials, s3StagingLocation,
...
{-# INLINEABLE rdsDatabaseInformation #-}
...
{-# INLINEABLE rdsDatabaseCredentials #-}
...
{-# INLINEABLE rdsS3StagingLocation #-}
...
{-# INLINEABLE rdsDataRearrangement #-}
