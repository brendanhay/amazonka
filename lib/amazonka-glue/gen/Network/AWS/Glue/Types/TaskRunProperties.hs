...
mkTaskRunProperties
    :: TaskRunProperties
mkTaskRunProperties
  = TaskRunProperties'{exportLabelsTaskRunProperties = Core.Nothing,
...
{-# INLINEABLE trpExportLabelsTaskRunProperties #-}
{-# DEPRECATED exportLabelsTaskRunProperties "Use generic-lens or generic-optics with 'exportLabelsTaskRunProperties' instead"  #-}
...
{-# INLINEABLE trpFindMatchesTaskRunProperties #-}
{-# DEPRECATED findMatchesTaskRunProperties "Use generic-lens or generic-optics with 'findMatchesTaskRunProperties' instead"  #-}
...
{-# INLINEABLE trpImportLabelsTaskRunProperties #-}
{-# DEPRECATED importLabelsTaskRunProperties "Use generic-lens or generic-optics with 'importLabelsTaskRunProperties' instead"  #-}
...
{-# INLINEABLE trpLabelingSetGenerationTaskRunProperties #-}
{-# DEPRECATED labelingSetGenerationTaskRunProperties "Use generic-lens or generic-optics with 'labelingSetGenerationTaskRunProperties' instead"  #-}
...
instance Core.FromJSON TaskRunProperties where
        parseJSON
          = Core.withObject "TaskRunProperties" Core.$
              \ x ->
                TaskRunProperties' Core.<$>
                  (x Core..:? "ExportLabelsTaskRunProperties") Core.<*>
                    x Core..:? "FindMatchesTaskRunProperties"
