...
{-# DEPRECATED dbcsarDBClusterSnapshotAttributes "Use generic-lens or generic-optics with 'dBClusterSnapshotAttributes' instead." #-}
...
dbcsarDBClusterSnapshotIdentifier :: Lens.Lens' DBClusterSnapshotAttributesResult (Core.Maybe Types.String)
dbcsarDBClusterSnapshotIdentifier = Lens.field @"dBClusterSnapshotIdentifier"
{-# DEPRECATED dbcsarDBClusterSnapshotIdentifier "Use generic-lens or generic-optics with 'dBClusterSnapshotIdentifier' instead." #-}

instance Core.FromXML DBClusterSnapshotAttributesResult where
  parseXML x =
    DBClusterSnapshotAttributesResult'
      Core.<$> ( x Core..@? "DBClusterSnapshotAttributes"
                   Core..<@> Core.parseXMLList "DBClusterSnapshotAttribute"
               )
