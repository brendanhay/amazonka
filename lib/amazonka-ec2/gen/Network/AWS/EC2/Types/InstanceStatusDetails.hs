...
mkInstanceStatusDetails
    :: InstanceStatusDetails
mkInstanceStatusDetails
  = InstanceStatusDetails'{impairedSince = Core.Nothing,
...
{-# INLINEABLE isdImpairedSince #-}
{-# DEPRECATED impairedSince "Use generic-lens or generic-optics with 'impairedSince' instead"  #-}
...
{-# INLINEABLE isdStatus #-}
{-# DEPRECATED status "Use generic-lens or generic-optics with 'status' instead"  #-}

instance Core.FromXML InstanceStatusDetails where
        parseXML x
          = InstanceStatusDetails' Core.<$>
              (x Core..@? "impairedSince") Core.<*> x Core..@? "name" Core.<*>
                x Core..@? "status"
