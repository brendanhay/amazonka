...
mkInsightRuleMetricDatapoint timestamp
  = InsightRuleMetricDatapoint'{timestamp, average = Core.Nothing,
                                maxContributorValue = Core.Nothing, maximum = Core.Nothing,
                                minimum = Core.Nothing, sampleCount = Core.Nothing,
                                sum = Core.Nothing, uniqueContributors = Core.Nothing}
...
{-# INLINEABLE irmdMaxContributorValue #-}
{-# DEPRECATED maxContributorValue "Use generic-lens or generic-optics with 'maxContributorValue' instead"  #-}
...
{-# INLINEABLE irmdUniqueContributors #-}
{-# DEPRECATED uniqueContributors "Use generic-lens or generic-optics with 'uniqueContributors' instead"  #-}

instance Core.FromXML InsightRuleMetricDatapoint where
        parseXML x
          = InsightRuleMetricDatapoint' Core.<$>
              (x Core..@ "Timestamp") Core.<*> x Core..@? "Average" Core.<*>
                x Core..@? "MaxContributorValue"
                Core.<*> x Core..@? "Maximum"
                Core.<*> x Core..@? "Minimum"
