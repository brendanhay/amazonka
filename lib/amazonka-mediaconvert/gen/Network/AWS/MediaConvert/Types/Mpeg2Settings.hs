...
data Mpeg2Settings = Mpeg2Settings'
  { -- | Optional. Use Quality tuning level (qualityTuningLevel) to choose how you want to trade off encoding speed for output video quality. The default behavior is faster, lower quality, single-pass encoding.
    qualityTuningLevel :: Lude.Maybe Mpeg2QualityTuningLevel,
    ...
    temporalAdaptiveQuantization :: Lude.Maybe Mpeg2TemporalAdaptiveQuantization,
    ...
    framerateConversionAlgorithm :: Lude.Maybe Mpeg2FramerateConversionAlgorithm,
    ...
    spatialAdaptiveQuantization :: Lude.Maybe Mpeg2SpatialAdaptiveQuantization
  }
