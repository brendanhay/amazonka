...
mkBillingModeSummary
    :: BillingModeSummary
mkBillingModeSummary
  = BillingModeSummary'{billingMode = Core.Nothing,
...
{-# INLINEABLE bmsLastUpdateToPayPerRequestDateTime #-}
{-# DEPRECATED lastUpdateToPayPerRequestDateTime "Use generic-lens or generic-optics with 'lastUpdateToPayPerRequestDateTime' instead"  #-}
          ...
          = Core.withObject "BillingModeSummary" Core.$
              \ x ->
                BillingModeSummary' Core.<$>
                  (x Core..:? "BillingMode") Core.<*>
                    x Core..:? "LastUpdateToPayPerRequestDateTime"
