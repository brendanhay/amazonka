...
-- |
-- Module      : Network.AWS.LexV2Models.ListBuiltInSlotTypes
...
instance Prelude.Hashable ListBuiltInSlotTypes

instance Prelude.NFData ListBuiltInSlotTypes
...
instance Prelude.NFData ListBuiltInSlotTypesResponse
