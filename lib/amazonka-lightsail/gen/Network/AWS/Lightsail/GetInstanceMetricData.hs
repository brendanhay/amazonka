...
mkGetInstanceMetricData
    ...
    -> Types.InstanceMetricName -- ^ 'metricName'
    -> Core.Natural -- ^ 'period'
    -> Core.NominalDiffTime -- ^ 'startTime'
    -> Core.NominalDiffTime -- ^ 'endTime'
    -> Types.MetricUnit -- ^ 'unit'
    -> GetInstanceMetricData
mkGetInstanceMetricData instanceName metricName period startTime
  endTime unit
  = GetInstanceMetricData'{instanceName, metricName, period,
                           startTime, endTime, unit, statistics = Core.mempty}
...
instance Core.ToHeaders GetInstanceMetricData where
        toHeaders GetInstanceMetricData{..}
          = Core.pure
...
instance Core.AWSRequest GetInstanceMetricData where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetInstanceMetricDataResponse' Core.<$>
...
mkGetInstanceMetricDataResponse responseStatus
  = GetInstanceMetricDataResponse'{metricData = Core.Nothing,
...
{-# INLINEABLE gimdrrsResponseStatus #-}
