...
mkLaunchPathSummary
    :: LaunchPathSummary
mkLaunchPathSummary
  = LaunchPathSummary'{constraintSummaries = Core.Nothing,
                       id = Core.Nothing, name = Core.Nothing, tags = Core.Nothing}
...
{-# INLINEABLE lpsConstraintSummaries #-}
...
instance Core.FromJSON LaunchPathSummary where
        parseJSON
          = Core.withObject "LaunchPathSummary" Core.$
              \ x ->
                LaunchPathSummary' Core.<$>
                  (x Core..:? "ConstraintSummaries") Core.<*> x Core..:? "Id"
                    Core.<*> x Core..:? "Name"
                    Core.<*> x Core..:? "Tags"
