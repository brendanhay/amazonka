...
mkOutputSource
    :: OutputSource
mkOutputSource
  = OutputSource'{outputSourceId = Core.Nothing,
...
{-# INLINEABLE osOutputSourceId #-}
{-# DEPRECATED outputSourceId "Use generic-lens or generic-optics with 'outputSourceId' instead"  #-}
...
{-# INLINEABLE osOutputSourceType #-}
{-# DEPRECATED outputSourceType "Use generic-lens or generic-optics with 'outputSourceType' instead"  #-}
...
instance Core.FromJSON OutputSource where
        parseJSON
          = Core.withObject "OutputSource" Core.$
              \ x ->
                OutputSource' Core.<$>
                  (x Core..:? "OutputSourceId") Core.<*>
                    x Core..:? "OutputSourceType"
