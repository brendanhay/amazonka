...
mkSubmitTaskStateChange
    :: SubmitTaskStateChange
mkSubmitTaskStateChange
  = SubmitTaskStateChange'{attachments = Core.Nothing,
                           cluster = Core.Nothing, containers = Core.Nothing,
                           executionStoppedAt = Core.Nothing, pullStartedAt = Core.Nothing,
                           pullStoppedAt = Core.Nothing, reason = Core.Nothing,
                           status = Core.Nothing, task = Core.Nothing}
...
{-# INLINEABLE stscExecutionStoppedAt #-}
...
stscTask :: Lens.Lens' SubmitTaskStateChange (Core.Maybe Core.Text)
...
instance Core.ToHeaders SubmitTaskStateChange where
        toHeaders SubmitTaskStateChange{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest SubmitTaskStateChange where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 SubmitTaskStateChangeResponse' Core.<$>
...
mkSubmitTaskStateChangeResponse responseStatus
  = SubmitTaskStateChangeResponse'{acknowledgment = Core.Nothing,
                                   responseStatus}
...
stscrrsAcknowledgment :: Lens.Lens' SubmitTaskStateChangeResponse (Core.Maybe Core.Text)
stscrrsAcknowledgment = Lens.field @"acknowledgment"
{-# INLINEABLE stscrrsAcknowledgment #-}
...
{-# INLINEABLE stscrrsResponseStatus #-}
