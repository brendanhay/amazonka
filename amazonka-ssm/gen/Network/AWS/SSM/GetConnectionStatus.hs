...
getConnectionStatus
    :: Text -- ^ 'gcsTarget'
    -> GetConnectionStatus
getConnectionStatus pTarget_ = GetConnectionStatus' {_gcsTarget = pTarget_}
...
instance Hashable GetConnectionStatus where

instance NFData GetConnectionStatus where
...
data GetConnectionStatusResponse = GetConnectionStatusResponse'
  { _gcsrsStatus         :: !(Maybe ConnectionStatus)
...
instance NFData GetConnectionStatusResponse where
