...
`2.0` - Derived from API version @2020-05-31@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.CloudFront](http://hackage.haskell.org/package/amazonka-cloudfront/docs/Amazonka-CloudFront.html)
