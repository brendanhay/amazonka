...
instance Pager.AWSPager ListAddons where
  page rq rs
    | Pager.stop
        ( rs
...
instance Prelude.AWSRequest ListAddons where
  type Rs ListAddons = ListAddonsResponse
...
instance Prelude.ToHeaders ListAddons where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath ListAddons where
  toPath ListAddons' {..} =
    Prelude.mconcat
      ["/clusters/", Prelude.toBS clusterName, "/addons"]

instance Prelude.ToQuery ListAddons where
  toQuery ListAddons' {..} =
    Prelude.mconcat
...
listAddonsResponse_addons = Lens.lens (\ListAddonsResponse' {addons} -> addons) (\s@ListAddonsResponse' {} a -> s {addons = a} :: ListAddonsResponse) Prelude.. Lens.mapping Prelude._Coerce
