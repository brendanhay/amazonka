...
instance Prelude.FromXML Action where
  parseXML x =
    Action'
      Prelude.<$> (x Prelude..@? "AuthenticateOidcConfig")
      Prelude.<*> (x Prelude..@? "TargetGroupArn")
      Prelude.<*> (x Prelude..@? "AuthenticateCognitoConfig")
      Prelude.<*> (x Prelude..@? "FixedResponseConfig")
      Prelude.<*> (x Prelude..@? "ForwardConfig")
      Prelude.<*> (x Prelude..@? "Order")
      Prelude.<*> (x Prelude..@? "RedirectConfig")
...
instance Prelude.ToQuery Action where
  toQuery Action' {..} =
    Prelude.mconcat
      [ "AuthenticateOidcConfig"
        ...
        "FixedResponseConfig" Prelude.=: fixedResponseConfig,
        "ForwardConfig" Prelude.=: forwardConfig,
        "Order" Prelude.=: order,
        "RedirectConfig" Prelude.=: redirectConfig,
        "Type" Prelude.=: type'
      ]
