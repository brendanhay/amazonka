...
data ExecuteProvisionedProductServiceAction = ExecuteProvisionedProductServiceAction'
  { _eppsaAcceptLanguage       :: !(Maybe Text)
  , _eppsaProvisionedProductId :: !Text
  , _eppsaServiceActionId      :: !Text
  , _eppsaExecuteToken         :: !Text
...
executeProvisionedProductServiceAction
    ...
    -> ExecuteProvisionedProductServiceAction
executeProvisionedProductServiceAction pProvisionedProductId_ pServiceActionId_ pExecuteToken_ =
  ExecuteProvisionedProductServiceAction'
    { _eppsaAcceptLanguage = Nothing
...
data ExecuteProvisionedProductServiceActionResponse = ExecuteProvisionedProductServiceActionResponse'
  { _eppsarsRecordDetail   :: !(Maybe RecordDetail)
  , _eppsarsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
executeProvisionedProductServiceActionResponse pResponseStatus_ =
  ExecuteProvisionedProductServiceActionResponse'
    {_eppsarsRecordDetail = Nothing, _eppsarsResponseStatus = pResponseStatus_}
