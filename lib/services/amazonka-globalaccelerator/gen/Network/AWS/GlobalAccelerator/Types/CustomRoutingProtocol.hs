...
-- |
-- Module      : Network.AWS.GlobalAccelerator.Types.CustomRoutingProtocol
...
pattern CustomRoutingProtocol_TCP = CustomRoutingProtocol' "TCP"

pattern CustomRoutingProtocol_UDP :: CustomRoutingProtocol
pattern CustomRoutingProtocol_UDP = CustomRoutingProtocol' "UDP"
