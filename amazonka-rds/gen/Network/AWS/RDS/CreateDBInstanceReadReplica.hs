...
--
-- Creates a new DB instance that acts as a Read Replica for an existing source DB instance. You can create a Read Replica for a DB instance running MySQL, MariaDB, or PostgreSQL. For more information, see <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.html Working with PostgreSQL, MySQL, and MariaDB Read Replicas> in the /Amazon RDS User Guide/ .
--
--
...
data CreateDBInstanceReadReplica = CreateDBInstanceReadReplica'
  { _cdirrDeletionProtection                 :: !(Maybe Bool)
  ...
  , _cdirrProcessorFeatures                  :: !(Maybe [ProcessorFeature])
  , _cdirrDBInstanceClass                    :: !(Maybe Text)
  , _cdirrPerformanceInsightsRetentionPeriod :: !(Maybe Int)
  ...
  , _cdirrVPCSecurityGroupIds                :: !(Maybe [Text])
  ...
  , _cdirrUseDefaultProcessorFeatures        :: !(Maybe Bool)
...
--
-- * 'cdirrDeletionProtection' - Indicates if the DB instance should have deletion protection enabled. The database can't be deleted when this value is set to true. The default is false. For more information, see <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_DeleteInstance.html Deleting a DB Instance> .
--
-- * 'cdirrPubliclyAccessible' - Specifies the accessibility options for the DB instance. A value of true specifies an Internet-facing instance with a publicly resolvable DNS name, which resolves to a public IP address. A value of false specifies an internal instance with a DNS name that resolves to a private IP address. For more information, see 'CreateDBInstance' .
--
...
--
-- * 'cdirrEnablePerformanceInsights' - True to enable Performance Insights for the read replica, and otherwise false.  For more information, see <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.html Using Amazon Performance Insights> in the /Amazon RDS User Guide/ .
--
...
--
-- * 'cdirrUseDefaultProcessorFeatures' - A value that specifies that the DB instance class of the DB instance uses its default processor features.
--
...
-- | True to enable Performance Insights for the read replica, and otherwise false.  For more information, see <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.html Using Amazon Performance Insights> in the /Amazon RDS User Guide/ .
