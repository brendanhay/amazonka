  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "secretsmanager.UpdateSecret")
...
{-# DEPRECATED usrrsARN "Use generic-lens or generic-optics with 'arn' instead." #-}
...
{-# DEPRECATED usrrsName "Use generic-lens or generic-optics with 'name' instead." #-}
...
{-# DEPRECATED usrrsVersionId "Use generic-lens or generic-optics with 'versionId' instead." #-}
