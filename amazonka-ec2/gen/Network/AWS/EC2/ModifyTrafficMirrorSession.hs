...
modifyTrafficMirrorSession_removeFields = Lens.lens (\ModifyTrafficMirrorSession' {removeFields} -> removeFields) (\s@ModifyTrafficMirrorSession' {} a -> s {removeFields = a} :: ModifyTrafficMirrorSession) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.ToHeaders ModifyTrafficMirrorSession where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath ModifyTrafficMirrorSession where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ModifyTrafficMirrorSession where
  toQuery ModifyTrafficMirrorSession' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("ModifyTrafficMirrorSession" :: Prelude.ByteString),
        "Version"
          Prelude.=: ("2016-11-15" :: Prelude.ByteString),
        Prelude.toQuery
          ( Prelude.toQueryList "RemoveField"
