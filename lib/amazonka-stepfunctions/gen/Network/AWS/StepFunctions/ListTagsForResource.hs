...
--
-- * 'ltfrResourceARN' - The Amazon Resource Name (ARN) for the Step Functions state machine or activity.
listTagsForResource ::
  -- | 'ltfrResourceARN'
  Text ->
  ListTagsForResource
...
instance ToHeaders ListTagsForResource where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("AWSStepFunctions.ListTagsForResource" :: ByteString),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ltfrrsTags' - An array of tags associated with the resource.
--
