...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CodeStar",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "codestar",
...
{-# INLINEABLE _TeamMemberAlreadyAssociatedException #-}
...
{-# INLINEABLE _InvalidServiceRoleException #-}
...
{-# INLINEABLE _ProjectCreationFailedException #-}
...
{-# INLINEABLE _UserProfileAlreadyExistsException #-}
...
{-# INLINEABLE _ProjectNotFoundException #-}
...
{-# INLINEABLE _TeamMemberNotFoundException #-}
...
{-# INLINEABLE _ProjectAlreadyExistsException #-}
...
{-# INLINEABLE _ProjectConfigurationException #-}
...
{-# INLINEABLE _UserProfileNotFoundException #-}
