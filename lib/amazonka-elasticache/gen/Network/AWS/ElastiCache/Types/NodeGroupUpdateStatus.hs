...
mkNodeGroupUpdateStatus
    :: NodeGroupUpdateStatus
mkNodeGroupUpdateStatus
  = NodeGroupUpdateStatus'{nodeGroupId = Core.Nothing,
...
ngusNodeGroupId :: Lens.Lens' NodeGroupUpdateStatus (Core.Maybe Core.Text)
ngusNodeGroupId = Lens.field @"nodeGroupId"
{-# INLINEABLE ngusNodeGroupId #-}
...
{-# INLINEABLE ngusNodeGroupMemberUpdateStatus #-}
{-# DEPRECATED nodeGroupMemberUpdateStatus "Use generic-lens or generic-optics with 'nodeGroupMemberUpdateStatus' instead"  #-}

instance Core.FromXML NodeGroupUpdateStatus where
        parseXML x
          = NodeGroupUpdateStatus' Core.<$>
              (x Core..@? "NodeGroupId") Core.<*>
                x Core..@? "NodeGroupMemberUpdateStatus" Core..<@>
