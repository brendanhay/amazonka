...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "WorkSpaces",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "workspaces",
                 Core._svcVersion = "2015-04-08", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _UnsupportedNetworkConfigurationException #-}
...
{-# INLINEABLE _ResourceCreationFailedException #-}
...
{-# INLINEABLE _ResourceUnavailableException #-}
...
{-# INLINEABLE _InvalidParameterValuesException #-}
...
{-# INLINEABLE _ResourceAssociatedException #-}
...
{-# INLINEABLE _ResourceLimitExceededException #-}
...
{-# INLINEABLE _InvalidResourceStateException #-}
...
{-# INLINEABLE _UnsupportedWorkspaceConfigurationException #-}
...
{-# INLINEABLE _WorkspacesDefaultRoleNotFoundException #-}
