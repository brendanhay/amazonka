...
mkDescribeSpotPriceHistory
    :: DescribeSpotPriceHistory
mkDescribeSpotPriceHistory
  = DescribeSpotPriceHistory'{availabilityZone = Core.Nothing,
                              dryRun = Core.Nothing, endTime = Core.Nothing,
                              filters = Core.Nothing, instanceTypes = Core.Nothing,
                              maxResults = Core.Nothing, nextToken = Core.Nothing,
                              productDescriptions = Core.Nothing, startTime = Core.Nothing}

-- | Filters the results by the specified Availability Zone.
--
-- /Note:/ Consider using 'availabilityZone' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsphAvailabilityZone :: Lens.Lens' DescribeSpotPriceHistory (Core.Maybe Core.Text)
dsphAvailabilityZone = Lens.field @"availabilityZone"
{-# INLINEABLE dsphAvailabilityZone #-}
...
{-# INLINEABLE dsphMaxResults #-}
{-# DEPRECATED maxResults "Use generic-lens or generic-optics with 'maxResults' instead"  #-}

-- | The token for the next set of results.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsphNextToken :: Lens.Lens' DescribeSpotPriceHistory (Core.Maybe Core.Text)
dsphNextToken = Lens.field @"nextToken"
{-# INLINEABLE dsphNextToken #-}
...
dsphProductDescriptions :: Lens.Lens' DescribeSpotPriceHistory (Core.Maybe [Core.Text])
dsphProductDescriptions = Lens.field @"productDescriptions"
{-# INLINEABLE dsphProductDescriptions #-}
{-# DEPRECATED productDescriptions "Use generic-lens or generic-optics with 'productDescriptions' instead"  #-}
...
instance Core.ToQuery DescribeSpotPriceHistory where
        toQuery DescribeSpotPriceHistory{..}
          = Core.toQueryPair "Action"
              ...
              Core.<>
              Core.maybe Core.mempty (Core.toQueryList "InstanceType")
                instanceTypes
              Core.<>
              ...
              Core.<>
              Core.maybe Core.mempty (Core.toQueryList "ProductDescription")
                productDescriptions
              Core.<>
...
instance Core.AWSRequest DescribeSpotPriceHistory where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 DescribeSpotPriceHistoryResponse' Core.<$>
                   (x Core..@? "nextToken") Core.<*>
                     x Core..@? "spotPriceHistorySet" Core..<@> Core.parseXMLList "item"
...
mkDescribeSpotPriceHistoryResponse responseStatus
  = DescribeSpotPriceHistoryResponse'{nextToken = Core.Nothing,
                                      spotPriceHistory = Core.Nothing, responseStatus}

-- | The token required to retrieve the next set of results. This value is null or an empty string when there are no more results to return.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dsphrrsNextToken :: Lens.Lens' DescribeSpotPriceHistoryResponse (Core.Maybe Core.Text)
dsphrrsNextToken = Lens.field @"nextToken"
{-# INLINEABLE dsphrrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE dsphrrsSpotPriceHistory #-}
{-# DEPRECATED spotPriceHistory "Use generic-lens or generic-optics with 'spotPriceHistory' instead"  #-}
...
{-# INLINEABLE dsphrrsResponseStatus #-}
