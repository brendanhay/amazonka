...
--
-- * 'desBlockDeviceMappings'
data DescribeInstanceAttributeResponse = DescribeInstanceAttributeResponse'{_desInstanceId :: Maybe Text, _desGroups :: [GroupIdentifier], _desSourceDestCheck :: Maybe AttributeBooleanValue, _desDisableAPITermination :: Maybe AttributeBooleanValue, _desRAMDiskId :: Maybe AttributeValue, _desKernelId :: Maybe AttributeValue, _desInstanceType :: Maybe AttributeValue, _desRootDeviceName :: Maybe AttributeValue, _desEBSOptimized :: Maybe AttributeBooleanValue, _desUserData :: Maybe AttributeValue, _desSRIOVNetSupport :: Maybe AttributeValue, _desInstanceInitiatedShutdownBehavior :: Maybe AttributeValue, _desProductCodes :: [ProductCode], _desBlockDeviceMappings :: [InstanceBlockDeviceMapping]} deriving (Eq, Read, Show)

-- | 'DescribeInstanceAttributeResponse' smart constructor.
describeInstanceAttributeResponse :: DescribeInstanceAttributeResponse
describeInstanceAttributeResponse = DescribeInstanceAttributeResponse'{_desInstanceId = Nothing, _desGroups = mempty, _desSourceDestCheck = Nothing, _desDisableAPITermination = Nothing, _desRAMDiskId = Nothing, _desKernelId = Nothing, _desInstanceType = Nothing, _desRootDeviceName = Nothing, _desEBSOptimized = Nothing, _desUserData = Nothing, _desSRIOVNetSupport = Nothing, _desInstanceInitiatedShutdownBehavior = Nothing, _desProductCodes = mempty, _desBlockDeviceMappings = mempty};
