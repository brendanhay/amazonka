...
mkAPNSSandboxChannelRequest
    :: APNSSandboxChannelRequest
mkAPNSSandboxChannelRequest
  = APNSSandboxChannelRequest'{bundleId = Core.Nothing,
...
{-# INLINEABLE apnsscrfCertificate #-}
...
{-# INLINEABLE apnsscrfDefaultAuthenticationMethod #-}
