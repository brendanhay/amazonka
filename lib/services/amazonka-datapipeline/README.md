...
`2.0` - Derived from API version @2012-10-29@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.DataPipeline](http://hackage.haskell.org/package/amazonka-datapipeline/docs/Amazonka-DataPipeline.html)
