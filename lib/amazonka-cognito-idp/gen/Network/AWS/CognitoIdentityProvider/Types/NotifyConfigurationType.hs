...
mkNotifyConfigurationType sourceArn
  = NotifyConfigurationType'{sourceArn, blockEmail = Core.Nothing,
                             from = Core.Nothing, mfaEmail = Core.Nothing,
                             noActionEmail = Core.Nothing, replyTo = Core.Nothing}
...
{-# INLINEABLE nctBlockEmail #-}
{-# DEPRECATED blockEmail "Use generic-lens or generic-optics with 'blockEmail' instead"  #-}
...
{-# INLINEABLE nctMfaEmail #-}
{-# DEPRECATED mfaEmail "Use generic-lens or generic-optics with 'mfaEmail' instead"  #-}
...
{-# INLINEABLE nctNoActionEmail #-}
{-# DEPRECATED noActionEmail "Use generic-lens or generic-optics with 'noActionEmail' instead"  #-}
...
{-# INLINEABLE nctReplyTo #-}
{-# DEPRECATED replyTo "Use generic-lens or generic-optics with 'replyTo' instead"  #-}
...
instance Core.FromJSON NotifyConfigurationType where
        parseJSON
          = Core.withObject "NotifyConfigurationType" Core.$
              \ x ->
                NotifyConfigurationType' Core.<$>
                  (x Core..: "SourceArn") Core.<*> x Core..:? "BlockEmail" Core.<*>
                    x Core..:? "From"
