...
--
-- * 'staWorkflowType'
data StartWorkflowExecution = StartWorkflowExecution'{_staTagList :: Maybe [Text], _staTaskStartToCloseTimeout :: Maybe Text, _staInput :: Maybe Text, _staExecutionStartToCloseTimeout :: Maybe Text, _staTaskList :: Maybe TaskList, _staTaskPriority :: Maybe Text, _staChildPolicy :: Maybe ChildPolicy, _staDomain :: Text, _staWorkflowId :: Text, _staWorkflowType :: WorkflowType} deriving (Eq, Read, Show)

-- | 'StartWorkflowExecution' smart constructor.
startWorkflowExecution :: Text -> Text -> WorkflowType -> StartWorkflowExecution
startWorkflowExecution pDomain pWorkflowId pWorkflowType = StartWorkflowExecution'{_staTagList = Nothing, _staTaskStartToCloseTimeout = Nothing, _staInput = Nothing, _staExecutionStartToCloseTimeout = Nothing, _staTaskList = Nothing, _staTaskPriority = Nothing, _staChildPolicy = Nothing, _staDomain = pDomain, _staWorkflowId = pWorkflowId, _staWorkflowType = pWorkflowType};
...
--
-- * 'swerStatusCode'
data StartWorkflowExecutionResponse = StartWorkflowExecutionResponse'{_swerRunId :: Maybe Text, _swerStatusCode :: Int} deriving (Eq, Read, Show)

-- | 'StartWorkflowExecutionResponse' smart constructor.
startWorkflowExecutionResponse :: Int -> StartWorkflowExecutionResponse
startWorkflowExecutionResponse pStatusCode = StartWorkflowExecutionResponse'{_swerRunId = Nothing, _swerStatusCode = pStatusCode};
...
swerStatusCode :: Lens' StartWorkflowExecutionResponse Int
swerStatusCode = lens _swerStatusCode (\ s a -> s{_swerStatusCode = a});
