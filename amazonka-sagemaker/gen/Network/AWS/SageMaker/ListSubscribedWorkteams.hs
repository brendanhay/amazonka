...
instance AWSPager ListSubscribedWorkteams where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lswNextToken .~ rs ^. lswrsNextToken

instance AWSRequest ListSubscribedWorkteams where
        type Rs ListSubscribedWorkteams =
             ListSubscribedWorkteamsResponse
...
instance Hashable ListSubscribedWorkteams where

instance NFData ListSubscribedWorkteams where
...
data ListSubscribedWorkteamsResponse = ListSubscribedWorkteamsResponse'
  { _lswrsNextToken           :: !(Maybe Text)
  , _lswrsResponseStatus      :: !Int
  , _lswrsSubscribedWorkteams :: ![SubscribedWorkteam]
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
instance NFData ListSubscribedWorkteamsResponse where
