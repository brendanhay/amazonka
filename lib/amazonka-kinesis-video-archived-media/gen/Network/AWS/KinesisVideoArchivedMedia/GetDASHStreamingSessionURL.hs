...
mkGetDASHStreamingSessionURL
    :: GetDASHStreamingSessionURL
mkGetDASHStreamingSessionURL
  = GetDASHStreamingSessionURL'{dASHFragmentSelector = Core.Nothing,
...
{-# INLINEABLE gdashssurlDASHFragmentSelector #-}
{-# DEPRECATED dASHFragmentSelector "Use generic-lens or generic-optics with 'dASHFragmentSelector' instead"  #-}
...
{-# INLINEABLE gdashssurlDisplayFragmentNumber #-}
{-# DEPRECATED displayFragmentNumber "Use generic-lens or generic-optics with 'displayFragmentNumber' instead"  #-}
...
{-# INLINEABLE gdashssurlDisplayFragmentTimestamp #-}
...
{-# INLINEABLE gdashssurlMaxManifestFragmentResults #-}
{-# DEPRECATED maxManifestFragmentResults "Use generic-lens or generic-optics with 'maxManifestFragmentResults' instead"  #-}
...
{-# INLINEABLE gdashssurlPlaybackMode #-}
...
{-# INLINEABLE gdashssurlStreamARN #-}
...
{-# INLINEABLE gdashssurlStreamName #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("DASHFragmentSelector" Core..=) Core.<$> dASHFragmentSelector,
                  ...
                  ("MaxManifestFragmentResults" Core..=) Core.<$>
...
instance Core.AWSRequest GetDASHStreamingSessionURL where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/getDASHStreamingSessionURL",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetDASHStreamingSessionURLResponse' Core.<$>
                   (x Core..:? "DASHStreamingSessionURL") Core.<*>
...
mkGetDASHStreamingSessionURLResponse responseStatus
  = GetDASHStreamingSessionURLResponse'{dASHStreamingSessionURL =
                                          Core.Nothing,
                                        responseStatus}
...
{-# INLINEABLE gdashssurlrrsDASHStreamingSessionURL #-}
{-# DEPRECATED dASHStreamingSessionURL "Use generic-lens or generic-optics with 'dASHStreamingSessionURL' instead"  #-}
...
{-# INLINEABLE gdashssurlrrsResponseStatus #-}
