...
mkRealtimeLogConfig arn name samplingRate
  = RealtimeLogConfig'{arn, name, samplingRate,
                       endPoints = Core.mempty, fields = Core.mempty}

-- | The Amazon Resource Name (ARN) of this real-time log configuration.
--
-- /Note:/ Consider using 'arn' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
rlcARN :: Lens.Lens' RealtimeLogConfig Core.Text
...
rlcName :: Lens.Lens' RealtimeLogConfig Core.Text
        ...
        parseXML x
          = RealtimeLogConfig' Core.<$>
              (x Core..@ "ARN") Core.<*> x Core..@ "Name" Core.<*>
                ...
                Core.<*>
                x Core..@ "Fields" Core..@! Core.mempty Core..<@>
                  Core.parseXMLList "Field"
