...
mkMatchmakingRuleSet ruleSetBody
  = MatchmakingRuleSet'{ruleSetBody, creationTime = Core.Nothing,
                        ruleSetArn = Core.Nothing, ruleSetName = Core.Nothing}
...
instance Core.FromJSON MatchmakingRuleSet where
        parseJSON
          = Core.withObject "MatchmakingRuleSet" Core.$
              \ x ->
                MatchmakingRuleSet' Core.<$>
                  (x Core..: "RuleSetBody") Core.<*> x Core..:? "CreationTime"
