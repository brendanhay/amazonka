...
mkStartLambdaFunctionFailedEventAttributes
    :: StartLambdaFunctionFailedEventAttributes
mkStartLambdaFunctionFailedEventAttributes
  = StartLambdaFunctionFailedEventAttributes'{cause = Core.Nothing,
...
{-# INLINEABLE sScheduledEventId #-}
{-# DEPRECATED scheduledEventId "Use generic-lens or generic-optics with 'scheduledEventId' instead"  #-}

instance Core.FromJSON StartLambdaFunctionFailedEventAttributes
         where
        parseJSON
          = Core.withObject "StartLambdaFunctionFailedEventAttributes" Core.$
              \ x ->
                StartLambdaFunctionFailedEventAttributes' Core.<$>
                  (x Core..:? "cause") Core.<*> x Core..:? "message" Core.<*>
