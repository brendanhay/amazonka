...
dcgcrsCustomerGateways :: Lens.Lens' DescribeCustomerGatewaysResponse (Lude.Maybe [CustomerGateway])
dcgcrsCustomerGateways = Lens.lens (customerGateways :: DescribeCustomerGatewaysResponse -> Lude.Maybe [CustomerGateway]) (\s a -> s {customerGateways = a} :: DescribeCustomerGatewaysResponse)
{-# DEPRECATED dcgcrsCustomerGateways "Use generic-lens or generic-optics with 'customerGateways' instead." #-}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dcgcrsResponseStatus :: Lens.Lens' DescribeCustomerGatewaysResponse Lude.Int
dcgcrsResponseStatus = Lens.lens (responseStatus :: DescribeCustomerGatewaysResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: DescribeCustomerGatewaysResponse)
{-# DEPRECATED dcgcrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
