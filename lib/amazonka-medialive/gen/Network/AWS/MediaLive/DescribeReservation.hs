...
instance Core.AWSRequest DescribeReservation where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeReservationResponse' Core.<$>
...
mkDescribeReservationResponse responseStatus
  = DescribeReservationResponse'{arn = Core.Nothing,
...
{-# INLINEABLE drrfrsDurationUnits #-}
...
{-# INLINEABLE drrfrsOfferingDescription #-}
...
{-# INLINEABLE drrfrsReservationId #-}
{-# DEPRECATED reservationId "Use generic-lens or generic-optics with 'reservationId' instead"  #-}
...
{-# INLINEABLE drrfrsResourceSpecification #-}
