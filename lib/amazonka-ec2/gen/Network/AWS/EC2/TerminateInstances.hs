...
mkTerminateInstances
    :: TerminateInstances
mkTerminateInstances
  = TerminateInstances'{instanceIds = Core.mempty,
                        dryRun = Core.Nothing}
...
instance Core.ToQuery TerminateInstances where
        toQuery TerminateInstances{..}
          = Core.toQueryPair "Action" ("TerminateInstances" :: Core.Text)
...
instance Core.AWSRequest TerminateInstances where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 TerminateInstancesResponse' Core.<$>
...
mkTerminateInstancesResponse responseStatus
  = TerminateInstancesResponse'{terminatingInstances = Core.Nothing,
                                responseStatus}
...
{-# INLINEABLE tirrsTerminatingInstances #-}
{-# DEPRECATED terminatingInstances "Use generic-lens or generic-optics with 'terminatingInstances' instead"  #-}
...
{-# INLINEABLE tirrsResponseStatus #-}
