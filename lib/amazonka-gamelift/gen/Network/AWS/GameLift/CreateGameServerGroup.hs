...
mkCreateGameServerGroup
    ...
    -> Types.IamRoleArn -- ^ 'roleArn'
    -> Core.Natural -- ^ 'minSize'
    -> Core.Natural -- ^ 'maxSize'
    -> Types.LaunchTemplateSpecification -- ^ 'launchTemplate'
    -> Core.NonEmpty Types.InstanceDefinition -- ^ 'instanceDefinitions'
    -> CreateGameServerGroup
mkCreateGameServerGroup gameServerGroupName roleArn minSize maxSize
  launchTemplate instanceDefinitions
  = CreateGameServerGroup'{gameServerGroupName, roleArn, minSize,
                           maxSize, launchTemplate, instanceDefinitions,
                           autoScalingPolicy = Core.Nothing, balancingStrategy = Core.Nothing,
                           gameServerProtectionPolicy = Core.Nothing, tags = Core.Nothing,
...
{-# INLINEABLE cgsgGameServerGroupName #-}
...
{-# INLINEABLE cgsgInstanceDefinitions #-}
...
{-# INLINEABLE cgsgAutoScalingPolicy #-}
...
{-# INLINEABLE cgsgBalancingStrategy #-}
...
{-# INLINEABLE cgsgGameServerProtectionPolicy #-}
...
{-# INLINEABLE cgsgVpcSubnets #-}
{-# DEPRECATED vpcSubnets "Use generic-lens or generic-optics with 'vpcSubnets' instead"  #-}

instance Core.ToQuery CreateGameServerGroup where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders CreateGameServerGroup where
        toHeaders CreateGameServerGroup{..}
...
instance Core.AWSRequest CreateGameServerGroup where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateGameServerGroupResponse' Core.<$>
...
mkCreateGameServerGroupResponse responseStatus
  = CreateGameServerGroupResponse'{gameServerGroup = Core.Nothing,
                                   responseStatus}
...
{-# INLINEABLE cgsgrrsGameServerGroup #-}
...
{-# INLINEABLE cgsgrrsResponseStatus #-}
