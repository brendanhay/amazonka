...
mkJobCommand
    :: JobCommand
mkJobCommand
  = JobCommand'{name = Core.Nothing, pythonVersion = Core.Nothing,
...
{-# INLINEABLE jcfPythonVersion #-}
{-# DEPRECATED pythonVersion "Use generic-lens or generic-optics with 'pythonVersion' instead"  #-}
...
{-# INLINEABLE jcfScriptLocation #-}
{-# DEPRECATED scriptLocation "Use generic-lens or generic-optics with 'scriptLocation' instead"  #-}
...
instance Core.FromJSON JobCommand where
        parseJSON
          = Core.withObject "JobCommand" Core.$
              \ x ->
                JobCommand' Core.<$>
                  (x Core..:? "Name") Core.<*> x Core..:? "PythonVersion" Core.<*>
                    x Core..:? "ScriptLocation"
