...
mkListDomains registrationStatus
  = ListDomains'{registrationStatus, maximumPageSize = Core.Nothing,
...
{-# INLINEABLE ldRegistrationStatus #-}
          ...
          = Response.receiveJSON
              (\ s h x ->
                 ListDomainsResponse' Core.<$>
                   (x Core..:? "domainInfos" Core..!= Core.mempty) Core.<*>
...
mkListDomainsResponse responseStatus
  = ListDomainsResponse'{domainInfos = Core.mempty,
...
{-# INLINEABLE ldrrsDomainInfos #-}
{-# DEPRECATED domainInfos "Use generic-lens or generic-optics with 'domainInfos' instead"  #-}
