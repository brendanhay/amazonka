...
mkSchemaListItem
    :: SchemaListItem
mkSchemaListItem
  = SchemaListItem'{createdTime = Core.Nothing,
                    description = Core.Nothing, registryName = Core.Nothing,
