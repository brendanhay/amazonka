...
-- |
-- Module      : Network.AWS.IoTEventsData.BatchEnableAlarm
...
instance Prelude.Hashable BatchEnableAlarm

instance Prelude.NFData BatchEnableAlarm
...
instance Prelude.NFData BatchEnableAlarmResponse
