...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "DirectConnect",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "directconnect",
                 Core._svcVersion = "2012-10-25", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _DirectConnectClientException #-}
...
{-# INLINEABLE _DirectConnectServerException #-}
