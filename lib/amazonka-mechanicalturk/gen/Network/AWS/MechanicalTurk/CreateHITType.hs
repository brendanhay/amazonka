...
mkCreateHITType
    ...
    -> CreateHITType
mkCreateHITType assignmentDurationInSeconds reward title
  description
  = CreateHITType'{assignmentDurationInSeconds, reward, title,
                   description, autoApprovalDelayInSeconds = Core.Nothing,
                   keywords = Core.Nothing, qualificationRequirements = Core.Nothing}
...
{-# INLINEABLE chittAssignmentDurationInSeconds #-}
...
{-# INLINEABLE chittAutoApprovalDelayInSeconds #-}
...
chittKeywords :: Lens.Lens' CreateHITType (Core.Maybe Core.Text)
chittKeywords = Lens.field @"keywords"
{-# INLINEABLE chittKeywords #-}
...
{-# INLINEABLE chittQualificationRequirements #-}
...
instance Core.AWSRequest CreateHITType where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateHITTypeResponse' Core.<$>
                   (x Core..:? "HITTypeId") Core.<*> Core.pure (Core.fromEnum s))
...
{-# INLINEABLE chittrrsResponseStatus #-}
