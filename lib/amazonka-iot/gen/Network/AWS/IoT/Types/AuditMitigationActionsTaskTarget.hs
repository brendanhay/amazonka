...
mkAuditMitigationActionsTaskTarget
    :: AuditMitigationActionsTaskTarget
mkAuditMitigationActionsTaskTarget
  = AuditMitigationActionsTaskTarget'{auditCheckToReasonCodeFilter =
                                        Core.Nothing,
                                      auditTaskId = Core.Nothing, findingIds = Core.Nothing}
...
{-# INLINEABLE amattAuditCheckToReasonCodeFilter #-}
{-# DEPRECATED auditCheckToReasonCodeFilter "Use generic-lens or generic-optics with 'auditCheckToReasonCodeFilter' instead"  #-}
...
instance Core.FromJSON AuditMitigationActionsTaskTarget where
        toJSON AuditMitigationActionsTaskTarget{..}
          = Core.object
              (Core.catMaybes
                 [("auditCheckToReasonCodeFilter" Core..=) Core.<$>
...
instance Core.FromJSON AuditMitigationActionsTaskTarget where
        parseJSON
          = Core.withObject "AuditMitigationActionsTaskTarget" Core.$
              \ x ->
                AuditMitigationActionsTaskTarget' Core.<$>
                  (x Core..:? "auditCheckToReasonCodeFilter") Core.<*>
                    x Core..:? "auditTaskId"
