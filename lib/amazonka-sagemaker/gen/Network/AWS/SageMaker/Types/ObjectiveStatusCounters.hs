...
mkObjectiveStatusCounters
    :: ObjectiveStatusCounters
mkObjectiveStatusCounters
  = ObjectiveStatusCounters'{failed = Core.Nothing,
                             pending = Core.Nothing, succeeded = Core.Nothing}
...
instance Core.FromJSON ObjectiveStatusCounters where
        parseJSON
          = Core.withObject "ObjectiveStatusCounters" Core.$
              \ x ->
                ObjectiveStatusCounters' Core.<$>
                  (x Core..:? "Failed") Core.<*> x Core..:? "Pending" Core.<*>
                    x Core..:? "Succeeded"
