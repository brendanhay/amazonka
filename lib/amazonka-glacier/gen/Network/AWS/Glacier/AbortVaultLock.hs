...
avlAccountId :: Lens.Lens' AbortVaultLock Core.Text
avlAccountId = Lens.field @"accountId"
{-# INLINEABLE avlAccountId #-}
{-# DEPRECATED accountId "Use generic-lens or generic-optics with 'accountId' instead"  #-}

-- | The name of the vault.
--
-- /Note:/ Consider using 'vaultName' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
avlVaultName :: Lens.Lens' AbortVaultLock Core.Text
avlVaultName = Lens.field @"vaultName"
{-# INLINEABLE avlVaultName #-}
...
instance Core.AWSRequest AbortVaultLock where
        ...
        {-# INLINE toRequest #-}
        parseResponse = Response.receiveNull AbortVaultLockResponse'
