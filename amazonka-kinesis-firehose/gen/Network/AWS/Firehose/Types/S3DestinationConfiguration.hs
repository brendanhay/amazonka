...
-- bucket name. For information about how to specify this prefix, see
-- <https://docs.aws.amazon.com/firehose/latest/dev/s3-prefixes.html Custom Prefixes for Amazon S3 Objects>.
s3DestinationConfiguration_errorOutputPrefix :: Lens.Lens' S3DestinationConfiguration (Core.Maybe Core.Text)
...
-- | The encryption configuration. If no value is specified, the default is
-- no encryption.
s3DestinationConfiguration_encryptionConfiguration :: Lens.Lens' S3DestinationConfiguration (Core.Maybe EncryptionConfiguration)
...
-- | The CloudWatch logging options for your delivery stream.
s3DestinationConfiguration_cloudWatchLoggingOptions :: Lens.Lens' S3DestinationConfiguration (Core.Maybe CloudWatchLoggingOptions)
...
-- described in
-- <https://docs.aws.amazon.com/firehose/latest/dev/s3-prefixes.html Custom Prefixes for Amazon S3 Objects>.
s3DestinationConfiguration_prefix :: Lens.Lens' S3DestinationConfiguration (Core.Maybe Core.Text)
...
-- | The buffering option. If no value is specified, @BufferingHints@ object
-- default values are used.
s3DestinationConfiguration_bufferingHints :: Lens.Lens' S3DestinationConfiguration (Core.Maybe BufferingHints)
...
-- Redshift destinations because they are not supported by the Amazon
-- Redshift @COPY@ operation that reads from the S3 bucket.
s3DestinationConfiguration_compressionFormat :: Lens.Lens' S3DestinationConfiguration (Core.Maybe CompressionFormat)
...
-- | The ARN of the S3 bucket. For more information, see
-- <https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html Amazon Resource Names (ARNs) and AWS Service Namespaces>.
s3DestinationConfiguration_bucketARN :: Lens.Lens' S3DestinationConfiguration Core.Text
