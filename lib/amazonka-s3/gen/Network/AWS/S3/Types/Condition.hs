...
mkCondition
    :: Condition
mkCondition
  = Condition'{httpErrorCodeReturnedEquals = Core.Nothing,
...
{-# INLINEABLE cHttpErrorCodeReturnedEquals #-}
{-# DEPRECATED httpErrorCodeReturnedEquals "Use generic-lens or generic-optics with 'httpErrorCodeReturnedEquals' instead"  #-}
...
{-# INLINEABLE cKeyPrefixEquals #-}
{-# DEPRECATED keyPrefixEquals "Use generic-lens or generic-optics with 'keyPrefixEquals' instead"  #-}

instance Core.ToXML Condition where
        toXML Condition{..}
          = Core.maybe Core.mempty
              (Core.toXMLElement "HttpErrorCodeReturnedEquals")
              httpErrorCodeReturnedEquals
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "KeyPrefixEquals")
                keyPrefixEquals

instance Core.FromXML Condition where
        parseXML x
          = Condition' Core.<$>
              (x Core..@? "HttpErrorCodeReturnedEquals") Core.<*>
                x Core..@? "KeyPrefixEquals"
