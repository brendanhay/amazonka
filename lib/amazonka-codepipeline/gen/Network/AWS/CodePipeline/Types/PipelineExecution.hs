...
mkPipelineExecution
    :: PipelineExecution
mkPipelineExecution
  = PipelineExecution'{artifactRevisions = Core.Nothing,
                       pipelineExecutionId = Core.Nothing, pipelineName = Core.Nothing,
                       pipelineVersion = Core.Nothing, status = Core.Nothing}
...
{-# INLINEABLE peArtifactRevisions #-}
{-# DEPRECATED artifactRevisions "Use generic-lens or generic-optics with 'artifactRevisions' instead"  #-}
...
{-# INLINEABLE pePipelineExecutionId #-}
