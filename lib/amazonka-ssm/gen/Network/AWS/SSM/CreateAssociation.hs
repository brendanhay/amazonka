...
mkCreateAssociation name
  = CreateAssociation'{name, applyOnlyAtCronInterval = Core.Nothing,
                       ...
                       instanceId = Core.Nothing, maxConcurrency = Core.Nothing,
                       maxErrors = Core.Nothing, outputLocation = Core.Nothing,
...
{-# INLINEABLE caApplyOnlyAtCronInterval #-}
...
{-# INLINEABLE caAutomationTargetParameterName #-}
...
{-# INLINEABLE caComplianceSeverity #-}
...
{-# INLINEABLE caScheduleExpression #-}
...
instance Core.ToHeaders CreateAssociation where
        toHeaders CreateAssociation{..}
          = Core.pure ("X-Amz-Target", "AmazonSSM.CreateAssociation") Core.<>
...
instance Core.AWSRequest CreateAssociation where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateAssociationResponse' Core.<$>
...
mkCreateAssociationResponse responseStatus
  = CreateAssociationResponse'{associationDescription = Core.Nothing,
                               responseStatus}
...
{-# INLINEABLE carrsAssociationDescription #-}
