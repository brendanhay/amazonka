  ...
  toQuery ModifyCacheCluster' {..} =
    mconcat
      [ "Action" =: ("ModifyCacheCluster" :: ByteString),
        ...
        "SecurityGroupIds"
          =: toQuery (toQueryList "SecurityGroupId" <$> _mccSecurityGroupIds),
        ...
        "CacheNodeIdsToRemove"
          =: toQuery (toQueryList "CacheNodeId" <$> _mccCacheNodeIdsToRemove),
        ...
        "AuthTokenUpdateStrategy" =: _mccAuthTokenUpdateStrategy,
