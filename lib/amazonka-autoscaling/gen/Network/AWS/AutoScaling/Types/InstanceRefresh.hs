...
mkInstanceRefresh
    :: InstanceRefresh
mkInstanceRefresh
  = InstanceRefresh'{autoScalingGroupName = Core.Nothing,
                     endTime = Core.Nothing, instanceRefreshId = Core.Nothing,
                     instancesToUpdate = Core.Nothing,
                     percentageComplete = Core.Nothing, startTime = Core.Nothing,
...
{-# INLINEABLE irAutoScalingGroupName #-}
...
{-# INLINEABLE irInstanceRefreshId #-}
...
{-# INLINEABLE irInstancesToUpdate #-}
{-# DEPRECATED instancesToUpdate "Use generic-lens or generic-optics with 'instancesToUpdate' instead"  #-}
...
{-# INLINEABLE irPercentageComplete #-}
{-# DEPRECATED percentageComplete "Use generic-lens or generic-optics with 'percentageComplete' instead"  #-}
...
instance Core.FromXML InstanceRefresh where
        parseXML x
          = InstanceRefresh' Core.<$>
              (x Core..@? "AutoScalingGroupName") Core.<*> x Core..@? "EndTime"
