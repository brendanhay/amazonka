...
_CredentialReportNotPresentException =
  Core._MatchServiceError mkServiceConfig "ReportNotPresent"
...
_CredentialReportNotReadyException =
  Core._MatchServiceError mkServiceConfig "ReportInProgress"
...
_CredentialReportExpiredException =
  Core._MatchServiceError mkServiceConfig "ReportExpired"
    Core.. Core.hasStatues 410
...
_DeleteConflictException =
  Core._MatchServiceError mkServiceConfig "DeleteConflict"
    Core.. Core.hasStatues 409
...
_NoSuchEntityException =
  Core._MatchServiceError mkServiceConfig "NoSuchEntity"
    Core.. Core.hasStatues 404
...
_InvalidUserTypeException =
  Core._MatchServiceError mkServiceConfig "InvalidUserType"
    Core.. Core.hasStatues 400
...
_ServiceFailureException =
  Core._MatchServiceError mkServiceConfig "ServiceFailure"
...
_InvalidPublicKeyException =
  Core._MatchServiceError mkServiceConfig "InvalidPublicKey"
    Core.. Core.hasStatues 400
...
_KeyPairMismatchException =
  Core._MatchServiceError mkServiceConfig "KeyPairMismatch"
    Core.. Core.hasStatues 400
...
_PolicyEvaluationException =
  Core._MatchServiceError mkServiceConfig "PolicyEvaluation"
    Core.. Core.hasStatues 500
