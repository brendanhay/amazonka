...
mkAddressConfiguration
    :: AddressConfiguration
mkAddressConfiguration
  = AddressConfiguration'{bodyOverride = Core.Nothing,
                          channelType = Core.Nothing, context = Core.Nothing,
                          rawContent = Core.Nothing, substitutions = Core.Nothing,
...
{-# INLINEABLE acBodyOverride #-}
{-# DEPRECATED bodyOverride "Use generic-lens or generic-optics with 'bodyOverride' instead"  #-}
...
{-# INLINEABLE acTitleOverride #-}
{-# DEPRECATED titleOverride "Use generic-lens or generic-optics with 'titleOverride' instead"  #-}
