...
mkReservedCacheNodesOffering
    :: ReservedCacheNodesOffering
mkReservedCacheNodesOffering
  = ReservedCacheNodesOffering'{cacheNodeType = Core.Nothing,
...
rcnoCacheNodeType :: Lens.Lens' ReservedCacheNodesOffering (Core.Maybe Core.Text)
rcnoCacheNodeType = Lens.field @"cacheNodeType"
{-# INLINEABLE rcnoCacheNodeType #-}
...
rcnoProductDescription :: Lens.Lens' ReservedCacheNodesOffering (Core.Maybe Core.Text)
rcnoProductDescription = Lens.field @"productDescription"
{-# INLINEABLE rcnoProductDescription #-}
...
{-# INLINEABLE rcnoRecurringCharges #-}
...
rcnoReservedCacheNodesOfferingId :: Lens.Lens' ReservedCacheNodesOffering (Core.Maybe Core.Text)
rcnoReservedCacheNodesOfferingId = Lens.field @"reservedCacheNodesOfferingId"
{-# INLINEABLE rcnoReservedCacheNodesOfferingId #-}
...
instance Core.FromXML ReservedCacheNodesOffering where
        parseXML x
          = ReservedCacheNodesOffering' Core.<$>
              (x Core..@? "CacheNodeType") Core.<*> x Core..@? "Duration"
