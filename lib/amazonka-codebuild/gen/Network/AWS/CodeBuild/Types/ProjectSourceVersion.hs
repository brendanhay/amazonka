...
import qualified Network.AWS.CodeBuild.Types.SourceIdentifier as Types
...
data ProjectSourceVersion = ProjectSourceVersion'
  { -- | An identifier for a source in the build project.
    ...
    sourceVersion :: Types.SourceVersion
  }
...
psvSourceIdentifier :: Lens.Lens' ProjectSourceVersion Types.SourceIdentifier
...
psvSourceVersion :: Lens.Lens' ProjectSourceVersion Types.SourceVersion
...
instance Core.FromJSON ProjectSourceVersion where
  parseJSON =
    Core.withObject "ProjectSourceVersion" Core.$
      \x ->
        ProjectSourceVersion'
          Core.<$> (x Core..: "sourceIdentifier") Core.<*> (x Core..: "sourceVersion")
