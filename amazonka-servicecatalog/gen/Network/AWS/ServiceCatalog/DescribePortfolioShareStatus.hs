...
describePortfolioShareStatus
    :: Text -- ^ 'dpssPortfolioShareToken'
    -> DescribePortfolioShareStatus
describePortfolioShareStatus pPortfolioShareToken_ =
  DescribePortfolioShareStatus'
    {_dpssPortfolioShareToken = pPortfolioShareToken_}
...
instance AWSRequest DescribePortfolioShareStatus
         where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribePortfolioShareStatusResponse' <$>
                   (x .?> "Status") <*> (x .?> "PortfolioShareToken")
                     <*> (x .?> "ShareDetails")
                     <*> (x .?> "PortfolioId")
                     <*> (x .?> "OrganizationNodeValue")
                     <*> (pure (fromEnum s)))

instance Hashable DescribePortfolioShareStatus where

instance NFData DescribePortfolioShareStatus where
...
data DescribePortfolioShareStatusResponse = DescribePortfolioShareStatusResponse'
  { _dpssrsStatus                :: !(Maybe ShareStatus)
  , _dpssrsPortfolioShareToken   :: !(Maybe Text)
  , _dpssrsShareDetails          :: !(Maybe ShareDetails)
  , _dpssrsPortfolioId           :: !(Maybe Text)
  , _dpssrsOrganizationNodeValue :: !(Maybe Text)
  , _dpssrsResponseStatus        :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
