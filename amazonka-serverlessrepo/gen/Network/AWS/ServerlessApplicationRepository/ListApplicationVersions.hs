...
instance Prelude.AWSRequest ListApplicationVersions where
  type
...
instance Prelude.ToHeaders ListApplicationVersions where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath ListApplicationVersions where
...
instance Prelude.ToQuery ListApplicationVersions where
...
listApplicationVersionsResponse_versions = Lens.lens (\ListApplicationVersionsResponse' {versions} -> versions) (\s@ListApplicationVersionsResponse' {} a -> s {versions = a} :: ListApplicationVersionsResponse) Prelude.. Lens.mapping Prelude._Coerce
