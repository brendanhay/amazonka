...
data AccountSettings = AccountSettings'
  { -- | The AWS account number specified in the @AccountSettings@ container.
    ...
    trialMinutes :: Core.Maybe TrialMinutes,
    ...
    unmeteredDevices :: Core.Maybe (Core.HashMap DevicePlatform Core.Int),
    -- | Returns the unmetered remote access devices you have purchased or want
    -- to purchase.
    unmeteredRemoteAccessDevices :: Core.Maybe (Core.HashMap DevicePlatform Core.Int)
  }
...
newAccountSettings =
  AccountSettings'
    { awsAccountNumber = Core.Nothing,
      maxSlots = Core.Nothing,
      trialMinutes = Core.Nothing,
      skipAppResign = Core.Nothing,
      maxJobTimeoutMinutes = Core.Nothing,
...
-- | The AWS account number specified in the @AccountSettings@ container.
accountSettings_awsAccountNumber :: Lens.Lens' AccountSettings (Core.Maybe Core.Text)
...
-- @offering-id@ represents one of the IDs returned by the @ListOfferings@
-- command.
accountSettings_maxSlots :: Lens.Lens' AccountSettings (Core.Maybe (Core.HashMap Core.Text Core.Int))
accountSettings_maxSlots = Lens.lens (\AccountSettings' {maxSlots} -> maxSlots) (\s@AccountSettings' {} a -> s {maxSlots = a} :: AccountSettings) Core.. Lens.mapping Lens._Coerce

-- | Information about an AWS account\'s usage of free trial device minutes.
accountSettings_trialMinutes :: Lens.Lens' AccountSettings (Core.Maybe TrialMinutes)
...
-- <https://aws.amazon.com/device-farm/faq/ Do you modify my app?> in the
-- /AWS Device Farm FAQs/.
accountSettings_skipAppResign :: Lens.Lens' AccountSettings (Core.Maybe Core.Bool)
...
-- | The maximum number of minutes a test run executes before it times out.
accountSettings_maxJobTimeoutMinutes :: Lens.Lens' AccountSettings (Core.Maybe Core.Int)
...
-- | The default number of minutes (at the account level) a test run executes
-- before it times out. The default value is 150 minutes.
accountSettings_defaultJobTimeoutMinutes :: Lens.Lens' AccountSettings (Core.Maybe Core.Int)
...
-- | Returns the unmetered devices you have purchased or want to purchase.
accountSettings_unmeteredDevices :: Lens.Lens' AccountSettings (Core.Maybe (Core.HashMap DevicePlatform Core.Int))
accountSettings_unmeteredDevices = Lens.lens (\AccountSettings' {unmeteredDevices} -> unmeteredDevices) (\s@AccountSettings' {} a -> s {unmeteredDevices = a} :: AccountSettings) Core.. Lens.mapping Lens._Coerce

-- | Returns the unmetered remote access devices you have purchased or want
-- to purchase.
accountSettings_unmeteredRemoteAccessDevices :: Lens.Lens' AccountSettings (Core.Maybe (Core.HashMap DevicePlatform Core.Int))
accountSettings_unmeteredRemoteAccessDevices = Lens.lens (\AccountSettings' {unmeteredRemoteAccessDevices} -> unmeteredRemoteAccessDevices) (\s@AccountSettings' {} a -> s {unmeteredRemoteAccessDevices = a} :: AccountSettings) Core.. Lens.mapping Lens._Coerce
