...
mkListTaskDefinitionFamilies
    :: ListTaskDefinitionFamilies
mkListTaskDefinitionFamilies
  = ListTaskDefinitionFamilies'{familyPrefix = Core.Nothing,
...
ltdfFamilyPrefix :: Lens.Lens' ListTaskDefinitionFamilies (Core.Maybe Core.Text)
ltdfFamilyPrefix = Lens.field @"familyPrefix"
{-# INLINEABLE ltdfFamilyPrefix #-}
...
{-# INLINEABLE ltdfMaxResults #-}
{-# DEPRECATED maxResults "Use generic-lens or generic-optics with 'maxResults' instead"  #-}

-- | The @nextToken@ value returned from a @ListTaskDefinitionFamilies@ request indicating that more results are available to fulfill the request and further calls will be needed. If @maxResults@ was provided, it is possible the number of results to be fewer than @maxResults@ .
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
ltdfNextToken :: Lens.Lens' ListTaskDefinitionFamilies (Core.Maybe Core.Text)
ltdfNextToken = Lens.field @"nextToken"
{-# INLINEABLE ltdfNextToken #-}
...
instance Core.AWSRequest ListTaskDefinitionFamilies where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListTaskDefinitionFamiliesResponse' Core.<$>
                   (x Core..:? "families") Core.<*> x Core..:? "nextToken" Core.<*>
...
mkListTaskDefinitionFamiliesResponse responseStatus
  = ListTaskDefinitionFamiliesResponse'{families = Core.Nothing,
...
ltdfrrsFamilies :: Lens.Lens' ListTaskDefinitionFamiliesResponse (Core.Maybe [Core.Text])
ltdfrrsFamilies = Lens.field @"families"
{-# INLINEABLE ltdfrrsFamilies #-}
{-# DEPRECATED families "Use generic-lens or generic-optics with 'families' instead"  #-}

-- | The @nextToken@ value to include in a future @ListTaskDefinitionFamilies@ request. When the results of a @ListTaskDefinitionFamilies@ request exceed @maxResults@ , this value can be used to retrieve the next page of results. This value is @null@ when there are no more results to return.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
ltdfrrsNextToken :: Lens.Lens' ListTaskDefinitionFamiliesResponse (Core.Maybe Core.Text)
ltdfrrsNextToken = Lens.field @"nextToken"
{-# INLINEABLE ltdfrrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE ltdfrrsResponseStatus #-}
