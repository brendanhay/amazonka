...
`2.0` - Derived from API version @2015-01-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.ElasticSearch](http://hackage.haskell.org/package/amazonka-elasticsearch/docs/Network-AWS-ElasticSearch.html)
