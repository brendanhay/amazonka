...
mkWebhookDefinition
    ...
    -> Types.PipelineName -- ^ 'targetPipeline'
    -> Types.TargetAction -- ^ 'targetAction'
    -> Types.WebhookAuthenticationType -- ^ 'authentication'
    -> Types.WebhookAuthConfiguration -- ^ 'authenticationConfiguration'
    -> WebhookDefinition
mkWebhookDefinition name targetPipeline targetAction authentication
  authenticationConfiguration
  = WebhookDefinition'{name, targetPipeline, targetAction,
                       filters = Core.mempty, authentication, authenticationConfiguration}
...
{-# INLINEABLE wdTargetPipeline #-}
{-# DEPRECATED targetPipeline "Use generic-lens or generic-optics with 'targetPipeline' instead"  #-}
...
{-# INLINEABLE wdAuthenticationConfiguration #-}
{-# DEPRECATED authenticationConfiguration "Use generic-lens or generic-optics with 'authenticationConfiguration' instead"  #-}
...
instance Core.FromJSON WebhookDefinition where
        parseJSON
          = Core.withObject "WebhookDefinition" Core.$
              \ x ->
                WebhookDefinition' Core.<$>
                  (x Core..: "name") Core.<*> x Core..: "targetPipeline" Core.<*>
                    x Core..: "targetAction"
