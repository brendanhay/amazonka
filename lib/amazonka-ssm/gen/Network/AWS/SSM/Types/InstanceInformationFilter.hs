...
mkInstanceInformationFilter
    :: Types.InstanceInformationFilterKey -- ^ 'key'
    -> Core.NonEmpty Types.InstanceInformationFilterValue -- ^ 'valueSet'
    -> InstanceInformationFilter
...
{-# INLINEABLE iifValueSet #-}
{-# DEPRECATED valueSet "Use generic-lens or generic-optics with 'valueSet' instead"  #-}
