...
instance ServiceError (Er ElasticBeanstalk) where
...
instance ToByteString ConfigurationDeploymentStatus where
    toBS ConfigurationDeploymentStatusDeployed = "deployed"
    toBS ConfigurationDeploymentStatusFailed = "failed"
    toBS ConfigurationDeploymentStatusPending = "pending"
...
instance ToByteString ConfigurationOptionValueType where
    toBS ConfigurationOptionValueTypeList = "List"
    toBS ConfigurationOptionValueTypeScalar = "Scalar"
...
instance ToByteString EnvironmentHealth where
    toBS EnvironmentHealthGreen = "Green"
    toBS EnvironmentHealthGrey = "Grey"
    toBS EnvironmentHealthRed = "Red"
    toBS EnvironmentHealthYellow = "Yellow"
...
instance ToByteString EnvironmentInfoType where
    toBS EnvironmentInfoTypeTail = "tail"
...
instance ToByteString EnvironmentStatus where
    toBS EnvironmentStatusLaunching = "Launching"
    toBS EnvironmentStatusReady = "Ready"
    toBS EnvironmentStatusTerminated = "Terminated"
    toBS EnvironmentStatusTerminating = "Terminating"
    toBS EnvironmentStatusUpdating = "Updating"
...
instance ToByteString EventSeverity where
    toBS EventSeverityDebug = "DEBUG"
    toBS EventSeverityError = "ERROR"
    toBS EventSeverityFatal = "FATAL"
    toBS EventSeverityInfo = "INFO"
    toBS EventSeverityTrace = "TRACE"
    toBS EventSeverityWarn = "WARN"
...
instance ToByteString ValidationSeverity where
    toBS ValidationSeverityError = "error"
    toBS ValidationSeverityWarning = "warning"
