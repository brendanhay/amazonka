...
instance Hashable ListEventSources

instance NFData ListEventSources

instance ToHeaders ListEventSources where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target" =# ("AWSEvents.ListEventSources" :: ByteString),
...
instance NFData ListEventSourcesResponse
