...
instance AWSRequest DeleteTransitGatewayRouteTable where
  ...
  response =
    receiveXML
      ( \s h x ->
          DeleteTransitGatewayRouteTableResponse'
            <$> (x .@? "transitGatewayRouteTable") <*> (pure (fromEnum s))
      )
...
instance ToQuery DeleteTransitGatewayRouteTable where
  toQuery DeleteTransitGatewayRouteTable' {..} =
    mconcat
      [ "Action" =: ("DeleteTransitGatewayRouteTable" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        "DryRun" =: _dtgrtDryRun,
        "TransitGatewayRouteTableId" =: _dtgrtTransitGatewayRouteTableId
      ]
...
data DeleteTransitGatewayRouteTableResponse = DeleteTransitGatewayRouteTableResponse'
  { _dtgrtrsTransitGatewayRouteTable ::
      !( Maybe
...
instance NFData DeleteTransitGatewayRouteTableResponse
