...
-- |
-- Module      : Network.AWS.Kendra.ListThesauri
...
--
-- 'indexId', 'listThesauri_indexId' - The identifier of the index associated with the thesaurus to list.
newListThesauri ::
  -- | 'indexId'
  Prelude.Text ->
  ListThesauri
...
instance Prelude.Hashable ListThesauri

instance Prelude.NFData ListThesauri
...
instance Prelude.NFData ListThesauriResponse
