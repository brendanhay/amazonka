    ...
    Core.withObject "HistoryEvent" Core.$
      \x ->
        HistoryEvent'
          ...
          Core.<*> (x Core..:? "childWorkflowExecutionCompletedEventAttributes")
          Core.<*> (x Core..:? "childWorkflowExecutionFailedEventAttributes")
          Core.<*> (x Core..:? "childWorkflowExecutionStartedEventAttributes")
          Core.<*> (x Core..:? "childWorkflowExecutionTerminatedEventAttributes")
          Core.<*> (x Core..:? "childWorkflowExecutionTimedOutEventAttributes")
          Core.<*> (x Core..:? "completeWorkflowExecutionFailedEventAttributes")
          Core.<*> (x Core..:? "continueAsNewWorkflowExecutionFailedEventAttributes")
          ...
          Core.<*> (x Core..:? "externalWorkflowExecutionSignaledEventAttributes")
          ...
          Core.<*> (x Core..:? "requestCancelActivityTaskFailedEventAttributes")
          Core.<*> ( x
          ...
          Core.<*> (x Core..:? "signalExternalWorkflowExecutionFailedEventAttributes")
          Core.<*> ( x
                       Core..:? "signalExternalWorkflowExecutionInitiatedEventAttributes"
                   )
          Core.<*> (x Core..:? "startChildWorkflowExecutionFailedEventAttributes")
          Core.<*> (x Core..:? "startChildWorkflowExecutionInitiatedEventAttributes")
          ...
          Core.<*> (x Core..:? "workflowExecutionCancelRequestedEventAttributes")
          Core.<*> (x Core..:? "workflowExecutionCanceledEventAttributes")
          Core.<*> (x Core..:? "workflowExecutionCompletedEventAttributes")
          Core.<*> (x Core..:? "workflowExecutionContinuedAsNewEventAttributes")
