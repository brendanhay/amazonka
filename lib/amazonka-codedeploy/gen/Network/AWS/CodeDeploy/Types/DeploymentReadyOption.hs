...
mkDeploymentReadyOption
    :: DeploymentReadyOption
mkDeploymentReadyOption
  = DeploymentReadyOption'{actionOnTimeout = Core.Nothing,
...
{-# INLINEABLE droActionOnTimeout #-}
{-# DEPRECATED actionOnTimeout "Use generic-lens or generic-optics with 'actionOnTimeout' instead"  #-}
...
{-# INLINEABLE droWaitTimeInMinutes #-}
{-# DEPRECATED waitTimeInMinutes "Use generic-lens or generic-optics with 'waitTimeInMinutes' instead"  #-}
          ...
          = Core.withObject "DeploymentReadyOption" Core.$
              \ x ->
                DeploymentReadyOption' Core.<$>
                  (x Core..:? "actionOnTimeout") Core.<*>
                    x Core..:? "waitTimeInMinutes"
