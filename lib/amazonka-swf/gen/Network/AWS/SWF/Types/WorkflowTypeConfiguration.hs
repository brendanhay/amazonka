...
mkWorkflowTypeConfiguration
    :: WorkflowTypeConfiguration
mkWorkflowTypeConfiguration
  = WorkflowTypeConfiguration'{defaultChildPolicy = Core.Nothing,
...
{-# INLINEABLE wtcDefaultChildPolicy #-}
...
{-# INLINEABLE wtcDefaultExecutionStartToCloseTimeout #-}
...
{-# INLINEABLE wtcDefaultLambdaRole #-}
...
{-# INLINEABLE wtcDefaultTaskPriority #-}
...
{-# INLINEABLE wtcDefaultTaskStartToCloseTimeout #-}
...
instance Core.FromJSON WorkflowTypeConfiguration where
        parseJSON
          = Core.withObject "WorkflowTypeConfiguration" Core.$
              \ x ->
                WorkflowTypeConfiguration' Core.<$>
                  (x Core..:? "defaultChildPolicy") Core.<*>
                    x Core..:? "defaultExecutionStartToCloseTimeout"
