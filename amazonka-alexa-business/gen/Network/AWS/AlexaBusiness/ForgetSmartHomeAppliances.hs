...
instance Hashable ForgetSmartHomeAppliances where

instance NFData ForgetSmartHomeAppliances where
...
forgetSmartHomeAppliancesResponse
    :: Int -- ^ 'fsharsResponseStatus'
    -> ForgetSmartHomeAppliancesResponse
forgetSmartHomeAppliancesResponse pResponseStatus_ =
  ForgetSmartHomeAppliancesResponse' {_fsharsResponseStatus = pResponseStatus_}
