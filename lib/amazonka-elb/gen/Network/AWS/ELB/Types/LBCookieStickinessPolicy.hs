...
mkLBCookieStickinessPolicy
    :: LBCookieStickinessPolicy
mkLBCookieStickinessPolicy
  = LBCookieStickinessPolicy'{cookieExpirationPeriod = Core.Nothing,
...
{-# INLINEABLE lbcspCookieExpirationPeriod #-}
...
instance Core.FromXML LBCookieStickinessPolicy where
        parseXML x
          = LBCookieStickinessPolicy' Core.<$>
              (x Core..@? "CookieExpirationPeriod") Core.<*>
                x Core..@? "PolicyName"
