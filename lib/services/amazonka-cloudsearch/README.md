...
`2.0` - Derived from API version @2013-01-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.CloudSearch](http://hackage.haskell.org/package/amazonka-cloudsearch/docs/Amazonka-CloudSearch.html)
