...
import Network.AWS.CloudFront.Types.ARN
...
import Network.AWS.CloudFront.Types.AwsAccountNumber
import Network.AWS.CloudFront.Types.CNAME
...
import Network.AWS.CloudFront.Types.CallerReference
...
import Network.AWS.CloudFront.Types.ContentType
...
import Network.AWS.CloudFront.Types.DistributionId
...
import Network.AWS.CloudFront.Types.DomainName
import Network.AWS.CloudFront.Types.ETag
...
import Network.AWS.CloudFront.Types.Id
import Network.AWS.CloudFront.Types.IfMatch
...
import Network.AWS.CloudFront.Types.Location
import Network.AWS.CloudFront.Types.LoggingConfig
import Network.AWS.CloudFront.Types.Marker
...
import Network.AWS.CloudFront.Types.Name
import Network.AWS.CloudFront.Types.NextMarker
...
import Network.AWS.CloudFront.Types.OriginPath
...
import Network.AWS.CloudFront.Types.ProfileId
import Network.AWS.CloudFront.Types.ProviderId
import Network.AWS.CloudFront.Types.PublicKey
import Network.AWS.CloudFront.Types.PublicKeyConfig
import Network.AWS.CloudFront.Types.PublicKeyId
...
import Network.AWS.CloudFront.Types.S3CanonicalUserId
...
import Network.AWS.CloudFront.Types.Status
...
import Network.AWS.CloudFront.Types.String
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "CloudFront",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "cloudfront",
      Core._svcVersion = "2020-05-31",
...
_InvalidTagging =
  Core._MatchServiceError mkServiceConfig "InvalidTagging"
    Core.. Core.hasStatues 400
...
_InvalidErrorCode =
  Core._MatchServiceError mkServiceConfig "InvalidErrorCode"
    Core.. Core.hasStatues 400
...
_InvalidWebACLId =
  Core._MatchServiceError mkServiceConfig "InvalidWebACLId"
    Core.. Core.hasStatues 400
...
_BatchTooLarge =
  Core._MatchServiceError mkServiceConfig "BatchTooLarge"
...
_InvalidOrigin =
  Core._MatchServiceError mkServiceConfig "InvalidOrigin"
    Core.. Core.hasStatues 400
...
_CachePolicyInUse =
  Core._MatchServiceError mkServiceConfig "CachePolicyInUse"
    Core.. Core.hasStatues 409
...
_NoSuchOrigin =
  Core._MatchServiceError mkServiceConfig "NoSuchOrigin"
    Core.. Core.hasStatues 404
...
_InvalidTTLOrder =
  Core._MatchServiceError mkServiceConfig "InvalidTTLOrder"
    Core.. Core.hasStatues 400
...
_NoSuchResource =
  Core._MatchServiceError mkServiceConfig "NoSuchResource"
    Core.. Core.hasStatues 404
...
_TooManyKeyGroups =
  Core._MatchServiceError mkServiceConfig "TooManyKeyGroups"
    Core.. Core.hasStatues 400
...
_MissingBody =
  Core._MatchServiceError mkServiceConfig "MissingBody"
    Core.. Core.hasStatues 400
...
_IllegalDelete =
  Core._MatchServiceError mkServiceConfig "IllegalDelete"
    Core.. Core.hasStatues 400
...
_IllegalUpdate =
  Core._MatchServiceError mkServiceConfig "IllegalUpdate"
    Core.. Core.hasStatues 400
...
_NoSuchPublicKey =
  Core._MatchServiceError mkServiceConfig "NoSuchPublicKey"
    Core.. Core.hasStatues 404
...
_PublicKeyInUse =
  Core._MatchServiceError mkServiceConfig "PublicKeyInUse"
    Core.. Core.hasStatues 409
...
_TooManyOrigins =
  Core._MatchServiceError mkServiceConfig "TooManyOrigins"
    Core.. Core.hasStatues 400
...
_AccessDenied =
  Core._MatchServiceError mkServiceConfig "AccessDenied"
