...
`1.6.1` - Derived from API version @2015-07-09@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Network.AWS.CodePipeline](http://hackage.haskell.org/package/amazonka-codepipeline/docs/Network-AWS-CodePipeline.html)
