...
{-# INLINEABLE secDelayUntilElbConnectionsDrained #-}
{-# DEPRECATED delayUntilElbConnectionsDrained "Use generic-lens or generic-optics with 'delayUntilElbConnectionsDrained' instead"  #-}
...
{-# INLINEABLE secExecutionTimeout #-}
{-# DEPRECATED executionTimeout "Use generic-lens or generic-optics with 'executionTimeout' instead"  #-}

instance Core.FromJSON ShutdownEventConfiguration where
        toJSON ShutdownEventConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("DelayUntilElbConnectionsDrained" Core..=) Core.<$>
...
instance Core.FromJSON ShutdownEventConfiguration where
        parseJSON
          = Core.withObject "ShutdownEventConfiguration" Core.$
              \ x ->
                ShutdownEventConfiguration' Core.<$>
                  (x Core..:? "DelayUntilElbConnectionsDrained") Core.<*>
                    x Core..:? "ExecutionTimeout"
