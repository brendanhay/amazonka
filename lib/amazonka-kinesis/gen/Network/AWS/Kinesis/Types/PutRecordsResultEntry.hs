...
mkPutRecordsResultEntry
    :: PutRecordsResultEntry
mkPutRecordsResultEntry
  = PutRecordsResultEntry'{errorCode = Core.Nothing,
                           errorMessage = Core.Nothing, sequenceNumber = Core.Nothing,
