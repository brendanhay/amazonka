...
instance FromText Runtime where
    parser = takeLowerText >>= \case
        ...
        e -> fromTextError $ "Failure parsing Runtime from value: '" <> e
           <> "'. Accepted values: dotnetcore1.0, dotnetcore2.0, dotnetcore2.1, go1.x, java8, nodejs4.3, nodejs4.3-edge, nodejs6.10, nodejs8.10, nodejs, python2.7, python3.6, python3.7, provided, ruby2.5"
