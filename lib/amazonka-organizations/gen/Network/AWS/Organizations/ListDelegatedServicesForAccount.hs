...
mkListDelegatedServicesForAccount accountId
  = ListDelegatedServicesForAccount'{accountId,
...
{-# INLINEABLE ldsfaNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery ListDelegatedServicesForAccount where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders ListDelegatedServicesForAccount where
        toHeaders ListDelegatedServicesForAccount{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest ListDelegatedServicesForAccount where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListDelegatedServicesForAccountResponse' Core.<$>
                   (x Core..:? "DelegatedServices") Core.<*> x Core..:? "NextToken"
...
{-# INLINEABLE ldsfarrsDelegatedServices #-}
{-# DEPRECATED delegatedServices "Use generic-lens or generic-optics with 'delegatedServices' instead"  #-}
...
{-# INLINEABLE ldsfarrsResponseStatus #-}
