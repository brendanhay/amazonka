...
{-# DEPRECATED saBucketName "Use generic-lens or generic-optics with 'bucketName' instead." #-}
...
{-# DEPRECATED saKmsKeyArn "Use generic-lens or generic-optics with 'kmsKeyArn' instead." #-}
...
{-# DEPRECATED saObjectKeyPrefix "Use generic-lens or generic-optics with 'objectKeyPrefix' instead." #-}
