...
mkCaptionSelectorSettings
    :: CaptionSelectorSettings
mkCaptionSelectorSettings
  = CaptionSelectorSettings'{ancillarySourceSettings = Core.Nothing,
...
{-# INLINEABLE cssAribSourceSettings #-}
{-# DEPRECATED aribSourceSettings "Use generic-lens or generic-optics with 'aribSourceSettings' instead"  #-}
...
{-# INLINEABLE cssScte20SourceSettings #-}
{-# DEPRECATED scte20SourceSettings "Use generic-lens or generic-optics with 'scte20SourceSettings' instead"  #-}
...
{-# INLINEABLE cssScte27SourceSettings #-}
{-# DEPRECATED scte27SourceSettings "Use generic-lens or generic-optics with 'scte27SourceSettings' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("ancillarySourceSettings" Core..=) Core.<$>
                  ...
                  ("teletextSourceSettings" Core..=) Core.<$>
...
instance Core.FromJSON CaptionSelectorSettings where
        parseJSON
          = Core.withObject "CaptionSelectorSettings" Core.$
              \ x ->
                CaptionSelectorSettings' Core.<$>
                  (x Core..:? "ancillarySourceSettings") Core.<*>
                    x Core..:? "aribSourceSettings"
