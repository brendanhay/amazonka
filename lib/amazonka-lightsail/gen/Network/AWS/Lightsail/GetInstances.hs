...
giPageToken :: Lens.Lens' GetInstances (Core.Maybe Core.Text)
giPageToken = Lens.field @"pageToken"
{-# INLINEABLE giPageToken #-}
...
instance Core.AWSRequest GetInstances where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetInstancesResponse' Core.<$>
                   (x Core..:? "instances") Core.<*> x Core..:? "nextPageToken"
...
mkGetInstancesResponse responseStatus
  = GetInstancesResponse'{instances = Core.Nothing,
...
girrsNextPageToken :: Lens.Lens' GetInstancesResponse (Core.Maybe Core.Text)
girrsNextPageToken = Lens.field @"nextPageToken"
{-# INLINEABLE girrsNextPageToken #-}
