...
instance AWSRequest ListTrafficPolicyInstancesByPolicy where
  type
...
instance ToPath ListTrafficPolicyInstancesByPolicy where
  toPath = const "/2013-04-01/trafficpolicyinstances/trafficpolicy"
...
data ListTrafficPolicyInstancesByPolicyResponse = ListTrafficPolicyInstancesByPolicyResponse'
  { _ltpibprsTrafficPolicyInstanceTypeMarker ::
      !( Maybe
           RecordType
       ),
...
instance NFData ListTrafficPolicyInstancesByPolicyResponse
