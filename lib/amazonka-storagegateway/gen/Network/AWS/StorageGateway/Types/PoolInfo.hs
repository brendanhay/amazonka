...
mkPoolInfo
    :: PoolInfo
mkPoolInfo
  = PoolInfo'{poolARN = Core.Nothing, poolName = Core.Nothing,
              poolStatus = Core.Nothing, retentionLockTimeInDays = Core.Nothing,
              retentionLockType = Core.Nothing, storageClass = Core.Nothing}
...
{-# INLINEABLE piPoolStatus #-}
{-# DEPRECATED poolStatus "Use generic-lens or generic-optics with 'poolStatus' instead"  #-}
...
{-# INLINEABLE piRetentionLockTimeInDays #-}
...
{-# INLINEABLE piRetentionLockType #-}
...
instance Core.FromJSON PoolInfo where
        parseJSON
          = Core.withObject "PoolInfo" Core.$
              \ x ->
                PoolInfo' Core.<$>
                  (x Core..:? "PoolARN") Core.<*> x Core..:? "PoolName" Core.<*>
                    x Core..:? "PoolStatus"
