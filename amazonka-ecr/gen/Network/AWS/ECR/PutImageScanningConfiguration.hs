...
instance
  ...
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonEC2ContainerRegistry_V20150921.PutImageScanningConfiguration" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON PutImageScanningConfiguration where
...
instance Prelude.ToPath PutImageScanningConfiguration where
