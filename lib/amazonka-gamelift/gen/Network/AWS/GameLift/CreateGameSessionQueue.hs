...
mkCreateGameSessionQueue name
  = CreateGameSessionQueue'{name, destinations = Core.Nothing,
                            playerLatencyPolicies = Core.Nothing, tags = Core.Nothing,
...
{-# INLINEABLE cgsqPlayerLatencyPolicies #-}
...
{-# INLINEABLE cgsqTimeoutInSeconds #-}
...
instance Core.ToHeaders CreateGameSessionQueue where
        toHeaders CreateGameSessionQueue{..}
...
instance Core.AWSRequest CreateGameSessionQueue where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateGameSessionQueueResponse' Core.<$>
...
mkCreateGameSessionQueueResponse responseStatus
  = CreateGameSessionQueueResponse'{gameSessionQueue = Core.Nothing,
                                    responseStatus}
...
{-# INLINEABLE cgsqrrsGameSessionQueue #-}
...
{-# INLINEABLE cgsqrrsResponseStatus #-}
