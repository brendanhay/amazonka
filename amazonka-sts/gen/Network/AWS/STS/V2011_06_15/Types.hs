...
aruAssumedRoleId
    ...
    -> AssumedRoleUser
    -> f AssumedRoleUser
aruAssumedRoleId f x =
    (\y -> x { _aruAssumedRoleId = y })
       <$> f (_aruAssumedRoleId x)
{-# INLINE aruAssumedRoleId #-}
...
cSecretAccessKey
    ...
    -> Credentials
    -> f Credentials
cSecretAccessKey f x =
    (\y -> x { _cSecretAccessKey = y })
       <$> f (_cSecretAccessKey x)
{-# INLINE cSecretAccessKey #-}
...
cSessionToken
    ...
    -> f Credentials
cSessionToken f x =
    (\y -> x { _cSessionToken = y })
       <$> f (_cSessionToken x)
{-# INLINE cSessionToken #-}
...
fuFederatedUserId
    ...
    -> FederatedUser
    -> f FederatedUser
fuFederatedUserId f x =
    (\y -> x { _fuFederatedUserId = y })
       <$> f (_fuFederatedUserId x)
{-# INLINE fuFederatedUserId #-}
