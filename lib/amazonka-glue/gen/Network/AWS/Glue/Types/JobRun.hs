...
mkJobRun
    :: JobRun
mkJobRun
  = JobRun'{allocatedCapacity = Core.Nothing,
            arguments = Core.Nothing, attempt = Core.Nothing,
            completedOn = Core.Nothing, errorMessage = Core.Nothing,
            executionTime = Core.Nothing, glueVersion = Core.Nothing,
            id = Core.Nothing, jobName = Core.Nothing,
            jobRunState = Core.Nothing, lastModifiedOn = Core.Nothing,
            logGroupName = Core.Nothing, maxCapacity = Core.Nothing,
            notificationProperty = Core.Nothing,
            numberOfWorkers = Core.Nothing, predecessorRuns = Core.Nothing,
            previousRunId = Core.Nothing, securityConfiguration = Core.Nothing,
            startedOn = Core.Nothing, timeout = Core.Nothing,
            triggerName = Core.Nothing, workerType = Core.Nothing}
...
{-# INLINEABLE jrAllocatedCapacity #-}
...
{-# INLINEABLE jrJobRunState #-}
{-# DEPRECATED jobRunState "Use generic-lens or generic-optics with 'jobRunState' instead"  #-}
...
{-# INLINEABLE jrNotificationProperty #-}
...
{-# INLINEABLE jrPredecessorRuns #-}
{-# DEPRECATED predecessorRuns "Use generic-lens or generic-optics with 'predecessorRuns' instead"  #-}
...
{-# INLINEABLE jrSecurityConfiguration #-}
...
instance Core.FromJSON JobRun where
        parseJSON
          = Core.withObject "JobRun" Core.$
              \ x ->
                JobRun' Core.<$>
                  (x Core..:? "AllocatedCapacity") Core.<*> x Core..:? "Arguments"
                    Core.<*> x Core..:? "Attempt"
