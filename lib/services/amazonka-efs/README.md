...
`2.0` - Derived from API version @2015-02-01@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.EFS](http://hackage.haskell.org/package/amazonka-efs/docs/Amazonka-EFS.html)
