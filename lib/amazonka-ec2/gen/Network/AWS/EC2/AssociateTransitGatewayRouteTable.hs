...
instance ToQuery AssociateTransitGatewayRouteTable where
  toQuery AssociateTransitGatewayRouteTable' {..} =
    mconcat
      [ "Action" =: ("AssociateTransitGatewayRouteTable" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        "DryRun" =: _atgrtDryRun,
        "TransitGatewayRouteTableId" =: _atgrtTransitGatewayRouteTableId,
        "TransitGatewayAttachmentId" =: _atgrtTransitGatewayAttachmentId
      ]
...
associateTransitGatewayRouteTableResponse pResponseStatus_ =
  AssociateTransitGatewayRouteTableResponse'
    { _atgrtrsAssociation =
        Nothing,
      _atgrtrsResponseStatus = pResponseStatus_
    }
...
instance NFData AssociateTransitGatewayRouteTableResponse
