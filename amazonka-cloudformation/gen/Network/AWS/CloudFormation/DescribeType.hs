...
describeTypeResponse_requiredActivatedTypes = Lens.lens (\DescribeTypeResponse' {requiredActivatedTypes} -> requiredActivatedTypes) (\s@DescribeTypeResponse' {} a -> s {requiredActivatedTypes = a} :: DescribeTypeResponse) Prelude.. Lens.mapping Lens._Coerce
