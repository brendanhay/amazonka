...
mkListCompatibleImages
    :: ListCompatibleImages
mkListCompatibleImages
  = ListCompatibleImages'{maxResults = Core.Nothing,
...
lciNextToken :: Lens.Lens' ListCompatibleImages (Core.Maybe Core.Text)
...
instance Core.ToHeaders ListCompatibleImages where
        toHeaders ListCompatibleImages{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest ListCompatibleImages where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListCompatibleImagesResponse' Core.<$>
                   (x Core..:? "CompatibleImages") Core.<*> x Core..:? "NextToken"
...
mkListCompatibleImagesResponse responseStatus
  = ListCompatibleImagesResponse'{compatibleImages = Core.Nothing,
...
{-# INLINEABLE lcirrsCompatibleImages #-}
{-# DEPRECATED compatibleImages "Use generic-lens or generic-optics with 'compatibleImages' instead"  #-}

-- | Because HTTP requests are stateless, this is the starting point for your next list of returned images.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
lcirrsNextToken :: Lens.Lens' ListCompatibleImagesResponse (Core.Maybe Core.Text)
