...
scsfrsResponseStatus :: Lens.Lens' StopCrawlerScheduleResponse Lude.Int
scsfrsResponseStatus = Lens.lens (responseStatus :: StopCrawlerScheduleResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: StopCrawlerScheduleResponse)
{-# DEPRECATED scsfrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
