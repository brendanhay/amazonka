...
mkCreateTransformJob
    ...
    -> CreateTransformJob
mkCreateTransformJob transformJobName modelName transformInput
  transformOutput transformResources
  = CreateTransformJob'{transformJobName, modelName, transformInput,
                        transformOutput, transformResources, batchStrategy = Core.Nothing,
...
{-# INLINEABLE ctjTransformJobName #-}
...
{-# INLINEABLE ctjTransformResources #-}
...
{-# INLINEABLE ctjExperimentConfig #-}
...
{-# INLINEABLE ctjMaxConcurrentTransforms #-}
...
{-# INLINEABLE ctjModelClientConfig #-}
...
instance Core.AWSRequest CreateTransformJob where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 CreateTransformJobResponse' Core.<$>
                   (x Core..: "TransformJobArn") Core.<*> Core.pure (Core.fromEnum s))
...
{-# INLINEABLE ctjrrsTransformJobArn #-}
...
{-# INLINEABLE ctjrrsResponseStatus #-}
