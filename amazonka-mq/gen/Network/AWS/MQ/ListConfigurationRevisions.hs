...
-- | The token that specifies the next page of results Amazon MQ should
-- return. To request the first page, leave nextToken empty.
listConfigurationRevisions_nextToken :: Lens.Lens' ListConfigurationRevisions (Core.Maybe Core.Text)
...
-- | The maximum number of configurations that Amazon MQ can return per page
-- (20 by default). This value must be an integer from 5 to 100.
listConfigurationRevisions_maxResults :: Lens.Lens' ListConfigurationRevisions (Core.Maybe Core.Natural)
...
-- | The unique ID that Amazon MQ generates for the configuration.
listConfigurationRevisions_configurationId :: Lens.Lens' ListConfigurationRevisions Core.Text
...
instance Core.Hashable ListConfigurationRevisions

instance Core.NFData ListConfigurationRevisions
...
data ListConfigurationRevisionsResponse = ListConfigurationRevisionsResponse'
  { -- | The token that specifies the next page of results Amazon MQ should
    ...
    revisions :: Core.Maybe [ConfigurationRevision],
    -- | The unique ID that Amazon MQ generates for the configuration.
...
-- | The token that specifies the next page of results Amazon MQ should
-- return. To request the first page, leave nextToken empty.
listConfigurationRevisionsResponse_nextToken :: Lens.Lens' ListConfigurationRevisionsResponse (Core.Maybe Core.Text)
...
-- | The maximum number of configuration revisions that can be returned per
-- page (20 by default). This value must be an integer from 5 to 100.
listConfigurationRevisionsResponse_maxResults :: Lens.Lens' ListConfigurationRevisionsResponse (Core.Maybe Core.Int)
...
-- | The list of all revisions for the specified configuration.
listConfigurationRevisionsResponse_revisions :: Lens.Lens' ListConfigurationRevisionsResponse (Core.Maybe [ConfigurationRevision])
listConfigurationRevisionsResponse_revisions = Lens.lens (\ListConfigurationRevisionsResponse' {revisions} -> revisions) (\s@ListConfigurationRevisionsResponse' {} a -> s {revisions = a} :: ListConfigurationRevisionsResponse) Core.. Lens.mapping Lens._Coerce

-- | The unique ID that Amazon MQ generates for the configuration.
listConfigurationRevisionsResponse_configurationId :: Lens.Lens' ListConfigurationRevisionsResponse (Core.Maybe Core.Text)
...
-- | The response's http status code.
listConfigurationRevisionsResponse_httpStatus :: Lens.Lens' ListConfigurationRevisionsResponse Core.Int
