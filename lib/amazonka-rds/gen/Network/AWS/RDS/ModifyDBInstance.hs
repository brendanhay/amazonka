...
data ModifyDBInstance = ModifyDBInstance'
  { _mdiEngineVersion ::
    ...
    _mdiMaxAllocatedStorage :: !(Maybe Int),
  ...
  toQuery ModifyDBInstance' {..} =
    mconcat
      [ "Action" =: ("ModifyDBInstance" :: ByteString),
        ...
        "DBSecurityGroups"
          =: toQuery
            (toQueryList "DBSecurityGroupName" <$> _mdiDBSecurityGroups),
        ...
        "AutoMinorVersionUpgrade" =: _mdiAutoMinorVersionUpgrade,
        "DBSubnetGroupName" =: _mdiDBSubnetGroupName,
        "MonitoringRoleArn" =: _mdiMonitoringRoleARN,
        "Iops" =: _mdiIOPS,
        "AllowMajorVersionUpgrade" =: _mdiAllowMajorVersionUpgrade,
        "NewDBInstanceIdentifier" =: _mdiNewDBInstanceIdentifier,
        "Domain" =: _mdiDomain,
        "ReplicaMode" =: _mdiReplicaMode,
        "MonitoringInterval" =: _mdiMonitoringInterval,
        "CloudwatchLogsExportConfiguration"
          =: _mdiCloudwatchLogsExportConfiguration,
        "CertificateRotationRestart" =: _mdiCertificateRotationRestart,
        "TdeCredentialPassword" =: _mdiTDECredentialPassword,
        "ProcessorFeatures"
          =: toQuery (toQueryList "ProcessorFeature" <$> _mdiProcessorFeatures),
        "DBInstanceClass" =: _mdiDBInstanceClass,
        "PromotionTier" =: _mdiPromotionTier,
        "LicenseModel" =: _mdiLicenseModel,
        "PreferredMaintenanceWindow" =: _mdiPreferredMaintenanceWindow,
        "PerformanceInsightsRetentionPeriod"
          =: _mdiPerformanceInsightsRetentionPeriod,
        "CACertificateIdentifier" =: _mdiCACertificateIdentifier,
        "MaxAllocatedStorage" =: _mdiMaxAllocatedStorage,
        "EnablePerformanceInsights" =: _mdiEnablePerformanceInsights,
        ...
        "PerformanceInsightsKMSKeyId" =: _mdiPerformanceInsightsKMSKeyId,
        "VpcSecurityGroupIds"
          =: toQuery
            (toQueryList "VpcSecurityGroupId" <$> _mdiVPCSecurityGroupIds),
        "MultiAZ" =: _mdiMultiAZ,
        ...
        "UseDefaultProcessorFeatures" =: _mdiUseDefaultProcessorFeatures,
