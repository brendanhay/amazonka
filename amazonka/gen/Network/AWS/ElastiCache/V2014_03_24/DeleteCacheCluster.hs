...
-- &CacheClusterId=simcoprod43&Version=2014-03-24 &SignatureVersion=2
-- &SignatureMethod=HmacSHA256 &Timestamp=2014-03-27T02%3A46%3A46.129Z
...
module Network.AWS.ElastiCache.V2014_03_24.DeleteCacheCluster where
...
instance AWSRequest DeleteCacheCluster where
    ...
    response _ = cursorResponse $ \hs xml ->
        pure DeleteCacheClusterResponse
            <*> xml %|? "CacheCluster"
