...
mkStartSchemaExtension
    ...
    -> Core.Bool -- ^ 'createSnapshotBeforeSchemaExtension'
    -> Types.LdifContent -- ^ 'ldifContent'
    -> Types.Description -- ^ 'description'
    -> StartSchemaExtension
mkStartSchemaExtension directoryId
...
{-# INLINEABLE sseCreateSnapshotBeforeSchemaExtension #-}
{-# DEPRECATED createSnapshotBeforeSchemaExtension "Use generic-lens or generic-optics with 'createSnapshotBeforeSchemaExtension' instead"  #-}
...
{-# INLINEABLE sseLdifContent #-}
{-# DEPRECATED ldifContent "Use generic-lens or generic-optics with 'ldifContent' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("DirectoryId" Core..= directoryId),
                  Core.Just
                    ("CreateSnapshotBeforeSchemaExtension" Core..=
...
instance Core.AWSRequest StartSchemaExtension where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 StartSchemaExtensionResponse' Core.<$>
                   (x Core..:? "SchemaExtensionId") Core.<*>
...
mkStartSchemaExtensionResponse responseStatus
  = StartSchemaExtensionResponse'{schemaExtensionId = Core.Nothing,
                                  responseStatus}
...
{-# INLINEABLE sserrsSchemaExtensionId #-}
