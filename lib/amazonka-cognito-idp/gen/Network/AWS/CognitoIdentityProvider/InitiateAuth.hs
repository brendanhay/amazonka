...
{-# DEPRECATED iarrsAuthenticationResult "Use generic-lens or generic-optics with 'authenticationResult' instead." #-}
...
{-# DEPRECATED iarrsChallengeName "Use generic-lens or generic-optics with 'challengeName' instead." #-}
...
{-# DEPRECATED iarrsChallengeParameters "Use generic-lens or generic-optics with 'challengeParameters' instead." #-}
...
{-# DEPRECATED iarrsSession "Use generic-lens or generic-optics with 'session' instead." #-}
...
{-# DEPRECATED iarrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
