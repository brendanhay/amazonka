...
mkFailedRemediationExceptionBatch
    :: FailedRemediationExceptionBatch
mkFailedRemediationExceptionBatch
  = FailedRemediationExceptionBatch'{failedItems = Core.Nothing,
...
frebFailureMessage :: Lens.Lens' FailedRemediationExceptionBatch (Core.Maybe Core.Text)
frebFailureMessage = Lens.field @"failureMessage"
{-# INLINEABLE frebFailureMessage #-}
...
instance Core.FromJSON FailedRemediationExceptionBatch where
        parseJSON
          = Core.withObject "FailedRemediationExceptionBatch" Core.$
              \ x ->
                FailedRemediationExceptionBatch' Core.<$>
