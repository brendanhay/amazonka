...
--
-- * 'urResourceARN' - The Amazon Resource Name (ARN) of the resource to remove tags from.
--
-- * 'urTagKeys' - The list of keys for the tags to be removed from the resource.
untagResource ::
  -- | 'urResourceARN'
  Text ->
  UntagResource
...
instance ToHeaders UntagResource where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("CodePipeline_20150709.UntagResource" :: ByteString),
