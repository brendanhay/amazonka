...
mkAudioMetadata
    :: AudioMetadata
mkAudioMetadata
  = AudioMetadata'{codec = Core.Nothing,
                   durationMillis = Core.Nothing, numberOfChannels = Core.Nothing,
...
amCodec :: Lens.Lens' AudioMetadata (Core.Maybe Core.Text)
...
{-# INLINEABLE amNumberOfChannels #-}
{-# DEPRECATED numberOfChannels "Use generic-lens or generic-optics with 'numberOfChannels' instead"  #-}
