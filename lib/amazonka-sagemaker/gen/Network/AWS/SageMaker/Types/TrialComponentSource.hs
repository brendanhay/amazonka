...
mkTrialComponentSource
    :: Types.TrialComponentSourceArn -- ^ 'sourceArn'
    -> TrialComponentSource
...
instance Core.FromJSON TrialComponentSource where
        parseJSON
          = Core.withObject "TrialComponentSource" Core.$
              \ x ->
                TrialComponentSource' Core.<$>
                  (x Core..: "SourceArn") Core.<*> x Core..:? "SourceType"
