...
{-# INLINEABLE bcComparisonOperator #-}
...
{-# INLINEABLE bcConsecutiveDatapointsToAlarm #-}
{-# DEPRECATED consecutiveDatapointsToAlarm "Use generic-lens or generic-optics with 'consecutiveDatapointsToAlarm' instead"  #-}
...
{-# INLINEABLE bcConsecutiveDatapointsToClear #-}
{-# DEPRECATED consecutiveDatapointsToClear "Use generic-lens or generic-optics with 'consecutiveDatapointsToClear' instead"  #-}
...
{-# INLINEABLE bcStatisticalThreshold #-}
{-# DEPRECATED statisticalThreshold "Use generic-lens or generic-optics with 'statisticalThreshold' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("comparisonOperator" Core..=) Core.<$> comparisonOperator,
                  ("consecutiveDatapointsToAlarm" Core..=) Core.<$>
                    consecutiveDatapointsToAlarm,
                  ("consecutiveDatapointsToClear" Core..=) Core.<$>
...
instance Core.FromJSON BehaviorCriteria where
        parseJSON
          = Core.withObject "BehaviorCriteria" Core.$
              \ x ->
                BehaviorCriteria' Core.<$>
                  (x Core..:? "comparisonOperator") Core.<*>
                    x Core..:? "consecutiveDatapointsToAlarm"
