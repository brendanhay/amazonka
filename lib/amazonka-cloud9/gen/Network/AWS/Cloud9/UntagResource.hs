...
--
-- * 'urResourceARN' - The Amazon Resource Name (ARN) of the AWS Cloud9 development environment to remove tags from.
--
-- * 'urTagKeys' - The tag names of the tags to remove from the given AWS Cloud9 development environment.
untagResource ::
  -- | 'urResourceARN'
  Text ->
  UntagResource
