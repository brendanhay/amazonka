...
mkPathToObjectIdentifiers
    :: PathToObjectIdentifiers
mkPathToObjectIdentifiers
  = PathToObjectIdentifiers'{objectIdentifiers = Core.Nothing,
                             path = Core.Nothing}
...
{-# INLINEABLE ptoiObjectIdentifiers #-}
...
instance Core.FromJSON PathToObjectIdentifiers where
        parseJSON
          = Core.withObject "PathToObjectIdentifiers" Core.$
              \ x ->
                PathToObjectIdentifiers' Core.<$>
                  (x Core..:? "ObjectIdentifiers") Core.<*> x Core..:? "Path"
