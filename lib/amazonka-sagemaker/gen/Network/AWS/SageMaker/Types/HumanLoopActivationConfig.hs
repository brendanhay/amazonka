...
mkHumanLoopActivationConfig
    :: Types.HumanLoopActivationConditionsConfig -- ^ 'humanLoopActivationConditionsConfig'
    -> HumanLoopActivationConfig
...
{-# INLINEABLE hlacHumanLoopActivationConditionsConfig #-}
{-# DEPRECATED humanLoopActivationConditionsConfig "Use generic-lens or generic-optics with 'humanLoopActivationConditionsConfig' instead"  #-}
          ...
          = Core.withObject "HumanLoopActivationConfig" Core.$
              \ x ->
                HumanLoopActivationConfig' Core.<$>
                  (x Core..: "HumanLoopActivationConditionsConfig")
