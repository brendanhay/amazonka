...
mkCreateMountTarget fileSystemId subnetId
  = CreateMountTarget'{fileSystemId, subnetId,
                       ipAddress = Core.Nothing, securityGroups = Core.Nothing}
