...
instance AWSRequest GetServiceLastAccessedDetailsWithEntities where
  type
    ...
    receiveXMLWrapper
      ...
      ( \s h x ->
          GetServiceLastAccessedDetailsWithEntitiesResponse'
            ...
            <*> (x .@ "JobCreationDate")
            <*> (x .@ "JobCompletionDate")
            <*> (x .@? "EntityDetailsList" .!@ mempty >>= parseXMLList "member")
      )

instance Hashable GetServiceLastAccessedDetailsWithEntities

instance NFData GetServiceLastAccessedDetailsWithEntities

instance ToHeaders GetServiceLastAccessedDetailsWithEntities where
  toHeaders = const mempty

instance ToPath GetServiceLastAccessedDetailsWithEntities where
  toPath = const "/"

instance ToQuery GetServiceLastAccessedDetailsWithEntities where
  toQuery GetServiceLastAccessedDetailsWithEntities' {..} =
    mconcat
      [ "Action"
          =: ("GetServiceLastAccessedDetailsWithEntities" :: ByteString),
...
instance NFData GetServiceLastAccessedDetailsWithEntitiesResponse
