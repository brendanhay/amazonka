...
-- | The content-type for the model.
model_contentType :: Lens.Lens' Model (Core.Maybe Core.Text)
...
-- JavaScript, causing the installation of your API\'s SDK generated by API
-- Gateway to fail.
model_schema :: Lens.Lens' Model (Core.Maybe Core.Text)
model_schema = Lens.lens (\Model' {schema} -> schema) (\s@Model' {} a -> s {schema = a} :: Model)

-- | The identifier for the model resource.
model_id :: Lens.Lens' Model (Core.Maybe Core.Text)
model_id = Lens.lens (\Model' {id} -> id) (\s@Model' {} a -> s {id = a} :: Model)

-- | The name of the model. Must be an alphanumeric string.
model_name :: Lens.Lens' Model (Core.Maybe Core.Text)
model_name = Lens.lens (\Model' {name} -> name) (\s@Model' {} a -> s {name = a} :: Model)

-- | The description of the model.
model_description :: Lens.Lens' Model (Core.Maybe Core.Text)
...
instance Core.Hashable Model

instance Core.NFData Model
