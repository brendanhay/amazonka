...
mkPolicy
    ...
    -> Types.SecurityServicePolicyData -- ^ 'securityServicePolicyData'
    -> Types.ResourceType -- ^ 'resourceType'
    -> Core.Bool -- ^ 'excludeResourceTags'
    -> Core.Bool -- ^ 'remediationEnabled'
    -> Policy
mkPolicy policyName securityServicePolicyData resourceType
  excludeResourceTags remediationEnabled
  = Policy'{policyName, securityServicePolicyData, resourceType,
            excludeResourceTags, remediationEnabled, excludeMap = Core.Nothing,
            includeMap = Core.Nothing, policyId = Core.Nothing,
            policyUpdateToken = Core.Nothing, resourceTags = Core.Nothing,
...
{-# INLINEABLE pSecurityServicePolicyData #-}
{-# DEPRECATED securityServicePolicyData "Use generic-lens or generic-optics with 'securityServicePolicyData' instead"  #-}
...
{-# INLINEABLE pExcludeResourceTags #-}
{-# DEPRECATED excludeResourceTags "Use generic-lens or generic-optics with 'excludeResourceTags' instead"  #-}
...
{-# INLINEABLE pRemediationEnabled #-}
...
{-# INLINEABLE pExcludeMap #-}
{-# DEPRECATED excludeMap "Use generic-lens or generic-optics with 'excludeMap' instead"  #-}
...
{-# INLINEABLE pIncludeMap #-}
{-# DEPRECATED includeMap "Use generic-lens or generic-optics with 'includeMap' instead"  #-}
...
{-# INLINEABLE pPolicyUpdateToken #-}
{-# DEPRECATED policyUpdateToken "Use generic-lens or generic-optics with 'policyUpdateToken' instead"  #-}
...
{-# INLINEABLE pResourceTypeList #-}
{-# DEPRECATED resourceTypeList "Use generic-lens or generic-optics with 'resourceTypeList' instead"  #-}
              ...
              \ x ->
                Policy' Core.<$>
                  (x Core..: "PolicyName") Core.<*>
                    x Core..: "SecurityServicePolicyData"
