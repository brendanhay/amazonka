...
mkListOrganizations
    :: ListOrganizations
mkListOrganizations
  = ListOrganizations'{maxResults = Core.Nothing,
...
instance Core.AWSRequest ListOrganizations where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListOrganizationsResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*>
                     x Core..:? "OrganizationSummaries"
...
mkListOrganizationsResponse responseStatus
  = ListOrganizationsResponse'{nextToken = Core.Nothing,
                               organizationSummaries = Core.Nothing, responseStatus}
...
{-# INLINEABLE lorrsOrganizationSummaries #-}
{-# DEPRECATED organizationSummaries "Use generic-lens or generic-optics with 'organizationSummaries' instead"  #-}
