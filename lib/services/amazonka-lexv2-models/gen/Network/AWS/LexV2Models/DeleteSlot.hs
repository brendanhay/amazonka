...
-- |
-- Module      : Network.AWS.LexV2Models.DeleteSlot
...
instance Prelude.Hashable DeleteSlot

instance Prelude.NFData DeleteSlot

instance Core.ToHeaders DeleteSlot where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Core.ToPath DeleteSlot where
  toPath DeleteSlot' {..} =
    Prelude.mconcat
      [ "/bots/",
        Core.toBS botId,
...
instance Core.ToQuery DeleteSlot where
...
instance Prelude.NFData DeleteSlotResponse
