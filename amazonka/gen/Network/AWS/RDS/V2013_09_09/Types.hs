...
instance ToByteString ApplyMethod where
    toBS ApplyMethodImmediate = "immediate"
    toBS ApplyMethodPendingReboot = "pending-reboot"
...
instance ToByteString SourceType where
    toBS SourceTypeDbInstance = "db-instance"
    toBS SourceTypeDbParameterGroup = "db-parameter-group"
    toBS SourceTypeDbSecurityGroup = "db-security-group"
    toBS SourceTypeDbSnapshot = "db-snapshot"
