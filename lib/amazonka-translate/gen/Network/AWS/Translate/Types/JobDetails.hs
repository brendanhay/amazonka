...
mkJobDetails
    :: JobDetails
mkJobDetails
  = JobDetails'{documentsWithErrorsCount = Core.Nothing,
...
{-# INLINEABLE jdDocumentsWithErrorsCount #-}
{-# DEPRECATED documentsWithErrorsCount "Use generic-lens or generic-optics with 'documentsWithErrorsCount' instead"  #-}
...
{-# INLINEABLE jdInputDocumentsCount #-}
{-# DEPRECATED inputDocumentsCount "Use generic-lens or generic-optics with 'inputDocumentsCount' instead"  #-}
...
{-# INLINEABLE jdTranslatedDocumentsCount #-}
{-# DEPRECATED translatedDocumentsCount "Use generic-lens or generic-optics with 'translatedDocumentsCount' instead"  #-}
...
instance Core.FromJSON JobDetails where
        parseJSON
          = Core.withObject "JobDetails" Core.$
              \ x ->
                JobDetails' Core.<$>
                  (x Core..:? "DocumentsWithErrorsCount") Core.<*>
                    x Core..:? "InputDocumentsCount"
