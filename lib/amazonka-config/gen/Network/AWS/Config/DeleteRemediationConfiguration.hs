...
mkDeleteRemediationConfiguration configRuleName
  = DeleteRemediationConfiguration'{configRuleName,
...
drcfResourceType :: Lens.Lens' DeleteRemediationConfiguration (Core.Maybe Core.Text)
drcfResourceType = Lens.field @"resourceType"
{-# INLINEABLE drcfResourceType #-}
{-# DEPRECATED resourceType "Use generic-lens or generic-optics with 'resourceType' instead"  #-}

instance Core.ToQuery DeleteRemediationConfiguration where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DeleteRemediationConfiguration where
        toHeaders DeleteRemediationConfiguration{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DeleteRemediationConfiguration where
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 DeleteRemediationConfigurationResponse' Core.<$>
