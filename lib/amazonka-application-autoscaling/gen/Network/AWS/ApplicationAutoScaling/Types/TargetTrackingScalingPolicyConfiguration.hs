...
{-# INLINEABLE ttspcCustomizedMetricSpecification #-}
...
{-# INLINEABLE ttspcDisableScaleIn #-}
...
{-# INLINEABLE ttspcPredefinedMetricSpecification #-}
...
{-# INLINEABLE ttspcScaleInCooldown #-}
