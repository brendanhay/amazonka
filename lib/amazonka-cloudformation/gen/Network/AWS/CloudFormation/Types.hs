...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "CloudFormation",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "cloudformation",
                 Core._svcVersion = "2010-05-15", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _TypeNotFoundException #-}
...
{-# INLINEABLE _CreatedButModifiedException #-}
...
_ChangeSetNotFoundException
  = Core._MatchServiceError mkServiceConfig "ChangeSetNotFound"
      Core.. Core.hasStatues 404
{-# INLINEABLE _ChangeSetNotFoundException #-}
...
{-# INLINEABLE _InvalidChangeSetStatusException #-}
...
_OperationNotFoundException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 404
{-# INLINEABLE _OperationNotFoundException #-}
...
_OperationIdAlreadyExistsException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _OperationIdAlreadyExistsException #-}
...
_InsufficientCapabilitiesException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _InsufficientCapabilitiesException #-}
...
_TokenAlreadyExistsException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 400
{-# INLINEABLE _TokenAlreadyExistsException #-}
...
_StackSetNotFoundException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 404
{-# INLINEABLE _StackSetNotFoundException #-}
...
_StackInstanceNotFoundException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 404
{-# INLINEABLE _StackInstanceNotFoundException #-}
...
_OperationStatusCheckFailedException
  = Core._MatchServiceError mkServiceConfig "ConditionalCheckFailed"
      Core.. Core.hasStatues 400
{-# INLINEABLE _OperationStatusCheckFailedException #-}
...
_StackSetNotEmptyException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _StackSetNotEmptyException #-}
...
_NameAlreadyExistsException
  = Core._MatchServiceError mkServiceConfig
      ...
      Core.. Core.hasStatues 409
{-# INLINEABLE _NameAlreadyExistsException #-}
...
_CFNRegistryException
  = Core._MatchServiceError mkServiceConfig "CFNRegistryException"
      Core.. Core.hasStatues 400
{-# INLINEABLE _CFNRegistryException #-}
...
_StaleRequestException
  = Core._MatchServiceError mkServiceConfig "StaleRequestException"
      Core.. Core.hasStatues 409
{-# INLINEABLE _StaleRequestException #-}
