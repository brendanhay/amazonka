...
mkProtectiveEquipmentSummary
    :: ProtectiveEquipmentSummary
mkProtectiveEquipmentSummary
  = ProtectiveEquipmentSummary'{personsIndeterminate = Core.Nothing,
...
{-# INLINEABLE pesPersonsIndeterminate #-}
{-# DEPRECATED personsIndeterminate "Use generic-lens or generic-optics with 'personsIndeterminate' instead"  #-}
...
{-# INLINEABLE pesPersonsWithRequiredEquipment #-}
{-# DEPRECATED personsWithRequiredEquipment "Use generic-lens or generic-optics with 'personsWithRequiredEquipment' instead"  #-}
...
{-# INLINEABLE pesPersonsWithoutRequiredEquipment #-}
{-# DEPRECATED personsWithoutRequiredEquipment "Use generic-lens or generic-optics with 'personsWithoutRequiredEquipment' instead"  #-}

instance Core.FromJSON ProtectiveEquipmentSummary where
        parseJSON
          = Core.withObject "ProtectiveEquipmentSummary" Core.$
              \ x ->
                ProtectiveEquipmentSummary' Core.<$>
                  (x Core..:? "PersonsIndeterminate") Core.<*>
                    x Core..:? "PersonsWithRequiredEquipment"
