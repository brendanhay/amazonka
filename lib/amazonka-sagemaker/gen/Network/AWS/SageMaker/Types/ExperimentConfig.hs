...
mkExperimentConfig
    :: ExperimentConfig
mkExperimentConfig
  = ExperimentConfig'{experimentName = Core.Nothing,
                      trialComponentDisplayName = Core.Nothing, trialName = Core.Nothing}
...
{-# INLINEABLE ecTrialComponentDisplayName #-}
{-# DEPRECATED trialComponentDisplayName "Use generic-lens or generic-optics with 'trialComponentDisplayName' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("ExperimentName" Core..=) Core.<$> experimentName,
                  ("TrialComponentDisplayName" Core..=) Core.<$>
          ...
          = Core.withObject "ExperimentConfig" Core.$
              \ x ->
                ExperimentConfig' Core.<$>
                  (x Core..:? "ExperimentName") Core.<*>
                    x Core..:? "TrialComponentDisplayName"
