...
mkCustomMessageActivity
    :: CustomMessageActivity
mkCustomMessageActivity
  = CustomMessageActivity'{deliveryUri = Core.Nothing,
                           endpointTypes = Core.Nothing, messageConfig = Core.Nothing,
