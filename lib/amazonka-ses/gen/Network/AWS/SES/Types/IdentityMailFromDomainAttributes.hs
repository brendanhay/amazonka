...
mkIdentityMailFromDomainAttributes
    :: Types.MailFromDomain -- ^ 'mailFromDomain'
    -> Types.CustomMailFromStatus -- ^ 'mailFromDomainStatus'
    -> Types.BehaviorOnMXFailure -- ^ 'behaviorOnMXFailure'
    -> IdentityMailFromDomainAttributes
mkIdentityMailFromDomainAttributes mailFromDomain
  mailFromDomainStatus behaviorOnMXFailure
  = IdentityMailFromDomainAttributes'{mailFromDomain,
                                      mailFromDomainStatus, behaviorOnMXFailure}
...
{-# INLINEABLE imfdaMailFromDomain #-}
...
{-# INLINEABLE imfdaMailFromDomainStatus #-}
{-# DEPRECATED mailFromDomainStatus "Use generic-lens or generic-optics with 'mailFromDomainStatus' instead"  #-}
...
{-# INLINEABLE imfdaBehaviorOnMXFailure #-}
...
instance Core.FromXML IdentityMailFromDomainAttributes where
        parseXML x
          = IdentityMailFromDomainAttributes' Core.<$>
              (x Core..@ "MailFromDomain") Core.<*>
                x Core..@ "MailFromDomainStatus"
