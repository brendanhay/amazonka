...
mkListTapes
    :: ListTapes
mkListTapes
  = ListTapes'{limit = Core.Nothing, marker = Core.Nothing,
...
instance Core.AWSRequest ListTapes where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListTapesResponse' Core.<$>
                   (x Core..:? "Marker") Core.<*> x Core..:? "TapeInfos" Core.<*>
...
mkListTapesResponse responseStatus
  = ListTapesResponse'{marker = Core.Nothing,
                       tapeInfos = Core.Nothing, responseStatus}
...
{-# INLINEABLE ltrrsTapeInfos #-}
{-# DEPRECATED tapeInfos "Use generic-lens or generic-optics with 'tapeInfos' instead"  #-}
