...
mkS3Settings
    :: S3Settings
mkS3Settings
  = S3Settings'{bucketFolder = Core.Nothing,
                bucketName = Core.Nothing, cdcInsertsAndUpdates = Core.Nothing,
                cdcInsertsOnly = Core.Nothing, compressionType = Core.Nothing,
                csvDelimiter = Core.Nothing, csvRowDelimiter = Core.Nothing,
                dataFormat = Core.Nothing, dataPageSize = Core.Nothing,
                datePartitionDelimiter = Core.Nothing,
                datePartitionEnabled = Core.Nothing,
                datePartitionSequence = Core.Nothing,
                dictPageSizeLimit = Core.Nothing, enableStatistics = Core.Nothing,
                encodingType = Core.Nothing, encryptionMode = Core.Nothing,
                externalTableDefinition = Core.Nothing,
                includeOpForFullLoad = Core.Nothing,
                parquetTimestampInMillisecond = Core.Nothing,
                parquetVersion = Core.Nothing, rowGroupLength = Core.Nothing,
...
ssBucketFolder :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssBucketFolder = Lens.field @"bucketFolder"
{-# INLINEABLE ssBucketFolder #-}
...
ssBucketName :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssBucketName = Lens.field @"bucketName"
{-# INLINEABLE ssBucketName #-}
...
{-# INLINEABLE ssCdcInsertsAndUpdates #-}
{-# DEPRECATED cdcInsertsAndUpdates "Use generic-lens or generic-optics with 'cdcInsertsAndUpdates' instead"  #-}
...
{-# INLINEABLE ssCdcInsertsOnly #-}
{-# DEPRECATED cdcInsertsOnly "Use generic-lens or generic-optics with 'cdcInsertsOnly' instead"  #-}
...
ssCsvDelimiter :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssCsvDelimiter = Lens.field @"csvDelimiter"
{-# INLINEABLE ssCsvDelimiter #-}
{-# DEPRECATED csvDelimiter "Use generic-lens or generic-optics with 'csvDelimiter' instead"  #-}
...
ssCsvRowDelimiter :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssCsvRowDelimiter = Lens.field @"csvRowDelimiter"
{-# INLINEABLE ssCsvRowDelimiter #-}
{-# DEPRECATED csvRowDelimiter "Use generic-lens or generic-optics with 'csvRowDelimiter' instead"  #-}
...
{-# INLINEABLE ssDataPageSize #-}
{-# DEPRECATED dataPageSize "Use generic-lens or generic-optics with 'dataPageSize' instead"  #-}
...
{-# INLINEABLE ssDatePartitionDelimiter #-}
{-# DEPRECATED datePartitionDelimiter "Use generic-lens or generic-optics with 'datePartitionDelimiter' instead"  #-}
...
{-# INLINEABLE ssDatePartitionEnabled #-}
{-# DEPRECATED datePartitionEnabled "Use generic-lens or generic-optics with 'datePartitionEnabled' instead"  #-}
...
{-# INLINEABLE ssDatePartitionSequence #-}
{-# DEPRECATED datePartitionSequence "Use generic-lens or generic-optics with 'datePartitionSequence' instead"  #-}
...
{-# INLINEABLE ssDictPageSizeLimit #-}
{-# DEPRECATED dictPageSizeLimit "Use generic-lens or generic-optics with 'dictPageSizeLimit' instead"  #-}
...
{-# INLINEABLE ssEnableStatistics #-}
{-# DEPRECATED enableStatistics "Use generic-lens or generic-optics with 'enableStatistics' instead"  #-}
...
ssExternalTableDefinition :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssExternalTableDefinition = Lens.field @"externalTableDefinition"
{-# INLINEABLE ssExternalTableDefinition #-}
...
{-# INLINEABLE ssIncludeOpForFullLoad #-}
{-# DEPRECATED includeOpForFullLoad "Use generic-lens or generic-optics with 'includeOpForFullLoad' instead"  #-}
...
{-# INLINEABLE ssParquetTimestampInMillisecond #-}
{-# DEPRECATED parquetTimestampInMillisecond "Use generic-lens or generic-optics with 'parquetTimestampInMillisecond' instead"  #-}
...
{-# INLINEABLE ssParquetVersion #-}
{-# DEPRECATED parquetVersion "Use generic-lens or generic-optics with 'parquetVersion' instead"  #-}
...
{-# INLINEABLE ssRowGroupLength #-}
{-# DEPRECATED rowGroupLength "Use generic-lens or generic-optics with 'rowGroupLength' instead"  #-}
...
ssServerSideEncryptionKmsKeyId :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssServerSideEncryptionKmsKeyId = Lens.field @"serverSideEncryptionKmsKeyId"
{-# INLINEABLE ssServerSideEncryptionKmsKeyId #-}
...
ssServiceAccessRoleArn :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssServiceAccessRoleArn = Lens.field @"serviceAccessRoleArn"
{-# INLINEABLE ssServiceAccessRoleArn #-}
...
ssTimestampColumnName :: Lens.Lens' S3Settings (Core.Maybe Core.Text)
ssTimestampColumnName = Lens.field @"timestampColumnName"
{-# INLINEABLE ssTimestampColumnName #-}
{-# DEPRECATED timestampColumnName "Use generic-lens or generic-optics with 'timestampColumnName' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("BucketFolder" Core..=) Core.<$> bucketFolder,
                  ...
                  ("ParquetTimestampInMillisecond" Core..=) Core.<$>
...
instance Core.FromJSON S3Settings where
        parseJSON
          = Core.withObject "S3Settings" Core.$
              \ x ->
                S3Settings' Core.<$>
                  (x Core..:? "BucketFolder") Core.<*> x Core..:? "BucketName"
