...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "SMS", Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "sms", Core._svcVersion = "2016-10-24",
...
{-# INLINEABLE _ReplicationRunLimitExceededException #-}
...
{-# INLINEABLE _NoConnectorsAvailableException #-}
...
{-# INLINEABLE _ReplicationJobNotFoundException #-}
...
{-# INLINEABLE _ServerCannotBeReplicatedException #-}
...
{-# INLINEABLE _DryRunOperationException #-}
...
{-# INLINEABLE _ReplicationJobAlreadyExistsException #-}
...
{-# INLINEABLE _TemporarilyUnavailableException #-}
