...
mkReactionForComment
    :: ReactionForComment
mkReactionForComment
  = ReactionForComment'{reaction = Core.Nothing,
...
{-# INLINEABLE rfcReaction #-}
{-# DEPRECATED reaction "Use generic-lens or generic-optics with 'reaction' instead"  #-}
...
{-# INLINEABLE rfcReactionUsers #-}
{-# DEPRECATED reactionUsers "Use generic-lens or generic-optics with 'reactionUsers' instead"  #-}
...
{-# INLINEABLE rfcReactionsFromDeletedUsersCount #-}
{-# DEPRECATED reactionsFromDeletedUsersCount "Use generic-lens or generic-optics with 'reactionsFromDeletedUsersCount' instead"  #-}

instance Core.FromJSON ReactionForComment where
        parseJSON
          = Core.withObject "ReactionForComment" Core.$
              \ x ->
                ReactionForComment' Core.<$>
                  (x Core..:? "reaction") Core.<*> x Core..:? "reactionUsers"
