...
--
-- As an example: using "Network.AWS.Kinesis" with the smart constructor and
...
-- @
--
-- Versus using "Network.AWS.Kinesis.Monadic" with the 'State' operator variants from
...
getShardIteratorCatch :: ( MonadCatch m
                         , MonadResource m
                         , MonadReader Env m
                         )
    => Text -- ^ 'gsiStreamName'
