...
mkUpdateMatchmakingConfiguration name
  = UpdateMatchmakingConfiguration'{name,
...
{-# INLINEABLE umcAcceptanceRequired #-}
...
{-# INLINEABLE umcAcceptanceTimeoutSeconds #-}
...
{-# INLINEABLE umcAdditionalPlayerCount #-}
...
{-# INLINEABLE umcGameSessionQueueArns #-}
...
{-# INLINEABLE umcNotificationTarget #-}
...
{-# INLINEABLE umcRequestTimeoutSeconds #-}
...
instance Core.ToHeaders UpdateMatchmakingConfiguration where
        toHeaders UpdateMatchmakingConfiguration{..}
          = Core.pure
...
instance Core.AWSRequest UpdateMatchmakingConfiguration where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateMatchmakingConfigurationResponse' Core.<$>
...
{-# INLINEABLE umcrrsConfiguration #-}
...
{-# INLINEABLE umcrrsResponseStatus #-}
