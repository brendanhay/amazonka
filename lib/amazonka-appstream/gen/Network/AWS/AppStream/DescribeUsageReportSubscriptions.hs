...
mkDescribeUsageReportSubscriptions
    :: DescribeUsageReportSubscriptions
mkDescribeUsageReportSubscriptions
  = DescribeUsageReportSubscriptions'{maxResults = Core.Nothing,
...
{-# INLINEABLE dursMaxResults #-}
{-# DEPRECATED maxResults "Use generic-lens or generic-optics with 'maxResults' instead"  #-}

-- | The pagination token to use to retrieve the next page of results for this operation. If this value is null, it retrieves the first page.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dursNextToken :: Lens.Lens' DescribeUsageReportSubscriptions (Core.Maybe Core.Text)
dursNextToken = Lens.field @"nextToken"
{-# INLINEABLE dursNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}

instance Core.ToQuery DescribeUsageReportSubscriptions where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders DescribeUsageReportSubscriptions where
        toHeaders DescribeUsageReportSubscriptions{..}
          = Core.pure
              ("X-Amz-Target",
...
instance Core.AWSRequest DescribeUsageReportSubscriptions where
        type Rs DescribeUsageReportSubscriptions =
             DescribeUsageReportSubscriptionsResponse
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeUsageReportSubscriptionsResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*>
                     x Core..:? "UsageReportSubscriptions"
...
mkDescribeUsageReportSubscriptionsResponse responseStatus
  = DescribeUsageReportSubscriptionsResponse'{nextToken =
                                                Core.Nothing,
...
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
dursrrsNextToken :: Lens.Lens' DescribeUsageReportSubscriptionsResponse (Core.Maybe Core.Text)
dursrrsNextToken = Lens.field @"nextToken"
{-# INLINEABLE dursrrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE dursrrsUsageReportSubscriptions #-}
{-# DEPRECATED usageReportSubscriptions "Use generic-lens or generic-optics with 'usageReportSubscriptions' instead"  #-}
...
{-# INLINEABLE dursrrsResponseStatus #-}
