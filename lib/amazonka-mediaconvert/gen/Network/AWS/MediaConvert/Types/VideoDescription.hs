...
mkVideoDescription
    :: VideoDescription
mkVideoDescription
  = VideoDescription'{afdSignaling = Core.Nothing,
                      antiAlias = Core.Nothing, codecSettings = Core.Nothing,
                      colorMetadata = Core.Nothing, crop = Core.Nothing,
                      dropFrameTimecode = Core.Nothing, fixedAfd = Core.Nothing,
                      height = Core.Nothing, position = Core.Nothing,
                      respondToAfd = Core.Nothing, scalingBehavior = Core.Nothing,
                      sharpness = Core.Nothing, timecodeInsertion = Core.Nothing,
                      videoPreprocessors = Core.Nothing, width = Core.Nothing}
...
{-# INLINEABLE vdAntiAlias #-}
{-# DEPRECATED antiAlias "Use generic-lens or generic-optics with 'antiAlias' instead"  #-}
...
{-# INLINEABLE vdDropFrameTimecode #-}
{-# DEPRECATED dropFrameTimecode "Use generic-lens or generic-optics with 'dropFrameTimecode' instead"  #-}
...
{-# INLINEABLE vdTimecodeInsertion #-}
...
{-# INLINEABLE vdVideoPreprocessors #-}
{-# DEPRECATED videoPreprocessors "Use generic-lens or generic-optics with 'videoPreprocessors' instead"  #-}
          ...
          = Core.withObject "VideoDescription" Core.$
              \ x ->
                VideoDescription' Core.<$>
                  (x Core..:? "afdSignaling") Core.<*> x Core..:? "antiAlias"
