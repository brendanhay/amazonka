...
deleteItem :: HashMap Text AttributeValue -- ^ '_diiKey'
           -> Text -- ^ '_diiTableName'
           -> DeleteItem
...
data DeleteItem = DeleteItem
    { _diiKey :: HashMap Text AttributeValue
    ...
    , _diiExpected :: HashMap Text ExpectedAttributeValue
...
data DeleteItemResponse = DeleteItemResponse
    { _dioAttributes :: HashMap Text AttributeValue
      -- ^ A map of attribute names to AttributeValue objects, representing
