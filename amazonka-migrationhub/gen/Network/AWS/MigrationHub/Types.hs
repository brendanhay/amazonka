...
_AccessDeniedException =
    _MatchServiceError migrationHub "AccessDeniedException"
...
_InvalidInputException =
    _MatchServiceError migrationHub "InvalidInputException"
...
_UnauthorizedOperation =
    _MatchServiceError migrationHub "UnauthorizedOperation"
