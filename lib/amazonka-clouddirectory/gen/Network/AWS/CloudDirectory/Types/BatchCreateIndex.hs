...
mkBatchCreateIndex isUnique
  = BatchCreateIndex'{orderedIndexedAttributeList = Core.mempty,
                      isUnique, batchReferenceName = Core.Nothing,
...
{-# INLINEABLE bciOrderedIndexedAttributeList #-}
...
{-# INLINEABLE bciBatchReferenceName #-}
