...
mkTiming
    :: Timing
mkTiming
  = Timing'{finishTimeMillis = Core.Nothing,
            startTimeMillis = Core.Nothing, submitTimeMillis = Core.Nothing}
...
{-# INLINEABLE tFinishTimeMillis #-}
{-# DEPRECATED finishTimeMillis "Use generic-lens or generic-optics with 'finishTimeMillis' instead"  #-}
...
{-# INLINEABLE tStartTimeMillis #-}
{-# DEPRECATED startTimeMillis "Use generic-lens or generic-optics with 'startTimeMillis' instead"  #-}
...
{-# INLINEABLE tSubmitTimeMillis #-}
{-# DEPRECATED submitTimeMillis "Use generic-lens or generic-optics with 'submitTimeMillis' instead"  #-}
...
instance Core.FromJSON Timing where
        parseJSON
          = Core.withObject "Timing" Core.$
              \ x ->
                Timing' Core.<$>
                  (x Core..:? "FinishTimeMillis") Core.<*>
                    x Core..:? "StartTimeMillis"
