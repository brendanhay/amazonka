...
Documentation is available via [Hackage](http://hackage.haskell.org/package/amazonka-cloud9)
...
`amazonka-cloud9` is released under the [Mozilla Public License Version 2.0](http://www.mozilla.org/MPL/).
