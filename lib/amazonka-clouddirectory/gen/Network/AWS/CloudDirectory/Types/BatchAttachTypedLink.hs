...
mkBatchAttachTypedLink
    ...
    -> BatchAttachTypedLink
mkBatchAttachTypedLink sourceObjectReference targetObjectReference
  typedLinkFacet
...
{-# INLINEABLE batlSourceObjectReference #-}
...
{-# INLINEABLE batlTargetObjectReference #-}
