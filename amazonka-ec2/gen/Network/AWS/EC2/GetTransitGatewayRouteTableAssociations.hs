...
--
-- * 'gtgrtaFilters' - One or more filters. The possible values are:     * @resource-id@ - The ID of the resource.     * @resource-type@ - The resource type (@vpc@ | @vpn@ ).     * @transit-gateway-attachment-id@ - The ID of the attachment.
--
