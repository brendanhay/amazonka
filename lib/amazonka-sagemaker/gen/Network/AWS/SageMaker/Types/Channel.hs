...
mkChannel channelName dataSource
  = Channel'{channelName, dataSource, compressionType = Core.Nothing,
             contentType = Core.Nothing, inputMode = Core.Nothing,
             recordWrapperType = Core.Nothing, shuffleConfig = Core.Nothing}
...
{-# INLINEABLE cInputMode #-}
{-# DEPRECATED inputMode "Use generic-lens or generic-optics with 'inputMode' instead"  #-}
...
{-# INLINEABLE cRecordWrapperType #-}
{-# DEPRECATED recordWrapperType "Use generic-lens or generic-optics with 'recordWrapperType' instead"  #-}
...
{-# INLINEABLE cShuffleConfig #-}
{-# DEPRECATED shuffleConfig "Use generic-lens or generic-optics with 'shuffleConfig' instead"  #-}
...
instance Core.FromJSON Channel where
        parseJSON
          = Core.withObject "Channel" Core.$
              \ x ->
                Channel' Core.<$>
                  (x Core..: "ChannelName") Core.<*> x Core..: "DataSource" Core.<*>
                    x Core..:? "CompressionType"
