...
mkLabelingJobAlgorithmsConfig
    :: Types.LabelingJobAlgorithmSpecificationArn -- ^ 'labelingJobAlgorithmSpecificationArn'
    -> LabelingJobAlgorithmsConfig
...
{-# INLINEABLE ljacLabelingJobAlgorithmSpecificationArn #-}
{-# DEPRECATED labelingJobAlgorithmSpecificationArn "Use generic-lens or generic-optics with 'labelingJobAlgorithmSpecificationArn' instead"  #-}
...
{-# INLINEABLE ljacInitialActiveLearningModelArn #-}
{-# DEPRECATED initialActiveLearningModelArn "Use generic-lens or generic-optics with 'initialActiveLearningModelArn' instead"  #-}
...
{-# INLINEABLE ljacLabelingJobResourceConfig #-}
{-# DEPRECATED labelingJobResourceConfig "Use generic-lens or generic-optics with 'labelingJobResourceConfig' instead"  #-}
...
instance Core.FromJSON LabelingJobAlgorithmsConfig where
        toJSON LabelingJobAlgorithmsConfig{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just
                    ("LabelingJobAlgorithmSpecificationArn" Core..=
                       labelingJobAlgorithmSpecificationArn),
                  ("InitialActiveLearningModelArn" Core..=) Core.<$>
                    initialActiveLearningModelArn,
                  ("LabelingJobResourceConfig" Core..=) Core.<$>
          ...
          = Core.withObject "LabelingJobAlgorithmsConfig" Core.$
              \ x ->
                LabelingJobAlgorithmsConfig' Core.<$>
                  (x Core..: "LabelingJobAlgorithmSpecificationArn") Core.<*>
                    x Core..:? "InitialActiveLearningModelArn"
