...
-- &amp;IpPermissions.1.IpRanges.1.CidrIp=your-local-system's-public-ip-address/32.
-- 
module Network.AWS.EC2.V2014_05_01.AuthorizeSecurityGroupIngress where
