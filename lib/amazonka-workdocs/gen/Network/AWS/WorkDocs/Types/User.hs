...
mkUser
    :: User
mkUser
  = User'{createdTimestamp = Core.Nothing,
          emailAddress = Core.Nothing, givenName = Core.Nothing,
          id = Core.Nothing, locale = Core.Nothing,
          modifiedTimestamp = Core.Nothing, organizationId = Core.Nothing,
          recycleBinFolderId = Core.Nothing, rootFolderId = Core.Nothing,
          status = Core.Nothing, storage = Core.Nothing,
          surname = Core.Nothing, timeZoneId = Core.Nothing,
          type' = Core.Nothing, username = Core.Nothing}
...
{-# INLINEABLE uRecycleBinFolderId #-}
{-# DEPRECATED recycleBinFolderId "Use generic-lens or generic-optics with 'recycleBinFolderId' instead"  #-}
...
{-# INLINEABLE uRootFolderId #-}
{-# DEPRECATED rootFolderId "Use generic-lens or generic-optics with 'rootFolderId' instead"  #-}
...
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User" Core.$
              \ x ->
                User' Core.<$>
                  (x Core..:? "CreatedTimestamp") Core.<*> x Core..:? "EmailAddress"
