  ...
  request x@Core.Request {..} =
    Core.Request
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqHeaders =
          Core.pure ("X-Amz-Target", "AmazonSSM.PutParameter")
...
{-# DEPRECATED pprrsTier "Use generic-lens or generic-optics with 'tier' instead." #-}
...
{-# DEPRECATED pprrsVersion "Use generic-lens or generic-optics with 'version' instead." #-}
