...
mkPendingAggregationRequest
    :: PendingAggregationRequest
mkPendingAggregationRequest
  = PendingAggregationRequest'{requesterAccountId = Core.Nothing,
...
{-# INLINEABLE parRequesterAccountId #-}
...
{-# INLINEABLE parRequesterAwsRegion #-}
...
instance Core.FromJSON PendingAggregationRequest where
        parseJSON
          = Core.withObject "PendingAggregationRequest" Core.$
              \ x ->
                PendingAggregationRequest' Core.<$>
                  (x Core..:? "RequesterAccountId") Core.<*>
                    x Core..:? "RequesterAwsRegion"
