...
mkOrganizationConformancePackDetailedStatus ::
  ...
  -- | 'status'
  Types.OrganizationResourceDetailedStatus ->
  OrganizationConformancePackDetailedStatus
mkOrganizationConformancePackDetailedStatus
  accountId
  conformancePackName
...
ocpdsErrorCode :: Lens.Lens' OrganizationConformancePackDetailedStatus (Core.Maybe Types.String)
...
ocpdsErrorMessage :: Lens.Lens' OrganizationConformancePackDetailedStatus (Core.Maybe Types.String)
...
instance Core.FromJSON OrganizationConformancePackDetailedStatus where
  parseJSON =
    Core.withObject "OrganizationConformancePackDetailedStatus" Core.$
      \x ->
        OrganizationConformancePackDetailedStatus'
