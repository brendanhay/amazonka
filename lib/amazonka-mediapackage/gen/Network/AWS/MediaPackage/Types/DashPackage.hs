...
mkDashPackage
  = DashPackage'{adTriggers = Core.Nothing,
                 ...
                 utcTiming = Core.Nothing, utcTimingUri = Core.Nothing}
...
{-# INLINEABLE dpAdsOnDeliveryRestrictions #-}
...
{-# INLINEABLE dpManifestLayout #-}
{-# DEPRECATED manifestLayout "Use generic-lens or generic-optics with 'manifestLayout' instead"  #-}
...
{-# INLINEABLE dpManifestWindowSeconds #-}
...
{-# INLINEABLE dpMinBufferTimeSeconds #-}
{-# DEPRECATED minBufferTimeSeconds "Use generic-lens or generic-optics with 'minBufferTimeSeconds' instead"  #-}
...
{-# INLINEABLE dpMinUpdatePeriodSeconds #-}
{-# DEPRECATED minUpdatePeriodSeconds "Use generic-lens or generic-optics with 'minUpdatePeriodSeconds' instead"  #-}
...
{-# INLINEABLE dpPeriodTriggers #-}
{-# DEPRECATED periodTriggers "Use generic-lens or generic-optics with 'periodTriggers' instead"  #-}
...
{-# INLINEABLE dpSegmentDurationSeconds #-}
...
{-# INLINEABLE dpSegmentTemplateFormat #-}
{-# DEPRECATED segmentTemplateFormat "Use generic-lens or generic-optics with 'segmentTemplateFormat' instead"  #-}
...
{-# INLINEABLE dpSuggestedPresentationDelaySeconds #-}
{-# DEPRECATED suggestedPresentationDelaySeconds "Use generic-lens or generic-optics with 'suggestedPresentationDelaySeconds' instead"  #-}
...
{-# INLINEABLE dpUtcTiming #-}
{-# DEPRECATED utcTiming "Use generic-lens or generic-optics with 'utcTiming' instead"  #-}
...
{-# INLINEABLE dpUtcTimingUri #-}
{-# DEPRECATED utcTimingUri "Use generic-lens or generic-optics with 'utcTimingUri' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("adTriggers" Core..=) Core.<$> adTriggers,
                  ...
                  ("suggestedPresentationDelaySeconds" Core..=) Core.<$>
