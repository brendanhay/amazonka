...
instance Core.ToQuery VerifyDomainDkim where
        toQuery VerifyDomainDkim{..}
          = Core.toQueryPair "Action" ("VerifyDomainDkim" :: Core.Text)
...
instance Core.AWSRequest VerifyDomainDkim where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "VerifyDomainDkimResult"
              (\ s h x ->
                 VerifyDomainDkimResponse' Core.<$>
                   (x Core..@ "DkimTokens" Core..@! Core.mempty Core..<@>
...
mkVerifyDomainDkimResponse responseStatus
  = VerifyDomainDkimResponse'{dkimTokens = Core.mempty,
                              responseStatus}
...
{-# INLINEABLE vddrrsResponseStatus #-}
