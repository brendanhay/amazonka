...
mkDevicePoolCompatibilityResult
    :: DevicePoolCompatibilityResult
mkDevicePoolCompatibilityResult
  = DevicePoolCompatibilityResult'{compatible = Core.Nothing,
                                   device = Core.Nothing, incompatibilityMessages = Core.Nothing}
...
{-# INLINEABLE dpcrCompatible #-}
{-# DEPRECATED compatible "Use generic-lens or generic-optics with 'compatible' instead"  #-}
...
{-# INLINEABLE dpcrIncompatibilityMessages #-}
{-# DEPRECATED incompatibilityMessages "Use generic-lens or generic-optics with 'incompatibilityMessages' instead"  #-}

instance Core.FromJSON DevicePoolCompatibilityResult where
        parseJSON
          = Core.withObject "DevicePoolCompatibilityResult" Core.$
              \ x ->
                DevicePoolCompatibilityResult' Core.<$>
                  (x Core..:? "compatible") Core.<*> x Core..:? "device" Core.<*>
                    x Core..:? "incompatibilityMessages"
