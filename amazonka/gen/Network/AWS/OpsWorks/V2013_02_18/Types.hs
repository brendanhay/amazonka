...
instance ServiceError (Er OpsWorks) where
...
data App = App
    ...
    , _apAppId :: Maybe Text
      -- ^ The app ID.
    , _apAttributes :: HashMap AppAttributesKeys Text
...
data Layer = Layer
    ...
    , _lrAttributes :: HashMap LayerAttributesKeys Text
...
data Stack = Stack
    ...
    , _ssssssqAttributes :: HashMap StackAttributesKeys Text
