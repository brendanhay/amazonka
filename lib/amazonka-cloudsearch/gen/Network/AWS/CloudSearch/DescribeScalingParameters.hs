...
instance Core.AWSRequest DescribeScalingParameters where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "DescribeScalingParametersResult"
              (\ s h x ->
                 DescribeScalingParametersResponse' Core.<$>
...
mkDescribeScalingParametersResponse
    ...
    -> DescribeScalingParametersResponse
mkDescribeScalingParametersResponse scalingParameters
  responseStatus
...
{-# INLINEABLE dsprrsScalingParameters #-}
