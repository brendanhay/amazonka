...
csSecretBinary :: Lens.Lens' CreateSecret (Lude.Maybe (Lude.Sensitive Lude.Base64))
csSecretBinary = Lens.lens (secretBinary :: CreateSecret -> Lude.Maybe (Lude.Sensitive Lude.Base64)) (\s a -> s {secretBinary = a} :: CreateSecret)
...
csSecretString :: Lens.Lens' CreateSecret (Lude.Maybe (Lude.Sensitive Lude.Text))
csSecretString = Lens.lens (secretString :: CreateSecret -> Lude.Maybe (Lude.Sensitive Lude.Text)) (\s a -> s {secretString = a} :: CreateSecret)
...
csClientRequestToken :: Lens.Lens' CreateSecret (Lude.Maybe Lude.Text)
csClientRequestToken = Lens.lens (clientRequestToken :: CreateSecret -> Lude.Maybe Lude.Text) (\s a -> s {clientRequestToken = a} :: CreateSecret)
...
csDescription :: Lens.Lens' CreateSecret (Lude.Maybe Lude.Text)
csDescription = Lens.lens (description :: CreateSecret -> Lude.Maybe Lude.Text) (\s a -> s {description = a} :: CreateSecret)
...
csTags :: Lens.Lens' CreateSecret (Lude.Maybe [Tag])
...
instance Lude.ToHeaders CreateSecret where
  toHeaders =
    Lude.const
      ( Lude.mconcat
          [ "X-Amz-Target"
              Lude.=# ("secretsmanager.CreateSecret" :: Lude.ByteString),
            "Content-Type"
              Lude.=# ("application/x-amz-json-1.1" :: Lude.ByteString)
          ]
      )

instance Lude.ToJSON CreateSecret where
  toJSON CreateSecret' {..} =
    Lude.object
      ( Lude.catMaybes
...
instance Lude.ToPath CreateSecret where
  toPath = Lude.const "/"

instance Lude.ToQuery CreateSecret where
...
mkCreateSecretResponse ::
  ...
  Lude.Int ->
  CreateSecretResponse
mkCreateSecretResponse pResponseStatus_ =
  CreateSecretResponse'
...
csrsVersionId :: Lens.Lens' CreateSecretResponse (Lude.Maybe Lude.Text)
csrsVersionId = Lens.lens (versionId :: CreateSecretResponse -> Lude.Maybe Lude.Text) (\s a -> s {versionId = a} :: CreateSecretResponse)
{-# DEPRECATED csrsVersionId "Use generic-lens or generic-optics with 'versionId' instead." #-}

-- | The Amazon Resource Name (ARN) of the secret that you just created.
--
-- /Note:/ Consider using 'arn' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
csrsARN :: Lens.Lens' CreateSecretResponse (Lude.Maybe Lude.Text)
csrsARN = Lens.lens (arn :: CreateSecretResponse -> Lude.Maybe Lude.Text) (\s a -> s {arn = a} :: CreateSecretResponse)
{-# DEPRECATED csrsARN "Use generic-lens or generic-optics with 'arn' instead." #-}

-- | The friendly name of the secret that you just created.
--
-- /Note:/ Consider using 'name' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
csrsName :: Lens.Lens' CreateSecretResponse (Lude.Maybe Lude.Text)
csrsName = Lens.lens (name :: CreateSecretResponse -> Lude.Maybe Lude.Text) (\s a -> s {name = a} :: CreateSecretResponse)
{-# DEPRECATED csrsName "Use generic-lens or generic-optics with 'name' instead." #-}

-- | The response status code.
--
-- /Note:/ Consider using 'responseStatus' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
csrsResponseStatus :: Lens.Lens' CreateSecretResponse Lude.Int
csrsResponseStatus = Lens.lens (responseStatus :: CreateSecretResponse -> Lude.Int) (\s a -> s {responseStatus = a} :: CreateSecretResponse)
