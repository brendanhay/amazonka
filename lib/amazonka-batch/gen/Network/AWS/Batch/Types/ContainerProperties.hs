...
cpCommand :: Lens.Lens' ContainerProperties (Core.Maybe [Types.String])
...
cpExecutionRoleArn :: Lens.Lens' ContainerProperties (Core.Maybe Types.String)
...
cpImage :: Lens.Lens' ContainerProperties (Core.Maybe Types.String)
...
cpInstanceType :: Lens.Lens' ContainerProperties (Core.Maybe Types.String)
...
cpJobRoleArn :: Lens.Lens' ContainerProperties (Core.Maybe Types.String)
...
cpUser :: Lens.Lens' ContainerProperties (Core.Maybe Types.String)
