...
import Network.AWS.Lambda.Types.Marker
...
import Network.AWS.Lambda.Types.RevisionId
...
import Network.AWS.Lambda.Types.StatusReason
import Network.AWS.Lambda.Types.String
...
import Network.AWS.Lambda.Types.UUID
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "Lambda",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "lambda",
      Core._svcVersion = "2015-03-31",
...
_EFSIOException =
  Core._MatchServiceError mkServiceConfig "EFSIOException"
