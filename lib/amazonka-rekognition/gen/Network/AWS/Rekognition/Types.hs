...
import Network.AWS.Rekognition.Types.ModerationModelVersion
...
import Network.AWS.Rekognition.Types.ParentName
...
import Network.AWS.Rekognition.Types.ProtectiveEquipmentModelVersion
...
import Network.AWS.Rekognition.Types.String
...
import Network.AWS.Rekognition.Types.TextModelVersion
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "Rekognition",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "rekognition",
      Core._svcVersion = "2016-06-27",
