...
mkBulkDeployment
    :: BulkDeployment
mkBulkDeployment
  = BulkDeployment'{bulkDeploymentArn = Core.Nothing,
                    bulkDeploymentId = Core.Nothing, createdAt = Core.Nothing}
...
{-# INLINEABLE bdBulkDeploymentArn #-}
