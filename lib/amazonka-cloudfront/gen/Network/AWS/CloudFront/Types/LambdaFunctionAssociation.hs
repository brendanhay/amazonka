...
mkLambdaFunctionAssociation lambdaFunctionARN eventType
  = LambdaFunctionAssociation'{lambdaFunctionARN, eventType,
...
{-# INLINEABLE lfaLambdaFunctionARN #-}
...
{-# INLINEABLE lfaIncludeBody #-}
{-# DEPRECATED includeBody "Use generic-lens or generic-optics with 'includeBody' instead"  #-}

instance Core.ToXML LambdaFunctionAssociation where
        toXML LambdaFunctionAssociation{..}
          = Core.toXMLElement "LambdaFunctionARN" lambdaFunctionARN Core.<>
              Core.toXMLElement "EventType" eventType
              Core.<>
              Core.maybe Core.mempty (Core.toXMLElement "IncludeBody")
                includeBody

instance Core.FromXML LambdaFunctionAssociation where
        parseXML x
          = LambdaFunctionAssociation' Core.<$>
              (x Core..@ "LambdaFunctionARN") Core.<*> x Core..@ "EventType"
