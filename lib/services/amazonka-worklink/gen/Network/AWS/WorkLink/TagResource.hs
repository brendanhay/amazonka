...
-- |
-- Module      : Network.AWS.WorkLink.TagResource
...
--
-- 'resourceArn', 'tagResource_resourceArn' - The Amazon Resource Name (ARN) of the fleet.
--
-- 'tags', 'tagResource_tags' - The tags to add to the resource. A tag is a key-value pair.
newTagResource ::
  -- | 'resourceArn'
  Prelude.Text ->
  TagResource
