...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "MarketplaceAnalytics",
                 Core._svcSigner = Sign.v4,
                 Core._svcPrefix = "marketplacecommerceanalytics",
                 Core._svcVersion = "2015-07-01", Core._svcTimeout = Core.Just 70,
...
{-# INLINEABLE _MarketplaceCommerceAnalyticsException #-}
