...
{-# DEPRECATED aBundleId "Use generic-lens or generic-optics with 'bundleId' instead." #-}
...
{-# DEPRECATED aCertificate "Use generic-lens or generic-optics with 'certificate' instead." #-}
...
{-# DEPRECATED aDefaultAuthenticationMethod "Use generic-lens or generic-optics with 'defaultAuthenticationMethod' instead." #-}
...
{-# DEPRECATED aPrivateKey "Use generic-lens or generic-optics with 'privateKey' instead." #-}
...
{-# DEPRECATED aTeamId "Use generic-lens or generic-optics with 'teamId' instead." #-}
...
{-# DEPRECATED aTokenKey "Use generic-lens or generic-optics with 'tokenKey' instead." #-}
...
{-# DEPRECATED aTokenKeyId "Use generic-lens or generic-optics with 'tokenKeyId' instead." #-}
