...
-- | The time the session mapping was created.
sessionMappingSummary_creationTime :: Lens.Lens' SessionMappingSummary (Core.Maybe Core.UTCTime)
sessionMappingSummary_creationTime = Lens.lens (\SessionMappingSummary' {creationTime} -> creationTime) (\s@SessionMappingSummary' {} a -> s {creationTime = a} :: SessionMappingSummary) Core.. Lens.mapping Core._Time
...
-- <https://docs.aws.amazon.com/singlesignon/latest/IdentityStoreAPIReference/API_Group.html#singlesignon-Type-Group-DisplayName DisplayName>
-- in the /AWS SSO Identity Store API Reference/.
sessionMappingSummary_identityName :: Lens.Lens' SessionMappingSummary (Core.Maybe Core.Text)
...
-- | Specifies whether the identity mapped to the Amazon EMR Studio is a user
-- or a group.
sessionMappingSummary_identityType :: Lens.Lens' SessionMappingSummary (Core.Maybe IdentityType)
...
-- | The globally unique identifier (GUID) of the user or group from the AWS
-- SSO Identity Store.
sessionMappingSummary_identityId :: Lens.Lens' SessionMappingSummary (Core.Maybe Core.Text)
...
-- | The Amazon Resource Name (ARN) of the session policy associated with the
-- user or group.
sessionMappingSummary_sessionPolicyArn :: Lens.Lens' SessionMappingSummary (Core.Maybe Core.Text)
...
-- | The ID of the Amazon EMR Studio.
sessionMappingSummary_studioId :: Lens.Lens' SessionMappingSummary (Core.Maybe Core.Text)
...
instance Core.Hashable SessionMappingSummary

instance Core.NFData SessionMappingSummary
