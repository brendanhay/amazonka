...
-- |
-- Module      : Amazonka.Athena.Types.WorkGroupState
...
pattern WorkGroupState_DISABLED = WorkGroupState' "DISABLED"

pattern WorkGroupState_ENABLED :: WorkGroupState
pattern WorkGroupState_ENABLED = WorkGroupState' "ENABLED"
