...
mkClassifierEvaluationMetrics
    :: ClassifierEvaluationMetrics
mkClassifierEvaluationMetrics
  = ClassifierEvaluationMetrics'{accuracy = Core.Nothing,
                                 f1Score = Core.Nothing, hammingLoss = Core.Nothing,
                                 microF1Score = Core.Nothing, microPrecision = Core.Nothing,
                                 microRecall = Core.Nothing, precision = Core.Nothing,
                                 recall = Core.Nothing}
...
{-# INLINEABLE cemAccuracy #-}
{-# DEPRECATED accuracy "Use generic-lens or generic-optics with 'accuracy' instead"  #-}
...
{-# INLINEABLE cemHammingLoss #-}
{-# DEPRECATED hammingLoss "Use generic-lens or generic-optics with 'hammingLoss' instead"  #-}
...
{-# INLINEABLE cemMicroF1Score #-}
{-# DEPRECATED microF1Score "Use generic-lens or generic-optics with 'microF1Score' instead"  #-}
...
{-# INLINEABLE cemMicroPrecision #-}
{-# DEPRECATED microPrecision "Use generic-lens or generic-optics with 'microPrecision' instead"  #-}
...
{-# INLINEABLE cemMicroRecall #-}
{-# DEPRECATED microRecall "Use generic-lens or generic-optics with 'microRecall' instead"  #-}
...
instance Core.FromJSON ClassifierEvaluationMetrics where
        parseJSON
          = Core.withObject "ClassifierEvaluationMetrics" Core.$
              \ x ->
                ClassifierEvaluationMetrics' Core.<$>
                  (x Core..:? "Accuracy") Core.<*> x Core..:? "F1Score" Core.<*>
                    x Core..:? "HammingLoss"
