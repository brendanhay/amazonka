...
mkIotAnalyticsAction
    :: IotAnalyticsAction
mkIotAnalyticsAction
  = IotAnalyticsAction'{batchMode = Core.Nothing,
                        channelArn = Core.Nothing, channelName = Core.Nothing,
...
instance Core.FromJSON IotAnalyticsAction where
        parseJSON
          = Core.withObject "IotAnalyticsAction" Core.$
              \ x ->
                IotAnalyticsAction' Core.<$>
                  (x Core..:? "batchMode") Core.<*> x Core..:? "channelArn" Core.<*>
                    x Core..:? "channelName"
                    Core.<*> x Core..:? "roleArn"
