...
--
-- * 'tgiTransactItems' - An ordered array of up to 25 @TransactGetItem@ objects, each of which contains a @Get@ structure.
transactGetItems ::
  -- | 'tgiTransactItems'
...
instance Hashable TransactGetItems

instance NFData TransactGetItems
...
instance ToJSON TransactGetItems where
  toJSON TransactGetItems' {..} =
    object
      ( catMaybes
          [ ("ReturnConsumedCapacity" .=) <$> _tgiReturnConsumedCapacity,
...
instance NFData TransactGetItemsResponse
