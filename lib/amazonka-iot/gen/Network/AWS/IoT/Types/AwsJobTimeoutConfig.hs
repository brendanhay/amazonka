...
-- | Creates a 'AwsJobTimeoutConfig' value with any optional fields omitted.
mkAwsJobTimeoutConfig
    :: AwsJobTimeoutConfig
mkAwsJobTimeoutConfig
  = AwsJobTimeoutConfig'{inProgressTimeoutInMinutes = Core.Nothing}
...
ajtcInProgressTimeoutInMinutes :: Lens.Lens' AwsJobTimeoutConfig (Core.Maybe Core.Integer)
ajtcInProgressTimeoutInMinutes = Lens.field @"inProgressTimeoutInMinutes"
{-# INLINEABLE ajtcInProgressTimeoutInMinutes #-}
{-# DEPRECATED inProgressTimeoutInMinutes "Use generic-lens or generic-optics with 'inProgressTimeoutInMinutes' instead"  #-}

instance Core.FromJSON AwsJobTimeoutConfig where
