...
newtype DeleteConferenceProvider = DeleteConferenceProvider'
  { _dcpConferenceProviderARN :: Text
...
deleteConferenceProvider
    :: Text -- ^ 'dcpConferenceProviderARN'
    -> DeleteConferenceProvider
deleteConferenceProvider pConferenceProviderARN_ =
  DeleteConferenceProvider'
    {_dcpConferenceProviderARN = pConferenceProviderARN_}
...
instance AWSRequest DeleteConferenceProvider where
        type Rs DeleteConferenceProvider =
             DeleteConferenceProviderResponse
...
instance Hashable DeleteConferenceProvider where

instance NFData DeleteConferenceProvider where
...
deleteConferenceProviderResponse pResponseStatus_ =
  DeleteConferenceProviderResponse' {_dcprsResponseStatus = pResponseStatus_}
