...
{-# INLINEABLE ltimorHttpPutResponseHopLimit #-}
...
{-# INLINEABLE ltimorHttpTokens #-}
{-# DEPRECATED httpTokens "Use generic-lens or generic-optics with 'httpTokens' instead"  #-}

instance Core.ToQuery LaunchTemplateInstanceMetadataOptionsRequest
         where
