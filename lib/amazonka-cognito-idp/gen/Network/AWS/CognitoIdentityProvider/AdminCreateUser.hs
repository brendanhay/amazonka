    ...
    object
      ( catMaybes
          [ ("ClientMetadata" .=) <$> _acuClientMetadata,
            ...
            ("DesiredDeliveryMediums" .=) <$> _acuDesiredDeliveryMediums,
