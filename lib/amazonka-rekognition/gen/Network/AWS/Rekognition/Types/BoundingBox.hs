...
mkBoundingBox
    :: BoundingBox
mkBoundingBox
  = BoundingBox'{height = Core.Nothing, left = Core.Nothing,
                 top = Core.Nothing, width = Core.Nothing}
...
{-# INLINEABLE bbLeft #-}
{-# DEPRECATED left "Use generic-lens or generic-optics with 'left' instead"  #-}
...
{-# INLINEABLE bbTop #-}
{-# DEPRECATED top "Use generic-lens or generic-optics with 'top' instead"  #-}
...
instance Core.FromJSON BoundingBox where
        parseJSON
          = Core.withObject "BoundingBox" Core.$
              \ x ->
                BoundingBox' Core.<$>
                  (x Core..:? "Height") Core.<*> x Core..:? "Left" Core.<*>
                    x Core..:? "Top"
                    Core.<*> x Core..:? "Width"
