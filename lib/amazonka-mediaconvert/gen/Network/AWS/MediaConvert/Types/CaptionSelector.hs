...
mkCaptionSelector
    :: CaptionSelector
mkCaptionSelector
  = CaptionSelector'{customLanguageCode = Core.Nothing,
                     languageCode = Core.Nothing, sourceSettings = Core.Nothing}
...
{-# INLINEABLE csCustomLanguageCode #-}
...
{-# INLINEABLE csSourceSettings #-}
{-# DEPRECATED sourceSettings "Use generic-lens or generic-optics with 'sourceSettings' instead"  #-}
