...
newtype UpdateEmergencyContactSettings = UpdateEmergencyContactSettings'
  { _uecsEmergencyContactList :: Maybe [EmergencyContact]
...
--
-- * 'uecsEmergencyContactList' - A list of email addresses that the DRT can use to contact you during a suspected attack.
updateEmergencyContactSettings
    :: UpdateEmergencyContactSettings
updateEmergencyContactSettings =
  UpdateEmergencyContactSettings' {_uecsEmergencyContactList = Nothing}
...
updateEmergencyContactSettingsResponse pResponseStatus_ =
  UpdateEmergencyContactSettingsResponse'
    {_uecsrsResponseStatus = pResponseStatus_}
