...
{-# INLINEABLE atcDefaultTaskHeartbeatTimeout #-}
...
{-# INLINEABLE atcDefaultTaskPriority #-}
...
{-# INLINEABLE atcDefaultTaskScheduleToCloseTimeout #-}
...
{-# INLINEABLE atcDefaultTaskScheduleToStartTimeout #-}
...
{-# INLINEABLE atcDefaultTaskStartToCloseTimeout #-}
...
instance Core.FromJSON ActivityTypeConfiguration where
        parseJSON
          = Core.withObject "ActivityTypeConfiguration" Core.$
              \ x ->
                ActivityTypeConfiguration' Core.<$>
                  (x Core..:? "defaultTaskHeartbeatTimeout") Core.<*>
                    x Core..:? "defaultTaskList"
