...
mkUpdateQualificationType qualificationTypeId
  = UpdateQualificationType'{qualificationTypeId,
                             answerKey = Core.Nothing, autoGranted = Core.Nothing,
                             autoGrantedValue = Core.Nothing, description = Core.Nothing,
...
{-# INLINEABLE uqtQualificationTypeId #-}
...
uqtAnswerKey :: Lens.Lens' UpdateQualificationType (Core.Maybe Core.Text)
uqtAnswerKey = Lens.field @"answerKey"
{-# INLINEABLE uqtAnswerKey #-}
...
{-# INLINEABLE uqtAutoGrantedValue #-}
...
uqtDescription :: Lens.Lens' UpdateQualificationType (Core.Maybe Core.Text)
uqtDescription = Lens.field @"description"
{-# INLINEABLE uqtDescription #-}
...
{-# INLINEABLE uqtQualificationTypeStatus #-}
...
{-# INLINEABLE uqtRetryDelayInSeconds #-}
...
uqtTest :: Lens.Lens' UpdateQualificationType (Core.Maybe Core.Text)
...
{-# INLINEABLE uqtTestDurationInSeconds #-}
...
instance Core.ToHeaders UpdateQualificationType where
        toHeaders UpdateQualificationType{..}
          = Core.pure
              ("X-Amz-Target",
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("QualificationTypeId" Core..= qualificationTypeId),
                  ...
                  ("QualificationTypeStatus" Core..=) Core.<$>
...
instance Core.AWSRequest UpdateQualificationType where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateQualificationTypeResponse' Core.<$>
...
mkUpdateQualificationTypeResponse responseStatus
  = UpdateQualificationTypeResponse'{qualificationType =
                                       Core.Nothing,
                                     responseStatus}
...
{-# INLINEABLE uqtrrsQualificationType #-}
...
{-# INLINEABLE uqtrrsResponseStatus #-}
