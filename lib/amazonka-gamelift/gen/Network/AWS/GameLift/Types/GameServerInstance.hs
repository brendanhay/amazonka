...
mkGameServerInstance
    :: GameServerInstance
mkGameServerInstance
  = GameServerInstance'{gameServerGroupArn = Core.Nothing,
                        gameServerGroupName = Core.Nothing, instanceId = Core.Nothing,
...
{-# INLINEABLE gsiGameServerGroupArn #-}
...
{-# INLINEABLE gsiGameServerGroupName #-}
...
instance Core.FromJSON GameServerInstance where
        parseJSON
          = Core.withObject "GameServerInstance" Core.$
              \ x ->
                GameServerInstance' Core.<$>
                  (x Core..:? "GameServerGroupArn") Core.<*>
                    x Core..:? "GameServerGroupName"
