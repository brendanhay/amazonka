...
{-# INLINEABLE dbacExpectedBucketOwner #-}
{-# DEPRECATED expectedBucketOwner "Use generic-lens or generic-optics with 'expectedBucketOwner' instead"  #-}

instance Core.ToQuery DeleteBucketAnalyticsConfiguration where
        toQuery DeleteBucketAnalyticsConfiguration{..}
          = Core.toQueryPair "id" id Core.<>
              Core.toQueryPair "analytics" ("" :: Core.Text)

instance Core.ToHeaders DeleteBucketAnalyticsConfiguration where
