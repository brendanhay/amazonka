...
-- |
-- Module      : Amazonka.DataSync.Types.RecommendationStatus
...
pattern RecommendationStatus_NONE :: RecommendationStatus
pattern RecommendationStatus_NONE = RecommendationStatus' "NONE"
