...
mkCacheClusterAvailable
  = Waiter.Wait{Waiter._waitName = "CacheClusterAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"cacheClusters" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"cacheClusterStatus" Core.. Lens._Just),
                     ...
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"cacheClusters" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"cacheClusterStatus" Core.. Lens._Just),
                   Waiter.matchAny "restore-failed" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"cacheClusters" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkCacheClusterDeleted
  = Waiter.Wait{Waiter._waitName = "CacheClusterDeleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                     ...
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"cacheClusters" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"cacheClusterStatus" Core.. Lens._Just),
                   Waiter.matchAny "snapshotting" Waiter.AcceptFailure
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"cacheClusters" Core.. Lens._Just Core..
                              Lens.to Core.toList))
...
mkReplicationGroupDeleted
  = Waiter.Wait{Waiter._waitName = "ReplicationGroupDeleted",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "deleted" Waiter.AcceptSuccess
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationGroups" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                     ...
                     (Lens.folding
                        (Lens.concatOf
                           (Lens.field @"replicationGroups" Core.. Lens._Just Core..
                              Lens.to Core.toList))
                        Core.. Lens.field @"status" Core.. Lens._Just),
                   Waiter.matchError "ReplicationGroupNotFoundFault"
                     Waiter.AcceptSuccess]}

-- | Polls 'Network.AWS.ElastiCache.DescribeReplicationGroups' every 15 seconds until a successful state is reached. An error is returned after 40 failed checks.
mkReplicationGroupAvailable :: Waiter.Wait DescribeReplicationGroups
mkReplicationGroupAvailable
  = Waiter.Wait{Waiter._waitName = "ReplicationGroupAvailable",
                Waiter._waitAttempts = 40, Waiter._waitDelay = 15,
                Waiter._waitAcceptors =
                  [Waiter.matchAll "available" Waiter.AcceptSuccess
                     (Lens.folding
