      ...
      { Core._rqService = Types.mkServiceConfig,
        ...
        Core._rqQuery =
          Core.toQueryValue "maxitems" Core.<$> maxItems
            Core.<> (Core.toQueryValue "identifier" Core.<$> startRecordIdentifier)
            Core.<> (Core.toQueryValue "name" Core.<$> startRecordName)
            Core.<> (Core.toQueryValue "type" Core.<$> startRecordType),
...
instance Pager.AWSPager ListResourceRecordSets where
  page rq rs
    ...
    | Core.isNothing (rs Lens.^. Lens.field @"nextRecordName")
        Core.&& Core.isNothing (rs Lens.^. Lens.field @"nextRecordType")
        Core.&& Core.isNothing (rs Lens.^. Lens.field @"nextRecordIdentifier") =
      Core.Nothing
    | Core.otherwise =
      Core.Just
        ( rq
            Core.& Lens.field @"startRecordName"
            Lens..~ rs Lens.^. Lens.field @"nextRecordName"
            Core.& Lens.field @"startRecordType"
            Lens..~ rs Lens.^. Lens.field @"nextRecordType"
            Core.& Lens.field @"startRecordIdentifier"
            Lens..~ rs Lens.^. Lens.field @"nextRecordIdentifier"
        )
...
{-# DEPRECATED lrrsrrsResourceRecordSets "Use generic-lens or generic-optics with 'resourceRecordSets' instead." #-}
...
{-# DEPRECATED lrrsrrsIsTruncated "Use generic-lens or generic-optics with 'isTruncated' instead." #-}
...
{-# DEPRECATED lrrsrrsMaxItems "Use generic-lens or generic-optics with 'maxItems' instead." #-}
...
{-# DEPRECATED lrrsrrsNextRecordIdentifier "Use generic-lens or generic-optics with 'nextRecordIdentifier' instead." #-}
...
{-# DEPRECATED lrrsrrsNextRecordName "Use generic-lens or generic-optics with 'nextRecordName' instead." #-}
...
{-# DEPRECATED lrrsrrsNextRecordType "Use generic-lens or generic-optics with 'nextRecordType' instead." #-}
