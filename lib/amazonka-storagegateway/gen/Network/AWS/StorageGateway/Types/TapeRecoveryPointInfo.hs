...
mkTapeRecoveryPointInfo
    :: TapeRecoveryPointInfo
mkTapeRecoveryPointInfo
  = TapeRecoveryPointInfo'{tapeARN = Core.Nothing,
...
{-# INLINEABLE trpiTapeRecoveryPointTime #-}
{-# DEPRECATED tapeRecoveryPointTime "Use generic-lens or generic-optics with 'tapeRecoveryPointTime' instead"  #-}
...
{-# INLINEABLE trpiTapeSizeInBytes #-}
...
instance Core.FromJSON TapeRecoveryPointInfo where
        parseJSON
          = Core.withObject "TapeRecoveryPointInfo" Core.$
              \ x ->
                TapeRecoveryPointInfo' Core.<$>
                  (x Core..:? "TapeARN") Core.<*> x Core..:? "TapeRecoveryPointTime"
