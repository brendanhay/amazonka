...
mkListBuildBatches
    :: ListBuildBatches
mkListBuildBatches
  = ListBuildBatches'{filter = Core.Nothing,
...
{-# INLINEABLE lbbMaxResults #-}
{-# DEPRECATED maxResults "Use generic-lens or generic-optics with 'maxResults' instead"  #-}

-- | The @nextToken@ value returned from a previous call to @ListBuildBatches@ . This specifies the next item to return. To return the beginning of the list, exclude this parameter.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
lbbNextToken :: Lens.Lens' ListBuildBatches (Core.Maybe Core.Text)
lbbNextToken = Lens.field @"nextToken"
{-# INLINEABLE lbbNextToken #-}
...
mkListBuildBatchesResponse responseStatus
  = ListBuildBatchesResponse'{ids = Core.Nothing,
...
{-# INLINEABLE lbbrrsIds #-}
{-# DEPRECATED ids "Use generic-lens or generic-optics with 'ids' instead"  #-}

-- | If there are more items to return, this contains a token that is passed to a subsequent call to @ListBuildBatches@ to retrieve the next set of items.
--
-- /Note:/ Consider using 'nextToken' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
lbbrrsNextToken :: Lens.Lens' ListBuildBatchesResponse (Core.Maybe Core.Text)
lbbrrsNextToken = Lens.field @"nextToken"
{-# INLINEABLE lbbrrsNextToken #-}
{-# DEPRECATED nextToken "Use generic-lens or generic-optics with 'nextToken' instead"  #-}
...
{-# INLINEABLE lbbrrsResponseStatus #-}
