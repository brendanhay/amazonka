...
mkPartnerEventSourceAccount
    :: PartnerEventSourceAccount
mkPartnerEventSourceAccount
  = PartnerEventSourceAccount'{account = Core.Nothing,
...
instance Core.FromJSON PartnerEventSourceAccount where
        parseJSON
          = Core.withObject "PartnerEventSourceAccount" Core.$
              \ x ->
                PartnerEventSourceAccount' Core.<$>
                  (x Core..:? "Account") Core.<*> x Core..:? "CreationTime" Core.<*>
