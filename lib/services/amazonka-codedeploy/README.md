...
`2.0` - Derived from API version @2014-10-06@ of the AWS service descriptions, licensed under Apache 2.0.
...
See [Amazonka.CodeDeploy](http://hackage.haskell.org/package/amazonka-codedeploy/docs/Amazonka-CodeDeploy.html)
