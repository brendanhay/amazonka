...
mkUpdateSamplingRule
    :: Types.SamplingRuleUpdate -- ^ 'samplingRuleUpdate'
    -> UpdateSamplingRule
...
{-# INLINEABLE usrSamplingRuleUpdate #-}
{-# DEPRECATED samplingRuleUpdate "Use generic-lens or generic-optics with 'samplingRuleUpdate' instead"  #-}
...
instance Core.AWSRequest UpdateSamplingRule where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/UpdateSamplingRule",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 UpdateSamplingRuleResponse' Core.<$>
...
mkUpdateSamplingRuleResponse responseStatus
  = UpdateSamplingRuleResponse'{samplingRuleRecord = Core.Nothing,
                                responseStatus}
...
{-# INLINEABLE usrrrsSamplingRuleRecord #-}
...
{-# INLINEABLE usrrrsResponseStatus #-}
