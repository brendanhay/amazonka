...
import Network.AWS.Pricing.Types.FormatVersion
import Network.AWS.Pricing.Types.NextToken
import Network.AWS.Pricing.Types.PriceListItemJSON
import Network.AWS.Pricing.Types.PricingService
import Network.AWS.Pricing.Types.String
import Network.AWS.Pricing.Types.Value
...
mkServiceConfig =
  Core.Service
    { Core._svcAbbrev = "Pricing",
      Core._svcSigner = Sign.v4,
      Core._svcPrefix = "api.pricing",
      Core._svcVersion = "2017-10-15",
