...
mkDescribeAffectedEntities
    :: Types.EntityFilter -- ^ 'filter'
    -> DescribeAffectedEntities
mkDescribeAffectedEntities filter
  = DescribeAffectedEntities'{filter, locale = Core.Nothing,
...
instance Core.AWSRequest DescribeAffectedEntities where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeAffectedEntitiesResponse' Core.<$>
...
mkDescribeAffectedEntitiesResponse responseStatus
  = DescribeAffectedEntitiesResponse'{entities = Core.Nothing,
