...
-- |
-- Module      : Amazonka.PaymentCryptography.UntagResource
...
--
-- 'resourceArn', 'untagResource_resourceArn' - The @KeyARN@ of the key whose tags are being removed.
--
-- 'tagKeys', 'untagResource_tagKeys' - One or more tag keys. Don\'t include the tag values.
--
-- If the Amazon Web Services Payment Cryptography key doesn\'t have the
-- specified tag key, Amazon Web Services Payment Cryptography doesn\'t
-- throw an exception or return a response. To confirm that the operation
...
instance Data.ToHeaders UntagResource where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Data.=# ( "PaymentCryptographyControlPlane.UntagResource" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
