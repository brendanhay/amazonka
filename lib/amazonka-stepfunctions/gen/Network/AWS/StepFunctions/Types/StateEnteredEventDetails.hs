...
{-# DEPRECATED seedInput "Use generic-lens or generic-optics with 'input' instead." #-}
...
{-# DEPRECATED seedInputDetails "Use generic-lens or generic-optics with 'inputDetails' instead." #-}
