...
mkLogConfig
    :: Types.FieldLogLevel -- ^ 'fieldLogLevel'
    -> Core.Text -- ^ 'cloudWatchLogsRoleArn'
    -> LogConfig
mkLogConfig fieldLogLevel cloudWatchLogsRoleArn
  = LogConfig'{fieldLogLevel, cloudWatchLogsRoleArn,
...
{-# INLINEABLE lcFieldLogLevel #-}
{-# DEPRECATED fieldLogLevel "Use generic-lens or generic-optics with 'fieldLogLevel' instead"  #-}
...
lcCloudWatchLogsRoleArn :: Lens.Lens' LogConfig Core.Text
lcCloudWatchLogsRoleArn = Lens.field @"cloudWatchLogsRoleArn"
{-# INLINEABLE lcCloudWatchLogsRoleArn #-}
...
{-# INLINEABLE lcExcludeVerboseContent #-}
{-# DEPRECATED excludeVerboseContent "Use generic-lens or generic-optics with 'excludeVerboseContent' instead"  #-}
