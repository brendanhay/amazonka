...
mkUpdateAuditSuppression checkName resourceIdentifier
  = UpdateAuditSuppression'{checkName, resourceIdentifier,
...
{-# INLINEABLE uasResourceIdentifier #-}
...
{-# INLINEABLE uasSuppressIndefinitely #-}
...
instance Core.AWSRequest UpdateAuditSuppression where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/audit/suppressions/update",
        ...
        parseResponse
          = Response.receiveEmpty
              (\ s h x ->
                 UpdateAuditSuppressionResponse' Core.<$>
