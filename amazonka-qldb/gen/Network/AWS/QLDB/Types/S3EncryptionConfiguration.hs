...
instance Prelude.FromJSON S3EncryptionConfiguration where
  parseJSON =
    Prelude.withObject
      "S3EncryptionConfiguration"
      ( \x ->
          S3EncryptionConfiguration'
            ...
            Prelude.<*> (x Prelude..: "ObjectEncryptionType")
      )
...
instance Prelude.ToJSON S3EncryptionConfiguration where
