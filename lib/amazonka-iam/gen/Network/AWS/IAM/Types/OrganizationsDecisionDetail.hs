...
{-# INLINEABLE oddAllowedByOrganizations #-}
{-# DEPRECATED allowedByOrganizations "Use generic-lens or generic-optics with 'allowedByOrganizations' instead"  #-}

instance Core.FromXML OrganizationsDecisionDetail where
        parseXML x
          = OrganizationsDecisionDetail' Core.<$>
              (x Core..@? "AllowedByOrganizations")
