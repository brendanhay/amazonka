...
mkContainerOverrides
    :: ContainerOverrides
mkContainerOverrides
  = ContainerOverrides'{command = Core.Nothing,
                        environment = Core.Nothing, instanceType = Core.Nothing,
                        memory = Core.Nothing, resourceRequirements = Core.Nothing,
                        vcpus = Core.Nothing}
...
coCommand :: Lens.Lens' ContainerOverrides (Core.Maybe [Core.Text])
...
coInstanceType :: Lens.Lens' ContainerOverrides (Core.Maybe Core.Text)
coInstanceType = Lens.field @"instanceType"
{-# INLINEABLE coInstanceType #-}
