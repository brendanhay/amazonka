...
mkSendBounce
    :: Types.OriginalMessageId -- ^ 'originalMessageId'
    -> Types.BounceSender -- ^ 'bounceSender'
    -> SendBounce
mkSendBounce originalMessageId bounceSender
  = SendBounce'{originalMessageId, bounceSender,
                bouncedRecipientInfoList = Core.mempty,
                bounceSenderArn = Core.Nothing, explanation = Core.Nothing,
...
{-# INLINEABLE sbOriginalMessageId #-}
{-# DEPRECATED originalMessageId "Use generic-lens or generic-optics with 'originalMessageId' instead"  #-}
...
{-# INLINEABLE sbBounceSender #-}
{-# DEPRECATED bounceSender "Use generic-lens or generic-optics with 'bounceSender' instead"  #-}
...
{-# INLINEABLE sbBouncedRecipientInfoList #-}
{-# DEPRECATED bouncedRecipientInfoList "Use generic-lens or generic-optics with 'bouncedRecipientInfoList' instead"  #-}
...
{-# INLINEABLE sbBounceSenderArn #-}
{-# DEPRECATED bounceSenderArn "Use generic-lens or generic-optics with 'bounceSenderArn' instead"  #-}
...
{-# INLINEABLE sbExplanation #-}
{-# DEPRECATED explanation "Use generic-lens or generic-optics with 'explanation' instead"  #-}
...
{-# INLINEABLE sbMessageDsn #-}
{-# DEPRECATED messageDsn "Use generic-lens or generic-optics with 'messageDsn' instead"  #-}

instance Core.ToQuery SendBounce where
        toQuery SendBounce{..}
          = Core.toQueryPair "Action" ("SendBounce" :: Core.Text) Core.<>
              Core.toQueryPair "Version" ("2010-12-01" :: Core.Text)
              Core.<> Core.toQueryPair "OriginalMessageId" originalMessageId
              Core.<> Core.toQueryPair "BounceSender" bounceSender
              Core.<>
              Core.toQueryPair "BouncedRecipientInfoList"
                (Core.toQueryList "member" bouncedRecipientInfoList)
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "BounceSenderArn")
                bounceSenderArn
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "Explanation") explanation
              Core.<>
              Core.maybe Core.mempty (Core.toQueryPair "MessageDsn") messageDsn
...
instance Core.AWSRequest SendBounce where
        ...
        {-# INLINE toRequest #-}
        parseResponse
          = Response.receiveXMLWrapper "SendBounceResult"
              (\ s h x ->
                 SendBounceResponse' Core.<$>
