...
--
-- 'failureCode', 'layerFailure_failureCode' - The failure code that\'s associated with the failure.
--
-- 'failureReason', 'layerFailure_failureReason' - The reason for the failure.
--
-- 'layerDigest', 'layerFailure_layerDigest' - The layer digest that\'s associated with the failure.
newLayerFailure ::
  LayerFailure
newLayerFailure =
  LayerFailure'
