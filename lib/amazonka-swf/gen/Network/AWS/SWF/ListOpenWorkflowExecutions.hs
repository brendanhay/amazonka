...
{-# INLINEABLE loweStartTimeFilter #-}
...
{-# INLINEABLE loweExecutionFilter #-}
...
{-# INLINEABLE loweMaximumPageSize #-}
...
instance Core.ToHeaders ListOpenWorkflowExecutions where
        toHeaders ListOpenWorkflowExecutions{..}
          = Core.pure
              ("X-Amz-Target",
