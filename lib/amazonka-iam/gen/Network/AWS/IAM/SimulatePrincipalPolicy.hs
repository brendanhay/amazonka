...
instance ToQuery SimulatePrincipalPolicy where
  toQuery SimulatePrincipalPolicy' {..} =
    mconcat
      [ "Action" =: ("SimulatePrincipalPolicy" :: ByteString),
        "Version" =: ("2010-05-08" :: ByteString),
        "PolicyInputList"
          =: toQuery (toQueryList "member" <$> _sppPolicyInputList),
        "ResourcePolicy" =: _sppResourcePolicy,
        "CallerArn" =: _sppCallerARN,
        "ResourceHandlingOption" =: _sppResourceHandlingOption,
        "ResourceArns"
          =: toQuery (toQueryList "member" <$> _sppResourceARNs),
        "PermissionsBoundaryPolicyInputList"
          =: toQuery
            (toQueryList "member" <$> _sppPermissionsBoundaryPolicyInputList),
        "Marker" =: _sppMarker,
        "MaxItems" =: _sppMaxItems,
        "ContextEntries"
          =: toQuery (toQueryList "member" <$> _sppContextEntries),
        "ResourceOwner" =: _sppResourceOwner,
        "PolicySourceArn" =: _sppPolicySourceARN,
        "ActionNames" =: toQueryList "member" _sppActionNames
      ]
