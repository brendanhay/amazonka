...
-- | The activityId provided in the @RequestCancelActivityTask@ decision that
-- failed.
requestCancelActivityTaskFailedEventAttributes_activityId :: Lens.Lens' RequestCancelActivityTaskFailedEventAttributes Core.Text
...
-- diagnosing problems by tracing back the chain of events leading up to
-- this event.
requestCancelActivityTaskFailedEventAttributes_decisionTaskCompletedEventId :: Lens.Lens' RequestCancelActivityTaskFailedEventAttributes Core.Integer
...
instance
  ...
  parseJSON =
    Core.withObject
      ...
      ( \x ->
          RequestCancelActivityTaskFailedEventAttributes'
            Core.<$> (x Core..: "activityId") Core.<*> (x Core..: "cause")
