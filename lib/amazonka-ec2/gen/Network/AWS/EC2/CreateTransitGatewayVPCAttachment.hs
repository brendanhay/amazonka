...
instance ToQuery CreateTransitGatewayVPCAttachment where
  toQuery CreateTransitGatewayVPCAttachment' {..} =
    mconcat
      [ "Action" =: ("CreateTransitGatewayVpcAttachment" :: ByteString),
        "Version" =: ("2016-11-15" :: ByteString),
        toQuery
          (toQueryList "TagSpecifications" <$> _ctgvaTagSpecifications),
...
data CreateTransitGatewayVPCAttachmentResponse = CreateTransitGatewayVPCAttachmentResponse'
  { _ctgvarsTransitGatewayVPCAttachment ::
      !( Maybe
...
instance NFData CreateTransitGatewayVPCAttachmentResponse
