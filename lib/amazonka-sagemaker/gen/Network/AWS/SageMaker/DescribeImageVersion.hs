...
instance Core.ToHeaders DescribeImageVersion where
        toHeaders DescribeImageVersion{..}
...
instance Core.AWSRequest DescribeImageVersion where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeImageVersionResponse' Core.<$>
                   (x Core..:? "BaseImage") Core.<*> x Core..:? "ContainerImage"
...
mkDescribeImageVersionResponse responseStatus
  = DescribeImageVersionResponse'{baseImage = Core.Nothing,
                                  containerImage = Core.Nothing, creationTime = Core.Nothing,
                                  failureReason = Core.Nothing, imageArn = Core.Nothing,
                                  imageVersionArn = Core.Nothing, imageVersionStatus = Core.Nothing,
                                  lastModifiedTime = Core.Nothing, version = Core.Nothing,
                                  responseStatus}
...
{-# INLINEABLE divrfrsContainerImage #-}
...
{-# INLINEABLE divrfrsCreationTime #-}
...
{-# INLINEABLE divrfrsFailureReason #-}
...
{-# INLINEABLE divrfrsImageVersionArn #-}
...
{-# INLINEABLE divrfrsImageVersionStatus #-}
...
{-# INLINEABLE divrfrsLastModifiedTime #-}
...
{-# INLINEABLE divrfrsResponseStatus #-}
