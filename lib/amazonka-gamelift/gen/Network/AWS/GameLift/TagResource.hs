...
-- * 'tags' - A list of one or more tags to assign to the specified GameLift resource. Tags are developer-defined and structured as key-value pairs. The maximum tag limit may be lower than stated. See <https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html Tagging AWS Resources> for actual tagging limits.
mkTagResource ::
  -- | 'resourceARN'
  Lude.Text ->
  TagResource
...
instance Lude.ToHeaders TagResource where
  toHeaders =
    Lude.const
      ( Lude.mconcat
          [ "X-Amz-Target"
              Lude.=# ("GameLift.TagResource" :: Lude.ByteString),
            "Content-Type"
