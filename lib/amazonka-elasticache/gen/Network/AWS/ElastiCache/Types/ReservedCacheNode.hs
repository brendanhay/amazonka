...
mkReservedCacheNode
    :: ReservedCacheNode
mkReservedCacheNode
  = ReservedCacheNode'{cacheNodeCount = Core.Nothing,
                       cacheNodeType = Core.Nothing, duration = Core.Nothing,
                       fixedPrice = Core.Nothing, offeringType = Core.Nothing,
                       productDescription = Core.Nothing, recurringCharges = Core.Nothing,
                       reservationARN = Core.Nothing, reservedCacheNodeId = Core.Nothing,
...
rcnCacheNodeType :: Lens.Lens' ReservedCacheNode (Core.Maybe Core.Text)
rcnCacheNodeType = Lens.field @"cacheNodeType"
{-# INLINEABLE rcnCacheNodeType #-}
...
rcnProductDescription :: Lens.Lens' ReservedCacheNode (Core.Maybe Core.Text)
rcnProductDescription = Lens.field @"productDescription"
{-# INLINEABLE rcnProductDescription #-}
...
{-# INLINEABLE rcnRecurringCharges #-}
...
rcnReservationARN :: Lens.Lens' ReservedCacheNode (Core.Maybe Core.Text)
rcnReservationARN = Lens.field @"reservationARN"
{-# INLINEABLE rcnReservationARN #-}
{-# DEPRECATED reservationARN "Use generic-lens or generic-optics with 'reservationARN' instead"  #-}
...
rcnReservedCacheNodeId :: Lens.Lens' ReservedCacheNode (Core.Maybe Core.Text)
rcnReservedCacheNodeId = Lens.field @"reservedCacheNodeId"
{-# INLINEABLE rcnReservedCacheNodeId #-}
...
rcnReservedCacheNodesOfferingId :: Lens.Lens' ReservedCacheNode (Core.Maybe Core.Text)
rcnReservedCacheNodesOfferingId = Lens.field @"reservedCacheNodesOfferingId"
{-# INLINEABLE rcnReservedCacheNodesOfferingId #-}
...
{-# INLINEABLE rcnStartTime #-}
{-# DEPRECATED startTime "Use generic-lens or generic-optics with 'startTime' instead"  #-}

-- | The state of the reserved cache node.
--
-- /Note:/ Consider using 'state' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
rcnState :: Lens.Lens' ReservedCacheNode (Core.Maybe Core.Text)
...
instance Core.FromXML ReservedCacheNode where
        parseXML x
          = ReservedCacheNode' Core.<$>
              (x Core..@? "CacheNodeCount") Core.<*> x Core..@? "CacheNodeType"
