...
mkAction
    :: Action
mkAction
  = Action'{cloudwatchAlarm = Core.Nothing,
            cloudwatchLogs = Core.Nothing, cloudwatchMetric = Core.Nothing,
            dynamoDB = Core.Nothing, dynamoDBv2 = Core.Nothing,
            elasticsearch = Core.Nothing, firehose = Core.Nothing,
            http = Core.Nothing, iotAnalytics = Core.Nothing,
            iotEvents = Core.Nothing, iotSiteWise = Core.Nothing,
            kinesis = Core.Nothing, lambda = Core.Nothing,
            republish = Core.Nothing, s3 = Core.Nothing,
            salesforce = Core.Nothing, sns = Core.Nothing, sqs = Core.Nothing,
            stepFunctions = Core.Nothing, timestream = Core.Nothing}
...
{-# INLINEABLE aCloudwatchAlarm #-}
{-# DEPRECATED cloudwatchAlarm "Use generic-lens or generic-optics with 'cloudwatchAlarm' instead"  #-}
...
{-# INLINEABLE aCloudwatchMetric #-}
{-# DEPRECATED cloudwatchMetric "Use generic-lens or generic-optics with 'cloudwatchMetric' instead"  #-}
...
{-# INLINEABLE aDynamoDBv2 #-}
{-# DEPRECATED dynamoDBv2 "Use generic-lens or generic-optics with 'dynamoDBv2' instead"  #-}
...
{-# INLINEABLE aElasticsearch #-}
{-# DEPRECATED elasticsearch "Use generic-lens or generic-optics with 'elasticsearch' instead"  #-}
...
{-# INLINEABLE aFirehose #-}
{-# DEPRECATED firehose "Use generic-lens or generic-optics with 'firehose' instead"  #-}
...
{-# INLINEABLE aIotAnalytics #-}
{-# DEPRECATED iotAnalytics "Use generic-lens or generic-optics with 'iotAnalytics' instead"  #-}
...
{-# INLINEABLE aIotEvents #-}
{-# DEPRECATED iotEvents "Use generic-lens or generic-optics with 'iotEvents' instead"  #-}
...
{-# INLINEABLE aIotSiteWise #-}
{-# DEPRECATED iotSiteWise "Use generic-lens or generic-optics with 'iotSiteWise' instead"  #-}
...
{-# INLINEABLE aKinesis #-}
{-# DEPRECATED kinesis "Use generic-lens or generic-optics with 'kinesis' instead"  #-}
...
{-# INLINEABLE aRepublish #-}
{-# DEPRECATED republish "Use generic-lens or generic-optics with 'republish' instead"  #-}
...
{-# INLINEABLE aSalesforce #-}
{-# DEPRECATED salesforce "Use generic-lens or generic-optics with 'salesforce' instead"  #-}
...
aSns = Lens.field @"sns"
{-# INLINEABLE aSns #-}
{-# DEPRECATED sns "Use generic-lens or generic-optics with 'sns' instead"  #-}
...
aSqs = Lens.field @"sqs"
{-# INLINEABLE aSqs #-}
{-# DEPRECATED sqs "Use generic-lens or generic-optics with 'sqs' instead"  #-}
...
{-# INLINEABLE aStepFunctions #-}
{-# DEPRECATED stepFunctions "Use generic-lens or generic-optics with 'stepFunctions' instead"  #-}
...
{-# INLINEABLE aTimestream #-}
{-# DEPRECATED timestream "Use generic-lens or generic-optics with 'timestream' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudwatchAlarm" Core..=) Core.<$> cloudwatchAlarm,
                  ...
                  ("sns" Core..=) Core.<$> sns, ("sqs" Core..=) Core.<$> sqs,
...
instance Core.FromJSON Action where
        parseJSON
          = Core.withObject "Action" Core.$
              \ x ->
                Action' Core.<$>
                  (x Core..:? "cloudwatchAlarm") Core.<*> x Core..:? "cloudwatchLogs"
