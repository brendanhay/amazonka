...
describeServiceAction pId_ =
  DescribeServiceAction' {_dsaAcceptLanguage = Nothing, _dsaId = pId_}
...
instance Hashable DescribeServiceAction where

instance NFData DescribeServiceAction where
...
data DescribeServiceActionResponse = DescribeServiceActionResponse'
  { _dsarsServiceActionDetail :: !(Maybe ServiceActionDetail)
...
describeServiceActionResponse pResponseStatus_ =
  DescribeServiceActionResponse'
    { _dsarsServiceActionDetail = Nothing
...
instance NFData DescribeServiceActionResponse where
