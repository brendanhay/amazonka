...
{-# INLINEABLE aorAutoSnapshotAddOnRequest #-}
{-# DEPRECATED autoSnapshotAddOnRequest "Use generic-lens or generic-optics with 'autoSnapshotAddOnRequest' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("addOnType" Core..= addOnType),
                  ("autoSnapshotAddOnRequest" Core..=) Core.<$>
