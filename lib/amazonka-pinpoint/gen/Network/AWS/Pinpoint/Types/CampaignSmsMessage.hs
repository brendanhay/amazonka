...
mkCampaignSmsMessage
    :: CampaignSmsMessage
mkCampaignSmsMessage
  = CampaignSmsMessage'{body = Core.Nothing,
                        messageType = Core.Nothing, senderId = Core.Nothing}
...
instance Core.FromJSON CampaignSmsMessage where
        parseJSON
          = Core.withObject "CampaignSmsMessage" Core.$
              \ x ->
                CampaignSmsMessage' Core.<$>
                  (x Core..:? "Body") Core.<*> x Core..:? "MessageType" Core.<*>
                    x Core..:? "SenderId"
