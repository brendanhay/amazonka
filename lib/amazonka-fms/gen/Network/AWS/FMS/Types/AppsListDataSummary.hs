...
mkAppsListDataSummary
    :: AppsListDataSummary
mkAppsListDataSummary
  = AppsListDataSummary'{appsList = Core.Nothing,
                         listArn = Core.Nothing, listId = Core.Nothing,
...
instance Core.FromJSON AppsListDataSummary where
        parseJSON
          = Core.withObject "AppsListDataSummary" Core.$
              \ x ->
                AppsListDataSummary' Core.<$>
                  (x Core..:? "AppsList") Core.<*> x Core..:? "ListArn" Core.<*>
                    x Core..:? "ListId"
