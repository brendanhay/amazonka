...
-- This information is for the AWS CodeBuild console's use only. Your code should not get or set this information directly.
  ...
  , buildspec :: Core.Maybe Core.Text
...
mkProjectSource type'
  = ProjectSource'{type', auth = Core.Nothing,
                   buildStatusConfig = Core.Nothing, buildspec = Core.Nothing,
                   gitCloneDepth = Core.Nothing, gitSubmodulesConfig = Core.Nothing,
                   insecureSsl = Core.Nothing, location = Core.Nothing,
                   reportBuildStatus = Core.Nothing, sourceIdentifier = Core.Nothing}
...
{-# INLINEABLE psBuildStatusConfig #-}
{-# DEPRECATED buildStatusConfig "Use generic-lens or generic-optics with 'buildStatusConfig' instead"  #-}
...
psBuildspec :: Lens.Lens' ProjectSource (Core.Maybe Core.Text)
psBuildspec = Lens.field @"buildspec"
{-# INLINEABLE psBuildspec #-}
{-# DEPRECATED buildspec "Use generic-lens or generic-optics with 'buildspec' instead"  #-}
...
{-# INLINEABLE psGitCloneDepth #-}
{-# DEPRECATED gitCloneDepth "Use generic-lens or generic-optics with 'gitCloneDepth' instead"  #-}
...
{-# INLINEABLE psGitSubmodulesConfig #-}
{-# DEPRECATED gitSubmodulesConfig "Use generic-lens or generic-optics with 'gitSubmodulesConfig' instead"  #-}
...
{-# INLINEABLE psInsecureSsl #-}
{-# DEPRECATED insecureSsl "Use generic-lens or generic-optics with 'insecureSsl' instead"  #-}
...
psLocation :: Lens.Lens' ProjectSource (Core.Maybe Core.Text)
psLocation = Lens.field @"location"
{-# INLINEABLE psLocation #-}
...
{-# INLINEABLE psReportBuildStatus #-}
{-# DEPRECATED reportBuildStatus "Use generic-lens or generic-optics with 'reportBuildStatus' instead"  #-}
...
psSourceIdentifier :: Lens.Lens' ProjectSource (Core.Maybe Core.Text)
psSourceIdentifier = Lens.field @"sourceIdentifier"
{-# INLINEABLE psSourceIdentifier #-}
...
instance Core.FromJSON ProjectSource where
        toJSON ProjectSource{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("type" Core..= type'), ("auth" Core..=) Core.<$> auth,
...
instance Core.FromJSON ProjectSource where
        parseJSON
          = Core.withObject "ProjectSource" Core.$
              \ x ->
                ProjectSource' Core.<$>
                  (x Core..: "type") Core.<*> x Core..:? "auth" Core.<*>
                    x Core..:? "buildStatusConfig"
