...
mkGetInventory
    :: GetInventory
mkGetInventory
  = GetInventory'{aggregators = Core.Nothing, filters = Core.Nothing,
...
instance Core.ToHeaders GetInventory where
        toHeaders GetInventory{..}
          = Core.pure ("X-Amz-Target", "AmazonSSM.GetInventory") Core.<>
...
mkGetInventoryResponse responseStatus
  = GetInventoryResponse'{entities = Core.Nothing,
