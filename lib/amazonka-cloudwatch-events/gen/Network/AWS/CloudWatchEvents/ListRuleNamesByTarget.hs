...
mkListRuleNamesByTarget targetArn
  = ListRuleNamesByTarget'{targetArn, eventBusName = Core.Nothing,
...
instance Core.AWSRequest ListRuleNamesByTarget where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 ListRuleNamesByTargetResponse' Core.<$>
                   (x Core..:? "NextToken") Core.<*> x Core..:? "RuleNames" Core.<*>
...
mkListRuleNamesByTargetResponse responseStatus
  = ListRuleNamesByTargetResponse'{nextToken = Core.Nothing,
                                   ruleNames = Core.Nothing, responseStatus}
...
{-# INLINEABLE lrnbtrrsResponseStatus #-}
