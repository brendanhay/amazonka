...
--
-- * 'cwacNamespace' - The namespace of the metric that the alarm is associated with. For more information, see <http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html Amazon CloudWatch Namespaces, Dimensions, and Metrics Reference> in the /Amazon CloudWatch Developer Guide/ .
--
...
-- | The namespace of the metric that the alarm is associated with. For more information, see <http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html Amazon CloudWatch Namespaces, Dimensions, and Metrics Reference> in the /Amazon CloudWatch Developer Guide/ .
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dsId' - Undocumented member.
--
-- * 'dsCallerReference' - Undocumented member.
--
...
--
-- * 'hccIPAddress' - The IPv4 IP address of the endpoint on which you want Amazon Route 53 to perform health checks. If you don't specify a value for @IPAddress@ , Amazon Route 53 sends a DNS request to resolve the domain name that you specify in @FullyQualifiedDomainName@ at the interval that you specify in RequestInterval. Using an IP address that DNS returns, Amazon Route 53 then checks the health of the endpoint. If the endpoint is an Amazon EC2 instance, we recommend that you create an Elastic IP address, associate it with your Amazon EC2 instance, and specify the Elastic IP address for @IPAddress@ . This ensures that the IP address of your instance will never change. For more information, see 'HealthCheckConfig$FullyQualifiedDomainName' . Contraints: Amazon Route 53 cannot check the health of endpoints for which the IP address is in local, private, non-routable, or multicast ranges. For more information about IP addresses for which you cannot create health checks, see <https://tools.ietf.org/html/rfc5735 RFC 5735, Special Use IPv4 Addresses> and <https://tools.ietf.org/html/rfc6598 RFC 6598, IANA-Reserved IPv4 Prefix for Shared Address Space> . When the value of Type is @CALCULATED@ or @CLOUDWATCH_METRIC@ , omit IPAddress.
--
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rrValue' - The current or new DNS record value, not to exceed 4,000 characters. In the case of a @DELETE@ action, if the current value does not match the actual value, an error is returned. For descriptions about how to format @Value@ for different record types, see <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DeveloperGuide/ResourceRecordTypes.html Supported DNS Resource Record Types> in the /Amazon Route 53 Developer Guide/ . You can specify more than one value for all record types except @CNAME@ and @SOA@ .
resourceRecord
    :: Text -- ^ 'rrValue'
    -> ResourceRecord
...
--
-- * 'rrsTrafficPolicyInstanceId' - Undocumented member.
--
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'tpComment' - Undocumented member.
--
-- * 'tpId' - Undocumented member.
--
-- * 'tpVersion' - Undocumented member.
--
-- * 'tpName' - Undocumented member.
--
-- * 'tpType' - Undocumented member.
--
-- * 'tpDocument' - Undocumented member.
trafficPolicy
    :: Text -- ^ 'tpId'
    -> Natural -- ^ 'tpVersion'
    -> Text -- ^ 'tpName'
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'tpiId' - Undocumented member.
--
-- * 'tpiHostedZoneId' - Undocumented member.
--
-- * 'tpiName' - Undocumented member.
--
-- * 'tpiTTL' - Undocumented member.
--
-- * 'tpiState' - Undocumented member.
--
-- * 'tpiMessage' - Undocumented member.
--
-- * 'tpiTrafficPolicyId' - Undocumented member.
--
-- * 'tpiTrafficPolicyVersion' - Undocumented member.
--
-- * 'tpiTrafficPolicyType' - Undocumented member.
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'tpsId' - Undocumented member.
--
-- * 'tpsName' - Undocumented member.
--
-- * 'tpsType' - Undocumented member.
--
-- * 'tpsLatestVersion' - Undocumented member.
--
-- * 'tpsTrafficPolicyCount' - Undocumented member.
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'vpcVPCRegion' - Undocumented member.
--
