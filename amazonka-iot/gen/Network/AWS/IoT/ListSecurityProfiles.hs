...
instance Prelude.AWSRequest ListSecurityProfiles where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          ListSecurityProfilesResponse'
            ...
            Prelude.<*> ( x Prelude..?> "securityProfileIdentifiers"
...
instance Prelude.ToHeaders ListSecurityProfiles where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath ListSecurityProfiles where
  toPath = Prelude.const "/security-profiles"

instance Prelude.ToQuery ListSecurityProfiles where
...
listSecurityProfilesResponse_securityProfileIdentifiers = Lens.lens (\ListSecurityProfilesResponse' {securityProfileIdentifiers} -> securityProfileIdentifiers) (\s@ListSecurityProfilesResponse' {} a -> s {securityProfileIdentifiers = a} :: ListSecurityProfilesResponse) Prelude.. Lens.mapping Prelude._Coerce
