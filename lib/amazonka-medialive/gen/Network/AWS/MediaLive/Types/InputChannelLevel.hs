...
{-# INLINEABLE iclInputChannel #-}
{-# DEPRECATED inputChannel "Use generic-lens or generic-optics with 'inputChannel' instead"  #-}
...
{-# INLINEABLE iclGain #-}
{-# DEPRECATED gain "Use generic-lens or generic-optics with 'gain' instead"  #-}
...
instance Core.FromJSON InputChannelLevel where
        parseJSON
          = Core.withObject "InputChannelLevel" Core.$
              \ x ->
                InputChannelLevel' Core.<$>
                  (x Core..: "inputChannel") Core.<*> x Core..: "gain"
