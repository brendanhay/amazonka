...
mkNotificationConfig
    :: NotificationConfig
mkNotificationConfig
  = NotificationConfig'{notificationArn = Core.Nothing,
                        notificationEvents = Core.Nothing, notificationType = Core.Nothing}
...
{-# INLINEABLE ncNotificationArn #-}
{-# DEPRECATED notificationArn "Use generic-lens or generic-optics with 'notificationArn' instead"  #-}
...
{-# INLINEABLE ncNotificationEvents #-}
{-# DEPRECATED notificationEvents "Use generic-lens or generic-optics with 'notificationEvents' instead"  #-}
          ...
          = Core.withObject "NotificationConfig" Core.$
              \ x ->
                NotificationConfig' Core.<$>
                  (x Core..:? "NotificationArn") Core.<*>
                    x Core..:? "NotificationEvents"
