...
mkExecutionConfiguration
    :: ExecutionConfiguration
mkExecutionConfiguration
  = ExecutionConfiguration'{accountsCleanup = Core.Nothing,
                            appPackagesCleanup = Core.Nothing,
                            jobTimeoutMinutes = Core.Nothing, skipAppResign = Core.Nothing,
...
{-# INLINEABLE ecAccountsCleanup #-}
{-# DEPRECATED accountsCleanup "Use generic-lens or generic-optics with 'accountsCleanup' instead"  #-}
...
{-# INLINEABLE ecAppPackagesCleanup #-}
{-# DEPRECATED appPackagesCleanup "Use generic-lens or generic-optics with 'appPackagesCleanup' instead"  #-}
...
{-# INLINEABLE ecJobTimeoutMinutes #-}
