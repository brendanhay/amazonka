...
mkRestoreServer backupId serverName
  = RestoreServer'{backupId, serverName, instanceType = Core.Nothing,
...
rsInstanceType :: Lens.Lens' RestoreServer (Core.Maybe Core.Text)
