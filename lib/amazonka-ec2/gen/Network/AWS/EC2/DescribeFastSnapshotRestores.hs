...
mkDescribeFastSnapshotRestores
    :: DescribeFastSnapshotRestores
mkDescribeFastSnapshotRestores
  = DescribeFastSnapshotRestores'{dryRun = Core.Nothing,
...
instance Core.AWSRequest DescribeFastSnapshotRestores where
        type Rs DescribeFastSnapshotRestores =
             DescribeFastSnapshotRestoresResponse
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 DescribeFastSnapshotRestoresResponse' Core.<$>
                   (x Core..@? "fastSnapshotRestoreSet" Core..<@>
...
mkDescribeFastSnapshotRestoresResponse responseStatus
  = DescribeFastSnapshotRestoresResponse'{fastSnapshotRestores =
                                            Core.Nothing,
...
{-# INLINEABLE dfsrrrsFastSnapshotRestores #-}
{-# DEPRECATED fastSnapshotRestores "Use generic-lens or generic-optics with 'fastSnapshotRestores' instead"  #-}
...
{-# INLINEABLE dfsrrrsResponseStatus #-}
