...
gorpId :: Lens.Lens' GetOriginRequestPolicy Core.Text
...
instance Core.AWSRequest GetOriginRequestPolicy where
        ...
        parseResponse
          = Response.receiveXML
              (\ s h x ->
                 GetOriginRequestPolicyResponse' Core.<$>
...
mkGetOriginRequestPolicyResponse responseStatus
  = GetOriginRequestPolicyResponse'{eTag = Core.Nothing,
                                    originRequestPolicy = Core.Nothing, responseStatus}

-- | The current version of the origin request policy.
--
-- /Note:/ Consider using 'eTag' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
gorprrsETag :: Lens.Lens' GetOriginRequestPolicyResponse (Core.Maybe Core.Text)
gorprrsETag = Lens.field @"eTag"
{-# INLINEABLE gorprrsETag #-}
...
{-# INLINEABLE gorprrsOriginRequestPolicy #-}
...
{-# INLINEABLE gorprrsResponseStatus #-}
