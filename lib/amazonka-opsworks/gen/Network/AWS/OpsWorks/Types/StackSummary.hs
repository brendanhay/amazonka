...
mkStackSummary
    :: StackSummary
mkStackSummary
  = StackSummary'{appsCount = Core.Nothing, arn = Core.Nothing,
                  instancesCount = Core.Nothing, layersCount = Core.Nothing,
                  name = Core.Nothing, stackId = Core.Nothing}
...
{-# INLINEABLE ssAppsCount #-}
{-# DEPRECATED appsCount "Use generic-lens or generic-optics with 'appsCount' instead"  #-}

-- | The stack's ARN.
--
-- /Note:/ Consider using 'arn' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
ssArn :: Lens.Lens' StackSummary (Core.Maybe Core.Text)
...
{-# INLINEABLE ssInstancesCount #-}
{-# DEPRECATED instancesCount "Use generic-lens or generic-optics with 'instancesCount' instead"  #-}
...
{-# INLINEABLE ssLayersCount #-}
{-# DEPRECATED layersCount "Use generic-lens or generic-optics with 'layersCount' instead"  #-}

-- | The stack name.
--
-- /Note:/ Consider using 'name' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
ssName :: Lens.Lens' StackSummary (Core.Maybe Core.Text)
...
ssStackId :: Lens.Lens' StackSummary (Core.Maybe Core.Text)
...
instance Core.FromJSON StackSummary where
        parseJSON
          = Core.withObject "StackSummary" Core.$
              \ x ->
                StackSummary' Core.<$>
                  (x Core..:? "AppsCount") Core.<*> x Core..:? "Arn" Core.<*>
                    x Core..:? "InstancesCount"
