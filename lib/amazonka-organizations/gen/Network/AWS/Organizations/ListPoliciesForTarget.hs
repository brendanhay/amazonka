...
{-# DEPRECATED lpftrrsNextToken "Use generic-lens or generic-optics with 'nextToken' instead." #-}
...
{-# DEPRECATED lpftrrsPolicies "Use generic-lens or generic-optics with 'policies' instead." #-}
...
{-# DEPRECATED lpftrrsResponseStatus "Use generic-lens or generic-optics with 'responseStatus' instead." #-}
