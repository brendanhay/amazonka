...
mkInstanceFleetConfig
    :: Types.InstanceFleetType -- ^ 'instanceFleetType'
    -> InstanceFleetConfig
...
{-# INLINEABLE ifcInstanceFleetType #-}
...
{-# INLINEABLE ifcInstanceTypeConfigs #-}
{-# DEPRECATED instanceTypeConfigs "Use generic-lens or generic-optics with 'instanceTypeConfigs' instead"  #-}
...
{-# INLINEABLE ifcLaunchSpecifications #-}
...
{-# INLINEABLE ifcTargetOnDemandCapacity #-}
...
{-# INLINEABLE ifcTargetSpotCapacity #-}
