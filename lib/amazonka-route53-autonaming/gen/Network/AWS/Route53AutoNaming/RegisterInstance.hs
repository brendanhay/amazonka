...
mkRegisterInstance serviceId instanceId
  = RegisterInstance'{serviceId, instanceId,
                      attributes = Core.mempty, creatorRequestId = Core.Nothing}
...
mkRegisterInstanceResponse responseStatus
  = RegisterInstanceResponse'{operationId = Core.Nothing,
                              responseStatus}
