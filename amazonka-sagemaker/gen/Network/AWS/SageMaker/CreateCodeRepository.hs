...
--
--
-- The repository can be hosted either in <http://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html AWS CodeCommit> or in any other Git repository.
--
module Network.AWS.SageMaker.CreateCodeRepository
    (
    -- * Creating a Request
...
createCodeRepository
    :: Text -- ^ 'ccrCodeRepositoryName'
    -> GitConfig -- ^ 'ccrGitConfig'
    -> CreateCodeRepository
createCodeRepository pCodeRepositoryName_ pGitConfig_ =
  CreateCodeRepository'
    {_ccrCodeRepositoryName = pCodeRepositoryName_, _ccrGitConfig = pGitConfig_}
...
instance Hashable CreateCodeRepository where

instance NFData CreateCodeRepository where
...
instance NFData CreateCodeRepositoryResponse where
