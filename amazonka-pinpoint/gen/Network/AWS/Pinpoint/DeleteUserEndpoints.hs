...
--
-- * 'dueApplicationId' - The unique ID of your Amazon Pinpoint application.
--
-- * 'dueUserId' - The unique ID of the user.
deleteUserEndpoints
...
deleteUserEndpoints pApplicationId_ pUserId_ =
  DeleteUserEndpoints'
    {_dueApplicationId = pApplicationId_, _dueUserId = pUserId_}
...
data DeleteUserEndpointsResponse = DeleteUserEndpointsResponse'
  { _duersResponseStatus    :: !Int
  , _duersEndpointsResponse :: !EndpointsResponse
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
deleteUserEndpointsResponse pResponseStatus_ pEndpointsResponse_ =
  DeleteUserEndpointsResponse'
    { _duersResponseStatus = pResponseStatus_
