...
mkBuild
    :: Build
mkBuild
  = Build'{buildArn = Core.Nothing, buildId = Core.Nothing,
           creationTime = Core.Nothing, name = Core.Nothing,
           operatingSystem = Core.Nothing, sizeOnDisk = Core.Nothing,
