...
mkPipelineDetail
    :: PipelineDetail
mkPipelineDetail
  = PipelineDetail'{activeInputAttachmentName = Core.Nothing,
...
{-# INLINEABLE pdActiveInputAttachmentName #-}
{-# DEPRECATED activeInputAttachmentName "Use generic-lens or generic-optics with 'activeInputAttachmentName' instead"  #-}
...
{-# INLINEABLE pdActiveInputSwitchActionName #-}
{-# DEPRECATED activeInputSwitchActionName "Use generic-lens or generic-optics with 'activeInputSwitchActionName' instead"  #-}
...
instance Core.FromJSON PipelineDetail where
        parseJSON
          = Core.withObject "PipelineDetail" Core.$
              \ x ->
                PipelineDetail' Core.<$>
                  (x Core..:? "activeInputAttachmentName") Core.<*>
                    x Core..:? "activeInputSwitchActionName"
