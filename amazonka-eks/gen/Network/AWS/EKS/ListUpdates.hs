...
instance Pager.AWSPager ListUpdates where
  page rq rs
    | Pager.stop
        ( rs
...
instance Prelude.AWSRequest ListUpdates where
...
instance Prelude.ToHeaders ListUpdates where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath ListUpdates where
  toPath ListUpdates' {..} =
    Prelude.mconcat
      ["/clusters/", Prelude.toBS name, "/updates"]

instance Prelude.ToQuery ListUpdates where
  toQuery ListUpdates' {..} =
    Prelude.mconcat
...
listUpdatesResponse_updateIds = Lens.lens (\ListUpdatesResponse' {updateIds} -> updateIds) (\s@ListUpdatesResponse' {} a -> s {updateIds = a} :: ListUpdatesResponse) Prelude.. Lens.mapping Prelude._Coerce
