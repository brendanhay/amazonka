...
mkPlayer
    :: Player
mkPlayer
  = Player'{latencyInMs = Core.Nothing,
            playerAttributes = Core.Nothing, playerId = Core.Nothing,
            team = Core.Nothing}
...
{-# INLINEABLE pLatencyInMs #-}
{-# DEPRECATED latencyInMs "Use generic-lens or generic-optics with 'latencyInMs' instead"  #-}
...
{-# INLINEABLE pPlayerAttributes #-}
{-# DEPRECATED playerAttributes "Use generic-lens or generic-optics with 'playerAttributes' instead"  #-}
...
{-# INLINEABLE pTeam #-}
{-# DEPRECATED team "Use generic-lens or generic-optics with 'team' instead"  #-}
...
instance Core.FromJSON Player where
        parseJSON
          = Core.withObject "Player" Core.$
              \ x ->
                Player' Core.<$>
                  (x Core..:? "LatencyInMs") Core.<*> x Core..:? "PlayerAttributes"
