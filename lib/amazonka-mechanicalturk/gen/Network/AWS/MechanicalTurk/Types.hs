...
mkServiceConfig
  = Core.Service{Core._svcAbbrev = "MechanicalTurk",
                 Core._svcSigner = Sign.v4, Core._svcPrefix = "mturk-requester",
                 Core._svcVersion = "2017-01-17", Core._svcTimeout = Core.Just 70,
