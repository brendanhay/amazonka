...
mkOidcConfig
    ...
    -> Types.ClientSecret -- ^ 'clientSecret'
    -> Types.OidcEndpoint -- ^ 'issuer'
    -> Types.OidcEndpoint -- ^ 'authorizationEndpoint'
    -> Types.OidcEndpoint -- ^ 'tokenEndpoint'
    -> Types.OidcEndpoint -- ^ 'userInfoEndpoint'
    -> Types.OidcEndpoint -- ^ 'logoutEndpoint'
    -> Types.OidcEndpoint -- ^ 'jwksUri'
    -> OidcConfig
mkOidcConfig clientId clientSecret issuer authorizationEndpoint
  tokenEndpoint userInfoEndpoint logoutEndpoint jwksUri
  = OidcConfig'{clientId, clientSecret, issuer,
                authorizationEndpoint, tokenEndpoint, userInfoEndpoint,
                logoutEndpoint, jwksUri}
...
{-# INLINEABLE ocAuthorizationEndpoint #-}
...
{-# INLINEABLE ocLogoutEndpoint #-}
{-# DEPRECATED logoutEndpoint "Use generic-lens or generic-optics with 'logoutEndpoint' instead"  #-}
...
{-# INLINEABLE ocJwksUri #-}
{-# DEPRECATED jwksUri "Use generic-lens or generic-optics with 'jwksUri' instead"  #-}
