...
mkLabelCountersForWorkteam
    :: LabelCountersForWorkteam
mkLabelCountersForWorkteam
  = LabelCountersForWorkteam'{humanLabeled = Core.Nothing,
                              pendingHuman = Core.Nothing, total = Core.Nothing}
...
{-# INLINEABLE lcfwPendingHuman #-}
{-# DEPRECATED pendingHuman "Use generic-lens or generic-optics with 'pendingHuman' instead"  #-}
...
instance Core.FromJSON LabelCountersForWorkteam where
        parseJSON
          = Core.withObject "LabelCountersForWorkteam" Core.$
              \ x ->
                LabelCountersForWorkteam' Core.<$>
                  (x Core..:? "HumanLabeled") Core.<*> x Core..:? "PendingHuman"
                    Core.<*> x Core..:? "Total"
