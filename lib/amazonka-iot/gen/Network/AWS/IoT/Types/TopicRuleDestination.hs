...
mkTopicRuleDestination
    :: TopicRuleDestination
mkTopicRuleDestination
  = TopicRuleDestination'{arn = Core.Nothing,
                          httpUrlProperties = Core.Nothing, status = Core.Nothing,
...
{-# INLINEABLE trdHttpUrlProperties #-}
{-# DEPRECATED httpUrlProperties "Use generic-lens or generic-optics with 'httpUrlProperties' instead"  #-}
...
{-# INLINEABLE trdStatus #-}
{-# DEPRECATED status "Use generic-lens or generic-optics with 'status' instead"  #-}

-- | Additional details or reason why the topic rule destination is in the current status.
--
-- /Note:/ Consider using 'statusReason' with <https://hackage.haskell.org/package/generic-lens generic-lens> or <https://hackage.haskell.org/package/generic-optics generic-optics> instead.
trdStatusReason :: Lens.Lens' TopicRuleDestination (Core.Maybe Core.Text)
trdStatusReason = Lens.field @"statusReason"
{-# INLINEABLE trdStatusReason #-}
...
instance Core.FromJSON TopicRuleDestination where
        parseJSON
          = Core.withObject "TopicRuleDestination" Core.$
              \ x ->
                TopicRuleDestination' Core.<$>
                  (x Core..:? "arn") Core.<*> x Core..:? "httpUrlProperties" Core.<*>
                    x Core..:? "status"
