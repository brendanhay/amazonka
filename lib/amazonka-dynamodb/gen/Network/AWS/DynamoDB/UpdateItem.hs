...
mkUpdateItem tableName
  = UpdateItem'{tableName, key = Core.mempty,
                ...
                returnValues = Core.Nothing, updateExpression = Core.Nothing}
...
{-# INLINEABLE uiConditionExpression #-}
...
{-# INLINEABLE uiConditionalOperator #-}
...
{-# INLINEABLE uiExpressionAttributeNames #-}
...
{-# INLINEABLE uiExpressionAttributeValues #-}
...
{-# INLINEABLE uiReturnConsumedCapacity #-}
...
{-# INLINEABLE uiReturnItemCollectionMetrics #-}
...
{-# INLINEABLE uiUpdateExpression #-}
{-# DEPRECATED updateExpression "Use generic-lens or generic-optics with 'updateExpression' instead"  #-}

instance Core.ToQuery UpdateItem where
        toQuery _ = Core.pure Core.mempty

instance Core.ToHeaders UpdateItem where
        toHeaders UpdateItem{..}
...
mkUpdateItemResponse responseStatus
  = UpdateItemResponse'{attributes = Core.Nothing,
...
{-# INLINEABLE uirrsConsumedCapacity #-}
...
{-# INLINEABLE uirrsItemCollectionMetrics #-}
