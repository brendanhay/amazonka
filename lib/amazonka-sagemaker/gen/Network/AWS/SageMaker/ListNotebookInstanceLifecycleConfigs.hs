...
instance AWSPager ListNotebookInstanceLifecycleConfigs where
  page rq rs
    | stop (rs ^. lnilcrsNextToken) = Nothing
    | stop (rs ^. lnilcrsNotebookInstanceLifecycleConfigs) = Nothing
    | otherwise = Just $ rq & lnilcNextToken .~ rs ^. lnilcrsNextToken

instance AWSRequest ListNotebookInstanceLifecycleConfigs where
  type
...
instance Hashable ListNotebookInstanceLifecycleConfigs

instance NFData ListNotebookInstanceLifecycleConfigs

instance ToHeaders ListNotebookInstanceLifecycleConfigs where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("SageMaker.ListNotebookInstanceLifecycleConfigs" :: ByteString),
    ...
    object
      ( catMaybes
          [ ("NameContains" .=) <$> _lnilcNameContains,
            ("LastModifiedTimeBefore" .=) <$> _lnilcLastModifiedTimeBefore,
            ("CreationTimeAfter" .=) <$> _lnilcCreationTimeAfter,
            ("NextToken" .=) <$> _lnilcNextToken,
            ("SortOrder" .=) <$> _lnilcSortOrder,
            ("LastModifiedTimeAfter" .=) <$> _lnilcLastModifiedTimeAfter,
            ("CreationTimeBefore" .=) <$> _lnilcCreationTimeBefore,
...
instance NFData ListNotebookInstanceLifecycleConfigsResponse
