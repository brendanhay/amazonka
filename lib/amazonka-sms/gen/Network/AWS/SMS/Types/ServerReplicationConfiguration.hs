...
mkServerReplicationConfiguration
    :: ServerReplicationConfiguration
mkServerReplicationConfiguration
  = ServerReplicationConfiguration'{server = Core.Nothing,
...
{-# INLINEABLE srcServerReplicationParameters #-}
{-# DEPRECATED serverReplicationParameters "Use generic-lens or generic-optics with 'serverReplicationParameters' instead"  #-}
          ...
          = Core.object
              (Core.catMaybes
                 [("server" Core..=) Core.<$> server,
                  ("serverReplicationParameters" Core..=) Core.<$>
...
instance Core.FromJSON ServerReplicationConfiguration where
        parseJSON
          = Core.withObject "ServerReplicationConfiguration" Core.$
              \ x ->
                ServerReplicationConfiguration' Core.<$>
                  (x Core..:? "server") Core.<*>
                    x Core..:? "serverReplicationParameters"
