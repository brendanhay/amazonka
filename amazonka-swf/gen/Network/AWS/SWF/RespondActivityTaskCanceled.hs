...
-- | Information about the cancellation.
respondActivityTaskCanceled_details :: Lens.Lens' RespondActivityTaskCanceled (Core.Maybe Core.Text)
...
-- must also be passed. This enables it to provide its progress and respond
-- with results.
respondActivityTaskCanceled_taskToken :: Lens.Lens' RespondActivityTaskCanceled Core.Text
...
instance Core.Hashable RespondActivityTaskCanceled

instance Core.NFData RespondActivityTaskCanceled
