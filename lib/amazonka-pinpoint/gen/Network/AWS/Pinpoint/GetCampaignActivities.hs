...
mkGetCampaignActivities applicationId campaignId
  = GetCampaignActivities'{applicationId, campaignId,
...
instance Core.ToHeaders GetCampaignActivities where
        toHeaders GetCampaignActivities{..}
...
instance Core.AWSRequest GetCampaignActivities where
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 GetCampaignActivitiesResponse' Core.<$>
...
mkGetCampaignActivitiesResponse
    :: Types.ActivitiesResponse -- ^ 'activitiesResponse'
...
{-# INLINEABLE gcarrsActivitiesResponse #-}
{-# DEPRECATED activitiesResponse "Use generic-lens or generic-optics with 'activitiesResponse' instead"  #-}
