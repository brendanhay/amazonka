...
mkDescribeAccessPoints
    :: DescribeAccessPoints
mkDescribeAccessPoints
  = DescribeAccessPoints'{accessPointId = Core.Nothing,
                          fileSystemId = Core.Nothing, maxResults = Core.Nothing,
...
instance Core.AWSRequest DescribeAccessPoints where
        ...
        toRequest x@Core.Request{..}
          = Core.Request{Core._rqService = Types.mkServiceConfig,
                         ...
                         Core._rqPath = "/2015-02-01/access-points",
        ...
        parseResponse
          = Response.receiveJSON
              (\ s h x ->
                 DescribeAccessPointsResponse' Core.<$>
                   (x Core..:? "AccessPoints") Core.<*> x Core..:? "NextToken"
...
mkDescribeAccessPointsResponse responseStatus
  = DescribeAccessPointsResponse'{accessPoints = Core.Nothing,
...
{-# INLINEABLE daprrsAccessPoints #-}
{-# DEPRECATED accessPoints "Use generic-lens or generic-optics with 'accessPoints' instead"  #-}
