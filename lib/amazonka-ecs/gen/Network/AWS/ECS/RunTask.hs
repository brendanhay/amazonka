...
rtTaskDefinition :: Lens.Lens' RunTask Types.String
...
rtCluster :: Lens.Lens' RunTask (Core.Maybe Types.String)
...
rtGroup :: Lens.Lens' RunTask (Core.Maybe Types.String)
...
rtPlatformVersion :: Lens.Lens' RunTask (Core.Maybe Types.String)
...
rtReferenceId :: Lens.Lens' RunTask (Core.Maybe Types.String)
...
rtStartedBy :: Lens.Lens' RunTask (Core.Maybe Types.String)
...
{-# DEPRECATED rtrrsFailures "Use generic-lens or generic-optics with 'failures' instead." #-}
...
{-# DEPRECATED rtrrsTasks "Use generic-lens or generic-optics with 'tasks' instead." #-}
